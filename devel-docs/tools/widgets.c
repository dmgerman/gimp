...
directive|if
literal|0
block|g_signal_connect_swapped (info->window, "realize",                                 G_CALLBACK (realize_callback), info);
endif|#
directive|endif
block|}
else|else
