...
name|WidgetInfo
modifier|*
DECL|function|new_widget_info (const char * name,GtkWidget * widget,gboolean show_all,WidgetSize size)
...
name|WidgetInfo
modifier|*
DECL|function|create_busy_box (void)
name|create_busy_box
parameter_list|(
name|void
parameter_list|)
block|{
...
name|WidgetInfo
modifier|*
DECL|function|create_color_notebook (void)
name|create_color_notebook
parameter_list|(
name|void
parameter_list|)
block|{
...
name|new_widget_info
argument_list|(
literal|"gimp-widget-color-notebook"
argument_list|,
name|vbox
argument_list|,
name|FALSE
...
name|WidgetInfo
modifier|*
DECL|function|create_color_profile_view (void)
name|create_color_profile_view
parameter_list|(
name|void
parameter_list|)
block|{
...
name|new_widget_info
argument_list|(
literal|"gimp-widget-color-profile-view"
argument_list|,
name|vbox
argument_list|,
name|TRUE
...
name|WidgetInfo
modifier|*
DECL|function|create_color_scales (void)
name|create_color_scales
parameter_list|(
name|void
parameter_list|)
block|{
...
name|new_widget_info
argument_list|(
literal|"gimp-widget-color-scales"
argument_list|,
name|vbox
argument_list|,
name|FALSE
...
name|WidgetInfo
modifier|*
DECL|function|create_color_select (void)
name|create_color_select
parameter_list|(
name|void
parameter_list|)
block|{
...
name|new_widget_info
argument_list|(
literal|"gimp-widget-color-select"
argument_list|,
name|vbox
argument_list|,
name|FALSE
...
name|WidgetInfo
modifier|*
DECL|function|create_ruler (void)
name|create_ruler
parameter_list|(
name|void
parameter_list|)
...
name|WidgetInfo
modifier|*
DECL|function|create_unit_combo_box (void)
name|create_unit_combo_box
parameter_list|(
name|void
parameter_list|)
block|{
...
name|new_widget_info
argument_list|(
literal|"gimp-widget-unit-combo-box"
argument_list|,
name|vbox
argument_list|,
name|TRUE
...
argument_list|)
expr_stmt|;
comment|/* put selection before notebook, selection ensures the modules */
name|retval
operator|=
name|g_list_append
argument_list|(
