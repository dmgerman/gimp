...
argument_list|(
argument|GimpConfigWriter
argument_list|,
argument|gimp_config_writer
argument_list|,
argument|gimp_config_writer_ref
argument_list|,
argument|gimp_config_writer_unref
argument_list|)
end_macro
...
begin_comment
comment|/**  * gimp_config_writer_ref:  * @writer: #GimpConfigWriter to ref  *  * Adds a reference to a #GimpConfigWriter.  *  * Returns: the same @writer.  *  * Since: 3.0  */
end_comment

begin_function
name|GimpConfigWriter
modifier|*
DECL|function|gimp_config_writer_ref (GimpConfigWriter * writer)
...
begin_function
name|void
DECL|function|gimp_config_writer_unref (GimpConfigWriter * writer)
...
name|g_printerr
argument_list|(
literal|"%s: dropping last reference via unref(), you should "
literal|"call gimp_config_writer_finish()\n"
argument_list|,
name|G_STRFUNC
argument_list|)
expr_stmt|;
...
name|g_printerr
argument_list|(
literal|"%s: error on finishing writer: %s\n"
argument_list|,
name|G_STRFUNC
argument_list|,
name|error
...
begin_comment
comment|/**  * gimp_config_writer_finish:  * @writer: a #GimpConfigWriter  * @footer: text to include as comment at the bottom of the file  * @error: return location for possible errors  *  * This function finishes the work of @writer and unrefs it  * afterwards.  It closes all open elements, appends an optional  * comment and releases all resources allocated by @writer.  *  * Using any function except gimp_config_writer_ref() or  * gimp_config_writer_unref() after this function is forbidden  * and will trigger warnings.  *  * Returns: %TRUE if everything could be successfully written,  *          %FALSE otherwise  *  * Since: 2.4  **/
end_comment
