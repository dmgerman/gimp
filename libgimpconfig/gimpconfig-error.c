...
begin_comment
comment|/**  * gimp_config_error_quark:  *  * This function is never called directly. Use GIMP_CONFIG_ERROR() instead.  *  * Returns: the #GQuark that defines the GimpConfig error domain.  *  * Since: 2.4  **/
end_comment
