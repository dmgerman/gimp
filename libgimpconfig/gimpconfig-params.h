...
begin_comment
comment|/*  create a copy of a GParamSpec  */
end_comment

begin_empty_stmt
unit|GParamSpec * gimp_config_param_spec_duplicate (GParamSpec *pspec)
empty_stmt|;
end_empty_stmt
