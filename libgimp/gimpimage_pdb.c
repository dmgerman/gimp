...
begin_comment
comment|/**  * gimp_image_flip:  * @image_ID: The image.  * @flip_type: Type of flip.  *  * Flips the image horizontally or vertically.  *  * This procedure flips (mirrors) the images.  *  * Returns: TRUE on success.  */
end_comment
