...
begin_comment
comment|/**  * _gimp_image_is_valid: (skip)  * @image_ID: The image to check.  *  * Returns TRUE if the image is valid.  *  * This procedure checks if the given image is valid and refers to an  * existing image.  *  * Returns: Whether the image is valid.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_is_valid (gint32 image_ID)
...
begin_comment
comment|/**  * gimp_image_list:  * @num_images: (out): The number of images currently open.  *  * Returns the list of images currently open.  *  * This procedure returns the list of images currently open in GIMP.  *  * Returns: (array length=num_images) (element-type gint32) (transfer full):  *          The list of images currently open.  *          The returned value must be freed with g_free().  **/
end_comment
...
begin_comment
comment|/**  * _gimp_image_new: (skip)  * @width: The width of the image.  * @height: The height of the image.  * @type: The type of image.  *  * Creates a new image with the specified width, height, and type.  *  * Creates a new image, undisplayed, with the specified extents and  * type. A layer should be created and added before this image is  * displayed, or subsequent calls to gimp_display_new() with this image  * as an argument will fail. Layers can be created using the  * gimp_layer_new() commands. They can be added to an image using the  * gimp_image_insert_layer() command.  *  * If your image's type if INDEXED, a colormap must also be added with  * gimp_image_set_colormap(). An indexed image without a colormap will  * output unexpected colors.  *  * Returns: The newly created image.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_new (gint width,gint height,GimpImageBaseType type)
...
begin_comment
comment|/**  * _gimp_image_new_with_precision: (skip)  * @width: The width of the image.  * @height: The height of the image.  * @type: The type of image.  * @precision: The precision.  *  * Creates a new image with the specified width, height, type and  * precision.  *  * Creates a new image, undisplayed with the specified extents, type  * and precision. Indexed images can only be created at  * GIMP_PRECISION_U8_NON_LINEAR precision. See gimp_image_new() for  * further details.  *  * Returns: The newly created image.  *  * Since: 2.10  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_new_with_precision (gint width,gint height,GimpImageBaseType type,GimpPrecision precision)
...
begin_comment
comment|/**  * _gimp_image_duplicate: (skip)  * @image_ID: The image.  *  * Duplicate the specified image  *  * This procedure duplicates the specified image, copying all layers,  * channels, and image information.  *  * Returns: The new, duplicated image.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_duplicate (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_delete: (skip)  * @image_ID: The image.  *  * Delete the specified image.  *  * If there are no displays associated with this image it will be  * deleted. This means that you can not delete an image through the PDB  * that was created by the user. If the associated display was however  * created through the PDB and you know the display ID, you may delete  * the display. Removal of the last associated display will then delete  * the image.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_delete (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_base_type: (skip)  * @image_ID: The image.  *  * Get the base type of the image.  *  * This procedure returns the image's base type. Layers in the image  * must be of this subtype, but can have an optional alpha channel.  *  * Returns: The image's base type.  **/
end_comment

begin_function
name|GimpImageBaseType
DECL|function|_gimp_image_base_type (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_precision: (skip)  * @image_ID: The image.  *  * Get the precision of the image.  *  * This procedure returns the image's precision.  *  * Returns: The image's precision.  *  * Since: 2.10  **/
end_comment

begin_function
name|GimpPrecision
DECL|function|_gimp_image_get_precision (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_default_new_layer_mode: (skip)  * @image_ID: The image.  *  * Get the default mode for newly created layers of this image.  *  * Returns the default mode for newly created layers of this image.  *  * Returns: The layer mode.  *  * Since: 2.10  **/
end_comment

begin_function
name|GimpLayerMode
DECL|function|_gimp_image_get_default_new_layer_mode (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_width: (skip)  * @image_ID: The image.  *  * Return the width of the image  *  * This procedure returns the image's width. This value is independent  * of any of the layers in this image. This is the \"canvas\" width.  *  * Returns: The image's width.  **/
end_comment

begin_function
name|gint
DECL|function|_gimp_image_width (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_height: (skip)  * @image_ID: The image.  *  * Return the height of the image  *  * This procedure returns the image's height. This value is independent  * of any of the layers in this image. This is the \"canvas\" height.  *  * Returns: The image's height.  **/
end_comment

begin_function
name|gint
DECL|function|_gimp_image_height (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_layers: (skip)  * @image_ID: The image.  * @num_layers: (out): The number of layers contained in the image.  *  * Returns the list of layers contained in the specified image.  *  * This procedure returns the list of layers contained in the specified  * image. The order of layers is from topmost to bottommost.  *  * Returns: (array length=num_layers):  *          The list of layers contained in the image.  *          The returned value must be freed with g_free().  **/
end_comment

begin_function
name|gint
modifier|*
DECL|function|_gimp_image_get_layers (gint32 image_ID,gint * num_layers)
...
begin_comment
comment|/**  * _gimp_image_get_channels: (skip)  * @image_ID: The image.  * @num_channels: (out): The number of channels contained in the image.  *  * Returns the list of channels contained in the specified image.  *  * This procedure returns the list of channels contained in the  * specified image. This does not include the selection mask, or layer  * masks. The order is from topmost to bottommost. Note that  * \"channels\" are custom channels and do not include the image's  * color components.  *  * Returns: (array length=num_channels):  *          The list of channels contained in the image.  *          The returned value must be freed with g_free().  **/
end_comment

begin_function
name|gint
modifier|*
DECL|function|_gimp_image_get_channels (gint32 image_ID,gint * num_channels)
...
begin_comment
comment|/**  * _gimp_image_get_vectors: (skip)  * @image_ID: The image.  * @num_vectors: (out): The number of vectors contained in the image.  *  * Returns the list of vectors contained in the specified image.  *  * This procedure returns the list of vectors contained in the  * specified image.  *  * Returns: (array length=num_vectors):  *          The list of vectors contained in the image.  *          The returned value must be freed with g_free().  *  * Since: 2.4  **/
end_comment

begin_function
name|gint
modifier|*
DECL|function|_gimp_image_get_vectors (gint32 image_ID,gint * num_vectors)
...
begin_comment
comment|/**  * _gimp_image_get_active_drawable: (skip)  * @image_ID: The image.  *  * Get the image's active drawable  *  * This procedure returns the ID of the image's active drawable. This  * can be either a layer, a channel, or a layer mask. The active  * drawable is specified by the active image channel. If that is -1,  * then by the active image layer. If the active image layer has a  * layer mask and the layer mask is in edit mode, then the layer mask  * is the active drawable.  *  * Returns: The active drawable.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_active_drawable (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_unset_active_channel: (skip)  * @image_ID: The image.  *  * Unsets the active channel in the specified image.  *  * If an active channel exists, it is unset. There then exists no  * active channel, and if desired, one can be set through a call to  * 'Set Active Channel'. No error is returned in the case of no  * existing active channel.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_unset_active_channel (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_floating_sel: (skip)  * @image_ID: The image.  *  * Return the floating selection of the image.  *  * This procedure returns the image's floating selection, if it exists.  * If it doesn't exist, -1 is returned as the layer ID.  *  * Returns: The image's floating selection.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_floating_sel (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_floating_sel_attached_to: (skip)  * @image_ID: The image.  *  * Return the drawable the floating selection is attached to.  *  * This procedure returns the drawable the image's floating selection  * is attached to, if it exists. If it doesn't exist, -1 is returned as  * the drawable ID.  *  * Returns: The drawable the floating selection is attached to.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_floating_sel_attached_to (gint32 image_ID)
...
begin_function
name|gboolean
DECL|function|_gimp_image_pick_color (gint32 image_ID,gint32 drawable_ID,gdouble x,gdouble y,gboolean sample_merged,gboolean sample_average,gdouble average_radius,GimpRGB * color)
...
begin_comment
comment|/**  * _gimp_image_pick_correlate_layer: (skip)  * @image_ID: The image.  * @x: The x coordinate for the pick.  * @y: The y coordinate for the pick.  *  * Find the layer visible at the specified coordinates.  *  * This procedure finds the layer which is visible at the specified  * coordinates. Layers which do not qualify are those whose extents do  * not pass within the specified coordinates, or which are transparent  * at the specified coordinates. This procedure will return -1 if no  * layer is found.  *  * Returns: The layer found at the specified coordinates.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_pick_correlate_layer (gint32 image_ID,gint x,gint y)
...
begin_function
name|gboolean
DECL|function|_gimp_image_insert_layer (gint32 image_ID,gint32 layer_ID,gint32 parent_ID,gint position)
...
begin_comment
comment|/**  * _gimp_image_remove_layer: (skip)  * @image_ID: The image.  * @layer_ID: The layer.  *  * Remove the specified layer from the image.  *  * This procedure removes the specified layer from the image. If the  * layer doesn't exist, an error is returned. If there are no layers  * left in the image, this call will fail. If this layer is the last  * layer remaining, the image will become empty and have no active  * layer.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_remove_layer (gint32 image_ID,gint32 layer_ID)
...
begin_comment
comment|/**  * _gimp_image_thaw_layers: (skip)  * @image_ID: The image.  *  * Thaw the image's layer list.  *  * This procedure thaws the layer list of the image, re-enabling  * updates to the Layers dialog.  *  * This procedure should match a corresponding call to  * gimp_image_freeze_layers().  *  * Returns: TRUE on success.  *  * Since: 2.10.2  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_thaw_layers (gint32 image_ID)
...
begin_function
name|gboolean
DECL|function|_gimp_image_insert_channel (gint32 image_ID,gint32 channel_ID,gint32 parent_ID,gint position)
...
begin_comment
comment|/**  * _gimp_image_remove_channel: (skip)  * @image_ID: The image.  * @channel_ID: The channel.  *  * Remove the specified channel from the image.  *  * This procedure removes the specified channel from the image. If the  * channel doesn't exist, an error is returned.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_remove_channel (gint32 image_ID,gint32 channel_ID)
...
begin_comment
comment|/**  * _gimp_image_freeze_channels: (skip)  * @image_ID: The image.  *  * Freeze the image's channel list.  *  * This procedure freezes the channel list of the image, suppressing  * any updates to the Channels dialog in response to changes to the  * image's channels. This can significantly improve performance while  * applying changes affecting the channel list.  *  * Each call to gimp_image_freeze_channels() should be matched by a  * corresponding call to gimp_image_thaw_channels(), undoing its  * effects.  *  * Returns: TRUE on success.  *  * Since: 2.10.2  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_freeze_channels (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_thaw_channels: (skip)  * @image_ID: The image.  *  * Thaw the image's channel list.  *  * This procedure thaws the channel list of the image, re-enabling  * updates to the Channels dialog.  *  * This procedure should match a corresponding call to  * gimp_image_freeze_channels().  *  * Returns: TRUE on success.  *  * Since: 2.10.2  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_thaw_channels (gint32 image_ID)
...
begin_function
name|gboolean
DECL|function|_gimp_image_insert_vectors (gint32 image_ID,gint32 vectors_ID,gint32 parent_ID,gint position)
...
begin_comment
comment|/**  * _gimp_image_remove_vectors: (skip)  * @image_ID: The image.  * @vectors_ID: The vectors object.  *  * Remove the specified path from the image.  *  * This procedure removes the specified path from the image. If the  * path doesn't exist, an error is returned.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_remove_vectors (gint32 image_ID,gint32 vectors_ID)
...
begin_comment
comment|/**  * _gimp_image_thaw_vectors: (skip)  * @image_ID: The image.  *  * Thaw the image's vectors list.  *  * This procedure thaws the vectors list of the image, re-enabling  * updates to the Paths dialog.  *  * This procedure should match a corresponding call to  * gimp_image_freeze_vectors().  *  * Returns: TRUE on success.  *  * Since: 2.10.2  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_thaw_vectors (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_item_position: (skip)  * @image_ID: The image.  * @item_ID: The item.  *  * Returns the position of the item in its level of its item tree.  *  * This procedure determines the position of the specified item in its  * level in its item tree in the image. If the item doesn't exist in  * the image, or the item is not part of an item tree, an error is  * returned.  *  * Returns: The position of the item in its level in the item tree.  *  * Since: 2.8  **/
end_comment

begin_function
name|gint
DECL|function|_gimp_image_get_item_position (gint32 image_ID,gint32 item_ID)
...
begin_comment
comment|/**  * _gimp_image_raise_item: (skip)  * @image_ID: The image.  * @item_ID: The item to raise.  *  * Raise the specified item in its level in its item tree  *  * This procedure raises the specified item one step in the item tree.  * The procedure call will fail if there is no item above it.  *  * Returns: TRUE on success.  *  * Since: 2.8  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_raise_item (gint32 image_ID,gint32 item_ID)
...
begin_comment
comment|/**  * _gimp_image_lower_item: (skip)  * @image_ID: The image.  * @item_ID: The item to lower.  *  * Lower the specified item in its level in its item tree  *  * This procedure lowers the specified item one step in the item tree.  * The procedure call will fail if there is no item below it.  *  * Returns: TRUE on success.  *  * Since: 2.8  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_lower_item (gint32 image_ID,gint32 item_ID)
...
begin_comment
comment|/**  * _gimp_image_raise_item_to_top: (skip)  * @image_ID: The image.  * @item_ID: The item to raise to top.  *  * Raise the specified item to the top of its level in its item tree  *  * This procedure raises the specified item to top of its level in the  * item tree. It will not move the item if there is no item above it.  *  * Returns: TRUE on success.  *  * Since: 2.8  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_raise_item_to_top (gint32 image_ID,gint32 item_ID)
...
begin_comment
comment|/**  * _gimp_image_lower_item_to_bottom: (skip)  * @image_ID: The image.  * @item_ID: The item to lower to bottom.  *  * Lower the specified item to the bottom of its level in its item tree  *  * This procedure lowers the specified item to bottom of its level in  * the item tree. It will not move the layer if there is no layer below  * it.  *  * Returns: TRUE on success.  *  * Since: 2.8  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_lower_item_to_bottom (gint32 image_ID,gint32 item_ID)
...
begin_function
name|gboolean
DECL|function|_gimp_image_reorder_item (gint32 image_ID,gint32 item_ID,gint32 parent_ID,gint position)
...
begin_comment
comment|/**  * _gimp_image_merge_visible_layers: (skip)  * @image_ID: The image.  * @merge_type: The type of merge.  *  * Merge the visible image layers into one.  *  * This procedure combines the visible layers into a single layer using  * the specified merge type. A merge type of EXPAND_AS_NECESSARY  * expands the final layer to encompass the areas of the visible  * layers. A merge type of CLIP_TO_IMAGE clips the final layer to the  * extents of the image. A merge type of CLIP_TO_BOTTOM_LAYER clips the  * final layer to the size of the bottommost layer.  *  * Returns: The resulting layer.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_merge_visible_layers (gint32 image_ID,GimpMergeType merge_type)
...
begin_comment
comment|/**  * _gimp_image_merge_down: (skip)  * @image_ID: The image.  * @merge_layer_ID: The layer to merge down from.  * @merge_type: The type of merge.  *  * Merge the layer passed and the first visible layer below.  *  * This procedure combines the passed layer and the first visible layer  * below it using the specified merge type. A merge type of  * EXPAND_AS_NECESSARY expands the final layer to encompass the areas  * of the visible layers. A merge type of CLIP_TO_IMAGE clips the final  * layer to the extents of the image. A merge type of  * CLIP_TO_BOTTOM_LAYER clips the final layer to the size of the  * bottommost layer.  *  * Returns: The resulting layer.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_merge_down (gint32 image_ID,gint32 merge_layer_ID,GimpMergeType merge_type)
...
begin_comment
comment|/**  * __gimp_image_get_colormap: (skip)  * @image_ID: The image.  * @num_bytes: (out): Number of bytes in the colormap array.  *  * Returns the image's colormap  *  * This procedure returns an actual pointer to the image's colormap, as  * well as the number of bytes contained in the colormap. The actual  * number of colors in the transmitted colormap will be 'num-bytes' /  * 3. If the image is not in Indexed color mode, no colormap is  * returned.  *  * Returns: (array length=num_bytes): The image's colormap.  *          The returned value must be freed with g_free().  **/
end_comment

begin_function
name|guint8
modifier|*
DECL|function|__gimp_image_get_colormap (gint32 image_ID,gint * num_bytes)
...
begin_comment
comment|/**  * __gimp_image_set_colormap: (skip)  * @image_ID: The image.  * @num_bytes: Number of bytes in the colormap array.  * @colormap: (array length=num_bytes) (element-type guint8): The new colormap values.  *  * Sets the entries in the image's colormap.  *  * This procedure sets the entries in the specified image's colormap.  * The number of entries is specified by the 'num-bytes' parameter and  * corresponds to the number of INT8 triples that must be contained in  * the 'colormap' array. The actual number of colors in the transmitted  * colormap is 'num-bytes' / 3.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|__gimp_image_set_colormap (gint32 image_ID,gint num_bytes,const guint8 * colormap)
...
begin_comment
comment|/**  * __gimp_image_get_metadata: (skip)  * @image_ID: The image.  *  * Returns the image's metadata.  *  * Returns exif/iptc/xmp metadata from the image.  *  * Returns: The exif/ptc/xmp metadata as a string.  *          The returned value must be freed with g_free().  **/
end_comment

begin_function
name|gchar
modifier|*
DECL|function|__gimp_image_get_metadata (gint32 image_ID)
...
begin_comment
comment|/**  * __gimp_image_set_metadata: (skip)  * @image_ID: The image.  * @metadata_string: The exif/ptc/xmp metadata as a string.  *  * Set the image's metadata.  *  * Sets exif/iptc/xmp metadata on the image.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|__gimp_image_set_metadata (gint32 image_ID,const gchar * metadata_string)
...
begin_comment
comment|/**  * _gimp_image_clean_all: (skip)  * @image_ID: The image.  *  * Set the image dirty count to 0.  *  * This procedure sets the specified image's dirty count to 0, allowing  * operations to occur without having a 'dirtied' image. This is  * especially useful for creating and loading images which should not  * initially be considered dirty, even though layers must be created,  * filled, and installed in the image. Note that save plug-ins must NOT  * call this function themselves after saving the image.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_clean_all (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_is_dirty: (skip)  * @image_ID: The image.  *  * Checks if the image has unsaved changes.  *  * This procedure checks the specified image's dirty count to see if it  * needs to be saved. Note that saving the image does not automatically  * set the dirty count to 0, you need to call gimp_image_clean_all()  * after calling a save procedure to make the image clean.  *  * Returns: TRUE if the image has unsaved changes.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_is_dirty (gint32 image_ID)
...
begin_comment
comment|/**  * __gimp_image_thumbnail: (skip)  * @image_ID: The image.  * @width: The requested thumbnail width.  * @height: The requested thumbnail height.  * @actual_width: (out): The previews width.  * @actual_height: (out): The previews height.  * @bpp: (out): The previews bpp.  * @thumbnail_data_count: (out): The number of bytes in thumbnail data.  * @thumbnail_data: (out) (array length=thumbnail_data_count): The thumbnail data.  *  * Get a thumbnail of an image.  *  * This function gets data from which a thumbnail of an image preview  * can be created. Maximum x or y dimension is 1024 pixels. The pixels  * are returned in RGB[A] or GRAY[A] format. The bpp return value gives  * the number of bits per pixel in the image.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|__gimp_image_thumbnail (gint32 image_ID,gint width,gint height,gint * actual_width,gint * actual_height,gint * bpp,gint * thumbnail_data_count,guint8 ** thumbnail_data)
...
begin_comment
comment|/**  * _gimp_image_get_active_layer: (skip)  * @image_ID: The image.  *  * Returns the specified image's active layer.  *  * If there is an active layer, its ID will be returned, otherwise, -1.  * If a channel is currently active, then no layer will be. If a layer  * mask is active, then this will return the associated layer.  *  * Returns: The active layer.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_active_layer (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_set_active_layer: (skip)  * @image_ID: The image.  * @active_layer_ID: The new image active layer.  *  * Sets the specified image's active layer.  *  * If the layer exists, it is set as the active layer in the image. Any  * previous active layer or channel is set to inactive. An exception is  * a previously existing floating selection, in which case this  * procedure will return an execution error.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_set_active_layer (gint32 image_ID,gint32 active_layer_ID)
...
begin_comment
comment|/**  * _gimp_image_get_active_channel: (skip)  * @image_ID: The image.  *  * Returns the specified image's active channel.  *  * If there is an active channel, this will return the channel ID,  * otherwise, -1.  *  * Returns: The active channel.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_active_channel (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_set_active_channel: (skip)  * @image_ID: The image.  * @active_channel_ID: The new image active channel.  *  * Sets the specified image's active channel.  *  * If the channel exists, it is set as the active channel in the image.  * Any previous active channel or layer is set to inactive. An  * exception is a previously existing floating selection, in which case  * this procedure will return an execution error.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_set_active_channel (gint32 image_ID,gint32 active_channel_ID)
...
begin_comment
comment|/**  * _gimp_image_get_active_vectors: (skip)  * @image_ID: The image.  *  * Returns the specified image's active vectors.  *  * If there is an active path, its ID will be returned, otherwise, -1.  *  * Returns: The active vectors.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_active_vectors (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_set_active_vectors: (skip)  * @image_ID: The image.  * @active_vectors_ID: The new image active vectors.  *  * Sets the specified image's active vectors.  *  * If the path exists, it is set as the active path in the image.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_set_active_vectors (gint32 image_ID,gint32 active_vectors_ID)
...
begin_comment
comment|/**  * _gimp_image_get_selection: (skip)  * @image_ID: The image.  *  * Returns the specified image's selection.  *  * This will always return a valid ID for a selection -- which is  * represented as a channel internally.  *  * Returns: The selection channel.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_selection (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_component_active: (skip)  * @image_ID: The image.  * @component: The image component.  *  * Returns if the specified image's image component is active.  *  * This procedure returns if the specified image's image component  * (i.e. Red, Green, Blue intensity channels in an RGB image) is active  * or inactive -- whether or not it can be modified. If the specified  * component is not valid for the image type, an error is returned.  *  * Returns: Component is active.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_get_component_active (gint32 image_ID,GimpChannelType component)
...
begin_comment
comment|/**  * _gimp_image_set_component_active: (skip)  * @image_ID: The image.  * @component: The image component.  * @active: Component is active.  *  * Sets if the specified image's image component is active.  *  * This procedure sets if the specified image's image component (i.e.  * Red, Green, Blue intensity channels in an RGB image) is active or  * inactive -- whether or not it can be modified. If the specified  * component is not valid for the image type, an error is returned.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_set_component_active (gint32 image_ID,GimpChannelType component,gboolean active)
...
begin_comment
comment|/**  * _gimp_image_get_component_visible: (skip)  * @image_ID: The image.  * @component: The image component.  *  * Returns if the specified image's image component is visible.  *  * This procedure returns if the specified image's image component  * (i.e. Red, Green, Blue intensity channels in an RGB image) is  * visible or invisible -- whether or not it can be seen. If the  * specified component is not valid for the image type, an error is  * returned.  *  * Returns: Component is visible.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_get_component_visible (gint32 image_ID,GimpChannelType component)
...
begin_comment
comment|/**  * _gimp_image_set_component_visible: (skip)  * @image_ID: The image.  * @component: The image component.  * @visible: Component is visible.  *  * Sets if the specified image's image component is visible.  *  * This procedure sets if the specified image's image component (i.e.  * Red, Green, Blue intensity channels in an RGB image) is visible or  * invisible -- whether or not it can be seen. If the specified  * component is not valid for the image type, an error is returned.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_set_component_visible (gint32 image_ID,GimpChannelType component,gboolean visible)
...
begin_comment
comment|/**  * _gimp_image_get_filename: (skip)  * @image_ID: The image.  *  * Returns the specified image's filename.  *  * This procedure returns the specified image's filename in the  * filesystem encoding. The image has a filename only if it was loaded  * or imported from a file or has since been saved or exported.  * Otherwise, this function returns %NULL. See also  * gimp_image_get_uri().  *  * Returns: The filename.  *          The returned value must be freed with g_free().  **/
end_comment

begin_function
name|gchar
modifier|*
DECL|function|_gimp_image_get_filename (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_set_filename: (skip)  * @image_ID: The image.  * @filename: The new image filename.  *  * Sets the specified image's filename.  *  * This procedure sets the specified image's filename. The filename  * should be in the filesystem encoding.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_set_filename (gint32 image_ID,const gchar * filename)
...
begin_comment
comment|/**  * _gimp_image_get_uri: (skip)  * @image_ID: The image.  *  * Returns the URI for the specified image.  *  * This procedure returns the URI associated with the specified image.  * The image has an URI only if it was loaded or imported from a file  * or has since been saved or exported. Otherwise, this function  * returns %NULL. See also gimp-image-get-imported-uri to get the URI  * of the current file if it was imported from a non-GIMP file format  * and not yet saved, or gimp-image-get-exported-uri if the image has  * been exported to a non-GIMP file format.  *  * Returns: The URI.  *          The returned value must be freed with g_free().  *  * Since: 2.8  **/
end_comment

begin_function
name|gchar
modifier|*
DECL|function|_gimp_image_get_uri (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_xcf_uri: (skip)  * @image_ID: The image.  *  * Returns the XCF URI for the specified image.  *  * This procedure returns the XCF URI associated with the image. If  * there is no such URI, this procedure returns %NULL.  *  * Returns: The imported URI.  *          The returned value must be freed with g_free().  *  * Since: 2.8  **/
end_comment

begin_function
name|gchar
modifier|*
DECL|function|_gimp_image_get_xcf_uri (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_exported_uri: (skip)  * @image_ID: The image.  *  * Returns the exported URI for the specified image.  *  * This procedure returns the URI associated with the specified image  * if the image was exported a non-native GIMP format. If the image was  * not exported, this procedure returns %NULL.  *  * Returns: The exported URI.  *          The returned value must be freed with g_free().  *  * Since: 2.8  **/
end_comment

begin_function
name|gchar
modifier|*
DECL|function|_gimp_image_get_exported_uri (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_name: (skip)  * @image_ID: The image.  *  * Returns the specified image's name.  *  * This procedure returns the image's name. If the image has a filename  * or an URI, then the returned name contains the filename's or URI's  * base name (the last component of the path). Otherwise it is the  * translated string \"Untitled\". The returned name is formatted like  * the image name in the image window title, it may contain '[]',  * '(imported)' etc. and should only be used to label user interface  * elements. Never use it to construct filenames.  *  * Returns: The name.  *          The returned value must be freed with g_free().  **/
end_comment

begin_function
name|gchar
modifier|*
DECL|function|_gimp_image_get_name (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_get_resolution: (skip)  * @image_ID: The image.  * @xresolution: (out): The resolution in the x-axis, in dots per inch.  * @yresolution: (out): The resolution in the y-axis, in dots per inch.  *  * Returns the specified image's resolution.  *  * This procedure returns the specified image's resolution in dots per  * inch. This value is independent of any of the layers in this image.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_get_resolution (gint32 image_ID,gdouble * xresolution,gdouble * yresolution)
...
begin_comment
comment|/**  * _gimp_image_set_resolution: (skip)  * @image_ID: The image.  * @xresolution: The new image resolution in the x-axis, in dots per inch.  * @yresolution: The new image resolution in the y-axis, in dots per inch.  *  * Sets the specified image's resolution.  *  * This procedure sets the specified image's resolution in dots per  * inch. This value is independent of any of the layers in this image.  * No scaling or resizing is performed.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_set_resolution (gint32 image_ID,gdouble xresolution,gdouble yresolution)
...
begin_comment
comment|/**  * _gimp_image_get_unit: (skip)  * @image_ID: The image.  *  * Returns the specified image's unit.  *  * This procedure returns the specified image's unit. This value is  * independent of any of the layers in this image. See the  * gimp_unit_*() procedure definitions for the valid range of unit IDs  * and a description of the unit system.  *  * Returns: The unit.  **/
end_comment

begin_function
name|GimpUnit
DECL|function|_gimp_image_get_unit (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_set_unit: (skip)  * @image_ID: The image.  * @unit: The new image unit.  *  * Sets the specified image's unit.  *  * This procedure sets the specified image's unit. No scaling or  * resizing is performed. This value is independent of any of the  * layers in this image. See the gimp_unit_*() procedure definitions  * for the valid range of unit IDs and a description of the unit  * system.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_set_unit (gint32 image_ID,GimpUnit unit)
...
begin_comment
comment|/**  * _gimp_image_get_tattoo_state: (skip)  * @image_ID: The image.  *  * Returns the tattoo state associated with the image.  *  * This procedure returns the tattoo state of the image. Use only by  * save/load plug-ins that wish to preserve an images tattoo state.  * Using this function at other times will produce unexpected results.  *  * Returns: The tattoo state.  **/
end_comment

begin_function
name|guint
DECL|function|_gimp_image_get_tattoo_state (gint32 image_ID)
...
begin_comment
comment|/**  * _gimp_image_set_tattoo_state: (skip)  * @image_ID: The image.  * @tattoo_state: The new image tattoo state.  *  * Set the tattoo state associated with the image.  *  * This procedure sets the tattoo state of the image. Use only by  * save/load plug-ins that wish to preserve an images tattoo state.  * Using this function at other times will produce unexpected results.  * A full check of uniqueness of states in layers, channels and paths  * will be performed by this procedure and a execution failure will be  * returned if this fails. A failure will also be returned if the new  * tattoo state value is less than the maximum tattoo value from all of  * the tattoos from the paths, layers and channels. After the image  * data has been loaded and all the tattoos have been set then this is  * the last procedure that should be called. If effectively does a  * status check on the tattoo values that have been set to make sure  * that all is OK.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_set_tattoo_state (gint32 image_ID,guint tattoo_state)
...
begin_comment
comment|/**  * _gimp_image_get_layer_by_tattoo: (skip)  * @image_ID: The image.  * @tattoo: The tattoo of the layer to find.  *  * Find a layer with a given tattoo in an image.  *  * This procedure returns the layer with the given tattoo in the  * specified image.  *  * Returns: The layer with the specified tattoo.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_layer_by_tattoo (gint32 image_ID,guint tattoo)
...
begin_comment
comment|/**  * _gimp_image_get_channel_by_tattoo: (skip)  * @image_ID: The image.  * @tattoo: The tattoo of the channel to find.  *  * Find a channel with a given tattoo in an image.  *  * This procedure returns the channel with the given tattoo in the  * specified image.  *  * Returns: The channel with the specified tattoo.  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_channel_by_tattoo (gint32 image_ID,guint tattoo)
...
begin_comment
comment|/**  * _gimp_image_get_vectors_by_tattoo: (skip)  * @image_ID: The image.  * @tattoo: The tattoo of the vectors to find.  *  * Find a vectors with a given tattoo in an image.  *  * This procedure returns the vectors with the given tattoo in the  * specified image.  *  * Returns: The vectors with the specified tattoo.  *  * Since: 2.6  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_vectors_by_tattoo (gint32 image_ID,guint tattoo)
...
begin_comment
comment|/**  * _gimp_image_get_layer_by_name: (skip)  * @image_ID: The image.  * @name: The name of the layer to find.  *  * Find a layer with a given name in an image.  *  * This procedure returns the layer with the given name in the  * specified image.  *  * Returns: The layer with the specified name.  *  * Since: 2.8  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_layer_by_name (gint32 image_ID,const gchar * name)
...
begin_comment
comment|/**  * _gimp_image_get_channel_by_name: (skip)  * @image_ID: The image.  * @name: The name of the channel to find.  *  * Find a channel with a given name in an image.  *  * This procedure returns the channel with the given name in the  * specified image.  *  * Returns: The channel with the specified name.  *  * Since: 2.8  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_channel_by_name (gint32 image_ID,const gchar * name)
...
begin_comment
comment|/**  * _gimp_image_get_vectors_by_name: (skip)  * @image_ID: The image.  * @name: The name of the vectors to find.  *  * Find a vectors with a given name in an image.  *  * This procedure returns the vectors with the given name in the  * specified image.  *  * Returns: The vectors with the specified name.  *  * Since: 2.8  **/
end_comment

begin_function
name|gint32
DECL|function|_gimp_image_get_vectors_by_name (gint32 image_ID,const gchar * name)
...
begin_comment
comment|/**  * _gimp_image_attach_parasite: (skip)  * @image_ID: The image.  * @parasite: The parasite to attach to an image.  *  * Add a parasite to an image.  *  * This procedure attaches a parasite to an image. It has no return  * values.  *  * Returns: TRUE on success.  *  * Since: 2.8  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_attach_parasite (gint32 image_ID,const GimpParasite * parasite)
...
begin_comment
comment|/**  * _gimp_image_detach_parasite: (skip)  * @image_ID: The image.  * @name: The name of the parasite to detach from an image.  *  * Removes a parasite from an image.  *  * This procedure detaches a parasite from an image. It has no return  * values.  *  * Returns: TRUE on success.  *  * Since: 2.8  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_detach_parasite (gint32 image_ID,const gchar * name)
...
begin_comment
comment|/**  * _gimp_image_get_parasite: (skip)  * @image_ID: The image.  * @name: The name of the parasite to find.  *  * Look up a parasite in an image  *  * Finds and returns the parasite that was previously attached to an  * image.  *  * Returns: The found parasite.  *  * Since: 2.8  **/
end_comment

begin_function
name|GimpParasite
modifier|*
DECL|function|_gimp_image_get_parasite (gint32 image_ID,const gchar * name)
...
modifier|*
modifier|*
DECL|function|_gimp_image_get_parasite_list (gint32 image_ID,gint * num_parasites)
