...
begin_comment
comment|/**  * gimp_image_raise_vectors_to_top:  * @image_ID: The image.  * @vectors_ID: The vectors object to raise to top.  *  * Raise the specified vectors in the image's vectors stack to top of  * stack  *  * This procedure raises the specified vectors to top of the existing  * vectors stack. It will not move the vectors if there is no vectors  * above it.  *  * Returns: TRUE on success.  *  * Since: GIMP 2.4  */
end_comment
...
begin_comment
comment|/**  * gimp_image_lower_vectors_to_bottom:  * @image_ID: The image.  * @vectors_ID: The vectors object to lower to bottom.  *  * Lower the specified vectors in the image's vectors stack to bottom  * of stack  *  * This procedure lowers the specified vectors to bottom of the  * existing vectors stack. It will not move the vectors if there is no  * vectors below it.  *  * Returns: TRUE on success.  *  * Since: GIMP 2.4  */
end_comment
...
begin_comment
comment|/**  * gimp_image_add_vectors:  * @image_ID: The image.  * @vectors_ID: The vectors object.  * @position: The vectors objects position.  *  * Add the specified vectors object to the image.  *  * This procedure adds the specified vectors object to the gimage at  * the given position. If the position is specified as -1, then the  * vectors object is inserted at the top of the vectors stack.  *  * Returns: TRUE on success.  */
end_comment
