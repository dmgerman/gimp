...
begin_comment
comment|/**  * gimp_image_list:  * @num_images: The number of images currently open.  *  * Returns the list of images currently open.  *  * This procedure returns the list of images currently open in GIMP.  *  * Returns: (transfer full) The list of images currently open. The  * returned value must be freed with g_free().  **/
end_comment
...
begin_comment
comment|/**  * gimp_image_get_vectors:  * @image_ID: The image.  * @num_vectors: The number of vectors contained in the image.  *  * Returns the list of vectors contained in the specified image.  *  * This procedure returns the list of vectors contained in the  * specified image.  *  * Returns: (transfer full) The list of vectors contained in the image.  * The returned value must be freed with g_free().  *  * Since: 2.4  **/
end_comment
...
begin_comment
comment|/**  * _gimp_image_get_colormap:  * @image_ID: The image.  * @num_bytes: Number of bytes in the colormap array.  *  * Returns the image's colormap  *  * This procedure returns an actual pointer to the image's colormap, as  * well as the number of bytes contained in the colormap. The actual  * number of colors in the transmitted colormap will be 'num-bytes' /  * 3. If the image is not in Indexed color mode, no colormap is  * returned.  *  * Returns: (transfer full) The image's colormap. The returned value  * must be freed with g_free().  **/
end_comment
...
begin_comment
comment|/**  * _gimp_image_get_metadata:  * @image_ID: The image.  *  * Returns the image's metadata.  *  * Returns exif/iptc/xmp metadata from the image.  *  * Returns: (transfer full) The exif/ptc/xmp metadata as a string.  **/
end_comment
...
begin_comment
comment|/**  * _gimp_image_thumbnail:  * @image_ID: The image.  * @width: The requested thumbnail width.  * @height: The requested thumbnail height.  * @actual_width: The previews width.  * @actual_height: The previews height.  * @bpp: The previews bpp.  * @thumbnail_data_count: The number of bytes in thumbnail data.  * @thumbnail_data: (transfer full) The thumbnail data.  *  * Get a thumbnail of an image.  *  * This function gets data from which a thumbnail of an image preview  * can be created. Maximum x or y dimension is 1024 pixels. The pixels  * are returned in RGB[A] or GRAY[A] format. The bpp return value gives  * the number of bits per pixel in the image.  *  * Returns: TRUE on success.  **/
end_comment
...
begin_comment
comment|/**  * gimp_image_get_parasite_list:  * @image_ID: The image.  * @num_parasites: The number of attached parasites.  *  * List all parasites.  *  * Returns a list of all currently attached parasites.  *  * Returns: (transfer full) The names of currently attached parasites.  * The returned value must be freed with g_strfreev().  *  * Since: 2.8  **/
end_comment
