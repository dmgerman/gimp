...
name|args
decl_stmt|;
DECL|member|n_aux_args
name|gint32
name|n_aux_args
decl_stmt|;
DECL|member|aux_args
name|GParamSpec
modifier|*
modifier|*
name|aux_args
...
modifier|*
name|gimp_procedure_real_create_config
parameter_list|(
name|GimpProcedure
modifier|*
name|procedure
...
specifier|static
name|void
DECL|function|gimp_procedure_install_icon (GimpProcedure * procedure)
name|gimp_procedure_install_icon
parameter_list|(
name|GimpProcedure
modifier|*
name|procedure
...
name|GimpProcedureConfig
modifier|*
DECL|function|gimp_procedure_real_create_config (GimpProcedure * procedure,GParamSpec ** args,gint n_args)
name|gimp_procedure_real_create_config
parameter_list|(
name|GimpProcedure
modifier|*
...
name|g_warning
argument_list|(
literal|"Argument with name '%s' already exists on procedure '%s'"
argument_list|,
name|pspec
operator|->
name|name
...
name|g_warning
argument_list|(
literal|"Auxiliary argument with name '%s' already exists "
literal|"on procedure '%s'"
argument_list|,
name|pspec
operator|->
name|name
...
begin_comment
comment|/**  * gimp_procedure_add_argument_from_property:  * @procedure: the #GimpProcedure.  * @config:    a #GObject.  * @prop_name: property name in @config.  *  * Add a new argument to @procedure according to the specifications of  * the property @prop_name registered on @config.  *  * See gimp_procedure_add_argument() for details.  *  * Since: 3.0  */
end_comment
...
begin_comment
comment|/**  * gimp_procedure_add_aux_argument:  * @procedure: the #GimpProcedure.  * @pspec:     (transfer full): the argument specification.  *  * Add a new auxiliary argument to @procedure according to @pspec  * specifications.  *  * Auxiliary arguments are not passed to the @procedure in run() and  * are not known to the PDB. They are however members of the  * #GimpProcedureConfig created by gimp_procedure_create_config() and  * can be used to persistently store whatever last used values the  * @procedure wants to remember across invocations  *  * Since: 3.0  **/
end_comment

begin_function
name|void
DECL|function|gimp_procedure_add_aux_argument (GimpProcedure * procedure,GParamSpec * pspec)
...
begin_comment
comment|/**  * gimp_procedure_add_aux_argument_from_property:  * @procedure: the #GimpProcedure.  * @config:    a #GObject.  * @prop_name: property name in @config.  *  * Add a new auxiliary argument to @procedure according to the  * specifications of the property @prop_name registered on @config.  *  * See gimp_procedure_add_aux_argument() for details.  *  * Since: 3.0  */
end_comment

begin_function
name|void
DECL|function|gimp_procedure_add_aux_argument_from_property (GimpProcedure * procedure,GObject * config,const gchar * prop_name)
...
name|g_warning
argument_list|(
literal|"Return value with name '%s' already exists on procedure '%s'"
argument_list|,
name|pspec
operator|->
name|name
...
begin_comment
comment|/**  * gimp_procedure_find_argument:  * @procedure: A #GimpProcedure  * @name:      An argument name  *  * Searches the @procedure's arguments for a #GParamSpec called @name.  *  * Returns: (transfer none): The @procedure's argument with @name if it  *          exists, or %NULL otherwise.  *  * Since: 3.0  **/
end_comment

begin_function
name|GParamSpec
modifier|*
DECL|function|gimp_procedure_find_argument (GimpProcedure * procedure,const gchar * name)
name|gimp_procedure_find_argument
parameter_list|(
name|GimpProcedure
modifier|*
...
begin_comment
comment|/**  * gimp_procedure_find_aux_argument:  * @procedure: A #GimpProcedure  * @name:      An auxiliary argument name  *  * Searches the @procedure's auxiliary arguments for a #GParamSpec  * called @name.  *  * Returns: (transfer none): The @procedure's auxiliary argument with  *          @name if it exists, or %NULL otherwise.  *  * Since: 3.0  **/
end_comment

begin_function
name|GParamSpec
modifier|*
DECL|function|gimp_procedure_find_aux_argument (GimpProcedure * procedure,const gchar * name)
name|gimp_procedure_find_aux_argument
parameter_list|(
name|GimpProcedure
modifier|*
...
begin_comment
comment|/**  * gimp_procedure_find_return_value:  * @procedure: A #GimpProcedure  * @name:      A return value name  *  * Searches the @procedure's return values for a #GParamSpec called  * @name.  *  * Returns: (transfer none): The @procedure's return values with @name  *          if it exists, or %NULL otherwise.  *  * Since: 3.0  **/
end_comment

begin_function
name|GParamSpec
modifier|*
DECL|function|gimp_procedure_find_return_value (GimpProcedure * procedure,const gchar * name)
name|gimp_procedure_find_return_value
parameter_list|(
name|GimpProcedure
modifier|*
...
begin_comment
comment|/**  * gimp_procedure_get_aux_arguments:  * @procedure:   A #GimpProcedure.  * @n_arguments: (out): Returns the number of auxiliary arguments.  *  * Returns: (transfer none) (array length=n_arguments): An array  *          of @GParamSpec in the order added with  *          gimp_procedure_add_aux_argument().  *  * Since: 3.0  **/
end_comment
...
modifier|*
modifier|*
DECL|function|gimp_procedure_get_aux_arguments (GimpProcedure * procedure,gint * n_arguments)
...
name|complete
decl_stmt|;
comment|/*  if saved defaults exist, they override GParamSpec  */
name|config
operator|=
...
begin_comment
comment|/**  * gimp_procedure_create_config:  * @procedure: A #GimpProcedure  *  * Create a #GimpConfig with properties that match @procedure's arguments.  *  * Returns: (transfer full): The new #GimpConfig.  *  * Since: 3.0  **/
end_comment

begin_function
name|GimpProcedureConfig
modifier|*
DECL|function|gimp_procedure_create_config (GimpProcedure * procedure)
name|gimp_procedure_create_config
parameter_list|(
name|GimpProcedure
modifier|*
...
name|GimpDisplay
modifier|*
DECL|function|_gimp_procedure_get_display (GimpProcedure * procedure,gint32 display_id)
...
name|GimpImage
modifier|*
DECL|function|_gimp_procedure_get_image (GimpProcedure * procedure,gint32 image_id)
...
name|GimpItem
modifier|*
DECL|function|_gimp_procedure_get_item (GimpProcedure * procedure,gint32 item_id)
...
begin_function
name|void
DECL|function|_gimp_procedure_destroy_proxies (GimpProcedure * procedure)
name|_gimp_procedure_destroy_proxies
parameter_list|(
name|GimpProcedure
modifier|*
