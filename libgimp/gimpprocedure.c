...
begin_comment
comment|/**  * gimp_procedure_add_aux_argument_from_property:  * @procedure: the #GimpProcedure.  * @config:    a #GObject.  * @prop_name: property name in @config.  *  * Add a new auxiliaty argument to @procedure according to the  * specifications of the property @prop_name registered on @config.  *  * See gimp_procedure_add_aux_argument() for details.  *  * Since: 3.0  */
end_comment
