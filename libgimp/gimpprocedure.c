...
begin_comment
comment|/**  * gimp_procedure_set_icon: (skip)  * @procedure: a #GimpProcedure.  * @icon_type: the #GimpIconType of @icon_data.  * @icon_data: icon representation.  *  * Sets the icon for @procedure. @icon_data contents type depends on  * @icon_type.  *  * This procedure is skipped from bindings, where you should use  * specific gimp_procedure_set_icon_*() instead, such as  * gimp_procedure_set_icon_name().  */
end_comment
...
begin_comment
comment|/**  * gimp_procedure_set_icon_name:  * @procedure: a #GimpProcedure.  * @icon_name: an icon name.  *  * Sets the icon for @procedure by its name.  */
end_comment
...
begin_comment
comment|/**  * gimp_procedure_set_icon_file:  * @procedure: a #GimpProcedure.  * @icon_path: a file path for an image.  *  * Sets the icon for @procedure by specifying an image file path in a  * format supported by GdkPixbuf. @icon_path must be in in the GLib file  * name encoding.  */
end_comment

begin_function
name|void
DECL|function|gimp_procedure_set_icon_file (GimpProcedure * procedure,const gchar * icon_path)
...
begin_comment
comment|/**  * gimp_procedure_set_icon_inline:  * @procedure: a #GimpProcedure.  * @icon_data: inline pixel data for the icon image.  *  * Sets the icon for @procedure by specifying inline pixel data. The  * data must be serialized in the format supported by  * gdk_pixbuf_new_from_inline(), e.g. as generated by the tool  * [gdk-pixbuf-csource](https://developer.gnome.org/gdk-pixbuf/stable/gdk-pixbuf-csource.html).  */
end_comment

begin_function
name|void
DECL|function|gimp_procedure_set_icon_inline (GimpProcedure * procedure,const guint8 * icon_data)
...
begin_comment
comment|/**  * gimp_procedure_get_icon: (skip)  * @procedure:        a #GimpProcedure.  * @icon_data:        icon representation.  * @icon_data_length: length of @icon_data.  *  * Gets the icon for @procedure. @icon_data contents type depends on  * the returned type.  *  * This procedure is skipped from bindings, where you should use  * specific gimp_procedure_get_icon_type() instead, followed by the  * relevant specific function, such as gimp_procedure_get_icon_name().  *  * Returns: the #GimpIconType of @icon_data.  */
end_comment
...
begin_comment
comment|/**  * gimp_procedure_get_icon_type:  * @procedure: a #GimpProcedure.  *  * Gets the type of data set as @procedure's icon.  * Depending on the result, you can call the relevant specific function,  * such as gimp_procedure_get_icon_name().  *  * Returns: the #GimpIconType of @icon_data.  */
end_comment
...
begin_comment
comment|/**  * gimp_procedure_get_icon_name:  * @procedure: a #GimpProcedure.  *  * Gets the name of the icon if one was set for @procedure.  *  * Returns: (nullable): the icon name or %NULL if no icon name was set.  */
end_comment
...
begin_comment
comment|/**  * gimp_procedure_get_icon_file:  * @procedure: a #GimpProcedure.  *  * Gets the file path of the icon if one was set for @procedure.  *  * Returns: (nullable): the icon file path or %NULL if no file was set.  */
end_comment
...
begin_comment
comment|/**  * gimp_procedure_get_icon_inline:  * @procedure: a #GimpProcedure.  * @icon_data_length: length of @icon_data.  *  * Gets the pixel data of the icon if an icon was set this way for  * @procedure. See gimp_procedure_set_icon_file() for information on the  * format of returned data.  *  * Returns: (nullable) (array length=icon_data_length):             the icon byte data or %NULL if no icon name was set.  */
end_comment
...
name|guint8
modifier|*
DECL|function|gimp_procedure_get_icon_inline (GimpProcedure * procedure,gint * icon_data_length)
