...
begin_comment
comment|/**  * gimp_procedure_get_blurb:  * @procedure: A #GimpProcedure.  *  * Returns: The procedure's blurb given in gimp_procedure_set_help().  *  * Since: 3.0  **/
end_comment
...
begin_comment
comment|/**  * gimp_procedure_get_help:  * @procedure: A #GimpProcedure.  *  * Returns: The procedure's help text given in  *          gimp_procedure_set_help().  *  * Since: 3.0  **/
end_comment
...
begin_comment
comment|/**  * gimp_procedure_get_help_id:  * @procedure: A #GimpProcedure.  *  * Returns: The procedure's help ID given in  *          gimp_procedure_set_help().  *  * Since: 3.0  **/
end_comment
