...
condition|)
block|{
comment|/* set the digits of the reference value to 0 if the refval            * is pixels, to 2 otherwise 	   */
name|int
name|refval_digits
init|=
operator|(
...
block|}
block|}
comment|/* don't show 'pixels' if not appropriate */
if|if
condition|(
name|update_policy
operator|!=
