...
specifier|static
name|int
name|gimp_size_entry_focus_in_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_comment
comment|/*  this one highlights the spinbutton's contents  */
end_comment

begin_function
specifier|static
name|int
DECL|function|gimp_size_entry_focus_in_callback (GtkWidget * widget,GdkEvent * event,gpointer data)
name|gimp_size_entry_focus_in_callback
parameter_list|(
name|GtkWidget
modifier|*
...
parameter_list|)
block|{
comment|/* gtk_editable_select_region (GTK_EDITABLE (widget), 0, -1); */
return|return
name|TRUE
return|;
block|}
