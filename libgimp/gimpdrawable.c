...
begin_comment
comment|/**  * gimp_drawable_get_thumbnail_deprecated: (skip)  * @drawable_ID: the drawable ID  * @width:       the requested thumbnail width  (<= 1024 pixels)  * @height:      the requested thumbnail height (<= 1024 pixels)  * @alpha:       how to handle an alpha channel  *  * Retrieves a thumbnail pixbuf for the drawable identified by  * @drawable_ID. The thumbnail will be not larger than the requested  * size.  *  * Returns: (transfer full) (nullable): a new #GdkPixbuf or %NULL if  *          @drawable_ID is invalid.  *  * Since: 2.2  **/
end_comment

begin_function
name|GdkPixbuf
modifier|*
DECL|function|gimp_drawable_get_thumbnail_deprecated (gint32 drawable_ID,gint width,gint height,GimpPixbufTransparency alpha)
name|gimp_drawable_get_thumbnail_deprecated
parameter_list|(
name|gint32
name|drawable_ID
parameter_list|,
...
name|guchar
modifier|*
DECL|function|gimp_drawable_get_sub_thumbnail_data_deprecated (gint32 drawable_ID,gint src_x,gint src_y,gint src_width,gint src_height,gint * dest_width,gint * dest_height,gint * bpp)
name|gimp_drawable_get_sub_thumbnail_data_deprecated
parameter_list|(
name|gint32
name|drawable_ID
parameter_list|,
...
begin_comment
comment|/**  * gimp_drawable_get_sub_thumbnail_deprecated: (skip)  * @drawable_ID: the drawable ID  * @src_x:       the x coordinate of the area  * @src_y:       the y coordinate of the area  * @src_width:   the width of the area  * @src_height:  the height of the area  * @dest_width:  the requested thumbnail width  (<= 1024 pixels)  * @dest_height: the requested thumbnail height (<= 1024 pixels)  * @alpha:       how to handle an alpha channel  *  * Retrieves a thumbnail pixbuf for the drawable identified by  * @drawable_ID. The thumbnail will be not larger than the requested  * size.  *  * Returns: (transfer full): a new #GdkPixbuf  *  * Since: 2.2  **/
end_comment

begin_function
name|GdkPixbuf
modifier|*
DECL|function|gimp_drawable_get_sub_thumbnail_deprecated (gint32 drawable_ID,gint src_x,gint src_y,gint src_width,gint src_height,gint dest_width,gint dest_height,GimpPixbufTransparency alpha)
name|gimp_drawable_get_sub_thumbnail_deprecated
parameter_list|(
name|gint32
name|drawable_ID
parameter_list|,
...
name|GeglBuffer
modifier|*
DECL|function|gimp_drawable_get_buffer_deprecated (gint32 drawable_ID)
...
begin_comment
comment|/**  * gimp_drawable_get_thumbnail_format_deprecated: (skip)  * @drawable_ID: the ID of the #GimpDrawable to get the thumbnail format for.  *  * Returns the #Babl thumbnail format of the drawable.  *  * Returns: The #Babl thumbnail format.  *  * Since: 2.10.14  */
end_comment
...
name|Babl
modifier|*
DECL|function|gimp_drawable_get_thumbnail_format_deprecated (gint32 drawable_ID)
name|gimp_drawable_get_thumbnail_format_deprecated
parameter_list|(
name|gint32
name|drawable_ID
parameter_list|)
