...
begin_comment
comment|/**  * gimp_image_metadata_load_thumbnail:  * @file:  A #GFile image  * @error: Return location for error message  *  * Retrieves a thumbnail from metadata if present.  *  * Returns: (transfer none) (nullable): a #GimpImage of the @file thumbnail.  */
end_comment
...
begin_comment
comment|/**  * gimp_image_metadata_load_prepare_deprecated: (skip)  * @image_id:  The image  * @mime_type: The loaded file's mime-type  * @file:      The file to load the metadata from  * @error:     Return location for error  *  * Loads and returns metadata from @file to be passed into  * gimp_image_metadata_load_finish().  *  * Returns: (transfer full): The file's metadata.  *  * Since: 2.10  */
end_comment

begin_function
name|GimpMetadata
modifier|*
DECL|function|gimp_image_metadata_load_prepare_deprecated (gint32 image_id,const gchar * mime_type,GFile * file,GError ** error)
...
begin_comment
comment|/**  * gimp_image_metadata_load_finish_deprecated: (skip)  * @image_id:    The image  * @mime_type:   The loaded file's mime-type  * @metadata:    The metadata to set on the image  * @flags:       Flags to specify what of the metadata to apply to the image  * @interactive: Whether this function is allowed to query info with dialogs  *  * Applies the @metadata previously loaded with  * gimp_image_metadata_load_prepare()_deprecated to the image, taking into account  * the passed @flags.  *  * Since: 2.10  */
end_comment

begin_function
name|void
DECL|function|gimp_image_metadata_load_finish_deprecated (gint32 image_id,const gchar * mime_type,GimpMetadata * metadata,GimpMetadataLoadFlags flags,gboolean interactive)
...
begin_comment
comment|/**  * gimp_image_metadata_save_prepare_deprecated: (skip)  * @image_id:        The image  * @mime_type:       The saved file's mime-type  * @suggested_flags: Suggested default values for the @flags passed to  *                   gimp_image_metadata_save_finish()  *  * Gets the image metadata for saving it using  * gimp_image_metadata_save_finish().  *  * The @suggested_flags are determined from what kind of metadata  * (Exif, XMP, ...) is actually present in the image and the preferences  * for metadata exporting.  * The calling application may still update @available_flags, for  * instance to follow the settings from a previous export in the same  * session, or a previous export of the same image. But it should not  * override the preferences without a good reason since it is a data  * leak.  *  * The suggested value for GIMP_METADATA_SAVE_THUMBNAIL is determined by  * whether there was a thumbnail in the previously imported image.  *  * Returns: (transfer full): The image's metadata, prepared for saving.  *  * Since: 2.10  */
end_comment

begin_function
name|GimpMetadata
modifier|*
DECL|function|gimp_image_metadata_save_prepare_deprecated (gint32 image_id,const gchar * mime_type,GimpMetadataSaveFlags * suggested_flags)
...
begin_comment
comment|/**  * gimp_image_metadata_save_finish_deprecated: (skip)  * @image_id:  The image  * @mime_type: The saved file's mime-type  * @metadata:  The metadata to set on the image  * @flags:     Flags to specify what of the metadata to save  * @file:      The file to load the metadata from  * @error:     Return location for error message  *  * Saves the @metadata retrieved from the image with  * gimp_image_metadata_save_prepare()_deprecated to @file, taking into account  * the passed @flags.  *  * Returns: Whether the save was successful.  *  * Since: 2.10  */
end_comment

begin_function
name|gboolean
DECL|function|gimp_image_metadata_save_finish_deprecated (gint32 image_id,const gchar * mime_type,GimpMetadata * metadata,GimpMetadataSaveFlags flags,GFile * file,GError ** error)
...
begin_comment
comment|/**  * gimp_image_metadata_load_thumbnail_deprecated: (skip)  * @file:  A #GFile image  * @error: Return location for error message  *  * Retrieves a thumbnail from metadata if present.  *  * Returns: an image id of the @file thumbnail.  */
end_comment

begin_function
name|gint32
DECL|function|gimp_image_metadata_load_thumbnail_deprecated (GFile * file,GError ** error)
