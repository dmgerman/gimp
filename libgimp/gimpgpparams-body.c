...
name|GimpValueArray
modifier|*
DECL|function|_gimp_gp_params_to_value_array (GParamSpec ** pspecs,gint n_pspecs,GPParam * params,gint n_params,gboolean return_values,gboolean full_copy)
