...
specifier|static
name|void
DECL|function|gimp_gp_param_to_value (gpointer gimp,const GPParam * param,GType type,GValue * value)
...
name|GimpValueArray
modifier|*
DECL|function|_gimp_gp_params_to_value_array (gpointer gimp,GParamSpec ** pspecs,gint n_pspecs,const GPParam * params,gint n_params,gboolean return_values)
...
name|length
expr_stmt|;
comment|/* must be free'd also for full_copy == FALSE */
name|param
operator|->
name|data
operator|.
...
begin_function
name|void
DECL|function|_gimp_gp_params_free (GPParam * params,gint n_params,gboolean full_copy)
