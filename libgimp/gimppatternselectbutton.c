...
name|obj
parameter_list|)
value|(((GimpPatternSelectButtonPrivate *) (obj))->priv)
end_define
...
name|priv
operator|=
name|gimp_pattern_select_button_get_instance_private
argument_list|(
name|button
argument_list|)
expr_stmt|;
