...
specifier|static
name|void
name|gimp_chain_button_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
argument_list|)
expr_stmt|;
comment|/* That's all we do here, since setting the pixmaps won't work before       the parent window is realized.      We connect to the realized-signal instead and do the rest there. */
name|gtk_signal_connect
argument_list|(
name|GTK_OBJECT
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_chain_button_realize (GtkWidget * widget,GimpChainButton * gcb)
name|gimp_chain_button_realize
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_chain_button_callback (GtkWidget * widget,GimpChainButton * gcb)
name|gimp_chain_button_callback
parameter_list|(
name|GtkWidget
modifier|*
