...
ifndef|#
directive|ifndef
name|__GIMP_GRAIDENT_MENU_H__
end_ifndef

begin_define
DECL|macro|__GIMP_GRADIENT_MENU_H__
define|#
directive|define
name|__GIMP_GRADIENT_MENU_H__
end_define
...
name|GIMP_DEPRECATED_FOR
argument_list|(
argument|gimp_gradient_select_button_set_gradient
argument_list|)
end_macro
...
begin_comment
comment|/* __GIMP_GRADIENT_MENU_H__ */
end_comment
