...
name|gchar
modifier|*
DECL|function|gimp_gradients_new (const gchar * name)
name|gimp_gradients_new
parameter_list|(
specifier|const
name|gchar
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_gradients_duplicate (const gchar * name)
name|gimp_gradients_duplicate
parameter_list|(
specifier|const
name|gchar
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_gradients_delete (const gchar * name)
name|gimp_gradients_delete
parameter_list|(
specifier|const
name|gchar
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_gradients_rename (const gchar * name,const gchar * new_name)
name|gimp_gradients_rename
parameter_list|(
specifier|const
name|gchar
modifier|*
