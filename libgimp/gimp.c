...
begin_decl_stmt
DECL|variable|_gimp_temp_proc_ht
name|GHashTable
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|gimp_run_procedure_with_array (const gchar * name,GimpValueArray * arguments)
...
specifier|static
name|void
DECL|function|gimp_proc_run_internal (GPProcRun * proc_run,GimpProcedure * procedure,GimpRunProc run_proc,GPProcReturn * proc_return)
name|gimp_proc_run_internal
parameter_list|(
name|GPProcRun
modifier|*
