...
begin_comment
comment|/**  * gimp_parasite_find:  * @name: The name of the parasite to find.  *  * Deprecated: Use gimp_get_parasite() instead.  *  * Returns: The found parasite.  **/
end_comment
...
begin_comment
comment|/**  * gimp_parasite_attach:  * @parasite: The parasite to attach.  *  * Deprecated: Use gimp_attach_parasite() instead.  *  * Returns: TRUE on success.  **/
end_comment
...
begin_comment
comment|/**  * gimp_parasite_detach:  * @name: The name of the parasite to detach.  *  * Deprecated: Use gimp_detach_parasite() instead.  *  * Returns: TRUE on success.  **/
end_comment
...
begin_comment
comment|/**  * gimp_parasite_list:  * @num_parasites: The number of attached parasites.  * @parasites: The names of currently attached parasites.  *  * Deprecated: Use gimp_get_parasite_list() instead.  *  * Returns: TRUE on success.  **/
end_comment
...
begin_comment
comment|/**  * gimp_attach_new_parasite:  * @name: the name of the #GimpParasite to create and attach.  * @flags: the flags set on the #GimpParasite.  * @size: the size of the parasite data in bytes.  * @data: a pointer to the data attached with the #GimpParasite.  *  * Convenience function that creates a parasite and attaches it  * to GIMP.  *  * Deprecated: Use gimp_attach_parasite() instead.  *  * Return value: TRUE on successful creation and attachment of  * the new parasite.  *  * See Also: gimp_attach_parasite()  */
end_comment
