...
name|ARG_WRITE_FD
block|,
DECL|enumerator|ARG_PARENT_READ_FD
name|ARG_PARENT_READ_FD
block|,
DECL|enumerator|ARG_PARENT_WRITE_FD
name|ARG_PARENT_WRITE_FD
block|,
...
argument_list|)
expr_stmt|;
comment|/* Close parent end of pipes */
name|close
argument_list|(
name|atoi
argument_list|(
