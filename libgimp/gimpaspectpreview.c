...
typedef|typedef
struct|struct
DECL|struct|__anon2b3267f50208
block|{
DECL|member|update
name|gboolean
name|update
...
specifier|static
name|void
name|gimp_aspect_preview_style_updated
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_aspect_preview_style_updated (GtkWidget * widget)
name|gimp_aspect_preview_style_updated
parameter_list|(
name|GtkWidget
modifier|*
...
begin_comment
comment|/**  * gimp_aspect_preview_new_from_drawable:  * @drawable: (transfer none): a drawable  *  * Creates a new #GimpAspectPreview widget for @drawable_. See also  * gimp_drawable_preview_new_from_drawable().  *  * Since: 2.10  *  * Returns: a new #GimpAspectPreview.  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_aspect_preview_new_from_drawable (GimpDrawable * drawable)
