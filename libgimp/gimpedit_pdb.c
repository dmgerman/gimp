...
begin_comment
comment|/**  * gimp_edit_named_delete:  * @buffer_name: The buffer name.  *  * Deletes a named buffer.  *  * This procedure deletes a named buffer.  *  * Returns: TRUE on success.  *  * Since: GIMP 2.4  */
end_comment

begin_function
name|gboolean
DECL|function|gimp_edit_named_delete (const gchar * buffer_name)
...
begin_comment
comment|/**  * gimp_edit_named_rename:  * @buffer_name: The buffer name.  * @new_name: The buffer's new name.  *  * Renames a named buffer.  *  * This procedure renames a named buffer.  *  * Returns: The real name given to the buffer.  *  * Since: GIMP 2.4  */
end_comment

begin_function
name|gchar
modifier|*
DECL|function|gimp_edit_named_rename (const gchar * buffer_name,const gchar * new_name)
