...
directive|define
name|gimp_image_get_color_profile
value|gimp_image_get_color_profile_deprecated
end_define
...
directive|define
name|gimp_image_set_color_profile
value|gimp_image_set_color_profile_deprecated
end_define
...
directive|define
name|gimp_image_get_effective_color_profile
value|gimp_image_get_effective_color_profile_deprecated
end_define
...
directive|define
name|gimp_image_convert_color_profile
value|gimp_image_convert_color_profile_deprecated
end_define
...
name|GimpColorProfile
modifier|*
name|gimp_image_get_color_profile_deprecated
parameter_list|(
name|gint32
name|image_id
parameter_list|)
...
begin_function_decl
name|gboolean
name|gimp_image_set_color_profile_deprecated
parameter_list|(
name|gint32
name|image_id
parameter_list|,
...
name|GimpColorProfile
modifier|*
name|gimp_image_get_effective_color_profile_deprecated
parameter_list|(
name|gint32
name|image_id
parameter_list|)
...
begin_function_decl
name|gboolean
name|gimp_image_convert_color_profile_deprecated
parameter_list|(
name|gint32
name|image_id
parameter_list|,
