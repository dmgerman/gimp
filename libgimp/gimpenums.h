...
begin_decl_stmt
name|G_BEGIN_DECLS
comment|/**  * SECTION: gimpenums  * @title: gimpenums  * @short_description: Enums and definitions.  *  * Enums and definitions.  **/
