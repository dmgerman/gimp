...
begin_typedef
DECL|typedef|GimpProcedureReturn
typedef|typedef
name|void
function_decl|(
modifier|*
name|GimpProcedureReturn
function_decl|)
parameter_list|(
name|GimpParam
modifier|*
...
begin_function_decl
name|void
name|gimp_run_procedure2_async
parameter_list|(
specifier|const
name|gchar
modifier|*
