...
specifier|static
name|void
DECL|function|gimp_image_combo_box_model_add (GtkListStore * store,GList * images,GimpImageConstraintFunc constraint,GimpImageConstraintDeprecatedFunc constraint_d,gpointer data)
name|gimp_image_combo_box_model_add
parameter_list|(
name|GtkListStore
modifier|*
