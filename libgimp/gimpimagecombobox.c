...
specifier|static
name|void
name|gimp_image_combo_box_changed
parameter_list|(
name|GimpImageComboBox
modifier|*
name|combo_box
...
specifier|static
name|void
DECL|function|gimp_image_combo_box_populate (GimpImageComboBox * combo_box)
name|gimp_image_combo_box_populate
parameter_list|(
name|GimpImageComboBox
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_combo_box_model_add (GtkListStore * store,gint num_images,gint32 * images,GimpImageConstraintFunc constraint,GimpImageConstraintDeprecatedFunc constraint_d,gpointer data)
name|gimp_image_combo_box_model_add
parameter_list|(
name|GtkListStore
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_combo_box_changed (GimpImageComboBox * combo_box)
name|gimp_image_combo_box_changed
parameter_list|(
name|GimpImageComboBox
modifier|*
...
begin_comment
comment|/**  * gimp_image_combo_box_new_deprecated: (skip)  * @constraint:   a #GimpImageConstraintDeprecatedFunc or %NULL  * @data:         a pointer that is passed to @constraint  * @data_destroy: Destroy function for @data.  *  * Creates a new #GimpIntComboBox filled with all currently opened  * images. If a @constraint function is specified, it is called for  * each image and only if the function returns %TRUE, the image is  * added to the combobox.  *  * You should use gimp_int_combo_box_connect() to initialize and  * connect the combo. Use gimp_int_combo_box_set_active() to get the  * active image ID and gimp_int_combo_box_get_active() to retrieve the  * ID of the selected image.  *  * Returns: a new #GimpIntComboBox.  *  * Since: 2.2  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_image_combo_box_new_deprecated (GimpImageConstraintDeprecatedFunc constraint,gpointer data,GDestroyNotify data_destroy)
