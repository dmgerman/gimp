...
specifier|static
name|void
name|gimp_progress_bar_dispose
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
DECL|function|gimp_progress_bar_dispose (GObject * object)
name|gimp_progress_bar_dispose
parameter_list|(
name|GObject
modifier|*
...
begin_comment
comment|/**  * gimp_progress_bar_new:  *  * Creates a new #GimpProgressBar widget.  *  * Returns: the new widget.  *  * Since: 2.2  **/
end_comment
