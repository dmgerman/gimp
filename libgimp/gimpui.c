...
begin_comment
comment|/**  * gimp_ui_get_display_window:  * @gdisp_ID: a GimpDisplay ID.  *  * Returns the #GdkWindow of a display window. The purpose is to allow  * to make plug-in dialogs transient to the image display as explained  * with gdk_window_set_transient_for().  *  * You shouldn't have to call this function directly. Use  * gimp_window_set_transient_for_display() instead.  *  * Return value: (transfer full): A reference to a #GdkWindow or %NULL.  *               You should unref the window using g_object_unref() as  *               soon as you don't need it any longer.  *  * Since: 2.4  */
end_comment
...
begin_comment
comment|/**  * gimp_ui_get_progress_window:  *  * Returns the #GdkWindow of the window this plug-in's progress bar is  * shown in. Use it to make plug-in dialogs transient to this window  * as explained with gdk_window_set_transient_for().  *  * You shouldn't have to call this function directly. Use  * gimp_window_set_transient() instead.  *  * Return value: (transfer full): A reference to a #GdkWindow or %NULL.  *               You should unref the window using g_object_unref() as  *               soon as you don't need it any longer.  *  * Since: 2.4  */
end_comment
...
specifier|static
name|void
DECL|function|gimp_ui_theme_changed (GFileMonitor * monitor,GFile * file,GFile * other_file,GFileMonitorEvent event_type,GtkCssProvider * css_provider)
name|gimp_ui_theme_changed
parameter_list|(
name|GFileMonitor
modifier|*
