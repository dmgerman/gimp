...
begin_comment
comment|/**  * gimp_window_set_transient_for_default_display:  * @window: the #GtkWindow that should become transient  *  * Indicates to the window manager that @window is a transient dialog  * associated with the GIMP image window that the plug-in has been  * started from. See also gimp_window_set_transient_for_display().  *  * Since: GIMP 2.4  */
end_comment

begin_function
name|void
DECL|function|gimp_window_set_transient_for_default_display (GtkWindow * window)
