...
condition|(
operator|!
name|gtk_css_provider_load_from_path
argument_list|(
name|css_provider
argument_list|,
name|theme_css
...
directive|if
literal|0
comment|/* FIXME CSS: do we still need such code on gtk3? */
block|g_signal_connect (css_monitor, "changed",                     G_CALLBACK (gtk_rc_reparse_all),                     NULL);
endif|#
directive|endif
