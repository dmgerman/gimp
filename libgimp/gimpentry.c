...
begin_decl_stmt
DECL|variable|gse_unit_factor
specifier|static
name|float
name|gse_unit_factor
index|[]
init|=
block|{
literal|1.0
...
begin_decl_stmt
DECL|variable|gse_unit_string
specifier|static
name|gchar
modifier|*
name|gse_unit_string
index|[]
init|=
block|{
literal|"px"
...
name|GtkWidget
modifier|*
DECL|function|gimp_size_entry_new (gfloat value,GSizeUnit unit,gfloat resolution,guint positive_only)
...
begin_function
name|void
DECL|function|gimp_size_entry_set_unit (GimpSizeEntry * gse,GSizeUnit new_unit)
