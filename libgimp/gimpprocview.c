...
begin_comment
comment|/**  * gimp_proc_view_new:  * @procedure_name: The name of a procedure.  *  * Returns: (transfer full): a new widget providing a view on a  *          GIMP procedure  *  * Since: 2.4  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_proc_view_new (const gchar * procedure_name)
