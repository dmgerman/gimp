...
name|GtkWidget
modifier|*
DECL|function|gimp_proc_view_create_args (const gchar * procedure_name,gint n_args,gboolean return_values,GtkSizeGroup * name_group,GtkSizeGroup * type_group,GtkSizeGroup * desc_group)
name|gimp_proc_view_create_args
parameter_list|(
specifier|const
name|gchar
