...
name|GtkWidget
modifier|*
name|gimp_proc_view_create_args
parameter_list|(
name|GimpProcedure
modifier|*
name|procedure
...
begin_comment
comment|/**  * gimp_proc_view_new:  * @procedure_name: The name of a procedure.  * @menu_path:      (nullable):  The procedure's menu path, or %NULL.  *  * Returns: (transfer full): a new widget providing a view on a  *          GIMP procedure  *  * Since: 2.4  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_proc_view_new (const gchar * procedure_name,const gchar * menu_path)
...
specifier|static
name|gint
DECL|function|gimp_proc_view_add_label (GtkGrid * grid,gint row,const gchar * left_label,const gchar * right_label)
name|gimp_proc_view_add_label
parameter_list|(
name|GtkGrid
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|gimp_proc_view_create_args (GimpProcedure * procedure,gboolean return_values,GtkSizeGroup * name_group,GtkSizeGroup * type_group,GtkSizeGroup * desc_group)
name|gimp_proc_view_create_args
parameter_list|(
name|GimpProcedure
modifier|*
