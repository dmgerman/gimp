...
begin_comment
comment|/**  * gimp_vectors_get_locked:  * @vectors_ID: The vectors object.  *  * Gets the locking state of the vectors object.  *  * Gets the locking state of the vectors object.  *  * Returns: TRUE if the path is locked, FALSE otherwise.  *  * Since: GIMP 2.4  */
end_comment

begin_function
name|gboolean
DECL|function|gimp_vectors_get_locked (gint32 vectors_ID)
name|gimp_vectors_get_locked
parameter_list|(
name|gint32
name|vectors_ID
parameter_list|)
...
name|gimp_run_procedure
argument_list|(
literal|"gimp-vectors-get-locked"
argument_list|,
operator|&
name|nreturn_vals
argument_list|,
...
begin_comment
comment|/**  * gimp_vectors_set_locked:  * @vectors_ID: The vectors object.  * @locked: Whether the path is locked.  *  * Sets the locking state of the vectors object.  *  * Sets the locking state of the vectors object.  *  * Returns: TRUE on success.  *  * Since: GIMP 2.4  */
end_comment

begin_function
name|gboolean
DECL|function|gimp_vectors_set_locked (gint32 vectors_ID,gboolean locked)
name|gimp_vectors_set_locked
parameter_list|(
name|gint32
name|vectors_ID
parameter_list|,
...
name|gimp_run_procedure
argument_list|(
literal|"gimp-vectors-set-locked"
argument_list|,
operator|&
name|nreturn_vals
argument_list|,
