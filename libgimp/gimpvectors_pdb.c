...
begin_comment
comment|/**  * gimp_vectors_copy:  * @vectors_ID: The vectors object to copy.  *  * Copy a vectors object.  *  * This procedure copies the specified vectors object and returns the  * copy.  *  * Returns: The newly copied vectors object.  *  * Since: 2.6  **/
end_comment
...
begin_comment
comment|/**  * gimp_vectors_stroke_get_length:  * @vectors_ID: The vectors object.  * @stroke_id: The stroke ID.  * @precision: The precision used for the approximation.  *  * Measure the length of the given stroke.  *  * Measure the length of the given stroke.  *  * Returns: The length (in pixels) of the given stroke.  *  * Since: 2.4  **/
end_comment
...
begin_comment
comment|/**  * gimp_vectors_remove_stroke:  * @vectors_ID: The vectors object.  * @stroke_id: The stroke ID.  *  * remove the stroke from a vectors object.  *  * Remove the stroke from a vectors object.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment
...
begin_comment
comment|/**  * gimp_vectors_stroke_close:  * @vectors_ID: The vectors object.  * @stroke_id: The stroke ID.  *  * closes the specified stroke.  *  * Closes the specified stroke.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment
...
begin_comment
comment|/**  * gimp_vectors_stroke_translate:  * @vectors_ID: The vectors object.  * @stroke_id: The stroke ID.  * @off_x: Offset in x direction.  * @off_y: Offset in y direction.  *  * translate the given stroke.  *  * Translate the given stroke.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment
...
begin_comment
comment|/**  * gimp_vectors_stroke_scale:  * @vectors_ID: The vectors object.  * @stroke_id: The stroke ID.  * @scale_x: Scale factor in x direction.  * @scale_y: Scale factor in y direction.  *  * scales the given stroke.  *  * Scale the given stroke.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment
...
begin_comment
comment|/**  * gimp_vectors_bezier_stroke_lineto:  * @vectors_ID: The vectors object.  * @stroke_id: The stroke ID.  * @x0: The x-coordinate of the lineto.  * @y0: The y-coordinate of the lineto.  *  * Extends a bezier stroke with a lineto.  *  * Extends a bezier stroke with a lineto.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment
