...
specifier|static
name|void
name|gimp_drawable_combo_box_drag_data_received
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_drawable_combo_box_drag_data_received (GtkWidget * widget,GdkDragContext * context,gint x,gint y,GtkSelectionData * selection,guint info,guint time)
name|gimp_drawable_combo_box_drag_data_received
parameter_list|(
name|GtkWidget
modifier|*
