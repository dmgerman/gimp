...
specifier|static
name|void
DECL|function|gimp_item_combo_box_model_add (GimpIntComboBox * combo_box,GtkListStore * store,GimpImage * image,GList * items,gint tree_level)
name|gimp_item_combo_box_model_add
parameter_list|(
name|GimpIntComboBox
modifier|*
...
begin_comment
comment|/**  * gimp_drawable_combo_box_new_deprecated: (skip)  * @constraint:   a #GimpItemConstraintDeprecatedFunc or %NULL  * @data  :       a pointer that is passed to @constraint  * @data_destroy: Destroy function for @data  *  * Creates a new #GimpIntComboBox filled with all currently opened  * drawables. If a @constraint function is specified, it is called for  * each drawable and only if the function returns %TRUE, the drawable  * is added to the combobox.  *  * You should use gimp_int_combo_box_connect() to initialize and connect  * the combo.  Use gimp_int_combo_box_set_active() to get the active  * drawable ID and gimp_int_combo_box_get_active() to retrieve the ID  * of the selected drawable.  *  * Returns: a new #GimpIntComboBox.  *  * Since: 2.2  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_drawable_combo_box_new_deprecated (GimpItemConstraintDeprecatedFunc constraint,gpointer data,GDestroyNotify data_destroy)
...
name|GtkWidget
modifier|*
DECL|function|gimp_item_combo_box_new_deprecated (GType type,GimpItemConstraintDeprecatedFunc constraint,gpointer data,GDestroyNotify data_destroy)
name|gimp_item_combo_box_new_deprecated
parameter_list|(
name|GType
name|type
