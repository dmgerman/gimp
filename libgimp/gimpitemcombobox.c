...
specifier|static
name|void
DECL|function|gimp_item_combo_box_model_add (GtkListStore * store,gint32 image,gint num_items,gint32 * items,gint tree_level,GimpComboBoxType type,GimpItemConstraintFunc constraint,gpointer data)
name|gimp_item_combo_box_model_add
parameter_list|(
name|GtkListStore
modifier|*
