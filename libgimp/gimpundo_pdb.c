...
begin_comment
comment|/**  * gimp_image_undo_group_end:  * @image_ID: The ID of the image in which to close an undo group.  *  * Finish a group undo.  *  * This function must be called once for each  * 'gimp-image-undo-group-start' call that is made.  *  * Returns: TRUE on success.  */
end_comment
