...
typedef|typedef
struct|struct
DECL|struct|__anon291c39070108
block|{
...
specifier|static
name|void
DECL|function|export_merge (GimpImage * image,GimpDrawable ** drawable)
name|export_merge
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|export_flatten (GimpImage * image,GimpDrawable ** drawable)
name|export_flatten
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|export_remove_alpha (GimpImage * image,GimpDrawable ** drawable)
...
specifier|static
name|void
DECL|function|export_apply_masks (GimpImage * image,GimpDrawable ** drawable)
...
specifier|static
name|void
DECL|function|export_convert_rgb (GimpImage * image,GimpDrawable ** drawable)
...
specifier|static
name|void
DECL|function|export_convert_grayscale (GimpImage * image,GimpDrawable ** drawable)
...
specifier|static
name|void
DECL|function|export_convert_indexed (GimpImage * image,GimpDrawable ** drawable)
...
specifier|static
name|void
DECL|function|export_convert_bitmap (GimpImage * image,GimpDrawable ** drawable)
...
specifier|static
name|void
DECL|function|export_add_alpha (GimpImage * image,GimpDrawable ** drawable)
...
specifier|static
name|void
DECL|function|export_void (GimpImage * image,GimpDrawable ** drawable)
name|export_void
parameter_list|(
name|GimpImage
modifier|*
...
begin_decl_stmt
DECL|variable|export_action_remove_alpha
specifier|static
name|ExportAction
name|export_action_remove_alpha
init|=
block|{
name|export_remove_alpha
block|,
...
name|N_
argument_list|(
literal|"%s plug-in can't handle transparent layers"
argument_list|)
block|,
block|{
name|N_
...
specifier|static
name|void
DECL|function|export_action_perform (const ExportAction * action,GimpImage * image,GimpDrawable ** drawable)
...
name|g_getenv
argument_list|(
literal|"GIMP_INTERACTIVE_EXPORT"
argument_list|)
condition|)
name|interactive
operator|=
...
block|}
block|}
comment|/* check for a single toplevel layer group */
elseif|else
if|if
condition|(
name|children
...
begin_comment
comment|/**  * gimp_export_dialog_get_content_area:  * @dialog: A dialog created with gimp_export_dialog_new()  *  * Returns the #GtkVBox of the passed export dialog to be filled with  * export options.  *  * Returns: (transfer none): The #GtkVBox to fill with export options.  *  * Since: 2.8  **/
end_comment
