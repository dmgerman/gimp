...
typedef|typedef
struct|struct
DECL|struct|__anon29e766b10108
block|{
...
specifier|static
name|void
DECL|function|export_confirm_callback (GtkWidget * widget,gpointer data)
name|export_confirm_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
argument_list|)
expr_stmt|;
comment|/*    *  Plug-ins must have called gtk_init () before calling gimp_export ().    *  Otherwise bad things will happen now!!    */
comment|/* the dialog */
name|dialog
operator|=
