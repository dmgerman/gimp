...
block|{
struct|struct
DECL|struct|__anon28af74790108
block|{
DECL|member|g_type
name|GType
name|g_type
...
name|GimpValueArray
modifier|*
DECL|function|_gimp_pdb_params_to_args (GParamSpec ** pspecs,gint n_pspecs,const GimpParam * params,gint n_params,gboolean return_values,gboolean full_copy)
...
name|GimpParam
modifier|*
DECL|function|_gimp_pdb_args_to_params (GimpValueArray * args,gboolean full_copy)
