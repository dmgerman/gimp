...
begin_comment
comment|/**  * _gimp_image_grid_get_spacing: (skip)  * @image_ID: The image.  * @xspacing: (out): The image's grid horizontal spacing.  * @yspacing: (out): The image's grid vertical spacing.  *  * Gets the spacing of an image's grid.  *  * This procedure retrieves the horizontal and vertical spacing of an  * image's grid. It takes the image as parameter.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_grid_get_spacing (gint32 image_ID,gdouble * xspacing,gdouble * yspacing)
name|_gimp_image_grid_get_spacing
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_grid_set_spacing: (skip)  * @image_ID: The image.  * @xspacing: The image's grid horizontal spacing.  * @yspacing: The image's grid vertical spacing.  *  * Sets the spacing of an image's grid.  *  * This procedure sets the horizontal and vertical spacing of an  * image's grid.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_grid_set_spacing (gint32 image_ID,gdouble xspacing,gdouble yspacing)
name|_gimp_image_grid_set_spacing
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_grid_get_offset: (skip)  * @image_ID: The image.  * @xoffset: (out): The image's grid horizontal offset.  * @yoffset: (out): The image's grid vertical offset.  *  * Gets the offset of an image's grid.  *  * This procedure retrieves the horizontal and vertical offset of an  * image's grid. It takes the image as parameter.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_grid_get_offset (gint32 image_ID,gdouble * xoffset,gdouble * yoffset)
name|_gimp_image_grid_get_offset
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_grid_set_offset: (skip)  * @image_ID: The image.  * @xoffset: The image's grid horizontal offset.  * @yoffset: The image's grid vertical offset.  *  * Sets the offset of an image's grid.  *  * This procedure sets the horizontal and vertical offset of an image's  * grid.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_grid_set_offset (gint32 image_ID,gdouble xoffset,gdouble yoffset)
name|_gimp_image_grid_set_offset
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_grid_get_foreground_color: (skip)  * @image_ID: The image.  * @fgcolor: (out caller-allocates): The image's grid foreground color.  *  * Sets the foreground color of an image's grid.  *  * This procedure gets the foreground color of an image's grid.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_grid_get_foreground_color (gint32 image_ID,GimpRGB * fgcolor)
name|_gimp_image_grid_get_foreground_color
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_grid_set_foreground_color: (skip)  * @image_ID: The image.  * @fgcolor: The new foreground color.  *  * Gets the foreground color of an image's grid.  *  * This procedure sets the foreground color of an image's grid.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_grid_set_foreground_color (gint32 image_ID,const GimpRGB * fgcolor)
name|_gimp_image_grid_set_foreground_color
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_grid_get_background_color: (skip)  * @image_ID: The image.  * @bgcolor: (out caller-allocates): The image's grid background color.  *  * Sets the background color of an image's grid.  *  * This procedure gets the background color of an image's grid.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_grid_get_background_color (gint32 image_ID,GimpRGB * bgcolor)
name|_gimp_image_grid_get_background_color
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_grid_set_background_color: (skip)  * @image_ID: The image.  * @bgcolor: The new background color.  *  * Gets the background color of an image's grid.  *  * This procedure sets the background color of an image's grid.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_grid_set_background_color (gint32 image_ID,const GimpRGB * bgcolor)
name|_gimp_image_grid_set_background_color
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_grid_get_style: (skip)  * @image_ID: The image.  *  * Gets the style of an image's grid.  *  * This procedure retrieves the style of an image's grid.  *  * Returns: The image's grid style.  *  * Since: 2.4  **/
end_comment

begin_function
name|GimpGridStyle
DECL|function|_gimp_image_grid_get_style (gint32 image_ID)
name|_gimp_image_grid_get_style
parameter_list|(
name|gint32
name|image_ID
parameter_list|)
...
begin_comment
comment|/**  * _gimp_image_grid_set_style: (skip)  * @image_ID: The image.  * @style: The image's grid style.  *  * Sets the style unit of an image's grid.  *  * This procedure sets the style of an image's grid. It takes the image  * and the new style as parameters.  *  * Returns: TRUE on success.  *  * Since: 2.4  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_grid_set_style (gint32 image_ID,GimpGridStyle style)
name|_gimp_image_grid_set_style
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
