...
begin_comment
comment|/**  * gimp_get_default_new_layer_mode:  *  * Get the default mode for newly created layers.  *  * Returns the default mode for newly created layers.  *  * Returns: The layer mode.  *  * Since: 2.10  **/
end_comment

begin_function
name|GimpLayerMode
DECL|function|gimp_get_default_new_layer_mode (void)
...
name|gimp_run_procedure
argument_list|(
literal|"gimp-get-default-new-layer-mode"
argument_list|,
operator|&
name|nreturn_vals
argument_list|,
...
begin_comment
comment|/**  * gimp_get_icon_theme_dir:  *  * Get the directory of the current icon theme.  *  * Returns a copy of the current icon theme dir.  *  * Returns: The icon theme dir.  *  * Since: 2.10  **/
end_comment

begin_function
name|gchar
modifier|*
DECL|function|gimp_get_icon_theme_dir (void)
