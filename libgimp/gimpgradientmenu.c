...
specifier|static
name|void
DECL|function|compat_callback (GimpGradientSelectButton * gradient_button,const gchar * gradient_name,gint width,const gdouble * grad_data,gboolean dialog_closing,gpointer data)
name|compat_callback
parameter_list|(
name|GimpGradientSelectButton
modifier|*
