...
specifier|static
name|void
DECL|function|gradient_preview_update (GtkWidget * gradient_preview,gint width,const gdouble * grad_data)
name|gradient_preview_update
parameter_list|(
name|GtkWidget
modifier|*
name|gradient_preview
...
specifier|static
name|void
DECL|function|gradient_select_invoker (const gchar * name,gint width,const gdouble * grad_data,gint closing,gpointer data)
...
specifier|static
name|void
DECL|function|gradient_select_callback (GtkWidget * widget,gpointer data)
name|gradient_select_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
name|GtkWidget
modifier|*
DECL|function|gimp_gradient_select_widget (const gchar * title,const gchar * gradient_name,GimpRunGradientCallback callback,gpointer data)
...
begin_comment
comment|/**  * gimp_gradient_select_widget_set_popup:  * @widget: A gradient select widget.  * @gradient_name: gradient name to set.  *  * Sets the current gradient for the gradient  * select widget.  Calls the callback function if one was  * supplied in the call to gimp_gradient_select_widget().  */
end_comment

begin_function
name|void
DECL|function|gimp_gradient_select_widget_set_popup (GtkWidget * widget,const gchar * gradient_name)
