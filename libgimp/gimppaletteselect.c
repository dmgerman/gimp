...
typedef|typedef
struct|struct
DECL|struct|__anon2c50abb00108
block|{
...
name|GimpValueArray
modifier|*
name|gimp_temp_palette_run_func
parameter_list|(
name|GimpProcedure
modifier|*
name|procedure
...
specifier|static
name|gboolean
name|gimp_temp_palette_run_idle
parameter_list|(
name|GimpPaletteData
modifier|*
name|palette_data
...
begin_decl_stmt
DECL|variable|gimp_palette_select_ht
specifier|static
name|GHashTable
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_palette_select_new (const gchar * title,const gchar * palette_name,GimpRunPaletteCallback callback,gpointer data,GDestroyNotify data_destroy)
...
name|palette_callback
argument_list|,
literal|"Temporary palette popup callback procedure"
argument_list|,
literal|""
argument_list|,
literal|""
...
begin_function
name|void
DECL|function|gimp_palette_select_destroy (const gchar * palette_callback)
...
name|g_warning
argument_list|(
literal|"Can't find internal palette data"
argument_list|)
expr_stmt|;
return|return;
block|}
...
specifier|static
name|void
DECL|function|gimp_temp_palette_run (const gchar * name,gint nparams,const GimpParam * param,gint * nreturn_vals,GimpParam ** return_vals)
name|gimp_temp_palette_run
parameter_list|(
specifier|const
name|gchar
...
name|GimpValueArray
modifier|*
DECL|function|gimp_temp_palette_run_func (GimpProcedure * procedure,const GimpValueArray * args,gpointer run_data)
name|gimp_temp_palette_run_func
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_temp_palette_run_idle (GimpPaletteData * palette_data)
name|gimp_temp_palette_run_idle
parameter_list|(
name|GimpPaletteData
modifier|*
