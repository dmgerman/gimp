...
typedef|typedef
struct|struct
DECL|struct|__anon2b840c850108
block|{
...
name|GimpValueArray
modifier|*
DECL|function|gimp_temp_palette_run (GimpProcedure * procedure,const GimpValueArray * args,gpointer run_data)
name|gimp_temp_palette_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_temp_palette_idle (GimpPaletteData * data)
name|gimp_temp_palette_idle
parameter_list|(
name|GimpPaletteData
modifier|*
