...
begin_comment
comment|/**  * __gimp_progress_init: (skip)  * @message: Message to use in the progress dialog.  * @gdisplay_ID: GimpDisplay to update progressbar in, or -1 for a separate window.  *  * Initializes the progress bar for the current plug-in.  *  * Initializes the progress bar for the current plug-in. It is only  * valid to call this procedure from a plug-in.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|__gimp_progress_init (const gchar * message,gint32 gdisplay_ID)
name|__gimp_progress_init
parameter_list|(
specifier|const
name|gchar
modifier|*
