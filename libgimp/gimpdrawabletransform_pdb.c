...
begin_comment
comment|/**  * gimp_drawable_transform_flip:  * @drawable_ID: The affected drawable.  * @x0: horz. coord. of one end of axis.  * @y0: vert. coord. of one end of axis.  * @x1: horz. coord. of other end of axis.  * @y1: vert. coord. of other end of axis.  * @transform_direction: Direction of transformation.  * @interpolation: Type of interpolation.  * @supersample: This parameter is ignored.  * @recursion_level: This parameter is ignored.  * @clip_result: Whether to clip results.  *  * Deprecated: Use gimp_item_transform_flip() instead.  *  * Returns: The flipped drawable.  *  * Since: GIMP 2.2  **/
end_comment
...
begin_comment
comment|/**  * gimp_drawable_transform_shear:  * @drawable_ID: The affected drawable.  * @shear_type: Type of shear.  * @magnitude: The magnitude of the shear.  * @transform_direction: Direction of transformation.  * @interpolation: Type of interpolation.  * @supersample: This parameter is ignored.  * @recursion_level: This parameter is ignored.  * @clip_result: How to clip results.  *  * Deprecated: Use gimp_item_transform_shear() instead.  *  * Returns: The sheared drawable.  *  * Since: GIMP 2.2  **/
end_comment
