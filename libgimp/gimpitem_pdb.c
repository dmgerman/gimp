...
begin_function
name|gboolean
DECL|function|gimp_item_is_text_layer (gint32 item_ID)
...
begin_comment
comment|/**  * gimp_item_get_children:  * @item_ID: The item.  * @num_children: The item's number of children.  *  * Returns the item's list of children.  *  * This procedure returns the list of items which are children of the  * specified item. The order is topmost to bottommost.  *  * Returns: (element-type gint32) (transfer full) The item's list of  * children.  *  * Since: 2.8  **/
end_comment
...
begin_comment
comment|/**  * gimp_item_get_expanded:  * @item_ID: The item.  *  * Returns whether the item is expanded.  *  * This procedure returns TRUE if the specified item is expanded.  *  * Returns: TRUE if the item is expanded, FALSE otherwise.  *  * Since: 2.10  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_item_get_expanded (gint32 item_ID)
...
begin_comment
comment|/**  * gimp_item_set_expanded:  * @item_ID: The item.  * @expanded: TRUE to expand the item, FALSE to collapse the item.  *  * Sets the expanded state of the item.  *  * This procedure expands or collapses the item.  *  * Returns: TRUE on success.  *  * Since: 2.10  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_item_set_expanded (gint32 item_ID,gboolean expanded)
...
begin_function
name|gboolean
DECL|function|gimp_item_get_lock_position (gint32 item_ID)
...
begin_function
name|gboolean
DECL|function|gimp_item_set_lock_position (gint32 item_ID,gboolean lock_position)
...
begin_comment
comment|/**  * gimp_item_get_color_tag:  * @item_ID: The item.  *  * Get the color tag of the specified item.  *  * This procedure returns the specified item's color tag.  *  * Returns: The item's color tag.  *  * Since: 2.10  **/
end_comment

begin_function
name|GimpColorTag
DECL|function|gimp_item_get_color_tag (gint32 item_ID)
...
begin_comment
comment|/**  * gimp_item_set_color_tag:  * @item_ID: The item.  * @color_tag: The new item color tag.  *  * Set the color tag of the specified item.  *  * This procedure sets the specified item's color tag.  *  * Returns: TRUE on success.  *  * Since: 2.10  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_item_set_color_tag (gint32 item_ID,GimpColorTag color_tag)
...
begin_function
name|gboolean
DECL|function|gimp_item_attach_parasite (gint32 item_ID,const GimpParasite * parasite)
...
begin_function
name|gboolean
DECL|function|gimp_item_detach_parasite (gint32 item_ID,const gchar * name)
...
begin_comment
comment|/**  * gimp_item_get_parasite_list:  * @item_ID: The item.  * @num_parasites: The number of attached parasites.  *  * List all parasites.  *  * Returns a list of all parasites currently attached the an item.  *  * Returns: (element-type gchar*) (transfer full) The names of  * currently attached parasites. The returned value must be freed with  * g_strfreev().  *  * Since: 2.8  **/
end_comment
