...
begin_comment
comment|/**  * gimp_item_get_children:  * @item_ID: The item.  * @num_children: The item's number of children.  *  * Returns the item's list of children.  *  * This procedure returns the list of items which are children of the  * specified item. The order is topmost to bottommost.  *  * Returns: (transfer full) The item's list of children.  *  * Since: 2.8  **/
end_comment
