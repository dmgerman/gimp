...
begin_comment
comment|/**  * _gimp_item_get_metadata:  * @item_ID: The item.  *  * Returns the item's metadata.  *  * Returns metadata from the item.  *  * Returns: The metadata as a xml string.  **/
end_comment

begin_function
name|gchar
modifier|*
DECL|function|_gimp_item_get_metadata (gint32 item_ID)
...
begin_comment
comment|/**  * _gimp_item_set_metadata:  * @item_ID: The item.  * @metadata_string: The metadata as a xml string.  *  * Set the item's metadata.  *  * Sets metadata on the item.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_item_set_metadata (gint32 item_ID,const gchar * metadata_string)
