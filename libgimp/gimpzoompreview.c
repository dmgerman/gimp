...
typedef|typedef
struct|struct
DECL|struct|__anon2ab920010208
block|{
DECL|member|update
name|gboolean
name|update
...
argument_list|)
expr_stmt|;
comment|/**    * GimpZoomPreview:drawable:    *    * The drawable the #GimpZoomPreview is attached to.    *    * Deprecated: use the drawable-id property instead.    *    * Since: 2.4    */
...
begin_comment
comment|/**  * gimp_zoom_preview_new:  * @drawable: a #GimpDrawable  *  * Creates a new #GimpZoomPreview widget for @drawable.  *  * Deprecated: 2.10: Use gimp_zoom_preview_new_from_drawable_id() instead.  *  * Since: 2.4  *  * Returns: a new #GimpZoomPreview.  **/
end_comment
...
begin_comment
comment|/**  * gimp_zoom_preview_new_with_model:  * @drawable: a #GimpDrawable  * @model:    a #GimpZoomModel  *  * Creates a new #GimpZoomPreview widget for @drawable using the  * given @model.  *  * This variant of gimp_zoom_preview_new() allows you to create a  * preview using an existing zoom model. This may be useful if for  * example you want to have two zoom previews that keep their zoom  * factor in sync.  *  * Deprecated: 2.10: Use gimp_zoom_preview_new_with_model_from_drawable_id()  * instead.  *  * Since: 2.4  *  * Returns: a new #GimpZoomPreview.  **/
end_comment
...
begin_comment
comment|/**  * gimp_zoom_preview_get_drawable:  * @preview: a #GimpZoomPreview widget  *  * Returns the #GimpDrawable the #GimpZoomPreview is attached to.  *  * Return Value: the #GimpDrawable that was passed to gimp_zoom_preview_new().  *  * Deprecated: 2.10: Use gimp_zoom_preview_get_drawable_id() instead.  *  * Since: 2.4  **/
end_comment
