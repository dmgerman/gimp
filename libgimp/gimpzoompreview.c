...
name|guchar
modifier|*
DECL|function|gimp_zoom_preview_get_data (GimpZoomPreview * preview,gint * width,gint * height,gint * bpp)
...
specifier|static
name|void
DECL|function|gimp_zoom_preview_draw (GimpPreview * gimp_preview)
name|gimp_zoom_preview_draw
parameter_list|(
name|GimpPreview
modifier|*
