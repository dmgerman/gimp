...
begin_comment
comment|/**  * _gimp_channel_new:  * @image_ID: The image to which to add the channel.  * @width: The channel width.  * @height: The channel height.  * @name: The channel name.  * @opacity: The channel opacity.  * @color: The channel compositing color.  *  * Create a new channel.  *  * This procedure creates a new channel with the specified width,  * height, name, opacity and color. \n\nThe new channel still needs to  * be added to the image, as this is not automatic. Add the new channel  * with gimp_image_insert_channel(). Other attributes, such as channel  * visibility, should be set with explicit procedure calls. \nThe  * channel's contents are undefined initially.  *  * Returns: The newly created channel.  **/
end_comment
...
begin_comment
comment|/**  * gimp_channel_new_from_component:  * @image_ID: The image to which to add the channel.  * @component: The image component.  * @name: The channel name.  *  * Create a new channel from a color component  *  * This procedure creates a new channel from a color component. \n\nThe  * new channel still needs to be added to the image, as this is not  * automatic. Add the new channel with gimp_image_insert_channel().  * Other attributes, such as channel visibility, should be set with  * explicit procedure calls.  *  * Returns: The newly created channel.  *  * Since: GIMP 2.4  **/
end_comment
...
begin_comment
comment|/**  * gimp_channel_copy:  * @channel_ID: The channel to copy.  *  * Copy a channel.  *  * This procedure copies the specified channel and returns the copy.  * \n\nThe new channel still needs to be added to the image, as this is  * not automatic. Add the new channel with gimp_image_insert_channel().  *  * Returns: The newly copied channel.  **/
end_comment
