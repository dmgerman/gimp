...
begin_comment
comment|/**  * gimp_image_list:  *  * Returns the list of images currently open.  *  * This procedure returns the list of images currently open in GIMP.  *  * Returns: (element-type GimpImage) (transfer full):  *          The list of images currently open.  *          The returned value must be freed with:  *          g_list_free_full(list, g_object_unref);  **/
end_comment
...
begin_comment
comment|/**  * gimp_image_list_deprecated: (skip)  * @num_images: (out): The number of images currently open.  *  * Returns the list of images currently open.  *  * This procedure returns the list of images currently open in GIMP.  *  * Returns: (array length=num_images) (element-type gint32) (transfer full):  *          The list of images currently open.  *          The returned value must be freed with g_free().  **/
end_comment

begin_function
name|gint
modifier|*
DECL|function|gimp_image_list_deprecated (gint * num_images)
...
name|gint
modifier|*
DECL|function|gimp_image_get_channels_deprecated (gint32 image_id,gint * num_channels)
...
begin_comment
comment|/**  * gimp_image_get_vectors_deprecated: (skip)  * @image_id: The image.  * @num_vectors: (out): The number of vectors contained in the image.  *  * Returns the list of vectors contained in the specified image.  *  * This procedure returns the list of vectors contained in the  * specified image.  *  * Returns: (array length=num_vectors) (element-type gint32) (transfer full):  *          The list of vectors contained in the image.  *          The returned value must be freed with g_free().  *  * Since: 2.4  **/
end_comment

begin_function
name|gint
modifier|*
DECL|function|gimp_image_get_vectors_deprecated (gint32 image_id,gint * num_vectors)
...
begin_comment
comment|/**  * gimp_image_get_thumbnail_data_deprecated: (skip)  * @image_id: The image.  * @width:   (inout): The requested thumbnail width.  * @height:  (inout): The requested thumbnail height.  * @bpp:     (out): The previews bpp.  *  * Get a thumbnail of an image.  *  * This function gets data from which a thumbnail of an image preview  * can be created. Maximum x or y dimension is 1024 pixels. The pixels  * are returned in RGB[A] or GRAY[A] format. The bpp return value  * gives the number of bytes per pixel in the image.  *  * Returns: (transfer full): the thumbnail data.  **/
end_comment

begin_function
name|guchar
modifier|*
DECL|function|gimp_image_get_thumbnail_data_deprecated (gint32 image_id,gint * width,gint * height,gint * bpp)
...
begin_comment
comment|/**  * gimp_image_get_thumbnail_deprecated: (skip)  * @image_id: the image ID  * @width:    the requested thumbnail width  (<= 1024 pixels)  * @height:   the requested thumbnail height (<= 1024 pixels)  * @alpha:    how to handle an alpha channel  *  * Retrieves a thumbnail pixbuf for the image identified by @image->priv->id.  * The thumbnail will be not larger than the requested size.  *  * Returns: (transfer full): a new #GdkPixbuf  *  * Since: 2.2  **/
end_comment

begin_function
name|GdkPixbuf
modifier|*
DECL|function|gimp_image_get_thumbnail_deprecated (gint32 image_id,gint width,gint height,GimpPixbufTransparency alpha)
