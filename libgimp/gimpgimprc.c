...
begin_comment
comment|/**  * gimp_get_color_configuration:  *  * Retrieve a copy of the current color management configuration.  *  * Returns: (transfer full): A copy of the core's #GimpColorConfig. You  *          should unref this copy if you don't need it any longer.  *  * Since: 2.4  */
end_comment
