...
begin_define
DECL|macro|regexec (pr,st,nm,pm,ef)
define|#
directive|define
name|regexec
parameter_list|(
...
begin_define
DECL|macro|regcomp (preg,pattern,cflags)
define|#
directive|define
name|regcomp
parameter_list|(
...
begin_define
DECL|macro|regerror (errcode,preg,errbuf,errbuf_size)
define|#
directive|define
name|regerror
parameter_list|(
...
begin_define
DECL|macro|re_set_registers (bu,re,nu,st,en)
define|#
directive|define
...
begin_define
DECL|macro|re_match_2 (bufp,string1,size1,string2,size2,pos,regs,stop)
define|#
directive|define
name|re_match_2
parameter_list|(
...
begin_define
DECL|macro|re_match (bufp,string,size,pos,regs)
define|#
directive|define
name|re_match
parameter_list|(
...
begin_define
DECL|macro|re_search (bufp,string,size,startpos,range,regs)
define|#
directive|define
name|re_search
parameter_list|(
...
begin_define
DECL|macro|re_compile_pattern (pattern,length,bufp)
define|#
directive|define
...
begin_define
DECL|macro|re_set_syntax (syntax)
define|#
directive|define
name|re_set_syntax
parameter_list|(
...
begin_define
DECL|macro|re_search_2 (bufp,st1,s1,st2,s2,startpos,range,regs,stop)
define|#
directive|define
name|re_search_2
parameter_list|(
...
begin_define
DECL|macro|re_compile_fastmap (bufp)
define|#
directive|define
...
begin_decl_stmt
DECL|variable|re_error_msgid_idx
specifier|static
specifier|const
name|size_t
...
typedef|typedef
struct|struct
DECL|struct|__anon2911b2110208
block|{
DECL|member|stack
name|fail_stack_elt_t
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2911b2110308
block|{
DECL|member|stack
name|fail_stack_elt_t
modifier|*
...
decl_stmt|;
struct|struct
DECL|struct|__anon2911b2110508
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2911b2110608
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2911b2110708
block|{
DECL|member|stack
name|compile_stack_elt_t
modifier|*
...
name|bufp
decl_stmt|;
DECL|variable|string1
DECL|variable|string2
specifier|const
name|char
modifier|*
name|string1
...
DECL|variable|end_match_1
DECL|variable|end_match_2
specifier|const
name|char
modifier|*
name|end_match_1
...
DECL|variable|just_past_start_mem
name|unsigned
name|char
modifier|*
...
directive|ifdef
name|DEBUG
DECL|variable|failure_id
specifier|static
name|unsigned
name|failure_id
decl_stmt|;
DECL|variable|nfailure_points_pushed
DECL|variable|nfailure_points_popped
name|unsigned
...
name|REL_ALLOC
comment|/* This holds the pointer to the failure stack, when      it is allocated relocatably.  */
DECL|variable|failure_stack_ptr
name|fail_stack_elt_t
modifier|*
name|failure_stack_ptr
decl_stmt|;
...
DECL|variable|lowest_active_reg
name|active_reg_t
name|lowest_active_reg
init|=
name|NO_LOWEST_ACTIVE_REG
decl_stmt|;
DECL|variable|highest_active_reg
name|active_reg_t
...
DECL|variable|set_regs_matched_done
name|int
...
DECL|variable|dummy_low_reg
DECL|variable|dummy_high_reg
name|active_reg_t
name|dummy_low_reg
decl_stmt|,
name|dummy_high_reg
decl_stmt|;
DECL|variable|pdummy
name|unsigned
name|char
modifier|*
name|pdummy
decl_stmt|;
DECL|variable|sdummy
specifier|const
name|char
modifier|*
name|sdummy
...
case|:
block|{
DECL|variable|prevchar
DECL|variable|thischar
name|boolean
name|prevchar
decl_stmt|,
name|thischar
