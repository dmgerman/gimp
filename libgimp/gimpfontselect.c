...
typedef|typedef
struct|struct
DECL|struct|__anon2770f8070108
block|{
...
name|GimpValueArray
modifier|*
DECL|function|gimp_temp_font_run_func (GimpProcedure * procedure,const GimpValueArray * args,gpointer run_data)
name|gimp_temp_font_run_func
parameter_list|(
name|GimpProcedure
modifier|*
