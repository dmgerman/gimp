...
begin_comment
comment|/**  * gimp_layer_get_blend_space:  * @layer_ID: The layer.  *  * Get the blend space of the specified layer.  *  * This procedure returns the specified layer's blend space.  *  * Returns: The layer blend space.  *  * Since: 2.10  **/
end_comment

begin_function
name|GimpLayerColorSpace
DECL|function|gimp_layer_get_blend_space (gint32 layer_ID)
...
begin_comment
comment|/**  * gimp_layer_set_blend_space:  * @layer_ID: The layer.  * @blend_space: The new layer blend space.  *  * Set the blend space of the specified layer.  *  * This procedure sets the specified layer's blend space.  *  * Returns: TRUE on success.  *  * Since: 2.10  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_layer_set_blend_space (gint32 layer_ID,GimpLayerColorSpace blend_space)
...
begin_comment
comment|/**  * gimp_layer_get_composite_space:  * @layer_ID: The layer.  *  * Get the composite space of the specified layer.  *  * This procedure returns the specified layer's composite space.  *  * Returns: The layer composite space.  *  * Since: 2.10  **/
end_comment

begin_function
name|GimpLayerColorSpace
DECL|function|gimp_layer_get_composite_space (gint32 layer_ID)
...
begin_comment
comment|/**  * gimp_layer_set_composite_space:  * @layer_ID: The layer.  * @composite_space: The new layer composite space.  *  * Set the composite space of the specified layer.  *  * This procedure sets the specified layer's composite space.  *  * Returns: TRUE on success.  *  * Since: 2.10  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_layer_set_composite_space (gint32 layer_ID,GimpLayerColorSpace composite_space)
...
begin_comment
comment|/**  * gimp_layer_get_composite_mode:  * @layer_ID: The layer.  *  * Get the composite mode of the specified layer.  *  * This procedure returns the specified layer's composite mode.  *  * Returns: The layer composite mode.  *  * Since: 2.10  **/
end_comment

begin_function
name|GimpLayerCompositeMode
DECL|function|gimp_layer_get_composite_mode (gint32 layer_ID)
...
begin_comment
comment|/**  * gimp_layer_set_composite_mode:  * @layer_ID: The layer.  * @composite_mode: The new layer composite mode.  *  * Set the composite mode of the specified layer.  *  * This procedure sets the specified layer's composite mode.  *  * Returns: TRUE on success.  *  * Since: 2.10  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_layer_set_composite_mode (gint32 layer_ID,GimpLayerCompositeMode composite_mode)
