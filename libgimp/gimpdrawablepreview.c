...
begin_comment
comment|/**  * gimp_drawable_preview_draw_buffer:  * @preview:   a #GimpDrawablePreview widget  * @buffer:  * @rowstride:  *  * Since: GIMP 2.2  **/
end_comment

begin_function
name|void
DECL|function|gimp_drawable_preview_draw_buffer (GimpDrawablePreview * preview,const guchar * buffer,gint rowstride)
