...
begin_comment
comment|/**  * gimp_context_push:  *  * Pushes a context to the top of the plug-in's context stack.  *  * This procedure creates a new context by copying the current context.  * This copy becomes the new current context for the calling plug-in  * until it is popped again.  *  * Returns: TRUE on success.  *  * Since: GIMP 2.2  */
end_comment
...
begin_comment
comment|/**  * gimp_context_pop:  *  * Pops the topmost context from the plug-in's context stack.  *  * This procedure creates a new context and makes it the current  * context for the calling plug-in.  *  * Returns: TRUE on success.  *  * Since: GIMP 2.2  */
end_comment
...
begin_comment
comment|/**  * gimp_context_get_foreground:  * @foreground: The foreground color.  *  * Get the current GIMP foreground color.  *  * This procedure retrieves the current GIMP foreground color. The  * foreground color is used in a variety of tools such as paint tools,  * blending, and bucket fill.  *  * Returns: TRUE on success.  *  * Since: GIMP 2.2  */
end_comment
...
begin_comment
comment|/**  * gimp_context_get_background:  * @foreground: The foreground color.  *  * Get the current GIMP background color.  *  * This procedure retrieves the current GIMP background color. The  * background color is used in a variety of tools such as blending,  * erasing (with non-alpha images), and image filling.  *  * Returns: TRUE on success.  *  * Since: GIMP 2.2  */
end_comment

begin_function
name|gboolean
DECL|function|gimp_context_get_background (GimpRGB * foreground)
...
begin_comment
comment|/**  * gimp_context_swap_colors:  *  * Swap the current GIMP foreground and background colors.  *  * This procedure swaps the current GIMP foreground and background  * colors, so that the new foreground color becomes the old background  * color and vice versa.  *  * Returns: TRUE on success.  */
end_comment
