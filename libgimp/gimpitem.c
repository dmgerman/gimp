...
condition|)
block|{
comment|/* Make sure the item is the proper class, since it could be            * reused (which means we'd have cycled over the whole int            * range; not that likely yet still possible on a very very            * long run process).            */
if|if
condition|(
operator|(
