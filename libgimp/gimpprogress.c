...
typedef|typedef
struct|struct
DECL|struct|__anon2a235d8b0108
block|{
...
name|GimpValueArray
modifier|*
name|gimp_temp_progress_run_func
parameter_list|(
name|GimpProcedure
modifier|*
name|procedure
...
name|GimpValueArray
modifier|*
DECL|function|gimp_temp_progress_run_func (GimpProcedure * procedure,const GimpValueArray * args,gpointer run_data)
name|gimp_temp_progress_run_func
parameter_list|(
name|GimpProcedure
modifier|*
