...
begin_comment
comment|/**  * gimp_display_get_by_id:  * @display_id: The display id.  *  * Returns a #GimpDisplay representing @display_id.  *  * Returns: (nullable) (transfer none): a #GimpDisplay for @display_id or  *          %NULL if @display_id does not represent a valid display.  *          The object belongs to libgimp and you must not modify or  *          unref it.  *  * Since: 3.0  **/
end_comment
