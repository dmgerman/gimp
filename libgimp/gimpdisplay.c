...
begin_comment
comment|/**  * gimp_display_new_by_id:  * @display_id: The display id.  *  * Creates a #GimpDisplay representing @display_id.  *  * Returns: (nullable) (transfer full): a #GimpDisplay for @display_id or  *          %NULL if @display_id does not represent a valid display.  *  * Since: 3.0  **/
end_comment

begin_function
name|GimpDisplay
modifier|*
DECL|function|gimp_display_new_by_id (gint32 display_id)
