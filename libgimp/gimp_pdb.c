...
begin_comment
comment|/**  * gimp_version:  *  * Returns the host GIMP version.  *  * This procedure returns the version number of the currently running  * GIMP.  *  * Returns: (transfer full): GIMP version number.  *          The returned value must be freed with g_free().  **/
end_comment
