...
directive|define
name|CAN_HANDLE_RGB
value|GIMP_EXPORT_CAN_HANDLE_RGB
DECL|macro|CAN_HANDLE_GRAY
define|#
directive|define
name|CAN_HANDLE_GRAY
value|GIMP_EXPORT_CAN_HANDLE_GRAY
DECL|macro|CAN_HANDLE_INDEXED
define|#
directive|define
name|CAN_HANDLE_INDEXED
value|GIMP_EXPORT_CAN_HANDLE_INDEXED
DECL|macro|CAN_HANDLE_ALPHA
define|#
directive|define
name|CAN_HANDLE_ALPHA
value|GIMP_EXPORT_CAN_HANDLE_ALPHA
DECL|macro|CAN_HANDLE_LAYERS
define|#
directive|define
name|CAN_HANDLE_LAYERS
value|GIMP_EXPORT_CAN_HANDLE_LAYERS
DECL|macro|CAN_HANDLE_LAYERS_AS_ANIMATION
define|#
directive|define
name|CAN_HANDLE_LAYERS_AS_ANIMATION
value|GIMP_EXPORT_CAN_HANDLE_LAYERS_AS_ANIMATION
DECL|macro|NEEDS_ALPHA
define|#
directive|define
name|NEEDS_ALPHA
value|GIMP_EXPORT_NEEDS_ALPHA
DECL|macro|EXPORT_CANCEL
define|#
directive|define
name|EXPORT_CANCEL
value|GIMP_EXPORT_CANCEL
DECL|macro|EXPORT_IGNORE
define|#
directive|define
name|EXPORT_IGNORE
value|GIMP_EXPORT_IGNORE
DECL|macro|EXPORT_EXPORT
define|#
directive|define
name|EXPORT_EXPORT
value|GIMP_EXPORT_EXPORT
endif|#
directive|endif
