...
begin_comment
comment|/**  * GimpPlugInClass:  *  * A class which every plug-in should sublass, while overriding  * GimpPlugInClass::query_procedures() and/or  * GimpPlugInClass::init_procedures(), as well as  * GimpPlugInClass::create_procedure().  *  * Since: 3.0  **/
end_comment
...
name|parent_class
decl_stmt|;
comment|/**    * GimpPlugInClass::query_procedures:    * @plug_in: a #GimpPlugIn.    *    * This method can be overridden by all plug-ins to return a newly    * allocated GList of allocated strings naming the procedures    * registered by this plug-in.    *    * See documentation of GimpPlugInClass::init_procedures() for    * differences.    *    * Returns: (element-type gchar*) (transfer full):    *          the names of the procedures registered by @plug_in.    *    * Since: 3.0    */
...
parameter_list|)
function_decl|;
comment|/**    * GimpPlugInClass::quit:    * @plug_in: a #GimpPlugIn.    *    * This method can be overridden by a plug-in which needs to perform    * some actions upon quitting.    *    * Since: 3.0    */
DECL|member|quit
name|void
function_decl|(
modifier|*
