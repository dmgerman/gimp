...
begin_comment
comment|/**  * gimp_text_layer_set_fontsize:  * @layer_ID: The text layer.  * @font_size: The font size.  * @unit: The unit to use for the font size.  *  * Set the font size.  *  * This procedure changes the font size of a text layer. The size of  * your font will be a double 'font-size' of 'unit' units.  *  * Returns: TRUE on success.  *  * Since: GIMP 2.6  */
end_comment

begin_function
name|gboolean
DECL|function|gimp_text_layer_set_fontsize (gint32 layer_ID,gdouble font_size,GimpUnit unit)
...
begin_comment
comment|/**  * gimp_text_layer_get_hinting:  * @layer_ID: The text layer.  * @autohint: A flag which is true if the text layer is forced to use the autohinter from FreeType.  *  * Get information about hinting in the specified text layer.  *  * This procedure provides information about the hinting that is being  * used in a text layer.  *  * Returns: A flag which is true if hinting is used on the font.  *  * Since: GIMP 2.6  */
end_comment
