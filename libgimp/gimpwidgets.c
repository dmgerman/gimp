...
begin_function
name|void
DECL|function|gimp_table_attach_aligned (GtkTable * table,gint row,gchar * label_text,gfloat xalign,gfloat yalign,GtkWidget * widget,gboolean left_adjust)
...
begin_function
name|void
DECL|function|gimp_table_attach_aligned2 (GtkTable * table,gint row,gchar * label_text,gfloat xalign,gfloat yalign,GtkWidget * widget,gint widget_left,gint widget_right,gboolean left_adjust)
