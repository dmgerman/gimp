...
name|menu_only
parameter_list|,
comment|/* specify menu items as va_list: 		       *  const gchar    *label, 		       *  GtkSignalFunc   callback, 		       *  gpointer        data, 		       *  gpointer        user_data, 		       *  GtkWidget     **widget_ptr, 		       *  gboolean        active 		       */
modifier|...
parameter_list|)
block|{
name|GtkWidget
...
name|GtkWidget
modifier|*
DECL|function|gimp_radio_group_new2 (gboolean in_frame,const gchar * frame_title,GtkSignalFunc radio_button_callback,gpointer data,gpointer initial,...)
...
typedef|typedef
struct|struct
DECL|struct|__anon2978de590108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2978de590208
block|{
...
begin_comment
comment|/**  * gimp_color_update:  * @widget: A pointer to a #GimpColorArea or #GimpColorButton.  * @data:   A pointer to an array of #guchar that will be set to the new color.  *  * This function will go away.  **/
end_comment

begin_function
name|void
DECL|function|gimp_color_update_uchar (GtkWidget * widget,gpointer data)
