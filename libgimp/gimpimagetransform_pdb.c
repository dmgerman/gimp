...
begin_comment
comment|/**  * SECTION: gimpimagetransform_pdb  * @title: gimpimagetransform  * @short_description: Transformations on images.  *  * Operations to scale, resize, crop, flip and rotate images.  **/
end_comment
