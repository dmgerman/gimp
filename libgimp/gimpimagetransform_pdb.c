...
begin_comment
comment|/**  * _gimp_image_resize: (skip)  * @image_ID: The image.  * @new_width: New image width.  * @new_height: New image height.  * @offx: x offset between upper left corner of old and new images: (new - old).  * @offy: y offset between upper left corner of old and new images: (new - old).  *  * Resize the image to the specified extents.  *  * This procedure resizes the image so that it's new width and height  * are equal to the supplied parameters. Offsets are also provided  * which describe the position of the previous image's content. All  * channels within the image are resized according to the specified  * parameters; this includes the image selection mask. All layers  * within the image are repositioned according to the specified  * offsets.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_resize (gint32 image_ID,gint new_width,gint new_height,gint offx,gint offy)
name|_gimp_image_resize
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_scale: (skip)  * @image_ID: The image.  * @new_width: New image width.  * @new_height: New image height.  *  * Scale the image using the default interpolation method.  *  * This procedure scales the image so that its new width and height are  * equal to the supplied parameters. All layers and channels within the  * image are scaled according to the specified parameters; this  * includes the image selection mask. The interpolation method used can  * be set with gimp_context_set_interpolation().  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_scale (gint32 image_ID,gint new_width,gint new_height)
name|_gimp_image_scale
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_crop: (skip)  * @image_ID: The image.  * @new_width: New image width: (0< new_width<= width).  * @new_height: New image height: (0< new_height<= height).  * @offx: X offset: (0<= offx<= (width - new_width)).  * @offy: Y offset: (0<= offy<= (height - new_height)).  *  * Crop the image to the specified extents.  *  * This procedure crops the image so that it's new width and height are  * equal to the supplied parameters. Offsets are also provided which  * describe the position of the previous image's content. All channels  * and layers within the image are cropped to the new image extents;  * this includes the image selection mask. If any parameters are out of  * range, an error is returned.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_crop (gint32 image_ID,gint new_width,gint new_height,gint offx,gint offy)
name|_gimp_image_crop
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_flip: (skip)  * @image_ID: The image.  * @flip_type: Type of flip.  *  * Flips the image horizontally or vertically.  *  * This procedure flips (mirrors) the image.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_flip (gint32 image_ID,GimpOrientationType flip_type)
name|_gimp_image_flip
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
begin_comment
comment|/**  * _gimp_image_rotate: (skip)  * @image_ID: The image.  * @rotate_type: Angle of rotation.  *  * Rotates the image by the specified degrees.  *  * This procedure rotates the image.  *  * Returns: TRUE on success.  **/
end_comment

begin_function
name|gboolean
DECL|function|_gimp_image_rotate (gint32 image_ID,GimpRotationType rotate_type)
name|_gimp_image_rotate
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
