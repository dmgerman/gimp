...
begin_comment
comment|/**  * gimp_file_load_layer:  * @run_mode: The run mode.  * @image_ID: Destination image.  * @filename: The name of the file to load.  *  * Loads an image file as a layer into an already opened image.  *  * This procedure behaves like the file-load procedure but opens the  * specified image as a layer into an already opened image.  *  * Returns: The layer created when loading the image file.  *  * Since: GIMP 2.4  */
end_comment
