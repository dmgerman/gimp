...
begin_function
name|void
DECL|function|gimp_image_metadata_load (gint32 image_ID,const gchar * mime_type,GFile * file,gboolean interactive)
...
begin_function
name|gboolean
DECL|function|gimp_image_metadata_save_finish (gint32 image_ID,const gchar * mime_type,GimpMetadata * metadata,GFile * file,GimpMetadataSaveFlags flags,GError ** error)
...
specifier|static
name|gboolean
DECL|function|gimp_image_metadata_rotate_dialog (gint32 image_ID,const gchar * parasite_name)
name|gimp_image_metadata_rotate_dialog
parameter_list|(
name|gint32
name|image_ID
