...
begin_comment
comment|/**  * SECTION: gimpplugin_pdb  * @title: gimpplugin  * @short_description: Functions useful for plug-ins, e.g. registration and progress indicators.  *  * Functions useful for plug-ins, e.g. registration and progress  * indicators.  **/
end_comment
