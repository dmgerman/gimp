...
specifier|static
name|void
name|gimp_plug_in_add_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
name|plug_in
...
begin_function
name|void
DECL|function|_gimp_plug_in_run (GimpPlugIn * plug_in,const gchar * name,gint n_params,const GimpParam * params,gint * n_return_vals,GimpParam ** return_vals)
...
specifier|static
name|void
DECL|function|gimp_plug_in_add_procedures (GimpPlugIn * plug_in)
name|gimp_plug_in_add_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
