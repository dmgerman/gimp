...
name|module
argument_list|,
literal|"gimp_tool_module_get_abi_version"
argument_list|,
operator|(
name|gpointer
operator|*
...
name|g_warning
argument_list|(
literal|"Cannot load tool plug-in %s.  It is for a newer version of GIMP."
argument_list|,
name|module
operator|->
name|filename
...
name|g_warning
argument_list|(
literal|"Cannot load tool plug-in %s.  It is for an older version of GIMP."
argument_list|,
name|module
operator|->
name|filename
...
argument_list|)
expr_stmt|;
comment|/* FIXME: memory leak; free on delete */
if|if
condition|(
name|gimp_tool_module_load
argument_list|(
