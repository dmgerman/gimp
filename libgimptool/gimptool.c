...
begin_comment
comment|/*#include "tool_manager.h"*/
end_comment
...
directive|if
literal|0
block|if (tool->toggled)     {       gimp_tool_set_cursor (tool, gdisp,                             tool->toggle_cursor,                             tool->toggle_tool_cursor,                             tool->toggle_cursor_modifier);     }   else     {       gimp_tool_set_cursor (tool, gdisp,                             tool->cursor,                             tool->tool_cursor,                             tool->cursor_modifier);     }
endif|#
directive|endif
block|}
end_function
