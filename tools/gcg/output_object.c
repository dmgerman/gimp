...
begin_function
DECL|function|pr_abstract_member (File * s,PrimType * t,Id name)
name|void
...
name|s
argument_list|,
literal|"%3(GTK_OBJECT(self)->klass)->%s"
argument_list|,
name|pr_macro_name
argument_list|,
name|t
...
begin_function
DECL|function|pr_real_varname (File * s,PrimType * t,Id name)
name|void
name|pr_real_varname
parameter_list|(
name|File
modifier|*
name|s
...
begin_function
DECL|function|output_method (Method * m)
name|void
name|output_method
parameter_list|(
name|Method
