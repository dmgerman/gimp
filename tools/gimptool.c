...
begin_comment
comment|/*  * Gimptool rewritten in C, originally for Win32, where end-users who  * might want to build and install a plug-in from source don't  * necessarily have any Bourne-compatible shell to run the gimptool  * script in. Later fixed up to replace the gimptool script on all  * platforms.  */
end_comment
...
begin_decl_stmt
DECL|variable|cli_exec_prefix
specifier|static
specifier|const
name|gchar
modifier|*
name|cli_exec_prefix
decl_stmt|;
end_decl_stmt
...
begin_define
DECL|macro|REMOVE_DIR
define|#
directive|define
name|REMOVE_DIR
value|win32_command ("rd /s /q")
end_define
...
begin_struct
DECL|struct|__anon2a2bf7730108
specifier|static
struct|struct
block|{
DECL|member|option
...
specifier|static
name|gboolean
DECL|function|starts_with_dir (const gchar * string,const gchar * dir)
...
condition|)
block|{
comment|/* It's known GCC recognizes .CPP and .cxx, so bypass these suffixes */
if|if
condition|(
name|p
operator|!=
...
condition|)
block|{
comment|/* It's known Clang recognizes .CC, .CPP, .cxx and .CXX,            * so bypass these suffixes            */
if|if
condition|(
name|p
operator|!=
...
name|gchar
modifier|*
DECL|function|get_user_plugin_dir (void)
...
name|gchar
modifier|*
DECL|function|get_plugin_dir (const gchar * base_dir,const gchar * what)
name|get_plugin_dir
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|void
DECL|function|do_uninstall (const gchar * dir)
name|do_uninstall
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|void
DECL|function|do_uninstall_script_2 (const gchar * dir,const gchar * what)
name|do_uninstall_script_2
parameter_list|(
specifier|const
name|gchar
modifier|*
...
name|gchar
modifier|*
DECL|function|get_user_script_dir (void)
...
name|gchar
modifier|*
DECL|function|get_sys_script_dir (void)
