...
begin_comment
comment|/**  * gimp_pixbuf_create_buffer:  * @pixbuf: a #GdkPixbuf  *  * Returns a #GeglBuffer that's backed by the @pixbuf's pixels, without  * copying them. This function refs the pixbuf, so it will be kept  * around for as long as te buffer exists.  *  * Return value: a new #GeglBuffer as a wrapper around @pixbuf.  *  * Since: GIMP 2.10  **/
end_comment
