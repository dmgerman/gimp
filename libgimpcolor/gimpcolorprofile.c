...
argument_list|,
literal|"linear TRC variant generated by GIMP"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|cmsSigProfileDescriptionTag
argument_list|,
literal|"sRGB TRC variant generated by GIMP"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|model
argument_list|,
literal|"Generated from '"
argument_list|)
condition|)
block|{
comment|/* don't add multiple "Generated from 'foo'" */
name|new_model
operator|=
name|g_strdup
argument_list|(
