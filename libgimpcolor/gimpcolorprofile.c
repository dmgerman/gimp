...
name|GimpColorProfile
modifier|*
DECL|function|gimp_color_profile_new_from_profile (GimpColorProfile * profile,gboolean linear)
name|gimp_color_profile_new_from_profile
parameter_list|(
name|GimpColorProfile
modifier|*
name|profile
...
argument_list|,
literal|"GIMP generated with linear gamma TRC"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|cmsSigProfileDescriptionTag
argument_list|,
literal|"GIMP generated with sRGB gamma TRC"
argument_list|)
expr_stmt|;
block|}
name|cmsWriteTag
