...
parameter_list|)
define|\
value|do                                                                         \       {                                                                        \         if (has_alpha)                                                         \           {                                                                    \             if (rgb)                                                           \               {                                                                \                 *lcms_format = TYPE_RGBA_##lcms_t;                             \                                                                                \                 if (linear)                                                    \                   output_format = babl_format ("RGBA " babl_t);                \                 else                                                           \                   output_format = babl_format ("R'G'B'A " babl_t);             \               }                                                                \             else if (gray)                                                     \               {                                                                \                 *lcms_format = TYPE_GRAYA_##lcms_t;                            \                                                                                \                 if (linear)                                                    \                   output_format = babl_format ("YA " babl_t);                  \                 else                                                           \                   output_format = babl_format ("Y'A " babl_t);                 \               }                                                                \             else if (cmyk)                                                     \               {                                                                \                 *lcms_format = TYPE_CMYKA_##lcms_t;                            \                                                                                \                 output_format = format;                                        \               }                                                                \           }                                                                    \         else                                                                   \           {                                                                    \             if (rgb)                                                           \               {                                                                \                 *lcms_format = TYPE_RGB_##lcms_t;                              \                                                                                \                 if (linear)                                                    \                   output_format = babl_format ("RGB " babl_t);                 \                 else                                                           \                   output_format = babl_format ("R'G'B' " babl_t);              \               }                                                                \             else if (gray)                                                     \               {                                                                \                 *lcms_format = TYPE_GRAY_##lcms_t;                             \                                                                                \                 if (linear)                                                    \                   output_format = babl_format ("Y " babl_t);                   \                 else                                                           \                   output_format = babl_format ("Y' " babl_t);                  \               }                                                                \             else if (cmyk)                                                     \               {                                                                \                 *lcms_format = TYPE_CMYK_##lcms_t;                             \                                                                                \                 output_format = format;                                        \               }                                                                \           }                                                                    \       }                                                                        \     while (FALSE)
if|if
condition|(
name|type
operator|==
