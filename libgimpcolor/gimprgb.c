...
begin_function
name|void
DECL|function|gimp_rgb_set_pixel (GimpRGB * rgb,const Babl * format,gconstpointer pixel)
...
begin_function
name|void
DECL|function|gimp_rgb_get_pixel (const GimpRGB * rgb,const Babl * format,gpointer pixel)
...
begin_function
name|void
DECL|function|gimp_rgba_set_pixel (GimpRGB * rgba,const Babl * format,gconstpointer pixel)
...
begin_function
name|void
DECL|function|gimp_rgba_get_pixel (const GimpRGB * rgba,const Babl * format,gpointer pixel)
...
begin_function
name|void
DECL|function|gimp_param_spec_rgb_get_default (GParamSpec * pspec,GimpRGB * default_value)
