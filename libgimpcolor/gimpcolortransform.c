...
begin_comment
comment|/**  * gimp_color_transform_new:  * @src_profile:  * @src_format:  * @desr_profile:  * @dest_format:  * @rendering_intent:  * @flags:  *  * This function creates an color transform.  *  * Return value: the #GimpColorTransform, or %NULL.  *  * Since: 2.10  **/
end_comment
