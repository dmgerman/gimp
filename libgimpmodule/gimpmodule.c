...
name|GimpModule
modifier|*
DECL|function|gimp_module_new (const gchar * filename,const gchar * inhibit_list,gboolean verbose)
...
begin_function
name|void
DECL|function|gimp_module_set_load_inhibit (GimpModule * module,const gchar * inhibit_list)
name|gimp_module_set_load_inhibit
parameter_list|(
name|GimpModule
modifier|*
