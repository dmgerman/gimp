...
define|#
directive|define
name|TAG_LINE_DELIMITER
value|"\v"
end_define

begin_define
DECL|macro|TAG_TAG_DELIMITER
define|#
directive|define
name|TAG_TAG_DELIMITER
value|"#"
end_define
...
specifier|static
name|gboolean
name|gimp_metadata_get_rational
parameter_list|(
specifier|const
name|gchar
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2c3b9d9a0108
block|{
DECL|member|name
name|gchar
name|name
...
name|gchar
modifier|*
DECL|function|gimp_metadata_escape (const gchar * name,const gchar * value)
...
name|g_printerr
argument_list|(
literal|"Invalid UTF-8 in metadata value %s: %s\n"
argument_list|,
name|name
argument_list|,
name|value
...
begin_comment
comment|/**  * determines the amount of delimiters in serialized  * metadata string  */
end_comment

begin_function
specifier|static
name|gint
DECL|function|gimp_metadata_length (const gchar * testline,const gchar * delim)
name|gimp_metadata_length
parameter_list|(
specifier|const
name|gchar
...
begin_comment
comment|/**  * gets rational values from string  */
end_comment

begin_function
specifier|static
name|gboolean
DECL|function|gimp_metadata_get_rational (const gchar * value,gint sections,gchar *** numerator,gchar *** denominator)
name|gimp_metadata_get_rational
parameter_list|(
specifier|const
name|gchar
