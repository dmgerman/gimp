...
name|g_printerr
argument_list|(
literal|"Failed to register XMP namespace 'DICOM'\n"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|g_printerr
argument_list|(
literal|"Failed to register XMP namespace 'GIMP'\n"
argument_list|)
expr_stmt|;
block|}
block|}
...
argument_list|)
expr_stmt|;
comment|/* FIXME!    * This call can return NULL.    */
if|if
condition|(
operator|!
name|filename
...
name|_
argument_list|(
literal|"Invalid Exif data size."
argument_list|)
argument_list|)
expr_stmt|;
return|return
...
specifier|static
name|void
DECL|function|gimp_metadata_copy_tag (GExiv2Metadata * src,GExiv2Metadata * dest,const gchar * tag)
name|gimp_metadata_copy_tag
parameter_list|(
name|GExiv2Metadata
modifier|*
...
specifier|static
name|void
DECL|function|gimp_metadata_copy_tags (GExiv2Metadata * src,GExiv2Metadata * dest,const gchar ** tags)
name|gimp_metadata_copy_tags
parameter_list|(
name|GExiv2Metadata
modifier|*
