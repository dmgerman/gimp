...
begin_function
name|gboolean
DECL|function|gimp_output_stream_printf (GOutputStream * stream,gsize * bytes_written,GCancellable * cancellable,GError ** error,const gchar * format,...)
...
begin_function
name|gboolean
DECL|function|gimp_output_stream_vprintf (GOutputStream * stream,gsize * bytes_written,GCancellable * cancellable,GError ** error,const gchar * format,va_list args)
name|gimp_output_stream_vprintf
parameter_list|(
name|GOutputStream
modifier|*
