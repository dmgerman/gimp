...
directive|if
literal|0
comment|/* found on stackoverflow, please turn this into working code...      */
block|void BrowseToFile(LPCTSTR filename)     {       ITEMIDLIST *pidl = ILCreateFromPath (filename);       if (pidl)         {           SHOpenFolderAndSelectItems (pidl, 0, 0, 0);           ILFree (pidl);         }     }
endif|#
directive|endif
...
literal|0
argument_list|,
literal|"Please implement something in "
...
literal|0
comment|/* found on stackoverflow, please turn this into working code...      */
block|NSArray *fileURLs = [NSArray arrayWithObjects:fileURL1,
comment|/* ... */
block|nil];      [[NSWorkspace sharedWorkspace] activateFileViewerSelectingURLs:fileURLs];
endif|#
directive|endif
name|g_set_error_literal
argument_list|(
