...
begin_comment
comment|/**  * gimp_enum_get_value:  * @enum_type:  the #GType of a registered enum  * @value:      an integer value  * @value_nick: return location for the value's nick (or %NULL)  * @value_name: return location for the value's translated name (or %NULL)  *  * Checks if @value is valid for the enum registered as @enum_type.  * If the value exists in that enum, its nick and its translated name  * are returned (if @value_nick and @value_name are not %NULL).  *  * Return value: %TRUE if @value is valid for the @enum_type,  *               %FALSE otherwise  *  * Since: GIMP 2.2  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_enum_get_value (GType enum_type,gint value,const gchar ** value_nick,const gchar ** value_name)
...
begin_comment
comment|/**  * gimp_enum_value_get_name:  * @enum_class: a #GEnumClass  * @enum_value: a #GEnumValue from @enum_class  *  * Retrieves the translated name for a given @enum_value.  *  * Return value: the translated name of the enum value  *  * Since: GIMP 2.2  **/
end_comment
...
name|gchar
modifier|*
DECL|function|gimp_enum_value_get_name (GEnumClass * enum_class,GEnumValue * enum_value)
