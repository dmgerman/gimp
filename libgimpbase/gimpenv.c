...
ifndef|#
directive|ifndef
name|CSIDL_MYDOCUMENTS
end_ifndef

begin_define
DECL|macro|CSIDL_MYDOCUMENTS
define|#
directive|define
name|CSIDL_MYDOCUMENTS
value|0x000C
...
name|gchar
modifier|*
DECL|function|find_folder (OSType type)
name|find_folder
parameter_list|(
name|OSType
name|type
...
begin_decl_stmt
DECL|variable|gimp_user_directories
specifier|static
name|gchar
modifier|*
modifier|*
name|gimp_user_directories
init|=
name|NULL
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/**  * gimp_user_directory:  * @type: the type of user directory to retrieve  *  * Identifies special folders used frequently by applications, but  * which may not have the same name or location on any given system.   * Plug-ins may want to use this function to add shortcuts to such  * folders to a file-chooser.  *  * Returns: The path to the specified user directory, or %NULL if the  *          logical ID was not found.  *  * Since: GIMP 2.4  **/
end_comment
...
directive|endif
comment|/* Special-case desktop for historical compatibility */
if|if
condition|(
name|gimp_user_directories
index|[
