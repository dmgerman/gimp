...
begin_comment
comment|/**  * gimp_user_directory:  * @type: the type of user directory to retrieve  *  * Identifies special folders used frequently by applications, but  * which may not have the same name or location on any given system.   * Plug-ins may want to use this function to add shortcuts to such  * folders to a file-chooser.  *  * Returns: a newly allocated directory name in filesystem encoding,  *          or %NULL  *  * Since: GIMP 2.4  **/
end_comment
