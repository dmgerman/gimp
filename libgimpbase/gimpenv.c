...
argument_list|)
expr_stmt|;
comment|/* g_locale_from_utf8() can fail in pathological cases, namely        * when the folder contains characters not in the system codepage,        * like Hebrew on a Western European machine.        */
if|if
condition|(
name|tmp
operator|==
...
condition|)
block|{
comment|/* Try to get the short name instead */
name|wchar_t
modifier|*
name|w_name
init|=
