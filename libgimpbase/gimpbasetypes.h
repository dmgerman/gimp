...
begin_comment
comment|/* XXX FIXME move these to a separate file */
end_comment
...
begin_define
DECL|macro|GIMP_DEPRECATED_FOR (f)
define|#
directive|define
...
begin_define
DECL|macro|GIMP_UNAVAILABLE (maj,min)
define|#
directive|define
name|GIMP_UNAVAILABLE
parameter_list|(
name|maj
parameter_list|,
name|min
