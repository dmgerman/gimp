...
specifier|static
name|gboolean
DECL|function|_gp_param_def_read (GIOChannel * channel,GPParamDef * param_def,gpointer user_data)
name|_gp_param_def_read
parameter_list|(
name|GIOChannel
modifier|*
name|channel
...
specifier|static
name|void
DECL|function|_gp_param_def_destroy (GPParamDef * param_def)
name|_gp_param_def_destroy
parameter_list|(
name|GPParamDef
modifier|*
name|param_def
...
specifier|static
name|gboolean
DECL|function|_gp_param_def_write (GIOChannel * channel,GPParamDef * param_def,gpointer user_data)
name|_gp_param_def_write
parameter_list|(
name|GIOChannel
modifier|*
name|channel
