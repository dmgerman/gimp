...
typedef|typedef
name|struct
name|_GimpStringArray
name|GimpStringArray
typedef|;
end_typedef

begin_struct
DECL|struct|_GimpStringArray
struct|struct
name|_GimpStringArray
block|{
DECL|member|data
...
begin_typedef
DECL|typedef|GimpObjectArray
typedef|typedef
name|struct
name|_GimpObjectArray
name|GimpObjectArray
typedef|;
end_typedef

begin_struct
DECL|struct|_GimpObjectArray
struct|struct
name|_GimpObjectArray
block|{
...
begin_define
DECL|macro|GIMP_TYPE_OBJECT_ARRAY
define|#
directive|define
name|GIMP_TYPE_OBJECT_ARRAY
value|(gimp_object_array_get_type ())
end_define

begin_define
DECL|macro|GIMP_VALUE_HOLDS_OBJECT_ARRAY (value)
define|#
directive|define
...
name|value
parameter_list|)
value|(G_TYPE_CHECK_VALUE_TYPE ((value), GIMP_TYPE_OBJECT_ARRAY))
end_define
...
begin_define
DECL|macro|GIMP_TYPE_PARAM_OBJECT_ARRAY
define|#
directive|define
name|GIMP_TYPE_PARAM_OBJECT_ARRAY
value|(gimp_param_object_array_get_type ())
end_define

begin_define
DECL|macro|GIMP_PARAM_SPEC_OBJECT_ARRAY (pspec)
define|#
directive|define
...
name|pspec
parameter_list|)
value|(G_TYPE_CHECK_INSTANCE_CAST ((pspec), GIMP_TYPE_PARAM_OBJECT_ARRAY, GimpParamSpecObjectArray))
end_define

begin_define
DECL|macro|GIMP_IS_PARAM_SPEC_OBJECT_ARRAY (pspec)
define|#
directive|define
...
name|pspec
parameter_list|)
value|(G_TYPE_CHECK_INSTANCE_TYPE ((pspec), GIMP_TYPE_PARAM_OBJECT_ARRAY))
end_define

begin_typedef
DECL|typedef|GimpParamSpecObjectArray
typedef|typedef
name|struct
name|_GimpParamSpecObjectArray
name|GimpParamSpecObjectArray
typedef|;
end_typedef

begin_struct
DECL|struct|_GimpParamSpecObjectArray
struct|struct
name|_GimpParamSpecObjectArray
block|{
DECL|member|parent_instance
