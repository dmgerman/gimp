...
block|,
comment|/*< desc="Vertical lines from right to left (mixed orientation)">*/
DECL|enumerator|GIMP_TEXT_DIRECTION_TTB_RTL_UPRIGHT
name|GIMP_TEXT_DIRECTION_TTB_RTL_UPRIGHT
block|,
comment|/*< desc="Vertical lines from right to left (upright characters)">*/
DECL|enumerator|GIMP_TEXT_DIRECTION_TTB_LTR
name|GIMP_TEXT_DIRECTION_TTB_LTR
block|,
comment|/*< desc="Vertical lines from left to right (mixed orientation)">*/
DECL|enumerator|GIMP_TEXT_DIRECTION_TTB_LTR_UPRIGHT
name|GIMP_TEXT_DIRECTION_TTB_LTR_UPRIGHT
comment|/*< desc="Vertical lines from left to right (upright characters)">*/
