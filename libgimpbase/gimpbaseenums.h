...
begin_comment
comment|/**  * GimpForegroundExtractMode:  * @GIMP_FOREGROUND_EXTRACT_SIOX:    Siox  * @GIMP_FOREGROUND_EXTRACT_MATTING: Matting (Since 2.10)  *  * Foreground extract engines.  **/
end_comment
