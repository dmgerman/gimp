...
begin_function
name|void
DECL|function|_gimp_color_area_render_buf (GimpColorAreaType type,guchar * buf,guint width,guint height,guint rowstride,GimpRGB * color)
