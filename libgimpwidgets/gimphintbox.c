...
begin_struct
DECL|struct|_GimpHintBoxPrivate
struct|struct
name|_GimpHintBoxPrivate
block|{
...
begin_macro
DECL|function|G_DEFINE_TYPE_WITH_PRIVATE (GimpHintBox,gimp_hint_box,GTK_TYPE_BOX)
...
name|priv
operator|=
name|gimp_hint_box_get_instance_private
argument_list|(
name|box
argument_list|)
expr_stmt|;
