...
literal|0
block|,
DECL|enumerator|GIMP_WIDGET_HELP_TYPE_TIPS_QUERY
name|GIMP_WIDGET_HELP_TYPE_TIPS_QUERY
init|=
literal|0xff
operator|+
literal|1
...
specifier|static
name|void
DECL|function|gimp_help_callback (GtkWidget * widget,GimpWidgetHelpType help_type,gpointer data)
name|gimp_help_callback
parameter_list|(
name|GtkWidget
modifier|*
