...
begin_comment
comment|/**  * gimp_zoom_model_get_factor:  * @model: a #GimpZoomModel  *  * Retrieve the current zoom factor of @model.  *  * Return value: the current scale factor  *  * Since GIMP 2.4  **/
end_comment
...
begin_comment
comment|/**  * gimp_zoom_widget_new:  * @model: a #GimpZoomModel  * @type: the type of widget to create  *  * Creates a new widget to interact with the #GimpZoomModel.  *  * Return value: a new #GtkWidget.  *  * Since GIMP 2.4  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_zoom_widget_new (GimpZoomModel * model,GimpZoomWidgetType type)
...
begin_comment
comment|/**  * gimp_zoom_model_get_fraction  * @zoom_factor: a scale factor  * @numerator: return location for numerator  * @denominator: return location for denominator  *  * Utility function that expresses @zoom_factor as a fraction.  *  * Since GIMP 2.4  **/
end_comment
...
begin_comment
comment|/**  * gimp_zoom_model_zoom_step:  * @zoom_type:  * @scale:  *  * Utility function to calculate a new scale factor.  *  * Return value: the new scale factor  *  * Since GIMP 2.4  **/
end_comment
