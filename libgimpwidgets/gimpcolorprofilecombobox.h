...
argument_list|(
argument|gimp_color_profile_combo_box_add_file
argument_list|)
end_macro
...
name|GIMP_DEPRECATED_FOR
argument_list|(
argument|gimp_color_profile_combo_box_set_active_file
argument_list|)
end_macro
...
name|GIMP_DEPRECATED_FOR
argument_list|(
argument|gimp_color_profile_combo_box_get_active_file
argument_list|)
end_macro
