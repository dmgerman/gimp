...
name|GtkWidget
modifier|*
DECL|function|gimp_color_selector_new (GType selector_type,const GimpRGB * rgb,const GimpHSV * hsv)
...
begin_function
name|void
DECL|function|gimp_color_selector_color_changed (GimpColorSelector * selector,const GimpRGB * rgb,const GimpHSV * hsv)
