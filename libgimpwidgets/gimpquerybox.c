...
name|GtkWidget
modifier|*
DECL|function|gimp_query_boolean_box (gchar * title,GimpHelpFunc help_func,gchar * help_data,gchar * message,gchar * true_button,gchar * false_button,GtkObject * object,gchar * signal,GimpQueryBooleanCallback callback,gpointer data)
