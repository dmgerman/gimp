...
name|callback_data
decl_stmt|;
DECL|member|callback_data_destroy
name|GDestroyNotify
...
name|QueryBox
modifier|*
DECL|function|create_query_box (const gchar * title,GtkWidget * parent,GimpHelpFunc help_func,const gchar * help_id,GCallback response_callback,const gchar * icon_name,const gchar * message,const gchar * ok_button,const gchar * cancel_button,GObject * object,const gchar * signal,GCallback callback,gpointer callback_data,GDestroyNotify callback_data_destroy)
name|create_query_box
parameter_list|(
specifier|const
name|gchar
...
begin_comment
comment|/**  * gimp_query_int_box:  * @title:        The query box dialog's title.  * @parent:       The dialog's parent widget.  * @help_func:    (scope async): The help function to show this dialog's help page.  * @help_id:      A string identifying this dialog's help page.  * @message:      A string which will be shown above the dialog's entry widget.  * @initial:      The initial value.  * @lower:        The lower boundary of the range of possible values.  * @upper:        The upper boundray of the range of possible values.  * @object:       The object this query box is associated with.  * @signal:       The object's signal which will cause the query box to be closed.  * @callback:     The function which will be called when the user selects "OK".  * @data:         The callback's user data.  * @data_destroy: Destroy function for @data.  *  * Creates a new #GtkDialog that queries the user for an integer value.  *  * Returns: (transfer full): A pointer to the new #GtkDialog.  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_query_int_box (const gchar * title,GtkWidget * parent,GimpHelpFunc help_func,const gchar * help_id,const gchar * message,gint initial,gint lower,gint upper,GObject * object,const gchar * signal,GimpQueryIntCallback callback,gpointer data,GDestroyNotify data_destroy)
...
begin_comment
comment|/**  * gimp_query_double_box:  * @title:       The query box dialog's title.  * @parent:      The dialog's parent widget.  * @help_func:   (scope async): The help function to show this dialog's help page.  * @help_id:     A string identifying this dialog's help page.  * @message:     A string which will be shown above the dialog's entry widget.  * @initial:     The initial value.  * @lower:       The lower boundary of the range of possible values.  * @upper:       The upper boundray of the range of possible values.  * @digits:      The number of decimal digits the #GtkSpinButton will provide.  * @object:      The object this query box is associated with.  * @signal:      The object's signal which will cause the query box to be closed.  * @callback:    The function which will be called when the user selects "OK".  * @data:        The callback's user data.  * @data_destroy: Destroy function for @data.  *  * Creates a new #GtkDialog that queries the user for a double value.  *  * Returns: (transfer full): A pointer to the new #GtkDialog.  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_query_double_box (const gchar * title,GtkWidget * parent,GimpHelpFunc help_func,const gchar * help_id,const gchar * message,gdouble initial,gdouble lower,gdouble upper,gint digits,GObject * object,const gchar * signal,GimpQueryDoubleCallback callback,gpointer data,GDestroyNotify data_destroy)
