...
specifier|static
name|gboolean
name|gimp_scrolled_preview_nav_popup_draw
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
directive|if
literal|0
block|GIMP_PREVIEW (preview)->width  = MIN (xmax - xmin, allocation->width);   GIMP_PREVIEW (preview)->height = MIN (ymax - ymin, allocation->height);
endif|#
directive|endif
name|gimp_scrolled_preview_hscr_update
argument_list|(
...
specifier|static
name|gboolean
DECL|function|gimp_scrolled_preview_nav_popup_draw (GtkWidget * widget,cairo_t * cr,GimpScrolledPreview * preview)
name|gimp_scrolled_preview_nav_popup_draw
parameter_list|(
name|GtkWidget
modifier|*
...
begin_function
name|void
DECL|function|gimp_scrolled_preview_get_adjustments (GimpScrolledPreview * preview,GtkAdjustment ** hadj,GtkAdjustment ** vadj)
...
begin_function
name|void
DECL|function|gimp_scroll_adjustment_values (GdkEventScroll * sevent,GtkAdjustment * hadj,GtkAdjustment * vadj,gdouble * hvalue,gdouble * vvalue)
name|gimp_scroll_adjustment_values
parameter_list|(
name|GdkEventScroll
modifier|*
