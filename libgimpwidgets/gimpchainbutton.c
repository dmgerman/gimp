...
begin_struct
DECL|struct|_GimpChainButtonPrivate
struct|struct
name|_GimpChainButtonPrivate
block|{
...
name|obj
parameter_list|)
value|(((GimpChainButton *) (obj))->priv)
end_define

begin_function_decl
specifier|static
name|void
name|gimp_chain_button_constructed
parameter_list|(
name|GObject
modifier|*
name|object
...
argument_list|)
expr_stmt|;
comment|/**    * GimpChainButton:icon-size:    *    * The chain button icon size.    *    * Since: 2.10.10    */
name|g_object_class_install_property
argument_list|(
name|object_class
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/**    * GimpChainButton:active:    *    * The toggled state of the chain button.    *    * Since: 2.10.10    */
name|g_object_class_install_property
argument_list|(
name|object_class
argument_list|,
...
literal|"Active"
argument_list|,
literal|"The chain's toggled state"
argument_list|,
name|FALSE
argument_list|,
name|G_PARAM_CONSTRUCT
...
name|priv
operator|=
name|gimp_chain_button_get_instance_private
argument_list|(
name|button
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|gimp_chain_button_constructed (GObject * object)
name|gimp_chain_button_constructed
parameter_list|(
name|GObject
modifier|*
...
begin_comment
comment|/**  * gimp_chain_button_set_icon_size:  * @button: Pointer to a #GimpChainButton.  * @size: The new icon size.  *  * Sets the icon size of the #GimpChainButton.  *  * Since: 2.10.10  */
end_comment

begin_function
name|void
DECL|function|gimp_chain_button_set_icon_size (GimpChainButton * button,GtkIconSize size)
...
begin_comment
comment|/**  * gimp_chain_button_get_icon_size:  * @button: Pointer to a #GimpChainButton.  *  * Gets the icon size of the #GimpChainButton.  *  * Returns: The icon size.  *  * Since: 2.10.10  */
end_comment

begin_function
name|GtkIconSize
DECL|function|gimp_chain_button_get_icon_size (GimpChainButton * button)
name|gimp_chain_button_get_icon_size
parameter_list|(
name|GimpChainButton
modifier|*
name|button
...
begin_comment
comment|/**  * gimp_chain_button_get_button  * @button: A #GimpChainButton.  *  * Returns: (transfer none): The #GimpChainButton's button.  *  * Since: 3.0  */
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_chain_button_get_button (GimpChainButton * button)
...
specifier|static
name|gboolean
DECL|function|gimp_chain_line_draw (GtkWidget * widget,cairo_t * cr)
name|gimp_chain_line_draw
parameter_list|(
name|GtkWidget
modifier|*
