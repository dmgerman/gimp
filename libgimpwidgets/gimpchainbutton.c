...
begin_typedef
DECL|typedef|GimpChainButtonPrivate
typedef|typedef
name|struct
...
name|obj
parameter_list|)
value|G_TYPE_INSTANCE_GET_PRIVATE (obj, \                                                       GIMP_TYPE_CHAIN_BUTTON, \                                                       GimpChainButtonPrivate)
end_define
