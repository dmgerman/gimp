...
specifier|static
name|void
name|gimp_size_entry_value_focus_out_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_size_entry_refval_focus_out_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_comment
comment|/*  this is a hack to avoid infinite recursion when calling the  *  boundary functions  */
end_comment

begin_decl_stmt
DECL|variable|gimp_size_entry_stop_recursion
specifier|static
name|gint
name|gimp_size_entry_stop_recursion
init|=
literal|0
decl_stmt|;
end_decl_stmt
...
specifier|static
name|void
DECL|function|gimp_size_entry_value_focus_out_callback (GtkWidget * widget,GdkEvent * event,gpointer data)
name|gimp_size_entry_value_focus_out_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_size_entry_refval_focus_out_callback (GtkWidget * widget,GdkEvent * event,gpointer data)
name|gimp_size_entry_refval_focus_out_callback
parameter_list|(
name|GtkWidget
modifier|*
