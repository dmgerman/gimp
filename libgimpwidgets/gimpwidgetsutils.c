...
typedef|typedef
struct|struct
DECL|struct|__anon2af0e7aa0108
block|{
DECL|member|widget
name|GtkWidget
modifier|*
...
begin_comment
comment|/**  * gimp_screen_get_color_profile:  * @screen:  a #GdkScreen  * @monitor: the monitor number  *  * This function returns the #GimpColorProfile of monitor number @monitor  * of @screen, or %NULL if there is no profile configured.  *  * Since: 2.10  *  * Return value: the monitor's #GimpColorProfile, or %NULL.  **/
end_comment

begin_function
name|GimpColorProfile
modifier|*
DECL|function|gimp_screen_get_color_profile (GdkScreen * screen,gint monitor)
