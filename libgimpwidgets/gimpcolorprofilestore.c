...
specifier|static
name|void
name|gimp_color_profile_store_constructed
parameter_list|(
name|GObject
modifier|*
name|object
...
name|G_TYPE_FILE
block|,
comment|/*  GIMP_COLOR_PROFILE_STORE_FILE       */
name|G_TYPE_INT
...
specifier|static
name|void
DECL|function|gimp_color_profile_store_constructed (GObject * object)
name|gimp_color_profile_store_constructed
parameter_list|(
name|GObject
modifier|*
...
begin_function
name|void
DECL|function|gimp_color_profile_store_add_file (GimpColorProfileStore * store,GFile * file,const gchar * label)
name|gimp_color_profile_store_add_file
parameter_list|(
name|GimpColorProfileStore
modifier|*
...
begin_function
name|gboolean
DECL|function|_gimp_color_profile_store_history_add (GimpColorProfileStore * store,GFile * file,const gchar * label,GtkTreeIter * iter)
...
specifier|static
name|gboolean
DECL|function|gimp_color_profile_store_history_insert (GimpColorProfileStore * store,GtkTreeIter * iter,GFile * file,const gchar * label,gint index)
name|gimp_color_profile_store_history_insert
parameter_list|(
name|GimpColorProfileStore
modifier|*
