...
specifier|static
name|void
name|gimp_color_scales_set_model_visible
parameter_list|(
name|GimpColorSelector
modifier|*
name|selector
...
specifier|static
name|void
name|gimp_color_scales_toggle_lch_hsv
parameter_list|(
...
name|babl_format
argument_list|(
literal|"CIE LCH(ab) alpha double"
argument_list|)
argument_list|)
expr_stmt|;
name|fish_lch_to_rgb
...
argument_list|)
expr_stmt|;
comment|/*  don't need the toggles for our own operation  */
name|selector
operator|->
...
specifier|static
name|void
DECL|function|gimp_color_scales_set_model_visible (GimpColorSelector * selector,GimpColorSelectorModel model,gboolean visible)
name|gimp_color_scales_set_model_visible
parameter_list|(
name|GimpColorSelector
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_scales_toggle_lch_hsv (GtkToggleButton * toggle,GimpColorScales * scales)
name|gimp_color_scales_toggle_lch_hsv
parameter_list|(
name|GtkToggleButton
modifier|*
