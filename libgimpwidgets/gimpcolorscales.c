...
specifier|static
name|void
name|gimp_color_scales_switch_page
parameter_list|(
name|GtkNotebook
modifier|*
name|notebook
...
specifier|static
name|void
name|gimp_color_scales_model_changed
parameter_list|(
name|GimpColorSelector
modifier|*
name|selector
...
argument_list|)
expr_stmt|;
name|gtk_notebook_set_tab_label_text
argument_list|(
name|GTK_NOTEBOOK
argument_list|(
name|notebook
...
argument_list|)
expr_stmt|;
comment|/* This works because we ordered the notebook tabs in the same order    * as the GimpColorSelectorModel enum.    */
...
specifier|static
name|void
DECL|function|gimp_color_scales_switch_page (GtkNotebook * notebook,GtkWidget * page,gint num,GimpColorScales * scales)
name|gimp_color_scales_switch_page
parameter_list|(
name|GtkNotebook
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_scales_model_changed (GimpColorSelector * selector,GimpColorSelectorModel model,GtkNotebook * notebook)
name|gimp_color_scales_model_changed
parameter_list|(
name|GimpColorSelector
modifier|*
