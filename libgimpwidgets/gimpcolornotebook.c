...
begin_struct
DECL|struct|_GimpColorNotebookPrivate
struct|struct
name|_GimpColorNotebookPrivate
block|{
...
name|obj
parameter_list|)
value|(((GimpColorNotebook *) obj)->priv)
end_define

begin_function_decl
specifier|static
name|void
name|gimp_color_notebook_style_updated
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_color_notebook_set_model_visible
parameter_list|(
name|GimpColorSelector
modifier|*
name|selector
...
specifier|static
name|void
name|gimp_color_notebook_model_visible_changed
parameter_list|(
name|GimpColorSelector
modifier|*
name|page
...
specifier|static
name|void
DECL|function|gimp_color_notebook_style_updated (GtkWidget * widget)
name|gimp_color_notebook_style_updated
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_notebook_set_model_visible (GimpColorSelector * selector,GimpColorSelectorModel model,gboolean visible)
name|gimp_color_notebook_set_model_visible
parameter_list|(
name|GimpColorSelector
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_notebook_model_visible_changed (GimpColorSelector * page,GimpColorSelectorModel model,gboolean visible,GimpColorNotebook * notebook)
name|gimp_color_notebook_model_visible_changed
parameter_list|(
name|GimpColorSelector
modifier|*
...
begin_comment
comment|/**  * gimp_color_notebook_set_has_page:  * @notebook:  A #GimpColorNotebook widget.  * @page_type: The #GType of the notebook page to add or remove.  * @has_page:  Whether the page should be added or removed.  *  * This function adds and removed pages to / from a #GimpColorNotebook.  * The @page_type passed must be a #GimpColorSelector subtype.  *  * Returns: (transfer none): The new page widget, if @has_page was  *               %TRUE, or %NULL if @has_page was %FALSE.  **/
end_comment
...
begin_comment
comment|/**  * gimp_color_notebook_get_notebook:  * @notebook:  A #GimpColorNotebook widget.  *  * Returns: (transfer none): The #GtkNotebook inside.  *  * Since: 3.0  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_color_notebook_get_notebook (GimpColorNotebook * notebook)
...
begin_comment
comment|/**  * gimp_color_notebook_get_selectors:  * @notebook:  A #GimpColorNotebook widget.  *  * Returns: (element-type GimpColorSelector) (transfer none): The  *               notebook's list of #GimpColorSelector's.  *  * Since: 3.0  **/
end_comment

begin_function
name|GList
modifier|*
DECL|function|gimp_color_notebook_get_selectors (GimpColorNotebook * notebook)
name|gimp_color_notebook_get_selectors
parameter_list|(
name|GimpColorNotebook
modifier|*
name|notebook
...
begin_comment
comment|/**  * gimp_color_notebook_get_current_selector:  * @notebook:  A #GimpColorNotebook widget.  *  * Returns: (transfer none): The active page's #GimpColorSelector.  *  * Since: 3.0  **/
end_comment

begin_function
name|GimpColorSelector
modifier|*
DECL|function|gimp_color_notebook_get_current_selector (GimpColorNotebook * notebook)
