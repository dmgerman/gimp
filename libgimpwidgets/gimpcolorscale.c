...
specifier|static
name|void
name|gimp_color_scale_state_flags_changed
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_color_scale_state_flags_changed (GtkWidget * widget,GtkStateFlags previous_state)
name|gimp_color_scale_state_flags_changed
parameter_list|(
name|GtkWidget
modifier|*
