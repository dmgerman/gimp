...
argument_list|)
expr_stmt|;
comment|/*  This is so ugly... we have to babl_init() here so the binary    *  generated by gtk-doc to scan libgimpwidgets' types won't crash.    *  I didn't find a way to inject this line of code into the    *  generated source.    */
name|babl_init
argument_list|()
expr_stmt|;
name|fish_rgb_to_lch
...
specifier|static
name|gboolean
DECL|function|gimp_color_scale_scroll (GtkWidget * widget,GdkEventScroll * event)
name|gimp_color_scale_scroll
parameter_list|(
name|GtkWidget
modifier|*
