...
name|GtkIconSet
modifier|*
DECL|function|sized_icon_set_from_inline (const guchar * inline_data,GtkIconSize size)
name|sized_icon_set_from_inline
parameter_list|(
specifier|const
name|guchar
modifier|*
...
specifier|static
name|void
DECL|function|add_sized (GtkIconFactory * factory,const guchar * inline_data,GtkIconSize size,const gchar * stock_id)
name|add_sized
parameter_list|(
name|GtkIconFactory
modifier|*
