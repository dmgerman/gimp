...
specifier|static
struct|struct
DECL|struct|__anon2949b3f90108
block|{
...
name|GIMP_STOCK_LOWER
block|,
name|stock_button_lower
block|}
block|,
block|{
name|GIMP_STOCK_NEW
block|,
name|stock_button_new
block|}
block|,
block|{
name|GIMP_STOCK_PASTE
...
specifier|static
struct|struct
DECL|struct|__anon2949b3f90208
block|{
DECL|member|stock_id
specifier|const
name|gchar
