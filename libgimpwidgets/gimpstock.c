...
specifier|static
struct|struct
DECL|struct|__anon2979f8a40108
block|{
...
name|GIMP_STOCK_SELECTION_STROKE
block|,
name|stock_button_selection_stroke
block|}
block|,
block|{
name|GIMP_STOCK_SELECTION_TO_PATH
block|,
name|stock_button_selection_to_path
block|}
block|,
block|{
name|GIMP_STOCK_PATH_STROKE
block|,
name|stock_button_path_stroke
block|}
block|,
block|{
name|GIMP_STOCK_TOOL_AIRBRUSH
...
specifier|static
struct|struct
DECL|struct|__anon2979f8a40208
block|{
DECL|member|stock_id
specifier|const
name|gchar
...
name|GIMP_STOCK_CONVERT_RGB
block|,
name|stock_menu_convert_rgb
block|}
block|,
block|{
name|GIMP_STOCK_CONVERT_GRAYSCALE
block|,
name|stock_menu_convert_grayscale
block|}
block|,
block|{
name|GIMP_STOCK_CONVERT_INDEXED
block|,
name|stock_menu_convert_indexed
block|}
block|,
block|{
name|GIMP_STOCK_MERGE_DOWN
block|,
name|stock_menu_merge_down
block|}
block|,
block|{
name|GIMP_STOCK_RESHOW_FILTER
block|,
name|stock_menu_reshow_filter
block|}
block|,
block|{
name|GIMP_STOCK_ROTATE_90
block|,
name|stock_menu_rotate_90
block|}
block|,
block|{
name|GIMP_STOCK_ROTATE_180
block|,
name|stock_menu_rotate_180
block|}
block|,
block|{
name|GIMP_STOCK_ROTATE_270
block|,
name|stock_menu_rotate_270
block|}
block|,
block|{
name|GIMP_STOCK_RESIZE
block|,
name|stock_menu_resize
block|}
block|,
block|{
name|GIMP_STOCK_SCALE
block|,
name|stock_menu_scale
block|}
block|,
block|{
name|GIMP_STOCK_SELECTION_TO_CHANNEL
block|,
name|stock_menu_selection_to_channel
block|}
block|,
block|{
name|GIMP_STOCK_NAVIGATION
