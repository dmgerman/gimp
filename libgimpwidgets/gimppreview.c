...
begin_comment
comment|/**  * gimp_preview_get_table:  * @preview: a #GimpPreview widget  *  * Return value: a pointer to the #GtkTable used in the @preview.  *  * Since: 3.0  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_preview_get_table (GimpPreview * preview)
