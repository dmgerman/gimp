...
begin_function
name|void
DECL|function|gimp_preview_get_bounds (GimpPreview * preview,gint * xmin,gint * ymin,gint * xmax,gint * ymax)
...
begin_function
name|void
DECL|function|gimp_preview_set_offsets (GimpPreview * preview,gint xoff,gint yoff)
...
begin_function
name|void
DECL|function|gimp_preview_get_offsets (GimpPreview * preview,gint * xoff,gint * yoff)
...
begin_comment
comment|/**  * gimp_preview_get_frame:  * @preview: a #GimpPreview widget  *  * Return value: a pointer to the #GtkAspectFrame used in the @preview.  *  * Since: 3.0  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_preview_get_frame (GimpPreview * preview)
...
begin_comment
comment|/**  * gimp_preview_get_grid:  * @preview: a #GimpPreview widget  *  * Return value: a pointer to the #GtkGrid used in the @preview.  *  * Since: 3.0  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_preview_get_grid (GimpPreview * preview)
...
begin_comment
comment|/**  * gimp_preview_set_default_cursor:  * @preview: a #GimpPreview widget  * @cursor:  a #GdkCursor or %NULL  *  * Sets the default mouse cursor for the preview.  Note that this will  * be overridden by a %GDK_FLEUR if the preview has scrollbars, or by a  * %GDK_WATCH when the preview is invalidated.  *  * Since: 2.2  **/
end_comment
...
name|GdkCursor
modifier|*
DECL|function|gimp_preview_get_default_cursor (GimpPreview * preview)
