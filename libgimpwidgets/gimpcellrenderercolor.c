...
specifier|static
name|void
name|gimp_cairo_set_checkerboard
parameter_list|(
name|cairo_t
modifier|*
name|cr
...
begin_comment
comment|/**  * gimp_cairo_set_checkerboard:  * @size:  * @light:  * @dark:  *  * Sets a repeating checkerboard as the source pattern within @cr.  **/
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_cairo_set_checkerboard (cairo_t * cr,gint size)
name|gimp_cairo_set_checkerboard
parameter_list|(
name|cairo_t
modifier|*
