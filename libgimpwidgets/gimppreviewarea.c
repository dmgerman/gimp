...
specifier|static
name|void
name|gimp_preview_area_config_notify
parameter_list|(
name|GimpColorConfig
modifier|*
name|config
...
specifier|static
name|void
DECL|function|gimp_preview_area_config_notify (GimpColorConfig * config,const GParamSpec * pspec,GimpPreviewArea * area)
name|gimp_preview_area_config_notify
parameter_list|(
name|GimpColorConfig
modifier|*
