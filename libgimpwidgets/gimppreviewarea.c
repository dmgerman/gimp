...
specifier|static
name|void
DECL|function|gimp_preview_area_get_check_colors (GimpPreviewArea * area,guchar * light,guchar * dark)
name|gimp_preview_area_get_check_colors
parameter_list|(
name|GimpPreviewArea
modifier|*
name|area
