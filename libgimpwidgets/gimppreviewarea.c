...
begin_define
DECL|macro|CHECK_COLOR (priv,row,col)
define|#
directive|define
name|CHECK_COLOR
parameter_list|(
...
parameter_list|)
define|\
value|(((((priv)->offset_y + (row))& size) ^  \     (((priv)->offset_x + (col))& size)) ? dark : light)
end_define
...
specifier|static
name|void
name|gimp_preview_area_dispose
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|gboolean
name|gimp_preview_area_widget_draw
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_preview_area_create_transform
parameter_list|(
name|GimpPreviewArea
modifier|*
name|area
...
specifier|static
name|void
DECL|function|gimp_preview_area_dispose (GObject * object)
name|gimp_preview_area_dispose
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_preview_area_widget_draw (GtkWidget * widget,cairo_t * cr)
name|gimp_preview_area_widget_draw
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_preview_area_create_transform (GimpPreviewArea * area)
name|gimp_preview_area_create_transform
parameter_list|(
name|GimpPreviewArea
modifier|*
...
specifier|static
name|void
DECL|function|gimp_preview_area_destroy_transform (GimpPreviewArea * area)
name|gimp_preview_area_destroy_transform
parameter_list|(
name|GimpPreviewArea
modifier|*
...
begin_comment
comment|/**  * gimp_preview_area_new:  *  * Creates a new #GimpPreviewArea widget.  *  * Returns: a new #GimpPreviewArea widget.  *  * Since GIMP 2.2  **/
end_comment
...
begin_comment
comment|/**  * gimp_preview_area_set_color_config:  * @area:   a #GimpPreviewArea widget.  * @config: a #GimpColorConfig object.  *  * Sets the color management configuration to use with this preview area.  *  * Since: 2.10  */
end_comment

begin_function
name|void
DECL|function|gimp_preview_area_set_color_config (GimpPreviewArea * area,GimpColorConfig * config)
name|gimp_preview_area_set_color_config
parameter_list|(
name|GimpPreviewArea
modifier|*
...
begin_function
name|void
DECL|function|gimp_preview_area_get_size (GimpPreviewArea * area,gint * width,gint * height)
