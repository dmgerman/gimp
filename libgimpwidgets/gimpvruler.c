...
specifier|const
struct|struct
DECL|struct|__anon28d67fa30108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon28d67fa30208
block|{
DECL|member|xsrc
name|gint
name|xsrc
...
name|ysrc
decl_stmt|;
DECL|typedef|GimpVRulerPrivate
block|}
name|GimpVRulerPrivate
typedef|;
end_typedef
...
specifier|static
name|gint
name|gimp_vruler_motion_notify
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpVRuler,gimp_vruler,GIMP_TYPE_RULER)
name|G_DEFINE_TYPE
argument_list|(
argument|GimpVRuler
argument_list|,
argument|gimp_vruler
argument_list|,
...
begin_define
DECL|macro|GIMP_VRULER_GET_PRIVATE (ruler)
define|#
directive|define
name|GIMP_VRULER_GET_PRIVATE
parameter_list|(
name|ruler
parameter_list|)
define|\
value|G_TYPE_INSTANCE_GET_PRIVATE (ruler, GIMP_TYPE_VRULER, GimpVRulerPrivate)
end_define

begin_function
specifier|static
name|void
name|gimp_vruler_class_init
parameter_list|(
...
specifier|static
name|void
DECL|function|gimp_vruler_init (GimpVRuler * vruler)
name|gimp_vruler_init
parameter_list|(
name|GimpVRuler
modifier|*
name|vruler
...
name|GtkWidget
modifier|*
DECL|function|gimp_vruler_new (void)
...
specifier|static
name|gint
DECL|function|gimp_vruler_motion_notify (GtkWidget * widget,GdkEventMotion * event)
name|gimp_vruler_motion_notify
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_vruler_draw_ticks (GimpRuler * ruler)
name|gimp_vruler_draw_ticks
parameter_list|(
name|GimpRuler
modifier|*
...
operator|)
expr_stmt|;
comment|/* determine the scale    *   use the maximum extents of the ruler to determine the largest    *   possible number to be displayed.  Calculate the height in pixels    *   of this displayed text. Use this height to find a scale which    *   leaves sufficient room for drawing the ruler.    */
name|scale
operator|=
name|ceil
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_vruler_draw_pos (GimpRuler * ruler)
name|gimp_vruler_draw_pos
parameter_list|(
name|GimpRuler
modifier|*
