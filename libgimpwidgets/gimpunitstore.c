...
block|,
DECL|enumerator|PROP_HAS_PIXELS
name|PROP_HAS_PIXELS
block|,
DECL|enumerator|PROP_HAS_PERCENT
name|PROP_HAS_PERCENT
block|,
DECL|enumerator|PROP_SHORT_FORMAT
name|PROP_SHORT_FORMAT
block|,
DECL|enumerator|PROP_LONG_FORMAT
name|PROP_LONG_FORMAT
block|}
enum|;
end_enum
...
name|num_values
decl_stmt|;
DECL|member|has_pixels
name|gboolean
name|has_pixels
decl_stmt|;
DECL|member|has_percent
name|gboolean
name|has_percent
decl_stmt|;
DECL|member|short_format
name|gchar
modifier|*
name|short_format
decl_stmt|;
DECL|member|long_format
name|gchar
modifier|*
name|long_format
decl_stmt|;
...
argument_list|,
argument|G_ADD_PRIVATE (GimpUnitStore)                          G_IMPLEMENT_INTERFACE (GTK_TYPE_TREE_MODEL,                                                 gimp_unit_store_tree_model_init)
argument_list|)
end_macro
...
name|priv
operator|=
name|gimp_unit_store_get_instance_private
argument_list|(
name|store
argument_list|)
expr_stmt|;
...
begin_function
name|void
DECL|function|gimp_unit_store_set_has_pixels (GimpUnitStore * store,gboolean has_pixels)
name|gimp_unit_store_set_has_pixels
parameter_list|(
name|GimpUnitStore
modifier|*
...
condition|)
block|{
name|gtk_tree_model_row_deleted
argument_list|(
name|model
argument_list|,
name|deleted_path
...
begin_function
name|gboolean
DECL|function|gimp_unit_store_get_has_pixels (GimpUnitStore * store)
...
begin_function
name|void
DECL|function|gimp_unit_store_set_has_percent (GimpUnitStore * store,gboolean has_percent)
name|gimp_unit_store_set_has_percent
parameter_list|(
name|GimpUnitStore
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_unit_store_get_has_percent (GimpUnitStore * store)
...
begin_function
name|void
DECL|function|_gimp_unit_store_sync_units (GimpUnitStore * store)
