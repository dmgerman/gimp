...
name|eva
argument_list|,
literal|"Exponent is not a dimensionless quantity"
argument_list|)
expr_stmt|;
name|evaluated_factor
operator|.
...
specifier|static
name|GimpEevlQuantity
DECL|function|gimp_eevl_quantity (GimpEevl * eva)
name|gimp_eevl_quantity
parameter_list|(
name|GimpEevl
modifier|*
