...
typedef|typedef
struct|struct
DECL|struct|__anon28b417b80308
block|{
...
specifier|static
name|void
DECL|function|gimp_number_pair_entry_parse_text (GimpNumberPairEntry * entry,const gchar * text)
name|gimp_number_pair_entry_parse_text
parameter_list|(
name|GimpNumberPairEntry
modifier|*
...
literal|0
case|:
comment|/* Unambigous user clear, start using defaults */
name|gimp_number_pair_entry_set_values
argument_list|(
name|entry
argument_list|,
...
case|:
default|default:
comment|/* Ambigous user input, reset to old values */
break|break;
block|}
