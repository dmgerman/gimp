...
typedef|typedef
struct|struct
DECL|struct|__anon2afcb4ea0408
block|{
...
specifier|static
name|gint
DECL|function|gimp_number_pair_entry_valid_separator (GimpNumberPairEntry * entry,gchar candidate)
name|gimp_number_pair_entry_valid_separator
parameter_list|(
name|GimpNumberPairEntry
modifier|*
...
literal|3
case|:
comment|/* Valid user entry, enter user-override mode */
if|if
condition|(
name|gimp_number_pair_entry_valid_separator
argument_list|(
