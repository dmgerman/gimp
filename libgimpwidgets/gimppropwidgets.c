...
begin_comment
comment|/* this evil hack is here to work around bug #327243 */
end_comment

begin_function
specifier|static
name|gboolean
DECL|function|gimp_prop_file_chooser_button_connect_idle (GObject * button)
name|gimp_prop_file_chooser_button_connect_idle
parameter_list|(
name|GObject
modifier|*
name|button
...
name|button
argument_list|,
literal|"gimp-prop-file-chooser-connect"
argument_list|)
decl_stmt|;
if|if
condition|(
...
argument_list|)
expr_stmt|;
comment|/*  GtkFileChooserButton::file-set is new in GTK+ 2.12  */
if|if
condition|(
...
literal|"file-set"
argument_list|,
name|GTK_TYPE_FILE_CHOOSER_BUTTON
argument_list|)
condition|)
block|{
name|g_signal_connect
