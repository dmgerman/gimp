...
literal|"N Pages"
argument_list|,
literal|"The number of pages to open"
argument_list|,
literal|0
argument_list|,
name|G_MAXINT
...
begin_comment
comment|/**  * gimp_page_selector_get_page_thumbnail:  * @selector: Pointer to a #GimpPageSelector.  * @page_no: The number of the page to get the thumbnail for.  *  * Returns: (nullable) (transfer none): The page's thumbnail, or %NULL if none  *          is set. The returned pixbuf is owned by #GimpPageSelector and must  *          not be unref'ed when no longer needed.  *  * Since: 2.4  **/
end_comment
...
begin_comment
comment|/**  * gimp_page_selector_get_page_label:  * @selector: Pointer to a #GimpPageSelector.  * @page_no: The number of the page to get the thumbnail for.  *  * Returns: (nullable) (transfer full): The page's label, or %NULL if none is  *          set. This is a newly allocated string that should be g_free()'d  *          when no longer needed.  *  * Since: 2.4  **/
end_comment
