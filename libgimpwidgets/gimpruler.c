...
begin_define
DECL|macro|IMMEDIATE_REDRAW_THRESHOLD
define|#
directive|define
name|IMMEDIATE_REDRAW_THRESHOLD
value|20
end_define

begin_enum
enum|enum
DECL|enum|__anon28b4b3690103
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon28b4b3690208
block|{
...
name|backing_store
decl_stmt|;
DECL|member|backing_store_valid
name|gboolean
name|backing_store_valid
decl_stmt|;
DECL|member|last_pos_rect
name|GdkRectangle
name|last_pos_rect
decl_stmt|;
DECL|member|pos_redraw_idle_id
name|guint
...
typedef|typedef
struct|struct
DECL|struct|__anon28b4b3690308
block|{
...
begin_decl_stmt
DECL|variable|ruler_metric_decimal
specifier|static
specifier|const
name|RulerMetric
...
begin_decl_stmt
DECL|variable|ruler_metric_inches
specifier|static
specifier|const
name|RulerMetric
...
begin_decl_stmt
DECL|variable|ruler_metric_feet
specifier|static
specifier|const
name|RulerMetric
...
begin_decl_stmt
DECL|variable|ruler_metric_yards
specifier|static
specifier|const
name|RulerMetric
...
specifier|static
name|void
name|gimp_ruler_get_preferred_width
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_ruler_get_preferred_height
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gboolean
name|gimp_ruler_idle_queue_pos_redraw
parameter_list|(
name|gpointer
name|data
parameter_list|)
...
specifier|static
name|void
name|gimp_ruler_queue_pos_redraw
parameter_list|(
name|GimpRuler
modifier|*
name|ruler
...
specifier|static
name|void
DECL|function|gimp_ruler_dispose (GObject * object)
name|gimp_ruler_dispose
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_ruler_update_position (GimpRuler * ruler,gdouble x,gdouble y)
...
name|w
operator|=
name|gdk_window_get_effective_parent
argument_list|(
name|w
argument_list|)
control|)
...
name|py
decl_stmt|;
name|gdk_window_coords_to_parent
argument_list|(
name|w
argument_list|,
operator|*
...
specifier|static
name|void
DECL|function|gimp_ruler_event_to_widget_coords (GtkWidget * widget,GdkWindow * window,gdouble event_x,gdouble event_y,gint * widget_x,gint * widget_y)
name|gimp_ruler_event_to_widget_coords
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gboolean
DECL|function|gimp_ruler_track_widget_motion_notify (GtkWidget * widget,GdkEventMotion * mevent,GimpRuler * ruler)
name|gimp_ruler_track_widget_motion_notify
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_function
name|void
DECL|function|gimp_ruler_add_track_widget (GimpRuler * ruler,GtkWidget * widget)
...
begin_function
name|void
DECL|function|gimp_ruler_remove_track_widget (GimpRuler * ruler,GtkWidget * widget)
name|gimp_ruler_remove_track_widget
parameter_list|(
name|GimpRuler
modifier|*
...
name|y
expr_stmt|;
comment|/*        * If the position has changed far enough, queue a redraw immediately.        * Otherwise, we only queue a redraw in a low priority idle handler, to        * allow for other things (like updating the canvas) to run.        *        * TODO: This might not be necessary any more in GTK3 with the frame        *       clock. Investigate this more after the port to GTK3.        */
if|if
condition|(
name|priv
operator|->
...
specifier|static
name|void
DECL|function|gimp_ruler_map (GtkWidget * widget)
name|gimp_ruler_map
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_ruler_unmap (GtkWidget * widget)
name|gimp_ruler_unmap
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_ruler_get_preferred_width (GtkWidget * widget,gint * minimum_width,gint * natural_width)
name|gimp_ruler_get_preferred_width
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_ruler_get_preferred_height (GtkWidget * widget,gint * minimum_height,gint * natural_height)
name|gimp_ruler_get_preferred_height
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_ruler_draw (GtkWidget * widget,cairo_t * cr)
name|gimp_ruler_draw
parameter_list|(
name|GtkWidget
modifier|*
...
directive|if
literal|0
block|gtk_paint_box (style, priv->backing_store,                  GTK_STATE_NORMAL, GTK_SHADOW_OUT,                  NULL, widget,                  priv->orientation == GTK_ORIENTATION_HORIZONTAL ?                  "hruler" : "vruler",                  0, 0,                  allocation.width, allocation.height);
else|#
directive|else
name|cairo_paint
argument_list|(
...
directive|if
literal|0
block|gtk_paint_layout (style,                                     priv->backing_store,                                     state,                                     FALSE,                                     NULL,                                     widget,                                     "hruler",                                     pos + 2,                                     ythickness + PANGO_PIXELS (logical_rect.y - digit_offset),                                     layout);
else|#
directive|else
name|cairo_move_to
argument_list|(
...
directive|if
literal|0
block|gtk_paint_layout (style,                                         priv->backing_store,                                         state,                                         FALSE,                                         NULL,                                         widget,                                         "vruler",                                         xthickness + 1,                                         pos + digit_height * j + 2 + PANGO_PIXELS (logical_rect.y - digit_offset),                                         layout);
else|#
directive|else
name|cairo_move_to
argument_list|(
...
specifier|static
name|GdkRectangle
DECL|function|gimp_ruler_get_pos_rect (GimpRuler * ruler,gdouble position)
name|gimp_ruler_get_pos_rect
parameter_list|(
name|GimpRuler
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_ruler_idle_queue_pos_redraw (gpointer data)
name|gimp_ruler_idle_queue_pos_redraw
parameter_list|(
name|gpointer
name|data
...
specifier|static
name|void
DECL|function|gimp_ruler_queue_pos_redraw (GimpRuler * ruler)
name|gimp_ruler_queue_pos_redraw
parameter_list|(
name|GimpRuler
modifier|*
...
name|f
parameter_list|)
value|(ABS (f - gimp_unit_get_factor (u))< FACTOR_EPSILON)
end_define
...
name|RulerMetric
modifier|*
DECL|function|gimp_ruler_get_metric (GimpUnit unit)
name|gimp_ruler_get_metric
parameter_list|(
name|GimpUnit
name|unit
