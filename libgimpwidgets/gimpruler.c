...
typedef|typedef
struct|struct
DECL|struct|__anon299d0ec80108
block|{
...
literal|"Metric"
argument_list|,
literal|"The metric used for the ruler"
argument_list|,
name|GTK_TYPE_METRIC_TYPE
argument_list|,
name|GTK_PIXELS
argument_list|,
name|GIMP_PARAM_READWRITE
...
begin_function
name|void
DECL|function|gimp_ruler_set_metric (GimpRuler * ruler,GtkMetricType metric)
name|gimp_ruler_set_metric
parameter_list|(
name|GimpRuler
modifier|*
...
begin_comment
comment|/**  * gimp_ruler_get_metric:  * @ruler: a #GimpRuler  *  * Gets the units used for a #GimpRuler. See gimp_ruler_set_metric().  *  * Return value: the units currently used for @ruler  *  * Since: GIMP 2.8  **/
end_comment

begin_function
name|GtkMetricType
DECL|function|gimp_ruler_get_metric (GimpRuler * ruler)
name|gimp_ruler_get_metric
parameter_list|(
name|GimpRuler
modifier|*
...
begin_comment
comment|/**  * gimp_ruler_set_range:  * @ruler: the gtkruler  * @lower: the lower limit of the ruler  * @upper: the upper limit of the ruler  * @position: the mark on the ruler  * @max_size: the maximum size of the ruler used when calculating the space to  * leave for the text  *  * This sets the range of the ruler.  *  * Since: GIMP 2.8  */
end_comment

begin_function
name|void
DECL|function|gimp_ruler_set_range (GimpRuler * ruler,gdouble lower,gdouble upper,gdouble position,gdouble max_size)
name|gimp_ruler_set_range
parameter_list|(
name|GimpRuler
modifier|*
...
begin_function
name|void
DECL|function|gimp_ruler_get_range (GimpRuler * ruler,gdouble * lower,gdouble * upper,gdouble * position,gdouble * max_size)
