...
begin_function
name|void
DECL|function|gimp_widgets_init (void)
...
typedef|typedef
struct|struct
DECL|struct|__anon27ddb1910108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon27ddb1910208
block|{
...
specifier|static
name|void
DECL|function|gimp_memsize_entry_callback (GtkAdjustment * adj,gpointer data)
name|gimp_memsize_entry_callback
parameter_list|(
name|GtkAdjustment
modifier|*
name|adj
...
specifier|static
name|void
DECL|function|gimp_memsize_unit_callback (GtkWidget * widget,gpointer data)
name|gimp_memsize_unit_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_comment
comment|/**  * gimp_memsize_entry_new:  * @adjustment: The adjustment containing the memsize and it's limits.  *  * Returns: A #GtkHBox with a #GtkSpinButton and a #GtkOptionMenu.  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_memsize_entry_new (GtkAdjustment * adjustment)
