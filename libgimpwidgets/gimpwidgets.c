...
typedef|typedef
struct|struct
DECL|struct|__anon29811c1a0108
block|{
...
name|GtkWidget
modifier|*
DECL|function|gimp_coordinates_new (GUnit unit,gchar * unit_format,gboolean menu_show_pixels,gboolean menu_show_percent,gint spinbutton_usize,GimpSizeEntryUP update_policy,gchar * xlabel,gdouble x,gdouble xres,gint lower_boundary_x,gint upper_boundary_x,gchar * ylabel,gdouble y,gdouble yres,gint lower_boundary_y,gint upper_boundary_y)
