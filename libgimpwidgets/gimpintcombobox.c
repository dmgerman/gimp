...
name|text_renderer
decl_stmt|;
DECL|member|menu_pixbuf_renderer
name|GtkCellRenderer
modifier|*
name|menu_pixbuf_renderer
decl_stmt|;
DECL|member|menu_text_renderer
name|GtkCellRenderer
modifier|*
name|menu_text_renderer
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|/**    * GimpIntComboBox:layout:    *    * Specifies the combo box layout.    *    * Since: 2.10    */
name|g_object_class_install_property
argument_list|(
name|object_class
argument_list|,
...
name|PROP_LAYOUT
case|:
name|gimp_int_combo_box_set_layout
argument_list|(
name|GIMP_INT_COMBO_BOX
argument_list|(
name|object
...
begin_comment
comment|/**  * gimp_int_combo_box_set_layout:  * @combo_box: a #GimpIntComboBox  * @layout:    the combo box layout  *  * Sets the layout of @combo_box to @layout.  *  * Since: 2.10  **/
end_comment

begin_function
name|void
DECL|function|gimp_int_combo_box_set_layout (GimpIntComboBox * combo_box,GimpIntComboBoxLayout layout)
name|gimp_int_combo_box_set_layout
parameter_list|(
name|GimpIntComboBox
modifier|*
...
begin_function
name|GimpIntComboBoxLayout
DECL|function|gimp_int_combo_box_get_layout (GimpIntComboBox * combo_box)
name|gimp_int_combo_box_get_layout
parameter_list|(
name|GimpIntComboBox
modifier|*
name|combo_box
