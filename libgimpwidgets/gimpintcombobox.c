...
typedef|typedef
struct|struct
DECL|struct|__anon2b0abb370208
block|{
...
name|GObject
modifier|*
name|gimp_int_combo_box_constructor
parameter_list|(
name|GType
name|type
parameter_list|,
...
name|GObject
modifier|*
DECL|function|gimp_int_combo_box_constructor (GType type,guint n_params,GObjectConstructParam * params)
name|gimp_int_combo_box_constructor
parameter_list|(
name|GType
name|type
