...
begin_comment
comment|/**  * gimp_int_store_new_valist:  * @first_label: the label of the first item  * @first_value: the value of the first item  * @values:      a va_list with more values  *  * A variant of gimp_int_store_new() that takes a va_list of  * label/value pairs.  *  * Returns: a new #GimpIntStore.  *  * Since: 3.0  **/
end_comment

begin_function
name|GtkListStore
modifier|*
DECL|function|gimp_int_store_new_valist (const gchar * first_label,gint first_value,va_list values)
name|gimp_int_store_new_valist
parameter_list|(
specifier|const
name|gchar
