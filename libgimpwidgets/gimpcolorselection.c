...
begin_comment
comment|/**  * gimp_color_selection_get_notebook:  * @selection: A #GimpColorSelection widget.  *  * Returns: The selection's #GimpColorNotebook.  *  * Since: 3.0  */
end_comment
...
begin_comment
comment|/**  * gimp_color_selection_get_right_vbox:  * @selection: A #GimpColorSelection widget.  *  * Returns: The selection's right #GtkBox which contains the color scales.  *  * Since: 3.0  */
end_comment
