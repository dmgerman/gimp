...
begin_comment
comment|/**  * gimp_color_selection_new:  *  * Creates a new #GimpColorSelection widget.  *  * Returns: The new #GimpColorSelection widget.  **/
end_comment
...
begin_comment
comment|/**  * gimp_color_selection_get_show_alpha:  * @selection: A #GimpColorSelection widget.  *  * Returns the @selection's @show_alpha property.  *  * Returns: %TRUE if the #GimpColorSelection has alpha controls.  **/
end_comment
...
begin_comment
comment|/**  * gimp_color_selection_get_color:  * @selection: A #GimpColorSelection widget.  * @color:     (out caller-allocates): Return location for the  *             @selection's current @color.  *  * This function returns the #GimpColorSelection's current color.  **/
end_comment
...
begin_comment
comment|/**  * gimp_color_selection_get_old_color:  * @selection: A #GimpColorSelection widget.  * @color:     (out caller-allocates): Return location for the  *             @selection's old @color.  *  * This function returns the #GimpColorSelection's old color.  **/
end_comment
...
begin_comment
comment|/**  * gimp_color_selection_get_notebook:  * @selection: A #GimpColorSelection widget.  *  * Returns: (transfer none): The selection's #GimpColorNotebook.  *  * Since: 3.0  */
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_color_selection_get_notebook (GimpColorSelection * selection)
...
name|GtkWidget
modifier|*
DECL|function|gimp_color_selection_get_right_vbox (GimpColorSelection * selection)
