...
specifier|static
name|void
name|cdisplay_gamma_adj_callback
parameter_list|(
name|GtkAdjustment
modifier|*
name|adj
...
specifier|static
name|void
DECL|function|cdisplay_gamma_dispose (GObject * object)
name|cdisplay_gamma_dispose
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|cdisplay_gamma_adj_callback (GtkAdjustment * adj,CdisplayGamma * gamma)
name|cdisplay_gamma_adj_callback
parameter_list|(
name|GtkAdjustment
modifier|*
