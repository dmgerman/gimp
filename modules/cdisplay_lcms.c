...
specifier|static
name|void
name|cdisplay_lcms_label_set_text
parameter_list|(
name|GtkLabel
modifier|*
name|label
...
typedef|typedef
struct|struct
DECL|struct|__anon27a0d0500108
block|{
DECL|member|data
name|guchar
modifier|*
...
specifier|static
name|void
DECL|function|cdisplay_lcms_attach_labelled (GtkTable * table,gint row,const gchar * text,GtkWidget * widget,gboolean tooltip)
name|cdisplay_lcms_attach_labelled
parameter_list|(
name|GtkTable
modifier|*
...
specifier|static
name|void
DECL|function|cdisplay_lcms_label_set_text (GtkLabel * label,const gchar * text,const gchar * tooltip)
name|cdisplay_lcms_label_set_text
parameter_list|(
name|GtkLabel
modifier|*
