...
begin_endif
unit|static void      gimp_input_device_store_device_added   (LibHalContext *ctx,                                                          const char    *udi); static void      gimp_input_device_store_device_removed (LibHalContext *ctx,                                                          const char    *udi);
endif|#
directive|endif
end_endif
