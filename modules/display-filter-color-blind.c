...
specifier|static
name|void
name|cdisplay_colorblind_convert_buffer
parameter_list|(
name|GimpColorDisplay
modifier|*
name|display
...
specifier|static
name|void
DECL|function|cdisplay_colorblind_convert_buffer (GimpColorDisplay * display,GeglBuffer * buffer,GeglRectangle * area)
name|cdisplay_colorblind_convert_buffer
parameter_list|(
name|GimpColorDisplay
modifier|*
