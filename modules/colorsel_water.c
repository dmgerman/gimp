...
name|GtkWidget
modifier|*
DECL|function|colorsel_water_new (gint r,gint g,gint b,gint a,gboolean show_alpha,GimpColorSelectorCallback callback,gpointer callback_data,gpointer * selector_data)
name|colorsel_water_new
parameter_list|(
name|gint
name|r
