...
specifier|static
name|void
name|colorsel_water_drag_begin
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|colorsel_water_drop_handle
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|colorsel_water_drag_handle
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
typedef|typedef
struct|struct
DECL|struct|__anon2ad7621c0108
block|{
...
specifier|static
name|void
DECL|function|set_bucket (gint i,gdouble r,gdouble g,gdouble b,gdouble a)
name|set_bucket
parameter_list|(
name|gint
name|i
...
specifier|static
name|void
DECL|function|draw_all_buckets (void)
...
specifier|static
name|void
DECL|function|shift_buckets (void)
name|shift_buckets
parameter_list|(
name|void
parameter_list|)
...
name|GtkWidget
modifier|*
DECL|function|colorsel_water_new (gint h,gint s,gint v,gint r,gint g,gint b,gint a,gboolean show_alpha,GimpColorSelectorCallback callback,gpointer callback_data,gpointer * selector_data)
name|colorsel_water_new
parameter_list|(
name|gint
name|h
...
specifier|static
name|void
DECL|function|colorsel_water_set_color (gpointer data,gint h,gint s,gint v,gint r,gint g,gint b,gint a)
name|colorsel_water_set_color
parameter_list|(
name|gpointer
name|data
...
specifier|static
name|void
DECL|function|colorsel_water_update (void)
name|colorsel_water_update
parameter_list|(
name|void
parameter_list|)
...
specifier|static
name|void
DECL|function|colorsel_water_drag_begin (GtkWidget * widget,GdkDragContext * context,gpointer data)
name|colorsel_water_drag_begin
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|colorsel_water_drag_end (GtkWidget * widget,GdkDragContext * context,gpointer data)
name|colorsel_water_drag_end
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|colorsel_water_drop_handle (GtkWidget * widget,GdkDragContext * context,gint x,gint y,GtkSelectionData * selection_data,guint info,guint time,gpointer data)
name|colorsel_water_drop_handle
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|colorsel_water_drag_handle (GtkWidget * widget,GdkDragContext * context,GtkSelectionData * selection_data,guint info,guint time,gpointer data)
name|colorsel_water_drag_handle
parameter_list|(
name|GtkWidget
modifier|*
