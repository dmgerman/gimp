...
begin_comment
comment|/* static void        color_select_update_hsv_values (ColorSelect *coldata); */
end_comment
...
name|GtkWidget
modifier|*
DECL|function|colorsel_triangle_new (gint hue,gint saturation,gint value,gint red,gint green,gint blue,gint alpha,gboolean show_alpha,GimpColorSelectorCallback callback,gpointer callback_data,gpointer * selector_data)
name|colorsel_triangle_new
parameter_list|(
name|gint
name|hue
...
specifier|static
name|void
DECL|function|colorsel_triangle_set_color (gpointer selector_data,gint hue,gint saturation,gint value,gint red,gint green,gint blue,gint alpha)
name|colorsel_triangle_set_color
parameter_list|(
name|gpointer
name|selector_data
...
begin_comment
comment|/* static void color_select_update_hsv_values (ColorSelect *csp) {   gdouble hue, sat, val;    hue = (gdouble) csp->values[RED]   / 255;   sat = (gdouble) csp->values[GREEN] / 255;   val = (gdouble) csp->values[BLUE]  / 255;      gimp_rgb_to_hsv_double (&hue,&sat,&val);    csp->values[HUE]        = RINT (hue * 360);   csp->values[SATURATION] = RINT (sat * 100);   csp->values[VALUE]      = RINT (val * 100); } */
end_comment
