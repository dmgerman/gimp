...
typedef|typedef
struct|struct
DECL|struct|__anon2b5a25e50208
block|{
comment|/* Color value */
DECL|member|h
name|gdouble
...
specifier|static
name|void
name|gimp_color_wheel_get_preferred_width
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_color_wheel_get_preferred_height
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_color_wheel_get_preferred_width (GtkWidget * widget,gint * minimum,gint * natural)
name|gimp_color_wheel_get_preferred_width
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_wheel_get_preferred_height (GtkWidget * widget,gint * minimum,gint * natural)
name|gimp_color_wheel_get_preferred_height
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|paint_ring (GimpColorWheel * wheel,cairo_t * cr)
name|paint_ring
parameter_list|(
name|GimpColorWheel
modifier|*
...
specifier|static
name|void
DECL|function|paint_triangle (GimpColorWheel * wheel,cairo_t * cr,gboolean draw_focus)
name|paint_triangle
parameter_list|(
name|GimpColorWheel
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_color_wheel_draw (GtkWidget * widget,cairo_t * cr)
name|gimp_color_wheel_draw
parameter_list|(
name|GtkWidget
modifier|*
...
name|draw_focus
operator|=
name|gtk_widget_has_visible_focus
argument_list|(
name|widget
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|gimp_color_wheel_destroy_transform (GimpColorWheel * wheel)
name|gimp_color_wheel_destroy_transform
parameter_list|(
name|GimpColorWheel
modifier|*
