...
begin_define
DECL|macro|DEFAULT_BOGUS_COLOR
define|#
directive|define
name|DEFAULT_BOGUS_COLOR
...
decl_stmt|;
DECL|member|show_bogus
name|gboolean
name|show_bogus
decl_stmt|;
DECL|member|bogus_color
name|GimpRGB
name|bogus_color
decl_stmt|;
...
name|include_alpha
decl_stmt|;
DECL|member|include_transparent
name|gboolean
name|include_transparent
decl_stmt|;
DECL|member|colors
name|gfloat
name|colors
...
block|,
DECL|enumerator|PROP_SHOW_BOGUS
name|PROP_SHOW_BOGUS
block|,
DECL|enumerator|PROP_BOGUS_COLOR
name|PROP_BOGUS_COLOR
block|,
DECL|enumerator|PROP_INCLUDE_ALPHA
name|PROP_INCLUDE_ALPHA
block|,
DECL|enumerator|PROP_INCLUDE_TRANSPARENT
name|PROP_INCLUDE_TRANSPARENT
block|}
enum|;
end_enum
...
name|_
argument_list|(
literal|"Show warning for pixels with an infinite or NaN component"
argument_list|)
argument_list|,
name|TRUE
argument_list|,
...
name|_
argument_list|(
literal|"Include alpha component"
argument_list|)
argument_list|,
name|_
argument_list|(
...
name|PROP_INCLUDE_TRANSPARENT
argument_list|,
literal|"include-transparent"
argument_list|,
name|_
argument_list|(
literal|"Include transparent pixels"
argument_list|)
argument_list|,
name|_
argument_list|(
literal|"Include fully transparent pixels in the warning"
argument_list|)
argument_list|,
name|TRUE
argument_list|,
...
condition|)
block|{
comment|/* don't combine warning color of pixels with a bogus                    * component with other warnings                    */
name|warning
operator|=
name|WARNING_BOGUS
expr_stmt|;
