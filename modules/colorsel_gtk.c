...
typedef|typedef
struct|struct
DECL|struct|__anon29c38ad30108
block|{
...
name|GtkWidget
modifier|*
DECL|function|colorsel_gtk_new (gint h,gint s,gint v,gint r,gint g,gint b,gint a,gboolean show_alpha,GimpColorSelectorCallback callback,gpointer data,gpointer * selector_data)
name|colorsel_gtk_new
parameter_list|(
name|gint
name|h
...
specifier|static
name|void
DECL|function|colorsel_gtk_set_color (gpointer data,gint h,gint s,gint v,gint r,gint g,gint b,gint a)
name|colorsel_gtk_set_color
parameter_list|(
name|gpointer
name|data
