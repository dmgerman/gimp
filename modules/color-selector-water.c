...
specifier|static
name|void
name|colorsel_water_config_notify
parameter_list|(
name|GimpColorConfig
modifier|*
name|config
...
specifier|static
name|void
DECL|function|colorsel_water_config_notify (GimpColorConfig * config,const GParamSpec * pspec,ColorselWater * water)
name|colorsel_water_config_notify
parameter_list|(
name|GimpColorConfig
modifier|*
...
specifier|static
name|gboolean
DECL|function|select_area_expose (GtkWidget * widget,GdkEventExpose * event,ColorselWater * water)
name|select_area_expose
parameter_list|(
name|GtkWidget
modifier|*
