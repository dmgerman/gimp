...
name|Tool
modifier|*
DECL|function|paint_core_new (int type)
name|paint_core_new
parameter_list|(
name|int
name|type
...
specifier|static
name|void
DECL|function|paint_to_canvas_tiles (PaintCore * paint_core,MaskBuf * brush_mask,int brush_opacity)
name|paint_to_canvas_tiles
parameter_list|(
name|PaintCore
modifier|*
...
specifier|static
name|void
DECL|function|paint_to_canvas_buf (PaintCore * paint_core,MaskBuf * brush_mask,int brush_opacity)
name|paint_to_canvas_buf
parameter_list|(
name|PaintCore
modifier|*
