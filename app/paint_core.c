...
specifier|static
name|void
DECL|function|paint_core_sample_color (GimpDrawable * drawable,gint x,gint y,gint state)
...
name|TempBuf
modifier|*
DECL|function|paint_core_get_paint_area (PaintCore * paint_core,GimpDrawable * drawable,gdouble scale)
...
specifier|static
name|void
DECL|function|paint_core_invalidate_cache (GimpBrush * brush,gpointer data)
name|paint_core_invalidate_cache
parameter_list|(
name|GimpBrush
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|paint_core_scale_mask (MaskBuf * brush_mask,gdouble scale)
name|paint_core_scale_mask
parameter_list|(
name|MaskBuf
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|paint_core_scale_pixmap (MaskBuf * brush_mask,gdouble scale)
name|paint_core_scale_pixmap
parameter_list|(
name|MaskBuf
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|paint_core_get_brush_mask (PaintCore * paint_core,BrushApplicationMode brush_hardness,gdouble scale)
name|paint_core_get_brush_mask
parameter_list|(
name|PaintCore
modifier|*
...
begin_comment
unit|static void paint_to_canvas_tiles (PaintCore *paint_core,  		       MaskBuf   *brush_mask,  		       gint       brush_opacity) {   PixelRegion srcPR;   PixelRegion maskPR;   gint x;   gint y;   gint xoff;   gint yoff;
comment|/*   combine the brush mask and the canvas tiles  */
end_comment
...
begin_function
name|void
DECL|function|paint_core_color_area_with_pixmap (PaintCore * paint_core,GimpImage * dest,GimpDrawable * drawable,TempBuf * area,gdouble scale,BrushApplicationMode mode)
