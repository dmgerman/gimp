...
name|GtkWidget
modifier|*
DECL|function|install_notebook_append_page (GtkNotebook * notebook,gchar * title)
...
specifier|static
name|void
DECL|function|add_label (GtkBox * box,gboolean last_line,gchar * text)
name|add_label
parameter_list|(
name|GtkBox
modifier|*
