...
begin_typedef
DECL|struct|__anon28d0727d0108
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon28d0727d0208
typedef|typedef
struct|struct
block|{
DECL|member|curve_count
...
begin_typedef
DECL|struct|__anon28d0727d0308
typedef|typedef
struct|struct
block|{
DECL|member|curve_count
...
name|last_point
expr_stmt|;
comment|/* 	  bezier_sel->cur_anchor = curve_start; */
comment|/* 	  bezier_sel->cur_control = curve_start->next; */
name|bezier_sel
operator|->
name|cur_anchor
operator|=
