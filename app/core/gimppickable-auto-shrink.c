...
begin_function
name|GimpAutoShrink
DECL|function|gimp_pickable_auto_shrink (GimpPickable * pickable,gint start_x,gint start_y,gint start_width,gint start_height,gint * shrunk_x,gint * shrunk_y,gint * shrunk_width,gint * shrunk_height)
