...
modifier|*
modifier|*
DECL|function|gimp_properties_append (GType object_type,gint * n_properties,gchar ** names,GValue ** values,...)
...
modifier|*
modifier|*
DECL|function|gimp_properties_append_valist (GType object_type,gint * n_properties,gchar ** names,GValue ** values,va_list args)
name|gimp_properties_append_valist
parameter_list|(
name|GType
name|object_type
...
begin_function
name|void
DECL|function|gimp_properties_free (gint n_properties,gchar ** names,GValue * values)
