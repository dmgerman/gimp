...
typedef|typedef
struct|struct
DECL|struct|__anon2993bfb50208
block|{
...
specifier|static
name|void
DECL|function|gimp_histogram_dispose (GObject * object)
name|gimp_histogram_dispose
parameter_list|(
name|GObject
modifier|*
...
parameter_list|)
define|\
value|G_STMT_START                                                                 \     {                                                                          \       if ((length) % 32 == 0&& async&& gimp_async_is_canceled (async))       \         {                                                                      \           gegl_buffer_iterator_stop (iter);                                    \                                                                                \           goto end;                                                            \         }                                                                      \     }                                                                          \   G_STMT_END
while|while
condition|(
