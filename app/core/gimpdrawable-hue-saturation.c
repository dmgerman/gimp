...
begin_function
name|void
DECL|function|gimp_drawable_hue_saturation (GimpDrawable * drawable,GimpProgress * progress,GimpHueRange range,gdouble hue,gdouble saturation,gdouble lightness)
