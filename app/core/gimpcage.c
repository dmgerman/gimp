...
begin_function
name|void
DECL|function|gimp_cage_add_cage_point (GimpCage * cage,gdouble x,gdouble y)
...
begin_function
name|void
DECL|function|gimp_cage_remove_last_cage_point (GimpCage * cage)
...
begin_function
name|gint
DECL|function|gimp_cage_is_on_handle (GimpCage * cage,gdouble x,gdouble y,gint handle_size)
...
begin_function
name|void
DECL|function|gimp_cage_move_cage_point (GimpCage * cage,gint point_number,gdouble x,gdouble y)
