...
typedef|typedef
enum|enum
DECL|enum|__anon2b63c1650303
block|{
DECL|enumerator|SIZE_PIXELS
name|SIZE_PIXELS
block|,
DECL|enumerator|SIZE_POINTS
name|SIZE_POINTS
