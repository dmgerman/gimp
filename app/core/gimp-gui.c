...
begin_function
name|void
DECL|function|gimp_wait (Gimp * gimp,GimpWaitable * waitable,const gchar * format,...)
name|gimp_wait
parameter_list|(
name|Gimp
modifier|*
...
return|return;
block|}
comment|/* Translator:  This message is displayed while GIMP is waiting for    * some operation to finish.  The %s argument is a message describing    * the operation.    */
name|g_printerr
argument_list|(
name|_
argument_list|(
literal|"Please wait: %s\n"
argument_list|)
argument_list|,
name|message
argument_list|)
...
name|GFile
modifier|*
DECL|function|gimp_get_icon_theme_dir (Gimp * gimp)
...
modifier|*
DECL|function|gimp_get_mount_operation (Gimp * gimp,GimpProgress * progress)
