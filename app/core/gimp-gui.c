...
name|GimpProgress
modifier|*
DECL|function|gimp_start_progress (Gimp * gimp,gint gdisp_ID,const gchar * message,GCallback cancel_cb,gpointer cancel_data)
...
name|GimpProgress
modifier|*
DECL|function|gimp_restart_progress (Gimp * gimp,GimpProgress * progress,const gchar * message,GCallback cancel_cb,gpointer cancel_data)
...
begin_function
name|void
DECL|function|gimp_update_progress (Gimp * gimp,GimpProgress * progress,gdouble percentage)
...
begin_function
name|void
DECL|function|gimp_end_progress (Gimp * gimp,GimpProgress * progress)
