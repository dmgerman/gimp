...
name|GimpDataFactory
modifier|*
DECL|function|gimp_data_loader_factory_new (Gimp * gimp,GType data_type,const gchar * path_property_name,const gchar * writable_property_name,GimpDataNewFunc new_func,GimpDataGetStandardFunc get_standard_func,const GimpDataLoaderEntry * loader_entries,gint n_loader_entries)
...
index|]
expr_stmt|;
comment|/* a loder matches if its extension matches, or if it doesn't        * have an extension, which is the case for the fallback loader,        * which must be last in the loader array        */
if|if
condition|(
operator|!
name|loader
