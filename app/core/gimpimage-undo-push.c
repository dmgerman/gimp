...
name|Undo
modifier|*
DECL|function|undo_new (UndoType type,glong size,gboolean dirties_image)
name|undo_new
parameter_list|(
name|UndoType
name|type
...
name|Undo
modifier|*
DECL|function|undo_push (GimpImage * gimage,glong size,UndoType type,gboolean dirties_image)
name|undo_push
parameter_list|(
name|GimpImage
modifier|*
...
begin_function
name|gboolean
DECL|function|undo_push_image_mask (GimpImage * gimage,TileManager * tiles,gint x,gint y)
...
specifier|static
name|gboolean
DECL|function|undo_pop_image_mask (GimpImage * gimage,UndoState state,UndoType type,gpointer mask_ptr)
name|undo_pop_image_mask
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_image_mask (UndoState state,UndoType type,gpointer mask_ptr)
name|undo_free_image_mask
parameter_list|(
name|UndoState
name|state
...
specifier|static
name|gboolean
DECL|function|undo_pop_layer_mod (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_layer_mod
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_layer_mod (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_layer_mod
parameter_list|(
name|UndoState
name|state
...
typedef|typedef
name|struct
name|_LayerRenameUndo
name|LayerRenameUndo
typedef|;
end_typedef

begin_struct
DECL|struct|_LayerRenameUndo
struct|struct
name|_LayerRenameUndo
block|{
DECL|member|layer
...
begin_function
name|gboolean
DECL|function|undo_push_layer_rename (GimpImage * gimage,GimpLayer * layer)
...
specifier|static
name|gboolean
DECL|function|undo_pop_layer_rename (GimpImage * gimage,UndoState state,UndoType type,void * data_ptr)
name|undo_pop_layer_rename
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_layer_rename (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_layer_rename
parameter_list|(
name|UndoState
name|state
