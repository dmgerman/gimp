...
begin_function
name|gboolean
DECL|function|gimp_image_undo_push_text_layer (GimpImage * gimage,const gchar * undo_desc,GimpTextLayer * layer)
...
specifier|static
name|gboolean
DECL|function|undo_pop_text_layer (GimpUndo * undo,GimpUndoMode undo_mode,GimpUndoAccumulator * accum)
name|undo_pop_text_layer
parameter_list|(
name|GimpUndo
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_text_layer (GimpUndo * undo,GimpUndoMode undo_mode)
name|undo_free_text_layer
parameter_list|(
name|GimpUndo
modifier|*
