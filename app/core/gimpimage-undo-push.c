...
name|GimpUndo
modifier|*
DECL|function|gimp_image_undo_push_item_metadata (GimpImage * image,const gchar * undo_desc,GimpItem * item)
...
name|GimpUndo
modifier|*
DECL|function|gimp_image_undo_push_group_layer_suspend (GimpImage * image,const gchar * undo_desc,GimpGroupLayer * group)
...
name|GimpUndo
modifier|*
DECL|function|gimp_image_undo_push_group_layer_resume (GimpImage * image,const gchar * undo_desc,GimpGroupLayer * group)
