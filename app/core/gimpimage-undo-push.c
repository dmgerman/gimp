...
begin_function
name|gboolean
DECL|function|undo_push_image_mod (GimpImage * gimage,GimpDrawable * drawable,gint x1,gint y1,gint x2,gint y2,gpointer tiles_ptr,gboolean sparse)
...
begin_function
name|gboolean
DECL|function|undo_push_mask (GimpImage * gimage,gpointer mask_ptr)
name|undo_push_mask
parameter_list|(
name|GimpImage
modifier|*
...
begin_function
name|gboolean
DECL|function|undo_push_transform (GimpImage * gimage,gpointer tu_ptr)
...
block|if (tu->tool_ID != active_tool->ID)     return TRUE;
comment|/*  swap the transformation information arrays  */
block|for (i = 0; i< TRAN_INFO_SIZE; i++)     {       d = tu->trans_info[i];       tu->trans_info[i] = tc->trans_info[i];       tc->trans_info[i] = d;     }
comment|/*  swap the original buffer--the source buffer for repeated transforms    */
block|temp = tu->original;   tu->original = tc->original;   tc->original = temp;
comment|/*  If we're re-implementing the first transform, reactivate tool  */
block|if (state == REDO&& tc->original)     {       active_tool->state = ACTIVE;       draw_core_resume (tc->core, active_tool);     }
endif|#
directive|endif
return|return
name|TRUE
...
begin_function
name|gboolean
DECL|function|undo_push_paint (GimpImage * gimage,gpointer pu_ptr)
...
begin_function
name|gboolean
DECL|function|undo_push_layer (GimpImage * gimage,UndoType type,gpointer lu_ptr)
...
begin_function
name|gboolean
DECL|function|undo_push_layer_mod (GimpImage * gimage,gpointer layer_ptr)
...
begin_function
name|gboolean
DECL|function|undo_push_layer_mask (GimpImage * gimage,UndoType type,gpointer lmu_ptr)
...
begin_function
name|gboolean
DECL|function|undo_push_channel (GimpImage * gimage,UndoType type,gpointer cu_ptr)
...
begin_function
name|gboolean
DECL|function|undo_push_channel_mod (GimpImage * gimage,gpointer channel_ptr)
...
begin_function
name|gboolean
DECL|function|undo_push_fs_to_layer (GimpImage * gimage,gpointer fsu_ptr)
...
begin_function
name|gboolean
DECL|function|undo_push_gimage_mod (GimpImage * gimage)
...
specifier|static
name|gboolean
DECL|function|undo_pop_gimage_mod (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_gimage_mod
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_gimage_mod (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_gimage_mod
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_qmask (GimpImage * gimage)
...
specifier|static
name|gboolean
DECL|function|undo_pop_qmask (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_qmask
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_qmask (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_qmask
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_guide (GimpImage * gimage,gpointer guide)
...
specifier|static
name|gboolean
DECL|function|undo_pop_guide (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_guide
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_guide (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_guide
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_resolution (GimpImage * gimage)
...
specifier|static
name|gboolean
DECL|function|undo_pop_resolution (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_resolution
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_resolution (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_resolution
parameter_list|(
name|UndoState
name|state
