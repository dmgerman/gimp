...
begin_decl_stmt
DECL|variable|resolution_changed
specifier|static
name|gboolean
...
specifier|static
name|void
DECL|function|undo_free_list (GimpImage * gimage,UndoState state,GSList * list)
name|undo_free_list
parameter_list|(
name|GimpImage
modifier|*
...
name|GSList
modifier|*
DECL|function|remove_stack_bottom (GimpImage * gimage)
...
name|Undo
modifier|*
DECL|function|undo_new (UndoType type,gsize size,gboolean dirties_image)
name|undo_new
parameter_list|(
name|UndoType
name|type
...
specifier|static
name|gboolean
DECL|function|undo_free_up_space (GimpImage * gimage)
...
name|Undo
modifier|*
DECL|function|undo_push (GimpImage * gimage,gsize size,UndoType type,gboolean dirties_image)
name|undo_push
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|gboolean
DECL|function|pop_stack (GimpImage * gimage,GSList ** stack_ptr,GSList ** unstack_ptr,UndoState state)
name|pop_stack
parameter_list|(
name|GimpImage
modifier|*
...
expr_stmt|;
block|}
comment|/*  If the resolution_changed flag was set  */
if|if
condition|(
name|resolution_changed
condition|)
...
expr_stmt|;
block|}
comment|/*  If the unit_changed flag was set  */
if|if
condition|(
name|unit_changed
condition|)
...
expr_stmt|;
block|}
comment|/*  If the mask_changed flag was set  */
if|if
condition|(
name|mask_changed
condition|)
...
expr_stmt|;
block|}
comment|/*  If the qmask_changed flag was set  */
if|if
condition|(
name|qmask_changed
condition|)
...
expr_stmt|;
block|}
comment|/*  If the alpha_changed flag was set  */
if|if
condition|(
name|alpha_changed
condition|)
...
begin_function
name|gboolean
DECL|function|undo_pop (GimpImage * gimage)
name|undo_pop
parameter_list|(
name|GimpImage
modifier|*
...
begin_function
name|gboolean
DECL|function|undo_redo (GimpImage * gimage)
name|undo_redo
parameter_list|(
name|GimpImage
modifier|*
...
name|gchar
modifier|*
DECL|function|undo_get_undo_name (GimpImage * gimage)
...
begin_function
name|UndoType
DECL|function|undo_get_undo_top_type (GimpImage * gimage)
...
name|gchar
modifier|*
DECL|function|undo_get_redo_name (GimpImage * gimage)
...
specifier|static
name|void
DECL|function|undo_map_over_stack (GSList * stack,undo_map_fn fn,gpointer data)
...
begin_function
name|void
DECL|function|undo_map_over_undo_stack (GimpImage * gimage,undo_map_fn fn,gpointer data)
...
begin_function
name|void
DECL|function|undo_map_over_redo_stack (GimpImage * gimage,undo_map_fn fn,gpointer data)
...
begin_function
name|void
DECL|function|undo_free (GimpImage * gimage)
name|undo_free
parameter_list|(
name|GimpImage
modifier|*
...
begin_function
name|gboolean
DECL|function|undo_push_group_start (GimpImage * gimage,UndoType type)
...
begin_function
name|gboolean
DECL|function|undo_push_image (GimpImage * gimage,GimpDrawable * drawable,gint x1,gint y1,gint x2,gint y2)
...
begin_function
name|gboolean
DECL|function|undo_push_image_mod (GimpImage * gimage,GimpDrawable * drawable,gint x1,gint y1,gint x2,gint y2,TileManager * tiles,gboolean sparse)
...
specifier|static
name|gboolean
DECL|function|undo_pop_image (GimpImage * gimage,UndoState state,UndoType type,gpointer image_undo_ptr)
name|undo_pop_image
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_image (UndoState state,UndoType type,gpointer image_undo_ptr)
name|undo_free_image
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_image_size (GimpImage * gimage)
...
specifier|static
name|gboolean
DECL|function|undo_pop_image_size (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_image_size
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_image_size (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_image_size
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_image_resolution (GimpImage * gimage)
...
specifier|static
name|gboolean
DECL|function|undo_pop_image_resolution (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_image_resolution
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_image_resolution (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_image_resolution
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_image_qmask (GimpImage * gimage)
...
specifier|static
name|gboolean
DECL|function|undo_pop_image_qmask (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_image_qmask
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_image_qmask (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_image_qmask
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_image_guide (GimpImage * gimage,GimpGuide * guide)
...
specifier|static
name|gboolean
DECL|function|undo_pop_image_guide (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_image_guide
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_image_guide (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_image_guide
parameter_list|(
name|UndoState
name|state
...
name|channel
decl_stmt|;
comment|/*  the channel this undo is for  */
DECL|member|tiles
name|TileManager
modifier|*
name|tiles
...
begin_function
name|gboolean
DECL|function|undo_push_mask (GimpImage * gimage,GimpChannel * mask)
name|undo_push_mask
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|gboolean
DECL|function|undo_pop_mask (GimpImage * gimage,UndoState state,UndoType type,gpointer mask_ptr)
name|undo_pop_mask
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_mask (UndoState state,UndoType type,gpointer mask_ptr)
name|undo_free_mask
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_item_rename (GimpImage * gimage,GimpItem * item)
...
specifier|static
name|gboolean
DECL|function|undo_pop_item_rename (GimpImage * gimage,UndoState state,UndoType type,gpointer iru_ptr)
name|undo_pop_item_rename
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_item_rename (UndoState state,UndoType type,gpointer iru_ptr)
name|undo_free_item_rename
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_layer_add (GimpImage * gimage,GimpLayer * layer,gint prev_position,GimpLayer * prev_layer)
...
begin_function
name|gboolean
DECL|function|undo_push_layer_remove (GimpImage * gimage,GimpLayer * layer,gint prev_position,GimpLayer * prev_layer)
...
specifier|static
name|gboolean
DECL|function|undo_push_layer (GimpImage * gimage,UndoType type,GimpLayer * layer,gint prev_position,GimpLayer * prev_layer)
name|undo_push_layer
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|gboolean
DECL|function|undo_pop_layer (GimpImage * gimage,UndoState state,UndoType type,gpointer lu_ptr)
name|undo_pop_layer
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_layer (UndoState state,UndoType type,gpointer lu_ptr)
name|undo_free_layer
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_layer_mod (GimpImage * gimage,GimpLayer * layer)
...
specifier|static
name|gboolean
DECL|function|undo_pop_layer_mod (GimpImage * gimage,UndoState state,UndoType type,gpointer lmu_ptr)
name|undo_pop_layer_mod
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_layer_mod (UndoState state,UndoType type,gpointer lmu_ptr)
name|undo_free_layer_mod
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_layer_mask_add (GimpImage * gimage,GimpLayer * layer,GimpLayerMask * mask)
...
begin_function
name|gboolean
DECL|function|undo_push_layer_mask_remove (GimpImage * gimage,GimpLayer * layer,GimpLayerMask * mask)
...
specifier|static
name|gboolean
DECL|function|undo_push_layer_mask (GimpImage * gimage,UndoType type,GimpLayer * layer,GimpLayerMask * mask)
name|undo_push_layer_mask
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|gboolean
DECL|function|undo_pop_layer_mask (GimpImage * gimage,UndoState state,UndoType type,gpointer lmu_ptr)
name|undo_pop_layer_mask
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_layer_mask (UndoState state,UndoType type,gpointer lmu_ptr)
name|undo_free_layer_mask
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_layer_reposition (GimpImage * gimage,GimpLayer * layer)
...
specifier|static
name|gboolean
DECL|function|undo_pop_layer_reposition (GimpImage * gimage,UndoState state,UndoType type,void * data_ptr)
name|undo_pop_layer_reposition
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_layer_reposition (UndoState state,UndoType type,void * data_ptr)
name|undo_free_layer_reposition
parameter_list|(
name|UndoState
name|state
...
begin_comment
comment|/*  Layer displacement Undo  */
end_comment
...
begin_function
name|gboolean
DECL|function|undo_push_layer_displace (GimpImage * gimage,GimpLayer * layer)
...
specifier|static
name|gboolean
DECL|function|undo_pop_layer_displace (GimpImage * gimage,UndoState state,UndoType type,gpointer info_ptr)
name|undo_pop_layer_displace
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_layer_displace (UndoState state,UndoType type,gpointer info_ptr)
name|undo_free_layer_displace
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_channel_add (GimpImage * gimage,GimpChannel * channel,gint prev_position,GimpChannel * prev_channel)
...
begin_function
name|gboolean
DECL|function|undo_push_channel_remove (GimpImage * gimage,GimpChannel * channel,gint prev_position,GimpChannel * prev_channel)
...
specifier|static
name|gboolean
DECL|function|undo_push_channel (GimpImage * gimage,UndoType type,GimpChannel * channel,gint prev_position,GimpChannel * prev_channel)
name|undo_push_channel
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|gboolean
DECL|function|undo_pop_channel (GimpImage * gimage,UndoState state,UndoType type,gpointer cu_ptr)
name|undo_pop_channel
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_channel (UndoState state,UndoType type,gpointer cu_ptr)
name|undo_free_channel
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_channel_mod (GimpImage * gimage,GimpChannel * channel)
...
specifier|static
name|gboolean
DECL|function|undo_pop_channel_mod (GimpImage * gimage,UndoState state,UndoType type,gpointer cmu_ptr)
name|undo_pop_channel_mod
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_channel_mod (UndoState state,UndoType type,gpointer cmu_ptr)
name|undo_free_channel_mod
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_channel_reposition (GimpImage * gimage,GimpChannel * channel)
...
specifier|static
name|gboolean
DECL|function|undo_pop_channel_reposition (GimpImage * gimage,UndoState state,UndoType type,gpointer cru_ptr)
name|undo_pop_channel_reposition
parameter_list|(
name|GimpImage
modifier|*
...
name|cru_ptr
expr_stmt|;
comment|/* what's the channel's current index? */
name|pos
operator|=
name|gimp_image_get_channel_index
argument_list|(
...
specifier|static
name|void
DECL|function|undo_free_channel_reposition (UndoState state,UndoType type,gpointer cru_ptr)
name|undo_free_channel_reposition
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_vectors_add (GimpImage * gimage,GimpVectors * vectors,gint prev_position,GimpVectors * prev_vectors)
...
begin_function
name|gboolean
DECL|function|undo_push_vectors_remove (GimpImage * gimage,GimpVectors * vectors,gint prev_position,GimpVectors * prev_vectors)
...
specifier|static
name|gboolean
DECL|function|undo_push_vectors (GimpImage * gimage,UndoType type,GimpVectors * vectors,gint prev_position,GimpVectors * prev_vectors)
name|undo_push_vectors
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|gboolean
DECL|function|undo_pop_vectors (GimpImage * gimage,UndoState state,UndoType type,gpointer vu_ptr)
name|undo_pop_vectors
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_vectors (UndoState state,UndoType type,gpointer vu_ptr)
name|undo_free_vectors
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_vectors_mod (GimpImage * gimage,GimpVectors * vectors)
...
specifier|static
name|gboolean
DECL|function|undo_pop_vectors_mod (GimpImage * gimage,UndoState state,UndoType type,gpointer vmu_ptr)
name|undo_pop_vectors_mod
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_vectors_mod (UndoState state,UndoType type,gpointer vmu_ptr)
name|undo_free_vectors_mod
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_vectors_reposition (GimpImage * gimage,GimpVectors * vectors)
...
specifier|static
name|gboolean
DECL|function|undo_pop_vectors_reposition (GimpImage * gimage,UndoState state,UndoType type,gpointer vru_ptr)
name|undo_pop_vectors_reposition
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_vectors_reposition (UndoState state,UndoType type,gpointer vru_ptr)
name|undo_free_vectors_reposition
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_fs_to_layer (GimpImage * gimage,GimpLayer * floating_layer,GimpDrawable * drawable)
...
specifier|static
name|gboolean
DECL|function|undo_pop_fs_to_layer (GimpImage * gimage,UndoState state,UndoType type,gpointer fsu_ptr)
name|undo_pop_fs_to_layer
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_fs_to_layer (UndoState state,UndoType type,gpointer fsu_ptr)
name|undo_free_fs_to_layer
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_fs_rigor (GimpImage * gimage,gint layer_ID)
...
specifier|static
name|gboolean
DECL|function|undo_pop_fs_rigor (GimpImage * gimage,UndoState state,UndoType type,gpointer layer_ptr)
name|undo_pop_fs_rigor
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_fs_rigor (UndoState state,UndoType type,gpointer layer_ptr)
name|undo_free_fs_rigor
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_fs_relax (GimpImage * gimage,gint32 layer_ID)
...
specifier|static
name|gboolean
DECL|function|undo_pop_fs_relax (GimpImage * gimage,UndoState state,UndoType type,gpointer layer_ptr)
name|undo_pop_fs_relax
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_fs_relax (UndoState state,UndoType type,gpointer layer_ptr)
name|undo_free_fs_relax
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_transform (GimpImage * gimage,gint tool_ID,GType tool_type,gdouble * trans_info,TileManager * original,GSList * path_undo)
...
specifier|static
name|gboolean
DECL|function|undo_pop_transform (GimpImage * gimage,UndoState state,UndoType type,gpointer tu_ptr)
name|undo_pop_transform
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_transform (UndoState state,UndoType type,gpointer tu_ptr)
name|undo_free_transform
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_paint (GimpImage * gimage,gint core_ID,GType core_type,GimpCoords * last_coords)
...
name|pu_ptr
expr_stmt|;
comment|/*  only pop if the active paint core is the one that pushed this undo  */
if|if
condition|(
name|pu
operator|->
...
specifier|static
name|void
DECL|function|undo_free_paint (UndoState state,UndoType type,gpointer pu_ptr)
name|undo_free_paint
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_image_parasite (GimpImage * gimage,gpointer parasite)
...
begin_function
name|gboolean
DECL|function|undo_push_image_parasite_remove (GimpImage * gimage,const gchar * name)
...
specifier|static
name|gboolean
DECL|function|undo_pop_parasite (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_parasite
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_parasite (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_parasite
parameter_list|(
name|UndoState
name|state
...
begin_function
name|gboolean
DECL|function|undo_push_cantundo (GimpImage * gimage,const gchar * action)
...
specifier|static
name|gboolean
DECL|function|undo_pop_cantundo (GimpImage * gimage,UndoState state,UndoType type,gpointer data_ptr)
name|undo_pop_cantundo
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|undo_free_cantundo (UndoState state,UndoType type,gpointer data_ptr)
name|undo_free_cantundo
parameter_list|(
name|UndoState
name|state
