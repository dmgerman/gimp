...
begin_function
name|int
DECL|function|undo_push_image (GImage * gimage,int drawable_ID,int x1,int y1,int x2,int y2)
...
begin_function
name|int
DECL|function|undo_push_image_mod (GImage * gimage,int drawable_ID,int x1,int y1,int x2,int y2,void * tiles_ptr,int sparse)
