...
begin_decl_stmt
DECL|variable|backtrace_state
specifier|static
name|struct
name|backtrace_state
modifier|*
name|backtrace_state
decl_stmt|;
end_decl_stmt
...
specifier|static
name|void
DECL|function|gimp_backtrace_syminfo_callback (GimpBacktraceAddressInfo * info,guintptr pc,const gchar * symname,guintptr symval,guintptr symsize)
name|gimp_backtrace_syminfo_callback
parameter_list|(
...
specifier|static
name|gint
DECL|function|gimp_backtrace_pcinfo_callback (GimpBacktraceAddressInfo * info,guintptr pc,const gchar * filename,gint lineno,const gchar * function)
name|gimp_backtrace_pcinfo_callback
parameter_list|(
name|GimpBacktraceAddressInfo
modifier|*
name|info
...
argument_list|,
operator|(
name|backtrace_syminfo_callback
operator|)
name|gimp_backtrace_syminfo_callback
argument_list|,
name|NULL
