...
condition|)
block|{
comment|/*  if the default old gimpdir was not found, try the "classic" one        *  in the home folder        */
name|gchar
modifier|*
name|dir
init|=
...
specifier|static
name|gboolean
DECL|function|gimp_user_install_detect_old (GimpUserInstall * install,const gchar * gimp_dir)
name|gimp_user_install_detect_old
parameter_list|(
name|GimpUserInstall
modifier|*
