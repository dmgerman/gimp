...
begin_function
name|gboolean
DECL|function|gimp_user_install_run (GimpUserInstall * install,gboolean migrate)
...
begin_function
name|gboolean
DECL|function|gimp_user_install_is_migration (GimpUserInstall * install,gchar ** version)
