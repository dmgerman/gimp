...
block|,
comment|/*< desc="Rigor floating selection">*/
DECL|enumerator|GIMP_UNDO_FS_RELAX
name|GIMP_UNDO_FS_RELAX
block|,
comment|/*< desc="Relax floating selection">*/
