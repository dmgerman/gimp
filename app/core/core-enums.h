...
begin_define
DECL|macro|GIMP_TYPE_IMAGE_MAP_REGION
define|#
directive|define
name|GIMP_TYPE_IMAGE_MAP_REGION
value|(gimp_image_map_region_get_type ())
end_define
