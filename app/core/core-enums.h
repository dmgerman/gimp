...
begin_define
DECL|macro|GIMP_TYPE_JOIN_TYPE
define|#
directive|define
name|GIMP_TYPE_JOIN_TYPE
value|(gimp_join_type_get_type ())
end_define
...
begin_define
DECL|macro|GIMP_TYPE_CAP_TYPE
define|#
directive|define
name|GIMP_TYPE_CAP_TYPE
value|(gimp_cap_type_get_type ())
end_define
