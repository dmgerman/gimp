...
block|,
comment|/*< desc="Normal (non-linear)">*/
...
block|,
comment|/*< desc="Behind (non-linear)">*/
...
block|,
comment|/*< desc="Darken only (linear)">*/
...
block|,
comment|/*< desc="Lighten only (linear)">*/
