...
begin_comment
comment|/*  Note: when appending values here, don't forget to update  *  GimpColorFrame and other places use this enum to create combo  *  boxes.  */
end_comment
...
enum|enum
comment|/*< pdb-skip>*/
DECL|enum|__anon2ac3316d0503
block|{
DECL|enumerator|GIMP_COLOR_PICK_MODE_PIXEL
name|GIMP_COLOR_PICK_MODE_PIXEL
block|,
comment|/*< desc="Pixel">*/
DECL|enumerator|GIMP_COLOR_PICK_MODE_RGB_PERCENT
name|GIMP_COLOR_PICK_MODE_RGB_PERCENT
block|,
comment|/*< desc="RGB (%)">*/
DECL|enumerator|GIMP_COLOR_PICK_MODE_RGB_U8
name|GIMP_COLOR_PICK_MODE_RGB_U8
block|,
comment|/*< desc="RGB (0..255)">*/
DECL|enumerator|GIMP_COLOR_PICK_MODE_HSV
name|GIMP_COLOR_PICK_MODE_HSV
block|,
comment|/*< desc="HSV">*/
DECL|enumerator|GIMP_COLOR_PICK_MODE_LCH
name|GIMP_COLOR_PICK_MODE_LCH
block|,
comment|/*< desc="CIE LCh">*/
DECL|enumerator|GIMP_COLOR_PICK_MODE_LAB
name|GIMP_COLOR_PICK_MODE_LAB
block|,
comment|/*< desc="CIE LAB">*/
DECL|enumerator|GIMP_COLOR_PICK_MODE_CMYK
name|GIMP_COLOR_PICK_MODE_CMYK
block|,
comment|/*< desc="CMYK">*/
DECL|enumerator|GIMP_COLOR_PICK_MODE_XYY
name|GIMP_COLOR_PICK_MODE_XYY
block|,
comment|/*< desc="CIE xyY">*/
DECL|enumerator|GIMP_COLOR_PICK_MODE_LAST
...
comment|/*< desc="Convert to built-in sRGB or grayscale profile">*/
...
DECL|enumerator|GIMP_CONVERT_DITHER_NODESTRUCT
...
begin_define
DECL|macro|GIMP_TYPE_CURVE_POINT_TYPE
define|#
directive|define
name|GIMP_TYPE_CURVE_POINT_TYPE
value|(gimp_curve_point_type_get_type ())
end_define

begin_decl_stmt
name|GType
name|gimp_curve_point_type_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
enum|enum
comment|/*< pdb-skip>*/
DECL|enum|__anon2ac3316d0b03
block|{
DECL|enumerator|GIMP_CURVE_POINT_SMOOTH
name|GIMP_CURVE_POINT_SMOOTH
block|,
comment|/*< desc="Smooth">*/
DECL|enumerator|GIMP_CURVE_POINT_CORNER
name|GIMP_CURVE_POINT_CORNER
comment|/*< desc="Corner">*/
DECL|typedef|GimpCurvePointType
block|}
...
begin_define
DECL|macro|GIMP_TYPE_DEBUG_POLICY
define|#
directive|define
name|GIMP_TYPE_DEBUG_POLICY
value|(gimp_debug_policy_get_type ())
end_define

begin_decl_stmt
name|GType
name|gimp_debug_policy_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
enum|enum
comment|/*< pdb-skip>*/
DECL|enum|__anon2ac3316d0e03
block|{
DECL|enumerator|GIMP_DEBUG_POLICY_WARNING
name|GIMP_DEBUG_POLICY_WARNING
block|,
comment|/*< desc="Debug warnings, critical errors and crashes">*/
DECL|enumerator|GIMP_DEBUG_POLICY_CRITICAL
name|GIMP_DEBUG_POLICY_CRITICAL
block|,
comment|/*< desc="Debug critical errors and crashes">*/
DECL|enumerator|GIMP_DEBUG_POLICY_FATAL
name|GIMP_DEBUG_POLICY_FATAL
block|,
comment|/*< desc="Debug crashes only">*/
DECL|enumerator|GIMP_DEBUG_POLICY_NEVER
name|GIMP_DEBUG_POLICY_NEVER
comment|/*< desc="Never debug GIMP">*/
DECL|typedef|GimpDebugPolicy
block|}
...
block|,
comment|/*< desc="Error">*/
DECL|enumerator|GIMP_MESSAGE_BUG_WARNING
name|GIMP_MESSAGE_BUG_WARNING
block|,
comment|/*< desc="WARNING">*/
DECL|enumerator|GIMP_MESSAGE_BUG_CRITICAL
name|GIMP_MESSAGE_BUG_CRITICAL
comment|/*< desc="CRITICAL">*/
...
begin_define
DECL|macro|GIMP_TYPE_TRC_TYPE
define|#
directive|define
name|GIMP_TYPE_TRC_TYPE
value|(gimp_trc_type_get_type ())
end_define

begin_decl_stmt
name|GType
name|gimp_trc_type_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
enum|enum
comment|/*< pdb-skip>*/
DECL|enum|__anon2ac3316d1c03
block|{
DECL|enumerator|GIMP_TRC_LINEAR
name|GIMP_TRC_LINEAR
block|,
comment|/*< desc="Linear">*/
DECL|enumerator|GIMP_TRC_NON_LINEAR
name|GIMP_TRC_NON_LINEAR
block|,
comment|/*< desc="Non-Linear">*/
DECL|enumerator|GIMP_TRC_PERCEPTUAL
name|GIMP_TRC_PERCEPTUAL
comment|/*< desc="Perceptual">*/
DECL|typedef|GimpTRCType
block|}
name|GimpTRCType
typedef|;
end_typedef
...
DECL|enumerator|GIMP_UNDO_GROUP_IMAGE_TRANSFORM
name|GIMP_UNDO_GROUP_IMAGE_TRANSFORM
block|,
comment|/*< desc="Transform image">*/
...
DECL|enumerator|GIMP_UNDO_GROUP_IMAGE_ITEM_REORDER
...
DECL|enumerator|GIMP_UNDO_IMAGE_HIDDEN_PROFILE
name|GIMP_UNDO_IMAGE_HIDDEN_PROFILE
block|,
comment|/*< desc="Hide/Unhide color profile">*/
...
block|,
comment|/*< desc="Layer/Channel modification">*/
DECL|enumerator|GIMP_UNDO_DRAWABLE_FORMAT
name|GIMP_UNDO_DRAWABLE_FORMAT
block|,
comment|/*< desc="Layer/Channel format">*/
...
DECL|enumerator|GIMP_UNDO_GROUP_LAYER_SUSPEND_RESIZE
name|GIMP_UNDO_GROUP_LAYER_SUSPEND_RESIZE
block|,
comment|/*< desc="Suspend group layer resize">*/
DECL|enumerator|GIMP_UNDO_GROUP_LAYER_RESUME_RESIZE
name|GIMP_UNDO_GROUP_LAYER_RESUME_RESIZE
block|,
comment|/*< desc="Resume group layer resize">*/
DECL|enumerator|GIMP_UNDO_GROUP_LAYER_SUSPEND_MASK
name|GIMP_UNDO_GROUP_LAYER_SUSPEND_MASK
block|,
comment|/*< desc="Suspend group layer mask">*/
DECL|enumerator|GIMP_UNDO_GROUP_LAYER_RESUME_MASK
name|GIMP_UNDO_GROUP_LAYER_RESUME_MASK
block|,
comment|/*< desc="Resume group layer mask">*/
DECL|enumerator|GIMP_UNDO_GROUP_LAYER_START_TRANSFORM
name|GIMP_UNDO_GROUP_LAYER_START_TRANSFORM
block|,
comment|/*< desc="Start transforming group layer">*/
DECL|enumerator|GIMP_UNDO_GROUP_LAYER_END_TRANSFORM
name|GIMP_UNDO_GROUP_LAYER_END_TRANSFORM
block|,
comment|/*< desc="End transforming group layer">*/
...
block|,
comment|/*< desc="Floating selection to layer">*/
DECL|enumerator|GIMP_UNDO_TRANSFORM_GRID
name|GIMP_UNDO_TRANSFORM_GRID
block|,
comment|/*< desc="Transform grid">*/
