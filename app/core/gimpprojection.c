...
begin_decl_stmt
DECL|variable|idlerender_gimage
specifier|static
name|GimpImage
modifier|*
...
begin_decl_stmt
DECL|variable|idlerender_width
specifier|static
name|int
...
begin_decl_stmt
DECL|variable|idlerender_height
specifier|static
name|int
...
begin_decl_stmt
DECL|variable|idlerender_basex
specifier|static
name|int
...
begin_decl_stmt
DECL|variable|idlerender_basey
specifier|static
name|int
...
begin_decl_stmt
DECL|variable|idlerender_idleid
specifier|static
name|guint
...
begin_decl_stmt
DECL|variable|idlerender_handlerid
specifier|static
name|guint
name|idlerender_handlerid
init|=
literal|0
decl_stmt|;
end_decl_stmt
...
name|idlerender_gimage_destroy_handler
parameter_list|(
name|GimpImage
modifier|*
name|gimage
...
name|printf
argument_list|(
literal|"Destroyed gimage at %p which idlerender was interested in...\n"
argument_list|,
name|gimage
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"Destroy handler finished.\n"
argument_list|)
expr_stmt|;
name|fflush
argument_list|(
...
specifier|static
name|void
DECL|function|idlerender_abort (GimpImage * gimage)
name|idlerender_abort
parameter_list|(
name|GimpImage
modifier|*
name|gimage
...
specifier|static
name|int
DECL|function|idlerender_callback (void * unused)
...
specifier|static
name|void
DECL|function|unify_and_start_idlerender (GimpImage * gimage,int basex,int basey,int width,int height)
name|unify_and_start_idlerender
parameter_list|(
name|GimpImage
modifier|*
name|gimage
...
begin_function
name|void
DECL|function|reinit_layer_idlerender (GimpImage * gimage,Layer * layer)
...
begin_function
name|void
DECL|function|reinit_drawable_idlerender (GimpImage * gimage,GimpDrawable * drawable)
...
begin_function
name|void
DECL|function|reinit_gimage_idlerender (GimpImage * gimage)
