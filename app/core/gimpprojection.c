...
begin_decl_stmt
DECL|variable|projection_signals
specifier|static
name|guint
...
begin_function
name|GType
DECL|function|gimp_projection_get_type (void)
...
specifier|static
name|void
DECL|function|gimp_projection_pickable_iface_init (GimpPickableInterface * pickable_iface)
name|gimp_projection_pickable_iface_init
parameter_list|(
name|GimpPickableInterface
modifier|*
