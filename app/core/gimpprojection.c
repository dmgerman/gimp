...
begin_define
DECL|macro|GIMP_PROJECTION_CHUNK_WIDTH
define|#
directive|define
...
begin_define
DECL|macro|GIMP_PROJECTION_CHUNK_HEIGHT
define|#
directive|define
...
begin_define
DECL|macro|GIMP_PROJECTION_CHUNK_TIME
define|#
directive|define
...
begin_function
name|void
DECL|function|gimp_projection_set_priority_rect (GimpProjection * proj,gint x,gint y,gint width,gint height)
