...
name|list
decl_stmt|;
comment|/* We need to merge the ChunkRender's and the GimpProjection's    * update_areas list to keep track of which of the updates have been    * flushed and hence need to be drawn.    */
for|for
control|(
name|list
operator|=
...
name|g_warning
argument_list|(
literal|"%s: wanted to start chunk render with no update_areas"
argument_list|,
name|G_STRFUNC
argument_list|)
expr_stmt|;
