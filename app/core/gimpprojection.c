...
begin_comment
comment|/**  * gimp_projection_level_size_from_scale:  * @proj:   pointer to a GimpProjection  * @scalex: scale to use  * @level:  where to store level used  * @width:  where to store width of level  * @height: where to store height of level  *  * Calculates what level and the width and height of that level that should be  * used for scale @scalex.  **/
end_comment

begin_function
name|void
DECL|function|gimp_projection_level_size_from_scale (GimpProjection * proj,gdouble scalex,gint * level,gint * width,gint * height)
...
argument_list|)
expr_stmt|;
comment|/* We must make sure the pyramid is up to date. */
name|gimp_projection_alloc_levels
argument_list|(
name|proj
argument_list|)
...
begin_function
name|gint
DECL|function|gimp_projection_scale_to_level (GimpProjection * proj,gdouble scalex)
name|gimp_projection_scale_to_level
parameter_list|(
name|GimpProjection
modifier|*
...
specifier|static
name|void
DECL|function|gimp_projection_alloc_levels (GimpProjection * proj)
name|gimp_projection_alloc_levels
parameter_list|(
name|GimpProjection
modifier|*
...
specifier|static
name|void
DECL|function|gimp_projection_write_quarter (Tile * dest,Tile * source,gint i,gint j)
name|gimp_projection_write_quarter
parameter_list|(
name|Tile
modifier|*
