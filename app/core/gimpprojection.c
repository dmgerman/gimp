...
begin_comment
comment|/**  * gimp_projection_get_level:  * @proj:    pointer to a GimpProjection  * @scale_x: horizontal scale factor  * @scale_y: vertical scale factor  *  * Return value: the pyramid level to use for a given display scale factor.  **/
end_comment
