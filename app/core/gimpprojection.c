...
parameter_list|)
block|{
comment|/* Warning: Lots of obscure Gdk-Stuff ahead. */
specifier|static
name|GdkPixmap
modifier|*
name|wilber_pixmap
...
name|g_printerr
argument_list|(
literal|"gdisplay_update_icon: falling back to default\n"
argument_list|)
expr_stmt|;
name|gdk_window_set_icon
argument_list|(
...
begin_function
name|void
DECL|function|gdisplay_update_icon_scheduler (GimpImage * gimage,gpointer data)
...
name|g_printerr
argument_list|(
literal|"gdisplay_update_icon_scheduler called for invalid gdisplay\n"
argument_list|)
expr_stmt|;
block|}
block|}
...
begin_function
name|gboolean
DECL|function|gdisplay_update_icon_timer (gpointer data)
name|gdisplay_update_icon_timer
parameter_list|(
name|gpointer
name|data
...
name|gdisp
decl_stmt|;
comment|/* we should check this for validity... */
name|gdisp
operator|=
operator|(
name|GDisplay
...
begin_function
name|gboolean
DECL|function|gdisplay_update_icon_invoker (gpointer data)
name|gdisplay_update_icon_invoker
parameter_list|(
name|gpointer
name|data
...
directive|if
literal|0
block|SET_SENSITIVE ("Image/Histogram...", lp);
endif|#
directive|endif
name|SET_SENSITIVE
argument_list|(
...
directive|if
literal|0
block|SET_SENSITIVE ("Image/Colors/Color Balance...", (base_type == RGB));       SET_SENSITIVE ("Image/Colors/Hue-Saturation...", (base_type == RGB));       SET_SENSITIVE ("Image/Colors/Brightness-Contrast...", (base_type != INDEXED));       SET_SENSITIVE ("Image/Colors/Threshold...", (base_type != INDEXED));       SET_SENSITIVE ("Image/Colors/Levels...", (base_type != INDEXED));       SET_SENSITIVE ("Image/Colors/Curves...", (base_type != INDEXED));
endif|#
directive|endif
name|SET_SENSITIVE
argument_list|(
...
directive|if
literal|0
block|SET_SENSITIVE ("Image/Colors/Posterize...", (base_type != INDEXED));
endif|#
directive|endif
name|SET_SENSITIVE
argument_list|(
