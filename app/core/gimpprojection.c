...
argument_list|)
expr_stmt|;
comment|/*  make sure to limit the invalidated area to a superset of the    *  untransformed sub-pixel display area, not a subset.    *  bug #116765. --mitch    */
name|x1
operator|=
name|floor
argument_list|(
