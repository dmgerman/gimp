...
name|GimpBrush
modifier|*
DECL|function|gimp_brush_load_abr_brush (FILE * file,AbrHeader * abr_hdr,gint index,const gchar * filename,GError ** error)
name|gimp_brush_load_abr_brush
parameter_list|(
name|FILE
modifier|*
...
name|gchar
modifier|*
DECL|function|abr_v2_read_brush_name (FILE * file)
name|abr_v2_read_brush_name
parameter_list|(
name|FILE
modifier|*
