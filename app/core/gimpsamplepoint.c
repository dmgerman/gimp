...
begin_function
name|GimpColorPickMode
DECL|function|gimp_sample_point_get_pick_mode (GimpSamplePoint * sample_point)
...
begin_function
name|void
DECL|function|gimp_sample_point_set_pick_mode (GimpSamplePoint * sample_point,GimpColorPickMode pick_mode)
