...
name|GeglNode
modifier|*
DECL|function|gimp_image_get_graph (GimpImage * image)
...
directive|if
literal|0
block|GeglNode *channels_node;   GeglNode *blend_node;
endif|#
directive|endif
name|GeglNode
modifier|*
...
directive|if
literal|0
block|channels_node =     gimp_drawable_stack_get_graph (GIMP_DRAWABLE_STACK (image->channels));    gegl_node_add_child (image->graph, channels_node);    blend_node = gegl_node_new_child (image->graph,                                     "operation", "normal",                                     NULL);    gegl_node_connect_to (layers_node,   "output",                         blend_node,    "input");   gegl_node_connect_to (channels_node, "output",                         blend_node,    "aux");
endif|#
directive|endif
name|output
operator|=
...
directive|if
literal|0
block|gegl_node_connect_to (blend_node, "output",                         output,     "input");
else|#
directive|else
