...
specifier|static
name|void
name|gimp_image_color_managed_profile_changed
parameter_list|(
name|GimpColorManaged
modifier|*
name|managed
...
specifier|static
name|GeglRectangle
name|gimp_image_get_bounding_box
parameter_list|(
name|GimpProjectable
modifier|*
name|projectable
...
specifier|static
name|void
name|gimp_image_get_pixel_average
parameter_list|(
name|GimpPickable
modifier|*
name|pickable
...
specifier|static
name|void
name|gimp_image_projection_buffer_notify
parameter_list|(
name|GimpProjection
modifier|*
name|projection
...
specifier|static
name|void
name|gimp_image_layers_changed
parameter_list|(
name|GimpContainer
modifier|*
name|container
...
specifier|static
name|void
name|gimp_image_layer_offset_changed
parameter_list|(
name|GimpDrawable
modifier|*
name|drawable
...
specifier|static
name|void
name|gimp_image_layer_bounding_box_changed
parameter_list|(
name|GimpDrawable
modifier|*
name|drawable
...
specifier|static
name|void
name|gimp_image_freeze_bounding_box
parameter_list|(
name|GimpImage
modifier|*
name|image
...
specifier|static
name|void
name|gimp_image_thaw_bounding_box
parameter_list|(
name|GimpImage
modifier|*
name|image
...
specifier|static
name|void
name|gimp_image_update_bounding_box
parameter_list|(
name|GimpImage
modifier|*
name|image
...
specifier|static
name|void
DECL|function|gimp_image_color_managed_profile_changed (GimpColorManaged * managed)
name|gimp_image_color_managed_profile_changed
parameter_list|(
name|GimpColorManaged
modifier|*
...
name|pickable_buffer
operator|=
name|gegl_buffer_create_sub_buffer
argument_list|(
name|buffer
argument_list|,
name|GEGL_RECTANGLE
...
specifier|static
name|void
DECL|function|gimp_image_get_pixel_average (GimpPickable * pickable,const GeglRectangle * rect,const Babl * format,gpointer pixel)
name|gimp_image_get_pixel_average
parameter_list|(
name|GimpPickable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_pixel_to_srgb (GimpPickable * pickable,const Babl * format,gpointer pixel,GimpRGB * color)
name|gimp_image_pixel_to_srgb
parameter_list|(
name|GimpPickable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_srgb_to_pixel (GimpPickable * pickable,const GimpRGB * color,const Babl * format,gpointer pixel)
name|gimp_image_srgb_to_pixel
parameter_list|(
name|GimpPickable
modifier|*
...
specifier|static
name|GeglRectangle
DECL|function|gimp_image_get_bounding_box (GimpProjectable * projectable)
name|gimp_image_get_bounding_box
parameter_list|(
name|GimpProjectable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_projection_buffer_notify (GimpProjection * projection,const GParamSpec * pspec,GimpImage * image)
name|gimp_image_projection_buffer_notify
parameter_list|(
name|GimpProjection
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_layers_changed (GimpContainer * container,GimpChannel * channel,GimpImage * image)
name|gimp_image_layers_changed
parameter_list|(
name|GimpContainer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_layer_offset_changed (GimpDrawable * drawable,const GParamSpec * pspec,GimpImage * image)
name|gimp_image_layer_offset_changed
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_layer_bounding_box_changed (GimpDrawable * drawable,GimpImage * image)
name|gimp_image_layer_bounding_box_changed
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_freeze_bounding_box (GimpImage * image)
name|gimp_image_freeze_bounding_box
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_thaw_bounding_box (GimpImage * image)
name|gimp_image_thaw_bounding_box
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_update_bounding_box (GimpImage * image)
name|gimp_image_update_bounding_box
parameter_list|(
name|GimpImage
modifier|*
...
condition|)
block|{
comment|/*  any non-legacy layer switches the mode to non-legacy                    */
name|private
operator|->
name|new_layer_mode
operator|=
...
block|}
block|}
comment|/*  only if all layers are legacy, the mode is also legacy            */
if|if
condition|(
operator|!
name|list
...
block|{
comment|/*  empty images are never considered legacy            */
name|private
operator|->
name|new_layer_mode
operator|=
...
begin_function
name|void
DECL|function|gimp_image_unset_default_new_layer_mode (GimpImage * image)
...
begin_function
name|void
DECL|function|gimp_image_invalidate_all (GimpImage * image)
name|gimp_image_invalidate_all
parameter_list|(
name|GimpImage
modifier|*
...
begin_comment
comment|/**  * gimp_image_saving:  * @image:  *  * Emits the "saving" signal, indicating that @image is about to be saved,  * or exported.  */
end_comment

begin_function
name|void
DECL|function|gimp_image_saving (GimpImage * image)
...
begin_function
name|void
DECL|function|gimp_image_inc_show_all_count (GimpImage * image)
...
begin_function
name|void
DECL|function|gimp_image_dec_show_all_count (GimpImage * image)
...
condition|)
block|{
comment|/* setting the builtin profile is equal to removing the profile */
