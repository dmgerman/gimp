...
begin_comment
comment|/*  Post notification of a layer merge   */
end_comment

begin_function
name|void
DECL|function|gimp_image_layer_merge (GimpImage * gimage)
