...
name|Babl
modifier|*
DECL|function|gimp_image_get_format (const GimpImage * image,GimpImageType type)
...
name|Babl
modifier|*
DECL|function|gimp_image_get_format_with_alpha (const GimpImage * image,GimpImageType type)
...
name|Babl
modifier|*
DECL|function|gimp_image_get_format_without_alpha (const GimpImage * image,GimpImageType type)
...
name|gchar
modifier|*
DECL|function|gimp_image_get_uri_or_untitled (const GimpImage * image)
name|gimp_image_get_uri_or_untitled
parameter_list|(
specifier|const
name|GimpImage
...
begin_comment
comment|/**  * gimp_image_get_imported_uri:  * @image: A #GimpImage.  *  * Returns: The URI of the imported image, or NULL if the image has  * been saved as XCF after it was imported.  **/
end_comment
...
name|gchar
modifier|*
DECL|function|gimp_image_get_imported_uri (const GimpImage * image)
...
begin_comment
comment|/**  * gimp_image_get_exported_uri:  * @image: A #GimpImage.  *  * Returns: The URI of the image last exported from this XCF file, or  * NULL if the image has never been exported.  **/
end_comment
...
name|gchar
modifier|*
DECL|function|gimp_image_get_exported_uri (const GimpImage * image)
...
begin_comment
comment|/**  * gimp_image_get_save_a_copy_uri:  * @image: A #GimpImage.  *  * Returns: The URI of the last copy that was saved of this XCF file.  **/
end_comment
...
name|gchar
modifier|*
DECL|function|gimp_image_get_save_a_copy_uri (const GimpImage * image)
...
begin_comment
comment|/**  * gimp_image_get_any_uri:  * @image: A #GimpImage.  *  * Returns: The XCF file URI, the imported file URI, or the exported  * file URI, in that order of precedence. Only to help implement  * backwards compatibility with GIMP 2.6 API.  **/
end_comment
...
name|gchar
modifier|*
DECL|function|gimp_image_get_any_uri (const GimpImage * image)
...
begin_comment
comment|/**  * gimp_image_set_imported_uri:  * @image: A #GimpImage.  * @uri:  *  * Sets the URI this file was imported from.  **/
end_comment

begin_function
name|void
DECL|function|gimp_image_set_imported_uri (GimpImage * image,const gchar * uri)
...
begin_comment
comment|/**  * gimp_image_set_exported_uri:  * @image: A #GimpImage.  * @uri:  *  * Sets the URI this file was last exported to. Note that saving as  * XCF is not "exporting".  **/
end_comment

begin_function
name|void
DECL|function|gimp_image_set_exported_uri (GimpImage * image,const gchar * uri)
...
begin_comment
comment|/**  * gimp_image_set_save_a_copy_uri:  * @image: A #GimpImage.  * @uri:  *  * Set the URI to the last copy this XCF file was saved to through the  * "save a copy" action.  **/
end_comment

begin_function
name|void
DECL|function|gimp_image_set_save_a_copy_uri (GimpImage * image,const gchar * uri)
