...
begin_comment
comment|/*  layer must be part of image->layers !!!  */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_image_add_layer_node (GimpImage * image,GimpLayer * layer)
name|gimp_image_add_layer_node
parameter_list|(
name|GimpImage
modifier|*
name|image
...
specifier|static
name|void
DECL|function|gimp_image_remove_layer_node (GimpImage * image,GimpLayer * layer)
name|gimp_image_remove_layer_node
parameter_list|(
name|GimpImage
modifier|*
name|image
