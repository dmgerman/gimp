...
expr_stmt|;
block|}
comment|/* need version 10 for fractional grid coordinates */
if|if
condition|(
...
name|_
argument_list|(
literal|"Fractional grid coordinates were "
literal|"added in %s"
argument_list|)
argument_list|,
literal|"GIMP 2.10"
