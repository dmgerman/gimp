...
begin_function
name|void
DECL|function|gimp_image_item_list_transform (GimpImage * image,GList * list,GimpContext * context,const GimpMatrix3 * matrix,GimpTransformDirection direction,GimpInterpolationType interpolation_type,gboolean supersample,gint recursion_level,gboolean clip_result,GimpProgress * progress)
...
begin_function
name|void
DECL|function|gimp_image_item_list_align (GimpImage * image,GList * list,GimpAlignmentType alignment,GimpItem * reference,GimpAlignmentType reference_alignment,gint offset)
