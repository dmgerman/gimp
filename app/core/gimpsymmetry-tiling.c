...
name|_
argument_list|(
literal|"Intervals on x-axis (pixels)"
argument_list|)
argument_list|,
literal|0.0
argument_list|,
...
name|_
argument_list|(
literal|"Intervals on y-axis (pixels)"
argument_list|)
argument_list|,
literal|0.0
argument_list|,
...
modifier|*
modifier|*
DECL|function|gimp_tiling_get_settings (GimpSymmetry * sym,gint * n_settings)
name|gimp_tiling_get_settings
parameter_list|(
name|GimpSymmetry
modifier|*
