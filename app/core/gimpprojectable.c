...
begin_function
name|void
DECL|function|gimp_projectable_bounds_changed (GimpProjectable * projectable,gint old_x,gint old_y,gint old_width,gint old_height)
