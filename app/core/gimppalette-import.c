...
name|GimpPalette
modifier|*
DECL|function|gimp_palette_import_from_file (GimpContext * context,GFile * file,const gchar * palette_name,GError ** error)
...
return|;
block|}
comment|/* EEK temporary double opening of the file, until all is GIO */
name|path
operator|=
