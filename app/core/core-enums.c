...
block|,
literal|"GIMP_LAYER_MODE_MULTIPLY_BROKEN"
block|,
literal|"multiply-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_SCREEN_BROKEN
block|,
literal|"GIMP_LAYER_MODE_SCREEN_BROKEN"
block|,
literal|"screen-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_OVERLAY_BROKEN
block|,
literal|"GIMP_LAYER_MODE_OVERLAY_BROKEN"
block|,
literal|"overlay-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_DIFFERENCE_BROKEN
block|,
literal|"GIMP_LAYER_MODE_DIFFERENCE_BROKEN"
block|,
literal|"difference-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_ADDITION_BROKEN
block|,
literal|"GIMP_LAYER_MODE_ADDITION_BROKEN"
block|,
literal|"addition-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_SUBTRACT_BROKEN
block|,
literal|"GIMP_LAYER_MODE_SUBTRACT_BROKEN"
block|,
literal|"subtract-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_DARKEN_ONLY_BROKEN
block|,
literal|"GIMP_LAYER_MODE_DARKEN_ONLY_BROKEN"
block|,
literal|"darken-only-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_LIGHTEN_ONLY_BROKEN
block|,
literal|"GIMP_LAYER_MODE_LIGHTEN_ONLY_BROKEN"
block|,
literal|"lighten-only-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_HSV_HUE_BROKEN
block|,
literal|"GIMP_LAYER_MODE_HSV_HUE_BROKEN"
block|,
literal|"hsv-hue-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_HSV_SATURATION_BROKEN
block|,
literal|"GIMP_LAYER_MODE_HSV_SATURATION_BROKEN"
block|,
literal|"hsv-saturation-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_HSV_COLOR_BROKEN
block|,
literal|"GIMP_LAYER_MODE_HSV_COLOR_BROKEN"
block|,
literal|"hsv-color-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_HSV_VALUE_BROKEN
block|,
literal|"GIMP_LAYER_MODE_HSV_VALUE_BROKEN"
block|,
literal|"hsv-value-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_DIVIDE_BROKEN
block|,
literal|"GIMP_LAYER_MODE_DIVIDE_BROKEN"
block|,
literal|"divide-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_DODGE_BROKEN
block|,
literal|"GIMP_LAYER_MODE_DODGE_BROKEN"
block|,
literal|"dodge-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_BURN_BROKEN
block|,
literal|"GIMP_LAYER_MODE_BURN_BROKEN"
block|,
literal|"burn-broken"
block|}
block|,
...
block|,
literal|"GIMP_LAYER_MODE_HARDLIGHT_BROKEN"
block|,
literal|"hardlight-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_SOFTLIGHT_BROKEN
block|,
literal|"GIMP_LAYER_MODE_SOFTLIGHT_BROKEN"
block|,
literal|"softlight-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_GRAIN_EXTRACT_BROKEN
block|,
literal|"GIMP_LAYER_MODE_GRAIN_EXTRACT_BROKEN"
block|,
literal|"grain-extract-broken"
block|}
block|,
block|{
name|GIMP_LAYER_MODE_GRAIN_MERGE_BROKEN
block|,
literal|"GIMP_LAYER_MODE_GRAIN_MERGE_BROKEN"
block|,
literal|"grain-merge-broken"
block|}
block|,
block|{
