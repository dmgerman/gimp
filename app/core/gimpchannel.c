...
specifier|static
name|gboolean
DECL|function|gimp_channel_item_bounds (GimpItem * item,gdouble * x,gdouble * y,gdouble * width,gdouble * height)
name|gimp_channel_item_bounds
parameter_list|(
name|GimpItem
modifier|*
