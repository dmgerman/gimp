...
specifier|static
name|void
name|gimp_channel_buffer_changed
parameter_list|(
name|GeglBuffer
modifier|*
name|buffer
...
condition|)
block|{
comment|/*  8-bit channel hack: make sure pixels between all sorts            *  of channels of an image is always copied without any            *  gamma conversion            */
name|GimpDrawable
modifier|*
name|new_drawable
init|=
...
specifier|static
name|void
DECL|function|gimp_channel_buffer_changed (GeglBuffer * buffer,const GeglRectangle * rect,GimpChannel * channel)
name|gimp_channel_buffer_changed
parameter_list|(
name|GeglBuffer
modifier|*
