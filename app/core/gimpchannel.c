...
specifier|static
name|gint
DECL|function|gimp_channel_real_value (GimpChannel * channel,gint x,gint y)
name|gimp_channel_real_value
parameter_list|(
name|GimpChannel
modifier|*
...
name|GimpChannel
modifier|*
DECL|function|gimp_channel_new_from_alpha (GimpImage * gimage,GimpLayer * layer,const gchar * name,const GimpRGB * color)
...
begin_function
name|gint
DECL|function|gimp_channel_value (GimpChannel * channel,gint x,gint y)
