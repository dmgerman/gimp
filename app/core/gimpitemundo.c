...
specifier|static
name|void
name|gimp_item_undo_constructed
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
DECL|function|gimp_item_undo_constructed (GObject * object)
name|gimp_item_undo_constructed
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_item_undo_pop (GimpUndo * undo,GimpUndoMode undo_mode,GimpUndoAccumulator * accum)
name|gimp_item_undo_pop
parameter_list|(
name|GimpUndo
modifier|*
