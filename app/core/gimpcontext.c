...
comment|/*  remaining values are in gimpcontext.h  */
block|}
enum|;
end_enum
...
specifier|static
name|void
DECL|function|gimp_context_config_iface_init (GimpConfigInterface * config_iface)
name|gimp_context_config_iface_init
parameter_list|(
name|GimpConfigInterface
modifier|*
...
parameter_list|)
block|{
comment|/*   g_free (context->imagefile_name);   context->imagefile_name = g_strdup (GIMP_OBJECT (imagefile)->name);   */
name|g_object_notify
argument_list|(
name|G_OBJECT
argument_list|(
...
parameter_list|)
block|{
comment|/*   GimpBuffer *imagefile;    if (! context->imagefile_name)     context->imagefile_name = g_strdup (context->gimp->config->default_imagefile);    if ((imagefile = (GimpImagefile *)        gimp_container_get_child_by_name (container, 					 context->imagefile_name)))     {       gimp_context_real_set_imagefile (context, imagefile);       return;     }   */
if|if
condition|(
name|gimp_container_num_children
argument_list|(
...
expr_stmt|;
block|}
comment|/*   else     gimp_context_real_set_imagefile (context, 				     GIMP_IMAGEFILE (gimp_imagefile_get_standard ()));   */
block|}
end_function
...
condition|)
return|return;
comment|/*   if (context->imagefile_name&& imagefile != standard_imagefile)     {       g_free (context->imagefile_name);       context->imagefile_name = NULL;     }   */
...
argument_list|)
expr_stmt|;
comment|/*       if (imagefile != standard_imagefile) 	context->imagefile_name = g_strdup (GIMP_OBJECT (imagefile)->name);       */
block|}
name|g_object_notify
argument_list|(
name|G_OBJECT
...
parameter_list|)
block|{
comment|/*   g_free (context->template_name);   context->template_name = g_strdup (GIMP_OBJECT (template)->name);   */
name|g_object_notify
argument_list|(
name|G_OBJECT
argument_list|(
...
parameter_list|)
block|{
comment|/*   GimpBuffer *template;    if (! context->template_name)     context->template_name = g_strdup (context->gimp->config->default_template);    if ((template = (GimpTemplate *)        gimp_container_get_child_by_name (container, 					 context->template_name)))     {       gimp_context_real_set_template (context, template);       return;     }   */
if|if
condition|(
name|gimp_container_num_children
argument_list|(
...
expr_stmt|;
block|}
comment|/*   else     gimp_context_real_set_template (context, 				     GIMP_TEMPLATE (gimp_template_get_standard ()));   */
block|}
end_function
...
condition|)
return|return;
comment|/*   if (context->template_name&& template != standard_template)     {       g_free (context->template_name);       context->template_name = NULL;     }   */
...
argument_list|)
expr_stmt|;
comment|/*       if (template != standard_template) 	context->template_name = g_strdup (GIMP_OBJECT (template)->name);       */
block|}
name|g_object_notify
argument_list|(
name|G_OBJECT
