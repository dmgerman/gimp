...
specifier|static
name|void
name|gimp_context_mybrush_removed
parameter_list|(
name|GimpContainer
modifier|*
name|brush_list
...
specifier|static
name|void
name|gimp_context_mybrush_list_thaw
parameter_list|(
name|GimpContainer
modifier|*
name|container
...
specifier|static
name|void
name|gimp_context_real_set_mybrush
parameter_list|(
name|GimpContext
modifier|*
name|context
...
specifier|static
name|void
name|gimp_context_tool_preset_removed
parameter_list|(
name|GimpContainer
modifier|*
name|container
...
specifier|static
name|void
name|gimp_context_tool_preset_list_thaw
parameter_list|(
name|GimpContainer
modifier|*
name|container
...
specifier|static
name|void
name|gimp_context_distance_metric_changed
parameter_list|(
name|GimpContext
modifier|*
name|context
...
specifier|static
name|void
name|gimp_context_real_set_distance_metric
parameter_list|(
name|GimpContext
modifier|*
name|context
...
block|,
DECL|enumerator|MYBRUSH_CHANGED
...
block|,
DECL|enumerator|TOOL_PRESET_CHANGED
name|TOOL_PRESET_CHANGED
block|,
...
block|,
DECL|enumerator|DISTANCE_METRIC_CHANGED
name|DISTANCE_METRIC_CHANGED
block|,
DECL|enumerator|PROP_NAME_CHANGED
name|PROP_NAME_CHANGED
block|,
...
name|g_signal_new
argument_list|(
literal|"distance-metric-changed"
argument_list|,
name|G_TYPE_FROM_CLASS
argument_list|(
name|klass
...
specifier|static
name|gboolean
DECL|function|gimp_context_deserialize (GimpConfig * config,GScanner * scanner,gint nest_level,gpointer data)
name|gimp_context_deserialize
parameter_list|(
name|GimpConfig
modifier|*
...
begin_function
name|void
DECL|function|gimp_context_dynamics_changed (GimpContext * context)
...
name|GimpMybrush
modifier|*
DECL|function|gimp_context_get_mybrush (GimpContext * context)
name|gimp_context_get_mybrush
parameter_list|(
name|GimpContext
modifier|*
...
begin_function
name|void
DECL|function|gimp_context_set_mybrush (GimpContext * context,GimpMybrush * brush)
name|gimp_context_set_mybrush
parameter_list|(
name|GimpContext
modifier|*
...
begin_function
name|void
DECL|function|gimp_context_mybrush_changed (GimpContext * context)
name|gimp_context_mybrush_changed
parameter_list|(
name|GimpContext
modifier|*
name|context
...
specifier|static
name|void
DECL|function|gimp_context_mybrush_dirty (GimpMybrush * brush,GimpContext * context)
name|gimp_context_mybrush_dirty
parameter_list|(
name|GimpMybrush
modifier|*
...
specifier|static
name|void
DECL|function|gimp_context_mybrush_list_thaw (GimpContainer * container,GimpContext * context)
name|gimp_context_mybrush_list_thaw
parameter_list|(
name|GimpContainer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_context_mybrush_removed (GimpContainer * container,GimpMybrush * brush,GimpContext * context)
name|gimp_context_mybrush_removed
parameter_list|(
name|GimpContainer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_context_real_set_mybrush (GimpContext * context,GimpMybrush * brush)
name|gimp_context_real_set_mybrush
parameter_list|(
name|GimpContext
modifier|*
...
name|GimpToolPreset
modifier|*
DECL|function|gimp_context_get_tool_preset (GimpContext * context)
name|gimp_context_get_tool_preset
parameter_list|(
name|GimpContext
modifier|*
...
begin_function
name|void
DECL|function|gimp_context_set_tool_preset (GimpContext * context,GimpToolPreset * tool_preset)
name|gimp_context_set_tool_preset
parameter_list|(
name|GimpContext
modifier|*
...
begin_function
name|void
DECL|function|gimp_context_tool_preset_changed (GimpContext * context)
...
specifier|static
name|void
DECL|function|gimp_context_tool_preset_dirty (GimpToolPreset * tool_preset,GimpContext * context)
name|gimp_context_tool_preset_dirty
parameter_list|(
name|GimpToolPreset
modifier|*
...
specifier|static
name|void
DECL|function|gimp_context_tool_preset_removed (GimpContainer * container,GimpToolPreset * tool_preset,GimpContext * context)
name|gimp_context_tool_preset_removed
parameter_list|(
name|GimpContainer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_context_tool_preset_list_thaw (GimpContainer * container,GimpContext * context)
name|gimp_context_tool_preset_list_thaw
parameter_list|(
name|GimpContainer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_context_real_set_tool_preset (GimpContext * context,GimpToolPreset * tool_preset)
name|gimp_context_real_set_tool_preset
parameter_list|(
name|GimpContext
modifier|*
...
begin_function
name|GeglDistanceMetric
DECL|function|gimp_context_get_distance_metric (GimpContext * context)
name|gimp_context_get_distance_metric
parameter_list|(
name|GimpContext
modifier|*
...
begin_function
name|void
DECL|function|gimp_context_set_distance_metric (GimpContext * context,GeglDistanceMetric metric)
name|gimp_context_set_distance_metric
parameter_list|(
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|gimp_context_distance_metric_changed (GimpContext * context)
name|gimp_context_distance_metric_changed
parameter_list|(
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|gimp_context_real_set_distance_metric (GimpContext * context,GeglDistanceMetric metric)
name|gimp_context_real_set_distance_metric
parameter_list|(
name|GimpContext
modifier|*
