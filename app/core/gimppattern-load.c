...
name|GList
modifier|*
DECL|function|gimp_pattern_load (GimpContext * context,GFile * file,GError ** error)
...
name|GList
modifier|*
DECL|function|gimp_pattern_load_pixbuf (GimpContext * context,GFile * file,GError ** error)
