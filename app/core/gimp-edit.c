...
begin_function
name|gboolean
DECL|function|gimp_edit_fill_full (GimpImage * image,GimpDrawable * drawable,const GimpRGB * color,GimpPattern * pattern,const gchar * undo_desc)
...
specifier|static
name|gboolean
DECL|function|gimp_edit_fill_internal (GimpImage * image,GimpDrawable * drawable,const GimpRGB * color,GimpPattern * pattern,gdouble opacity,GimpLayerModeEffects paint_mode,const gchar * undo_desc)
name|gimp_edit_fill_internal
parameter_list|(
name|GimpImage
modifier|*
