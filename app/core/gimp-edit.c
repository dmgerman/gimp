...
specifier|static
name|void
DECL|function|new_named_buffer_callback (GtkWidget * w,gpointer client_data,gpointer call_data)
name|new_named_buffer_callback
parameter_list|(
name|GtkWidget
modifier|*
name|w
...
specifier|static
name|void
DECL|function|new_named_buffer (TileManager * new_tiles)
...
parameter_list|)
block|{
comment|/*  Create the dialog box to ask for a name  */
name|query_string_box
argument_list|(
literal|"Named Buffer"
argument_list|,
