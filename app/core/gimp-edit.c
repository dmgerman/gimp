...
name|PASTE
block|,
DECL|enumerator|PASTE_INTO
name|PASTE_INTO
block|,
DECL|enumerator|PASTE_AS_NEW
name|PASTE_AS_NEW
DECL|typedef|PasteAction
block|}
name|PasteAction
typedef|;
end_typedef
...
begin_typedef
DECL|typedef|PasteNamedDialog
typedef|typedef
name|struct
name|_PasteNamedDialog
name|PasteNamedDialog
typedef|;
end_typedef

begin_struct
DECL|struct|_PasteNamedDialog
struct|struct
name|_PasteNamedDialog
block|{
DECL|member|shell
