...
begin_function
name|gboolean
DECL|function|gimp_edit_fill (GimpImage * image,GimpDrawable * drawable,GimpContext * context,GimpFillType fill_type,gdouble opacity,GimpLayerModeEffects paint_mode,GError ** error)
name|gimp_edit_fill
parameter_list|(
name|GimpImage
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_edit_fill_full (GimpImage * image,GimpDrawable * drawable,const GimpRGB * color,GimpPattern * pattern,gdouble opacity,GimpLayerModeEffects paint_mode,const gchar * undo_desc)
name|gimp_edit_fill_full
parameter_list|(
name|GimpImage
modifier|*
...
name|icc_data
condition|)
name|gimp_buffer_set_icc_profile
argument_list|(
name|gimp_buffer
argument_list|,
name|icc_data
