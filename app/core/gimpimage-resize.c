...
argument_list|)
expr_stmt|;
comment|/*  Resize all resize_layers, channels (including selection mask), and    *  vectors    */
while|while
condition|(
operator|(
name|item
...
begin_function
name|void
DECL|function|gimp_image_resize_to_layers (GimpImage * image,GimpContext * context,gint * offset_x,gint * offset_y,gint * new_width,gint * new_height,GimpProgress * progress)
