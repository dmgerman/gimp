...
name|_
argument_list|(
literal|"Enable feathering of fill edges"
argument_list|)
argument_list|,
name|FALSE
argument_list|,
...
begin_function
name|gboolean
DECL|function|gimp_fill_options_get_feather (GimpFillOptions * options,gdouble * radius)
name|gimp_fill_options_get_feather
parameter_list|(
name|GimpFillOptions
modifier|*
name|options
...
begin_function
name|void
DECL|function|gimp_fill_options_set_feather (GimpFillOptions * options,gboolean feather,gdouble radius)
...
name|Babl
modifier|*
DECL|function|gimp_fill_options_get_format (GimpFillOptions * options,GimpDrawable * drawable)
...
begin_function
name|void
DECL|function|gimp_fill_options_fill_buffer (GimpFillOptions * options,GimpDrawable * drawable,GeglBuffer * buffer,gint pattern_offset_x,gint pattern_offset_y)
name|gimp_fill_options_fill_buffer
parameter_list|(
name|GimpFillOptions
modifier|*
