...
block|,
DECL|enumerator|PROP_EXT_PROPERTY_NAME
name|PROP_EXT_PROPERTY_NAME
block|,
...
specifier|static
name|void
name|gimp_data_factory_real_data_cancel
parameter_list|(
name|GimpDataFactory
modifier|*
name|factory
...
condition|)
block|{
name|gimp_data_factory_data_cancel
argument_list|(
name|factory
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|gimp_data_factory_real_data_cancel (GimpDataFactory * factory)
name|gimp_data_factory_real_data_cancel
parameter_list|(
name|GimpDataFactory
modifier|*
...
begin_function
name|void
DECL|function|gimp_data_factory_data_cancel (GimpDataFactory * factory)
name|gimp_data_factory_data_cancel
parameter_list|(
name|GimpDataFactory
modifier|*
...
name|GList
modifier|*
DECL|function|gimp_data_factory_get_data_path_ext (GimpDataFactory * factory)
