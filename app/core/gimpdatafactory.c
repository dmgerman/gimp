...
specifier|static
name|gboolean
DECL|function|gimp_data_factory_is_dir_writable (const gchar * uri,GList * writable_path)
...
specifier|static
name|void
DECL|function|gimp_data_factory_load_directory (GimpDataFactory * factory,GimpContext * context,GHashTable * cache,GList * writable_path,GFile * directory,GFile * top_directory)
name|gimp_data_factory_load_directory
parameter_list|(
name|GimpDataFactory
modifier|*
...
specifier|static
name|void
DECL|function|gimp_data_factory_load_data (GimpDataFactory * factory,GimpContext * context,GHashTable * cache,GList * writable_path,GFile * file,guint64 mtime,GFile * top_directory)
name|gimp_data_factory_load_data
parameter_list|(
name|GimpDataFactory
modifier|*
