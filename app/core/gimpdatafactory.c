...
typedef|typedef
struct|struct
DECL|struct|__anon27b90e9f0108
block|{
DECL|member|factory
name|GimpDataFactory
modifier|*
...
specifier|static
name|void
DECL|function|gimp_data_factory_data_move_to_cache (GimpDataFactory * factory,GimpData * data,gpointer user_data)
...
specifier|static
name|void
DECL|function|gimp_data_factory_data_foreach (GimpDataFactory * factory,GimpDataForeachFunc callback,gpointer user_data)
