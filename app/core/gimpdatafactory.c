...
name|GimpDataFactory
modifier|*
DECL|function|gimp_data_factory_new (Gimp * gimp,GType data_type,const gchar * path_property_name,const GimpDataFactoryLoaderEntry * loader_entries,gint n_loader_entries,GimpDataNewFunc new_func,GimpDataGetStandardFunc standard_func)
