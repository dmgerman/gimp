...
specifier|static
name|void
DECL|function|gimp_constructed (GObject * object)
name|gimp_constructed
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_set_property (GObject * object,guint property_id,const GValue * value,GParamSpec * pspec)
name|gimp_set_property
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_get_property (GObject * object,guint property_id,GValue * value,GParamSpec * pspec)
name|gimp_get_property
parameter_list|(
name|GObject
modifier|*
...
name|g_warning
argument_list|(
literal|"%s: list of contexts not empty upon exit (%d contexts left)\n"
argument_list|,
name|G_STRFUNC
argument_list|,
name|g_list_length
...
name|GList
modifier|*
DECL|function|gimp_get_paint_info_iter (Gimp * gimp)
...
begin_function
name|void
DECL|function|gimp_set_clipboard_image (Gimp * gimp,GimpImage * image)
...
argument_list|)
expr_stmt|;
comment|/* ref first, it could be the same as gimp->clipboard_image, but    * don't bail if equal because always we want the signal emission    */
if|if
condition|(
name|image
condition|)
...
name|GimpImage
modifier|*
DECL|function|gimp_get_clipboard_image (Gimp * gimp)
...
begin_function
name|void
DECL|function|gimp_filter_history_changed (Gimp * gimp)
