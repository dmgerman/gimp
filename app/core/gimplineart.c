...
name|GList
modifier|*
DECL|function|gimp_lineart_find_spline_candidates (GArray * max_positions,gfloat *** normals,gint distance_threshold,gfloat max_angle_deg)
name|gimp_lineart_find_spline_candidates
parameter_list|(
name|GArray
modifier|*
...
specifier|inline
name|GimpVector2
DECL|function|pair2normal (Pixel p,gfloat *** normals)
name|pair2normal
parameter_list|(
name|Pixel
name|p
