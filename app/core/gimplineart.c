...
typedef|typedef
struct|struct
DECL|struct|__anon29c4f5580208
block|{
DECL|member|buffer
name|GeglBuffer
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4f5580308
block|{
DECL|member|closed
name|GeglBuffer
modifier|*
...
specifier|static
name|void
name|gimp_line_art_projection_rendered
parameter_list|(
name|GimpProjection
modifier|*
name|proj
...
specifier|static
name|void
name|gimp_line_art_drawable_painted
parameter_list|(
name|GimpDrawable
modifier|*
name|drawable
...
begin_macro
DECL|function|G_DEFINE_TYPE_WITH_CODE (GimpLineArt,gimp_line_art,GIMP_TYPE_OBJECT,G_ADD_PRIVATE (GimpLineArt))
...
condition|)
block|{
comment|/* we cancel the async, but don't wait for it to finish, since        * it can't actually be interrupted.  instead        * gimp_bucket_fill_compute_line_art_cb() bails if the async has        * been canceled, to avoid accessing the dead tool.        */
...
specifier|static
name|void
DECL|function|gimp_line_art_projection_rendered (GimpProjection * proj,GimpLineArt * line_art)
name|gimp_line_art_projection_rendered
parameter_list|(
name|GimpProjection
modifier|*
...
specifier|static
name|void
DECL|function|gimp_line_art_drawable_painted (GimpDrawable * drawable,GimpLineArt * line_art)
name|gimp_line_art_drawable_painted
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_lineart_compute_normals_curvatures (GeglBuffer * mask,gfloat * normals,gfloat * curvatures,gfloat * smoothed_curvatures,int normal_estimate_mask_size)
name|gimp_lineart_compute_normals_curvatures
parameter_list|(
name|GeglBuffer
modifier|*
...
name|gfloat
modifier|*
DECL|function|gimp_lineart_get_smooth_curvatures (GArray * edgelset)
name|gimp_lineart_get_smooth_curvatures
parameter_list|(
name|GArray
modifier|*
...
name|GArray
modifier|*
DECL|function|gimp_lineart_curvature_extremums (gfloat * curvatures,gfloat * smoothed_curvatures,gint width,gint height)
name|gimp_lineart_curvature_extremums
parameter_list|(
name|gfloat
modifier|*
...
name|gfloat
modifier|*
DECL|function|gimp_lineart_estimate_strokes_radii (GeglBuffer * mask)
name|gimp_lineart_estimate_strokes_radii
parameter_list|(
name|GeglBuffer
modifier|*
