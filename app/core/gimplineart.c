...
name|gfloat
modifier|*
DECL|function|gimp_lineart_estimate_strokes_radii (GeglBuffer * mask,gfloat ** lineart_distmap)
name|gimp_lineart_estimate_strokes_radii
parameter_list|(
name|GeglBuffer
modifier|*
