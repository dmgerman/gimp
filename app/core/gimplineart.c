...
specifier|static
name|void
name|gimp_lineart_add_label_equivalency
parameter_list|(
name|GHashTable
modifier|*
name|equivalencies
...
specifier|static
name|void
DECL|function|gimp_lineart_add_label_equivalency (GHashTable * equivalencies,guint label1,guint label2)
name|gimp_lineart_add_label_equivalency
parameter_list|(
name|GHashTable
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Check that the equivalent label has no equivalent itself. */
if|if
condition|(
operator|(
name|old_eq
...
begin_comment
comment|/**  * Label connected stroke pixels in regions, and leave all non-stroke  * pixels with label 0.  */
end_comment
...
name|GeglBuffer
modifier|*
DECL|function|gimp_lineart_label (GeglBuffer * line_art,guint32 * n_labels)
name|gimp_lineart_label
parameter_list|(
name|GeglBuffer
modifier|*
