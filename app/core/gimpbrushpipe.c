...
begin_comment
comment|/* Parameters related to one single gih file, collected in a struct  * just for clarity.  */
end_comment
...
specifier|static
name|void
DECL|function|init_pipe_parameters ()
name|init_pipe_parameters
parameter_list|()
block|{
name|int
name|i
...
specifier|static
name|void
DECL|function|parse_brush_pipe_parameters (gchar * parameters)
name|parse_brush_pipe_parameters
parameter_list|(
name|gchar
modifier|*
name|parameters
