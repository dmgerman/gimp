...
specifier|static
name|void
DECL|function|gimp_pdb_progress_progress_iface_init (GimpProgressInterface * progress_iface)
name|gimp_pdb_progress_progress_iface_init
parameter_list|(
name|GimpProgressInterface
modifier|*
...
begin_function
name|void
DECL|function|gimp_pdb_progresss_check_callback (GimpPdbProgressClass * klass)
