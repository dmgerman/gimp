...
specifier|static
name|void
DECL|function|gimp_drawable_stack_add_node (GimpDrawableStack * stack,GimpFilter * filter)
name|gimp_drawable_stack_add_node
parameter_list|(
name|GimpDrawableStack
modifier|*
...
specifier|static
name|void
DECL|function|gimp_drawable_stack_remove_node (GimpDrawableStack * stack,GimpFilter * filter)
name|gimp_drawable_stack_remove_node
parameter_list|(
name|GimpDrawableStack
modifier|*
