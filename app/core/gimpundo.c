...
name|PROP_UNDO_TYPE
block|,
DECL|enumerator|PROP_DIRTIES_IMAGE
name|PROP_DIRTIES_IMAGE
block|,
...
name|PROP_SIZE
block|,
DECL|enumerator|PROP_POP_FUNC
name|PROP_POP_FUNC
block|,
DECL|enumerator|PROP_FREE_FUNC
name|PROP_FREE_FUNC
block|}
enum|;
end_enum
...
name|GObject
modifier|*
DECL|function|gimp_undo_constructor (GType type,guint n_params,GObjectConstructParam * params)
name|gimp_undo_constructor
parameter_list|(
name|GType
name|type
