...
begin_function
name|void
DECL|function|gimp_drawable_apply_operation_to_tiles (GimpDrawable * drawable,GimpProgress * progress,const gchar * undo_desc,GeglNode * operation,gboolean linear,TileManager * dest_tiles)
...
specifier|static
name|void
DECL|function|gimp_drawable_apply_operation_private (GimpDrawable * drawable,GimpProgress * progress,const gchar * undo_desc,GeglNode * operation,gboolean linear,GeglBuffer * dest_buffer,const GeglRectangle * rect)
name|gimp_drawable_apply_operation_private
parameter_list|(
name|GimpDrawable
modifier|*
