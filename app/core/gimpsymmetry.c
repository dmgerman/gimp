...
modifier|*
modifier|*
name|gimp_symmetry_real_get_settings
parameter_list|(
name|GimpSymmetry
modifier|*
name|sym
...
modifier|*
modifier|*
DECL|function|gimp_symmetry_real_get_settings (GimpSymmetry * sym,gint * n_properties)
name|gimp_symmetry_real_get_settings
parameter_list|(
name|GimpSymmetry
modifier|*
...
begin_comment
comment|/**  * gimp_symmetry_get_settings:  * @sym:     the #GimpSymmetry  * @n_properties: the number of properties in the returned array  *  * Returns: an array of the symmetry properties which are supposed to  * be settable by the user.  * The returned array must be freed by the caller.  **/
end_comment
...
modifier|*
modifier|*
DECL|function|gimp_symmetry_get_settings (GimpSymmetry * sym,gint * n_properties)
