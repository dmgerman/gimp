...
specifier|static
name|void
name|gimp_symmetry_real_get_transform
parameter_list|(
name|GimpSymmetry
modifier|*
name|sym
...
specifier|static
name|void
DECL|function|gimp_symmetry_real_get_transform (GimpSymmetry * sym,gint stroke,gdouble * angle,gboolean * reflect)
name|gimp_symmetry_real_get_transform
parameter_list|(
name|GimpSymmetry
modifier|*
...
parameter_list|)
block|{
comment|/* The basic symmetry does nothing, since no transformation of the    * brush painting happen. */
block|}
end_function
...
begin_comment
comment|/**  * gimp_symmetry_clear_origin:  * @sym: the #GimpSymmetry  *  * Clear the symmetry's origin coordinates and drawable.  **/
end_comment

begin_function
name|void
DECL|function|gimp_symmetry_clear_origin (GimpSymmetry * sym)
name|gimp_symmetry_clear_origin
parameter_list|(
name|GimpSymmetry
modifier|*
...
begin_function
name|void
DECL|function|gimp_symmetry_get_transform (GimpSymmetry * sym,gint stroke,gdouble * angle,gboolean * reflect)
...
begin_function
name|void
DECL|function|gimp_symmetry_get_matrix (GimpSymmetry * sym,gint stroke,GimpMatrix3 * matrix)
