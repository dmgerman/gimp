...
begin_function
name|void
DECL|function|gimp_image_colormap_update_formats (GimpImage * image)
name|gimp_image_colormap_update_formats
parameter_list|(
name|GimpImage
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* make sure the image's colormap always has at least one color.  when    * n_colors == 0, use black.    */
name|private
operator|->
name|n_colors
operator|=
