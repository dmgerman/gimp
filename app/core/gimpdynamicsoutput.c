...
name|PROP_PRESSURE
block|,
DECL|enumerator|PROP_VELOCITY
name|PROP_VELOCITY
block|,
DECL|enumerator|PROP_DIRECTION
name|PROP_DIRECTION
block|,
DECL|enumerator|PROP_TILT
name|PROP_TILT
block|,
DECL|enumerator|PROP_RANDOM
name|PROP_RANDOM
block|,
DECL|enumerator|PROP_FADE
name|PROP_FADE
block|}
enum|;
end_enum
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpDynamicsOutput,gimp_dynamics_output,GIMP_TYPE_OBJECT)
name|G_DEFINE_TYPE
argument_list|(
