...
begin_define
DECL|macro|DEFAULT_USE_WHEEL
define|#
directive|define
name|DEFAULT_USE_WHEEL
value|FALSE
end_define
...
name|PROP_USE_TILT
block|,
DECL|enumerator|PROP_USE_WHEEL
name|PROP_USE_WHEEL
block|,
...
block|,
DECL|enumerator|PROP_WHEEL_CURVE
name|PROP_WHEEL_CURVE
block|,
...
begin_typedef
DECL|typedef|GimpDynamicsOutputPrivate
typedef|typedef
name|struct
name|_GimpDynamicsOutputPrivate
name|GimpDynamicsOutputPrivate
typedef|;
end_typedef

begin_struct
DECL|struct|_GimpDynamicsOutputPrivate
struct|struct
name|_GimpDynamicsOutputPrivate
block|{
DECL|member|type
...
name|GimpCurve
modifier|*
name|gimp_dynamics_output_create_curve
parameter_list|(
...
specifier|static
name|void
name|gimp_dynamics_output_curve_dirty
parameter_list|(
name|GimpCurve
modifier|*
name|curve
...
directive|if
literal|0
block|g_printerr ("Dynamics queried(aspect). Result: %f, factors: %d, total: %f sign: %f\n",               result, factors, total, sign);
endif|#
directive|endif
name|result
operator|=
...
name|GimpCurve
modifier|*
DECL|function|gimp_dynamics_output_create_curve (GimpDynamicsOutput * output,const gchar * name)
name|gimp_dynamics_output_create_curve
parameter_list|(
name|GimpDynamicsOutput
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dynamics_output_curve_dirty (GimpCurve * curve,GimpDynamicsOutput * output)
name|gimp_dynamics_output_curve_dirty
parameter_list|(
name|GimpCurve
modifier|*
