...
name|SVG_STATE_OUT
block|,
comment|/* not inside an<svg />  */
DECL|enumerator|SVG_STATE_IN
name|SVG_STATE_IN
block|,
comment|/* inside an<svg />      */
DECL|enumerator|SVG_STATE_DONE
name|SVG_STATE_DONE
comment|/* finished, don't care about the rest of the file                    *   (this is stupid, we should continue parsing                    *    and return multiple gradients if there are any)                    */
