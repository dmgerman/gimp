...
name|GList
modifier|*
DECL|function|gimp_gradient_load (GimpContext * context,GFile * file,GError ** error)
...
typedef|typedef
struct|struct
DECL|struct|__anon2b1b75ff0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b1b75ff0208
block|{
DECL|member|offset
name|gdouble
name|offset
...
name|GList
modifier|*
DECL|function|gimp_gradient_load_svg (GimpContext * context,GFile * file,GError ** error)
