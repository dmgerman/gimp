...
typedef|typedef
enum|enum
DECL|enum|__anon27a9951f0103
block|{
DECL|enumerator|SVG_START
name|SVG_START
block|,
DECL|enumerator|SVG_IN_SVG
name|SVG_IN_SVG
block|,
DECL|enumerator|SVG_IN_GRADIENT
name|SVG_IN_GRADIENT
block|,
DECL|enumerator|SVG_IN_GRADIENT_STOP
name|SVG_IN_GRADIENT_STOP
block|,
DECL|enumerator|SVG_IN_UNKNOWN
name|SVG_IN_UNKNOWN
DECL|typedef|SvgParserState
block|}
name|SvgParserState
typedef|;
end_typedef
...
typedef|typedef
struct|struct
DECL|struct|__anon27a9951f0208
block|{
DECL|member|state
name|SvgParserState
name|state
...
typedef|typedef
struct|struct
DECL|struct|__anon27a9951f0308
block|{
DECL|member|offset
name|gdouble
name|offset
...
argument_list|)
expr_stmt|;
comment|/*  FIXME: this will be overwritten by GimpDataFactory  */
name|data
operator|->
name|writable
operator|=
...
name|_
argument_list|(
literal|"Failed to import gradient from '%s': %s"
argument_list|)
argument_list|,
name|gimp_filename_to_utf8
argument_list|(
...
specifier|static
name|void
DECL|function|svg_parser_start_unknown (SvgParser * parser)
name|svg_parser_start_unknown
parameter_list|(
name|SvgParser
modifier|*
...
specifier|static
name|void
DECL|function|svg_parser_end_unknown (SvgParser * parser)
name|svg_parser_end_unknown
parameter_list|(
name|SvgParser
modifier|*
