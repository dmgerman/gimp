...
name|GList
modifier|*
DECL|function|gimp_gradient_load (GimpContext * context,GFile * file,GInputStream * input,GError ** error)
...
name|_
argument_list|(
literal|"In line %d of gradient file: "
argument_list|)
argument_list|,
name|linenum
argument_list|)
...
typedef|typedef
struct|struct
DECL|struct|__anon2af61d1f0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2af61d1f0208
block|{
DECL|member|offset
name|gdouble
name|offset
...
name|GList
modifier|*
DECL|function|gimp_gradient_load_svg (GimpContext * context,GFile * file,GInputStream * input,GError ** error)
...
name|_
argument_list|(
literal|"No linear gradients found."
argument_list|)
argument_list|)
expr_stmt|;
block|}
