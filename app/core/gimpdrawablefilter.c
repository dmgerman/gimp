...
specifier|static
name|void
name|gimp_drawable_filter_sync_crop
parameter_list|(
name|GimpDrawableFilter
modifier|*
name|filter
...
parameter_list|,
name|gboolean
name|old_preview_enabled
parameter_list|,
name|GimpAlignmentType
name|old_preview_alignment
parameter_list|,
name|gdouble
name|old_preview_position
parameter_list|,
name|gboolean
name|update
parameter_list|)
...
specifier|static
name|void
name|gimp_drawable_filter_sync_format
parameter_list|(
name|GimpDrawableFilter
modifier|*
name|filter
...
specifier|static
name|void
name|gimp_drawable_filter_format_changed
parameter_list|(
name|GimpDrawable
modifier|*
name|drawable
...
specifier|static
name|void
name|gimp_drawable_filter_lock_alpha_changed
parameter_list|(
name|GimpLayer
modifier|*
name|layer
...
begin_function
name|void
DECL|function|gimp_drawable_filter_set_crop (GimpDrawableFilter * filter,const GeglRectangle * rect,gboolean update)
...
specifier|static
name|gboolean
DECL|function|gimp_drawable_filter_get_crop_rect (GimpDrawableFilter * filter,gboolean crop_enabled,const GeglRectangle * crop_rect,gboolean preview_enabled,GimpAlignmentType preview_alignment,gdouble preview_position,GeglRectangle * rect)
name|gimp_drawable_filter_get_crop_rect
parameter_list|(
name|GimpDrawableFilter
modifier|*
name|filter
...
return|return
operator|!
name|gegl_rectangle_equal_coords
argument_list|(
name|rect
argument_list|,
literal|0
...
specifier|static
name|void
DECL|function|gimp_drawable_filter_sync_crop (GimpDrawableFilter * filter,gboolean old_crop_enabled,const GeglRectangle * old_crop_rect,gboolean old_preview_enabled,GimpAlignmentType old_preview_alignment,gdouble old_preview_position,gboolean update)
name|gimp_drawable_filter_sync_crop
parameter_list|(
name|GimpDrawableFilter
modifier|*
...
condition|)
block|{
comment|/* if the filter's op has no input, use NORMAL instead of REPLACE, so        * that we composite the op's output on top of the input, instead of        * completely replacing it.        */
name|paint_mode
operator|=
...
specifier|static
name|void
DECL|function|gimp_drawable_filter_sync_format (GimpDrawableFilter * filter)
name|gimp_drawable_filter_sync_format
parameter_list|(
name|GimpDrawableFilter
modifier|*
...
specifier|static
name|void
DECL|function|gimp_drawable_filter_format_changed (GimpDrawable * drawable,GimpDrawableFilter * filter)
name|gimp_drawable_filter_format_changed
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_drawable_filter_lock_alpha_changed (GimpLayer * layer,GimpDrawableFilter * filter)
name|gimp_drawable_filter_lock_alpha_changed
parameter_list|(
name|GimpLayer
modifier|*
