...
name|TempBuf
modifier|*
DECL|function|gimp_brush_scale_buf_up (TempBuf * brush_buf,gint dest_width,gint dest_height)
name|gimp_brush_scale_buf_up
parameter_list|(
name|TempBuf
modifier|*
