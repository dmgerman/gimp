...
begin_function
name|void
DECL|function|gimp_coords_interpolate_bezier (const GimpCoords bezier_pt[4],const gdouble precision,GArray * ret_coords,GArray * ret_params)
...
specifier|static
name|void
DECL|function|gimp_coords_interpolate_bezier_internal (const GimpCoords bezier_pt[4],const gdouble start_t,const gdouble end_t,const gdouble precision,GArray * ret_coords,GArray * ret_params,gint depth)
name|gimp_coords_interpolate_bezier_internal
parameter_list|(
specifier|const
name|GimpCoords
...
parameter_list|)
block|{
comment|/*    * bezier_pt has to contain four GimpCoords with the four control points    * of the bezier segment. We subdivide it at the parameter 0.5.    */
name|GimpCoords
name|subdivided
index|[
literal|8
...
begin_comment
comment|/*  * Returns the position and/or velocity of a Bezier curve at time 't'.  */
end_comment

begin_function
name|void
DECL|function|gimp_coords_interpolate_bezier_at (const GimpCoords bezier_pt[4],gdouble t,GimpCoords * position,GimpCoords * velocity)
...
begin_function
name|gboolean
DECL|function|gimp_coords_bezier_is_straight (const GimpCoords bezier_pt[4],gdouble precision)
name|gimp_coords_bezier_is_straight
parameter_list|(
specifier|const
name|GimpCoords
...
begin_comment
comment|/* Functions for catmull-rom interpolation */
end_comment

begin_function
name|void
DECL|function|gimp_coords_interpolate_catmull (const GimpCoords catmull_pt[4],gdouble precision,GArray * ret_coords,GArray * ret_params)
