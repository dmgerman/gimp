...
begin_function
name|void
DECL|function|gimp_buffer_set_icc_profile (GimpBuffer * buffer,const guint8 * data,gsize length)
name|gimp_buffer_set_icc_profile
parameter_list|(
name|GimpBuffer
modifier|*
...
name|guint8
modifier|*
DECL|function|gimp_buffer_get_icc_profile (const GimpBuffer * buffer,gsize * length)
