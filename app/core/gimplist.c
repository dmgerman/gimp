...
specifier|static
name|void
DECL|function|gimp_list_finalize (GObject * object)
name|gimp_list_finalize
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|gint
DECL|function|gimp_list_sort_func (gconstpointer a,gconstpointer b,gpointer user_data)
name|gimp_list_sort_func
parameter_list|(
name|gconstpointer
name|a
parameter_list|,
...
name|GimpObject
modifier|*
DECL|function|gimp_list_get_child_by_name (GimpContainer * container,const gchar * name)
name|gimp_list_get_child_by_name
parameter_list|(
name|GimpContainer
modifier|*
