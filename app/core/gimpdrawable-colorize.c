...
begin_function
name|void
DECL|function|gimp_drawable_colorize (GimpDrawable * drawable,GimpProgress * progress,gdouble hue,gdouble saturation,gdouble lightness)
