...
begin_function
name|void
DECL|function|gimp_image_set_sample_point_pick_mode (GimpImage * image,GimpSamplePoint * sample_point,GimpColorPickMode pick_mode,gboolean push_undo)
...
literal|"undo-type"
argument_list|,
literal|"Set Sample Point Pick Mode"
argument_list|)
argument_list|,
name|sample_point
argument_list|)
