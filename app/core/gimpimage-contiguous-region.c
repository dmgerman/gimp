...
specifier|static
name|gboolean
DECL|function|find_contiguous_segment (const guchar * col,GeglBuffer * src_buffer,GeglBuffer * mask_buffer,const Babl * src_format,gint bytes,gboolean has_alpha,gint width,gboolean select_transparent,GimpSelectCriterion select_criterion,gboolean antialias,gint threshold,gint initial_x,gint initial_y,gint * start,gint * end)
name|find_contiguous_segment
parameter_list|(
specifier|const
name|guchar
...
specifier|static
name|void
DECL|function|find_contiguous_region_helper (GeglBuffer * src_buffer,GeglBuffer * mask_buffer,const Babl * format,gboolean select_transparent,GimpSelectCriterion select_criterion,gboolean antialias,gint threshold,gint x,gint y,const guchar * col)
name|find_contiguous_region_helper
parameter_list|(
name|GeglBuffer
modifier|*
