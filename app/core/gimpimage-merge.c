...
name|Parasite
modifier|*
DECL|function|gimp_image_find_parasite (const GimpImage * gimage,const char * creator,const char * type)
...
begin_function
name|void
DECL|function|gimp_image_detach_parasite (GimpImage * gimage,Parasite * parasite)
