...
name|GimpLayer
modifier|*
DECL|function|gimp_image_merge_layers (GimpImage * image,GimpContainer * container,GSList * merge_list,GimpContext * context,GimpMergeType merge_type,const gchar * undo_desc)
name|gimp_image_merge_layers
parameter_list|(
name|GimpImage
modifier|*
