...
begin_comment
comment|/*  just like gimp_list_get_child_by_name() but matches case-insensitive  */
end_comment
...
condition|)
block|{
comment|/* We changed the spelling of a couple of template names            * from upper to lower case between 2.0 and 2.2.            */
