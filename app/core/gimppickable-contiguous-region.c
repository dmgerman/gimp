...
argument_list|()
expr_stmt|;
comment|/* Compute a distance map for the labels. */
name|graph
operator|=
name|gegl_node_new
argument_list|()
...
argument_list|)
expr_stmt|;
comment|/* gegl:distance-transform returns distances as float. I want them as        * unsigned ints without converting (i.e. not assuming pixel values).        * Let's just loop through the map).        */
name|tmp
operator|=
name|gegl_buffer_new
argument_list|(
...
name|tmp
expr_stmt|;
comment|/* Flag the mask on the line art. */
name|gi
operator|=
name|gegl_buffer_iterator_new
argument_list|(
