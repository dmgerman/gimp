...
typedef|typedef
struct|struct
DECL|struct|__anon2be3c15e0108
block|{
DECL|member|x
name|gint
name|x
...
name|GeglBuffer
modifier|*
DECL|function|gimp_pickable_contiguous_region_by_seed (GimpPickable * pickable,GimpLineArt * line_art,gboolean antialias,gfloat threshold,gboolean select_transparent,GimpSelectCriterion select_criterion,gboolean diagonal_neighbors,gint x,gint y)
