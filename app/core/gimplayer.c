...
specifier|static
name|void
DECL|function|gimp_layer_set_tiles (GimpDrawable * drawable,gboolean push_undo,const gchar * undo_desc,TileManager * tiles,GimpImageType type)
name|gimp_layer_set_tiles
parameter_list|(
name|GimpDrawable
modifier|*
