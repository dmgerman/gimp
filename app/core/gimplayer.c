...
name|MODE_CHANGED
block|,
DECL|enumerator|COMPOSITE_CHANGED
...
argument_list|)
expr_stmt|;
comment|/*  when changing modes, we always switch to AUTO composite in        *  order to avoid confusion        */
if|if
condition|(
name|layer
operator|->
...
begin_function
name|void
DECL|function|gimp_layer_set_composite (GimpLayer * layer,GimpLayerCompositeMode composite,gboolean push_undo)
name|gimp_layer_set_composite
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|GimpLayerCompositeMode
DECL|function|gimp_layer_get_composite (GimpLayer * layer)
name|gimp_layer_get_composite
parameter_list|(
name|GimpLayer
modifier|*
