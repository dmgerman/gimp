...
name|MODE_CHANGED
block|,
DECL|enumerator|BLEND_SPACE_CHANGED
name|BLEND_SPACE_CHANGED
block|,
DECL|enumerator|COMPOSITE_SPACE_CHANGED
name|COMPOSITE_SPACE_CHANGED
block|,
DECL|enumerator|COMPOSITE_MODE_CHANGED
name|COMPOSITE_MODE_CHANGED
block|,
DECL|enumerator|EFFECTIVE_MODE_CHANGED
name|EFFECTIVE_MODE_CHANGED
block|,
DECL|enumerator|EXCLUDES_BACKDROP_CHANGED
...
block|,
DECL|enumerator|PROP_EXCLUDES_BACKDROP
name|PROP_EXCLUDES_BACKDROP
block|,
...
specifier|static
name|void
name|gimp_layer_real_translate
parameter_list|(
name|GimpLayer
modifier|*
name|layer
...
specifier|static
name|void
name|gimp_layer_real_transform
parameter_list|(
name|GimpLayer
modifier|*
name|layer
...
specifier|static
name|void
name|gimp_layer_real_get_effective_mode
parameter_list|(
name|GimpLayer
modifier|*
name|layer
...
specifier|static
name|gboolean
name|gimp_layer_real_get_excludes_backdrop
parameter_list|(
name|GimpLayer
modifier|*
name|layer
...
name|g_signal_new
argument_list|(
literal|"composite-space-changed"
argument_list|,
name|G_TYPE_FROM_CLASS
argument_list|(
name|klass
...
name|g_signal_new
argument_list|(
literal|"composite-mode-changed"
argument_list|,
name|G_TYPE_FROM_CLASS
argument_list|(
name|klass
...
specifier|static
name|void
DECL|function|gimp_layer_start_move (GimpItem * item,gboolean push_undo)
name|gimp_layer_start_move
parameter_list|(
name|GimpItem
modifier|*
...
name|NULL
decl_stmt|;
comment|/* suspend mask cropping for all of the layer's ancestors */
while|while
condition|(
operator|(
name|ancestor
...
expr_stmt|;
block|}
comment|/* we keep the ancestor list around, so that we can resume mask cropping for    * the same set of groups in gimp_layer_end_move().  note that    * gimp_image_remove_layer() calls start_move() before removing the layer,    * while it's still part of the layer tree, and end_move() afterwards, when    * it's no longer part of the layer tree, and hence we can't use get_parent()    * in end_move() to get the same set of ancestors.    */
name|layer
operator|->
name|move_stack
operator|=
...
specifier|static
name|void
DECL|function|gimp_layer_end_move (GimpItem * item,gboolean push_undo)
name|gimp_layer_end_move
parameter_list|(
name|GimpItem
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* resume mask cropping for all of the layer's ancestors */
for|for
control|(
name|iter
operator|=
...
argument_list|)
expr_stmt|;
comment|/* temporarily set layer->mask to NULL, so that its size won't be counted        * when pushing the layer to the queue.        */
name|mask
operator|=
name|layer
operator|->
...
argument_list|)
expr_stmt|;
comment|/*  when called with a dest_profile, always use the space from that    *  profile, we can't use gimp_image_get_layer_space() during an    *  image type or precision conversion    */
if|if
condition|(
name|dest_profile
condition|)
...
specifier|static
name|void
DECL|function|gimp_layer_real_translate (GimpLayer * layer,gint offset_x,gint offset_y)
name|gimp_layer_real_translate
parameter_list|(
name|GimpLayer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_layer_real_scale (GimpLayer * layer,gint new_width,gint new_height,gint new_offset_x,gint new_offset_y,GimpInterpolationType interpolation_type,GimpProgress * progress)
name|gimp_layer_real_scale
parameter_list|(
name|GimpLayer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_layer_real_resize (GimpLayer * layer,GimpContext * context,GimpFillType fill_type,gint new_width,gint new_height,gint offset_x,gint offset_y)
name|gimp_layer_real_resize
parameter_list|(
name|GimpLayer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_layer_real_flip (GimpLayer * layer,GimpContext * context,GimpOrientationType flip_type,gdouble axis,gboolean clip_result)
name|gimp_layer_real_flip
parameter_list|(
name|GimpLayer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_layer_real_rotate (GimpLayer * layer,GimpContext * context,GimpRotationType rotate_type,gdouble center_x,gdouble center_y,gboolean clip_result)
name|gimp_layer_real_rotate
parameter_list|(
name|GimpLayer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_layer_real_transform (GimpLayer * layer,GimpContext * context,const GimpMatrix3 * matrix,GimpTransformDirection direction,GimpInterpolationType interpolation_type,GimpTransformResize clip_result,GimpProgress * progress)
name|gimp_layer_real_transform
parameter_list|(
name|GimpLayer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_layer_real_get_effective_mode (GimpLayer * layer,GimpLayerMode * mode,GimpLayerColorSpace * blend_space,GimpLayerColorSpace * composite_space,GimpLayerCompositeMode * composite_mode)
name|gimp_layer_real_get_effective_mode
parameter_list|(
name|GimpLayer
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_layer_real_get_excludes_backdrop (GimpLayer * layer)
name|gimp_layer_real_get_excludes_backdrop
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|void
DECL|function|gimp_layer_fix_format_space (GimpLayer * layer,gboolean copy_buffer,gboolean push_undo)
...
argument_list|)
expr_stmt|;
comment|/*  when changing modes, we always switch to AUTO blend and        *  composite in order to avoid confusion        */
if|if
condition|(
name|layer
operator|->
...
begin_function
name|void
DECL|function|gimp_layer_set_blend_space (GimpLayer * layer,GimpLayerColorSpace blend_space,gboolean push_undo)
name|gimp_layer_set_blend_space
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|GimpLayerColorSpace
DECL|function|gimp_layer_get_real_blend_space (GimpLayer * layer)
name|gimp_layer_get_real_blend_space
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|void
DECL|function|gimp_layer_set_composite_space (GimpLayer * layer,GimpLayerColorSpace composite_space,gboolean push_undo)
name|gimp_layer_set_composite_space
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|GimpLayerColorSpace
DECL|function|gimp_layer_get_real_composite_space (GimpLayer * layer)
name|gimp_layer_get_real_composite_space
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|void
DECL|function|gimp_layer_set_composite_mode (GimpLayer * layer,GimpLayerCompositeMode composite_mode,gboolean push_undo)
name|gimp_layer_set_composite_mode
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|GimpLayerCompositeMode
DECL|function|gimp_layer_get_real_composite_mode (GimpLayer * layer)
name|gimp_layer_get_real_composite_mode
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|void
DECL|function|gimp_layer_get_effective_mode (GimpLayer * layer,GimpLayerMode * mode,GimpLayerColorSpace * blend_space,GimpLayerColorSpace * composite_space,GimpLayerCompositeMode * composite_mode)
...
begin_function
name|gboolean
DECL|function|gimp_layer_get_excludes_backdrop (GimpLayer * layer)
name|gimp_layer_get_excludes_backdrop
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|void
DECL|function|gimp_layer_update_effective_mode (GimpLayer * layer)
name|gimp_layer_update_effective_mode
parameter_list|(
name|GimpLayer
modifier|*
...
begin_function
name|void
DECL|function|gimp_layer_update_excludes_backdrop (GimpLayer * layer)
name|gimp_layer_update_excludes_backdrop
parameter_list|(
name|GimpLayer
modifier|*
