...
specifier|static
name|void
DECL|function|gimp_layer_convert_type (GimpDrawable * drawable,GimpImage * dest_image,GimpImageBaseType new_base_type,GimpPrecision new_precision,gboolean push_undo)
name|gimp_layer_convert_type
parameter_list|(
name|GimpDrawable
modifier|*
