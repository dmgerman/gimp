...
specifier|static
name|void
name|gimp_layer_visibility_changed
parameter_list|(
name|GimpItem
modifier|*
name|item
...
specifier|static
name|void
DECL|function|gimp_layer_set_tiles (GimpDrawable * drawable,gboolean push_undo,const gchar * undo_desc,TileManager * tiles,GimpImageType type,gint offset_x,gint offset_y)
name|gimp_layer_set_tiles
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_layer_visibility_changed (GimpItem * item)
name|gimp_layer_visibility_changed
parameter_list|(
name|GimpItem
modifier|*
...
name|GeglNode
modifier|*
DECL|function|gimp_layer_get_node (GimpLayer * layer)
