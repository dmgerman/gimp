...
name|GimpLayer
modifier|*
DECL|function|gimp_layer_copy (const GimpLayer * layer,GType new_type,gboolean add_alpha)
...
name|GimpLayer
modifier|*
DECL|function|gimp_layer_new_from_tiles (GimpImage * gimage,TileManager * tiles,const gchar * name,gint opacity,GimpLayerModeEffects mode)
...
name|GimpLayer
modifier|*
DECL|function|gimp_layer_new_from_drawable (GimpImage * dest_image,GimpDrawable * drawable)
...
begin_function
name|gboolean
DECL|function|gimp_layer_check_scaling (const GimpLayer * layer,gint new_width,gint new_height)
...
begin_function
name|gboolean
DECL|function|gimp_layer_has_alpha (const GimpLayer * layer)
name|gimp_layer_has_alpha
parameter_list|(
specifier|const
name|GimpLayer
...
begin_function
name|gboolean
DECL|function|gimp_layer_get_linked (const GimpLayer * layer)
