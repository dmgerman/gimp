...
DECL|function|gimp_drawable_transform_get_effective_clip (GimpDrawable * drawable,GeglBuffer * orig_buffer,GimpTransformResize clip_result)
...
argument_list|)
expr_stmt|;
comment|/*  Always clip unfloated buffers since they must keep their size  */
if|if
condition|(
