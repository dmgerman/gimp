...
name|TileManager
modifier|*
DECL|function|gimp_drawable_transform_tiles_affine (GimpDrawable * drawable,GimpContext * context,TileManager * orig_tiles,const Babl * orig_format,gint orig_offset_x,gint orig_offset_y,const GimpMatrix3 * matrix,GimpTransformDirection direction,GimpInterpolationType interpolation_type,gint recursion_level,GimpTransformResize clip_result,gint * new_offset_x,gint * new_offset_y,GimpProgress * progress)
...
name|TileManager
modifier|*
DECL|function|gimp_drawable_transform_tiles_flip (GimpDrawable * drawable,GimpContext * context,TileManager * orig_tiles,const Babl * orig_format,gint orig_offset_x,gint orig_offset_y,GimpOrientationType flip_type,gdouble axis,gboolean clip_result,gint * new_offset_x,gint * new_offset_y)
...
name|TileManager
modifier|*
DECL|function|gimp_drawable_transform_tiles_rotate (GimpDrawable * drawable,GimpContext * context,TileManager * orig_tiles,const Babl * orig_format,gint orig_offset_x,gint orig_offset_y,GimpRotationType rotate_type,gdouble center_x,gdouble center_y,gboolean clip_result,gint * new_offset_x,gint * new_offset_y)
...
name|TileManager
modifier|*
DECL|function|gimp_drawable_transform_cut (GimpDrawable * drawable,GimpContext * context,const Babl ** format,gint * offset_x,gint * offset_y,gboolean * new_layer)
name|gimp_drawable_transform_cut
parameter_list|(
name|GimpDrawable
modifier|*
...
name|GimpDrawable
modifier|*
DECL|function|gimp_drawable_transform_paste (GimpDrawable * drawable,TileManager * tiles,const Babl * format,gint offset_x,gint offset_y,gboolean new_layer)
name|gimp_drawable_transform_paste
parameter_list|(
name|GimpDrawable
modifier|*
