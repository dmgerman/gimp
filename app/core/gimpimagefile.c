...
typedef|typedef
struct|struct
DECL|struct|__anon2a23b8820208
block|{
DECL|member|dirname
specifier|const
name|gchar
...
name|_
argument_list|(
literal|"Failed to create preview"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
...
name|gchar
modifier|*
DECL|function|gimp_imagefile_find_png_thumb (const gchar * uri,time_t image_mtime,gint size,time_t * thumb_mtime,gint * thumb_size)
name|gimp_imagefile_find_png_thumb
parameter_list|(
specifier|const
name|gchar
