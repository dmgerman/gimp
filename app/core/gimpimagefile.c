...
typedef|typedef
struct|struct
DECL|struct|__anon2a0975350208
block|{
DECL|member|dirname
specifier|const
name|gchar
...
specifier|static
name|void
DECL|function|gimp_imagefile_set_info (GimpImagefile * imagefile,gint width,gint height,gint size,GimpImageType type)
name|gimp_imagefile_set_info
parameter_list|(
name|GimpImagefile
modifier|*
