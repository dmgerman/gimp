...
typedef|typedef
struct|struct
DECL|struct|__anon2ad69a5d0208
block|{
DECL|member|dirname
specifier|const
name|gchar
...
specifier|static
name|void
DECL|function|gimp_imagefile_set_info (GimpImagefile * imagefile,gboolean emit_always,gint width,gint height,gint size,GimpImageType type,gint n_layers)
name|gimp_imagefile_set_info
parameter_list|(
name|GimpImagefile
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_imagefile_find_png_thumb (const gchar * uri,time_t image_mtime,gint size,time_t * thumb_mtime)
name|gimp_imagefile_find_png_thumb
parameter_list|(
specifier|const
name|gchar
