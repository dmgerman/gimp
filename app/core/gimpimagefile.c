...
typedef|typedef
struct|struct
DECL|struct|__anon2b0e33c20108
block|{
DECL|member|dirname
specifier|const
name|gchar
...
comment|/*    if (changed) */
comment|/*      gimp_object_name_changed (GIMP_OBJECT (imagefile)); */
block|}
end_function
...
name|NULL
return|;
comment|/* FIXME: convert filename to URI */
name|uri
operator|=
...
name|gchar
modifier|*
DECL|function|gimp_imagefile_png_thumb_name (const gchar * uri,gint mtime,gint size)
name|gimp_imagefile_png_thumb_name
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|gboolean
DECL|function|gimp_image_file_test (const gchar * filename,gint * mtime)
name|gimp_image_file_test
parameter_list|(
specifier|const
name|gchar
