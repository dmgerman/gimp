...
specifier|static
name|gint64
name|gimp_group_layer_undo_get_memsize
parameter_list|(
name|GimpObject
modifier|*
name|object
...
specifier|static
name|void
name|gimp_group_layer_undo_free
parameter_list|(
name|GimpUndo
modifier|*
name|undo
...
specifier|static
name|gint64
DECL|function|gimp_group_layer_undo_get_memsize (GimpObject * object,gint64 * gui_size)
name|gimp_group_layer_undo_get_memsize
parameter_list|(
name|GimpObject
modifier|*
...
condition|)
block|{
comment|/*  resume group layer mask auto-resizing  */
...
block|{
comment|/*  suspend group layer mask auto-resizing  */
...
specifier|static
name|void
DECL|function|gimp_group_layer_undo_free (GimpUndo * undo,GimpUndoMode undo_mode)
name|gimp_group_layer_undo_free
parameter_list|(
name|GimpUndo
modifier|*
