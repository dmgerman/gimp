...
begin_function
name|void
DECL|function|gimp_drawable_set_is_last_node (GimpDrawable * drawable,gboolean last_node)
...
begin_function
name|gboolean
DECL|function|gimp_drawable_get_is_last_node (GimpDrawable * drawable)
