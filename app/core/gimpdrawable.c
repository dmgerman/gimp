...
begin_function
name|void
DECL|function|gimp_drawable_apply_image (GimpDrawable * drawable,int x1,int y1,int x2,int y2,TileManager * tiles,int sparse)
...
name|char
modifier|*
DECL|function|gimp_drawable_name (GimpDrawable * drawable)
