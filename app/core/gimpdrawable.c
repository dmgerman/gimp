...
name|GimpDrawable
modifier|*
DECL|function|gimp_drawable_new (GType type,GimpImage * image,const gchar * name,gint offset_x,gint offset_y,gint width,gint height,GimpImageType image_type)
...
begin_function
name|void
DECL|function|gimp_drawable_set_buffer (GimpDrawable * drawable,gboolean push_undo,const gchar * undo_desc,GeglBuffer * buffer,GimpImageType type)
...
begin_function
name|void
DECL|function|gimp_drawable_set_buffer_full (GimpDrawable * drawable,gboolean push_undo,const gchar * undo_desc,GeglBuffer * buffer,GimpImageType type,gint offset_x,gint offset_y)
name|gimp_drawable_set_buffer_full
parameter_list|(
name|GimpDrawable
modifier|*
...
begin_function
name|void
DECL|function|gimp_drawable_recreate_buffers (GimpDrawable * drawable)
