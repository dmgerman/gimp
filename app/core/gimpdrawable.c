...
begin_function
name|void
DECL|function|gimp_drawable_init_src_region (GimpDrawable * drawable,PixelRegion * srcPR,gint x,gint y,gint width,gint height,GeglBuffer ** temp_buffer)
