...
begin_function
name|void
DECL|function|gimp_drawable_init_src_region (GimpDrawable * drawable,PixelRegion * srcPR,gint x,gint y,gint width,gint height)
...
condition|)
block|{
comment|/*  FIXME: return the composite of the layer and the floating        *  selection.        */
name|pixel_region_init
argument_list|(
name|srcPR
argument_list|,
