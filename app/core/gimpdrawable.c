...
specifier|static
name|void
DECL|function|gimp_drawable_transform (GimpItem * item,const GimpMatrix3 * matrix,GimpTransformDirection direction,GimpInterpolationType interpolation_type,gboolean supersample,gboolean clip_result,GimpProgressFunc progress_callback,gpointer progress_data)
name|gimp_drawable_transform
parameter_list|(
name|GimpItem
modifier|*
...
specifier|static
name|void
DECL|function|gimp_drawable_real_set_tiles (GimpDrawable * drawable,gboolean push_undo,const gchar * undo_desc,TileManager * tiles,GimpImageType type)
name|gimp_drawable_real_set_tiles
parameter_list|(
name|GimpDrawable
modifier|*
