...
name|gdouble
modifier|*
name|create_lanczos_lookup_transform
parameter_list|(
name|void
parameter_list|)
function_decl|;
...
begin_function
name|void
DECL|function|gimp_transform_region (GimpPickable * pickable,GimpContext * context,TileManager * orig_tiles,PixelRegion * destPR,gint x1,gint y1,gint x2,gint y2,const GimpMatrix3 * matrix,GimpInterpolationType interpolation_type,gboolean supersample,gint recursion_level,GimpProgress * progress)
...
name|gdouble
modifier|*
DECL|function|create_lanczos_lookup_transform (void)
name|create_lanczos_lookup_transform
parameter_list|(
name|void
parameter_list|)
