...
specifier|static
name|void
DECL|function|sample_bi (PixelSurround * surround,const gint x,const gint y,guchar * color,const gint bpp,const gint alpha)
name|sample_bi
parameter_list|(
name|PixelSurround
modifier|*
...
specifier|static
name|void
DECL|function|get_sample (PixelSurround * surround,const gint xc,const gint yc,const gint x0,const gint y0,const gint x1,const gint y1,const gint x2,const gint y2,const gint x3,const gint y3,gint * cc,const gint level,guint * color,const gint bpp,const gint alpha)
name|get_sample
parameter_list|(
name|PixelSurround
modifier|*
...
specifier|static
name|void
DECL|function|sample_adapt (PixelSurround * surround,const gdouble xc,const gdouble yc,const gdouble x0,const gdouble y0,const gdouble x1,const gdouble y1,const gdouble x2,const gdouble y2,const gdouble x3,const gdouble y3,const gint level,guchar * color,const gint bpp,const gint alpha)
name|sample_adapt
parameter_list|(
name|PixelSurround
modifier|*
