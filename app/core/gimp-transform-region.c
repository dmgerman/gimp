...
specifier|inline
name|void
DECL|function|untransform_coords (const GimpMatrix3 * m,gint x,gint y,gdouble * tu,gdouble * tv,gdouble * tw)
name|untransform_coords
parameter_list|(
specifier|const
name|GimpMatrix3
...
specifier|static
name|void
DECL|function|sample_lanczos (PixelSurround * surround,const gfloat * lanczos,gdouble u,gdouble v,guchar * color,gint bytes,gint alpha)
name|sample_lanczos
parameter_list|(
name|PixelSurround
modifier|*
