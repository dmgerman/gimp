...
typedef|typedef
struct|struct
DECL|struct|__anon27c177e10208
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon27c177e10308
block|{
DECL|member|ncolors
name|long
name|ncolors
...
typedef|typedef
struct|struct
DECL|struct|__anon27c177e10408
block|{
...
directive|if
literal|0
block|has_alpha = gimp_layer_has_alpha (layer);       switch (new_type) 	{ 	case GIMP_RGB: 	  new_layer_type = (has_alpha) ? RGBA_GIMAGE : RGB_GIMAGE; 	  new_layer_bytes = (has_alpha) ? 4 : 3; 	  break; 	case GIMP_GRAY: 	  new_layer_type = (has_alpha) ? GRAYA_GIMAGE : GRAY_GIMAGE; 	  new_layer_bytes = (has_alpha) ? 2 : 1; 	  break; 	case GIMP_INDEXED: 	  new_layer_type = (has_alpha) ? INDEXEDA_GIMAGE : INDEXED_GIMAGE; 	  new_layer_bytes = (has_alpha) ? 2 : 1; 	  break; 	default: 	  break; 	}       new_tiles = tile_manager_new (GIMP_DRAWABLE(layer)->width, 				    GIMP_DRAWABLE(layer)->height, 				    new_layer_bytes);
endif|#
directive|endif
switch|switch
condition|(
