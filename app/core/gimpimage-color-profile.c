...
DECL|function|gimp_image_get_color_transform_to_srgb_u8 (GimpImage * image,const Babl ** pixel_format,const Babl ** srgb_u8_format)
...
begin_function
name|GimpColorTransform
DECL|function|gimp_image_get_color_transform_from_srgb_u8 (GimpImage * image,const Babl ** pixel_format,const Babl ** srgb_u8_format)
...
begin_function
name|GimpColorTransform
DECL|function|gimp_image_get_color_transform_to_srgb_double (GimpImage * image,const Babl ** pixel_format,const Babl ** srgb_double_format)
...
begin_function
name|GimpColorTransform
DECL|function|gimp_image_get_color_transform_from_srgb_double (GimpImage * image,const Babl ** pixel_format,const Babl ** srgb_double_format)
...
decl_stmt|;
name|cmsUInt32Number
name|srgb_u8_lcms_format
decl_stmt|;
name|cmsUInt32Number
name|srgb_double_lcms_format
decl_stmt|;
name|cmsUInt32Number
name|flags
decl_stmt|;
