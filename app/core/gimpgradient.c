...
specifier|static
name|void
name|gimp_gradient_get_flat_color
parameter_list|(
name|GimpContext
modifier|*
name|context
...
specifier|inline
name|gdouble
name|gimp_gradient_calc_step_factor
parameter_list|(
name|gdouble
name|middle
parameter_list|,
...
begin_decl_stmt
DECL|variable|fish_srgb_to_cie_lab
specifier|static
specifier|const
name|Babl
modifier|*
name|fish_srgb_to_cie_lab
init|=
name|NULL
decl_stmt|;
end_decl_stmt
...
specifier|static
name|void
DECL|function|gimp_gradient_copy (GimpData * data,GimpData * src_data)
name|gimp_gradient_copy
parameter_list|(
name|GimpData
modifier|*
...
specifier|static
name|gint
DECL|function|gimp_gradient_compare (GimpData * data1,GimpData * data2)
name|gimp_gradient_compare
parameter_list|(
name|GimpData
modifier|*
...
name|is_custom2
decl_stmt|;
comment|/* check whether data1 and data2 are the custom gradient, which is the only    * writable internal gradient.    */
name|is_custom1
operator|=
...
argument_list|)
expr_stmt|;
comment|/* order the custom gradient before all the other gradients; use the default    * ordering for the rest.    */
if|if
condition|(
name|is_custom1
condition|)
...
begin_function
name|void
DECL|function|gimp_gradient_segment_get_left_flat_color (GimpGradient * gradient,GimpContext * context,GimpGradientSegment * seg,GimpRGB * color)
name|gimp_gradient_segment_get_left_flat_color
parameter_list|(
name|GimpGradient
modifier|*
...
begin_function
name|void
DECL|function|gimp_gradient_segment_get_right_flat_color (GimpGradient * gradient,GimpContext * context,GimpGradientSegment * seg,GimpRGB * color)
name|gimp_gradient_segment_get_right_flat_color
parameter_list|(
name|GimpGradient
modifier|*
...
begin_function
name|gint
DECL|function|gimp_gradient_segment_range_get_n_segments (GimpGradient * gradient,GimpGradientSegment * range_l,GimpGradientSegment * range_r)
...
block|}
block|}
comment|/* Make sure that the left and right endpoints of the range are *exactly*    * equal to new_l and new_r; the above computations can introduce    * numerical inaccuracies.    */
name|range_l
operator|->
name|left
operator|=
...
begin_function
name|void
DECL|function|gimp_gradient_segment_range_merge (GimpGradient * gradient,GimpGradientSegment * start_seg,GimpGradientSegment * end_seg,GimpGradientSegment ** final_start_seg,GimpGradientSegment ** final_end_seg)
...
argument_list|)
expr_stmt|;
comment|/* Copy the end segment's right position and color to the start segment */
name|start_seg
operator|->
name|right
operator|=
...
name|right_color
expr_stmt|;
comment|/* Center the start segment's midpoint */
name|start_seg
operator|->
name|middle
operator|=
...
literal|2.0
expr_stmt|;
comment|/* Remove range segments past the start segment from the segment list */
name|start_seg
operator|->
name|next
operator|=
...
name|start_seg
expr_stmt|;
comment|/* Merge the range's blend function and coloring type, and free the rest of    * the segments.    */
name|seg
operator|=
name|end_seg
expr_stmt|;
...
name|prev
decl_stmt|;
comment|/* If the blend function and/or coloring type aren't uniform, reset them. */
if|if
condition|(
name|seg
operator|->
...
specifier|static
name|void
DECL|function|gimp_gradient_get_flat_color (GimpContext * context,const GimpRGB * color,GimpGradientColor color_type,GimpRGB * flat_color)
name|gimp_gradient_get_flat_color
parameter_list|(
name|GimpContext
modifier|*
...
specifier|inline
name|gdouble
DECL|function|gimp_gradient_calc_step_factor (gdouble middle,gdouble pos)
name|gimp_gradient_calc_step_factor
parameter_list|(
name|gdouble
name|middle
