...
name|data
decl_stmt|;
comment|/*  temporarily set the item to not being linked, or we will        *  run into a recursion because gimp_item_is_position_locked()        *  call this function if the item is linked        */
name|gimp_item_set_linked
argument_list|(
name|item
argument_list|,
