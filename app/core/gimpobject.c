...
argument_list|,
argument|G_ADD_PRIVATE (GimpObject)
argument_list|)
end_macro
...
name|p
operator|=
name|gimp_object_get_instance_private
argument_list|(
name|object
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|gimp_object_constructed (GObject * object)
name|gimp_object_constructed
parameter_list|(
name|GObject
modifier|*
