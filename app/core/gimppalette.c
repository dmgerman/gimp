...
specifier|static
name|void
DECL|function|gimp_palette_copy (GimpData * data,GimpData * src_data)
name|gimp_palette_copy
parameter_list|(
name|GimpData
modifier|*
...
begin_function
name|void
DECL|function|gimp_palette_move_entry (GimpPalette * palette,GimpPaletteEntry * entry,gint position)
