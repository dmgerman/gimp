...
name|GimpPaletteEntry
modifier|*
DECL|function|gimp_palette_add_entry (GimpPalette * palette,const gchar * name,const GimpRGB * color)
name|gimp_palette_add_entry
parameter_list|(
name|GimpPalette
modifier|*
...
name|GimpPaletteEntry
modifier|*
DECL|function|gimp_palette_insert_entry (GimpPalette * palette,gint position,const gchar * name,const GimpRGB * color)
