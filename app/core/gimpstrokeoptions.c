...
parameter_list|)
define|\
value|((GimpStrokeOptionsPrivate *) gimp_stroke_options_get_instance_private ((GimpStrokeOptions *) (options)))
end_define
...
argument_list|,
argument|G_ADD_PRIVATE (GimpStrokeOptions)                          G_IMPLEMENT_INTERFACE (GIMP_TYPE_CONFIG,                                                 gimp_stroke_options_config_iface_init)
argument_list|)
end_macro
