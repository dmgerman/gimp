...
name|g_message
argument_list|(
literal|"gimp_image_resize: width and height must be positive"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|GimpImage
modifier|*
DECL|function|gimp_image_get_named (char * name)
...
begin_function
name|int
DECL|function|gimp_image_is_flat (GimpImage * gimage)
name|gimp_image_is_flat
parameter_list|(
name|GimpImage
modifier|*
...
name|FALSE
expr_stmt|;
comment|/* AUGH! This is supposed to be a _predicate_ function */
if|if
condition|(
name|gimage
operator|->
...
begin_function
name|void
DECL|function|gimp_image_invalidate_previews (void)
