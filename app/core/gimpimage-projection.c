...
name|GimpGuide
modifier|*
DECL|function|gimp_image_find_guide (GimpImage * gimage,gint x,gint y)
...
begin_function
name|gboolean
DECL|function|gimp_image_snap_point (GimpImage * gimage,gint x,gint y,gint * tx,gint * ty)
...
begin_function
name|gboolean
DECL|function|gimp_image_snap_rectangle (GimpImage * gimage,gint x1,gint y1,gint x2,gint y2,gint * tx1,gint * ty1)
