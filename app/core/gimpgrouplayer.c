...
name|child_bounding_box
operator|=
name|gimp_drawable_get_bounding_box
argument_list|(
name|GIMP_DRAWABLE
argument_list|(
name|child
...
argument_list|)
expr_stmt|;
comment|/* update the bounding box before updating the projection, so that it        * picks up the right size.        */
name|private
operator|->
name|bounding_box
operator|=
