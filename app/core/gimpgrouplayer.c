...
specifier|static
name|void
DECL|function|gimp_group_layer_resize (GimpLayer * layer,GimpContext * context,GimpFillType fill_type,gint new_width,gint new_height,gint offset_x,gint offset_y)
name|gimp_group_layer_resize
parameter_list|(
name|GimpLayer
modifier|*
