...
specifier|static
name|void
DECL|function|gimp_group_layer_transform (GimpItem * item,GimpContext * context,const GimpMatrix3 * matrix,GimpTransformDirection direction,GimpInterpolationType interpolation_type,GimpTransformResize clip_result,GimpProgress * progress)
name|gimp_group_layer_transform
parameter_list|(
name|GimpItem
modifier|*
...
specifier|static
name|void
DECL|function|gimp_group_layer_convert_type (GimpDrawable * drawable,GimpImage * dest_image,const Babl * new_format,GimpImageBaseType new_base_type,GimpPrecision new_precision,gint layer_dither_type,gint mask_dither_type,gboolean convert_profile,gboolean push_undo,GimpProgress * progress)
name|gimp_group_layer_convert_type
parameter_list|(
name|GimpDrawable
modifier|*
