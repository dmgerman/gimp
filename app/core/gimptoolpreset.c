...
begin_define
DECL|macro|DEFAULT_USE_MYBRUSH
define|#
directive|define
name|DEFAULT_USE_MYBRUSH
value|TRUE
end_define
...
block|,
DECL|enumerator|PROP_USE_MYBRUSH
...
specifier|static
name|void
name|gimp_tool_preset_options_prop_name_changed
parameter_list|(
name|GimpContext
modifier|*
name|tool_options
...
specifier|static
name|void
DECL|function|gimp_tool_preset_options_prop_name_changed (GimpContext * tool_options,GimpContextPropType prop,GimpToolPreset * preset)
name|gimp_tool_preset_options_prop_name_changed
parameter_list|(
name|GimpContext
modifier|*
