...
name|GimpLayer
modifier|*
DECL|function|gimp_layer_new_from_gegl_buffer (GeglBuffer * buffer,GimpImage * dest_image,const Babl * format,const gchar * name,gdouble opacity,GimpLayerModeEffects mode)
name|gimp_layer_new_from_gegl_buffer
parameter_list|(
name|GeglBuffer
modifier|*
