...
specifier|static
name|void
name|gimp_brush_generated_get_half_width_and_height
parameter_list|(
...
specifier|static
name|void
name|gimp_brush_generated_real_get_scaled_size
parameter_list|(
name|GimpBrush
modifier|*
name|gbrush
...
begin_comment
comment|/* This function is shared between gimp_brush_get_scaled_size and    gimp_brush_generated_calc, therefore we provide a bunch of optional pointers    for returnvalues. */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_brush_generated_get_half_width_and_height (GimpBrushGenerated * gbrush,GimpBrushGeneratedShape shape,gfloat radius,gint spikes,gfloat hardness,gfloat aspect_ratio,gdouble angle_in_degrees,gint * half_width,gint * half_height,gdouble * _s,gdouble * _c,GimpVector2 * _x_axis,GimpVector2 * _y_axis)
name|gimp_brush_generated_get_half_width_and_height
parameter_list|(
name|GimpBrushGenerated
modifier|*
...
specifier|static
name|void
DECL|function|gimp_brush_generated_real_get_scaled_size (GimpBrush * brush,gdouble scale,gint * width,gint * height)
name|gimp_brush_generated_real_get_scaled_size
parameter_list|(
name|GimpBrush
modifier|*
