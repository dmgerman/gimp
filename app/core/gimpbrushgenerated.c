...
name|GimpData
modifier|*
DECL|function|gimp_brush_generated_new (const gchar * name,gfloat radius,gfloat hardness,gfloat angle,gfloat aspect_ratio,gboolean stingy_memory_use)
name|gimp_brush_generated_new
parameter_list|(
specifier|const
name|gchar
