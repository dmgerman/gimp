...
specifier|static
name|void
name|gimp_brush_generated_copy
parameter_list|(
name|GimpData
modifier|*
name|data
...
specifier|static
name|void
DECL|function|gimp_brush_generated_copy (GimpData * data,GimpData * src_data)
name|gimp_brush_generated_copy
parameter_list|(
name|GimpData
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Since generated brushes are symmetric they don't have aspect    * ratios< 1.0. it's the same as rotating by 90 degrees and 1 /    * ratio, so we fix the input for this case.    */
if|if
condition|(
name|aspect_ratio
operator|<
