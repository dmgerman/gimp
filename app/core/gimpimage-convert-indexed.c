...
include|#
directive|include
file|"gimpimage-convert-indexed.h"
end_include
...
expr_stmt|;
block|}
comment|/*  When converting from GRAY, set the new profile.    */
if|if
condition|(
name|old_type
operator|==
...
specifier|static
name|void
DECL|function|generate_histogram_rgb (CFHistogram histogram,GimpLayer * layer,gint col_limit,gboolean dither_alpha,GimpProgress * progress)
name|generate_histogram_rgb
parameter_list|(
name|CFHistogram
name|histogram
...
specifier|static
name|void
DECL|function|median_cut_pass2_no_dither_gray (QuantizeObj * quantobj,GimpLayer * layer,GeglBuffer * new_buffer)
...
specifier|static
name|void
DECL|function|median_cut_pass2_fixed_dither_gray (QuantizeObj * quantobj,GimpLayer * layer,GeglBuffer * new_buffer)
...
specifier|static
name|void
DECL|function|median_cut_pass2_no_dither_rgb (QuantizeObj * quantobj,GimpLayer * layer,GeglBuffer * new_buffer)
...
specifier|static
name|void
DECL|function|median_cut_pass2_fixed_dither_rgb (QuantizeObj * quantobj,GimpLayer * layer,GeglBuffer * new_buffer)
...
specifier|static
name|void
DECL|function|median_cut_pass2_nodestruct_dither_rgb (QuantizeObj * quantobj,GimpLayer * layer,GeglBuffer * new_buffer)
...
specifier|static
name|void
DECL|function|median_cut_pass2_fs_dither_gray (QuantizeObj * quantobj,GimpLayer * layer,GeglBuffer * new_buffer)
...
specifier|static
name|void
DECL|function|median_cut_pass2_fs_dither_rgb (QuantizeObj * quantobj,GimpLayer * layer,GeglBuffer * new_buffer)
...
begin_function
name|void
DECL|function|gimp_image_convert_indexed_set_dither_matrix (const guchar * matrix,gint width,gint height)
