...
specifier|static
name|gsize
DECL|function|gimp_parasite_list_get_memsize (GimpObject * object)
name|gimp_parasite_list_get_memsize
parameter_list|(
name|GimpObject
modifier|*
...
specifier|static
name|gint
DECL|function|free_a_parasite (gpointer key,gpointer parasite,gpointer unused)
name|free_a_parasite
parameter_list|(
name|gpointer
name|key
...
specifier|static
name|void
DECL|function|parasite_copy_one (gpointer key,gpointer parasite,gpointer list)
