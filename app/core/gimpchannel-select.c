...
begin_function
name|void
DECL|function|gimp_channel_select_buffer (GimpChannel * channel,const gchar * undo_desc,GeglBuffer * add_on,gint offset_x,gint offset_y,GimpChannelOps op,gboolean feather,gdouble feather_radius_x,gdouble feather_radius_y)
...
begin_function
name|void
DECL|function|gimp_channel_select_by_index (GimpChannel * channel,GimpDrawable * drawable,gint index,GimpChannelOps op,gboolean feather,gdouble feather_radius_x,gdouble feather_radius_y)
...
literal|"undo-type"
argument_list|,
literal|"Select by Indexed Color"
argument_list|)
argument_list|,
name|add_on
argument_list|,
