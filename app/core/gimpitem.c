...
specifier|static
name|void
name|gimp_item_real_start_transform
parameter_list|(
name|GimpItem
modifier|*
name|item
...
specifier|static
name|void
name|gimp_item_real_end_transform
parameter_list|(
name|GimpItem
modifier|*
name|item
...
specifier|static
name|void
DECL|function|gimp_item_real_start_transform (GimpItem * item,gboolean push_undo)
name|gimp_item_real_start_transform
parameter_list|(
name|GimpItem
modifier|*
...
specifier|static
name|void
DECL|function|gimp_item_real_end_transform (GimpItem * item,gboolean push_undo)
name|gimp_item_real_end_transform
parameter_list|(
name|GimpItem
modifier|*
...
begin_function
name|void
DECL|function|gimp_item_start_move (GimpItem * item,gboolean push_undo)
name|gimp_item_start_move
parameter_list|(
name|GimpItem
modifier|*
...
begin_function
name|void
DECL|function|gimp_item_end_move (GimpItem * item,gboolean push_undo)
name|gimp_item_end_move
parameter_list|(
name|GimpItem
modifier|*
...
begin_function
name|void
DECL|function|gimp_item_start_transform (GimpItem * item,gboolean push_undo)
...
begin_function
name|void
DECL|function|gimp_item_end_transform (GimpItem * item,gboolean push_undo)
...
decl_stmt|;
name|gint
name|new_item_offset_x
decl_stmt|;
name|gint
name|new_item_offset_y
decl_stmt|;
name|gint
name|new_item_width
decl_stmt|;
...
begin_comment
comment|/**  * gimp_item_scale_by_factors:  * @item:         Item to be transformed by explicit width and height factors.  * @w_factor:     scale factor to apply to width and horizontal offset  * @h_factor:     scale factor to apply to height and vertical offset  * @origin_x:     x-coordinate of the transformation input origin  * @origin_y:     y-coordinate of the transformation input origin  * @new_origin_x: x-coordinate of the transformation output origin  * @new_origin_y: y-coordinate of the transformation output origin  * @interpolation:  * @progress:  *  * Same as gimp_item_scale_by_factors(), but with the option to specify  * custom input and output points of origin for the transformation.  *  * Returns: #TRUE, if the scaled item has positive dimensions  *          #FALSE if the scaled item has at least one zero dimension  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_item_scale_by_factors_with_origin (GimpItem * item,gdouble w_factor,gdouble h_factor,gint origin_x,gint origin_y,gint new_origin_x,gint new_origin_y,GimpInterpolationType interpolation,GimpProgress * progress)
name|gimp_item_scale_by_factors_with_origin
parameter_list|(
name|GimpItem
modifier|*
...
name|g_warning
argument_list|(
literal|"%s: requested width or height scale is non-positive"
argument_list|,
name|G_STRFUNC
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* note that we call gimp_item_start_move(), and not    * gimp_item_start_transform().  whether or not a resize operation should be    * considered a transform operation, or a move operation, depends on the    * intended use of these functions by subclasses.  atm, we only use    * gimp_item_{start,end}_transform() to suspend mask resizing in group    * layers, which should not happen when reisizing a group, hence the call to    * gimp_item_start_move().    *    * see the comment in gimp_group_layer_resize() for more information.    */
name|gimp_item_start_move
argument_list|(
name|item
argument_list|,
...
begin_function
name|GimpColorTag
DECL|function|gimp_item_get_merged_color_tag (GimpItem * item)
