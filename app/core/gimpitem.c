...
begin_function
name|void
DECL|function|gimp_item_sink (GimpItem * item)
name|gimp_item_sink
parameter_list|(
name|GimpItem
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_item_stroke (GimpItem * item,GimpDrawable * drawable,GimpContext * context,GimpObject * stroke_desc,gboolean use_default_values)
