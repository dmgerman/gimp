...
begin_function
name|void
DECL|function|gimp_item_offsets (const GimpItem * item,gint * off_x,gint * off_y)
...
begin_function
name|void
DECL|function|gimp_item_translate (GimpItem * item,gint off_x,gint off_y,gboolean push_undo)
