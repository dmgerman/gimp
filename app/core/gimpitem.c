...
begin_function
name|void
DECL|function|gimp_item_set_metadata (GimpItem * item,GimpMetadata * metadata,gboolean push_undo)
...
name|push_undo
condition|)
name|gimp_image_undo_push_item_metadata
argument_list|(
name|gimp_item_get_image
argument_list|(
name|item
...
name|GimpMetadata
modifier|*
DECL|function|gimp_item_get_metadata (GimpItem * item)
