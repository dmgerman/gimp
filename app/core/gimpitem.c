...
begin_comment
comment|/**  * gimp_item_configure:  * @item:     The #GimpItem to configure.  * @offset_x: The X offset to assign the item.  * @offset_y: The Y offset to assign the item.  * @width:    The width to assign the item.  * @height:   The height to assign the item.  * @name:     The name to assign the item.  *  * This function is used to configure a new item.  */
end_comment

begin_function
name|void
DECL|function|gimp_item_configure (GimpItem * item,gint offset_x,gint offset_y,gint width,gint height,const gchar * name)
name|gimp_item_configure
parameter_list|(
name|GimpItem
modifier|*
