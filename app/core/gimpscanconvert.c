...
include|#
directive|include
file|<libart_lgpl/art_gray_svp.h>
end_include

begin_include
include|#
directive|include
file|<libart_lgpl/art_misc.h>
end_include

begin_include
include|#
directive|include
file|<libart_lgpl/art_pathcode.h>
end_include

begin_include
include|#
directive|include
file|<libart_lgpl/art_svp.h>
end_include

begin_include
include|#
directive|include
file|<libart_lgpl/art_svp_vpath.h>
end_include

begin_include
include|#
directive|include
file|<libart_lgpl/art_svp_wind.h>
end_include

begin_include
include|#
directive|include
file|<libart_lgpl/art_vpath.h>
end_include
...
expr_stmt|;
block|}
comment|/* We need up to two extra nodes later to close and finish the path */
name|sc
operator|->
name|vpath
operator|=
