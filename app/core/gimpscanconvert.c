...
name|GimpScanConvert
modifier|*
DECL|function|gimp_scan_convert_new_from_boundary (const GimpBoundSeg * bound_segs,gint n_bound_segs,gint offset_x,gint offset_y)
