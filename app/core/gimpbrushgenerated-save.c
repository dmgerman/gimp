...
name|GimpData
modifier|*
DECL|function|gimp_brush_generated_new (const gchar * name,GimpBrushGeneratedShape shape,gfloat radius,gfloat hardness,gfloat aspect_ratio,gfloat angle,gboolean stingy_memory_use)
name|gimp_brush_generated_new
parameter_list|(
specifier|const
name|gchar
