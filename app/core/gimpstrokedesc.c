...
specifier|static
name|void
name|gimp_stroke_desc_config_iface_init
parameter_list|(
name|gpointer
name|iface
parameter_list|,
...
begin_macro
DECL|function|G_DEFINE_TYPE_WITH_CODE (GimpStrokeDesc,gimp_stroke_desc,GIMP_TYPE_OBJECT,G_IMPLEMENT_INTERFACE (GIMP_TYPE_CONFIG,gimp_stroke_desc_config_iface_init))
...
argument_list|,
argument|G_IMPLEMENT_INTERFACE (GIMP_TYPE_CONFIG,                                                 gimp_stroke_desc_config_iface_init)
argument_list|)
end_macro
...
specifier|static
name|void
DECL|function|gimp_stroke_desc_config_iface_init (gpointer iface,gpointer iface_data)
name|gimp_stroke_desc_config_iface_init
parameter_list|(
name|gpointer
name|iface
...
name|GimpConfig
modifier|*
DECL|function|gimp_stroke_desc_duplicate (GimpConfig * config)
name|gimp_stroke_desc_duplicate
parameter_list|(
name|GimpConfig
modifier|*
