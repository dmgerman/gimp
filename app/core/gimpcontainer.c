...
begin_comment
comment|/**  * gimp_container_get_first_child:  * @container: a #GimpContainer  *  * Returns: (nullable) (transfer none): the first child object stored in  *          @container or %NULL if the container is empty.  */
end_comment
...
begin_comment
comment|/**  * gimp_container_get_last_child:  * @container: a #GimpContainer  *  * Returns: (nullable) (transfer none): the last child object stored in  *          @container or %NULL if the container is empty  */
end_comment
