...
typedef|typedef
struct|struct
DECL|struct|__anon2937ae020108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2937ae020208
block|{
DECL|member|PR
name|PixelRegion
modifier|*
...
begin_define
DECL|macro|gradient_dither (dest,rng,value)
define|#
directive|define
name|gradient_dither
parameter_list|(
name|dest
parameter_list|,
name|rng
...
name|value
parameter_list|)
value|G_STMT_START { \   gdouble ftmp = (value) * 255.0;        \   gint    itmp = ftmp;                   \                                          \   if (g_rand_double (rng)> ftmp - itmp) \     *dest++ = itmp;                      \   else                                   \     *dest++ = MIN (itmp + 1, 255);       \ } G_STMT_END
end_define
