...
specifier|static
name|void
DECL|function|gimp_item_tree_dispose (GObject * object)
name|gimp_item_tree_dispose
parameter_list|(
name|GObject
modifier|*
...
begin_function
name|void
DECL|function|gimp_item_tree_clear (GimpItemTree * tree)
name|gimp_item_tree_clear
parameter_list|(
name|GimpItemTree
modifier|*
...
expr_stmt|;
block|}
comment|/* Remove any trailing whitespace. */
if|if
condition|(
name|gimp_object_get_name
argument_list|(
