...
specifier|static
name|void
name|gimp_drawable_undo_constructed
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|gint64
name|gimp_drawable_undo_get_memsize
parameter_list|(
name|GimpObject
modifier|*
name|object
...
specifier|static
name|void
DECL|function|gimp_drawable_undo_constructed (GObject * object)
name|gimp_drawable_undo_constructed
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|gint64
DECL|function|gimp_drawable_undo_get_memsize (GimpObject * object,gint64 * gui_size)
name|gimp_drawable_undo_get_memsize
parameter_list|(
name|GimpObject
modifier|*
