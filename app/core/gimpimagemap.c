...
name|GimpImageMap
modifier|*
DECL|function|gimp_image_map_new (gboolean interactive,GimpDrawable * drawable)
...
name|guchar
modifier|*
DECL|function|gimp_image_map_get_color_at (GimpImageMap * image_map,gint x,gint y)
