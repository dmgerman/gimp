...
begin_function
name|void
DECL|function|channel_allocate (Channel * channel,int width,int height)
...
begin_function
name|void
DECL|function|channel_deallocate (Channel * channel)
...
literal|1
expr_stmt|;
comment|/*  allocate the memory for this channel  */
name|channel_allocate
argument_list|(
name|channel
argument_list|,
...
literal|0
expr_stmt|;
comment|/*  give this channel an ID  */
name|channel
operator|->
name|ID
operator|=
...
name|gimage_ID
expr_stmt|;
comment|/*  add the new channel to the global list  */
name|channel_list
operator|=
name|append_to_list
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  deallocate the channel mem  */
name|channel_deallocate
argument_list|(
name|channel
argument_list|)
expr_stmt|;
comment|/*  free the channel name buffer  */
name|g_free
argument_list|(
name|channel
operator|->
...
begin_function
name|void
DECL|function|channel_apply_image (Channel * channel,int x1,int y1,int x2,int y2,TileManager * tiles,int sparse)
...
begin_function
name|void
DECL|function|channel_layer_alpha (Channel * mask,int layer_id)
...
begin_function
name|void
DECL|function|channel_layer_mask (Channel * mask,int layer_id)
