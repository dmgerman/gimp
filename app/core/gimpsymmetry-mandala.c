...
argument_list|)
decl_stmt|;
comment|/* TODO:    * - "center-x" property should be soft-limited by the width;    * - "center-y" property should be soft-limited by the height.    */
...
condition|)
block|{
comment|/* TODO: change soft limits of "center-x" and "center-y"        * properties. */
name|g_signal_emit_by_name
argument_list|(
name|sym
argument_list|,
