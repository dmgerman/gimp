...
name|PROP_GIMP
block|,
DECL|enumerator|PROP_MASK_ONLY
name|PROP_MASK_ONLY
block|}
enum|;
end_enum
...
name|GimpData
modifier|*
name|gimp_brush_clipboard_duplicate
parameter_list|(
name|GimpData
modifier|*
name|data
...
specifier|static
name|void
name|gimp_brush_clipboard_changed
parameter_list|(
name|Gimp
modifier|*
name|gimp
...
name|GimpData
modifier|*
DECL|function|gimp_brush_clipboard_duplicate (GimpData * data)
name|gimp_brush_clipboard_duplicate
parameter_list|(
name|GimpData
modifier|*
...
name|GimpData
modifier|*
DECL|function|gimp_brush_clipboard_new (Gimp * gimp,gboolean mask_only)
...
specifier|static
name|void
DECL|function|gimp_brush_clipboard_changed (Gimp * gimp,GimpBrush * brush)
name|gimp_brush_clipboard_changed
parameter_list|(
name|Gimp
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  invert the mask, it's more intuitive to think            *  "black on white" than the other way around            */
for|for
control|(
name|i
operator|=
