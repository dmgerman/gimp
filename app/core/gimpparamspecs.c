...
name|GParamSpec
modifier|*
DECL|function|gimp_param_spec_string (const gchar * name,const gchar * nick,const gchar * blurb,const gchar * default_value,gboolean no_validate,gboolean null_ok,GParamFlags flags)
name|gimp_param_spec_string
parameter_list|(
specifier|const
name|gchar
