...
begin_comment
comment|/*  include the implementation of the remaining paramspecs, they are  *  shared between app/ and libgimp/ but need different headers.  */
end_comment

begin_define
DECL|macro|gimp_image_is_valid (image)
define|#
directive|define
...
begin_define
DECL|macro|gimp_item_is_valid (item)
define|#
directive|define
...
begin_define
DECL|macro|gimp_display_is_valid (display)
define|#
directive|define
...
include|#
directive|include
file|"../../libgimp/gimpparamspecs-body.c"
end_include
