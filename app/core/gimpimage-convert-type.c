...
typedef|typedef
struct|struct
DECL|struct|__anon2776ba4f0208
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2776ba4f0308
block|{
...
begin_function
name|gboolean
DECL|function|gimp_image_convert_type (GimpImage * image,GimpImageBaseType new_type,gint num_cols,GimpConvertDitherType dither,gboolean alpha_dither,gboolean text_layer_dither,gboolean remove_dups,GimpConvertPaletteType palette_type,GimpPalette * custom_palette,GimpProgress * progress,GError ** error)
