...
specifier|static
name|void
DECL|function|gimp_tool_info_dispose (GObject * object)
name|gimp_tool_info_dispose
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_tool_info_filter_preset (const GimpObject * object,gpointer user_data)
name|gimp_tool_info_filter_preset
parameter_list|(
specifier|const
name|GimpObject
modifier|*
