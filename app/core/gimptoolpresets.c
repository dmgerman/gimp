...
name|gchar
modifier|*
DECL|function|gimp_tool_presets_build_filename (GimpToolPresets * presets)
name|gimp_tool_presets_build_filename
parameter_list|(
name|GimpToolPresets
modifier|*
name|presets
