...
specifier|static
name|void
DECL|function|gimp_selection_changed (GimpSelection * selection)
name|gimp_selection_changed
parameter_list|(
name|GimpSelection
modifier|*
...
begin_function
name|void
DECL|function|gimp_selection_push_undo (GimpSelection * selection,const gchar * undo_desc)
name|gimp_selection_push_undo
parameter_list|(
name|GimpSelection
modifier|*
...
begin_function
name|void
DECL|function|gimp_selection_invalidate (GimpSelection * selection)
name|gimp_selection_invalidate
parameter_list|(
name|GimpSelection
modifier|*
