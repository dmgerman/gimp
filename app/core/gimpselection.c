...
specifier|static
name|gboolean
DECL|function|gimp_selection_fill (GimpItem * item,GimpDrawable * drawable,GimpFillOptions * fill_options,gboolean push_undo,GimpProgress * progress,GError ** error)
name|gimp_selection_fill
parameter_list|(
name|GimpItem
modifier|*
...
name|_
argument_list|(
literal|"There is no selection to fill."
argument_list|)
argument_list|)
expr_stmt|;
return|return
...
specifier|static
name|void
DECL|function|gimp_selection_convert_type (GimpDrawable * drawable,GimpImage * dest_image,const Babl * new_format,GimpColorProfile * src_profile,GimpColorProfile * dest_profile,GeglDitherMethod layer_dither_type,GeglDitherMethod mask_dither_type,gboolean push_undo,GimpProgress * progress)
name|gimp_selection_convert_type
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_selection_border (GimpChannel * channel,gint radius_x,gint radius_y,GimpChannelBorderStyle style,gboolean edge_lock,gboolean push_undo)
name|gimp_selection_border
parameter_list|(
name|GimpChannel
modifier|*
...
literal|0
expr_stmt|;
comment|/* can't cut from non-drawables, fall back to copy */
name|cut_image
operator|=
name|FALSE
expr_stmt|;
