...
specifier|static
name|gboolean
DECL|function|gimp_selection_stroke (GimpItem * item,GimpDrawable * drawable,GimpContext * context,GimpObject * stroke_desc,gboolean use_default_values)
name|gimp_selection_stroke
parameter_list|(
name|GimpItem
modifier|*
...
begin_function
name|void
DECL|function|gimp_selection_load (GimpChannel * selection,GimpChannel * channel)
...
name|GimpChannel
modifier|*
DECL|function|gimp_selection_save (GimpChannel * selection)
