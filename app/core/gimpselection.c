...
name|GeglBuffer
modifier|*
DECL|function|gimp_selection_extract_buffer (GimpSelection * selection,GimpPickable * pickable,GimpContext * context,gboolean cut_image,gboolean keep_indexed,gboolean add_alpha,gint * offset_x,gint * offset_y,GError ** error)
...
name|TileManager
modifier|*
DECL|function|gimp_selection_extract (GimpSelection * selection,GimpPickable * pickable,GimpContext * context,gboolean cut_image,gboolean keep_indexed,gboolean add_alpha,const Babl ** format,gint * offset_x,gint * offset_y,GError ** error)
name|gimp_selection_extract
parameter_list|(
name|GimpSelection
modifier|*
