...
specifier|static
name|void
name|gimp_drawable_stroke_scanconvert_stroke
parameter_list|(
name|GimpDrawable
modifier|*
name|drawable
...
specifier|static
name|void
DECL|function|gimp_drawable_stroke_scanconvert_stroke (GimpDrawable * drawable,GimpStrokeOptions * options,GimpScanConvert * scan_convert,gboolean use_mask_bounds)
name|gimp_drawable_stroke_scanconvert_stroke
parameter_list|(
name|GimpDrawable
modifier|*
