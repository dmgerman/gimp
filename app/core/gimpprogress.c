...
name|GimpProgress
modifier|*
DECL|function|gimp_progress_start (GimpProgress * progress,gboolean cancellable,const gchar * format,...)
...
begin_function
name|void
DECL|function|gimp_progress_set_text (GimpProgress * progress,const gchar * format,...)
...
begin_function
name|void
DECL|function|gimp_progress_set_text_literal (GimpProgress * progress,const gchar * message)
name|gimp_progress_set_text_literal
parameter_list|(
name|GimpProgress
modifier|*
