...
specifier|static
name|void
name|gimp_brush_real_get_scaled_size
parameter_list|(
name|GimpBrush
modifier|*
name|brush
...
name|height
decl_stmt|;
name|gimp_brush_get_scaled_size
argument_list|(
name|brush
argument_list|,
name|scale
...
specifier|static
name|void
DECL|function|gimp_brush_real_get_scaled_size (GimpBrush * brush,gdouble scale,gint * width,gint * height)
name|gimp_brush_real_get_scaled_size
parameter_list|(
name|GimpBrush
modifier|*
...
begin_function
name|void
DECL|function|gimp_brush_get_scaled_size (GimpBrush * brush,gdouble scale,gint * width,gint * height)
name|gimp_brush_get_scaled_size
parameter_list|(
name|GimpBrush
modifier|*
