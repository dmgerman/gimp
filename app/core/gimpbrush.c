...
specifier|static
name|void
name|gimp_brush_real_begin_use
parameter_list|(
name|GimpBrush
modifier|*
name|brush
...
specifier|static
name|void
DECL|function|gimp_brush_dirty (GimpData * data)
name|gimp_brush_dirty
parameter_list|(
name|GimpData
modifier|*
...
specifier|static
name|void
DECL|function|gimp_brush_copy (GimpData * data,GimpData * src_data)
name|gimp_brush_copy
parameter_list|(
name|GimpData
modifier|*
...
specifier|static
name|void
DECL|function|gimp_brush_real_begin_use (GimpBrush * brush)
name|gimp_brush_real_begin_use
parameter_list|(
name|GimpBrush
modifier|*
...
specifier|static
name|void
DECL|function|gimp_brush_real_end_use (GimpBrush * brush)
name|gimp_brush_real_end_use
parameter_list|(
name|GimpBrush
modifier|*
...
begin_function
name|void
DECL|function|gimp_brush_end_use (GimpBrush * brush)
name|gimp_brush_end_use
parameter_list|(
name|GimpBrush
modifier|*
...
name|GimpTempBuf
modifier|*
DECL|function|gimp_brush_transform_mask (GimpBrush * brush,gdouble scale,gdouble aspect_ratio,gdouble angle,gboolean reflect,gdouble hardness)
name|gimp_brush_transform_mask
parameter_list|(
name|GimpBrush
modifier|*
...
name|GimpTempBuf
modifier|*
DECL|function|gimp_brush_transform_pixmap (GimpBrush * brush,gdouble scale,gdouble aspect_ratio,gdouble angle,gboolean reflect,gdouble hardness)
name|gimp_brush_transform_pixmap
parameter_list|(
name|GimpBrush
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  while the brush mask is always at least 1x1 pixels, its        *  outline can correctly be NULL        *        *  FIXME: make the cache handle NULL things when it is        *         properly implemented        */
if|if
condition|(
name|boundary
condition|)
...
begin_function
name|void
DECL|function|gimp_brush_flush_blur_caches (GimpBrush * brush)
...
begin_function
name|gdouble
DECL|function|gimp_brush_get_blur_hardness (GimpBrush * brush)
