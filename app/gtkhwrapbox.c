...
specifier|static
name|void
DECL|function|_gtk_hwrap_box_size_request (GtkWidget * widget,GtkRequisition * requisition)
name|_gtk_hwrap_box_size_request
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|layout_row (GtkWrapBox * wbox,GtkAllocation * area,GSList * children,guint children_per_line,gboolean vexpand,gint * shortfall)
name|layout_row
parameter_list|(
name|GtkWrapBox
modifier|*
...
name|g_warning
argument_list|(
literal|"gtkhwrapbox: not enough space!\n"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|g_warning
argument_list|(
literal|"gtkhwrapbox: unhandled wbox justification"
argument_list|)
expr_stmt|;
name|width
operator|=
...
name|g_warning
argument_list|(
literal|"hwrapbox too small, shortfall is %d\n"
argument_list|,
name|shortfall
argument_list|)
expr_stmt|;
