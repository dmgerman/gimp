...
specifier|static
name|int
DECL|function|get_color (GimpImage * gimage,GimpDrawable * drawable,int x,int y,gboolean sample_merged,gboolean sample_average,double average_radius,int final)
name|get_color
parameter_list|(
name|GimpImage
modifier|*
