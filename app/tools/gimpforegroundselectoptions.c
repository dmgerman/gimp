...
name|PROP_DRAW_MODE
block|,
DECL|enumerator|PROP_PREVIEW_MODE
name|PROP_PREVIEW_MODE
block|,
...
argument_list|)
argument_list|,
name|GIMP_TYPE_MATTING_PREVIEW_MODE
argument_list|,
name|GIMP_MATTING_PREVIEW_MODE_ON_COLOR
argument_list|,
name|GIMP_PARAM_STATIC_STRINGS
argument_list|)
expr_stmt|;
