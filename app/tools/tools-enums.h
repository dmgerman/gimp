...
typedef|typedef
enum|enum
DECL|enum|__anon2be7d9a90b03
block|{
DECL|enumerator|GIMP_MATTING_ENGINE_MATTING_GLOBAL
name|GIMP_MATTING_ENGINE_MATTING_GLOBAL
block|,
comment|/*< desc="Matting Global">*/
DECL|enumerator|GIMP_MATTING_ENGINE_MATTING_LEVIN
