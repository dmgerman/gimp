...
argument_list|)
expr_stmt|;
comment|/*FIXME tool_cursor = tool->tool_cursor;*/
name|cmodifier
operator|=
...
directive|if
literal|0
block|switch (selection_tool->op)     {     case SELECTION_ADD:       cmodifier = GIMP_CURSOR_MODIFIER_PLUS;       break;     case SELECTION_SUBTRACT:       cmodifier = GIMP_CURSOR_MODIFIER_MINUS;       break;     case SELECTION_INTERSECT:        cmodifier = GIMP_CURSOR_MODIFIER_INTERSECT;       break;     case SELECTION_REPLACE:       break;     case SELECTION_MOVE_MASK:       cmodifier = GIMP_CURSOR_MODIFIER_MOVE;       break;     case SELECTION_MOVE:       tool_cursor = GIMP_MOVE_TOOL_CURSOR;       cmodifier   = GIMP_CURSOR_MODIFIER_NONE;       break;     case SELECTION_ANCHOR:       cmodifier = GIMP_CURSOR_MODIFIER_ANCHOR;       break;     }
endif|#
directive|endif
