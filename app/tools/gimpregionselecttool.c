...
name|Channel
modifier|*
DECL|function|find_contiguous_region (GImage * gimage,int drawable_id,int antialias,int threshold,int x,int y,int sample_merged)
...
specifier|static
name|void
DECL|function|fuzzy_select (GImage * gimage,int drawable_id,int op,int feather,double feather_radius)
name|fuzzy_select
parameter_list|(
name|GImage
modifier|*
