...
specifier|static
name|void
name|gimp_fuzzy_select_tool_cursor_update
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpFuzzySelectTool,gimp_fuzzy_select_tool,GIMP_TYPE_SELECTION_TOOL)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_fuzzy_select_tool_cursor_update (GimpTool * tool,GimpCoords * coords,GdkModifierType state,GimpDisplay * display)
name|gimp_fuzzy_select_tool_cursor_update
parameter_list|(
name|GimpTool
modifier|*
