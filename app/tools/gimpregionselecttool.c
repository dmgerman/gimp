...
specifier|static
name|void
DECL|function|gimp_region_select_tool_button_press (GimpTool * tool,GimpCoords * coords,guint32 time,GdkModifierType state,GimpDisplay * display)
name|gimp_region_select_tool_button_press
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_region_select_tool_motion (GimpTool * tool,GimpCoords * coords,guint32 time,GdkModifierType state,GimpDisplay * display)
name|gimp_region_select_tool_motion
parameter_list|(
name|GimpTool
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  calculate the new region boundary  */
name|new_segs
operator|=
name|gimp_region_select_tool_calculate
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_region_select_tool_cursor_update (GimpTool * tool,GimpCoords * coords,GdkModifierType state,GimpDisplay * display)
name|gimp_region_select_tool_cursor_update
parameter_list|(
name|GimpTool
modifier|*
...
name|GdkSegment
modifier|*
DECL|function|gimp_region_select_tool_calculate (GimpRegionSelectTool * region_sel,GimpDisplay * display,gint * num_segs)
name|gimp_region_select_tool_calculate
parameter_list|(
name|GimpRegionSelectTool
modifier|*
...
return|;
block|}
comment|/*  calculate and allocate a new segment array which represents the    *  boundary of the color-contiguous region    */
