...
specifier|static
name|void
name|gimp_rectangle_options_hide_on_user_override
parameter_list|(
name|GimpNumberPairEntry
modifier|*
...
specifier|static
name|void
DECL|function|gimp_rectangle_options_hide_on_user_override (GimpNumberPairEntry * number_pair_entry,GParamSpec * param_spec,GtkWidget * widget)
name|gimp_rectangle_options_hide_on_user_override
parameter_list|(
name|GimpNumberPairEntry
modifier|*
