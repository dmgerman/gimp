...
begin_comment
comment|/**  * gimp_rectangle_options_get_size_entry:  * @rectangle_options:  *  * Returns: GtkEntry used to enter desired size of rectangle. For  *          testing purposes.  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_rectangle_options_get_size_entry (GimpRectangleOptions * rectangle_options)
...
name|GtkWidget
modifier|*
DECL|function|gimp_rectangle_options_prop_dimension_frame_new (GObject * config,const gchar * x_property_name,const gchar * y_property_name,const gchar * unit_property_name,const gchar * table_label,GtkSizeGroup * label_group,GtkWidget ** entry)
...
begin_function
name|void
DECL|function|gimp_rectangle_options_connect (GimpRectangleOptions * options,GimpImage * image,GCallback shrink_callback,gpointer shrink_object)
...
begin_function
name|void
DECL|function|gimp_rectangle_options_disconnect (GimpRectangleOptions * options,GCallback shrink_callback,gpointer shrink_object)
