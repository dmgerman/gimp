...
specifier|static
name|void
name|gimp_rectangle_options_unparent_fixed_rule_widgets
parameter_list|(
...
begin_comment
comment|/* TODO: Calculate this dynamically so that the GtkEntry:s are always  * left-aligned with the right edge of the check buttons.  */
end_comment

begin_define
DECL|macro|FIXED_RULE_ENTRY_OFFSET
define|#
directive|define
name|FIXED_RULE_ENTRY_OFFSET
value|15
end_define
...
begin_comment
comment|/**  * gimp_rectangle_options_unparent_fixed_rule_widgets:  * @table:  *  * Removes any fixed rule widgets from the tool options that are in the tool  * options already. Meant to be used before inserting a new widget in the fixed  * rule tool options area.  */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_rectangle_options_unparent_fixed_rule_widgets (GimpRectangleOptionsPrivate * private)
name|gimp_rectangle_options_unparent_fixed_rule_widgets
parameter_list|(
name|GimpRectangleOptionsPrivate
modifier|*
...
block|{
name|gboolean
name|width_entry_sensitive
decl_stmt|;
name|gboolean
name|height_entry_sensitive
decl_stmt|;
...
expr_stmt|;
block|}
comment|/* Create and prepare the widgets that are on the second row      * dependant of current fixed-rule      */
block|{
comment|/* Aspect ratio entry */
name|entry
operator|=
