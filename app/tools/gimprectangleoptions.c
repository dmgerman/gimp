...
specifier|static
name|void
DECL|function|gimp_rectangle_options_notify_aspect (GtkWidget * widget,GParamSpec * param_spec,GimpRectangleOptions * options)
name|gimp_rectangle_options_notify_aspect
parameter_list|(
name|GtkWidget
modifier|*
name|widget
