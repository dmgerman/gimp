...
typedef|typedef
name|struct
name|_GimpForegroundSelectOptionsClass
name|GimpForegroundSelectOptionsClass
typedef|;
end_typedef

begin_typedef
DECL|typedef|GimpMattingDynamicWidgets
typedef|typedef
name|struct
name|_GimpMattingDynamicWidgets
name|GimpMattingDynamicWidgets
typedef|;
end_typedef

begin_struct
DECL|struct|_GimpMattingDynamicWidgets
struct|struct
name|_GimpMattingDynamicWidgets
block|{
DECL|member|levels
...
begin_struct
DECL|struct|_GimpForegroundSelectOptionsClass
struct|struct
name|_GimpForegroundSelectOptionsClass
block|{
