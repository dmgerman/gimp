...
specifier|static
name|void
name|gimp_bucket_fill_options_set_defaults
parameter_list|(
name|GimpToolOptions
modifier|*
name|tool_options
...
specifier|static
name|void
DECL|function|gimp_bucket_fill_options_set_defaults (GimpToolOptions * tool_options)
name|gimp_bucket_fill_options_set_defaults
parameter_list|(
name|GimpToolOptions
modifier|*
