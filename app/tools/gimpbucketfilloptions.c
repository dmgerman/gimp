...
name|PROP_THRESHOLD
block|,
DECL|enumerator|PROP_LINE_ART_SOURCE
name|PROP_LINE_ART_SOURCE
block|,
...
block|,
DECL|enumerator|PROP_LINE_ART_MAX_GAP_LENGTH
name|PROP_LINE_ART_MAX_GAP_LENGTH
block|,
...
name|_
argument_list|(
literal|"Source image for line art computation"
argument_list|)
argument_list|,
...
name|_
argument_list|(
literal|"Maximum gap length"
argument_list|)
argument_list|,
name|_
argument_list|(
literal|"Maximum gap (in pixels) in line art which can be closed"
argument_list|)
argument_list|,
literal|0
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/*  Line Art: source combo (replace sample merged!) */
name|combo
operator|=
name|gimp_prop_enum_combo_box_new
argument_list|(
