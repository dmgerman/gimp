...
block|,
DECL|enumerator|PROP_LINE_ART_EROSION
name|PROP_LINE_ART_EROSION
block|,
...
decl_stmt|;
DECL|member|line_art_erosion_scale
name|GtkWidget
modifier|*
name|line_art_erosion_scale
decl_stmt|;
block|}
struct|;
end_struct
...
name|_
argument_list|(
literal|"Size in pixel to erode the line art"
argument_list|)
argument_list|,
operator|-
literal|1
