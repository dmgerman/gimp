...
typedef|typedef
struct|struct
DECL|struct|__anon279d89ad0108
block|{
...
begin_comment
comment|/**  * gimp_free_select_tool_draw:  * @draw_tool:  *  * Draw the line segments and handles around segment vertices, the  * latter if the they are in proximity to cursor.  **/
end_comment
