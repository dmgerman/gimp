...
specifier|static
name|gboolean
DECL|function|gimp_free_select_tool_should_close (GimpFreeSelectTool * fst,GimpDisplay * display,GimpCoords * coords)
...
specifier|static
name|void
DECL|function|gimp_free_select_tool_handle_click (GimpFreeSelectTool * fst,GimpCoords * coords,GimpDisplay * display)
