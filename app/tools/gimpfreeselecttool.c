...
begin_function
name|gint
DECL|function|gimp_free_select_tool_get_n_points (GimpFreeSelectTool * tool)
...
case|:
comment|/*  don't gimp_tool_control(COMMIT) here because we don't always        *  want to HALT the tool after committing because we have a        *  subclass, we do that in the default implementation of        *  select().        */
name|gimp_free_select_tool_commit
argument_list|(
name|fst
argument_list|,
