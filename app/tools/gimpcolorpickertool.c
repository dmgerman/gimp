...
specifier|static
name|void
name|gimp_color_picker_tool_dispose
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
DECL|function|gimp_color_picker_tool_dispose (GObject * object)
name|gimp_color_picker_tool_dispose
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_picker_tool_picked (GimpColorTool * color_tool,const GimpCoords * coords,GimpDisplay * display,GimpColorPickState pick_state,const Babl * sample_format,gpointer pixel,const GimpRGB * color)
name|gimp_color_picker_tool_picked
parameter_list|(
name|GimpColorTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_picker_tool_info_create (GimpColorPickerTool * picker_tool,GimpDisplay * display)
name|gimp_color_picker_tool_info_create
parameter_list|(
name|GimpColorPickerTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_picker_tool_info_update (GimpColorPickerTool * picker_tool,GimpDisplay * display,gboolean sample_average,const Babl * sample_format,gpointer pixel,const GimpRGB * color,gint x,gint y)
name|gimp_color_picker_tool_info_update
parameter_list|(
name|GimpColorPickerTool
modifier|*
