...
specifier|static
name|void
DECL|function|gimp_text_options_notify_color (GObject * object,GParamSpec * pspec)
name|gimp_text_options_notify_color
parameter_list|(
name|GObject
modifier|*
...
name|GimpText
modifier|*
DECL|function|gimp_text_options_create_text (GimpTextOptions * options)
...
begin_function
name|void
DECL|function|gimp_text_options_disconnect_text (GimpTextOptions * options,GimpText * text)
...
specifier|static
name|void
DECL|function|gimp_text_options_text_changed (GimpTextEditor * editor,GimpTextOptions * options)
name|gimp_text_options_text_changed
parameter_list|(
name|GimpTextEditor
modifier|*
name|editor
