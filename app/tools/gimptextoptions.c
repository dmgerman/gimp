...
specifier|static
name|gboolean
name|gimp_text_options_font_scrolled
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gboolean
DECL|function|gimp_text_options_font_scrolled (GtkWidget * widget,GdkEventScroll * sevent,GimpContext * context)
name|gimp_text_options_font_scrolled
parameter_list|(
name|GtkWidget
modifier|*
