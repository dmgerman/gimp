...
condition|)
block|{
comment|/* gimp_pickable_contiguous_region_prepare_line_art_async()            * will flush the pickable, which may trigger this signal            * handler, and will leak a line art (as tool->priv->async has            * not been set yet.            */
