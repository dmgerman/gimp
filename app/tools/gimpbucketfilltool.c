...
specifier|static
name|void
name|gimp_bucket_fill_tool_drawable_update
parameter_list|(
name|GimpDrawable
modifier|*
name|drawable
...
typedef|typedef
struct|struct
DECL|struct|__anon29a27e550108
block|{
DECL|member|tool
name|GimpBucketFillTool
modifier|*
...
name|options
argument_list|,
literal|"notify::line-art-erosion"
argument_list|,
name|G_CALLBACK
argument_list|(
name|gimp_bucket_fill_tool_options_notified
...
specifier|static
name|void
DECL|function|gimp_bucket_fill_tool_drawable_update (GimpDrawable * drawable,gint x,gint y,gint width,gint height,GimpBucketFillTool * tool)
name|gimp_bucket_fill_tool_drawable_update
parameter_list|(
name|GimpDrawable
modifier|*
