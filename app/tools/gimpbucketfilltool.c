...
specifier|static
name|void
DECL|function|bucket_fill (GImage * gimage,GimpDrawable * drawable,FillMode fill_mode,int paint_mode,double opacity,double threshold,int sample_merged,double x,double y)
name|bucket_fill
parameter_list|(
name|GImage
modifier|*
...
specifier|static
name|void
DECL|function|bucket_fill_region (FillMode fill_mode,PixelRegion * bufPR,PixelRegion * maskPR,unsigned char * col,TempBuf * pattern,int off_x,int off_y,int has_alpha)
name|bucket_fill_region
parameter_list|(
name|FillMode
name|fill_mode
