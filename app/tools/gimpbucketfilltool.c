...
specifier|static
name|void
DECL|function|bucket_fill_mode_callback (GtkWidget * widget,gpointer client_data)
...
specifier|static
name|void
DECL|function|bucket_fill_paint_mode_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|bucket_fill (GimpImage * gimage,GimpDrawable * drawable,BucketFillMode fill_mode,int paint_mode,double opacity,double threshold,int sample_merged,double x,double y)
name|bucket_fill
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|bucket_fill_line_color (unsigned char * buf,unsigned char * mask,unsigned char * col,int has_alpha,int bytes,int width)
name|bucket_fill_line_color
parameter_list|(
name|unsigned
name|char
...
specifier|static
name|void
DECL|function|bucket_fill_line_pattern (unsigned char * buf,unsigned char * mask,TempBuf * pattern,int has_alpha,int bytes,int x,int y,int width)
name|bucket_fill_line_pattern
parameter_list|(
name|unsigned
name|char
...
specifier|static
name|void
DECL|function|bucket_fill_region (BucketFillMode fill_mode,PixelRegion * bufPR,PixelRegion * maskPR,unsigned char * col,TempBuf * pattern,int off_x,int off_y,int has_alpha)
name|bucket_fill_region
parameter_list|(
name|BucketFillMode
name|fill_mode
