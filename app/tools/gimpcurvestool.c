...
argument_list|)
expr_stmt|;
comment|/*  The option menu for selecting the curve type  */
name|c_tool
operator|->
...
specifier|static
name|void
DECL|function|curves_type_callback (GtkWidget * widget,GimpCurvesTool * c_tool)
name|curves_type_callback
parameter_list|(
name|GtkWidget
modifier|*
