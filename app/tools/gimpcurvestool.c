...
specifier|static
name|void
name|gimp_curves_tool_update_channel
parameter_list|(
name|GimpCurvesTool
modifier|*
name|tool
...
specifier|static
name|void
name|gimp_curves_tool_update_point
parameter_list|(
name|GimpCurvesTool
modifier|*
name|tool
...
specifier|static
name|void
name|curves_curve_dirty_callback
parameter_list|(
name|GimpCurve
modifier|*
name|curve
...
specifier|static
name|void
name|curves_graph_selection_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|curves_point_coords_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|curves_point_type_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
argument_list|)
expr_stmt|;
comment|/*  The grid for the color bars and the graph  */
name|grid
operator|=
name|gtk_grid_new
argument_list|()
...
argument_list|)
expr_stmt|;
comment|/*  The point properties box  */
name|tool
operator|->
name|point_box
operator|=
...
specifier|static
name|void
DECL|function|gimp_curves_tool_config_notify (GimpFilterTool * filter_tool,GimpConfig * config,const GParamSpec * pspec)
name|gimp_curves_tool_config_notify
parameter_list|(
name|GimpFilterTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_curves_tool_color_picked (GimpFilterTool * filter_tool,gpointer identifier,gdouble x,gdouble y,const Babl * sample_format,const GimpRGB * color)
name|gimp_curves_tool_color_picked
parameter_list|(
name|GimpFilterTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_curves_tool_update_channel (GimpCurvesTool * tool)
name|gimp_curves_tool_update_channel
parameter_list|(
name|GimpCurvesTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_curves_tool_update_point (GimpCurvesTool * tool)
name|gimp_curves_tool_update_point
parameter_list|(
name|GimpCurvesTool
modifier|*
...
specifier|static
name|void
DECL|function|curves_curve_dirty_callback (GimpCurve * curve,GimpCurvesTool * tool)
name|curves_curve_dirty_callback
parameter_list|(
name|GimpCurve
modifier|*
...
specifier|static
name|void
DECL|function|curves_graph_selection_callback (GtkWidget * widget,GimpCurvesTool * tool)
name|curves_graph_selection_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|curves_point_coords_callback (GtkWidget * widget,GimpCurvesTool * tool)
name|curves_point_coords_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|curves_point_type_callback (GtkWidget * widget,GimpCurvesTool * tool)
name|curves_point_type_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|curves_get_channel_color (GtkWidget * widget,GimpHistogramChannel channel,GimpRGB * color)
name|curves_get_channel_color
parameter_list|(
name|GtkWidget
modifier|*
