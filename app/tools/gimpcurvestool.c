...
argument_list|)
expr_stmt|;
name|gimp_histogram_view_set_curve
argument_list|(
name|GIMP_HISTOGRAM_VIEW
argument_list|(
name|c_tool
...
specifier|static
name|void
DECL|function|curves_curve_callback (GimpCurve * curve,const GParamSpec * pspec,GimpCurvesTool * tool)
name|curves_curve_callback
parameter_list|(
name|GimpCurve
modifier|*
...
argument_list|)
expr_stmt|;
name|gimp_histogram_view_set_cusor
argument_list|(
name|GIMP_HISTOGRAM_VIEW
argument_list|(
name|tool
