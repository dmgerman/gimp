...
specifier|static
name|void
DECL|function|curves (PixelRegion * srcPR,PixelRegion * destPR,void * user_data)
name|curves
parameter_list|(
name|PixelRegion
modifier|*
...
specifier|static
name|void
DECL|function|curves_control (Tool * tool,int action,gpointer gdisp_ptr)
name|curves_control
parameter_list|(
name|Tool
modifier|*
...
begin_comment
comment|/*  *  The curves procedure definitions  */
end_comment

begin_comment
comment|/*  Procedure for defining the curve with a spline  */
end_comment

begin_decl_stmt
DECL|variable|curves_spline_args
name|ProcArg
...
expr_stmt|;
block|}
comment|/*  arrange to modify the curves  */
if|if
condition|(
name|success
condition|)
...
begin_comment
comment|/*  Procedure for explicitly defining the curve  */
end_comment

begin_decl_stmt
DECL|variable|curves_explicit_args
name|ProcArg
