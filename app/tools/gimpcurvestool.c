...
block|gimp_int_option_menu_set_sensitive (GTK_OPTION_MENU (c_tool->channel_menu),                                       (GimpIntOptionMenuSensitivityCallback) curves_set_sensitive_callback,                                       c_tool);
endif|#
directive|endif
