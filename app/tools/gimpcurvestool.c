...
specifier|static
name|void
DECL|function|curves_color_update (GimpTool * tool,GimpDisplay * gdisp,GimpDrawable * drawable,gint x,gint y)
name|curves_color_update
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|file_dialog_cancel_callback (GimpCurvesTool * c_tool)
name|file_dialog_cancel_callback
parameter_list|(
name|GimpCurvesTool
modifier|*
