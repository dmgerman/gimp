...
directive|define
name|GRAPH_MASK
value|(GDK_EXPOSURE_MASK            | \ 		     GDK_POINTER_MOTION_MASK      | \ 		     GDK_POINTER_MOTION_HINT_MASK | \                      GDK_LEAVE_NOTIFY_MASK        | \ 		     GDK_BUTTON_PRESS_MASK        | \ 		     GDK_BUTTON_RELEASE_MASK      | \ 		     GDK_BUTTON1_MOTION_MASK)
end_define
...
specifier|static
name|void
DECL|function|curve_print_loc (GimpCurvesTool * c_tool,gint xpos,gint ypos)
...
case|:
comment|/* redraw to hide position indicator */
name|curves_update
argument_list|(
name|c_tool
argument_list|,
