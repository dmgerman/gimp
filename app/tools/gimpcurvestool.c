...
specifier|static
name|void
name|gimp_curves_tool_store_settings
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_curves_tool_recall_settings
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
name|_
argument_list|(
literal|"Remember curve temporarily"
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
name|_
argument_list|(
literal|"Recall most recently stored curve"
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
specifier|static
name|void
DECL|function|gimp_curves_tool_store_settings (GtkWidget * widget,gpointer data)
name|gimp_curves_tool_store_settings
parameter_list|(
name|GtkWidget
modifier|*
...
name|g_message
argument_list|(
literal|"Unable to open file for curves store."
argument_list|)
expr_stmt|;
return|return;
block|}
...
specifier|static
name|void
DECL|function|gimp_curves_tool_recall_settings (GtkWidget * widget,gpointer data)
name|gimp_curves_tool_recall_settings
parameter_list|(
name|GtkWidget
modifier|*
...
name|g_message
argument_list|(
literal|"Unable to open file for curves recall."
argument_list|)
expr_stmt|;
return|return;
block|}
...
specifier|static
name|gboolean
DECL|function|curves_menu_visible_func (GtkTreeModel * model,GtkTreeIter * iter,gpointer data)
name|curves_menu_visible_func
parameter_list|(
name|GtkTreeModel
modifier|*
...
specifier|static
name|void
DECL|function|curve_print_loc (GimpCurvesTool * tool)
