...
begin_comment
comment|/*  intelligent scissors tool options  */
end_comment
...
specifier|static
name|void
DECL|function|reset_iscissors_options (void)
name|reset_iscissors_options
parameter_list|(
name|void
parameter_list|)
block|{
...
name|IScissorsOptions
modifier|*
DECL|function|create_iscissors_options (void)
name|create_iscissors_options
parameter_list|(
name|void
parameter_list|)
block|{
