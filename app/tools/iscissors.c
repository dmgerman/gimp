...
name|SCREEN_COORDS
case|:
comment|/*	  gdisplay_transform_coords_f (gdisp, ,&x,&y, TRUE);       gdisplay_transform_coords (gdisp, points->x, points->y,&points->sx,&points->sy, 0);       */
comment|/*       gdisplay_untransform_coords_f (gdisp, (int) pts[indices[i]].dx, (int) pts[indices[i]].dy,&x,&y, TRUE);   */
name|geometry
index|[
name|i
index|]
