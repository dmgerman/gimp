...
name|GIMP_MOUSE_CURSOR
argument_list|,
name|GIMP_ISCISSORS_TOOL_CURSOR
argument_list|,
...
specifier|static
name|gint
DECL|function|mouse_over_vertex (Iscissors * iscissors,gint x,gint y)
name|mouse_over_vertex
parameter_list|(
name|Iscissors
modifier|*
...
name|GSList
modifier|*
DECL|function|mouse_over_curve (Iscissors * iscissors,gint x,gint y)
name|mouse_over_curve
parameter_list|(
name|Iscissors
modifier|*
