...
name|NULL
argument_list|,
name|gimp_marshal_VOID__ENUM_BOXED_INT
argument_list|,
name|G_TYPE_NONE
argument_list|,
literal|3
...
specifier|static
name|void
DECL|function|gimp_color_tool_pick (GimpColorTool * tool,gint x,gint y)
name|gimp_color_tool_pick
parameter_list|(
name|GimpColorTool
modifier|*
...
begin_function
name|void
DECL|function|gimp_color_tool_enable (GimpColorTool * color_tool,gboolean enable)
...
name|g_warning
argument_list|(
literal|"Trying to enable/disable GimpColorTool while it is active."
argument_list|)
expr_stmt|;
return|return;
block|}
