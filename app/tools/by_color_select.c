...
name|Channel
modifier|*
DECL|function|by_color_select_color (GImage * gimage,int drawable,unsigned char * color,int antialias,int threshold,int sample_merged)
name|by_color_select_color
parameter_list|(
name|GImage
modifier|*
...
specifier|static
name|void
DECL|function|by_color_select (GImage * gimage,int drawable_id,unsigned char * color,int threshold,int op,int antialias,int feather,double feather_radius,int sample_merged)
name|by_color_select
parameter_list|(
name|GImage
modifier|*
