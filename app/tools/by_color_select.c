...
begin_function
name|void
DECL|function|by_color_select (GImage * gimage,GimpDrawable * drawable,guchar * color,gint threshold,SelectOps op,gboolean antialias,gboolean feather,gdouble feather_radius,gboolean sample_merged)
...
specifier|static
name|void
DECL|function|by_color_select_update_op_state (ByColorSelect * by_col_sel,gint state,GDisplay * gdisp)
