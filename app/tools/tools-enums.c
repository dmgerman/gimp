...
begin_decl_stmt
DECL|variable|transform_state_enum_values
specifier|static
specifier|const
name|GEnumValue
name|transform_state_enum_values
index|[]
init|=
block|{
block|{
...
begin_function
name|GType
DECL|function|transform_state_get_type (void)
name|transform_state_get_type
parameter_list|(
name|void
parameter_list|)
block|{
