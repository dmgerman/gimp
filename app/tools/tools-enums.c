...
begin_function
name|GType
DECL|function|gimp_rectangle_mode_get_type (void)
name|gimp_rectangle_mode_get_type
parameter_list|(
name|void
parameter_list|)
block|{
...
block|,
literal|"GIMP_RECTANGLE_MODE_EXECUTE"
block|,
literal|"execute"
block|}
block|,
block|{
name|GIMP_RECTANGLE_MODE_RESIZE
block|,
literal|"GIMP_RECTANGLE_MODE_RESIZE"
block|,
literal|"resize"
block|}
block|,
