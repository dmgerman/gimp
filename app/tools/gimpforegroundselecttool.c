...
typedef|typedef
struct|struct
DECL|struct|__anon29567c840108
block|{
DECL|member|width
name|gint
name|width
...
specifier|static
name|void
DECL|function|gimp_foreground_select_tool_stroke (GimpChannel * mask,GimpDisplay * gdisp,FgSelectStroke * stroke)
name|gimp_foreground_select_tool_stroke
parameter_list|(
name|GimpChannel
modifier|*
...
argument_list|)
decl_stmt|;
comment|/* FIXME: We should be able to get away w/o a temporary drawable    *        by doing some changes to GimpScanConvert.    */
if|if
condition|(
name|stroke
operator|->
...
specifier|static
name|void
DECL|function|gimp_foreground_select_tool_push_stroke (GimpForegroundSelectTool * fg_select,GimpForegroundSelectOptions * options)
name|gimp_foreground_select_tool_push_stroke
parameter_list|(
name|GimpForegroundSelectTool
modifier|*
