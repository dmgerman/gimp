...
typedef|typedef
struct|struct
DECL|struct|__anon28f63c120108
block|{
DECL|member|width
name|gint
name|width
...
name|_
argument_list|(
literal|"Paint trimap, (background, foreground and unknown) or press Enter to preview"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|_
argument_list|(
literal|"Press escape for return to trimap or Enter to apply"
argument_list|)
expr_stmt|;
block|}
if|if
