...
specifier|static
name|void
name|gimp_foreground_select_tool_strokes_free
parameter_list|(
name|GList
modifier|*
name|strokes
...
name|g_warning
argument_list|(
literal|"%s: fg_strokes should be NULL at this point"
argument_list|,
name|G_STRLOC
argument_list|)
expr_stmt|;
...
name|g_warning
argument_list|(
literal|"%s: bg_strokes should be NULL at this point"
argument_list|,
name|G_STRLOC
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|/* FIXME: draw current stroke here */
block|}
name|GIMP_DRAW_TOOL_CLASS
argument_list|(
name|parent_class
...
specifier|static
name|void
DECL|function|gimp_foreground_select_tool_stroke (GimpChannel * mask,gint num_points,GimpVector2 * points,gint width,gboolean foreground)
name|gimp_foreground_select_tool_stroke
parameter_list|(
name|GimpChannel
modifier|*
...
specifier|static
name|void
DECL|function|gimp_foreground_select_tool_strokes_free (GList * strokes)
name|gimp_foreground_select_tool_strokes_free
parameter_list|(
name|GList
modifier|*
