...
typedef|typedef
struct|struct
DECL|struct|__anon29108def0108
block|{
DECL|member|width
name|gint
name|width
...
name|GObject
modifier|*
name|gimp_foreground_select_tool_constructor
parameter_list|(
name|GType
name|type
parameter_list|,
...
name|GObject
modifier|*
DECL|function|gimp_foreground_select_tool_constructor (GType type,guint n_params,GObjectConstructParam * params)
name|gimp_foreground_select_tool_constructor
parameter_list|(
name|GType
name|type
