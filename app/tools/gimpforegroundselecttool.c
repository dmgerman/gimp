...
specifier|static
name|void
name|gimp_foreground_select_tool_confirm
parameter_list|(
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpForegroundSelectTool,gimp_foreground_select_tool,GIMP_TYPE_POLYGON_SELECT_TOOL)
name|G_DEFINE_TYPE
argument_list|(
...
modifier|*
name|polygon_select_tool_class
decl_stmt|;
name|polygon_select_tool_class
operator|=
...
specifier|static
name|void
DECL|function|gimp_foreground_select_tool_confirm (GimpPolygonSelectTool * poly_sel,GimpDisplay * display)
name|gimp_foreground_select_tool_confirm
parameter_list|(
name|GimpPolygonSelectTool
modifier|*
