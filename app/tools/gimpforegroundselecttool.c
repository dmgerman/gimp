...
argument_list|)
expr_stmt|;
comment|/*  see comment in gimp_foreground_select_tool_select()  */
if|if
condition|(
name|fg_select
operator|->
...
specifier|static
name|void
DECL|function|gimp_foreground_select_tool_select (GimpFreeSelectTool * free_sel,GimpDisplay * display,const GimpVector2 * points,gint n_points)
name|gimp_foreground_select_tool_select
parameter_list|(
name|GimpFreeSelectTool
modifier|*
...
block|{
comment|/*  if the tool is active we got here by double click            *  detected in the parent class. We can't switch to trimap            *  mode in the middle of a click. Set a flag and let            *  button_release() forward the release to the parent class            *  so it can conclude its operation            */
name|fg_select
operator|->
name|in_double_click
operator|=
