...
specifier|static
name|void
DECL|function|gimp_foreground_select_tool_set_mask (GimpForegroundSelectTool * fg_select,GimpChannel * mask)
name|gimp_foreground_select_tool_set_mask
parameter_list|(
name|GimpForegroundSelectTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_foreground_select_tool_apply_mask (GimpForegroundSelectTool * fg_select,GimpImage * gimage)
name|gimp_foreground_select_tool_apply_mask
parameter_list|(
name|GimpForegroundSelectTool
modifier|*
