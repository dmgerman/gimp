...
specifier|static
name|gdouble
DECL|function|measure_tool_get_angle (gint dx,gint dy,gdouble xres,gdouble yres)
name|measure_tool_get_angle
parameter_list|(
name|gint
name|dx
...
name|GtkWidget
modifier|*
DECL|function|gimp_measure_tool_dialog_new (GimpMeasureTool * mtool)
name|gimp_measure_tool_dialog_new
parameter_list|(
name|GimpMeasureTool
modifier|*
