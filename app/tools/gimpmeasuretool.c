...
begin_decl_stmt
DECL|variable|measure_tool_cursor
name|BitmapCursor
name|measure_tool_cursor
init|=
block|{
...
begin_function
DECL|function|measure_tool_class_init (GimpToolClass * klass)
name|void
name|measure_tool_class_init
parameter_list|(
name|GimpToolClass
...
begin_function
DECL|function|measure_tool_initialize (GimpTool * tool)
name|void
name|measure_tool_initialize
parameter_list|(
name|GimpTool
