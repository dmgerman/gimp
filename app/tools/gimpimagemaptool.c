...
specifier|static
name|void
name|gimp_image_map_tool_button_press
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
specifier|static
name|void
name|gimp_image_map_tool_oper_update
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
specifier|static
name|void
name|gimp_image_map_tool_cursor_update
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
specifier|static
name|void
name|gimp_image_map_tool_add_guide
parameter_list|(
name|GimpImageMapTool
modifier|*
name|im_tool
...
specifier|static
name|void
name|gimp_image_map_tool_remove_guide
parameter_list|(
name|GimpImageMapTool
modifier|*
name|im_tool
...
specifier|static
name|void
name|gimp_image_map_tool_move_guide
parameter_list|(
name|GimpImageMapTool
modifier|*
name|im_tool
...
specifier|static
name|void
name|gimp_image_map_tool_guide_removed
parameter_list|(
name|GimpGuide
modifier|*
name|guide
...
specifier|static
name|void
name|gimp_image_map_tool_guide_moved
parameter_list|(
name|GimpGuide
modifier|*
name|guide
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_init (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_init
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|gamma_hack (GtkToggleButton * button,GimpImageMapTool * im_tool)
name|gamma_hack
parameter_list|(
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_button_press (GimpTool * tool,const GimpCoords * coords,guint32 time,GdkModifierType state,GimpButtonPressType press_type,GimpDisplay * display)
name|gimp_image_map_tool_button_press
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_oper_update (GimpTool * tool,const GimpCoords * coords,GdkModifierType state,gboolean proximity,GimpDisplay * display)
name|gimp_image_map_tool_oper_update
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_cursor_update (GimpTool * tool,const GimpCoords * coords,GdkModifierType state,GimpDisplay * display)
name|gimp_image_map_tool_cursor_update
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_draw (GimpDrawTool * draw_tool)
name|gimp_image_map_tool_draw
parameter_list|(
name|GimpDrawTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_map (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_map
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_dialog (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_dialog
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_dialog_unmap (GtkWidget * dialog,GimpImageMapTool * im_tool)
name|gimp_image_map_tool_dialog_unmap
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_reset (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_reset
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_create_map (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_create_map
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_flush (GimpImageMap * image_map,GimpImageMapTool * im_tool)
name|gimp_image_map_tool_flush
parameter_list|(
name|GimpImageMap
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_config_notify (GObject * object,const GParamSpec * pspec,GimpImageMapTool * im_tool)
name|gimp_image_map_tool_config_notify
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_guide_removed (GimpGuide * guide,GimpImageMapTool * im_tool)
name|gimp_image_map_tool_guide_removed
parameter_list|(
name|GimpGuide
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_guide_moved (GimpGuide * guide,const GParamSpec * pspec,GimpImageMapTool * im_tool)
name|gimp_image_map_tool_guide_moved
parameter_list|(
name|GimpGuide
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_add_guide (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_add_guide
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_remove_guide (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_remove_guide
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_move_guide (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_move_guide
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_response (GimpToolGui * gui,gint response_id,GimpImageMapTool * im_tool)
name|gimp_image_map_tool_response
parameter_list|(
name|GimpToolGui
modifier|*
...
begin_function
name|void
DECL|function|gimp_image_map_tool_get_operation (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_get_operation
parameter_list|(
name|GimpImageMapTool
modifier|*
...
begin_function
name|void
DECL|function|gimp_image_map_tool_preview (GimpImageMapTool * im_tool)
name|gimp_image_map_tool_preview
parameter_list|(
name|GimpImageMapTool
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|gimp_image_map_tool_dialog_get_vbox (GimpImageMapTool * im_tool)
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_color_picker_toggled (GtkWidget * widget,GimpImageMapTool * im_tool)
...
name|GtkWidget
modifier|*
DECL|function|gimp_image_map_tool_add_color_picker (GimpImageMapTool * im_tool,gpointer identifier,const gchar * icon_name,const gchar * tooltip)
