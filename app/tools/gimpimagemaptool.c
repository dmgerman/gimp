...
specifier|static
name|void
DECL|function|gimp_image_map_tool_load_clicked (GtkWidget * widget,GimpImageMapTool * image_map_tool)
name|gimp_image_map_tool_load_clicked
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_save_clicked (GtkWidget * widget,GimpImageMapTool * image_map_tool)
name|gimp_image_map_tool_save_clicked
parameter_list|(
name|GtkWidget
modifier|*
