...
comment|/* if (release_type == GIMP_BUTTON_RELEASE_CANCEL) */
if|if
condition|(
name|blend_tool
operator|->
...
comment|/*gimp_tool_control (tool, GIMP_TOOL_ACTION_COMMIT, display);       gimp_tool_control (tool, GIMP_TOOL_ACTION_HALT, display);*/
name|gimp_blend_tool_precalc_shapeburst
argument_list|(
name|blend_tool
argument_list|)
