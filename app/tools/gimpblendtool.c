...
typedef|typedef
struct|struct
DECL|struct|__anon2c6672540108
block|{
DECL|member|offset
name|double
name|offset
...
typedef|typedef
struct|struct
DECL|struct|__anon2c6672540208
block|{
DECL|member|PR
name|PixelRegion
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Restrict to multiples of 15 degrees if shift is pressed */
if|if
condition|(
name|mevent
operator|->
...
expr_stmt|;
block|}
comment|/* Use another way to restrict to multiples of 15 degrees if ctrl is pressed */
elseif|else
if|if
condition|(
name|mevent
...
name|g_warning
argument_list|(
literal|"blend_motion: should never be reached!"
argument_list|)
expr_stmt|;
break|break;
block|}
