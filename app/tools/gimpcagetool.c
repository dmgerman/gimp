...
condition|)
block|{
comment|/* user clicked on the first handle, we close the cage and        * switch to deform mode        */
if|if
condition|(
name|ct
operator|->
...
condition|)
block|{
comment|/* user released outside any handles, add one if the cage is not        * complete yet        */
if|if
condition|(
operator|!
name|ct
