...
include|#
directive|include
file|"display/gimpcanvastransformguides.h"
end_include
...
name|GimpCanvasItem
modifier|*
DECL|function|gimp_draw_tool_add_transform_guides (GimpDrawTool * draw_tool,const GimpMatrix3 * transform,GimpGuidesType type,gint n_guides,gdouble x1,gdouble y1,gdouble x2,gdouble y2)
...
name|GimpCanvasItem
modifier|*
DECL|function|gimp_draw_tool_add_transform_preview (GimpDrawTool * draw_tool,GimpDrawable * drawable,const GimpMatrix3 * transform,gdouble x1,gdouble y1,gdouble x2,gdouble y2,gboolean perspective,gdouble opacity)
