...
begin_comment
comment|/**  * gimp_draw_tool_draw_rectangle_stippled:  * @draw_tool:   the #GimpDrawTool  * @x:           horizontal image coordinate  * @y:           vertical image coordinate  * @width:       width in image coordinates  * @height:      height in image coordinates  * @use_offsets: whether to use the image pixel offsets of the tool's display  *  * This function takes image space coordinates and transforms them to  * screen window coordinates, then draws the resulting rectangle, filling  * it with the default stipple pattern.  **/
end_comment

begin_function
name|void
DECL|function|gimp_draw_tool_draw_rectangle_stippled (GimpDrawTool * draw_tool,gdouble x,gdouble y,gdouble width,gdouble height,gboolean use_offsets)
