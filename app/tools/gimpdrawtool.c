...
specifier|static
name|gboolean
DECL|function|gimp_draw_tool_on_vectors_curve (GimpDrawTool * draw_tool,GimpDisplay * display,GimpVectors * vectors,const GimpCoords * coords,gint width,gint height)
...
name|GimpVectors
modifier|*
DECL|function|gimp_draw_tool_on_vectors (GimpDrawTool * draw_tool,GimpDisplay * display,const GimpCoords * coords,gint width,gint height)
