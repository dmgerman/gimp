...
specifier|static
name|void
name|gimp_draw_tool_draw_vectors
parameter_list|(
name|GimpDrawTool
modifier|*
name|draw_tool
...
begin_function
name|void
DECL|function|gimp_draw_tool_set_clip_rect (GimpDrawTool * draw_tool,GdkRectangle * rect,gboolean use_offsets)
...
begin_function
name|void
DECL|function|gimp_draw_tool_draw_text_cursor (GimpDrawTool * draw_tool,gdouble x1,gdouble y1,gdouble x2,gdouble y2,gboolean use_offsets)
...
begin_comment
comment|/*  This is called from gimp_draw_tool_real_draw()  */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_draw_tool_draw_vectors (GimpDrawTool * draw_tool,GList * vectors)
name|gimp_draw_tool_draw_vectors
parameter_list|(
name|GimpDrawTool
modifier|*
