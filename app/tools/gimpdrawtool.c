...
specifier|static
name|void
DECL|function|gimp_draw_tool_invalidate_items (GimpDrawTool * draw_tool)
name|gimp_draw_tool_invalidate_items
parameter_list|(
name|GimpDrawTool
modifier|*
name|draw_tool
...
begin_function
name|void
DECL|function|gimp_draw_tool_draw_items (GimpDrawTool * draw_tool,cairo_t * cr)
