...
begin_comment
comment|/**  * gimp_draw_tool_calc_distance:  * @draw_tool: a #GimpDrawTool  * @display:   a #GimpDisplay  * @x1:        start point X in image coordinates  * @y1:        start point Y in image coordinates  * @x2:        end point X in image coordinates  * @y2:        end point Y in image coordinates  *  * Returns: the distance between the given points in display coordinates  **/
end_comment
...
begin_comment
comment|/**  * gimp_draw_tool_draw_corner:  * @draw_tool:   the #GimpDrawTool  * @filled:      whether to fill the rectangle  * @x1:  * @y1:  * @x2:  * @y2:  * @width:       corner width  * @height:      corner height  * @anchor:      which corner to draw  * @use_offsets: whether to use the image pixel offsets of the tool's display  *  * This function takes image space coordinates and transforms them to  * screen window coordinates. It draws a corner into an already drawn  * rectangle outline, taking care of not drawing over an already drawn line.  **/
end_comment

begin_function
name|void
DECL|function|gimp_draw_tool_draw_corner (GimpDrawTool * draw_tool,gboolean filled,gdouble x1,gdouble y1,gdouble x2,gdouble y2,gint width,gint height,GtkAnchorType anchor,gboolean use_offsets)
