...
begin_function
name|void
DECL|function|gimp_draw_tool_draw_rectangle_by_center (GimpDrawTool * draw_tool,gboolean filled,gdouble x,gdouble y,gint width,gint height,gboolean use_offsets)
...
begin_function
name|void
DECL|function|gimp_draw_tool_draw_arc_by_center (GimpDrawTool * draw_tool,gboolean filled,gdouble x,gdouble y,gint radius,gint angle1,gint angle2,gboolean use_offsets)
...
begin_function
name|void
DECL|function|gimp_draw_tool_draw_cross (GimpDrawTool * draw_tool,gdouble x,gdouble y,gint size,gboolean use_offsets)
...
begin_function
name|void
DECL|function|gimp_draw_tool_draw_handle (GimpDrawTool * draw_tool,GimpHandleType type,gboolean filled,gdouble x,gdouble y,gint size,gboolean use_offsets)
...
name|g_warning
argument_list|(
literal|"gimp_draw_tool_draw_handle(): invalid handle type"
argument_list|)
expr_stmt|;
break|break;
block|}
