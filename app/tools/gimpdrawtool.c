...
begin_function
name|void
DECL|function|gimp_draw_tool_draw_text_cursor (GimpDrawTool * draw_tool,gdouble x1,gdouble y1,gdouble x2,gdouble y2,gboolean overwrite,gboolean use_offsets)
