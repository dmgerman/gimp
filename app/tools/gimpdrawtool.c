...
include|#
directive|include
file|"display/gimpcanvasrectangleguides.h"
end_include
...
name|GimpCanvasItem
modifier|*
DECL|function|gimp_draw_tool_add_rectangle_guides (GimpDrawTool * draw_tool,GimpGuidesType type,gdouble x,gdouble y,gdouble width,gdouble height)
