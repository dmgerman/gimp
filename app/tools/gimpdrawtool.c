...
begin_comment
comment|/**  * gimp_draw_tool_draw_corner:  * @draw_tool:   the #GimpDrawTool  * @highlight:  * @x1:  * @y1:  * @x2:  * @y2:  * @width:       corner width  * @height:      corner height  * @anchor:      which corner to draw  * @use_offsets: whether to use the image pixel offsets of the tool's display  *  * This function takes image space coordinates and transforms them to  * screen window coordinates. It draws a corner into an already drawn  * rectangle outline, taking care of not drawing over an already drawn line.  **/
end_comment

begin_function
name|void
DECL|function|gimp_draw_tool_draw_corner (GimpDrawTool * draw_tool,gboolean highlight,gdouble x1,gdouble y1,gdouble x2,gdouble y2,gint width,gint height,GtkAnchorType anchor,gboolean use_offsets)
