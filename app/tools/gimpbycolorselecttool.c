...
begin_decl_stmt
DECL|variable|by_color_select_image_target_table
specifier|static
name|GtkTargetEntry
name|by_color_select_image_target_table
index|[]
init|=
block|{
...
begin_decl_stmt
DECL|variable|n_by_color_select_image_targets
specifier|static
name|guint
name|n_by_color_select_image_targets
init|=
operator|(
sizeof|sizeof
argument_list|(
