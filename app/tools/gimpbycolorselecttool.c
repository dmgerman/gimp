...
name|GObject
modifier|*
name|gimp_by_color_select_tool_constructor
parameter_list|(
name|GType
name|type
parameter_list|,
...
specifier|static
name|void
name|gimp_by_color_select_tool_dispose
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
name|gimp_by_color_select_tool_threshold_notify
parameter_list|(
...
name|GObject
modifier|*
DECL|function|gimp_by_color_select_tool_constructor (GType type,guint n_params,GObjectConstructParam * params)
name|gimp_by_color_select_tool_constructor
parameter_list|(
name|GType
name|type
...
specifier|static
name|void
DECL|function|gimp_by_color_select_tool_dispose (GObject * object)
name|gimp_by_color_select_tool_dispose
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_by_color_select_tool_threshold_notify (GimpSelectionOptions * options,GParamSpec * pspec,GimpByColorSelectTool * by_color_sel)
name|gimp_by_color_select_tool_threshold_notify
parameter_list|(
name|GimpSelectionOptions
modifier|*
...
name|image
expr_stmt|;
comment|/* don't do anything unless we have already done something */
if|if
condition|(
operator|!
name|undo
...
specifier|static
name|void
DECL|function|gimp_by_color_select_tool_select (GimpByColorSelectTool * by_color_sel)
name|gimp_by_color_select_tool_select
parameter_list|(
name|GimpByColorSelectTool
modifier|*
