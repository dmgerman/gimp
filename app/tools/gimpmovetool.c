...
specifier|static
name|void
DECL|function|gimp_move_tool_button_release (GimpTool * tool,GimpCoords * coords,guint32 time,GdkModifierType state,GimpButtonReleaseType release_type,GimpDisplay * display)
name|gimp_move_tool_button_release
parameter_list|(
name|GimpTool
modifier|*
...
name|FALSE
return|;
comment|/* Handle cases gimp_edit_selection_tool_key_press can't handle here,      otherwise just pass everything on to it. */
switch|switch
condition|(
name|options
operator|->
...
argument_list|)
expr_stmt|;
comment|/* Only push undo if we're not working on the same group of undo:s as in          the previous call to this function. */
name|push_undo
operator|=
operator|!
operator|(
