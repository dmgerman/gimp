...
begin_comment
comment|/*  paint brush tool options  */
end_comment
...
specifier|static
name|void
DECL|function|paintbrush_gradient_type_callback (GtkWidget * w,gpointer client_data)
...
specifier|static
name|void
DECL|function|reset_paint_options (void)
name|reset_paint_options
parameter_list|(
name|void
parameter_list|)
block|{
