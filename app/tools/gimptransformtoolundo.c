...
name|GObject
modifier|*
name|gimp_transform_tool_undo_constructor
parameter_list|(
name|GType
name|type
parameter_list|,
...
name|GObject
modifier|*
DECL|function|gimp_transform_tool_undo_constructor (GType type,guint n_params,GObjectConstructParam * params)
name|gimp_transform_tool_undo_constructor
parameter_list|(
name|GType
name|type
