...
begin_function
name|void
DECL|function|gimp_tool_control_set_dirty_action (GimpToolControl * control,GimpToolAction action)
...
begin_function
name|GimpToolAction
DECL|function|gimp_tool_control_get_dirty_action (GimpToolControl * control)
...
begin_function
name|void
DECL|function|gimp_tool_control_set_active_modifiers (GimpToolControl * control,GimpToolActiveModifiers active_modifiers)
...
begin_function
name|GimpToolActiveModifiers
DECL|function|gimp_tool_control_get_active_modifiers (GimpToolControl * control)
...
begin_function
name|void
DECL|function|gimp_tool_control_set_action_spacing (GimpToolControl * control,const gchar * action)
...
name|gchar
modifier|*
DECL|function|gimp_tool_control_get_action_spacing (GimpToolControl * control)
...
begin_function
name|void
DECL|function|gimp_tool_control_set_action_hardness (GimpToolControl * control,const gchar * action)
...
name|gchar
modifier|*
DECL|function|gimp_tool_control_get_action_hardness (GimpToolControl * control)
...
begin_function
name|void
DECL|function|gimp_tool_control_set_action_force (GimpToolControl * control,const gchar * action)
...
name|gchar
modifier|*
DECL|function|gimp_tool_control_get_action_force (GimpToolControl * control)
