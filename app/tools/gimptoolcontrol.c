...
begin_function
name|void
DECL|function|gimp_tool_control_snap_offsets (GimpToolControl * control,gint * offset_x,gint * offset_y,gint * width,gint * height)
...
begin_function
name|GimpDirtyMask
DECL|function|gimp_tool_control_dirty_mask (GimpToolControl * control)
