...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpConvolveTool,gimp_convolve_tool,GIMP_TYPE_PAINT_TOOL)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_convolve_tool_cursor_update (GimpTool * tool,GimpCoords * coords,GdkModifierType state,GimpDisplay * display)
name|gimp_convolve_tool_cursor_update
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_convolve_tool_oper_update (GimpTool * tool,GimpCoords * coords,GdkModifierType state,gboolean proximity,GimpDisplay * display)
name|gimp_convolve_tool_oper_update
parameter_list|(
name|GimpTool
modifier|*
