...
decl_stmt|;
DECL|member|image_undo_start_handler_id
name|GQuark
name|image_undo_start_handler_id
decl_stmt|;
block|}
struct|;
end_struct
...
specifier|static
name|void
name|tool_manager_image_undo_start
parameter_list|(
name|GimpImage
modifier|*
name|gimage
...
begin_function
name|void
DECL|function|tool_manager_save (Gimp * gimp)
...
specifier|static
name|void
DECL|function|tool_manager_image_dirty (GimpImage * gimage,GimpToolManager * tool_manager)
name|tool_manager_image_dirty
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|tool_manager_image_undo_start (GimpImage * gimage,GimpToolManager * tool_manager)
name|tool_manager_image_undo_start
parameter_list|(
name|GimpImage
modifier|*
