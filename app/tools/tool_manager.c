...
specifier|static
name|void
DECL|function|tool_manager_connect_options (GimpContext * user_context,GimpToolInfo * tool_info)
name|tool_manager_connect_options
parameter_list|(
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|tool_manager_disconnect_options (GimpContext * user_context,GimpToolInfo * tool_info)
name|tool_manager_disconnect_options
parameter_list|(
name|GimpContext
modifier|*
