...
name|tool_options
expr_stmt|;
comment|/*  copy various data objects' additional tool options again        *  manually, they might have been overwritten by e.g. the "link        *  brush stuff to brush defaults" logic in gimptooloptions.c        */
if|if
condition|(
name|preset
operator|->
...
typedef|typedef
struct|struct
DECL|struct|__anon28b9e26a0108
block|{
