...
typedef|typedef
struct|struct
DECL|struct|__anon2c7308110208
block|{
DECL|member|type
name|PaintItemType
name|type
decl_stmt|;
union|union
DECL|union|__anon2c730811030a
block|{
struct|struct
DECL|struct|__anon2c7308110408
block|{
...
specifier|static
name|void
name|gimp_paint_tool_paint_update_outline
parameter_list|(
name|GimpPaintTool
modifier|*
name|paint_tool
...
specifier|static
name|void
DECL|function|gimp_paint_tool_paint_update_outline (GimpPaintTool * paint_tool)
name|gimp_paint_tool_paint_update_outline
parameter_list|(
name|GimpPaintTool
modifier|*
...
expr_stmt|;
block|}
comment|/*  Update the brush outline  */
name|gimp_paint_tool_paint_update_outline
argument_list|(
name|paint_tool
argument_list|)
...
argument_list|)
expr_stmt|;
comment|/*  Clear the brush outline  */
name|g_clear_object
argument_list|(
operator|&
name|paint_tool
