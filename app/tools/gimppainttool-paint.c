...
typedef|typedef
enum|enum
DECL|enum|__anon2c93a0db0103
block|{
DECL|enumerator|PAINT_ITEM_TYPE_CORE_PAINT
name|PAINT_ITEM_TYPE_CORE_PAINT
block|,
DECL|enumerator|PAINT_ITEM_TYPE_CORE_INTERPOLATE
name|PAINT_ITEM_TYPE_CORE_INTERPOLATE
block|,
...
typedef|typedef
struct|struct
DECL|struct|__anon2c93a0db0208
block|{
DECL|member|type
name|PaintItemType
name|type
decl_stmt|;
union|union
DECL|union|__anon2c93a0db030a
block|{
struct|struct
DECL|struct|__anon2c93a0db0408
block|{
...
return|return;
block|}
name|gimp_paint_tool_paint_core_interpolate
argument_list|(
name|paint_tool
argument_list|,
operator|&
...
begin_function
name|void
DECL|function|gimp_paint_tool_paint_core_paint (GimpPaintTool * paint_tool,GimpPaintState state,guint32 time)
...
begin_function
name|void
DECL|function|gimp_paint_tool_paint_core_interpolate (GimpPaintTool * paint_tool,const GimpCoords * coords,guint32 time)
name|gimp_paint_tool_paint_core_interpolate
parameter_list|(
name|GimpPaintTool
modifier|*
