...
name|obj
parameter_list|)
value|(GTK_CHECK_CAST ((obj), GIMP_TYPE_PATH_TOOL, GimpPathTool))
end_define
...
name|obj
parameter_list|)
value|(GTK_CHECK_TYPE ((obj), GIMP_TYPE_PATH_TOOL))
end_define
...
name|klass
parameter_list|)
value|(GTK_CHECK_CLASS_CAST ((klass), GIMP_TYPE_PATH_TOOL, GimpPathToolClass))
end_define
...
name|klass
parameter_list|)
value|(GTK_CHECK_CLASS_TYPE ((klass), GIMP_TYPE_PATH_TOOL))
end_define
...
begin_function_decl
name|void
name|gimp_path_tool_draw_curve
parameter_list|(
name|GimpPathTool
modifier|*
parameter_list|,
...
begin_function_decl
name|void
name|gimp_path_tool_draw_segment
parameter_list|(
name|GimpPathTool
modifier|*
parameter_list|,
