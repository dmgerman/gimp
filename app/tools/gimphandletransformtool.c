...
expr_stmt|;
comment|/* There is nothing to be done on creation */
if|if
condition|(
name|tr_tool
operator|->
...
expr_stmt|;
block|}
comment|/* handle was added or moved. calculate new original position */
name|matrix
operator|=
name|tr_tool
operator|->
...
condition|)
block|{
comment|/* there aren't two other handles */
return|return
name|TRUE
return|;
block|}
