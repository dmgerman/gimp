...
include|#
directive|include
file|"core/gimp-internal-data.h"
end_include
...
argument_list|)
expr_stmt|;
comment|/* make the generic operation tool invisible by default */
name|object
operator|=
name|gimp_container_get_child_by_name
argument_list|(
...
expr_stmt|;
block|}
comment|/*  make sure there is always a tool active, so broken config files    *  can't leave us with no initial tool    */
if|if
condition|(
operator|!
