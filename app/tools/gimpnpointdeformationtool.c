...
begin_define
DECL|macro|GIMP_NPD_STRING
define|#
directive|define
name|GIMP_NPD_STRING
value|"N-Point Deformation"
end_define
...
specifier|static
name|void
name|gimp_n_point_deformation_tool_add_preview
parameter_list|(
name|GimpNPointDeformationTool
modifier|*
name|npd_tool
...
argument_list|)
expr_stmt|;
comment|/* create and start canvas update thread */
name|npd_tool
operator|->
...
argument_list|()
expr_stmt|;
comment|/* perform the deformation only if the tool hasn't been paused */
if|if
condition|(
operator|!
name|gimp_n_point_deformation_options_is_deformation_paused
...
specifier|static
name|void
DECL|function|gimp_n_point_deformation_tool_add_preview (GimpNPointDeformationTool * npd_tool)
name|gimp_n_point_deformation_tool_add_preview
parameter_list|(
name|GimpNPointDeformationTool
modifier|*
