...
begin_define
DECL|macro|gimp_n_point_deformation_tool_clear_selected_points_list ()
define|#
directive|define
name|gimp_n_point_deformation_tool_clear_selected_points_list
parameter_list|()
define|\
value|g_list_free      (*selected_cps);                                              \ g_list_free_full (*previous_cps_positions, g_free);                            \ *selected_cps           = NULL;                                                \ *previous_cps_positions = NULL
end_define
...
condition|)
block|{
comment|/* there isn't a control point at cursor's position - clear the list            * of selected control points */
name|gimp_n_point_deformation_tool_clear_selected_points_list
argument_list|()
expr_stmt|;
block|}
...
condition|)
block|{
comment|/* control point isn't selected, so we add it to the list                * of selected control points */
name|NPDPoint
modifier|*
name|cp_point_copy
init|=
