...
name|void
modifier|*
DECL|function|eraser_paint_func (paint_core,drawable_id,state)
...
begin_function
name|void
DECL|function|eraser_motion (paint_core,drawable_id)
name|eraser_motion
parameter_list|(
name|paint_core
parameter_list|,
...
name|void
modifier|*
DECL|function|eraser_non_gui_paint_func (PaintCore * paint_core,int drawable_id,int state)
