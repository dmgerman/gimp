...
specifier|static
name|void
name|gimp_threshold_tool_destroy
parameter_list|(
name|GtkObject
modifier|*
name|object
...
specifier|static
name|void
name|gimp_threshold_tool_control
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
begin_function
name|void
DECL|function|gimp_threshold_tool_register (void)
...
specifier|static
name|void
DECL|function|gimp_threshold_tool_init (GimpThresholdTool * bc_tool)
name|gimp_threshold_tool_init
parameter_list|(
name|GimpThresholdTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_threshold_tool_destroy (GtkObject * object)
name|gimp_threshold_tool_destroy
parameter_list|(
name|GtkObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_threshold_tool_initialize (GimpTool * tool,GDisplay * gdisp)
name|gimp_threshold_tool_initialize
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_threshold_tool_control (GimpTool * tool,ToolAction action,GDisplay * gdisp)
name|gimp_threshold_tool_control
parameter_list|(
name|GimpTool
modifier|*
...
begin_function
name|void
DECL|function|threshold_2 (gpointer data,PixelRegion * srcPR,PixelRegion * destPR)
name|threshold_2
parameter_list|(
name|gpointer
name|data
