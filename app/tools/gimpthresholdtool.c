...
include|#
directive|include
file|"core/gimptriviallycancelablewaitable.h"
end_include
...
specifier|static
name|gboolean
name|gimp_threshold_tool_channel_sensitive
parameter_list|(
name|gint
name|value
parameter_list|,
...
argument_list|)
expr_stmt|;
comment|/* this is a hack to make sure that    * 'gimp_histogram_n_bins (t_tool->histogram)' returns the correct value for    * 'drawable' before the asynchronous calculation of its histogram is    * finished.    */
block|{
name|GeglBuffer
modifier|*
name|temp
...
specifier|static
name|void
DECL|function|gimp_threshold_tool_config_notify (GimpFilterTool * filter_tool,GimpConfig * config,const GParamSpec * pspec)
name|gimp_threshold_tool_config_notify
parameter_list|(
name|GimpFilterTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_threshold_tool_channel_sensitive (gint value,gpointer data)
name|gimp_threshold_tool_channel_sensitive
parameter_list|(
name|gint
name|value
