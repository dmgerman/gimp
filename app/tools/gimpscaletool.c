...
specifier|static
name|void
DECL|function|gimp_scale_tool_init (GimpScaleTool * sc_tool)
name|gimp_scale_tool_init
parameter_list|(
name|GimpScaleTool
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* FIXME name is confusing */
block|}
end_function
...
specifier|static
name|void
DECL|function|gimp_scale_tool_info_update (GimpScaleTool * sc_tool)
name|gimp_scale_tool_info_update
parameter_list|(
name|GimpScaleTool
modifier|*
