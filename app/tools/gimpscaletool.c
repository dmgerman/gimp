...
name|TileManager
modifier|*
DECL|function|scale_tool_transform (Tool * tool,GDisplay * gdisp,TransformState state)
name|scale_tool_transform
parameter_list|(
name|Tool
modifier|*
...
specifier|static
name|void
DECL|function|scale_tool_motion (Tool * tool,GDisplay * gdisp)
name|scale_tool_motion
parameter_list|(
name|Tool
modifier|*
...
specifier|static
name|void
DECL|function|scale_tool_recalc (Tool * tool,GDisplay * gdisp)
name|scale_tool_recalc
parameter_list|(
name|Tool
modifier|*
