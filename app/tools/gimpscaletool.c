...
specifier|static
name|void
DECL|function|scale_width_changed (GtkWidget * w,gpointer data)
name|scale_width_changed
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|scale_height_changed (GtkWidget * w,gpointer data)
name|scale_height_changed
parameter_list|(
name|GtkWidget
modifier|*
...
name|void
modifier|*
DECL|function|scale_tool_scale (gimage,drawable,gdisp,trans_info,float_tiles,interpolation,matrix)
name|scale_tool_scale
parameter_list|(
name|gimage
parameter_list|,
