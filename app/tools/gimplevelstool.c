...
specifier|static
name|void
DECL|function|levels_calculate_transfers (GimpLevelsTool * l_tool)
name|levels_calculate_transfers
parameter_list|(
name|GimpLevelsTool
modifier|*
...
specifier|static
name|void
DECL|function|levels_adjust_channel (GimpLevelsTool * l_tool,GimpHistogram * hist,gint channel)
