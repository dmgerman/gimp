...
name|gchar
modifier|*
DECL|function|gimp_levels_tool_get_operation (GimpFilterTool * filter_tool,gchar ** description)
name|gimp_levels_tool_get_operation
parameter_list|(
name|GimpFilterTool
modifier|*
...
name|config
argument_list|,
literal|"clamp-output"
argument_list|,
name|_
argument_list|(
literal|"Clamp outpu_t"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_box_pack_start
...
specifier|static
name|void
DECL|function|gimp_levels_tool_config_notify (GimpFilterTool * filter_tool,GimpConfig * config,const GParamSpec * pspec)
name|gimp_levels_tool_config_notify
parameter_list|(
name|GimpFilterTool
modifier|*
