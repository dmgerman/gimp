...
name|GeglNode
modifier|*
DECL|function|gimp_levels_tool_get_operation (GimpImageMapTool * im_tool,GObject ** config,gchar ** undo_desc)
name|gimp_levels_tool_get_operation
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_levels_tool_color_picked (GimpImageMapTool * color_tool,gpointer identifier,const Babl * sample_format,const GimpRGB * color)
name|gimp_levels_tool_color_picked
parameter_list|(
name|GimpImageMapTool
modifier|*
