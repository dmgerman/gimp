...
specifier|static
name|void
name|levels_update_adjustments
parameter_list|(
name|GimpLevelsTool
modifier|*
name|tool
...
name|GeglNode
modifier|*
DECL|function|gimp_levels_tool_get_operation (GimpImageMapTool * im_tool)
name|gimp_levels_tool_get_operation
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|void
DECL|function|levels_update_adjustments (GimpLevelsTool * tool)
name|levels_update_adjustments
parameter_list|(
name|GimpLevelsTool
modifier|*
