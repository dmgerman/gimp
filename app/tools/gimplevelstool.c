...
specifier|static
name|gboolean
DECL|function|gimp_levels_tool_settings_import (GimpImageMapTool * image_map_tool,GInputStream * input,GError ** error)
name|gimp_levels_tool_settings_import
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_levels_tool_settings_export (GimpImageMapTool * image_map_tool,GOutputStream * output,GError ** error)
name|gimp_levels_tool_settings_export
parameter_list|(
name|GimpImageMapTool
modifier|*
