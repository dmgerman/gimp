...
begin_define
DECL|macro|LEVELS_DRAWING_AREA_MASK
define|#
directive|define
name|LEVELS_DRAWING_AREA_MASK
...
specifier|static
name|void
name|levels_input_area_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|levels_output_area_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|levels_channel_callback (GtkWidget * widget,GimpLevelsTool * l_tool)
name|levels_channel_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|levels_channel_reset_callback (GtkWidget * widget,GimpLevelsTool * l_tool)
name|levels_channel_reset_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|levels_auto_callback (GtkWidget * widget,GimpLevelsTool * l_tool)
name|levels_auto_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|levels_low_input_adjustment_update (GtkAdjustment * adjustment,GimpLevelsTool * l_tool)
name|levels_low_input_adjustment_update
parameter_list|(
name|GtkAdjustment
modifier|*
...
specifier|static
name|void
DECL|function|levels_gamma_adjustment_update (GtkAdjustment * adjustment,GimpLevelsTool * l_tool)
name|levels_gamma_adjustment_update
parameter_list|(
name|GtkAdjustment
modifier|*
...
specifier|static
name|void
DECL|function|levels_high_input_adjustment_update (GtkAdjustment * adjustment,GimpLevelsTool * l_tool)
name|levels_high_input_adjustment_update
parameter_list|(
name|GtkAdjustment
modifier|*
...
specifier|static
name|void
DECL|function|levels_low_output_adjustment_update (GtkAdjustment * adjustment,GimpLevelsTool * l_tool)
name|levels_low_output_adjustment_update
parameter_list|(
name|GtkAdjustment
modifier|*
...
specifier|static
name|void
DECL|function|levels_high_output_adjustment_update (GtkAdjustment * adjustment,GimpLevelsTool * l_tool)
name|levels_high_output_adjustment_update
parameter_list|(
name|GtkAdjustment
modifier|*
...
specifier|static
name|gboolean
DECL|function|levels_input_area_event (GtkWidget * widget,GdkEvent * event,GimpLevelsTool * l_tool)
name|levels_input_area_event
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|levels_input_area_expose (GtkWidget * widget,GdkEventExpose * event,GimpLevelsTool * l_tool)
name|levels_input_area_expose
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|levels_input_area_size_allocate (GtkWidget * widget,GtkAllocation * allocation,GimpLevelsTool * l_tool)
name|levels_input_area_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|levels_output_area_event (GtkWidget * widget,GdkEvent * event,GimpLevelsTool * l_tool)
name|levels_output_area_event
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|levels_output_area_expose (GtkWidget * widget,GdkEventExpose * event,GimpLevelsTool * l_tool)
name|levels_output_area_expose
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|levels_output_area_size_allocate (GtkWidget * widget,GtkAllocation * allocation,GimpLevelsTool * l_tool)
name|levels_output_area_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_levels_tool_color_picked (GimpColorTool * color_tool,GimpImageType sample_type,GimpRGB * color,gint color_index)
name|gimp_levels_tool_color_picked
parameter_list|(
name|GimpColorTool
modifier|*
...
specifier|static
name|void
DECL|function|levels_load_callback (GtkWidget * widget,GimpLevelsTool * l_tool)
name|levels_load_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|levels_save_callback (GtkWidget * widget,GimpLevelsTool * l_tool)
name|levels_save_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|file_dialog_response (GtkWidget * dialog,gint response_id,GimpLevelsTool * l_tool)
name|file_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
