...
specifier|static
name|void
DECL|function|gimp_levels_tool_control (GimpTool * tool,GimpToolAction action,GimpDisplay * gdisp)
name|gimp_levels_tool_control
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|levels_set_sensitive_callback (gpointer item_data,LevelsDialog * ld)
name|levels_set_sensitive_callback
parameter_list|(
name|gpointer
name|item_data
