...
argument_list|)
expr_stmt|;
comment|/*  Horizontal button box for load/sve  */
name|hbbox
operator|=
...
specifier|static
name|void
DECL|function|levels_load_callback (GtkWidget * widget,gpointer client_data)
name|levels_load_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|levels_save_callback (GtkWidget * widget,gpointer client_data)
name|levels_save_callback
parameter_list|(
name|GtkWidget
modifier|*
