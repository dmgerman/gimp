...
block|,
DECL|enumerator|PROP_REAL_TIME_PREVIEW
name|PROP_REAL_TIME_PREVIEW
block|,
...
name|_
argument_list|(
literal|"Render preview in real time (slower)"
argument_list|)
argument_list|,
name|FALSE
argument_list|,
