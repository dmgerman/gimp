...
specifier|static
name|gboolean
DECL|function|gradient_map_value (GeglBuffer * map,gint x,gint y,guint8 * grad,guint8 * dir)
...
specifier|static
name|gint
DECL|function|calculate_link (GeglBuffer * gradient_map,gint x,gint y,guint32 pixel,gint link)
name|calculate_link
parameter_list|(
name|GeglBuffer
modifier|*
