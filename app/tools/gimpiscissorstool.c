...
specifier|static
name|void
name|gimp_iscissors_tool_push_undo
parameter_list|(
...
specifier|static
name|void
name|gimp_iscissors_tool_pop_undo
parameter_list|(
name|GimpIscissorsTool
modifier|*
name|iscissors
...
specifier|static
name|void
name|gimp_iscissors_tool_free_redo
parameter_list|(
name|GimpIscissorsTool
modifier|*
name|iscissors
...
specifier|static
name|void
name|gimp_iscissors_tool_commit
parameter_list|(
name|GimpIscissorsTool
modifier|*
name|iscissors
...
modifier|*
name|icurve_create_scan_convert
parameter_list|(
name|ICurve
modifier|*
name|curve
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpIscissorsTool,gimp_iscissors_tool,GIMP_TYPE_SELECTION_TOOL)
name|G_DEFINE_TYPE
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  Initialize the draw tool only on starting the tool  */
...
block|}
block|}
comment|/*  If the iscissors is closed, check if the click was inside  */
elseif|else
if|if
condition|(
name|iscissors
...
condition|)
block|{
comment|/*  if we're not closed, we're adding a new point  */
name|ISegment
modifier|*
name|last
init|=
...
name|list
decl_stmt|;
comment|/*  First, render all segments and lines  */
if|if
condition|(
operator|!
name|iscissors
...
argument_list|)
expr_stmt|;
comment|/*  if this segment is currently being added or adjusted  */
if|if
condition|(
operator|(
name|iscissors
...
block|}
block|}
comment|/*  Then, render the handles on top of the segments  */
for|for
control|(
name|list
operator|=
...
expr_stmt|;
block|}
comment|/*  Draw the last point if the curve is not closed  */
if|if
condition|(
operator|!
name|list
...
name|_
argument_list|(
literal|"Click to remove this point"
argument_list|)
argument_list|)
expr_stmt|;
name|iscissors
...
name|_
argument_list|(
literal|"Click to close the curve"
argument_list|)
argument_list|)
expr_stmt|;
name|iscissors
...
name|_
argument_list|(
literal|"Click to add a point on this segment"
argument_list|)
argument_list|)
expr_stmt|;
name|iscissors
...
specifier|static
name|gboolean
DECL|function|gimp_iscissors_tool_undo (GimpTool * tool,GimpDisplay * display)
name|gimp_iscissors_tool_undo
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_iscissors_tool_redo (GimpTool * tool,GimpDisplay * display)
name|gimp_iscissors_tool_redo
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_iscissors_tool_push_undo (GimpIscissorsTool * iscissors)
name|gimp_iscissors_tool_push_undo
parameter_list|(
name|GimpIscissorsTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_iscissors_tool_pop_undo (GimpIscissorsTool * iscissors)
name|gimp_iscissors_tool_pop_undo
parameter_list|(
name|GimpIscissorsTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_iscissors_tool_free_redo (GimpIscissorsTool * iscissors)
name|gimp_iscissors_tool_free_redo
parameter_list|(
name|GimpIscissorsTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_iscissors_tool_halt (GimpIscissorsTool * iscissors,GimpDisplay * display)
name|gimp_iscissors_tool_halt
parameter_list|(
name|GimpIscissorsTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_iscissors_tool_commit (GimpIscissorsTool * iscissors,GimpDisplay * display)
name|gimp_iscissors_tool_commit
parameter_list|(
name|GimpIscissorsTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|gradient_map_value (GeglSampler * map_sampler,const GeglRectangle * map_extent,gint x,gint y,guint8 * grad,guint8 * dir)
...
specifier|static
name|gint
DECL|function|calculate_link (GeglSampler * map_sampler,const GeglRectangle * map_extent,gint x,gint y,guint32 pixel,gint link)
name|calculate_link
parameter_list|(
name|GeglSampler
modifier|*
...
specifier|static
name|void
DECL|function|find_optimal_path (GeglBuffer * gradient_map,GimpTempBuf * dp_buf,gint x1,gint y1,gint x2,gint y2,gint xs,gint ys)
name|find_optimal_path
parameter_list|(
name|GeglBuffer
modifier|*
...
argument_list|)
decl_stmt|;
comment|/*  initialize the gradient map sampler and extent  */
name|map_sampler
operator|=
...
name|ISegment
modifier|*
DECL|function|isegment_copy (ISegment * segment)
name|isegment_copy
parameter_list|(
name|ISegment
modifier|*
...
name|ICurve
modifier|*
DECL|function|icurve_copy (ICurve * curve)
name|icurve_copy
parameter_list|(
name|ICurve
modifier|*
...
specifier|static
name|void
DECL|function|icurve_clear (ICurve * curve)
name|icurve_clear
parameter_list|(
name|ICurve
modifier|*
...
name|ISegment
modifier|*
DECL|function|icurve_append_segment (ICurve * curve,gint x1,gint y1,gint x2,gint y2)
name|icurve_append_segment
parameter_list|(
name|ICurve
modifier|*
...
name|ISegment
modifier|*
DECL|function|icurve_insert_segment (ICurve * curve,GList * sibling,gint x1,gint y1,gint x2,gint y2)
name|icurve_insert_segment
parameter_list|(
name|ICurve
modifier|*
...
specifier|static
name|void
DECL|function|icurve_delete_segment (ICurve * curve,ISegment * segment)
name|icurve_delete_segment
parameter_list|(
name|ICurve
modifier|*
...
specifier|static
name|void
DECL|function|icurve_close (ICurve * curve)
name|icurve_close
parameter_list|(
name|ICurve
modifier|*
...
name|GimpScanConvert
modifier|*
DECL|function|icurve_create_scan_convert (ICurve * curve)
name|icurve_create_scan_convert
parameter_list|(
name|ICurve
modifier|*
