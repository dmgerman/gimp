...
name|MOVING
expr_stmt|;
comment|/*  If the pointer is in the rectangular region, crop it!  */
elseif|else
if|if
condition|(
name|bevent
...
specifier|static
name|void
DECL|function|crop_image (GImage * gimage,int x1,int y1,int x2,int y2)
name|crop_image
parameter_list|(
name|GImage
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  if the crop information dialog doesn't yet exist, create the bugger  */
if|if
condition|(
operator|!
name|crop_info
...
specifier|static
name|void
DECL|function|crop_orig_x_changed (GtkWidget * w,gpointer data)
name|crop_orig_x_changed
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|crop_orig_y_changed (GtkWidget * w,gpointer data)
name|crop_orig_y_changed
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|crop_width_changed (GtkWidget * w,gpointer data)
name|crop_width_changed
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|crop_height_changed (GtkWidget * w,gpointer data)
name|crop_height_changed
parameter_list|(
name|GtkWidget
modifier|*
