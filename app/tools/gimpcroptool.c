...
specifier|static
name|void
name|gimp_crop_tool_image_active_layer_changed
parameter_list|(
name|GimpCropTool
modifier|*
name|crop_tool
...
specifier|static
name|void
name|gimp_crop_tool_layer_size_changed
parameter_list|(
name|GimpCropTool
modifier|*
name|crop_tool
...
specifier|static
name|void
DECL|function|gimp_crop_tool_dispose (GObject * object)
name|gimp_crop_tool_dispose
parameter_list|(
name|GObject
modifier|*
...
argument_list|)
decl_stmt|;
comment|/* Clean up current_image and current_layer. */
name|gimp_crop_tool_image_changed
argument_list|(
name|crop_tool
argument_list|,
...
condition|)
block|{
comment|/* ugly hack: if we don't have a widget, construct a temporary one            * so that we can use it to call            * gimp_tool_rectangle_constraint_size_set().            */
name|GimpContext
modifier|*
name|context
init|=
...
expr_stmt|;
block|}
comment|/* Make sure we are connected to "size-changed" for the initial    * layer.    */
name|gimp_crop_tool_image_active_layer_changed
argument_list|(
name|crop_tool
argument_list|)
...
specifier|static
name|void
DECL|function|gimp_crop_tool_image_active_layer_changed (GimpCropTool * crop_tool)
name|gimp_crop_tool_image_active_layer_changed
parameter_list|(
name|GimpCropTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_crop_tool_layer_size_changed (GimpCropTool * crop_tool)
name|gimp_crop_tool_layer_size_changed
parameter_list|(
name|GimpCropTool
modifier|*
