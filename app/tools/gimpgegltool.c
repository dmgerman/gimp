...
specifier|static
name|void
DECL|function|gimp_gegl_tool_control (GimpTool * tool,GimpToolAction action,GimpDisplay * display)
name|gimp_gegl_tool_control
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_gegl_tool_halt (GimpGeglTool * gegl_tool)
name|gimp_gegl_tool_halt
parameter_list|(
name|GimpGeglTool
modifier|*
