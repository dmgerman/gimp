...
name|gchar
modifier|*
DECL|function|gimp_gegl_tool_get_operation (GimpImageMapTool * im_tool,gchar ** title,gchar ** description,gchar ** undo_desc,gchar ** icon_name,gchar ** help_id)
name|gimp_gegl_tool_get_operation
parameter_list|(
name|GimpImageMapTool
modifier|*
