...
specifier|static
name|void
DECL|function|gimp_paint_tool_push_status (GimpTool * tool,GimpDisplayShell * shell,const gchar * message)
name|gimp_paint_tool_push_status
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_paint_tool_pop_status (GimpTool * tool,GimpDisplayShell * shell)
name|gimp_paint_tool_pop_status
parameter_list|(
name|GimpTool
modifier|*
