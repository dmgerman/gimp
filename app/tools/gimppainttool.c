...
specifier|static
name|void
name|gimp_paint_tool_calculate_brush_size
parameter_list|(
name|MaskBuf
modifier|*
name|mask
...
name|MaskBuf
modifier|*
name|gimp_paint_tool_subsample_mask
parameter_list|(
name|MaskBuf
modifier|*
name|mask
...
name|MaskBuf
modifier|*
name|gimp_paint_tool_pressurize_mask
parameter_list|(
name|MaskBuf
modifier|*
name|brush_mask
...
name|MaskBuf
modifier|*
name|gimp_paint_tool_solidify_mask
parameter_list|(
name|MaskBuf
modifier|*
name|brush_mask
...
name|MaskBuf
modifier|*
name|gimp_paint_tool_scale_pixmap
parameter_list|(
name|MaskBuf
modifier|*
name|brush_mask
...
name|MaskBuf
modifier|*
name|gimp_paint_tool_get_brush_mask
parameter_list|(
name|GimpPaintTool
modifier|*
...
specifier|static
name|void
name|gimp_paint_tool_invalidate_cache
parameter_list|(
name|GimpBrush
modifier|*
name|brush
...
begin_decl_stmt
DECL|variable|gimp_paint_tool_signals
specifier|static
name|guint
name|gimp_paint_tool_signals
index|[
name|LAST_SIGNAL
index|]
init|=
...
specifier|static
name|void
DECL|function|gimp_paint_tool_init (GimpPaintTool * tool)
name|gimp_paint_tool_init
parameter_list|(
name|GimpPaintTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_paint_tool_control (GimpTool * tool,ToolAction action,GDisplay * gdisp)
name|gimp_paint_tool_control
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_paint_tool_button_press (GimpTool * tool,GdkEventButton * bevent,GDisplay * gdisp)
name|gimp_paint_tool_button_press
parameter_list|(
name|GimpTool
modifier|*
...
directive|if
literal|0
condition||| GIMP_BRUSH_GET_CLASS (paint_tool->brush)->want_null_motion (paint_tool)
endif|#
directive|endif
condition|)
block|{
...
directive|if
literal|0
block|paint_tool->brush = 		GIMP_BRUSH_GET_CLASS (paint_tool->brush)->select_brush (paint_tool);
endif|#
directive|endif
block|}
name|gimp_paint_tool_paint
...
specifier|static
name|void
DECL|function|gimp_paint_tool_button_release (GimpTool * tool,GdkEventButton * bevent,GDisplay * gdisp)
name|gimp_paint_tool_button_release
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_paint_tool_motion (GimpTool * tool,GdkEventMotion * mevent,GDisplay * gdisp)
name|gimp_paint_tool_motion
parameter_list|(
name|GimpTool
modifier|*
...
begin_comment
comment|/* FIXME: this belongs in the individual tools */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_paint_tool_cursor_update (GimpTool * tool,GdkEventMotion * mevent,GDisplay * gdisp)
name|gimp_paint_tool_cursor_update
parameter_list|(
name|GimpTool
modifier|*
...
name|offy
decl_stmt|;
comment|/* Adjust coords to start drawing from center of pixel if zoom> 1 */
name|offx
operator|=
operator|(
name|int
...
begin_function
name|void
DECL|function|gimp_paint_tool_paint (GimpPaintTool * tool,GimpDrawable * drawable,PaintState state)
name|gimp_paint_tool_paint
parameter_list|(
name|GimpPaintTool
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_paint_tool_start (GimpPaintTool * paint_tool,GimpDrawable * drawable,gdouble x,gdouble y)
name|gimp_paint_tool_start
parameter_list|(
name|GimpPaintTool
modifier|*
...
begin_function
name|void
DECL|function|gimp_paint_tool_interpolate (GimpPaintTool * paint_tool,GimpDrawable * drawable)
name|gimp_paint_tool_interpolate
parameter_list|(
name|GimpPaintTool
modifier|*
...
begin_function
name|void
DECL|function|gimp_paint_tool_finish (GimpPaintTool * paint_tool,GimpDrawable * drawable)
name|gimp_paint_tool_finish
parameter_list|(
name|GimpPaintTool
modifier|*
...
name|TempBuf
modifier|*
DECL|function|gimp_paint_tool_get_paint_area (GimpPaintTool * paint_tool,GimpDrawable * drawable,gdouble scale)
...
name|TempBuf
modifier|*
DECL|function|gimp_paint_tool_get_orig_image (GimpPaintTool * paint_tool,GimpDrawable * drawable,gint x1,gint y1,gint x2,gint y2)
...
begin_comment
comment|/* Similar to gimp_paint_tool_paste_canvas, but replaces the alpha channel    rather than using it to composite (i.e. transparent over opaque    becomes transparent rather than opauqe. */
end_comment

begin_function
name|void
DECL|function|gimp_paint_tool_replace_canvas (GimpPaintTool * paint_tool,GimpDrawable * drawable,gint brush_opacity,gint image_opacity,BrushApplicationMode brush_hardness,gdouble brush_scale,PaintApplicationMode mode)
...
specifier|static
name|void
DECL|function|gimp_paint_tool_invalidate_cache (GimpBrush * brush,gpointer data)
name|gimp_paint_tool_invalidate_cache
parameter_list|(
name|GimpBrush
modifier|*
...
specifier|static
name|void
DECL|function|gimp_paint_tool_calculate_brush_size (MaskBuf * mask,gdouble scale,gint * width,gint * height)
name|gimp_paint_tool_calculate_brush_size
parameter_list|(
name|MaskBuf
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_subsample_mask (MaskBuf * mask,gdouble x,gdouble y)
name|gimp_paint_tool_subsample_mask
parameter_list|(
name|MaskBuf
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_pressurize_mask (MaskBuf * brush_mask,gdouble x,gdouble y,gdouble pressure)
name|gimp_paint_tool_pressurize_mask
parameter_list|(
name|MaskBuf
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_solidify_mask (MaskBuf * brush_mask)
name|gimp_paint_tool_solidify_mask
parameter_list|(
name|MaskBuf
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_scale_mask (MaskBuf * brush_mask,gdouble scale)
name|gimp_paint_tool_scale_mask
parameter_list|(
name|MaskBuf
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_scale_pixmap (MaskBuf * brush_mask,gdouble scale)
name|gimp_paint_tool_scale_pixmap
parameter_list|(
name|MaskBuf
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_get_brush_mask (GimpPaintTool * paint_tool,BrushApplicationMode brush_hardness,gdouble scale)
name|gimp_paint_tool_get_brush_mask
parameter_list|(
name|GimpPaintTool
modifier|*
...
begin_comment
comment|/* This works similarly to gimp_paint_tool_paste. However, instead of combining    the canvas to the paint core drawable using one of the combination    modes, it uses a "replace" mode (i.e. transparent pixels in the    canvas erase the paint core drawable).     When not drawing on alpha-enabled images, it just paints using NORMAL    mode. */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_paint_tool_replace (GimpPaintTool * paint_tool,MaskBuf * brush_mask,GimpDrawable * drawable,gint brush_opacity,gint image_opacity,PaintApplicationMode mode)
name|gimp_paint_tool_replace
parameter_list|(
name|GimpPaintTool
modifier|*
...
specifier|static
name|void
DECL|function|canvas_tiles_to_canvas_buf (GimpPaintTool * gimp_paint_tool)
name|canvas_tiles_to_canvas_buf
parameter_list|(
name|GimpPaintTool
modifier|*
...
specifier|static
name|void
DECL|function|brush_to_canvas_tiles (GimpPaintTool * paint_tool,MaskBuf * brush_mask,gint brush_opacity)
name|brush_to_canvas_tiles
parameter_list|(
name|GimpPaintTool
modifier|*
...
specifier|static
name|void
DECL|function|brush_to_canvas_buf (GimpPaintTool * paint_tool,MaskBuf * brush_mask,gint brush_opacity)
name|brush_to_canvas_buf
parameter_list|(
name|GimpPaintTool
modifier|*
...
begin_comment
unit|static void paint_to_canvas_tiles (GimpPaintTool *paint_tool, 		       MaskBuf       *brush_mask, 		       gint           brush_opacity) {   PixelRegion srcPR;   PixelRegion maskPR;   gint x;   gint y;   gint xoff;   gint yoff;
comment|/*   combine the brush mask and the canvas tiles  */
end_comment

begin_comment
unit|pixel_region_init (&srcPR, canvas_tiles, 		     canvas_buf->x, canvas_buf->y, 		     canvas_buf->width, canvas_buf->height, TRUE);    x = (gint) floor (paint_tool->curx) - (brush_mask->width>> 1);   y = (gint) floor (paint_tool->cury) - (brush_mask->height>> 1);   xoff = (x< 0) ? -x : 0;   yoff = (y< 0) ? -y : 0;    maskPR.bytes     = 1;   maskPR.x         = 0;   maskPR.y         = 0;   maskPR.w         = srcPR.w;   maskPR.h         = srcPR.h;   maskPR.rowstride = maskPR.bytes * brush_mask->width;   maskPR.data      = mask_buf_data (brush_mask) + yoff * maskPR.rowstride + xoff * maskPR.bytes;
...
begin_comment
unit|apply_mask_to_region (&srcPR,&maskPR, OPAQUE_OPACITY); }  static void paint_to_canvas_buf (GimpPaintTool *paint_tool, 		     MaskBuf       *brush_mask, 		     gint           brush_opacity) {   PixelRegion srcPR;   PixelRegion maskPR;   gint x;   gint y;   gint xoff;   gint yoff;    x = (gint) floor (paint_tool->curx) - (brush_mask->width>> 1);   y = (gint) floor (paint_tool->cury) - (brush_mask->height>> 1);   xoff = (x< 0) ? -x : 0;   yoff = (y< 0) ? -y : 0;
comment|/*  combine the canvas buf and the brush mask to the canvas buf  */
end_comment
...
begin_function
name|void
DECL|function|gimp_paint_tool_color_area_with_pixmap (GimpPaintTool * paint_tool,GimpImage * dest,GimpDrawable * drawable,TempBuf * area,gdouble scale,BrushApplicationMode mode)
...
argument_list|)
expr_stmt|;
comment|/* Calculate upper left corner of brush as in    * gimp_paint_tool_get_paint_area.  Ugly to have to do this here, too.    */
name|ulx
operator|=
operator|(
name|gint
