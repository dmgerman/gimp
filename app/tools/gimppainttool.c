...
specifier|static
name|void
name|gimp_paint_tool_real_paint_prepare
parameter_list|(
name|GimpPaintTool
modifier|*
name|paint_tool
...
specifier|static
name|void
DECL|function|gimp_paint_tool_real_paint_prepare (GimpPaintTool * paint_tool,GimpDisplay * display)
name|gimp_paint_tool_real_paint_prepare
parameter_list|(
name|GimpPaintTool
modifier|*
...
name|_
argument_list|(
literal|"The active layer does not have an alpha channel."
argument_list|)
argument_list|)
expr_stmt|;
return|return
...
specifier|static
name|void
DECL|function|gimp_paint_tool_hard_notify (GimpPaintOptions * options,const GParamSpec * pspec,GimpPaintTool * paint_tool)
name|gimp_paint_tool_hard_notify
parameter_list|(
name|GimpPaintOptions
modifier|*
...
begin_function
name|void
DECL|function|gimp_paint_tool_set_active (GimpPaintTool * tool,gboolean active)
