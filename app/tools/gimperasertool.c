...
specifier|static
name|gboolean
name|gimp_eraser_tool_is_alpha_only
parameter_list|(
name|GimpPaintTool
modifier|*
name|paint_tool
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpEraserTool,gimp_eraser_tool,GIMP_TYPE_BRUSH_TOOL)
name|G_DEFINE_TYPE
argument_list|(
...
name|_
argument_list|(
literal|"Eraser Tool: Erase to background or transparency using a brush"
argument_list|)
argument_list|,
name|N_
argument_list|(
...
name|options
init|=
name|GIMP_ERASER_TOOL_GET_OPTIONS
argument_list|(
name|tool
argument_list|)
decl_stmt|;
...
specifier|static
name|gboolean
DECL|function|gimp_eraser_tool_is_alpha_only (GimpPaintTool * paint_tool,GimpDrawable * drawable)
name|gimp_eraser_tool_is_alpha_only
parameter_list|(
name|GimpPaintTool
modifier|*
