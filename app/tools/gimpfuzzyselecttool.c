...
name|threshold
decl_stmt|;
comment|/*  threshold value for soft seed fill     */
DECL|member|op
name|int
name|op
decl_stmt|;
...
argument_list|()
expr_stmt|;
comment|/*  adapt the threshold based on the final value of this use  */
name|default_threshold
operator|=
name|fuzzy_sel
operator|->
...
begin_comment
comment|/*  The fuzzy_select procedure definition  */
end_comment

begin_decl_stmt
DECL|variable|fuzzy_select_args
name|ProcArg
name|fuzzy_select_args
index|[]
init|=
block|{
block|{
