...
specifier|static
name|void
name|gimp_fuzzy_select_tool_destroy
parameter_list|(
name|GtkObject
modifier|*
name|object
...
begin_function
name|void
DECL|function|gimp_fuzzy_select_tool_register (void)
...
begin_function
name|void
DECL|function|fuzzy_select (GimpImage * gimage,GimpDrawable * drawable,gint op,gboolean feather,gdouble feather_radius)
name|fuzzy_select
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|gimp_fuzzy_select_tool_destroy (GtkObject * object)
name|gimp_fuzzy_select_tool_destroy
parameter_list|(
name|GtkObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_fuzzy_select_tool_button_press (GimpTool * tool,GdkEventButton * bevent,GDisplay * gdisp)
name|gimp_fuzzy_select_tool_button_press
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_fuzzy_select_tool_button_release (GimpTool * tool,GdkEventButton * bevent,GDisplay * gdisp)
name|gimp_fuzzy_select_tool_button_release
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_fuzzy_select_tool_motion (GimpTool * tool,GdkEventMotion * mevent,GDisplay * gdisp)
name|gimp_fuzzy_select_tool_motion
parameter_list|(
name|GimpTool
modifier|*
...
name|GdkSegment
modifier|*
DECL|function|fuzzy_select_calculate (GimpFuzzySelectTool * fuzzy_sel,GDisplay * gdisp,gint * nsegs)
name|fuzzy_select_calculate
parameter_list|(
name|GimpFuzzySelectTool
modifier|*
