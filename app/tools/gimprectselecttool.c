...
name|SelectionOptions
modifier|*
DECL|function|create_selection_options (ToolType tool_type,ToolOptionsResetFunc reset_func)
...
begin_function
name|void
DECL|function|reset_selection_options (SelectionOptions * options)
...
specifier|static
name|void
DECL|function|rect_select_reset_options ()
name|rect_select_reset_options
parameter_list|()
block|{
name|reset_selection_options
argument_list|(
