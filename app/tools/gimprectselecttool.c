...
operator|)
expr_stmt|;
comment|/* This is probably an inefficient way to do it, but it gives            * nicer, more predictable results than the original algorithm            */
if|if
condition|(
operator|(
name|abs
...
begin_function
name|void
DECL|function|gimp_rect_select_tool_coords_to_integer (GimpDisplay * gdisp,gdouble x,gdouble y,gdouble w,gdouble h,gint * ix,gint * iy,gint * iw,gint * ih)
name|gimp_rect_select_tool_coords_to_integer
parameter_list|(
name|GimpDisplay
modifier|*
