...
specifier|static
name|gboolean
DECL|function|gimp_tool_progress_button_press (GtkWidget * widget,const GdkEventButton * bevent,GimpTool * tool)
name|gimp_tool_progress_button_press
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gboolean
DECL|function|gimp_tool_progress_key_press (GtkWidget * widget,const GdkEventKey * kevent,GimpTool * tool)
name|gimp_tool_progress_key_press
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
name|GimpProgress
modifier|*
DECL|function|gimp_tool_progress_start (GimpProgress * progress,gboolean cancelable,const gchar * message)
name|gimp_tool_progress_start
parameter_list|(
name|GimpProgress
modifier|*
