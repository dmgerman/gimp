...
specifier|static
name|void
name|gimp_clone_tool_button_release
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
specifier|static
name|void
DECL|function|gimp_clone_tool_button_release (GimpTool * tool,GimpCoords * coords,guint32 time,GdkModifierType state,GimpDisplay * gdisp)
name|gimp_clone_tool_button_release
parameter_list|(
name|GimpTool
modifier|*
