...
name|void
modifier|*
DECL|function|clone_paint_func (PaintCore * paint_core,GimpDrawable * drawable,gint state)
...
begin_function
name|void
DECL|function|clone_cursor_update (Tool * tool,GdkEventMotion * mevent,gpointer gdisp_ptr)
...
begin_function
name|gboolean
DECL|function|clone_non_gui_default (GimpDrawable * drawable,int num_strokes,double * stroke_array)
