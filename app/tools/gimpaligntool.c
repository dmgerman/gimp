...
name|image
expr_stmt|;
comment|/* if nothing is selected, just return    * if only one object is selected, use the image as reference    * if multiple objects are selected, use the first one as reference    */
if|if
condition|(
name|g_list_length
argument_list|(
