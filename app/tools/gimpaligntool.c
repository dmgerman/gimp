...
operator|++
expr_stmt|;
comment|/* horizontal arrange row */
name|col
operator|=
literal|1
expr_stmt|;
...
name|_
argument_list|(
literal|"Arrange left edges of targets"
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
name|_
argument_list|(
literal|"Arrange horiz centers of targets"
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
name|_
argument_list|(
literal|"Arrange right edges of targets"
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
name|_
argument_list|(
literal|"Arrange top edges of targets"
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
name|_
argument_list|(
literal|"Arrange vertical centers of targets"
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
name|_
argument_list|(
literal|"Arrange bottoms of targets"
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
break|break;
block|}
comment|/* if nothing is selected, just return    * if only one object is selected, use the image as reference    * if multiple objects are selected, use the first one as reference if    * "set_reference" is TRUE, otherwise use NULL.    */
if|if
condition|(
name|g_list_length
argument_list|(
