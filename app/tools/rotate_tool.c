...
name|TileManager
modifier|*
DECL|function|rotate_tool_transform (Tool * tool,GDisplay * gdisp,TransformState state)
name|rotate_tool_transform
parameter_list|(
name|Tool
modifier|*
...
specifier|static
name|void
DECL|function|rotate_tool_motion (Tool * tool,GDisplay * gdisp)
name|rotate_tool_motion
parameter_list|(
name|Tool
modifier|*
...
specifier|static
name|void
DECL|function|rotate_tool_recalc (Tool * tool,GDisplay * gdisp)
name|rotate_tool_recalc
parameter_list|(
name|Tool
modifier|*
