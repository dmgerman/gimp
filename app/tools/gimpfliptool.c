...
specifier|static
name|gboolean
name|gimp_flip_tool_initialize
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
name|GimpDisplay
modifier|*
DECL|function|gimp_flip_tool_has_image (GimpTool * tool,GimpImage * image)
name|gimp_flip_tool_has_image
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_flip_tool_initialize (GimpTool * tool,GimpDisplay * display,GError ** error)
name|gimp_flip_tool_initialize
parameter_list|(
name|GimpTool
modifier|*
...
argument_list|)
decl_stmt|;
comment|/* let GimpTransformTool take control over the draw tool while it's active */
if|if
condition|(
