...
specifier|static
name|void
DECL|function|gimp_unified_transform_tool_recalc_matrix (GimpTransformGridTool * tg_tool,GimpToolWidget * widget)
name|gimp_unified_transform_tool_recalc_matrix
parameter_list|(
name|GimpTransformGridTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_unified_transform_tool_widget_changed (GimpToolWidget * widget,GimpTransformGridTool * tg_tool)
name|gimp_unified_transform_tool_widget_changed
parameter_list|(
name|GimpToolWidget
modifier|*
