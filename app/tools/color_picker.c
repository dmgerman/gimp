...
decl_stmt|;
DECL|member|average_radius_box
name|GtkWidget
modifier|*
name|average_radius_box
decl_stmt|;
...
specifier|static
name|void
DECL|function|color_picker_scale_update (GtkAdjustment * adjustment,double * scale_val)
name|color_picker_scale_update
parameter_list|(
name|GtkAdjustment
modifier|*
name|adjustment
