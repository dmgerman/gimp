...
specifier|static
name|gboolean
DECL|function|gimp_filter_tool_pick_color (GimpColorTool * color_tool,gint x,gint y,const Babl ** sample_format,gpointer pixel,GimpRGB * color)
name|gimp_filter_tool_pick_color
parameter_list|(
name|GimpColorTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_filter_tool_color_picked (GimpColorTool * color_tool,GimpColorPickState pick_state,gdouble x,gdouble y,const Babl * sample_format,gpointer pixel,const GimpRGB * color)
name|gimp_filter_tool_color_picked
parameter_list|(
name|GimpColorTool
modifier|*
