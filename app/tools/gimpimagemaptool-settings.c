...
specifier|static
name|gboolean
name|gimp_image_map_tool_menu_press
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_menu_position (GtkMenu * menu,gint * x,gint * y,gboolean * push_in,gpointer user_data)
name|gimp_image_map_tool_menu_position
parameter_list|(
name|GtkMenu
modifier|*
name|menu
...
specifier|static
name|gboolean
DECL|function|gimp_image_map_tool_menu_press (GtkWidget * widget,GdkEventButton * bevent,GimpImageMapTool * tool)
name|gimp_image_map_tool_menu_press
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_map_tool_favorite_activate (GtkWidget * widget,GimpImageMapTool * tool)
name|gimp_image_map_tool_favorite_activate
parameter_list|(
name|GtkWidget
modifier|*
