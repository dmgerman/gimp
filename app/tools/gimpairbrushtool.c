...
specifier|static
name|void
name|gimp_airbrush_tool_airbrush_timeout
parameter_list|(
name|GimpAirbrush
modifier|*
name|airbrush
...
specifier|static
name|void
DECL|function|gimp_airbrush_tool_airbrush_timeout (GimpAirbrush * airbrush,GimpAirbrushTool * airbrush_tool)
name|gimp_airbrush_tool_airbrush_timeout
parameter_list|(
name|GimpAirbrush
modifier|*
...
parameter_list|)
block|{
name|gimp_paint_tool_paint_core_paint
argument_list|(
name|GIMP_PAINT_TOOL
argument_list|(
name|airbrush_tool
