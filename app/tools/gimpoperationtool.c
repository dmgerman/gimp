...
specifier|static
name|void
DECL|function|gimp_operation_tool_color_picked (GimpImageMapTool * im_tool,gpointer identifier,const Babl * sample_format,const GimpRGB * color)
name|gimp_operation_tool_color_picked
parameter_list|(
name|GimpImageMapTool
modifier|*
...
begin_function
name|void
DECL|function|gimp_operation_tool_set_operation (GimpOperationTool * tool,const gchar * operation,const gchar * dialog_desc)
