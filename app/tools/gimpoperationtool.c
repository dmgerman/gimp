...
name|GtkWidget
modifier|*
DECL|function|gimp_operation_tool_get_settings_ui (GimpFilterTool * filter_tool,GimpContainer * settings,const gchar * import_dialog_title,const gchar * export_dialog_title,const gchar * file_dialog_help_id,GFile * default_folder,GtkWidget ** settings_box)
name|gimp_operation_tool_get_settings_ui
parameter_list|(
name|GimpFilterTool
modifier|*
