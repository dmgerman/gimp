...
argument_list|)
expr_stmt|;
comment|/* set cursor depending work mode */
if|if
condition|(
...
argument_list|)
expr_stmt|;
comment|/*combo = gimp_prop_enum_combo_box_new (config, "align-mode", 0, 0);   gimp_table_attach_aligned (GTK_TABLE (table), 0, 0,                              _("Alignment:"), 0.0, 0.5,                              combo, 1, FALSE);   */
name|frame
operator|=
name|gimp_prop_enum_radio_frame_new
argument_list|(
