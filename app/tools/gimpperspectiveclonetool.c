...
specifier|static
name|void
DECL|function|gimp_perspective_clone_tool_button_release (GimpTool * tool,GimpCoords * coords,guint32 time,GdkModifierType state,GimpButtonReleaseType release_type,GimpDisplay * display)
name|gimp_perspective_clone_tool_button_release
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_perspective_clone_tool_mode_notify (GObject * config,GParamSpec * pspec,GimpPerspectiveCloneTool * clone_tool)
name|gimp_perspective_clone_tool_mode_notify
parameter_list|(
name|GObject
modifier|*
...
block|g_printerr ("%f\t",   (clone_tool->transform).coeff[0][0]);       g_printerr ("%f\t",   (clone_tool->transform).coeff[0][1]);       g_printerr ("%f\n",   (clone_tool->transform).coeff[0][2]);       g_printerr ("%f\t",   (clone_tool->transform).coeff[1][0]);       g_printerr ("%f\t",   (clone_tool->transform).coeff[1][1]);       g_printerr ("%f\n",   (clone_tool->transform).coeff[1][2]);       g_printerr ("%f\t",   (clone_tool->transform).coeff[2][0]);       g_printerr ("%f\t",   (clone_tool->transform).coeff[2][1]);       g_printerr ("%f\n\n", (clone_tool->transform).coeff[2][2]);
endif|#
directive|endif
block|}
else|else
