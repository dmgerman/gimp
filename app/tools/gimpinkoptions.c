...
name|PROP_SIZE
block|,
DECL|enumerator|PROP_SENSITIVITY
name|PROP_SENSITIVITY
block|,
...
specifier|static
name|void
DECL|function|gimp_ink_options_notify (GimpInkOptions * options,GParamSpec * pspec,BrushWidget * brush_w)
name|gimp_ink_options_notify
parameter_list|(
name|GimpInkOptions
modifier|*
