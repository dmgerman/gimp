...
specifier|static
name|gboolean
DECL|function|gimp_vector_tool_on_handle (GimpTool * tool,GimpVectors * vectors,GimpCoords * coords,GimpAnchorType preferred,GimpDisplay * gdisp,GimpAnchor ** ret_anchor,GimpStroke ** ret_stroke)
name|gimp_vector_tool_on_handle
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_vector_tool_on_curve (GimpTool * tool,GimpVectors * vectors,GimpCoords * coord,GimpDisplay * gdisp,GimpCoords * ret_coords,gdouble * ret_pos,GimpAnchor ** ret_segment_start,GimpStroke ** ret_stroke)
name|gimp_vector_tool_on_curve
parameter_list|(
name|GimpTool
modifier|*
...
expr_stmt|;
block|}
comment|/* if not, are we hovering any visible vectors on any display? */
if|if
condition|(
operator|!
name|on_handle
...
condition|)
block|{
comment|/* we *are* hovering a visible vectors on some display */
name|select_vectors
operator|=
name|vectors
expr_stmt|;
