...
specifier|static
name|void
name|gimp_rectangle_select_tool_options_notify
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
expr_stmt|;
block|}
comment|/* Don't commit a zero-size rectangle, it would look like a        * click to commit() and that could anchor the floating        * selection or do other evil things. Instead, simply cancel a        * zero-size rectangle. See bug #796073.        */
if|if
condition|(
name|zero_rect
condition|)
...
specifier|static
name|void
DECL|function|gimp_rectangle_select_tool_options_notify (GimpTool * tool,GimpToolOptions * options,const GParamSpec * pspec)
name|gimp_rectangle_select_tool_options_notify
parameter_list|(
name|GimpTool
modifier|*
...
condition|)
block|{
comment|/*  if there are no extents, we got here because of a              *  click, call commit() directly because we might want to              *  reconfigure the rectangle and continue, instead of              *  HALTing it like calling COMMIT would do              */
name|gimp_rectangle_select_tool_commit
argument_list|(
name|rect_tool
argument_list|)
...
condition|)
block|{
comment|/*  if there still is no rectangle after the                  *  tool_commit(), the click was outside the selection                  *  and we HALT to get rid of a zero-size tool widget.                  */
name|gimp_tool_control
argument_list|(
name|tool
argument_list|,
...
specifier|static
name|void
DECL|function|gimp_rectangle_select_tool_update (GimpRectangleSelectTool * rect_tool)
name|gimp_rectangle_select_tool_update
parameter_list|(
name|GimpRectangleSelectTool
modifier|*
