...
typedef|typedef
struct|struct
DECL|struct|__anon27d5fe600108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon27d5fe600208
block|{
DECL|member|curve_count
name|CountCurves
name|curve_count
...
typedef|typedef
struct|struct
DECL|struct|__anon27d5fe600308
block|{
DECL|member|curve_count
name|CountCurves
name|curve_count
...
specifier|static
name|void
DECL|function|bezier_select_options_reset (void)
...
name|Tool
modifier|*
DECL|function|tools_new_bezier_select (void)
...
begin_function
name|gint
DECL|function|bezier_select_load (GDisplay * gdisp,BezierPoint * pts,gint num_pts,gint closed)
...
begin_function
name|void
DECL|function|bezier_draw_curve (BezierSelect * bezier_sel,BezierPointsFunc func,gint coord,gpointer data)
name|bezier_draw_curve
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|gboolean
DECL|function|bezier_edit_point_on_curve (gint x,gint y,gint halfwidth,GDisplay * gdisp,BezierSelect * bezier_sel,Tool * tool,GdkEventButton * bevent)
...
specifier|static
name|gboolean
DECL|function|bezier_add_point_on_segment (gint x,gint y,gint halfwidth,GDisplay * gdisp,BezierSelect * bezier_sel,Tool * tool)
...
specifier|static
name|void
DECL|function|bezier_select_button_press (Tool * tool,GdkEventButton * bevent,GDisplay * gdisp)
name|bezier_select_button_press
parameter_list|(
name|Tool
modifier|*
...
name|BEZIER_ADD
expr_stmt|;
comment|/*bezier_sel->draw = BEZIER_DRAW_CURVE; | BEZIER_DRAW_HANDLES;*/
name|bezier_sel
operator|->
name|draw
operator|=
...
specifier|static
name|void
DECL|function|bezier_select_button_release (Tool * tool,GdkEventButton * bevent,GDisplay * gdisp)
name|bezier_select_button_release
parameter_list|(
name|Tool
modifier|*
...
specifier|static
name|void
DECL|function|bezier_check_points (BezierSelect * bezier_sel,GdkPoint * points,gint n_points,gpointer data)
...
specifier|static
name|void
DECL|function|bezier_select_cursor_update (Tool * tool,GdkEventMotion * mevent,GDisplay * gdisp)
name|bezier_select_cursor_update
parameter_list|(
name|Tool
modifier|*
...
specifier|static
name|void
DECL|function|bezier_select_control (Tool * tool,ToolAction action,GDisplay * gdisp)
name|bezier_select_control
parameter_list|(
name|Tool
modifier|*
...
begin_function
name|void
DECL|function|bezier_add_point (BezierSelect * bezier_sel,gint type,gdouble x,gdouble y)
name|bezier_add_point
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|void
DECL|function|bezier_offset_point (BezierPoint * pt,gint x,gint y)
name|bezier_offset_point
parameter_list|(
name|BezierPoint
modifier|*
...
specifier|static
name|int
DECL|function|bezier_check_point (BezierPoint * pt,gint x,gint y,gint halfwidth)
name|bezier_check_point
parameter_list|(
name|BezierPoint
modifier|*
...
specifier|static
name|void
DECL|function|bezier_draw_handles (BezierSelect * bezier_sel,gboolean do_all)
name|bezier_draw_handles
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|void
DECL|function|bezier_draw_point (BezierSelect * bezier_sel,BezierPoint * pt,gboolean fill)
name|bezier_draw_point
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|void
DECL|function|bezier_draw_segment (BezierSelect * bezier_sel,BezierPoint * points,gint subdivisions,gint space,BezierPointsFunc points_func,gpointer data)
name|bezier_draw_segment
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|void
DECL|function|bezier_draw_segment_points (BezierSelect * bezier_sel,GdkPoint * points,gint n_points,gpointer data)
name|bezier_draw_segment_points
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|void
DECL|function|bezier_convert (BezierSelect * bezier_sel,GDisplay * gdisp,gint subdivisions,gboolean antialias)
name|bezier_convert
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|void
DECL|function|bezier_convert_points (BezierSelect * bezier_sel,GdkPoint * points,gint n_points,gpointer data)
name|bezier_convert_points
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|gboolean
DECL|function|test_add_point_on_segment (BezierSelect * bezier_sel,BezierPoint * pt,gint subdivisions,gint space,gint xpos,gint ypos,gint halfwidth)
name|test_add_point_on_segment
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|void
DECL|function|bezier_stack_points (BezierSelect * bezier_sel,GdkPoint * points,gint n_points,gpointer data)
name|bezier_stack_points
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|gint
DECL|function|bezier_gen_points (BezierSelect * bezier_sel,gint open_path,BezierRenderPnts * rpnts)
...
begin_function
name|void
DECL|function|bezier_stroke (BezierSelect * bezier_sel,GDisplay * gdisp,gint subdivisions,gint open_path)
name|bezier_stroke
parameter_list|(
name|BezierSelect
modifier|*
...
specifier|static
name|void
DECL|function|bezier_draw_segment_for_distance (BezierSelect * bezier_sel,BezierPoint * points,gint subdivisions,BezierDistance * bdist)
...
specifier|static
name|void
DECL|function|bezier_draw_curve_for_distance (BezierSelect * bezier_sel,BezierDistance * distance)
...
begin_function
name|gint
DECL|function|bezier_distance_along (BezierSelect * bezier_sel,gint open_path,gdouble dist,gint * x,gint * y,gdouble * gradient)
