...
block|{
comment|/* TempBuf clipping has occured on at least one edge...                   */
comment|/* Edge case: expand area under brush margin px on near edge(s), convolve */
comment|/* expanded buffers. copy src -> ovrsz1 convolve ovrsz1 -> ovrsz2         */
comment|/* copy-with-crop ovrsz2 -> dest                                          */
name|PixelRegion
name|ovrsz1PR
decl_stmt|;
name|PixelRegion
