...
name|constrain
decl_stmt|;
comment|/* constrain to image bounds       */
...
begin_function_decl
name|gboolean
name|gimp_rectangle_tool_get_constrain
parameter_list|(
name|GimpRectangleTool
modifier|*
name|tool
...
begin_function
name|void
DECL|function|gimp_rectangle_tool_set_constrain (GimpRectangleTool * tool,gboolean constrain)
...
begin_function
name|gboolean
DECL|function|gimp_rectangle_tool_get_constrain (GimpRectangleTool * tool)
name|gimp_rectangle_tool_get_constrain
parameter_list|(
name|GimpRectangleTool
modifier|*
