...
begin_comment
comment|/**  * gimp_rectangle_tool_pending_size_set_option:  * @width_property:  Option property to set to pending rectangle width.  * @height_property: Option property to set to pending rectangle height.  *  * Sets specified rectangle tool options properties to the width and  * height of the current pending rectangle.  */
end_comment
...
begin_comment
comment|/**  * gimp_rectangle_tool_constraint_size_set_option:  * @width_property:  Option property to set to current constraint width.  * @height_property: Option property to set to current constraint height.  *  * Sets specified rectangle tool options properties to the width and  * height of the current contraint size.  */
end_comment
