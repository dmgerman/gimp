...
comment|/* Holds the coordinate that should be                                        * used as the "other side" when modifier                                        * keys are released.                                        */
...
name|other_side_y
decl_stmt|;
comment|/* Holds the coordinate used as center                                          when fixed_center is used. */
...
specifier|static
name|void
name|gimp_rectangle_tool_get_fixed_center_coords
parameter_list|(
name|GimpRectangleTool
modifier|*
name|rectangle
...
specifier|static
name|void
DECL|function|gimp_rectangle_tool_get_fixed_center_coords (GimpRectangleTool * rectangle,gint * centerx,gint * centery)
name|gimp_rectangle_tool_get_fixed_center_coords
parameter_list|(
name|GimpRectangleTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_rectangle_tool_synthesize_motion (GimpRectangleTool * rectangle,gint function,gint startx,gint starty,GimpCoords * coords)
