...
name|g_printerr
argument_list|(
literal|"function is RECT_INACTIVE while mouse is moving; should not happen\n"
argument_list|)
expr_stmt|;
break|break;
case|case
...
argument_list|)
expr_stmt|;
comment|/* FIXME: why are we doing this instead of using x, y, w, h? */
name|g_object_get
argument_list|(
name|rectangle
argument_list|,
