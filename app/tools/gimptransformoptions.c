...
specifier|static
name|void
DECL|function|gimp_transform_options_preview_notify (GimpTransformOptions * options,GParamSpec * pspec,GtkWidget * box)
name|gimp_transform_options_preview_notify
parameter_list|(
name|GimpTransformOptions
modifier|*
...
specifier|static
name|void
DECL|function|gimp_transform_options_preview_opacity_notify (GimpTransformOptions * options,GParamSpec * pspec,GtkWidget * table)
name|gimp_transform_options_preview_opacity_notify
parameter_list|(
name|GimpTransformOptions
modifier|*
