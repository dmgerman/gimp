...
specifier|static
name|void
name|gimp_transform_options_notify
parameter_list|(
name|GimpTransformOptions
modifier|*
name|options
...
specifier|static
name|void
DECL|function|gimp_transform_options_notify (GimpTransformOptions * options,GParamSpec * pspec,GtkWidget * density_box)
name|gimp_transform_options_notify
parameter_list|(
name|GimpTransformOptions
modifier|*
...
directive|if
literal|0
block|gimp_transform_tool_show_path_changed (transform_tool, 1);
comment|/* pause */
block|gimp_toggle_button_update (widget,&options->show_path);            gimp_transform_tool_show_path_changed (transform_tool, 0);
comment|/* resume */
endif|#
directive|endif
block|}
