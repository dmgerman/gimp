...
begin_function
name|void
DECL|function|gimp_text_tool_register (void)
...
specifier|static
name|void
DECL|function|gimp_text_tool_destroy (GtkObject * object)
name|gimp_text_tool_destroy
parameter_list|(
name|GtkObject
modifier|*
...
name|TextOptions
modifier|*
DECL|function|text_tool_options_new (void)
name|text_tool_options_new
parameter_list|(
name|void
parameter_list|)
...
specifier|static
name|void
DECL|function|text_init_render (GimpTextTool * text_tool)
name|text_init_render
parameter_list|(
name|GimpTextTool
modifier|*
...
argument_list|(
literal|"%s(): Sanity check failed: could not get gdk image"
argument_list|,
...
name|gimp_fatal_error
argument_list|(
literal|"%s(): Sanity check failed: image should have 1 bit per pixel"
argument_list|,
name|G_GNUC_FUNCTION
argument_list|)
expr_stmt|;
