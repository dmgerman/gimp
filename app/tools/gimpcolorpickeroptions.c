...
begin_enum
enum|enum
DECL|enum|__anon2c95c16f0103
block|{
DECL|enumerator|PROP_0
name|PROP_0
block|,
DECL|enumerator|PROP_UPDATE_TOOLBOX
name|PROP_UPDATE_TOOLBOX
block|,
...
argument_list|)
expr_stmt|;
comment|/*  the update toolbox color toggle button  */
name|button
operator|=
name|gimp_prop_check_button_new
argument_list|(
