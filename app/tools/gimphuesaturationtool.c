...
specifier|static
name|void
name|gimp_hue_saturation_tool_constructed
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
DECL|function|gimp_hue_saturation_tool_constructed (GObject * object)
name|gimp_hue_saturation_tool_constructed
parameter_list|(
name|GObject
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_hue_saturation_tool_get_operation (GimpFilterTool * filter_tool,gchar ** title,gchar ** description,gchar ** undo_desc,gchar ** icon_name,gchar ** help_id,gboolean * has_settings,gchar ** settings_folder,gchar ** import_dialog_title,gchar ** export_dialog_title)
name|gimp_hue_saturation_tool_get_operation
parameter_list|(
name|GimpFilterTool
modifier|*
...
specifier|const
struct|struct
DECL|struct|__anon2b4ada950108
block|{
DECL|member|label
specifier|const
name|gchar
