...
specifier|static
name|void
DECL|function|hue_saturation_partition_callback (GtkWidget * widget,GimpHueSaturationTool * hs_tool)
name|hue_saturation_partition_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|hue_saturation_partition_reset_callback (GtkWidget * widget,GimpHueSaturationTool * hs_tool)
name|hue_saturation_partition_reset_callback
parameter_list|(
name|GtkWidget
modifier|*
