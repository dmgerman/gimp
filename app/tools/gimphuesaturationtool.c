...
name|GeglNode
modifier|*
DECL|function|gimp_hue_saturation_tool_get_operation (GimpImageMapTool * im_tool)
name|gimp_hue_saturation_tool_get_operation
parameter_list|(
name|GimpImageMapTool
modifier|*
...
specifier|const
struct|struct
DECL|struct|__anon279f40f90108
block|{
DECL|member|label
specifier|const
name|gchar
...
specifier|static
name|void
DECL|function|hue_saturation_update_sliders (GimpHueSaturationTool * hs_tool)
name|hue_saturation_update_sliders
parameter_list|(
name|GimpHueSaturationTool
modifier|*
