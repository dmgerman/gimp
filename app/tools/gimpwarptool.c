...
name|off_y
decl_stmt|;
comment|/* don't append the current point to the path if we're using the MOVE    * behavior, and the cursor didn't move since last time; it's a nop, and    * results in an unnecessary update.    */
if|if
condition|(
name|options
operator|->
