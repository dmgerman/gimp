...
include|#
directive|include
file|"tools/gimprotatetool.h"
end_include

begin_include
include|#
directive|include
file|"tools/gimpscaletool.h"
end_include

begin_include
include|#
directive|include
file|"tools/gimpsheartool.h"
end_include
...
specifier|static
name|void
name|gimp_transform_tool_change_type
parameter_list|(
name|GtkType
name|new_type
parameter_list|)
...
expr_stmt|;
comment|/* else     private->core = gimp_draw_tool_new (gimp_transform_tool_no_draw); */
block|}
end_function
...
ifdef|#
directive|ifdef
name|FIXME_I_DO_NOT_BELONG_HERE
if|if
condition|(
name|tool
operator|->
...
begin_comment
comment|/* FIXME Do we still want to do this this way?  Perhaps we should make separate icons for each tool. */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_transform_tool_type_callback (GtkWidget * widget,gpointer data)
name|gimp_transform_tool_type_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_comment
comment|/* FIXME!!! I haven't tested this code.  It might be horribly broken! */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_transform_tool_change_type (GtkType new_type)
name|gimp_transform_tool_change_type
parameter_list|(
name|GtkType
name|new_type
