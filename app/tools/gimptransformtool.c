...
name|TileManager
modifier|*
DECL|function|gimp_transform_tool_transform_tiles (GimpTransformTool * tr_tool,const gchar * progress_text)
...
begin_function
name|void
DECL|function|gimp_transform_tool_grid_density_changed (GimpTransformTool * tr_tool)
...
begin_function
name|void
DECL|function|gimp_transform_tool_show_path_changed (GimpTransformTool * tr_tool,gint type)
