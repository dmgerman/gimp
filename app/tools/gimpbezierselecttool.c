...
typedef|typedef
struct|struct
DECL|struct|__anon29f8629c0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29f8629c0208
block|{
DECL|member|curve_count
name|CountCurves
name|curve_count
...
typedef|typedef
struct|struct
DECL|struct|__anon29f8629c0308
block|{
DECL|member|curve_count
name|CountCurves
name|curve_count
...
specifier|static
name|void
DECL|function|gimp_bezier_select_tool_button_press (GimpTool * tool,GimpCoords * coords,guint32 time,GdkModifierType state,GimpDisplay * gdisp)
name|gimp_bezier_select_tool_button_press
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_bezier_select_tool_button_release (GimpTool * tool,GimpCoords * coords,guint32 time,GdkModifierType state,GimpDisplay * gdisp)
name|gimp_bezier_select_tool_button_release
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_bezier_select_tool_motion (GimpTool * tool,GimpCoords * coords,guint32 time,GdkModifierType state,GimpDisplay * gdisp)
name|gimp_bezier_select_tool_motion
parameter_list|(
name|GimpTool
modifier|*
...
condition|)
block|{
comment|/* the control key is down ... move the current anchor point        * we must also move the neighboring control points appropriately        */
name|offsetx
operator|=
name|coords
operator|->
...
argument_list|)
expr_stmt|;
comment|/* if the shift key is not down then we align the opposite control        * point...ie the opposite control point acts like a mirror of the        * current control point        */
if|if
condition|(
operator|!
operator|(
...
specifier|static
name|gboolean
DECL|function|bezier_edit_point_on_curve (gint x,gint y,gint halfwidth,gint halfheight,GimpDisplay * gdisp,GimpBezierSelectTool * bezier_sel,GimpTool * tool,GdkModifierType state)
name|bezier_edit_point_on_curve
parameter_list|(
name|gint
name|x
...
specifier|static
name|gboolean
DECL|function|bezier_add_point_on_segment (gint x,gint y,gint halfwidth,gint halfheight,GimpDisplay * gdisp,GimpBezierSelectTool * bezier_sel,GimpTool * tool)
name|bezier_add_point_on_segment
parameter_list|(
name|gint
name|x
...
specifier|static
name|gint
DECL|function|bezier_on_control_point (GimpDisplay * gdisp,GimpBezierSelectTool * bezier_sel,gint x,gint y,gint halfwidth,gint halfheight)
...
specifier|static
name|gint
DECL|function|bezier_point_on_curve (GimpDisplay * gdisp,GimpBezierSelectTool * bezier_sel,gint x,gint y,gint halfwidth,gint halfheight)
...
specifier|static
name|void
DECL|function|gimp_bezier_select_tool_cursor_update (GimpTool * tool,GimpCoords * coords,GdkModifierType state,GimpDisplay * gdisp)
name|gimp_bezier_select_tool_cursor_update
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|int
DECL|function|bezier_check_point (GimpBezierSelectPoint * pt,gint x,gint y,gint halfwidth,gint halfheight)
name|bezier_check_point
parameter_list|(
name|GimpBezierSelectPoint
modifier|*
...
specifier|static
name|gboolean
DECL|function|test_add_point_on_segment (GimpBezierSelectTool * bezier_sel,GimpBezierSelectPoint * pt,gint subdivisions,gint space,gint xpos,gint ypos,gint halfwidth,gint halfheight)
name|test_add_point_on_segment
parameter_list|(
name|GimpBezierSelectTool
modifier|*
