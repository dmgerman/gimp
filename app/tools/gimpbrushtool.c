...
specifier|static
name|void
DECL|function|gimp_brush_tool_motion (GimpTool * tool,GimpCoords * coords,guint32 time,GdkModifierType state,GimpDisplay * display)
name|gimp_brush_tool_motion
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_brush_tool_oper_update (GimpTool * tool,GimpCoords * coords,GdkModifierType state,gboolean proximity,GimpDisplay * display)
name|gimp_brush_tool_oper_update
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_brush_tool_cursor_update (GimpTool * tool,GimpCoords * coords,GdkModifierType state,GimpDisplay * display)
name|gimp_brush_tool_cursor_update
parameter_list|(
name|GimpTool
modifier|*
...
begin_function
name|void
DECL|function|gimp_brush_tool_draw_brush (GimpBrushTool * brush_tool,gdouble x,gdouble y)
name|gimp_brush_tool_draw_brush
parameter_list|(
name|GimpBrushTool
modifier|*
