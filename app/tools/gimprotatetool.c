...
begin_enum
enum|enum
DECL|enum|__anon2bf1964a0103
block|{
DECL|enumerator|ANGLE
name|ANGLE
block|,
DECL|enumerator|REAL_ANGLE
name|REAL_ANGLE
block|,
DECL|enumerator|CENTER_X
name|CENTER_X
block|,
DECL|enumerator|CENTER_Y
name|CENTER_Y
block|}
enum|;
end_enum
...
specifier|static
name|void
DECL|function|gimp_rotate_tool_motion (GimpTransformTool * tr_tool)
name|gimp_rotate_tool_motion
parameter_list|(
name|GimpTransformTool
modifier|*
