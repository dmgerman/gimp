...
specifier|static
name|void
name|gimp_histogram_options_scale_notify
parameter_list|(
name|GObject
modifier|*
name|src
...
begin_function
name|GType
DECL|function|gimp_histogram_options_get_type (void)
...
name|options
argument_list|,
literal|"notify::histogram-scale"
argument_list|,
name|G_CALLBACK
argument_list|(
name|gimp_histogram_options_scale_notify
...
specifier|static
name|void
DECL|function|gimp_histogram_options_scale_notify (GObject * src,GParamSpec * pspec,GObject * dest)
name|gimp_histogram_options_scale_notify
parameter_list|(
name|GObject
modifier|*
