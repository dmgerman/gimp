...
begin_comment
comment|/* #define DEBUG_ACTIVE_STATE 1 */
end_comment

begin_enum
enum|enum
DECL|enum|__anon2c4c057b0103
block|{
...
specifier|static
name|gboolean
name|gimp_tool_real_key_release
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
specifier|static
name|void
name|gimp_tool_real_options_notify
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
argument_list|,
argument|G_IMPLEMENT_INTERFACE (GIMP_TYPE_PROGRESS,                                                 gimp_tool_progress_iface_init)
argument_list|)
end_macro
...
specifier|static
name|void
DECL|function|gimp_tool_constructed (GObject * object)
name|gimp_tool_constructed
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_tool_dispose (GObject * object)
name|gimp_tool_dispose
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_tool_real_key_release (GimpTool * tool,GdkEventKey * kevent,GimpDisplay * display)
name|gimp_tool_real_key_release
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_tool_real_undo (GimpTool * tool,GimpDisplay * display)
name|gimp_tool_real_undo
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_tool_real_redo (GimpTool * tool,GimpDisplay * display)
name|gimp_tool_real_redo
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_tool_real_options_notify (GimpTool * tool,GimpToolOptions * options,const GParamSpec * pspec)
name|gimp_tool_real_options_notify
parameter_list|(
name|GimpTool
modifier|*
...
begin_function
name|void
DECL|function|gimp_tool_set_label (GimpTool * tool,const gchar * label)
name|gimp_tool_set_label
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
name|gchar
modifier|*
DECL|function|gimp_tool_get_label (GimpTool * tool)
...
begin_function
name|void
DECL|function|gimp_tool_set_undo_desc (GimpTool * tool,const gchar * undo_desc)
name|gimp_tool_set_undo_desc
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
name|gchar
modifier|*
DECL|function|gimp_tool_get_undo_desc (GimpTool * tool)
...
begin_function
name|void
DECL|function|gimp_tool_set_icon_name (GimpTool * tool,const gchar * icon_name)
name|gimp_tool_set_icon_name
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
name|gchar
modifier|*
DECL|function|gimp_tool_get_icon_name (GimpTool * tool)
...
begin_function
name|void
DECL|function|gimp_tool_set_help_id (GimpTool * tool,const gchar * help_id)
name|gimp_tool_set_help_id
parameter_list|(
name|GimpTool
modifier|*
name|tool
...
name|gchar
modifier|*
DECL|function|gimp_tool_get_help_id (GimpTool * tool)
...
begin_function
name|gboolean
DECL|function|gimp_tool_key_release (GimpTool * tool,GdkEventKey * kevent,GimpDisplay * display)
...
specifier|static
name|gboolean
DECL|function|state_changed (GdkModifierType old_state,GdkModifierType new_state,GdkModifierType modifier,gboolean * press)
name|state_changed
parameter_list|(
name|GdkModifierType
name|old_state
...
begin_function
name|gboolean
DECL|function|gimp_tool_undo (GimpTool * tool,GimpDisplay * display)
name|gimp_tool_undo
parameter_list|(
name|GimpTool
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_tool_redo (GimpTool * tool,GimpDisplay * display)
name|gimp_tool_redo
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_tool_options_notify (GimpToolOptions * options,const GParamSpec * pspec,GimpTool * tool)
name|gimp_tool_options_notify
parameter_list|(
name|GimpToolOptions
modifier|*
...
specifier|static
name|void
DECL|function|gimp_tool_release (GimpTool * tool)
name|gimp_tool_release
parameter_list|(
name|GimpTool
modifier|*
