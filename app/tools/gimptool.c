...
begin_function
name|void
DECL|function|gimp_tool_progress_start (GimpTool * tool,GimpDisplay * display,const gchar * text)
...
begin_function
name|void
DECL|function|gimp_tool_progress_set_value (GimpTool * tool,gdouble value)
...
begin_function
name|void
DECL|function|gimp_tool_progress_end (GimpTool * tool)
