...
name|GimpUIManager
modifier|*
DECL|function|gimp_tool_real_get_popup (GimpTool * tool,GimpCoords * coords,GdkModifierType state,GimpDisplay * display,const gchar ** ui_path)
name|gimp_tool_real_get_popup
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_tool_check_click_distance (GimpTool * tool,GimpCoords * coords,guint32 time,GimpDisplay * display)
...
name|GimpUIManager
modifier|*
DECL|function|gimp_tool_get_popup (GimpTool * tool,GimpCoords * coords,GdkModifierType state,GimpDisplay * display,const gchar ** ui_path)
