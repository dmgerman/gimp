...
specifier|static
name|gpointer
DECL|function|clone_paint_func (PaintCore * paint_core,GimpDrawable * drawable,PaintState state)
name|clone_paint_func
parameter_list|(
name|PaintCore
modifier|*
...
begin_function
name|void
DECL|function|clone_cursor_update (Tool * tool,GdkEventMotion * mevent,GDisplay * gdisp)
name|clone_cursor_update
parameter_list|(
name|Tool
modifier|*
name|tool
...
name|Tool
modifier|*
DECL|function|tools_new_clone (void)
...
argument_list|)
expr_stmt|;
comment|/* the clone tool provides its own cursor_update_function       until I figure out somethinh nicer -- Sven  */
name|tool
operator|->
...
specifier|static
name|gpointer
DECL|function|clone_non_gui_paint_func (PaintCore * paint_core,GimpDrawable * drawable,PaintState state)
...
begin_function
name|gboolean
DECL|function|clone_non_gui_default (GimpDrawable * drawable,gint num_strokes,gdouble * stroke_array)
...
begin_function
name|gboolean
DECL|function|clone_non_gui (GimpDrawable * drawable,GimpDrawable * src_drawable,CloneType clone_type,gdouble src_x,gdouble src_y,gint num_strokes,gdouble * stroke_array)
name|clone_non_gui
parameter_list|(
name|GimpDrawable
modifier|*
