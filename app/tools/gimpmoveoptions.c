...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpMoveOptions,gimp_move_options,GIMP_TYPE_TOOL_OPTIONS)
name|G_DEFINE_TYPE
argument_list|(
argument|GimpMoveOptions
argument_list|,
argument|gimp_move_options
argument_list|,
...
break|break;
default|default:
comment|/* GIMP_TRANSFORM_TYPE_SELECTION */
