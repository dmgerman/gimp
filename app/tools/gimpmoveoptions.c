...
block|,
DECL|enumerator|PROP_CHANGE_ACTIVE
name|PROP_CHANGE_ACTIVE
block|}
enum|;
end_enum
...
begin_function
name|GType
DECL|function|gimp_move_options_get_type (void)
...
name|_
argument_list|(
literal|"Change the active layer"
argument_list|)
expr_stmt|;
break|break;
case|case
...
name|_
argument_list|(
literal|"Change the active path"
argument_list|)
expr_stmt|;
break|break;
block|}
