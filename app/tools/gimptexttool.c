...
begin_function_decl
name|void
name|gimp_text_tool_buffer_tagged
parameter_list|(
name|GtkTextBuffer
modifier|*
name|buffer
...
begin_function
name|void
DECL|function|gimp_text_tool_buffer_tagged (GtkTextBuffer * buffer,GtkTextTag * tag,GtkTextIter * start,GtkTextIter * end,GimpTextTool * text_tool)
name|gimp_text_tool_buffer_tagged
parameter_list|(
name|GtkTextBuffer
modifier|*
