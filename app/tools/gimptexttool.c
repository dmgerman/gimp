...
argument_list|)
expr_stmt|;
comment|/*   if (text_tool->text) */
comment|/*     gtk_text_buffer_set_text (text_tool->text_buffer, */
comment|/*                               text_tool->text->text, -1); */
comment|/*   else */
comment|/*     gtk_text_buffer_set_text (text_tool->text_buffer, "", -1); */
block|}
end_function
...
block|{
comment|/* user has modified shape of an existing text layer */
name|gimp_draw_tool_pause
argument_list|(
name|GIMP_DRAW_TOOL
argument_list|(
