...
specifier|static
name|void
name|gimp_text_tool_constructed
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
name|gimp_text_tool_rectangle_response
parameter_list|(
...
specifier|static
name|void
name|gimp_text_tool_fonts_async_set_empty_notify
parameter_list|(
name|GimpAsyncSet
modifier|*
name|async_set
...
specifier|static
name|void
name|gimp_text_tool_buffer_color_applied
parameter_list|(
name|GimpTextBuffer
modifier|*
name|buffer
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpTextTool,gimp_text_tool,GIMP_TYPE_DRAW_TOOL)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_text_tool_constructed (GObject * object)
name|gimp_text_tool_constructed
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_text_tool_remove_empty_text_layer (GimpTextTool * text_tool)
...
argument_list|)
expr_stmt|;
comment|/* clicking anywhere while a preedit is going on aborts the        * preedit, this is ugly but at least leaves everything in        * a consistent state        */
if|if
condition|(
name|text_tool
operator|->
...
condition|)
block|{
comment|/*  user has canceled the rectangle resizing, fall through        *  and let the rectangle handle restoring the previous size        */
block|}
else|else
block|{
name|gdouble
...
specifier|static
name|gboolean
DECL|function|gimp_text_tool_start (GimpTextTool * text_tool,GimpDisplay * display,GimpLayer * layer,GError ** error)
name|gimp_text_tool_start
parameter_list|(
name|GimpTextTool
modifier|*
...
name|_
argument_list|(
literal|"Fonts are still loading"
argument_list|)
argument_list|)
expr_stmt|;
return|return
...
specifier|static
name|void
DECL|function|gimp_text_tool_rectangle_response (GimpToolRectangle * rectangle,gint response_id,GimpTextTool * text_tool)
name|gimp_text_tool_rectangle_response
parameter_list|(
name|GimpToolRectangle
modifier|*
...
argument_list|)
decl_stmt|;
comment|/* this happens when a newly created rectangle gets canceled,    * we have to shut down the tool    */
if|if
condition|(
name|response_id
operator|==
...
specifier|static
name|void
DECL|function|gimp_text_tool_rectangle_change_complete (GimpToolRectangle * rectangle,GimpTextTool * text_tool)
name|gimp_text_tool_rectangle_change_complete
parameter_list|(
name|GimpToolRectangle
modifier|*
...
condition|)
block|{
comment|/* if there is a preedit going on, don't queue pending            * changes to be idle-applied with undo; instead, flush the            * pending queue (happens only when preedit starts), and            * apply the changes to text_tool->text directly. Preedit            * will *always* end by removing the preedit string, and if            * the preedit was committed, it will insert the resulting            * text, which will not trigger this if() any more.            */
name|GList
modifier|*
name|list
init|=
name|NULL
decl_stmt|;
comment|/* if there are pending changes, apply them before applying            * preedit stuff directly (bypassing undo)            */
if|if
condition|(
name|text_tool
operator|->
...
argument_list|)
expr_stmt|;
comment|/* an undo cancels all preedit operations */
if|if
condition|(
name|text_tool
operator|->
...
specifier|static
name|void
DECL|function|gimp_text_tool_fonts_async_set_empty_notify (GimpAsyncSet * async_set,GParamSpec * pspec,GimpTextTool * text_tool)
name|gimp_text_tool_fonts_async_set_empty_notify
parameter_list|(
name|GimpAsyncSet
modifier|*
...
specifier|static
name|void
DECL|function|gimp_text_tool_apply_list (GimpTextTool * text_tool,GList * pspecs)
name|gimp_text_tool_apply_list
parameter_list|(
name|GimpTextTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_text_tool_buffer_color_applied (GimpTextBuffer * buffer,const GimpRGB * color,GimpTextTool * text_tool)
name|gimp_text_tool_buffer_color_applied
parameter_list|(
name|GimpTextBuffer
modifier|*
...
begin_function
name|GimpTextDirection
DECL|function|gimp_text_tool_get_direction (GimpTextTool * text_tool)
name|gimp_text_tool_get_direction
parameter_list|(
name|GimpTextTool
modifier|*
