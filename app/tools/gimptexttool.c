...
name|MOVE_CURSOR
block|,
DECL|enumerator|DELETE_FROM_CURSOR
name|DELETE_FROM_CURSOR
block|,
DECL|enumerator|BACKSPACE
name|BACKSPACE
block|,
...
name|NULL
argument_list|,
name|gimp_marshal_VOID__ENUM_INT_BOOLEAN
argument_list|,
name|G_TYPE_NONE
argument_list|,
literal|3
...
name|NULL
argument_list|,
name|gimp_marshal_VOID__ENUM_INT
argument_list|,
name|G_TYPE_NONE
argument_list|,
literal|2
...
directive|ifdef
name|TEXT_TOOL_HACK
comment|/*  we need this crap because we need some object to call    *  gtk_binding_set_activate() with. It takes a GtkObject instead of    *  a GObject. So instead of adding the needed binding signals to    *  GimpTextTool, we abuse a GtkTextView, which has all the needed    *  signals anyway, and connect to its signals. Puke!    */
block|{
name|GtkTextBuffer
modifier|*
name|dummy
...
name|GTK_OBJECT
argument_list|(
argument|text_tool->proxy_text_view
argument_list|)
else|#
directive|else
operator|(
...
specifier|static
name|void
DECL|function|gimp_text_tool_move_cursor (GimpTextTool * text_tool,GtkMovementStep step,gint count,gboolean extend_selection,GtkTextView * proxy)
name|gimp_text_tool_move_cursor
parameter_list|(
name|GimpTextTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_text_tool_delete_from_cursor (GimpTextTool * text_tool,GtkDeleteType type,gint count,GtkTextView * proxy)
name|gimp_text_tool_delete_from_cursor
parameter_list|(
name|GimpTextTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_text_tool_backspace (GimpTextTool * text_tool,GtkTextView * proxy)
name|gimp_text_tool_backspace
parameter_list|(
name|GimpTextTool
modifier|*
