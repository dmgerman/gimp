...
condition|)
block|{
comment|/*  when selecting words or lines, we always keep the                *  cursor at the start and the selection mark at the                *  end of the selection                */
if|if
condition|(
name|offset
operator|<
