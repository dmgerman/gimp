...
argument_list|)
expr_stmt|;
comment|/*  the text tool works on layers only  */
if|if
condition|(
operator|!
name|GIMP_IS_LAYER
...
name|offset_y
expr_stmt|;
comment|/*  if a layer is clicked, attempt to attach to it  */
if|if
condition|(
name|coords
operator|->
...
argument_list|)
expr_stmt|;
comment|/*  if we were attached and are still, open the text editor  */
if|if
condition|(
name|text_tool
operator|->
...
name|g_printerr
argument_list|(
literal|"gimp_text_tool_connect (%p)\n"
argument_list|,
name|text
argument_list|)
expr_stmt|;
...
name|g_printerr
argument_list|(
literal|"gimp_text_tool_set_layer (%p)\n"
argument_list|,
name|layer
argument_list|)
expr_stmt|;
