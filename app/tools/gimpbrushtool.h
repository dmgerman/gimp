...
name|boundary
decl_stmt|;
DECL|member|boundary_width
name|gint
name|boundary_width
decl_stmt|;
DECL|member|boundary_height
name|gint
name|boundary_height
decl_stmt|;
DECL|member|boundary_scale
name|gdouble
name|boundary_scale
decl_stmt|;
DECL|member|boundary_aspect_ratio
name|gdouble
name|boundary_aspect_ratio
decl_stmt|;
DECL|member|boundary_angle
name|gdouble
name|boundary_angle
decl_stmt|;
DECL|member|boundary_reflect
name|gboolean
name|boundary_reflect
decl_stmt|;
DECL|member|boundary_hardness
name|gdouble
name|boundary_hardness
decl_stmt|;
block|}
struct|;
end_struct
