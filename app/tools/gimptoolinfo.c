...
name|GimpToolInfo
modifier|*
DECL|function|gimp_tool_info_new (GtkType tool_type,const gchar * tool_name,const gchar * menu_path,const gchar * menu_accel,const gchar * tool_desc,const gchar * help_domain,const gchar * help_data,const gchar ** icon_data)
