...
name|GtkWidget
modifier|*
DECL|function|velocity_options_gui (GimpVelocityOptions * velocity,GimpPaintOptions * paint_options,GType tool_type)
name|velocity_options_gui
parameter_list|(
name|GimpVelocityOptions
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|random_options_gui (GimpRandomOptions * random,GimpPaintOptions * paint_options,GType tool_type)
name|random_options_gui
parameter_list|(
name|GimpRandomOptions
modifier|*
