...
name|GtkWidget
modifier|*
DECL|function|gimp_paint_options_gui_scale_with_reset_button (GtkWidget * parent,GObject * config,gchar * prop_name,gchar * prop_descr,gchar * reset_tooltip,gdouble minor_step,gdouble major_step,gdouble min,gdouble max,gdouble gamma,GCallback callback)
name|gimp_paint_options_gui_scale_with_reset_button
parameter_list|(
name|GtkWidget
modifier|*
