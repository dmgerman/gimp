...
name|GtkWidget
modifier|*
DECL|function|gimp_paint_options_gui_scale_with_reset_button (GObject * config,gchar * prop_name,gchar * prop_descr,gchar * reset_tooltip,gdouble step_increment,gdouble page_increment,gint digits,gdouble scale_min,gdouble scale_max,gdouble factor,gdouble gamma,GCallback reset_callback)
name|gimp_paint_options_gui_scale_with_reset_button
parameter_list|(
name|GObject
modifier|*
