...
begin_function
name|void
DECL|function|color_notebook_set_color (ColorNotebook * cnp,gint red,gint green,gint blue,gint alpha)
...
specifier|static
name|void
DECL|function|color_notebook_update_callback (gpointer data,gint hue,gint saturation,gint value,gint red,gint green,gint blue,gint alpha)
name|color_notebook_update_callback
parameter_list|(
name|gpointer
name|data
...
specifier|static
name|void
DECL|function|color_notebook_drag_new_color (GtkWidget * widget,guchar * r,guchar * g,guchar * b,guchar * a,gpointer data)
name|color_notebook_drag_new_color
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|color_notebook_drop_new_color (GtkWidget * widget,guchar r,guchar g,guchar b,guchar a,gpointer data)
name|color_notebook_drop_new_color
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|color_notebook_drag_old_color (GtkWidget * widget,guchar * r,guchar * g,guchar * b,guchar * a,gpointer data)
name|color_notebook_drag_old_color
parameter_list|(
name|GtkWidget
modifier|*
