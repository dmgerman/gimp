...
block|switch (gimage_base_type (gimage))     {     case RGB:       if (! gimage_get_component_visible (gimage, Red)&& 	  ! gimage_get_component_visible (gimage, Green)&& 	  ! gimage_get_component_visible (gimage, Blue)) 	return;       break;     case GRAY:       if (! gimage_get_component_visible (gimage, Gray)) 	return;       break;     case INDEXED:       if (! gimage_get_component_visible (gimage, Indexed)) 	return;       break;     }
endif|#
directive|endif
while|while
condition|(
...
name|Layer
modifier|*
DECL|function|gimage_merge_layers (GImage * gimage,GSList * merge_list,MergeType merge_type)
name|gimage_merge_layers
parameter_list|(
name|GImage
modifier|*
