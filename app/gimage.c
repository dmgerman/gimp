...
begin_function
name|void
DECL|function|gimage_apply_image (GImage * gimage,int drawable_id,PixelRegion * src2PR,int undo,int opacity,int mode,TileManager * src1_tiles,int x,int y)
...
begin_function
name|void
DECL|function|gimage_replace_image (GImage * gimage,int drawable_id,PixelRegion * src2PR,int undo,int opacity,PixelRegion * maskPR,int x,int y)
...
begin_function
name|void
DECL|function|gimage_get_foreground (GImage * gimage,int drawable_id,unsigned char * fg)
...
begin_function
name|void
DECL|function|gimage_get_background (GImage * gimage,int drawable_id,unsigned char * bg)
...
begin_function
name|void
DECL|function|gimage_transform_color (GImage * gimage,int drawable_id,unsigned char * src,unsigned char * dest,int type)
name|gimage_transform_color
parameter_list|(
name|GImage
modifier|*
...
specifier|static
name|void
DECL|function|gimage_get_active_channels (GImage * gimage,int drawable_id,int * active)
name|gimage_get_active_channels
parameter_list|(
name|GImage
modifier|*
...
begin_function
name|int
DECL|function|gimage_get_layer_index (GImage * gimage,int layer_ID)
...
begin_function
name|int
DECL|function|gimage_get_channel_index (GImage * gimage,int channel_ID)
...
name|Layer
modifier|*
DECL|function|gimage_set_active_layer (GImage * gimage,int layer_id)
...
name|Channel
modifier|*
DECL|function|gimage_set_active_channel (GImage * gimage,int channel_id)
...
begin_function
name|void
DECL|function|gimage_set_layer_mask_edit (GImage * gimage,int layer_id,int edit)
...
name|Layer
modifier|*
DECL|function|gimage_raise_layer (GImage * gimage,int layer_ID)
...
name|Layer
modifier|*
DECL|function|gimage_lower_layer (GImage * gimage,int layer_ID)
...
name|Layer
modifier|*
DECL|function|gimage_remove_layer (GImage * gimage,int layer_id)
name|gimage_remove_layer
parameter_list|(
name|GImage
modifier|*
...
name|Channel
modifier|*
DECL|function|gimage_add_layer_mask (GImage * gimage,int layer_id,int mask_id)
...
name|Channel
modifier|*
DECL|function|gimage_remove_layer_mask (GImage * gimage,int layer_id,int mode)
...
name|Channel
modifier|*
DECL|function|gimage_raise_channel (GImage * gimage,int channel_ID)
...
name|Channel
modifier|*
DECL|function|gimage_lower_channel (GImage * gimage,int channel_ID)
...
name|Channel
modifier|*
DECL|function|gimage_remove_channel (GImage * gimage,int channel_id)
