...
argument_list|)
expr_stmt|;
comment|/* height in pixels entry */
name|vals
operator|->
name|height_entry
operator|=
...
argument_list|)
expr_stmt|;
comment|/*  man this is lame, the unit stuff really needs to be in a struct */
name|printf
argument_list|(
literal|" vals unit is: %.2f\n"
argument_list|,
name|vals
operator|->
name|unit
...
argument_list|)
expr_stmt|;
comment|/* hbox containing the label, the entry, and the optionmenu */
name|hbox
operator|=
name|gtk_hbox_new
argument_list|(
