...
typedef|typedef
struct|struct
DECL|struct|__anon295028070308
block|{
DECL|member|shell
name|GtkWidget
modifier|*
...
struct|struct
DECL|struct|__anon295028070408
block|{
DECL|member|r
DECL|member|g
DECL|member|b
...
specifier|static
name|void
DECL|function|prev_fill_image (gint width,gint height,gdouble left,gdouble right)
name|prev_fill_image
parameter_list|(
name|gint
name|width
