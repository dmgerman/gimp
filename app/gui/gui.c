...
specifier|static
name|void
DECL|function|gui_add_to_app_menu (GimpUIManager * ui_manager,IgeMacMenuGroup * group,const gchar * action_path,const gchar * label)
...
directive|define
name|PREFERENCES
value|"/dummy-menubar/image-popup/Edit/Preferences/"
name|gui_add_to_app_menu
argument_list|(
name|image_ui_manager
argument_list|,
