...
specifier|static
name|void
name|gui_image_selection_control
parameter_list|(
name|GimpImage
modifier|*
name|gimage
...
begin_decl_stmt
DECL|variable|image_selection_control_handler_id
specifier|static
name|GQuark
name|image_selection_control_handler_id
init|=
literal|0
decl_stmt|;
end_decl_stmt
...
argument_list|)
expr_stmt|;
comment|/*  Fill the "last opened" menu items with the first last_opened_size    *  elements of gimp->documents    */
block|{
name|GimpImagefile
modifier|*
name|imagefile
...
specifier|static
name|void
DECL|function|gui_image_selection_control (GimpImage * gimage,GimpSelectionControl control,gpointer data)
name|gui_image_selection_control
parameter_list|(
name|GimpImage
modifier|*
