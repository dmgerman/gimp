...
begin_comment
comment|/* "class" information we keep on each registered color selector */
end_comment
...
begin_comment
comment|/* "instance" information we keep on each notebook tab */
end_comment
...
specifier|static
name|void
name|color_notebook_reset_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|color_notebook_reset_callback (GtkWidget * widget,gpointer data)
name|color_notebook_reset_callback
parameter_list|(
name|GtkWidget
modifier|*
...
directive|if
literal|0
block|g_print ("RGB: %d %d %d HSV: %d %d %d ALPHA: %d\n",  	   values[GIMP_COLOR_SELECTOR_RED], 	   values[GIMP_COLOR_SELECTOR_GREEN], 	   values[GIMP_COLOR_SELECTOR_BLUE], 	   values[GIMP_COLOR_SELECTOR_HUE], 	   values[GIMP_COLOR_SELECTOR_SATURATION], 	   values[GIMP_COLOR_SELECTOR_VALUE], 	   values[GIMP_COLOR_SELECTOR_ALPHA]);
endif|#
directive|endif
name|g_snprintf
argument_list|(
