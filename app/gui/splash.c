...
begin_define
DECL|macro|MEASURE_UPPER
define|#
directive|define
name|MEASURE_UPPER
value|"1235678901234567890"
end_define

begin_define
DECL|macro|MEASURE_LOWER
define|#
directive|define
name|MEASURE_LOWER
value|"12356789012345678901234567890"
end_define
...
name|GdkPixbufAnimation
modifier|*
name|splash_image_load_from_path
parameter_list|(
specifier|const
name|gchar
modifier|*
...
specifier|static
name|gboolean
DECL|function|splash_area_draw (GtkWidget * widget,cairo_t * cr,GimpSplash * splash)
name|splash_area_draw
parameter_list|(
name|GtkWidget
modifier|*
...
name|GdkPixbufAnimation
modifier|*
DECL|function|splash_image_load_from_path (const gchar * filename,gint max_width,gint max_height,gboolean be_verbose)
name|splash_image_load_from_path
parameter_list|(
specifier|const
name|gchar
...
name|GdkPixbufAnimation
modifier|*
DECL|function|splash_image_load_from_file (GFile * file,gint max_width,gint max_height,gboolean be_verbose)
name|splash_image_load_from_file
parameter_list|(
name|GFile
modifier|*
...
name|animation
operator|=
name|gdk_pixbuf_animation_new_from_stream
argument_list|(
name|G_INPUT_STREAM
argument_list|(
name|input
...
name|GdkPixbufAnimation
modifier|*
DECL|function|splash_image_pick_from_dirs (GList * dirs,gint max_width,gint max_height,gboolean be_verbose)
name|splash_image_pick_from_dirs
parameter_list|(
name|GList
modifier|*
