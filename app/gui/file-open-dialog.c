...
comment|/* Have to read the list before touching anything else */
name|toplist
operator|=
name|tvsel_to_slist
argument_list|(
...
specifier|static
name|void
DECL|function|tvsel_to_slist_helper (GtkTreeModel * model,GtkTreePath * path,GtkTreeIter * iter,gpointer data)
name|tvsel_to_slist_helper
parameter_list|(
name|GtkTreeModel
modifier|*
name|model
...
name|GSList
modifier|*
DECL|function|tvsel_to_slist (GtkTreeView * file_list)
name|tvsel_to_slist
parameter_list|(
name|GtkTreeView
modifier|*
