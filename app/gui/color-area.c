...
specifier|static
name|void
DECL|function|color_area_draw (GimpContext * context)
name|color_area_draw
parameter_list|(
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|color_area_select_callback (ColorNotebook * color_notebook,const GimpRGB * color,ColorNotebookState state,gpointer data)
name|color_area_select_callback
parameter_list|(
name|ColorNotebook
modifier|*
...
specifier|static
name|gint
DECL|function|color_area_events (GtkWidget * widget,GdkEvent * event,gpointer data)
name|color_area_events
parameter_list|(
name|GtkWidget
modifier|*
