...
name|GtkWidget
modifier|*
DECL|function|brush_dialog_create (Gimp * gimp)
...
name|BrushSelect
modifier|*
DECL|function|brush_select_new (Gimp * gimp,const gchar * title,const gchar * init_name,gdouble init_opacity,gint init_spacing,gint init_mode,const gchar * callback_name)
name|brush_select_new
parameter_list|(
name|Gimp
modifier|*
