...
name|gimage_id
decl_stmt|;
DECL|member|active_layer_id
name|int
name|active_layer_id
decl_stmt|;
DECL|member|active_channel_id
name|int
name|active_channel_id
decl_stmt|;
DECL|member|floating_sel_id
name|int
...
begin_function
name|void
DECL|function|lc_dialog_create (int gimage_id)
...
begin_function
name|void
DECL|function|layers_dialog_update (int gimage_id)
name|layers_dialog_update
parameter_list|(
name|int
name|gimage_id
...
specifier|static
name|void
DECL|function|layers_dialog_set_active_layer (int layer_ID)
name|layers_dialog_set_active_layer
parameter_list|(
name|int
name|layer_ID
...
specifier|static
name|void
DECL|function|layers_dialog_unset_layer (int layer_ID)
name|layers_dialog_unset_layer
parameter_list|(
name|int
name|layer_ID
...
specifier|static
name|void
DECL|function|layers_dialog_position_layer (int layer_ID,int new_index)
name|layers_dialog_position_layer
parameter_list|(
name|int
name|layer_ID
...
specifier|static
name|void
DECL|function|layers_dialog_add_layer (int layer_id)
name|layers_dialog_add_layer
parameter_list|(
name|int
name|layer_id
...
specifier|static
name|void
DECL|function|layers_dialog_remove_layer (int layer_ID)
name|layers_dialog_remove_layer
parameter_list|(
name|int
name|layer_ID
...
specifier|static
name|void
DECL|function|layers_dialog_add_layer_mask (int layer_id)
name|layers_dialog_add_layer_mask
parameter_list|(
name|int
name|layer_id
...
specifier|static
name|void
DECL|function|layers_dialog_remove_layer_mask (int layer_id)
name|layers_dialog_remove_layer_mask
parameter_list|(
name|int
name|layer_id
...
name|LayerWidget
modifier|*
DECL|function|layer_widget_get_ID (int ID)
name|layer_widget_get_ID
parameter_list|(
name|int
name|ID
...
specifier|static
name|void
DECL|function|layers_dialog_new_layer_query (int gimage_id)
name|layers_dialog_new_layer_query
parameter_list|(
name|int
name|gimage_id
...
begin_function
name|void
DECL|function|layers_dialog_add_mask_query (int layer_id)
name|layers_dialog_add_mask_query
parameter_list|(
name|int
name|layer_id
...
specifier|static
name|void
DECL|function|layers_dialog_apply_mask_query (int layer_id)
name|layers_dialog_apply_mask_query
parameter_list|(
name|int
name|layer_id
...
specifier|static
name|void
DECL|function|layers_dialog_scale_layer_query (int layer_id)
name|layers_dialog_scale_layer_query
parameter_list|(
name|int
name|layer_id
...
specifier|static
name|void
DECL|function|layers_dialog_resize_layer_query (int layer_id)
name|layers_dialog_resize_layer_query
parameter_list|(
name|int
name|layer_id
