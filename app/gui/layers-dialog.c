...
name|name_entry
decl_stmt|;
DECL|member|xsize_entry
name|GtkWidget
modifier|*
name|xsize_entry
decl_stmt|;
DECL|member|ysize_entry
name|GtkWidget
modifier|*
name|ysize_entry
decl_stmt|;
...
specifier|static
name|void
DECL|function|new_layer_background_callback (GtkWidget * w,gpointer client_data)
...
specifier|static
name|void
DECL|function|new_layer_transparent_callback (GtkWidget * w,gpointer client_data)
...
argument_list|)
expr_stmt|;
comment|/*  handle the wm close singal */
name|gtk_signal_connect
argument_list|(
name|GTK_OBJECT
argument_list|(
