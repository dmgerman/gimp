...
name|FontSelect
modifier|*
DECL|function|font_select_new (Gimp * gimp,GimpContext * context,const gchar * title,const gchar * initial_font,const gchar * callback_name)
...
specifier|static
name|void
DECL|function|font_select_response (GtkWidget * widget,gint response_id,FontSelect * font_select)
name|font_select_response
parameter_list|(
name|GtkWidget
modifier|*
