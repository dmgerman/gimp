...
literal|1
block|,
DECL|enumerator|HIDE_DOCKS
name|HIDE_DOCKS
block|,
DECL|enumerator|SINGLE_WINDOW_MODE
name|SINGLE_WINDOW_MODE
block|,
DECL|enumerator|TABS_POSITION
name|TABS_POSITION
block|,
DECL|enumerator|LAST_TIP_SHOWN
name|LAST_TIP_SHOWN
block|,
DECL|enumerator|ERROR_CONSOLE_HIGHLIGHT_ERROR
name|ERROR_CONSOLE_HIGHLIGHT_ERROR
block|,
DECL|enumerator|ERROR_CONSOLE_HIGHLIGHT_WARNING
name|ERROR_CONSOLE_HIGHLIGHT_WARNING
block|,
DECL|enumerator|ERROR_CONSOLE_HIGHLIGHT_INFO
name|ERROR_CONSOLE_HIGHLIGHT_INFO
block|}
enum|;
end_enum
...
name|GFile
modifier|*
DECL|function|session_file (Gimp * gimp)
name|session_file
parameter_list|(
name|Gimp
modifier|*
