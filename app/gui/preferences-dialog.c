...
begin_decl_stmt
DECL|variable|old_resize_windows_on_zoom
specifier|static
name|gboolean
name|old_resize_windows_on_zoom
decl_stmt|;
end_decl_stmt

begin_decl_stmt
DECL|variable|old_resize_windows_on_resize
specifier|static
name|gboolean
name|old_resize_windows_on_resize
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|old_default_comment
specifier|static
name|gchar
modifier|*
...
begin_decl_stmt
DECL|variable|old_tool_plug_in_path
specifier|static
name|gchar
modifier|*
name|old_tool_plug_in_path
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|old_image_status_format
specifier|static
name|gchar
modifier|*
name|old_image_status_format
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|old_cursor_mode
specifier|static
name|gint
name|old_cursor_mode
decl_stmt|;
end_decl_stmt

begin_decl_stmt
DECL|variable|old_default_threshold
specifier|static
name|gint
...
begin_decl_stmt
DECL|variable|old_disable_tearoff_menus
specifier|static
name|gboolean
...
begin_decl_stmt
DECL|variable|edit_tool_plug_in_path
specifier|static
name|gchar
modifier|*
name|edit_tool_plug_in_path
init|=
name|NULL
decl_stmt|;
end_decl_stmt
...
specifier|static
name|void
DECL|function|prefs_strset (gchar ** dst,const gchar * src)
name|prefs_strset
parameter_list|(
name|gchar
modifier|*
...
directive|if
literal|0
block|lc_dialog_rebuild (gimprc.preview_size);
endif|#
directive|endif
block|}
end_function
...
specifier|static
name|void
DECL|function|prefs_text_callback (GtkTextBuffer * buffer,gpointer data)
name|prefs_text_callback
parameter_list|(
name|GtkTextBuffer
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|prefs_notebook_append_page (Gimp * gimp,GtkNotebook * notebook,gchar * notebook_label,const gchar * notebook_icon,GtkTreeStore * tree,gchar * tree_label,gchar * help_data,GtkTreeIter * parent,GtkTreeIter * iter,gint page_index)
...
name|GtkWidget
modifier|*
DECL|function|prefs_check_button_new (const gchar * label,gboolean * value_location,GtkBox * vbox)
name|prefs_check_button_new
parameter_list|(
specifier|const
name|gchar
modifier|*
...
directive|if
literal|0
comment|/*  Don't show the Auto-save button until we really     *  have auto-saving in the gimp.    */
block|prefs_check_button (_("Auto Save"),&auto_save,                       vbox2);
endif|#
directive|endif
name|optionmenu
operator|=
...
specifier|const
struct|struct
DECL|struct|__anon2ba81f6f0208
block|{
DECL|member|label
name|gchar
modifier|*
...
specifier|const
struct|struct
DECL|struct|__anon2ba81f6f0308
block|{
