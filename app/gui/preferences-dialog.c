...
decl_stmt|;
struct|struct
DECL|struct|__anon2aae3ce80108
block|{
...
name|_
argument_list|(
literal|"Controller Specific Settings"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
specifier|const
struct|struct
DECL|struct|__anon2aae3ce80308
block|{
DECL|member|label
specifier|const
name|gchar
...
specifier|const
struct|struct
DECL|struct|__anon2aae3ce80408
block|{
