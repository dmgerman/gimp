...
name|GtkWidget
modifier|*
DECL|function|prefs_notebook_append_page (GtkNotebook * notebook,gchar * notebook_label,GtkTreeStore * tree,gchar * tree_label,gchar * help_data,GtkTreeIter * parent,GtkTreeIter * iter,gint page_index)
...
block|button = gtk_check_button_new_with_label(_("Auto Save"));   gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (button), auto_save);   gtk_box_pack_start (GTK_BOX (vbox2), button, FALSE, FALSE, 0);   gtk_widget_show (button);    g_signal_connect (G_OBJECT (button), "toggled",                     G_CALLBACK (prefs_toggle_callback),&auto_save);
endif|#
directive|endif
name|optionmenu
operator|=
