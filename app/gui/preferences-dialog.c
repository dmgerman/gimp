...
begin_decl_stmt
DECL|variable|old_environ_path
specifier|static
name|gchar
modifier|*
name|old_environ_path
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|edit_environ_path
specifier|static
name|gchar
modifier|*
name|edit_environ_path
init|=
name|NULL
decl_stmt|;
end_decl_stmt
...
directive|if
literal|0
block|gdisplays_nav_preview_resized ();
endif|#
directive|endif
block|}
if|if
...
specifier|const
struct|struct
DECL|struct|__anon28f521450208
block|{
DECL|member|label
name|gchar
modifier|*
...
specifier|const
struct|struct
DECL|struct|__anon28f521450308
block|{
