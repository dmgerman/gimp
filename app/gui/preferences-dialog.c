...
block|{
comment|/* Are you a gimp-hacker who is getting this message?  You 	 probably want to do the same as the&thumbnail_mode case 	 above is doing. */
name|g_warning
argument_list|(
...
name|_
argument_list|(
literal|"Display brush and pattern indicators on Toolbar"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_toggle_button_set_active
...
specifier|const
struct|struct
DECL|struct|__anon27870a050208
block|{
DECL|member|label
name|gchar
modifier|*
...
specifier|const
struct|struct
DECL|struct|__anon27870a050308
block|{
