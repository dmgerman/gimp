...
name|_
argument_list|(
literal|"Error: Default units must be withing unit range."
argument_list|)
argument_list|)
expr_stmt|;
name|default_units
...
begin_comment
comment|/*  commented out because it's not used  static void file_prefs_float_spinbutton_callback (GtkWidget *widget, 				      gpointer   data) {   float *val;    val = data;   *val = gtk_spin_button_get_value_as_int (GTK_SPIN_BUTTON (widget)); } */
end_comment
...
argument_list|)
expr_stmt|;
comment|/*      gtk_container_set_border_width (GTK_CONTAINER (default_size_sizeentry), 2); */
name|gtk_box_pack_start
argument_list|(
name|GTK_BOX
argument_list|(
