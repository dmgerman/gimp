...
specifier|static
name|void
DECL|function|prefs_template_select_callback (GimpContainerMenu * menu,GimpTemplate * template,gpointer insert_data,GimpTemplate * edit_template)
...
name|_
argument_list|(
literal|"Open _Recent Menu Size:"
argument_list|)
argument_list|,
name|GTK_TABLE
argument_list|(
...
expr_stmt|;
comment|/********************************************/
comment|/*  Interface / Image Windows / Appearance  */
comment|/********************************************/
name|vbox
operator|=
name|prefs_notebook_append_page
...
decl_stmt|;
struct|struct
DECL|struct|__anon2c0cabef0108
block|{
...
name|_
argument_list|(
literal|"Restore Saved Keyboard Shortcuts on Start-up"
argument_list|)
argument_list|,
name|GTK_BOX
argument_list|(
...
specifier|const
struct|struct
DECL|struct|__anon2c0cabef0208
block|{
DECL|member|label
specifier|const
name|gchar
...
specifier|const
struct|struct
DECL|struct|__anon2c0cabef0308
block|{
