...
specifier|static
name|gint
DECL|function|new_channel_query_delete_callback (GtkWidget * widget,GdkEvent * event,gpointer data)
...
specifier|static
name|gint
DECL|function|edit_channel_query_delete_callback (GtkWidget * widget,GdkEvent * event,gpointer data)
