...
typedef|typedef
enum|enum
DECL|enum|__anon29ad80140203
block|{
DECL|enumerator|TIPS_LANG_NONE
name|TIPS_LANG_NONE
block|,
DECL|enumerator|TIPS_LANG_MATCH
name|TIPS_LANG_MATCH
block|,
DECL|enumerator|TIPS_LANG_MISMATCH
name|TIPS_LANG_MISMATCH
block|, }
DECL|typedef|TipsParserLangState
name|TipsParserLangState
typedef|;
end_typedef
...
name|GList
modifier|*
DECL|function|gimp_tips_from_file (const gchar * filename,const gchar * language,GError ** error)
...
specifier|static
name|void
DECL|function|tips_parser_parse_lang (TipsParser * parser,const gchar ** names,const gchar ** values)
name|tips_parser_parse_lang
parameter_list|(
name|TipsParser
modifier|*
...
specifier|static
name|void
DECL|function|tips_parser_set_by_lang (TipsParser * parser,gchar ** dest)
name|tips_parser_set_by_lang
parameter_list|(
name|TipsParser
modifier|*
