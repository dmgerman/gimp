...
typedef|typedef
struct|struct
DECL|struct|__anon2b4265060108
block|{
DECL|member|gimp
name|Gimp
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Trace creation can be time consuming so don't block the            * mutex for too long and only increment and set a boolean            * here.            */
if|if
condition|(
name|n_traces
operator|<
...
specifier|static
name|void
DECL|function|gui_message_reset_errors (GObject * object,gpointer user_data)
name|gui_message_reset_errors
parameter_list|(
name|GObject
modifier|*
