...
specifier|static
name|void
DECL|function|new_channel_query_response (GtkWidget * widget,gint response_id,NewChannelOptions * options)
name|new_channel_query_response
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|edit_channel_query_response (GtkWidget * widget,gint response_id,EditChannelOptions * options)
name|edit_channel_query_response
parameter_list|(
name|GtkWidget
modifier|*
name|widget
