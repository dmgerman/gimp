...
begin_function
name|void
DECL|function|devices_rc_update (gchar * name,DeviceValues values,GdkInputMode mode,gint num_axes,GdkAxisUse * axes,gint num_keys,GdkDeviceKey * keys,gchar * brush_name,ToolType tool,guchar foreground[])
...
name|TRUE
expr_stmt|;
comment|/* FIXME: this should probably be left in brushes.c */
if|if
condition|(
name|values
operator|&
