...
name|gchar
modifier|*
name|menus_menu_translate_func
parameter_list|(
specifier|const
name|gchar
modifier|*
...
begin_define
DECL|macro|menus_menu_translate_func
define|#
directive|define
name|menus_menu_translate_func
value|(NULL)
...
specifier|static
name|void
name|menus_tearoff_cmd_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_toolbox_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_image_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_load_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_save_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_layers_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_channels_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_paths_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_dialogs_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_brushes_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_patterns_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_gradient_editor_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_gradients_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_palettes_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_buffers_factory (void)
...
name|GtkItemFactory
modifier|*
DECL|function|menus_get_documents_factory (void)
...
begin_function
name|void
DECL|function|menus_create_item_from_full_path (GimpItemFactoryEntry * entry,gchar * domain_name,gpointer callback_data)
...
begin_function
name|void
DECL|function|menus_set_active (gchar * path,gboolean active)
...
name|g_warning
argument_list|(
literal|"Unable to set \"active\" for menu which doesn't exist:\n%s"
argument_list|,
name|path
argument_list|)
expr_stmt|;
...
begin_function
name|void
DECL|function|menus_set_color (gchar * path,const GimpRGB * color,gboolean set_label)
name|menus_set_color
parameter_list|(
name|gchar
modifier|*
name|path
...
begin_function
name|void
DECL|function|menus_set_label (gchar * path,const gchar * label)
name|menus_set_label
parameter_list|(
name|gchar
modifier|*
name|path
...
begin_function
name|void
DECL|function|menus_set_visible (gchar * path,gboolean visible)
name|menus_set_visible
parameter_list|(
name|gchar
modifier|*
name|path
...
specifier|static
name|void
DECL|function|menus_create_branches (GtkItemFactory * item_factory,GimpItemFactoryEntry * entry)
name|menus_create_branches
parameter_list|(
name|GtkItemFactory
modifier|*
...
specifier|static
name|void
DECL|function|menus_create_item (GtkItemFactory * item_factory,GimpItemFactoryEntry * entry,gpointer callback_data,guint callback_type,gboolean create_tearoff,gboolean static_entry)
name|menus_create_item
parameter_list|(
name|GtkItemFactory
modifier|*
...
specifier|static
name|void
DECL|function|menus_create_items (GtkItemFactory * item_factory,guint n_entries,GimpItemFactoryEntry * entries,gpointer callback_data,guint callback_type,gboolean create_tearoff,gboolean static_entries)
name|menus_create_items
parameter_list|(
name|GtkItemFactory
modifier|*
...
name|GtkItemFactory
modifier|*
DECL|function|menus_item_factory_new (GtkType container_type,const gchar * path,const gchar * factory_path,guint n_entries,GimpItemFactoryEntry * entries,gpointer callback_data,gboolean create_tearoff)
name|menus_item_factory_new
parameter_list|(
name|GtkType
name|container_type
...
name|gchar
modifier|*
DECL|function|menus_menu_translate_func (const gchar * path,gpointer data)
name|menus_menu_translate_func
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|void
DECL|function|menus_tearoff_cmd_callback (GtkWidget * widget,gpointer data,guint action)
name|menus_tearoff_cmd_callback
parameter_list|(
name|GtkWidget
modifier|*
...
name|g_warning
argument_list|(
literal|"menus_tearoff_cmd_callback(): tearoff menu not "
literal|"in top level window"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|g_warning
argument_list|(
literal|"menus_tearoff_cmd_callback(): can't unregister "
literal|"tearoff menu top level window"
argument_list|)
expr_stmt|;
block|}
else|else
