...
name|entry
decl_stmt|;
comment|/* entry.path = g_strconcat ("<Image>", tool_info->menu_path, NULL);*/
comment|/* entry.callback_data = tool_info; */
name|entry
operator|.
name|path
operator|=
...
begin_comment
comment|/*  This is separate from menus_init() in case the last_opened_size changes,     or for any other reason we might want to regen just the toolbox menu     */
end_comment
