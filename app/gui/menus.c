...
begin_comment
comment|/*****<PaletteEditor>  *****/
end_comment

begin_decl_stmt
DECL|variable|palette_editor_entries
specifier|static
name|GimpItemFactoryEntry
name|palette_editor_entries
index|[]
init|=
block|{
block|{
...
begin_comment
comment|/*****<ColormapEditor>  *****/
end_comment

begin_decl_stmt
DECL|variable|colormap_editor_entries
specifier|static
name|GimpItemFactoryEntry
name|colormap_editor_entries
index|[]
init|=
block|{
block|{
...
name|GimpItemFactory
modifier|*
DECL|function|menus_get_new_image_factory (Gimp * gimp,gpointer callback_data,gboolean menu_bar)
...
name|f
parameter_list|)
value|(all_factories = g_list_append (all_factories, (f)));
name|toolbox_factory
operator|=
name|gimp_item_factory_new
argument_list|(
...
specifier|static
name|void
DECL|function|menus_foreground_changed (GimpContext * context,const GimpRGB * color,GimpItemFactory * item_factory)
name|menus_foreground_changed
parameter_list|(
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|menus_background_changed (GimpContext * context,const GimpRGB * color,GimpItemFactory * item_factory)
name|menus_background_changed
parameter_list|(
name|GimpContext
modifier|*
...
directive|if
literal|0
block|gint                  n_factories = 7;   GtkItemFactory       *factories[7];   GimpItemFactoryEntry *entries[7];    GtkWidget *menu_item;   gint       i;    factories[0] = GTK_ITEM_FACTORY (toolbox_factory);   factories[1] = GTK_ITEM_FACTORY (image_factory);   factories[2] = GTK_ITEM_FACTORY (layers_factory);   factories[3] = GTK_ITEM_FACTORY (channels_factory);   factories[4] = GTK_ITEM_FACTORY (paths_factory);   factories[5] = GTK_ITEM_FACTORY (load_factory);   factories[6] = GTK_ITEM_FACTORY (save_factory);    entries[0] = toolbox_entries;   entries[1] = image_entries;   entries[2] = layers_entries;   entries[3] = channels_entries;   entries[4] = paths_entries;   entries[5] = load_entries;   entries[6] = save_entries;
