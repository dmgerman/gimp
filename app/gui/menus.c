...
begin_decl_stmt
DECL|variable|n_brushes_entries
specifier|static
name|guint
name|n_brushes_entries
init|=
operator|(
sizeof|sizeof
argument_list|(
...
begin_decl_stmt
DECL|variable|n_patterns_entries
specifier|static
name|guint
name|n_patterns_entries
init|=
operator|(
sizeof|sizeof
argument_list|(
...
begin_decl_stmt
DECL|variable|n_gradients_entries
specifier|static
name|guint
name|n_gradients_entries
init|=
operator|(
sizeof|sizeof
argument_list|(
...
begin_decl_stmt
DECL|variable|n_palettes_entries
specifier|static
name|guint
name|n_palettes_entries
init|=
operator|(
sizeof|sizeof
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  see if we've already got the filename on the list  */
for|for
control|(
name|list
operator|=
...
condition|)
block|{
comment|/*  move the entry to the top  */
name|last_opened_raw_filenames
operator|=
