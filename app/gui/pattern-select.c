...
specifier|static
name|void
DECL|function|pattern_select_close_callback (GtkWidget * widget,gpointer client_data)
name|pattern_select_close_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|pattern_select_refresh_callback (GtkWidget * widget,gpointer client_data)
name|pattern_select_refresh_callback
parameter_list|(
name|GtkWidget
modifier|*
