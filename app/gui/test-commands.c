...
begin_function
name|void
DECL|function|test_serialize_devicerc_cmd_callback (GtkWidget * widget,gpointer data)
name|test_serialize_devicerc_cmd_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_function
name|void
DECL|function|test_deserialize_devicerc_cmd_callback (GtkWidget * widget,gpointer data)
name|test_deserialize_devicerc_cmd_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
argument_list|)
expr_stmt|;
name|gimp_devices_restore_test
argument_list|(
name|gimp
argument_list|)
expr_stmt|;
