...
specifier|static
name|void
DECL|function|themes_draw_layout (GtkStyle * style,GdkWindow * window,GtkStateType state_type,gboolean use_text,GdkRectangle * area,GtkWidget * widget,const gchar * detail,gint x,gint y,PangoLayout * layout)
name|themes_draw_layout
parameter_list|(
name|GtkStyle
modifier|*
