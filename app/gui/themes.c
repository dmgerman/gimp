...
specifier|static
name|void
name|themes_theme_paths_notify
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|/* Check for theme extensions. */
name|themes_theme_paths_notify
argument_list|(
name|gimp
operator|->
...
name|config
argument_list|,
literal|"notify::prefer-symbolic-icons"
argument_list|,
name|G_CALLBACK
argument_list|(
name|themes_theme_change_notify
...
name|css
argument_list|,
literal|"* { -gtk-icon-style: symbolic; } "
argument_list|)
expr_stmt|;
else|else
name|css2
...
name|css
argument_list|,
literal|"* { -gtk-icon-style: regular; } "
argument_list|)
expr_stmt|;
if|if
condition|(
...
specifier|static
name|void
DECL|function|themes_theme_paths_notify (GimpExtensionManager * manager,GParamSpec * pspec,Gimp * gimp)
name|themes_theme_paths_notify
parameter_list|(
name|GimpExtensionManager
modifier|*
