...
specifier|static
name|void
name|themes_draw_pixbuf_layout
parameter_list|(
name|GtkStyle
modifier|*
name|style
...
begin_decl_stmt
DECL|variable|pixbuf_style_class
specifier|static
name|GtkStyleClass
modifier|*
...
specifier|static
name|void
DECL|function|themes_fix_pixbuf_style (void)
name|themes_fix_pixbuf_style
parameter_list|(
name|void
parameter_list|)
...
specifier|static
name|void
DECL|function|themes_draw_pixbuf_layout (GtkStyle * style,GdkWindow * window,GtkStateType state_type,gboolean use_text,GdkRectangle * area,GtkWidget * widget,const gchar * detail,gint x,gint y,PangoLayout * layout)
name|themes_draw_pixbuf_layout
parameter_list|(
name|GtkStyle
modifier|*
