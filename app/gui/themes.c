...
specifier|static
name|void
DECL|function|draw_layout (GtkStyle * style,GdkWindow * window,GtkStateType state_type,gboolean use_text,GdkRectangle * area,GtkWidget * widget,const gchar * detail,gint x,gint y,PangoLayout * layout)
name|draw_layout
parameter_list|(
name|GtkStyle
modifier|*
