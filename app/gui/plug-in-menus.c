...
begin_function
name|void
DECL|function|plug_in_menus_add_proc (GimpUIManager * manager,const gchar * ui_path,PlugInProcDef * proc_def)
...
specifier|static
name|gboolean
DECL|function|plug_in_menus_tree_traverse (gpointer foo,PlugInProcDef * proc_def,GimpUIManager * manager)
name|plug_in_menus_tree_traverse
parameter_list|(
name|gpointer
name|foo
