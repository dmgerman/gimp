...
begin_function
name|void
DECL|function|plug_in_make_menu (GimpItemFactory * image_factory,GSList * proc_defs)
...
begin_function
name|void
DECL|function|plug_in_make_menu_entry (GimpItemFactory * image_factory,PlugInProcDef * proc_def,const gchar * domain,const gchar * help_path)
...
begin_function
name|void
DECL|function|plug_in_set_menu_sensitivity (GimpItemFactory * image_factory,GimpImageType type)
...
specifier|static
name|gboolean
DECL|function|plug_in_menu_tree_traverse_func (gpointer foo,PlugInMenuEntry * menu_entry,GimpItemFactory * image_factory)
name|plug_in_menu_tree_traverse_func
parameter_list|(
name|gpointer
name|foo
