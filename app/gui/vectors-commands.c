...
specifier|static
name|void
DECL|function|vectors_import_response (GtkWidget * dialog,gint response_id,GimpImage * gimage)
...
specifier|static
name|void
DECL|function|vectors_export_response (GtkWidget * dialog,gint response_id,GimpImage * gimage)
