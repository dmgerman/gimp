...
specifier|static
struct|struct
DECL|struct|__anon29911a310408
block|{
...
name|_
argument_list|(
literal|"<b>To display images in their natural size, "
literal|"GIMP needs to know your monitor resolution.</b>"
argument_list|)
argument_list|)
expr_stmt|;
comment|/*  EEK page  */
