...
parameter_list|)
define|\
value|gimage = (GimpImage *) gimp_widget_get_callback_context (widget); \   if (! gimage) \     gimage = gimp_context_get_image (gimp_get_user_context (GIMP (data))); \   if (! gimage) \     return
end_define
...
begin_function
name|void
DECL|function|layers_desaturate_cmd_callback (GtkWidget * widget,gpointer data)
...
begin_function
name|void
DECL|function|layers_invert_cmd_callback (GtkWidget * widget,gpointer data)
...
begin_function
name|void
DECL|function|layers_equalize_cmd_callback (GtkWidget * widget,gpointer data)
...
begin_function
name|void
DECL|function|layers_offset_cmd_callback (GtkWidget * widget,gpointer data)
...
begin_function
name|void
DECL|function|layers_new_layer_query (GimpImage * gimage,GimpLayer * template)
name|layers_new_layer_query
parameter_list|(
name|GimpImage
modifier|*
