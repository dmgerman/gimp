...
name|void
modifier|*
DECL|function|do_parallel_regions (struct parallel_struct * p_s)
...
name|g_message
argument_list|(
literal|"pixel_regions_process_parallel: Bad number of regions %d\n"
argument_list|,
name|p_s
operator|.
name|n_regions
...
name|IF_THREAD
argument_list|(
argument|nthreads = MIN(num_processors, 		   (p_s.PRI->region_width * p_s.PRI->region_height) /(
literal|64
argument|*
literal|64
...
name|stderr
argument_list|,
literal|"Ack, we've lost a thread."
argument_list|)
expr_stmt|;
block|}
end_function
