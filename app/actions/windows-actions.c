...
specifier|static
name|void
name|windows_actions_display_reorder
parameter_list|(
name|GimpContainer
modifier|*
name|container
...
specifier|static
name|void
name|windows_actions_title_notify
parameter_list|(
...
begin_decl_stmt
DECL|variable|windows_tabs_position_actions
specifier|static
specifier|const
name|GimpRadioActionEntry
name|windows_tabs_position_actions
index|[]
init|=
block|{
block|{
...
specifier|static
name|void
DECL|function|windows_actions_display_reorder (GimpContainer * container,GimpDisplay * display,gint new_index,GimpActionGroup * group)
name|windows_actions_display_reorder
parameter_list|(
name|GimpContainer
modifier|*
...
specifier|static
name|void
DECL|function|windows_actions_title_notify (GimpDisplayShell * shell,const GParamSpec * unused,GimpActionGroup * group)
name|windows_actions_title_notify
parameter_list|(
name|GimpDisplayShell
modifier|*
