...
specifier|static
name|void
DECL|function|dialogs_change_screen_confirm_callback (GtkWidget * query_box,gint value,gpointer data)
name|dialogs_change_screen_confirm_callback
parameter_list|(
name|GtkWidget
modifier|*
name|query_box
...
specifier|static
name|void
DECL|function|dialogs_change_screen_destroy_callback (GtkWidget * query_box,GtkWidget * dock)
name|dialogs_change_screen_destroy_callback
parameter_list|(
name|GtkWidget
modifier|*
name|query_box
...
begin_function
name|void
DECL|function|dialogs_change_screen_cmd_callback (GtkWidget * widget,gpointer data,guint action)
