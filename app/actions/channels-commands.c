...
begin_typedef
DECL|typedef|ChannelOptions
typedef|typedef
name|struct
name|_ChannelOptions
name|ChannelOptions
typedef|;
end_typedef

begin_struct
DECL|struct|_ChannelOptions
struct|struct
name|_ChannelOptions
block|{
...
name|ChannelOptions
modifier|*
DECL|function|channels_query_new (GimpImage * gimage,GimpContext * context,GimpChannel * channel,GtkWidget * parent)
name|channels_query_new
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|channels_new_channel_query (GimpImage * gimage,GimpContext * context,GtkWidget * parent)
name|channels_new_channel_query
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|channels_new_channel_response (GtkWidget * widget,gint response_id,ChannelOptions * options)
name|channels_new_channel_response
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|channels_edit_channel_response (GtkWidget * widget,gint response_id,ChannelOptions * options)
name|channels_edit_channel_response
parameter_list|(
name|GtkWidget
modifier|*
