...
name|action
argument_list|,
literal|"<Actions>/file/file-open"
argument_list|)
expr_stmt|;
name|n_entries
operator|=
...
specifier|static
name|void
DECL|function|file_actions_close_all_update (GimpContainer * container,GimpObject * unused,GimpActionGroup * group)
name|file_actions_close_all_update
parameter_list|(
name|GimpContainer
modifier|*
