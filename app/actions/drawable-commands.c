...
begin_function
name|void
DECL|function|drawable_linear_invert_cmd_callback (GtkAction * action,gpointer data)
...
specifier|static
name|void
DECL|function|drawable_offset_callback (GtkWidget * dialog,GimpDrawable * drawable,GimpContext * context,gboolean wrap_around,GimpOffsetType fill_type,gint offset_x,gint offset_y)
name|drawable_offset_callback
parameter_list|(
name|GtkWidget
modifier|*
