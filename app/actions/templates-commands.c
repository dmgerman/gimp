...
specifier|static
name|void
name|templates_delete_confirm_response
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
...
specifier|static
name|void
DECL|function|templates_new_template_dialog (Gimp * gimp,GtkWidget * parent)
name|templates_new_template_dialog
parameter_list|(
name|Gimp
modifier|*
...
specifier|static
name|void
DECL|function|templates_delete_confirm_response (GtkWidget * dialog,gint response_id,GimpTemplateDeleteData * delete_data)
name|templates_delete_confirm_response
parameter_list|(
name|GtkWidget
modifier|*
