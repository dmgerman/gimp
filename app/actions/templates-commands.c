...
typedef|typedef
struct|struct
DECL|struct|__anon2a21a9160108
block|{
DECL|member|context
name|GimpContext
modifier|*
...
directive|define
name|NEW_DIALOG_KEY
value|"gimp-template-new-dialog"
name|dialog
operator|=
...
value|"gimp-template-edit-dialog"
name|dialog
operator|=
name|dialogs_get_dialog
argument_list|(
...
specifier|static
name|void
DECL|function|templates_new_callback (GtkWidget * dialog,GimpTemplate * template,GimpTemplate * edit_template,GimpContext * context,gpointer user_data)
name|templates_new_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|templates_edit_callback (GtkWidget * dialog,GimpTemplate * template,GimpTemplate * edit_template,GimpContext * context,gpointer user_data)
name|templates_edit_callback
parameter_list|(
name|GtkWidget
modifier|*
