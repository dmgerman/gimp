...
begin_function
name|void
DECL|function|view_color_management_mode_cmd_callback (GtkAction * action,GtkAction * current,gpointer data)
...
begin_function
name|void
DECL|function|view_color_management_intent_cmd_callback (GtkAction * action,GtkAction * current,gpointer data)
...
begin_function
name|void
DECL|function|view_color_management_bpc_cmd_callback (GtkAction * action,gpointer data)
...
begin_function
name|void
DECL|function|view_color_management_gamut_check_cmd_callback (GtkAction * action,gpointer data)
