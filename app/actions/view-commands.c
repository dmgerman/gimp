...
include|#
directive|include
file|"display/gimpdisplayshell-rotate.h"
end_include

begin_include
include|#
directive|include
file|"display/gimpdisplayshell-rotate-dialog.h"
end_include
...
specifier|static
name|void
name|view_softproof_profile_callback
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
...
begin_function
name|void
DECL|function|view_show_all_cmd_callback (GimpAction * action,GVariant * value,gpointer data)
...
argument_list|)
expr_stmt|;
DECL|macro|FILTERS_DIALOG_KEY
define|#
directive|define
name|FILTERS_DIALOG_KEY
value|"gimp-display-filters-dialog"
name|dialog
operator|=
...
argument_list|)
expr_stmt|;
DECL|macro|SOFTPROOF_PROFILE_DIALOG_KEY
define|#
directive|define
name|SOFTPROOF_PROFILE_DIALOG_KEY
value|"gimp-softproof-profile-dialog"
name|dialog
operator|=
name|dialogs_get_dialog
argument_list|(
...
begin_function
name|void
DECL|function|view_toggle_canvas_boundary_cmd_callback (GimpAction * action,GVariant * value,gpointer data)
...
name|options
expr_stmt|;
DECL|macro|PADDING_COLOR_DIALOG_KEY
define|#
directive|define
name|PADDING_COLOR_DIALOG_KEY
...
begin_function
name|void
DECL|function|view_padding_color_in_show_all_cmd_callback (GimpAction * action,GVariant * value,gpointer data)
...
specifier|static
name|void
DECL|function|view_softproof_profile_callback (GtkWidget * dialog,GimpImage * image,GimpColorProfile * new_profile,GFile * new_file,GimpColorRenderingIntent intent,gboolean bpc,gpointer user_data)
name|view_softproof_profile_callback
parameter_list|(
name|GtkWidget
modifier|*
