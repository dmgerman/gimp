...
begin_function
name|void
DECL|function|view_rotate_reset_cmd_callback (GtkAction * action,gpointer data)
...
begin_function
name|void
DECL|function|view_rotate_cmd_callback (GtkAction * action,gint value,gpointer data)
