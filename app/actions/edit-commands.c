...
name|_
argument_list|(
literal|"Cut layer to the clipboard."
argument_list|)
else|:
name|_
argument_list|(
...
name|_
argument_list|(
literal|"Copied layer to the clipboard."
argument_list|)
else|:
name|_
argument_list|(
...
name|_
argument_list|(
literal|"There is no image data in the clipboard "
literal|"to paste."
argument_list|)
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|edit_paste (GimpDisplay * display,GimpPasteType paste_type,gboolean try_svg)
name|edit_paste
parameter_list|(
name|GimpDisplay
modifier|*
...
name|_
argument_list|(
literal|"Pasted as new layer because "
literal|"there was a layer the clipboard."
argument_list|)
argument_list|)
expr_stmt|;
name|paste_type
