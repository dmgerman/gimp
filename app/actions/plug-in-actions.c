...
begin_function
name|void
DECL|function|plug_in_actions_add_path (GimpActionGroup * group,GimpPlugInProcedure * proc,const gchar * menu_path)
...
begin_function
name|void
DECL|function|plug_in_actions_remove_proc (GimpActionGroup * group,GimpPlugInProcedure * proc)
...
expr_stmt|;
block|}
comment|/* update sensitivity of the actions */
name|plug_in_actions_update
argument_list|(
name|group
argument_list|,
