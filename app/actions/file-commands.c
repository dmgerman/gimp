...
specifier|static
name|void
name|file_export_dialog_destroyed
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
...
name|folder
operator|=
name|gtk_file_chooser_get_current_folder_uri
argument_list|(
name|GTK_FILE_CHOOSER
argument_list|(
name|dialog
...
specifier|static
name|void
DECL|function|file_export_dialog_destroyed (GtkWidget * dialog,GimpImage * image)
name|file_export_dialog_destroyed
parameter_list|(
name|GtkWidget
modifier|*
