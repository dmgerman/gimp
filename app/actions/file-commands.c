...
specifier|static
name|void
name|file_export_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
...
return|return;
block|}
DECL|macro|REVERT_DIALOG_KEY
define|#
directive|define
name|REVERT_DIALOG_KEY
value|"gimp-revert-confirm-dialog"
name|dialog
operator|=
...
begin_function
name|void
DECL|function|file_file_open_dialog (Gimp * gimp,GFile * file,GtkWidget * parent)
...
specifier|static
name|void
DECL|function|file_open_dialog_show (Gimp * gimp,GtkWidget * parent,const gchar * title,GimpImage * image,GFile * file,gboolean open_as_layers)
name|file_open_dialog_show
parameter_list|(
name|Gimp
modifier|*
...
name|dialog
decl_stmt|;
DECL|macro|SAVE_DIALOG_KEY
define|#
directive|define
name|SAVE_DIALOG_KEY
value|"gimp-file-save-dialog"
name|dialog
operator|=
name|dialogs_get_dialog
argument_list|(
...
specifier|static
name|void
DECL|function|file_save_dialog_response (GtkWidget * dialog,gint response_id,gpointer data)
name|file_save_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|file_export_dialog_show (Gimp * gimp,GimpImage * image,GtkWidget * parent)
name|file_export_dialog_show
parameter_list|(
name|Gimp
modifier|*
...
specifier|static
name|void
DECL|function|file_export_dialog_response (GtkWidget * dialog,gint response_id,gpointer data)
name|file_export_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
