...
name|GimpProcedure
modifier|*
DECL|function|gimp_gegl_procedure_new (Gimp * gimp,const gchar * operation,const gchar * name,const gchar * menu_label,const gchar * icon_name,const gchar * tooltip)
