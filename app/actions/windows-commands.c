...
begin_function
name|void
DECL|function|windows_show_tabs_cmd_callback (GtkAction * action,gpointer data)
...
begin_function
name|void
DECL|function|windows_set_tabs_position_cmd_callback (GtkAction * action,GtkAction * current,gpointer data)
