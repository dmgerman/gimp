...
block|,
block|{
literal|"image-color-profile-save"
block|,
name|NULL
block|,
name|NC_
...
literal|"image-action"
argument_list|,
literal|"_Save Color Profile to File..."
argument_list|)
block|,
name|NULL
block|,
...
literal|"image-convert-action"
argument_list|,
literal|"Convert the image to 64 bit floating point"
argument_list|)
block|,
...
block|,
block|{
literal|"image-convert-non-linear"
block|,
name|NULL
block|,
name|NC_
...
literal|"image-convert-action"
argument_list|,
literal|"Convert the image to non-linear gamma from the color profile"
argument_list|)
block|,
...
block|,
block|{
literal|"image-convert-perceptual"
block|,
name|NULL
block|,
name|NC_
