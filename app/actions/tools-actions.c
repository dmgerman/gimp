...
begin_decl_stmt
DECL|variable|tools_rectangle_toggle_actions
specifier|static
specifier|const
name|GimpToggleActionEntry
name|tools_rectangle_toggle_actions
index|[]
init|=
block|{
block|{
literal|"tools-rectangle-toggle-fixed-aspect"
block|,
name|GIMP_STOCK_TOOL_RECT_SELECT
block|,
name|N_
argument_list|(
literal|"Toggle Fixed-Aspect Option for Rectangle"
argument_list|)
block|,
name|NULL
block|,
...
block|,
block|{
literal|"tools-rectangle-toggle-fixed-center"
block|,
name|GIMP_STOCK_TOOL_RECT_SELECT
block|,
name|N_
argument_list|(
literal|"Toggle Expand-From-Center Option for Rectangle"
argument_list|)
block|,
name|NULL
block|,
...
name|G_CALLBACK
argument_list|(
name|tools_rectangle_toggle_fixed_center
argument_list|)
block|,
name|TRUE
block|,
