...
block|,
block|{
literal|"view-color-management-menu"
block|,
name|NULL
block|,
name|NC_
...
block|,
block|{
literal|"view-display-intent-menu"
block|,
name|NULL
block|,
name|NC_
...
literal|"view-action"
argument_list|,
literal|"Display _Rendering Intent"
argument_list|)
block|}
block|,
block|{
literal|"view-softproof-intent-menu"
block|,
name|NULL
block|,
name|NC_
...
literal|"view-action"
argument_list|,
literal|"Soft-_Proofing Profile..."
argument_list|)
block|,
name|NULL
block|,
...
literal|"view-action"
argument_list|,
literal|"_Mark Out Of Gamut Colors"
argument_list|)
block|,
name|NULL
block|,
...
literal|"view-action"
argument_list|,
literal|"Draw a border around the canvas"
argument_list|)
block|,
...
block|{
block|{
literal|"view-rotate-set-absolute"
block|,
name|NULL
block|,
literal|"Display Rotation Absolute Angle Set"
block|,
name|NULL
block|,
name|NULL
...
begin_decl_stmt
DECL|variable|view_display_intent_actions
specifier|static
specifier|const
name|GimpRadioActionEntry
name|view_display_intent_actions
index|[]
init|=
block|{
block|{
...
literal|"view-action"
argument_list|,
literal|"Display rendering intent is perceptual"
argument_list|)
block|,
...
literal|"view-action"
argument_list|,
literal|"_Relative Colorimetric"
argument_list|)
block|,
name|NULL
block|,
...
literal|"view-action"
argument_list|,
literal|"Display rendering intent is relative colorimetric"
argument_list|)
block|,
...
literal|"view-action"
argument_list|,
literal|"Display rendering intent is saturation"
argument_list|)
block|,
...
literal|"view-action"
argument_list|,
literal|"_Absolute Colorimetric"
argument_list|)
block|,
name|NULL
block|,
...
literal|"view-action"
argument_list|,
literal|"Display rendering intent is absolute colorimetric"
argument_list|)
block|,
...
begin_decl_stmt
DECL|variable|view_softproof_intent_actions
specifier|static
specifier|const
name|GimpRadioActionEntry
name|view_softproof_intent_actions
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|view_padding_color_toggle_actions
specifier|static
specifier|const
name|GimpToggleActionEntry
name|view_padding_color_toggle_actions
index|[]
init|=
block|{
block|{
...
literal|"view-padding-color"
argument_list|,
literal|"Keep Padding in \"Show _All\" Mode"
argument_list|)
block|,
name|NULL
block|,
...
literal|"view-padding-color"
argument_list|,
literal|"Keep canvas padding when \"View -> Show All\" is enabled"
argument_list|)
block|,
...
specifier|static
name|void
DECL|function|view_actions_set_rotate (GimpActionGroup * group,GimpDisplayShell * shell)
name|view_actions_set_rotate
parameter_list|(
name|GimpActionGroup
modifier|*
