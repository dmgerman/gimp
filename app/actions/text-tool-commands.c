...
argument_list|)
expr_stmt|;
comment|/*   gimp_text_tool_set_direction (editor, (GimpTextDirection) value);   */
block|}
end_function
...
specifier|static
name|void
DECL|function|text_tool_load_response (GtkWidget * dialog,gint response_id,GimpTextEditor * editor)
name|text_tool_load_response
parameter_list|(
name|GtkWidget
modifier|*
