...
begin_function
name|void
DECL|function|tools_rectangle_toggle_fixed_aspect (GtkAction * action,gpointer data)
...
begin_function
name|void
DECL|function|tools_rectangle_toggle_fixed_center (GtkAction * action,gpointer data)
