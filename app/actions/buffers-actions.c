...
begin_decl_stmt
DECL|variable|buffers_paste_actions
specifier|static
specifier|const
...
literal|"buffers-action"
argument_list|,
literal|"Paste Buffer In Pl_ace"
argument_list|)
block|,
name|NULL
block|,
...
literal|"buffers-action"
argument_list|,
literal|"Paste the selected buffer at its original position"
argument_list|)
block|,
...
literal|"buffers-action"
argument_list|,
literal|"Paste the selected buffer into the selection at its original position"
argument_list|)
block|,
...
literal|"buffers-action"
argument_list|,
literal|"Paste Buffer as New Layer in Place"
argument_list|)
block|,
name|NULL
block|,
...
literal|"buffers-action"
argument_list|,
literal|"Paste the selected buffer as a new layer at its original position"
argument_list|)
block|,
