...
specifier|static
name|void
DECL|function|layers_new_layer_response (GtkWidget * widget,gint response_id,NewLayerOptions * options)
...
specifier|static
name|void
DECL|function|layers_new_layer_query (GimpImage * gimage,GimpContext * context,GtkWidget * parent)
name|layers_new_layer_query
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|layers_edit_layer_response (GtkWidget * widget,gint response_id,EditLayerOptions * options)
...
specifier|static
name|void
DECL|function|layers_edit_layer_toggle_rename (GtkWidget * widget,EditLayerOptions * options)
name|layers_edit_layer_toggle_rename
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|layers_add_mask_response (GtkWidget * widget,gint response_id,AddMaskOptions * options)
...
specifier|static
name|void
DECL|function|layers_resize_layer_callback (GtkWidget * widget,gpointer data)
