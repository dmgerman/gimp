...
specifier|static
name|void
DECL|function|layers_new_callback (GtkWidget * dialog,GimpImage * image,GimpLayer * layer,GimpContext * context,const gchar * layer_name,GimpFillType layer_fill_type,gint layer_width,gint layer_height,gboolean rename_text_layer,gpointer user_data)
name|layers_new_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|layers_edit_attributes_callback (GtkWidget * dialog,GimpImage * image,GimpLayer * layer,GimpContext * context,const gchar * layer_name,GimpFillType layer_fill_type,gint layer_width,gint layer_height,gboolean rename_text_layer,gpointer user_data)
name|layers_edit_attributes_callback
parameter_list|(
name|GtkWidget
modifier|*
