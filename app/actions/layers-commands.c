...
specifier|static
name|void
DECL|function|layers_new_layer_response (GtkWidget * widget,gint response_id,LayerOptionsDialog * options)
name|layers_new_layer_response
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|layers_edit_layer_response (GtkWidget * widget,gint response_id,LayerOptionsDialog * options)
name|layers_edit_layer_response
parameter_list|(
name|GtkWidget
modifier|*
