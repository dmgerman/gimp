...
specifier|static
name|void
DECL|function|scale_layer_callback (GtkWidget * dialog,GimpViewable * viewable,gint width,gint height,GimpUnit unit,GimpInterpolationType interpolation,gpointer data)
name|scale_layer_callback
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
