...
specifier|static
name|void
DECL|function|dialogs_indexed_palette_select_callback (GimpColormapDialog * dialog,gpointer data)
...
begin_function
name|void
DECL|function|dialogs_undo_history_cmd_callback (GtkWidget * widget,gpointer client_data)
...
argument_list|)
expr_stmt|;
comment|/*     gtk_widget_hide (GTK_WIDGET (g_list_nth_data (gtk_container_children (GTK_CONTAINER (GTK_BIN (dialog)->child)), 1)));   */
...
begin_function
name|void
DECL|function|dialogs_test_image_container_list_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_image_container_grid_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_brush_container_list_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_pattern_container_list_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_gradient_container_list_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_palette_container_list_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_brush_container_grid_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_pattern_container_grid_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_gradient_container_grid_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_palette_container_grid_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_multi_container_list_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_multi_container_grid_view_cmd_callback (GtkWidget * widget,gpointer client_data)
...
specifier|static
name|void
DECL|function|layers_view_image_changed (GimpContext * context,GimpImage * gimage,GimpContainerView * view)
name|layers_view_image_changed
parameter_list|(
name|GimpContext
modifier|*
name|context
...
specifier|static
name|void
DECL|function|channels_view_image_changed (GimpContext * context,GimpImage * gimage,GimpContainerView * view)
name|channels_view_image_changed
parameter_list|(
name|GimpContext
modifier|*
name|context
...
specifier|static
name|void
DECL|function|drawable_view_new (GimpViewType view_type,gchar * title,gboolean channels,GimpContext * context)
...
begin_function
name|void
DECL|function|dialogs_test_layer_list_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_layer_grid_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_channel_list_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|dialogs_test_channel_grid_cmd_callback (GtkWidget * widget,gpointer client_data)
