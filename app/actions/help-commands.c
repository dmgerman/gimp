...
specifier|static
name|void
DECL|function|container_view_new (gboolean list,gchar * title,GimpContainer * container,GimpContext * context,gint preview_width,gint preview_height,gboolean multi)
