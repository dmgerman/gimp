...
specifier|static
name|void
DECL|function|image_convert_indexed_callback (GtkWidget * dialog,GimpImage * image,GimpConvertPaletteType palette_type,gint max_colors,gboolean remove_duplicates,GimpConvertDitherType dither_type,gboolean dither_alpha,gboolean dither_text_layers,GimpPalette * custom_palette,gpointer user_data)
name|image_convert_indexed_callback
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  we do the same dither method checks here *and* in the dialog,    *  because the dialog leaves the passed dither methods untouched if    *  dithering is disabled and passes the original values to the    *  callback, in order not to change the values saved in    *  GimpDialogConfig.    */
...
specifier|static
name|void
DECL|function|image_resize_callback (GtkWidget * dialog,GimpViewable * viewable,GimpContext * context,gint width,gint height,GimpUnit unit,gint offset_x,gint offset_y,GimpFillType fill_type,GimpItemSet layer_set,gboolean resize_text_layers,gpointer user_data)
name|image_resize_callback
parameter_list|(
name|GtkWidget
modifier|*
