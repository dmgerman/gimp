...
typedef|typedef
struct|struct
DECL|struct|__anon2952133f0108
block|{
DECL|member|context
name|GimpContext
modifier|*
...
name|g_message
argument_list|(
literal|"FIXME: implement image_color_profile_assign_cmd_callback()"
argument_list|)
expr_stmt|;
block|}
end_function
...
name|g_message
argument_list|(
literal|"FIXME: implement image_color_profile_convert_cmd_callback()"
argument_list|)
expr_stmt|;
block|}
end_function
