...
name|_
argument_list|(
literal|"The chosen image size will shrink some layers "
literal|"completely away. Is this what you want?"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
...
specifier|static
name|void
DECL|function|image_scale_warn (ImageResizeOptions * options,const gchar * warning_title,const gchar * warning_message)
name|image_scale_warn
parameter_list|(
name|ImageResizeOptions
modifier|*
...
specifier|static
name|void
DECL|function|image_merge_layers_response (GtkWidget * widget,gint response_id,LayerMergeOptions * options)
name|image_merge_layers_response
parameter_list|(
name|GtkWidget
modifier|*
