...
typedef|typedef
struct|struct
DECL|struct|__anon2ad7de170108
block|{
DECL|member|context
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|image_convert_type_dialog_unset (GtkWidget * widget)
...
specifier|static
name|void
DECL|function|image_convert_precision_dialog_unset (GtkWidget * widget)
