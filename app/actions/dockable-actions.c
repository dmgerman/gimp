...
block|,
block|{
literal|"dockable-move-to-screen"
block|,
...
block|{
block|{
literal|"dockable-show-image-menu"
block|,
name|NULL
block|,
name|N_
...
block|,
block|{
literal|"dockable-auto-follow-active"
block|,
name|NULL
block|,
name|N_
...
begin_function
name|void
DECL|function|dockable_actions_setup (GimpActionGroup * group,gpointer data)
