...
value|"gimp-vectors-fill-dialog"
name|dialog
operator|=
name|dialogs_get_dialog
argument_list|(
...
value|"gimp-vectors-stroke-dialog"
name|dialog
operator|=
name|dialogs_get_dialog
argument_list|(
...
specifier|static
name|void
DECL|function|vectors_new_callback (GtkWidget * dialog,GimpImage * image,GimpVectors * vectors,GimpContext * context,const gchar * vectors_name,gboolean vectors_visible,gboolean vectors_linked,gboolean vectors_lock_content,gboolean vectors_lock_position,gpointer user_data)
name|vectors_new_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|vectors_edit_attributes_callback (GtkWidget * dialog,GimpImage * image,GimpVectors * vectors,GimpContext * context,const gchar * vectors_name,gboolean vectors_visible,gboolean vectors_linked,gboolean vectors_lock_content,gboolean vectors_lock_position,gpointer user_data)
name|vectors_edit_attributes_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|vectors_fill_callback (GtkWidget * dialog,GimpItem * item,GimpDrawable * drawable,GimpContext * context,GimpFillOptions * options,gpointer user_data)
name|vectors_fill_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|vectors_stroke_callback (GtkWidget * dialog,GimpItem * item,GimpDrawable * drawable,GimpContext * context,GimpStrokeOptions * options,gpointer data)
name|vectors_stroke_callback
parameter_list|(
name|GtkWidget
modifier|*
