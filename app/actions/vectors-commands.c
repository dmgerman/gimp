...
begin_typedef
DECL|typedef|VectorsOptions
typedef|typedef
name|struct
name|_VectorsOptions
name|VectorsOptions
typedef|;
end_typedef

begin_struct
DECL|struct|_VectorsOptions
struct|struct
name|_VectorsOptions
block|{
...
begin_function
name|void
DECL|function|vectors_vectors_tool (GimpVectors * vectors,GimpContext * context,GtkWidget * parent)
name|vectors_vectors_tool
parameter_list|(
name|GimpVectors
modifier|*
...
begin_function
name|void
DECL|function|vectors_new_vectors_query (GimpImage * gimage,GimpContext * context,GimpVectors * template,gboolean interactive,GtkWidget * parent)
name|vectors_new_vectors_query
parameter_list|(
name|GimpImage
modifier|*
...
begin_function
name|void
DECL|function|vectors_edit_vectors_query (GimpVectors * vectors,GimpContext * context,GtkWidget * parent)
name|vectors_edit_vectors_query
parameter_list|(
name|GimpVectors
modifier|*
...
name|VectorsOptions
modifier|*
DECL|function|vectors_query_new (GimpImage * gimage,GimpContext * context,GimpVectors * vectors,GtkWidget * parent)
name|vectors_query_new
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|void
DECL|function|vectors_new_vectors_response (GtkWidget * widget,gint response_id,VectorsOptions * options)
name|vectors_new_vectors_response
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|vectors_edit_vectors_response (GtkWidget * widget,gint response_id,VectorsOptions * options)
name|vectors_edit_vectors_response
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  FIXME: add controls for merge and scale options  */
name|gtk_widget_show
argument_list|(
name|dialog
argument_list|)
...
argument_list|)
expr_stmt|;
comment|/*  FIXME: add control for saving all or just the active vectors  */
name|gtk_widget_show
argument_list|(
name|dialog
argument_list|)
