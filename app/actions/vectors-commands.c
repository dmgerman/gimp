...
specifier|static
name|void
DECL|function|vectors_new_callback (GtkWidget * dialog,GimpImage * image,GimpVectors * vectors,const gchar * vectors_name,gpointer user_data)
name|vectors_new_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|vectors_edit_attributes_callback (GtkWidget * dialog,GimpImage * image,GimpVectors * vectors,const gchar * vectors_name,gpointer user_data)
name|vectors_edit_attributes_callback
parameter_list|(
name|GtkWidget
modifier|*
