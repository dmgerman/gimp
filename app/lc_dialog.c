...
typedef|typedef
struct|struct
DECL|struct|__anon29e862cb0108
block|{
DECL|member|def
name|GImage
modifier|*
...
specifier|static
name|gint
DECL|function|lc_dialog_close_callback (GtkWidget * widget,gpointer data)
name|lc_dialog_close_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|lc_dialog_help_func (const gchar * help_data)
name|lc_dialog_help_func
parameter_list|(
specifier|const
name|gchar
