...
specifier|static
name|void
DECL|function|paint_mask_to_paint_area (GimpPaintCore * core,GeglBuffer * paint_mask,const GeglRectangle * paint_mask_rect,gdouble paint_opacity)
name|paint_mask_to_paint_area
parameter_list|(
name|GimpPaintCore
modifier|*
