...
specifier|static
name|void
name|canvas_buffer_to_paint_buffer
parameter_list|(
name|GimpPaintCore
modifier|*
name|core
...
begin_function
name|void
DECL|function|gimp_paint_core_paste (GimpPaintCore * core,GeglBuffer * paint_mask,const GeglRectangle * paint_mask_rect,GimpDrawable * drawable,gdouble paint_opacity,gdouble image_opacity,GimpLayerModeEffects paint_mode,GimpPaintApplicationMode mode)
...
begin_function
name|void
DECL|function|gimp_paint_core_replace (GimpPaintCore * core,GeglBuffer * paint_mask,const GeglRectangle * paint_mask_rect,GimpDrawable * drawable,gdouble paint_opacity,gdouble image_opacity,GimpPaintApplicationMode mode)
...
specifier|static
name|void
DECL|function|canvas_buffer_to_paint_buffer (GimpPaintCore * core)
name|canvas_buffer_to_paint_buffer
parameter_list|(
name|GimpPaintCore
modifier|*
...
specifier|static
name|void
DECL|function|paint_mask_to_canvas_buffer (GimpPaintCore * core,GeglBuffer * paint_mask,const GeglRectangle * paint_mask_rect,gdouble paint_opacity)
name|paint_mask_to_canvas_buffer
parameter_list|(
name|GimpPaintCore
modifier|*
...
specifier|static
name|void
DECL|function|paint_mask_to_paint_buffer (GimpPaintCore * core,GeglBuffer * paint_mask,const GeglRectangle * paint_mask_rect,gdouble paint_opacity)
name|paint_mask_to_paint_buffer
parameter_list|(
name|GimpPaintCore
modifier|*
