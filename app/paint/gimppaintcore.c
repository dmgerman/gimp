...
argument_list|)
expr_stmt|;
comment|/*  Set the image pickable  */
if|if
condition|(
operator|!
name|core
...
begin_function
name|void
DECL|function|gimp_paint_core_set_show_all (GimpPaintCore * core,gboolean show_all)
...
begin_function
name|gboolean
DECL|function|gimp_paint_core_get_show_all (GimpPaintCore * core)
...
name|GimpPickable
modifier|*
DECL|function|gimp_paint_core_get_image_pickable (GimpPaintCore * core)
...
name|mask_buffer
decl_stmt|;
comment|/*  If the mode is CONSTANT:        *   combine the paint mask to the canvas buffer, and use it as the mask        *   buffer        */
if|if
condition|(
name|mode
operator|==
...
expr_stmt|;
block|}
comment|/*  Otherwise:        *   use the paint mask as the mask buffer directly        */
else|else
block|{
name|mask_buffer
operator|=
...
name|GeglBuffer
modifier|*
name|combined_mask_buffer
decl_stmt|;
name|GeglRectangle
name|combined_mask_rect
decl_stmt|;
name|GeglRectangle
name|aligned_combined_mask_rect
decl_stmt|;
name|combined_mask_rect
operator|=
operator|*
