...
begin_decl_stmt
DECL|variable|non_gui_painting_tool
name|GimpPaintTool
modifier|*
name|non_gui_painting_tool
decl_stmt|;
end_decl_stmt

begin_decl_stmt
DECL|variable|non_gui_painting_tool_class
name|GimpPaintToolClass
modifier|*
name|non_gui_painting_tool_class
decl_stmt|;
end_decl_stmt
...
begin_function
DECL|function|standard_paint_func (GimpPaintTool * tool)
specifier|static
name|void
name|standard_paint_func
parameter_list|(
name|GimpPaintTool
modifier|*
name|tool
...
name|g_message
argument_list|(
literal|"sizeof GimpPaintTool = %i, GimpPaintToolClass = %i"
argument_list|,
sizeof|sizeof
argument_list|(
name|GimpPaintTool
...
name|g_message
argument_list|(
literal|"sizeof GimpDrawTool = %i, GimpDrawToolClass = %i"
argument_list|,
sizeof|sizeof
argument_list|(
name|GimpDrawTool
...
name|GimpPaintTool
modifier|*
DECL|function|gimp_paint_tool_new (void)
...
if|else if (tool->toggled) 	{ 	  switch (tool->type) 	    { 	    case ERASER: 	      ctype     = GIMP_MOUSE_CURSOR; 	      cmodifier = CURSOR_MODIFIER_MINUS; 	      break; 	    case CONVOLVE: 	      ctype     = GIMP_MOUSE_CURSOR; 	      cmodifier = CURSOR_MODIFIER_MINUS; 	      break; 	    case DODGEBURN: 	      ctype   = GIMP_MOUSE_CURSOR; 	      ctoggle = TRUE; 	      break; 	    default: 	      ctype = GIMP_MOUSE_CURSOR; 	      break; 	    } 	}
endif|#
directive|endif
...
block|}
block|}
comment|/* FIXME: install correct cursor */
comment|/*gdisplay_install_tool_cursor (gdisp, ctype, 				    ctype == GIMP_COLOR_PICKER_CURSOR ? 				    COLOR_PICKER : tool->type, 				    cmodifier, 				    ctoggle); */
block|}
block|}
end_function
...
begin_function
name|void
DECL|function|gimp_paint_tool_draw (GimpTool * tool)
...
specifier|static
name|void
DECL|function|gimp_paint_tool_initialize (GimpPaintTool * tool)
name|gimp_paint_tool_initialize
parameter_list|(
name|GimpPaintTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_paint_tool_class_init (GimpToolClass * klass)
name|gimp_paint_tool_class_init
parameter_list|(
name|GimpToolClass
modifier|*
...
name|g_message
argument_list|(
literal|"gimp_paint_tool_class_init"
argument_list|)
expr_stmt|;
name|klass
operator|->
...
begin_function
name|void
DECL|function|gimp_paint_tool_destroy (GimpTool * tool)
