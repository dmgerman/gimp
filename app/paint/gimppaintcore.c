...
specifier|static
name|void
DECL|function|gimp_paint_tool_invalidate_cache (GimpBrush * brush,GimpPaintTool * paint_tool)
name|gimp_paint_tool_invalidate_cache
parameter_list|(
name|GimpBrush
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_subsample_mask (GimpPaintTool * paint_tool,MaskBuf * mask,gdouble x,gdouble y)
name|gimp_paint_tool_subsample_mask
parameter_list|(
name|GimpPaintTool
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_pressurize_mask (GimpPaintTool * paint_tool,MaskBuf * brush_mask,gdouble x,gdouble y,gdouble pressure)
name|gimp_paint_tool_pressurize_mask
parameter_list|(
name|GimpPaintTool
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_solidify_mask (GimpPaintTool * paint_tool,MaskBuf * brush_mask)
name|gimp_paint_tool_solidify_mask
parameter_list|(
name|GimpPaintTool
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_scale_mask (GimpPaintTool * paint_tool,MaskBuf * brush_mask,gdouble scale)
name|gimp_paint_tool_scale_mask
parameter_list|(
name|GimpPaintTool
modifier|*
...
name|MaskBuf
modifier|*
DECL|function|gimp_paint_tool_scale_pixmap (GimpPaintTool * paint_tool,MaskBuf * brush_mask,gdouble scale)
name|gimp_paint_tool_scale_pixmap
parameter_list|(
name|GimpPaintTool
modifier|*
...
specifier|static
name|void
DECL|function|canvas_tiles_to_canvas_buf (GimpPaintTool * paint_tool)
name|canvas_tiles_to_canvas_buf
parameter_list|(
name|GimpPaintTool
modifier|*
...
begin_comment
unit|pixel_region_init (&srcPR, paint_tool->canvas_tiles, 		     paint_tool->canvas_buf->x,                      paint_tool->canvas_buf->y, 		     paint_tool->canvas_buf->width,                      paint_tool->canvas_buf->height,                      TRUE);    x = (gint) floor (paint_tool->cur_coords.x) - (brush_mask->width>> 1);   y = (gint) floor (paint_tool->cur_coords.y) - (brush_mask->height>> 1);   xoff = (x< 0) ? -x : 0;   yoff = (y< 0) ? -y : 0;    maskPR.bytes     = 1;   maskPR.x         = 0;   maskPR.y         = 0;   maskPR.w         = srcPR.w;   maskPR.h         = srcPR.h;   maskPR.rowstride = maskPR.bytes * brush_mask->width;   maskPR.data      = mask_buf_data (brush_mask) + (yoff * maskPR.rowstride +                                                    xoff * maskPR.bytes);
...
begin_comment
unit|srcPR.bytes     = paint_tool->canvas_buf->bytes;   srcPR.x         = 0;   srcPR.y         = 0;   srcPR.w         = paint_tool->canvas_buf->width;   srcPR.h         = paint_tool->canvas_buf->height;   srcPR.rowstride = paint_tool->canvas_buf->width * paint_tool->canvas_buf->bytes;   srcPR.data      = temp_buf_data (paint_tool->canvas_buf);    pixel_region_init (&maskPR, paint_tool->canvas_tiles, 		     paint_tool->canvas_buf->x,                      paint_tool->canvas_buf->y, 		     paint_tool->canvas_buf->width,                      paint_tool->canvas_buf->height,                      FALSE);
comment|/*  apply the canvas tiles to the canvas buf  */
end_comment
...
begin_comment
unit|srcPR.bytes     = paint_tool->canvas_buf->bytes;   srcPR.x         = 0;   srcPR.y         = 0;   srcPR.w         = paint_tool->canvas_buf->width;   srcPR.h         = paint_tool->canvas_buf->height;   srcPR.rowstride = paint_tool->canvas_buf->width * canvas_buf->bytes;   srcPR.data      = temp_buf_data (paint_tool->canvas_buf);    maskPR.bytes     = 1;   maskPR.x         = 0;   maskPR.y         = 0;   maskPR.w         = srcPR.w;   maskPR.h         = srcPR.h;   maskPR.rowstride = maskPR.bytes * brush_mask->width;   maskPR.data      = mask_buf_data (brush_mask) + yoff * maskPR.rowstride + xoff * maskPR.bytes;
comment|/*  apply the mask  */
end_comment
...
specifier|static
name|void
DECL|function|set_undo_tiles (GimpPaintTool * paint_tool,GimpDrawable * drawable,gint x,gint y,gint w,gint h)
name|set_undo_tiles
parameter_list|(
name|GimpPaintTool
modifier|*
...
specifier|static
name|void
DECL|function|set_canvas_tiles (GimpPaintTool * paint_tool,gint x,gint y,gint w,gint h)
name|set_canvas_tiles
parameter_list|(
name|GimpPaintTool
modifier|*
