...
expr_stmt|;
block|}
comment|/* Write canvas_buffer to the compositing mask */
name|algorithms
operator||=
...
argument_list|)
expr_stmt|;
comment|/* Write paint_mask to the compositing mask, does not modify            * canvas_buffer            */
name|params
operator|.
name|paint_mask
operator|=
