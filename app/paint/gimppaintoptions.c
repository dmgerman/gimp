...
begin_function
name|void
DECL|function|gimp_paint_options_copy_brush_props (GimpPaintOptions * src,GimpPaintOptions * dest)
...
begin_function
name|void
DECL|function|gimp_paint_options_copy_dynamics_props (GimpPaintOptions * src,GimpPaintOptions * dest)
...
begin_function
name|void
DECL|function|gimp_paint_options_copy_gradient_props (GimpPaintOptions * src,GimpPaintOptions * dest)
