...
begin_comment
comment|/* Calculates dynamics mix to be used for same parameter  * (velocity/pressure) mix Needed in may places and tools.  */
end_comment

begin_function
name|gdouble
DECL|function|gimp_paint_options_get_dynamics_mix (gdouble mix1,gdouble mix2)
