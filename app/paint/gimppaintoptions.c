...
argument_list|)
expr_stmt|;
comment|/*  after duplicating, copy those properties again which might have    *  changed by setting the brush on the copy, see    *  gimp_paint_options_brush_changed().    */
name|g_object_set
argument_list|(
name|new_options
argument_list|,
...
argument_list|)
decl_stmt|;
comment|/*  after copying, copy those properties again which might have        *  changed by setting the brush on dest, see        *  gimp_paint_options_brush_changed().        */
name|g_object_set
argument_list|(
name|dest
argument_list|,
