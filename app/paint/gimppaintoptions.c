...
begin_comment
comment|/* Calculates dynamics mix to be used for same parameter  * (velocity/pressure/random) mix Needed in may places and tools.  */
end_comment

begin_function
specifier|static
name|gdouble
DECL|function|gimp_paint_options_get_dynamics_mix (gdouble mix1,gdouble mix1_scale,gdouble mix2,gdouble mix2_scale,gdouble mix3,gdouble mix3_scale,gdouble mix4,gdouble mix4_scale)
name|gimp_paint_options_get_dynamics_mix
parameter_list|(
name|gdouble
name|mix1
