...
begin_define
DECL|macro|DEFAULT_PRESSURE_INVSIZE
define|#
directive|define
name|DEFAULT_PRESSURE_INVSIZE
value|FALSE
end_define
...
block|,
DECL|enumerator|PROP_PRESSURE_INVSIZE
name|PROP_PRESSURE_INVSIZE
block|,
