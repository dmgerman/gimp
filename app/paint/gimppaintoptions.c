...
begin_function
DECL|function|gimp_circular_queue_new (guint element_size,guint queue_size)
...
begin_function
DECL|function|gimp_circular_queue_free (GimpCircularQueue * queue)
name|void
...
begin_function
DECL|function|gimp_circular_queue_enqueue_data (GimpCircularQueue * queue,gpointer data)
name|void
...
begin_function
DECL|function|gimp_circular_queue_get_nth_offset (GimpCircularQueue * queue,guint index)
name|gpointer
...
begin_function
DECL|function|gimp_circular_queue_get_last_offset (GimpCircularQueue * queue)
name|gpointer
...
begin_define
DECL|macro|DEFAULT_SMOOTHING_HISTORY
define|#
directive|define
name|DEFAULT_SMOOTHING_HISTORY
value|20
end_define
...
block|,
DECL|enumerator|PROP_SMOOTHING_HISTORY
name|PROP_SMOOTHING_HISTORY
block|,
...
begin_function
DECL|function|gimp_paint_options_get_smoothed_coords (GimpPaintOptions * paint_options,const GimpCoords * original_coords,GimpCircularQueue * history)
name|GimpCoords
...
argument_list|)
expr_stmt|;
comment|/* If i == 0&& rate == 0.0, resulting value becomes zero.              * To avoid this, we treat this as a special case.              */
if|if
condition|(
name|i
operator|==
