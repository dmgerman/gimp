...
specifier|static
name|void
DECL|function|gimp_clone_set_property (GObject * object,guint property_id,const GValue * value,GParamSpec * pspec)
name|gimp_clone_set_property
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_clone_get_property (GObject * object,guint property_id,GValue * value,GParamSpec * pspec)
name|gimp_clone_get_property
parameter_list|(
name|GObject
modifier|*
