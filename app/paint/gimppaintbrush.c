...
condition|)
block|{
comment|/*         * jitter_x = g_random_double_range(-jitter, jitter);        * jitter_y = g_random_double_range(-jitter, jitter);        */
name|GIMP_BRUSH_CORE
argument_list|(
name|brush_core
argument_list|)
...
directive|if
literal|0
block|GIMP_PAINT_CORE (brush_core)->cur_coords.y 	= paint_core->last_coords.y + (jitter_y * brush_core->brush->y_axis.y);
endif|#
directive|endif
block|}
name|paint_appl_mode
