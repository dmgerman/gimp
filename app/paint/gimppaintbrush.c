...
specifier|static
name|void
DECL|function|gimp_paintbrush_real_get_paint_params (GimpPaintbrush * paintbrush,GimpDrawable * drawable,GimpPaintOptions * paint_options,GimpSymmetry * sym,gdouble grad_point,GimpLayerMode * paint_mode,GimpPaintApplicationMode * paint_appl_mode,const GimpTempBuf ** paint_pixmap,GimpRGB * paint_color)
name|gimp_paintbrush_real_get_paint_params
parameter_list|(
name|GimpPaintbrush
modifier|*
