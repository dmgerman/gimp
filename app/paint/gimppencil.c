...
condition|)
return|return;
comment|/* In keeping parallel with paintbrush... */
if|if
condition|(
name|pencil_options
condition|)
...
name|pressure_options
expr_stmt|;
comment|/*				gradient_options = pencil_options->paint_options.gradient_options; */
name|incremental
operator|=
name|pencil_options
operator|->
...
expr_stmt|;
comment|/*				gradient_options =&non_gui_gradient_options; */
name|incremental
operator|=
name|non_gui_incremental
expr_stmt|;
...
specifier|static
name|void
DECL|function|gimp_pencil_tool_motion (GimpPaintTool * paint_tool,GimpDrawable * drawable,PaintPressureOptions * pressure_options,gboolean increment)
name|gimp_pencil_tool_motion
parameter_list|(
name|GimpPaintTool
modifier|*
...
name|GimpTool
modifier|*
DECL|function|gimp_pencil_tool_new (void)
