...
specifier|static
name|void
DECL|function|gimp_convolve_paint (GimpPaintCore * paint_core,GimpDrawable * drawable,PaintOptions * paint_options,GimpPaintCoreState paint_state)
name|gimp_convolve_paint
parameter_list|(
name|GimpPaintCore
modifier|*
...
specifier|static
name|void
DECL|function|gimp_convolve_motion (GimpPaintCore * paint_core,GimpDrawable * drawable,PaintPressureOptions * pressure_options,ConvolveType type,gdouble rate)
name|gimp_convolve_motion
parameter_list|(
name|GimpPaintCore
modifier|*
