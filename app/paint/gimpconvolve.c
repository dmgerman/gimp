...
specifier|static
name|void
DECL|function|gimp_convolve_integer_matrix (const gfloat * source,gint * dest,gint size)
name|gimp_convolve_integer_matrix
parameter_list|(
specifier|const
name|gfloat
...
specifier|static
name|gint
DECL|function|gimp_convolve_sum_matrix (const gint * matrix,gint size)
name|gimp_convolve_sum_matrix
parameter_list|(
specifier|const
name|gint
