...
specifier|static
name|void
DECL|function|gimp_dodgeburn_paint (GimpPaintCore * paint_core,GimpDrawable * drawable,PaintOptions * paint_options,GimpPaintCoreState paint_state)
name|gimp_dodgeburn_paint
parameter_list|(
name|GimpPaintCore
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dodgeburn_motion (GimpPaintCore * paint_core,GimpDrawable * drawable,PaintOptions * paint_options)
name|gimp_dodgeburn_motion
parameter_list|(
name|GimpPaintCore
modifier|*
