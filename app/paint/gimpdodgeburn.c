...
specifier|static
name|void
DECL|function|gimp_dodge_burn_paint (GimpPaintCore * paint_core,GimpDrawable * drawable,GimpPaintOptions * paint_options,GimpSymmetry * sym,GimpPaintState paint_state,guint32 time)
name|gimp_dodge_burn_paint
parameter_list|(
name|GimpPaintCore
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dodge_burn_motion (GimpPaintCore * paint_core,GimpDrawable * drawable,GimpPaintOptions * paint_options,GimpSymmetry * sym)
name|gimp_dodge_burn_motion
parameter_list|(
name|GimpPaintCore
modifier|*
