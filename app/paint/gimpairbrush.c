...
name|void
modifier|*
DECL|function|airbrush_paint_func (PaintCore * paint_core,int drawable_id,int state)
...
specifier|static
name|void
DECL|function|airbrush_motion (PaintCore * paint_core,int drawable_id,double pressure)
name|airbrush_motion
parameter_list|(
name|PaintCore
modifier|*
...
name|void
modifier|*
DECL|function|airbrush_non_gui_paint_func (PaintCore * paint_core,int drawable_id,int state)
