...
specifier|static
name|void
name|gimp_clone_set_src_pickable
parameter_list|(
name|GimpClone
modifier|*
name|clone
...
specifier|static
name|void
DECL|function|gimp_clone_src_pickable_disconnect_cb (GimpPickable * pickable,GimpClone * clone)
name|gimp_clone_src_pickable_disconnect_cb
parameter_list|(
name|GimpPickable
modifier|*
name|pickable
...
specifier|static
name|void
DECL|function|gimp_clone_set_src_pickable (GimpClone * clone,GimpPickable * pickable)
name|gimp_clone_set_src_pickable
parameter_list|(
name|GimpClone
modifier|*
