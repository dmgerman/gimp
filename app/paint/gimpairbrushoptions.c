...
begin_function
name|GType
DECL|function|gimp_airbrush_options_get_type (void)
...
specifier|static
name|void
DECL|function|gimp_airbrush_options_class_init (GimpAirbrushOptionsClass * klass)
name|gimp_airbrush_options_class_init
parameter_list|(
name|GimpAirbrushOptionsClass
modifier|*
