...
name|Blob
modifier|*
DECL|function|blob_polygon (BlobPoint * points,int npoints)
name|blob_polygon
parameter_list|(
name|BlobPoint
modifier|*
...
name|Blob
modifier|*
DECL|function|blob_square (double xc,double yc,double xp,double yp,double xq,double yq)
name|blob_square
parameter_list|(
name|double
name|xc
...
name|Blob
modifier|*
DECL|function|blob_diamond (double xc,double yc,double xp,double yp,double xq,double yq)
name|blob_diamond
parameter_list|(
name|double
name|xc
