...
specifier|static
name|void
DECL|function|eraser_cursor_update (Tool * tool,GdkEventMotion * mevent,gpointer gdisp_ptr)
name|eraser_cursor_update
parameter_list|(
name|Tool
modifier|*
name|tool
...
name|GDK_PENCIL
expr_stmt|;
comment|/* ANTI_ERASER CURSOR */
else|else
name|ctype
operator|=
name|GDK_PENCIL
expr_stmt|;
comment|/* ERASER CURSOR */
block|}
block|}
block|}
