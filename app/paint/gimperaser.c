...
specifier|static
name|gboolean
name|gimp_eraser_get_color_history_color
parameter_list|(
name|GimpPaintbrush
modifier|*
name|paintbrush
...
specifier|static
name|gboolean
DECL|function|gimp_eraser_get_color_history_color (GimpPaintbrush * paintbrush,GimpDrawable * drawable,GimpPaintOptions * paint_options,GimpRGB * color)
name|gimp_eraser_get_color_history_color
parameter_list|(
name|GimpPaintbrush
modifier|*
