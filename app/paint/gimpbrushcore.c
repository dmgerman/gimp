...
specifier|static
name|gdouble
DECL|function|gimp_brush_core_calc_brush_scale (GimpBrushCore * core,GimpPaintOptions * paint_options,gdouble pressure,gdouble velocity)
name|gimp_brush_core_calc_brush_scale
parameter_list|(
name|GimpBrushCore
modifier|*
