...
name|GimpTempBuf
modifier|*
DECL|function|gimp_brush_core_get_brush_pixmap (GimpBrushCore * core,GeglNode * op)
...
begin_function
name|void
DECL|function|gimp_brush_core_color_area_with_pixmap (GimpBrushCore * core,GimpDrawable * drawable,const GimpCoords * coords,GeglNode * op,GeglBuffer * area,gint area_x,gint area_y,gboolean apply_mask)
