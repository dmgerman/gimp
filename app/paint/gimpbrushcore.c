...
name|brush_angle
expr_stmt|;
comment|/* gimp_paint_options_get_dynamic_angle (paint_options, coords,                                                           paint_core->pixel_dist);*/
name|core
operator|->
name|aspect_ratio
operator|=
...
expr_stmt|;
comment|/*        gimp_paint_options_get_dynamic_aspect_ratio (paint_options, coords,                                                      paint_core->pixel_dist);*/
block|}
name|core
operator|->
name|spacing
...
comment|/*   lastscale = MIN (last_coords.pressure, 1/256);                   */
comment|/*   curscale = MIN (current_coords.pressure,  1/256);                */
comment|/*   spacing = core->spacing * sqrt (0.5 * (lastscale + curscale));   */
