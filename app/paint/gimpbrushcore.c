...
begin_enum
enum|enum
DECL|enum|__anon2c3e0a660103
DECL|enum|__anon2c3e0a660203
block|{
...
specifier|static
name|gdouble
DECL|function|gimp_brush_core_calc_brush_size (GimpBrushCore * core,GimpBrush * brush,gdouble scale,gint * width,gint * height)
DECL|function|gimp_brush_core_calc_brush_size (GimpBrushCore * core,GimpBrush * brush,gdouble scale,gint * width,gint * height)
name|gimp_brush_core_calc_brush_size
parameter_list|(
name|GimpBrushCore
