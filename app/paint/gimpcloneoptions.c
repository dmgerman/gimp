...
specifier|static
name|void
name|gimp_clone_options_notify
parameter_list|(
name|GObject
modifier|*
name|object
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpCloneOptions,gimp_clone_options,GIMP_TYPE_SOURCE_OPTIONS)
name|G_DEFINE_TYPE
argument_list|(
...
argument_list|,
argument|GIMP_TYPE_SOURCE_OPTIONS
argument_list|)
end_macro
...
directive|define
name|parent_class
value|gimp_clone_options_parent_class
end_define
...
specifier|static
name|void
DECL|function|gimp_clone_options_notify (GObject * object,GParamSpec * pspec)
name|gimp_clone_options_notify
parameter_list|(
name|GObject
modifier|*
