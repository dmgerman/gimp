...
specifier|static
name|void
DECL|function|offset_fill_type_update (GtkWidget * widget,gpointer data)
name|offset_fill_type_update
parameter_list|(
name|GtkWidget
modifier|*
...
comment|/*       pixel_region_init (&srcPR, gimp_image_projection (oldgimage), 0, 0, 			 oldgimage->width, oldgimage->height, FALSE);       pixel_region_init (&destPR, gimp_image_projection (newgimage), 0, 0, 			 newgimage->width, newgimage->height, TRUE); 			 copy_region(&srcPR,&destPR);*/
name|pixel_region_init
argument_list|(
operator|&
name|srcPR
