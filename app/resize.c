...
begin_comment
comment|/*  * Callback function for "Reset" button.  * Data must be a pointer pointer to a Resize structure.  */
end_comment
...
specifier|static
name|void
DECL|function|resize_scale_warn_callback (GtkWidget * widget,gboolean do_scale,gpointer data)
name|resize_scale_warn_callback
parameter_list|(
name|GtkWidget
modifier|*
