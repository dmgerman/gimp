...
name|_
argument_list|(
literal|"Pixel Dimensions& Image Unit"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
...
argument_list|)
expr_stmt|;
comment|/*  the scale ratio labels and spinbuttons  */
name|label
operator|=
name|gtk_label_new
argument_list|(
...
specifier|static
name|void
DECL|function|size_update (GtkWidget * w,gpointer data)
name|size_update
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|ratio_update (GtkWidget * w,gpointer data)
name|ratio_update
parameter_list|(
name|GtkWidget
modifier|*
