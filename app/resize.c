...
begin_comment
comment|/*  TODO: - move size/resolution constants to a central place  *        - agree on reasonable values ;)  */
end_comment

begin_define
DECL|macro|MIN_IMAGE_SIZE
define|#
directive|define
name|MIN_IMAGE_SIZE
value|1
...
name|object
decl_stmt|;
DECL|member|object_destroy_handler
name|guint
name|object_destroy_handler
decl_stmt|;
DECL|member|ratio
name|double
name|ratio
...
name|Resize
modifier|*
DECL|function|resize_widget_new (ResizeType type,ResizeTarget target,GtkObject * object,int width,int height,float resolution_x,float resolution_y,GUnit unit,gboolean dot_for_dot,GtkSignalFunc ok_cb,GtkSignalFunc cancel_cb,gint (* delete_cb)(GtkWidget *,GdkEvent *,gpointer),gpointer user_data)
...
condition|)
block|{
comment|/*  compare ratios, not sizes because we need float values        */
if|if
condition|(
name|ratio_x
operator|!=
