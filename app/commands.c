...
begin_function
name|void
DECL|function|edit_show_undo_history_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|view_window_nav_cmd_callback (GtkWidget * widget,gpointer client_data)
...
begin_function
name|void
DECL|function|gimp_help_cmd_callback (GtkWidget * widget,gpointer client_data)
