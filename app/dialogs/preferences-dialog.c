...
specifier|static
name|void
DECL|function|prefs_profile_combo_box_set_active (GimpColorProfileComboBox * combo,const gchar * filename)
name|prefs_profile_combo_box_set_active
parameter_list|(
...
name|GdkPixbuf
modifier|*
DECL|function|prefs_get_pixbufs (Gimp * gimp,const gchar * name,GdkPixbuf ** small_pixbuf)
