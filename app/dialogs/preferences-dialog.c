...
include|#
directive|include
file|"widgets/gimpiconsizescale.h"
end_include

begin_include
include|#
directive|include
file|"widgets/gimplanguagecombobox.h"
end_include
...
specifier|static
name|void
name|prefs_color_management_reset
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|prefs_dialog_defaults_reset
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|prefs_help_language_change_callback
parameter_list|(
name|GtkComboBox
modifier|*
name|combo
...
specifier|static
name|void
name|prefs_help_language_change_callback2
parameter_list|(
name|GtkComboBox
modifier|*
name|combo
...
specifier|static
name|void
name|prefs_sensitive_debug_on_success
parameter_list|(
name|GPid
name|pid
parameter_list|,
...
specifier|static
name|void
name|prefs_notify_sensitive_debug
parameter_list|(
name|GtkWidget
modifier|*
name|button
...
specifier|static
name|void
name|prefs_hide_widget_on_success
parameter_list|(
name|GPid
name|pid
parameter_list|,
...
specifier|static
name|void
DECL|function|prefs_color_management_reset (GtkWidget * widget,GObject * config)
name|prefs_color_management_reset
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|prefs_dialog_defaults_reset (GtkWidget * widget,GObject * config)
name|prefs_dialog_defaults_reset
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|prefs_import_raw_procedure_callback (GtkWidget * widget,GObject * config)
name|prefs_import_raw_procedure_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|prefs_help_language_change_callback (GtkComboBox * combo,Gimp * gimp)
name|prefs_help_language_change_callback
parameter_list|(
name|GtkComboBox
modifier|*
...
specifier|static
name|void
DECL|function|prefs_help_language_change_callback2 (GtkComboBox * combo,GtkContainer * box)
name|prefs_help_language_change_callback2
parameter_list|(
name|GtkComboBox
modifier|*
...
specifier|static
name|void
DECL|function|prefs_sensitive_debug_on_success (GPid pid,gint status,GtkWidget * widget)
name|prefs_sensitive_debug_on_success
parameter_list|(
name|GPid
name|pid
...
name|widget
argument_list|,
name|g_spawn_check_exit_status
argument_list|(
name|status
argument_list|,
name|NULL
...
specifier|static
name|void
DECL|function|prefs_notify_sensitive_debug (GtkWidget * button,GParamSpec * pspec,GtkWidget * label)
name|prefs_notify_sensitive_debug
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|prefs_hide_widget_on_success (GPid pid,gint status,GtkWidget * widget)
name|prefs_hide_widget_on_success
parameter_list|(
name|GPid
name|pid
...
specifier|static
name|void
DECL|function|prefs_icon_theme_select_callback (GtkTreeSelection * sel,Gimp * gimp)
name|prefs_icon_theme_select_callback
parameter_list|(
name|GtkTreeSelection
modifier|*
name|sel
...
specifier|static
name|void
DECL|function|prefs_behavior_options_frame_add (Gimp * gimp,GObject * object,const gchar * label,GtkContainer * parent)
name|prefs_behavior_options_frame_add
parameter_list|(
name|Gimp
modifier|*
name|gimp
...
name|_
argument_list|(
literal|"This feature requires \"gdb\" or \"lldb\" installed on your system."
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_widget_set_sensitive
...
name|_
argument_list|(
literal|"This feature is more efficient with \"gdb\" or \"lldb\" installed on your system."
argument_list|)
argument_list|)
expr_stmt|;
endif|#
...
directive|ifndef
name|HAVE_EXECINFO_H
name|g_child_watch_add
argument_list|(
name|pid
argument_list|,
operator|(
name|GChildWatchFunc
operator|)
name|prefs_sensitive_debug_on_success
argument_list|,
name|button
...
name|_
argument_list|(
literal|"Use _black point compensation"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_table_attach_defaults
...
name|_
argument_list|(
literal|"Precision / Color Fidelity"
argument_list|)
argument_list|,
name|_
argument_list|(
...
name|_
argument_list|(
literal|"Use black _point compensation"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_table_attach_defaults
...
name|_
argument_list|(
literal|"Select Preferred RGB Color Profile"
argument_list|)
argument_list|,
name|_
argument_list|(
...
name|_
argument_list|(
literal|"Select Preferred Grayscale Color Profile"
argument_list|)
argument_list|,
name|_
argument_list|(
...
name|_
argument_list|(
literal|"_N-Point Deformation tool"
argument_list|)
argument_list|,
name|GTK_BOX
argument_list|(
...
expr_stmt|;
comment|/**********************************/
comment|/*  Default Image / Default Grid  */
comment|/**********************************/
name|vbox
operator|=
name|gimp_prefs_box_add_page
...
argument_list|)
expr_stmt|;
name|gtk_icon_theme_set_custom_theme
argument_list|(
name|theme
argument_list|,
name|icon_themes
...
name|example
operator|=
name|gtk_icon_theme_get_example_icon_name
argument_list|(
name|theme
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|/* If the icon theme didn't explicitly specify an example              * icon, try "gimp-wilber".              */
name|example
operator|=
name|g_strdup
argument_list|(
...
name|_
argument_list|(
literal|"Show GIMP _logo (drag-and-drop target)"
argument_list|)
argument_list|,
...
expr_stmt|;
comment|/*********************************/
comment|/*  Interface / Dialog Defaults  */
comment|/*********************************/
name|vbox
operator|=
name|gimp_prefs_box_add_page
...
argument_list|)
argument_list|,
comment|/* FIXME need an icon */
literal|"gimp-prefs-controllers"
argument_list|,
name|_
argument_list|(
literal|"Dialog Defaults"
argument_list|)
argument_list|,
name|_
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  Color profile import dialog  */
name|vbox2
operator|=
name|prefs_frame_new
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  Convert to Color Profile Dialog  */
name|vbox2
operator|=
name|prefs_frame_new
argument_list|(
name|_
argument_list|(
literal|"Convert to Color Profile Dialog"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  Convert Precision Dialog  */
name|vbox2
operator|=
name|prefs_frame_new
argument_list|(
name|_
argument_list|(
literal|"Precision Conversion Dialog"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  Convert Indexed Dialog  */
name|vbox2
operator|=
name|prefs_frame_new
argument_list|(
name|_
argument_list|(
literal|"Indexed Conversion Dialog"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
name|object
argument_list|,
literal|"image-convert-indexed-palette-type"
argument_list|,
literal|0
argument_list|,
literal|0
...
name|object
argument_list|,
literal|"image-convert-indexed-max-colors"
argument_list|,
literal|1.0
argument_list|,
literal|8.0
...
name|object
argument_list|,
literal|"image-convert-indexed-remove-duplicates"
argument_list|,
name|_
argument_list|(
literal|"Remove unused and duplicate colors "
...
name|object
argument_list|,
literal|"image-convert-indexed-dither-type"
argument_list|,
literal|0
argument_list|,
literal|0
...
name|object
argument_list|,
literal|"image-convert-indexed-dither-alpha"
argument_list|,
name|_
argument_list|(
...
name|object
argument_list|,
literal|"image-convert-indexed-dither-text-layers"
argument_list|,
name|_
argument_list|(
...
name|object
argument_list|,
literal|"image-resize-fill-type"
argument_list|,
literal|0
argument_list|,
literal|0
...
name|object
argument_list|,
literal|"image-resize-layer-set"
argument_list|,
literal|0
argument_list|,
literal|0
...
name|object
argument_list|,
literal|"image-resize-resize-text-layers"
argument_list|,
name|_
argument_list|(
literal|"Resize text layers"
argument_list|)
argument_list|,
name|GTK_BOX
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  Layer Boundary Size Dialog  */
name|vbox2
operator|=
name|prefs_frame_new
argument_list|(
name|_
argument_list|(
literal|"Layer Boundary Size Dialog"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
name|_
argument_list|(
literal|"Merge within active group only"
argument_list|)
argument_list|,
name|GTK_BOX
argument_list|(
...
name|_
argument_list|(
literal|"Discard invisible layers"
argument_list|)
argument_list|,
name|GTK_BOX
argument_list|(
...
name|_
argument_list|(
literal|"Export the active path only"
argument_list|)
argument_list|,
name|GTK_BOX
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  Feather Selection Dialog  */
name|vbox2
operator|=
name|prefs_frame_new
argument_list|(
name|_
argument_list|(
literal|"Feather Selection Dialog"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  Shrink Selection Dialog  */
name|vbox2
operator|=
name|prefs_frame_new
argument_list|(
name|_
argument_list|(
literal|"Shrink Selection Dialog"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  Border Selection Dialog  */
name|vbox2
operator|=
name|prefs_frame_new
argument_list|(
name|_
argument_list|(
literal|"Border Selection Dialog"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
name|_
argument_list|(
literal|"Fill Selection Outline& Fill Path Dialogs"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
name|_
argument_list|(
literal|"Stroke Selection& Stroke Path Dialogs"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
name|_
argument_list|(
literal|"User interface language"
argument_list|)
argument_list|)
expr_stmt|;
name|g_object_get
...
name|_
argument_list|(
literal|"There's a local installation "
literal|"of the user manual."
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|_
argument_list|(
literal|"The user manual is not installed "
literal|"locally."
argument_list|)
argument_list|)
expr_stmt|;
...
directive|ifdef
name|HAVE_WEBKIT
comment|/*  If there is no webkit available, assume we are on a platform    *  that doesn't use the help browser, so don't bother showing    *  the combo.    */
name|vbox2
operator|=
name|prefs_frame_new
argument_list|(
...
name|_
argument_list|(
literal|"The GIMP help browser doesn't seem to "
literal|"be installed. Using the web browser "
literal|"instead."
argument_list|)
argument_list|)
expr_stmt|;
...
name|_
argument_list|(
literal|"Show _unavailable actions"
argument_list|)
argument_list|,
name|GTK_BOX
argument_list|(
...
block|}
comment|/******************************/
comment|/*  Image Windows / Snapping  */
comment|/******************************/
name|vbox
operator|=
name|gimp_prefs_box_add_page
...
argument_list|)
argument_list|,
literal|"gimp-prefs-image-windows-snapping"
argument_list|,
name|_
argument_list|(
...
name|_
argument_list|(
literal|"Default Behavior in Normal Mode"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
name|_
argument_list|(
literal|"Default Behavior in Fullscreen Mode"
argument_list|)
argument_list|,
name|GTK_CONTAINER
argument_list|(
...
name|N_
argument_list|(
literal|"Select Dynamics Folders"
argument_list|)
block|,
...
name|N_
argument_list|(
literal|"Select MyPaint Brush Folders"
argument_list|)
block|,
