...
name|_
argument_list|(
literal|"Check for updates (requires internet)"
argument_list|)
argument_list|,
name|GTK_BOX
argument_list|(
...
literal|3
argument_list|,
name|CAIRO_GOBJECT_TYPE_SURFACE
argument_list|,
name|G_TYPE_STRING
argument_list|,
name|G_TYPE_STRING
...
name|g_strdup
argument_list|(
literal|"gimp-wilber-symbolic"
argument_list|)
expr_stmt|;
block|}
name|surface
operator|=
name|gtk_icon_theme_load_surface
argument_list|(
name|theme
argument_list|,
name|example
...
decl_stmt|;
struct|struct
DECL|struct|__anon2ba67ed10108
block|{
...
specifier|const
struct|struct
DECL|struct|__anon2ba67ed10208
block|{
DECL|member|property_name
specifier|const
name|gchar
...
specifier|const
struct|struct
DECL|struct|__anon2ba67ed10308
block|{
