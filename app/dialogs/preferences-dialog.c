...
argument_list|)
expr_stmt|;
comment|/* Check existence of gdb or lldb to activate the preference, as a    * good hint of its prerequisite.    */
block|{
name|gchar
modifier|*
name|args
...
decl_stmt|;
struct|struct
DECL|struct|__anon292eefc70108
block|{
...
specifier|const
struct|struct
DECL|struct|__anon292eefc70208
block|{
DECL|member|property_name
specifier|const
name|gchar
...
specifier|const
struct|struct
DECL|struct|__anon292eefc70308
block|{
