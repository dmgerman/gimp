...
name|_
argument_list|(
literal|"_Optimize display color transforms"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_table_attach_defaults
...
name|_
argument_list|(
literal|"O_ptimize simulation color transforms"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_table_attach_defaults
...
decl_stmt|;
struct|struct
DECL|struct|__anon2a3d380d0108
block|{
...
specifier|const
struct|struct
DECL|struct|__anon2a3d380d0208
block|{
DECL|member|property_name
specifier|const
name|gchar
...
specifier|const
struct|struct
DECL|struct|__anon2a3d380d0308
block|{
