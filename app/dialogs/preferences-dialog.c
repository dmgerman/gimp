...
directive|if
literal|0
block|text = gtk_text_new (NULL, NULL);   gtk_text_set_editable (GTK_TEXT (text), TRUE);   gtk_text_insert (GTK_TEXT (text), NULL, NULL, NULL, 		   the_gimp->config->default_comment, -1);   gtk_container_add (GTK_CONTAINER (hbox), text);   gtk_widget_show (text);    g_signal_connect (G_OBJECT (text), "changed", 		    G_CALLBACK (prefs_text_callback),&the_gimp->config->default_comment);
endif|#
directive|endif
...
specifier|const
struct|struct
DECL|struct|__anon274e73180208
block|{
DECL|member|label
name|gchar
modifier|*
...
specifier|const
struct|struct
DECL|struct|__anon274e73180308
block|{
