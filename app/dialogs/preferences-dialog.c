...
directive|if
literal|0
block|text = gtk_text_new (NULL, NULL);   gtk_text_set_editable (GTK_TEXT (text), TRUE);   gtk_text_insert (GTK_TEXT (text), NULL, NULL, NULL, 		   the_gimp->config->default_comment, -1);   gtk_signal_connect (GTK_OBJECT (text), "changed", 		      GTK_SIGNAL_FUNC (prefs_text_callback),&the_gimp->config->default_comment);   gtk_container_add (GTK_CONTAINER (hbox), text);   gtk_widget_show (text);
endif|#
directive|endif
...
specifier|const
struct|struct
DECL|struct|__anon27856c390208
block|{
DECL|member|label
name|gchar
modifier|*
...
specifier|const
struct|struct
DECL|struct|__anon27856c390308
block|{
