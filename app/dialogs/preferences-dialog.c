...
specifier|static
name|gboolean
DECL|function|prefs_idle_unref (gpointer data)
name|prefs_idle_unref
parameter_list|(
name|gpointer
name|data
parameter_list|)
...
decl_stmt|;
struct|struct
DECL|struct|__anon277395940108
block|{
...
block|}
comment|/********************************/
comment|/*  Image Windows / Behavior  */
comment|/********************************/
name|pixbuf
operator|=
name|prefs_get_pixbufs
...
name|_
argument_list|(
literal|"Image Window Drawing Behavior"
argument_list|)
argument_list|,
name|pixbuf
argument_list|,
...
specifier|const
struct|struct
DECL|struct|__anon277395940208
block|{
DECL|member|label
specifier|const
name|gchar
...
specifier|const
struct|struct
DECL|struct|__anon277395940308
block|{
DECL|member|property_name
specifier|const
name|gchar
...
specifier|const
struct|struct
DECL|struct|__anon277395940408
block|{
