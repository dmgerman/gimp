...
argument_list|)
expr_stmt|;
comment|/*  read the saved gimprc to get GIMP_PARAM_RESTART values  */
block|{
name|GimpRc
modifier|*
name|gimprc
...
decl_stmt|;
struct|struct
DECL|struct|__anon27cd2e7c0108
block|{
...
specifier|const
struct|struct
DECL|struct|__anon27cd2e7c0208
block|{
DECL|member|label
specifier|const
name|gchar
...
specifier|const
struct|struct
DECL|struct|__anon27cd2e7c0308
block|{
