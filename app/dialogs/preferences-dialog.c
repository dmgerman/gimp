...
parameter_list|)
block|{
comment|/* General sketch:    +      Frame VBox                     +     +    Checkbox HBox                +      + Checks VBox  + + Checks VBox  +       Menubar          Selection       Rulers           Active layer       Scrollbars       Guides       Statusbar        Grid      +              + +              +      +                                 +     Canvas padding     Custom color   +                                     +   */
name|GtkBox
modifier|*
name|box
decl_stmt|;
