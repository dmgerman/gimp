...
specifier|static
name|gboolean
name|file_save_dialog_overwrite
parameter_list|(
name|GtkWidget
modifier|*
name|save_dialog
...
specifier|static
name|gboolean
DECL|function|file_save_dialog_check_uri (GtkWidget * save_dialog,Gimp * gimp,gchar ** ret_uri,PlugInProcDef ** ret_save_proc)
name|file_save_dialog_check_uri
parameter_list|(
name|GtkWidget
modifier|*
...
name|g_print
argument_list|(
literal|"%s: appending .%s to basename without any extension\n"
argument_list|,
name|G_STRFUNC
argument_list|,
name|ext
...
specifier|static
name|gboolean
DECL|function|file_save_dialog_overwrite (GtkWidget * save_dialog,const gchar * uri)
name|file_save_dialog_overwrite
parameter_list|(
name|GtkWidget
modifier|*
