...
name|image
decl_stmt|;
DECL|member|current_profile
name|GimpColorProfile
modifier|*
name|current_profile
decl_stmt|;
DECL|member|default_profile
name|GimpColorProfile
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|color_profile_dialog_new (ColorProfileDialogType dialog_type,GimpImage * image,GimpContext * context,GtkWidget * parent,GimpColorProfile * current_profile,GimpColorProfile * default_profile,GimpColorRenderingIntent intent,gboolean bpc,GimpColorProfileCallback callback,gpointer user_data)
...
name|_
argument_list|(
literal|"Select Soft-Proof Profile"
argument_list|)
argument_list|,
name|parent
argument_list|,
...
specifier|static
name|void
DECL|function|color_profile_dialog_response (GtkWidget * dialog,gint response_id,ProfileDialog * private)
name|color_profile_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|color_profile_dest_changed (GtkWidget * combo,ProfileDialog * private)
name|color_profile_dest_changed
parameter_list|(
name|GtkWidget
modifier|*
