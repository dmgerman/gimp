...
name|_
argument_list|(
literal|"<b>The GIMP tips file is empty!</b>"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|_
argument_list|(
literal|"<b>The GIMP tips file appears to be "
literal|"missing!</b>\n\n"
...
name|_
argument_list|(
literal|"<b>The GIMP tips file could not be "
literal|"parsed:</b>\n\n%s"
argument_list|)
argument_list|,
name|error
