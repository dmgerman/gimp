...
specifier|static
name|void
name|layer_options_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
...
specifier|static
name|void
DECL|function|layer_options_dialog_response (GtkWidget * dialog,gint response_id,LayerOptionsDialog * private)
name|layer_options_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
