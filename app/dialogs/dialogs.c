...
name|FOREIGN
argument_list|(
literal|"gimp-unified-transform-tool-dialog"
argument_list|,
name|TRUE
argument_list|,
name|FALSE
...
name|FOREIGN
argument_list|(
literal|"gimp-handle-transform-tool-dialog"
argument_list|,
name|TRUE
argument_list|,
name|FALSE
...
argument_list|,
name|dialogs_action_search_get
argument_list|,
name|TRUE
argument_list|,
name|TRUE
...
argument_list|,
name|dialogs_symmetry_editor_new
argument_list|,
literal|0
argument_list|,
name|FALSE
...
name|GtkWidget
modifier|*
DECL|function|dialogs_get_dialog (GObject * attach_object,const gchar * attach_key)
...
begin_function
name|void
DECL|function|dialogs_attach_dialog (GObject * attach_object,const gchar * attach_key,GtkWidget * dialog)
...
argument_list|)
argument_list|,
literal|"gimp-dialogs-attach-key"
argument_list|,
operator|(
name|gpointer
operator|)
...
begin_function
name|void
DECL|function|dialogs_detach_dialog (GObject * attach_object,GtkWidget * dialog)
name|dialogs_detach_dialog
parameter_list|(
name|GObject
modifier|*
...
begin_function
name|void
DECL|function|dialogs_destroy_dialog (GObject * attach_object,const gchar * attach_key)
