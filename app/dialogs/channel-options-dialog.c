...
specifier|static
name|void
name|channel_options_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
...
name|GtkWidget
modifier|*
DECL|function|channel_options_dialog_new (GimpImage * image,GimpChannel * channel,GimpContext * context,GtkWidget * parent,const gchar * title,const gchar * role,const gchar * icon_name,const gchar * desc,const gchar * help_id,const gchar * channel_name,const GimpRGB * channel_color,const gchar * color_label,const gchar * opacity_label,gboolean show_from_sel,GimpChannelOptionsCallback callback,gpointer user_data)
...
specifier|static
name|void
DECL|function|channel_options_dialog_response (GtkWidget * dialog,gint response_id,ChannelOptionsDialog * private)
name|channel_options_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|channel_options_opacity_update (GtkAdjustment * adjustment,GimpColorButton * color_button)
name|channel_options_opacity_update
parameter_list|(
name|GtkAdjustment
modifier|*
