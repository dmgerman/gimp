...
modifier|*
DECL|function|channel_options_dialog_new (GimpImage * gimage,GimpContext * context,GimpChannel * channel,GtkWidget * parent,const GimpRGB * channel_color,const gchar * channel_name,const gchar * title,const gchar * role,const gchar * stock_id,const gchar * desc,const gchar * help_id,const gchar * color_label,const gchar * opacity_label)
