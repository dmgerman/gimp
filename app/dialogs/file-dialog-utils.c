...
name|GtkWidget
modifier|*
DECL|function|file_dialog_new (Gimp * gimp,GimpMenuFactory * menu_factory,const gchar * menu_identifier,const gchar * title,const gchar * wmclass_name,const gchar * help_data,GCallback ok_callback)
