...
name|container
decl_stmt|;
DECL|member|duplicates_toggle
name|GtkWidget
modifier|*
name|duplicates_toggle
decl_stmt|;
block|}
struct|;
end_struct
...
specifier|static
name|void
name|convert_dialog_type_update
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|convert_dialog_type_update (GtkWidget * widget,IndexedDialog * private)
name|convert_dialog_type_update
parameter_list|(
name|GtkWidget
modifier|*
