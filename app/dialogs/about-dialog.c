...
comment|/* we'd prefer just the names, please no email addresses.    */
name|N_
argument_list|(
...
typedef|typedef
struct|struct
DECL|struct|__anon2ba749930108
block|{
...
literal|32
expr_stmt|;
comment|/* gets changed in _expose () as well */
name|about_info
operator|.
name|textarea
operator|.
...
specifier|static
name|void
DECL|function|about_dialog_center (GtkWindow * window)
name|about_dialog_center
parameter_list|(
name|GtkWindow
modifier|*
