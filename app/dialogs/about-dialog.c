...
directive|if
literal|0
block|GtkStyle  *style;   GdkFont   *font;
endif|#
directive|endif
name|gint
name|max_width
...
directive|if
literal|0
block|font = gdk_font_load (_("-*-helvetica-medium-r-normal--*-140-*-*-*-*-*-*"));       if (font) 	{ 	  style = gtk_style_new (); 	  gdk_font_unref (style->font); 	  style->font = font; 	  gdk_font_ref (style->font); 	  gtk_widget_push_style (style); 	  gtk_style_unref (style); 	}
endif|#
directive|endif
name|label_text
operator|=
