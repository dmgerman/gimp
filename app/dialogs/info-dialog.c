...
expr_stmt|;
comment|/*  without blocking the first (num - 1) fields, a signal would        *  be emitted along with every gimp_size_entry_set_refval()...        */
...
argument_list|)
expr_stmt|;
comment|/*  ...so block them and emit the signal for the last field only        */
name|gimp_size_entry_set_refval
argument_list|(
name|GIMP_SIZE_ENTRY
argument_list|(
...
name|GtkWidget
modifier|*
DECL|function|info_dialog_add_scale (InfoDialog * idialog,gchar * title,gdouble * value_ptr,gfloat lower,gfloat upper,gfloat step_increment,gfloat page_increment,gfloat page_size,gint digits,GtkSignalFunc callback,gpointer data)
...
name|GtkWidget
modifier|*
DECL|function|info_dialog_add_spinbutton (InfoDialog * idialog,gchar * title,gdouble * value_ptr,gfloat lower,gfloat upper,gfloat step_increment,gfloat page_increment,gfloat page_size,gfloat climb_rate,gint digits,GtkSignalFunc callback,gpointer data)
