...
specifier|static
name|void
DECL|function|info_field_new (InfoDialog * idialog,InfoFieldType field_type,gchar * title,GtkWidget * widget,GtkObject * obj,gpointer value_ptr,GCallback callback,gpointer callback_data)
name|info_field_new
parameter_list|(
name|InfoDialog
modifier|*
