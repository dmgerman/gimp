...
name|data
decl_stmt|;
comment|/* Ignore dockable actions which are similar to the Dialogs-*            * actions except they always add a dock (instead of just            * showing it when already present).            */
if|if
condition|(
name|g_strcmp0
argument_list|(
