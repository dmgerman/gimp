...
argument_list|)
expr_stmt|;
comment|/* Try to match the keyword as an initialism of the action's label.    * For instance 'gb' will match 'Gaussian Blur...'    */
if|if
condition|(
name|g_strv_length
argument_list|(
...
condition|)
block|{
comment|/* full match is better than a partial match */
operator|*
name|section
operator|=
operator|!
