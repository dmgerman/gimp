...
typedef|typedef
struct|struct
DECL|struct|__anon2c2e9a930208
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* The user data for a GdkWindow is its associated widget. */
...
argument_list|)
expr_stmt|;
comment|/* NOTE: gtk_window_set_keep_above() would be easier but would render        * the search dialog above any windows, even non-GIMP related, which        * some early testers found annoying.        * Setting it transient forces it above a single parent instead. */
