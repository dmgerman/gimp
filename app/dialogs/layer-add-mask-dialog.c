...
specifier|static
name|void
name|layer_add_mask_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
...
name|GtkWidget
modifier|*
DECL|function|layer_add_mask_dialog_new (GimpLayer * layer,GimpContext * context,GtkWidget * parent,GimpAddMaskType add_mask_type,gboolean invert,GimpAddMaskCallback callback,gpointer user_data)
...
specifier|static
name|void
DECL|function|layer_add_mask_dialog_free (LayerAddMaskDialog * private)
name|layer_add_mask_dialog_free
parameter_list|(
name|LayerAddMaskDialog
modifier|*
...
specifier|static
name|void
DECL|function|layer_add_mask_dialog_response (GtkWidget * dialog,gint response_id,LayerAddMaskDialog * private)
name|layer_add_mask_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|layer_add_mask_dialog_channel_selected (GimpContainerView * view,GimpViewable * viewable,gpointer insert_data,LayerAddMaskDialog * private)
name|layer_add_mask_dialog_channel_selected
parameter_list|(
name|GimpContainerView
modifier|*
