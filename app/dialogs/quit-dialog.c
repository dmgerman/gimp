...
specifier|static
name|void
DECL|function|quit_close_all_dialog_save_clicked (GtkCellRenderer * cell,const gchar * path_str,GdkModifierType state,QuitDialog * dialog)
name|quit_close_all_dialog_save_clicked
parameter_list|(
name|GtkCellRenderer
modifier|*
...
specifier|static
name|gboolean
DECL|function|quit_close_all_dialog_query_tooltip (GtkWidget * widget,gint x,gint y,gboolean keyboard_tip,GtkTooltip * tooltip,QuitDialog * dialog)
name|quit_close_all_dialog_query_tooltip
parameter_list|(
name|GtkWidget
modifier|*
