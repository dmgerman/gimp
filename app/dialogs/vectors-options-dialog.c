...
specifier|static
name|void
name|vectors_options_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
...
name|GtkWidget
modifier|*
DECL|function|vectors_options_dialog_new (GimpImage * image,GimpVectors * vectors,GimpContext * context,GtkWidget * parent,const gchar * title,const gchar * role,const gchar * icon_name,const gchar * desc,const gchar * help_id,const gchar * vectors_name,GimpVectorsOptionsCallback callback,gpointer user_data)
...
specifier|static
name|void
DECL|function|vectors_options_dialog_response (GtkWidget * dialog,gint response_id,VectorsOptionsDialog * private)
name|vectors_options_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
