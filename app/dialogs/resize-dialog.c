...
begin_define
DECL|macro|RESIZE_RESPONSE_RESET
define|#
directive|define
name|RESIZE_RESPONSE_RESET
value|1
end_define
...
literal|"interpolation type will affect scaling "
literal|"channels and masks only."
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_misc_set_alignment
...
specifier|static
name|void
DECL|function|response_callback (GtkWidget * widget,gint response_id,Resize * resize)
name|response_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|size_callback (GtkWidget * widget,Resize * resize)
name|size_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|ratio_callback (GtkWidget * widget,Resize * resize)
name|ratio_callback
parameter_list|(
name|GtkWidget
modifier|*
