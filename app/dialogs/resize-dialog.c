...
DECL|member|interpolation_menu
name|GtkWidget
modifier|*
name|interpolation_menu
decl_stmt|;
...
name|Resize
modifier|*
DECL|function|resize_widget_new (GimpImage * gimage,ResizeType type,ResizeTarget target,GObject * object,const gchar * signal,gint width,gint height,gdouble resolution_x,gdouble resolution_y,GimpUnit unit,gboolean dot_for_dot,GCallback ok_cb,gpointer user_data)
