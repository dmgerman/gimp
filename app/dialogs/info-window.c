...
begin_comment
comment|/*  displays gimp-comment parasite  */
end_comment

begin_function
specifier|static
name|void
DECL|function|info_window_create_comment (InfoDialog * info_win,GimpDisplay * gdisp)
name|info_window_create_comment
parameter_list|(
name|InfoDialog
modifier|*
name|info_win
...
argument_list|)
expr_stmt|;
comment|/*  add the information field  */
name|vbox2
operator|=
name|gtk_vbox_new
argument_list|(
