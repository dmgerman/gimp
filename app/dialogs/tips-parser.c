...
typedef|typedef
struct|struct
DECL|struct|__anon276a56a20308
block|{
DECL|member|state
name|TipsParserState
name|state
...
name|gchar
modifier|*
name|tips_parser_parse_help_id
parameter_list|(
name|TipsParser
modifier|*
name|parser
...
name|GimpTip
modifier|*
DECL|function|gimp_tip_new (const gchar * title,const gchar * format,...)
name|gimp_tip_new
parameter_list|(
specifier|const
name|gchar
...
name|gchar
modifier|*
DECL|function|tips_parser_parse_help_id (TipsParser * parser,const gchar ** names,const gchar ** values)
name|tips_parser_parse_help_id
parameter_list|(
name|TipsParser
modifier|*
