...
name|GimpImage
modifier|*
DECL|function|file_open_dialog_open_image (GtkWidget * open_dialog,Gimp * gimp,GFile * file,GimpPlugInProcedure * load_proc)
name|file_open_dialog_open_image
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|file_open_dialog_open_layers (GtkWidget * open_dialog,GimpImage * image,GFile * file,GimpPlugInProcedure * load_proc)
name|file_open_dialog_open_layers
parameter_list|(
name|GtkWidget
modifier|*
