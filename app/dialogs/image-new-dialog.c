...
typedef|typedef
struct|struct
DECL|struct|__anon2785cb400108
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
begin_function
name|void
DECL|function|image_new_dialog_set (GtkWidget * dialog,GimpImage * image,GimpTemplate * template)
...
specifier|static
name|void
DECL|function|image_new_dialog_free (ImageNewDialog * private)
name|image_new_dialog_free
parameter_list|(
name|ImageNewDialog
modifier|*
...
specifier|static
name|void
DECL|function|image_new_dialog_response (GtkWidget * dialog,gint response_id,ImageNewDialog * private)
name|image_new_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|image_new_template_changed (GimpContext * context,GimpTemplate * template,ImageNewDialog * private)
name|image_new_template_changed
parameter_list|(
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|image_new_confirm_response (GtkWidget * dialog,gint response_id,ImageNewDialog * private)
...
specifier|static
name|void
DECL|function|image_new_confirm_dialog (ImageNewDialog * private)
name|image_new_confirm_dialog
parameter_list|(
name|ImageNewDialog
modifier|*
...
literal|"\"Maximum new image size\" in the Preferences "
...
specifier|static
name|void
DECL|function|image_new_create_image (ImageNewDialog * private)
name|image_new_create_image
parameter_list|(
name|ImageNewDialog
modifier|*
