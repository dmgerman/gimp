...
typedef|typedef
struct|struct
DECL|struct|__anon2b0c57db0108
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|convert_precision_dialog_new (GimpImage * image,GimpContext * context,GtkWidget * parent,GimpPrecision precision,GimpProgress * progress)
