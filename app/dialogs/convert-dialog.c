...
typedef|typedef
struct|struct
DECL|struct|__anon27b098890108
block|{
DECL|member|shell
name|GtkWidget
modifier|*
...
specifier|static
name|void
name|indexed_palette_select_destroy
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|indexed_palette_select_changed
parameter_list|(
name|GimpContext
modifier|*
name|context
...
name|GtkWidget
modifier|*
DECL|function|convert_dialog_new (GimpImage * gimage,GtkWidget * parent,GimpDisplay * gdisp)
...
specifier|static
name|void
DECL|function|progress_callback (gint stage,gdouble percentage,gpointer data)
...
specifier|static
name|void
DECL|function|indexed_destroy (GtkWidget * widget,IndexedDialog * dialog)
name|indexed_destroy
parameter_list|(
name|GtkWidget
modifier|*
...
literal|"role"
argument_list|,
literal|"gimp-pelette-selection"
argument_list|,
literal|"help-func"
argument_list|,
name|gimp_standard_help_func
...
specifier|static
name|void
DECL|function|indexed_palette_select_destroy (GtkWidget * widget,IndexedDialog * dialog)
name|indexed_palette_select_destroy
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|indexed_palette_select_changed (GimpContext * context,GimpPalette * palette,IndexedDialog * dialog)
name|indexed_palette_select_changed
parameter_list|(
name|GimpContext
modifier|*
