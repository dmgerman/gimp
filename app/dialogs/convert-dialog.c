...
typedef|typedef
struct|struct
DECL|struct|__anon2b1a46830108
block|{
DECL|member|gimage
name|GimpImage
modifier|*
...
name|custom_palette
decl_stmt|;
DECL|member|have_web_palette
name|gboolean
name|have_web_palette
decl_stmt|;
...
name|_
argument_list|(
literal|"Use black and "
literal|"white (1-bit) palette"
argument_list|)
argument_list|)
expr_stmt|;
name|group
