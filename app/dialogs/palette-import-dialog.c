...
name|_
argument_list|(
literal|"Select a Gradient to Create a Palette from"
argument_list|)
argument_list|,
name|GIMP_OBJECT
argument_list|(
...
specifier|static
name|void
DECL|function|palette_import_gradient_changed (GimpContext * context,GimpGradient * gradient,gpointer data)
...
specifier|static
name|void
DECL|function|palette_import_image_changed (GimpContext * context,GimpImage * gimage,gpointer data)
...
specifier|static
name|void
DECL|function|palette_import_image_add (GimpContainer * container,GimpImage * gimage,gpointer data)
...
specifier|static
name|void
DECL|function|palette_import_image_remove (GimpContainer * container,GimpImage * gimage,gpointer data)
...
argument_list|)
expr_stmt|;
comment|/* DON'T gtk_widget_show (import_dialog->image_menu); */
name|menu
operator|=
