...
specifier|static
struct|struct
DECL|struct|__anon278b85880408
block|{
...
specifier|static
name|gboolean
DECL|function|copy_file (gchar * source,gchar * dest,GError ** error)
name|copy_file
parameter_list|(
name|gchar
modifier|*
