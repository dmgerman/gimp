...
name|GtkWidget
modifier|*
DECL|function|user_install_dialog_add_welcome_page (GtkWidget * dialog G_GNUC_UNUSED,GtkWidget * notebook,const gchar * version)
...
specifier|static
name|gboolean
DECL|function|user_install_detect_old (const gchar ** version)
name|user_install_detect_old
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|void
DECL|function|user_install_log (GtkWidget * view,GtkTextBuffer * buffer,GError * error)
