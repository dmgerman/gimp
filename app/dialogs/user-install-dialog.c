...
specifier|static
struct|struct
DECL|struct|__anon2afab0ea0108
block|{
...
directive|if
literal|0
block|log_text = gtk_text_new (NULL, vadj);
endif|#
directive|endif
name|gtk_table_attach
argument_list|(
...
directive|if
literal|0
block|gtk_table_attach (GTK_TABLE (table), log_text, 0, 1, 0, 1, 			    GTK_EXPAND | GTK_SHRINK | GTK_FILL, 			    GTK_EXPAND | GTK_SHRINK | GTK_FILL, 			    0, 0);
endif|#
directive|endif
name|gtk_widget_show
argument_list|(
...
directive|if
literal|0
block|gtk_widget_show (log_text);
endif|#
directive|endif
name|gtk_widget_show
argument_list|(
...
directive|if
literal|0
block|gtk_text_insert (GTK_TEXT (log_text), NULL, NULL, NULL, buffer, -1);
endif|#
directive|endif
block|}
name|pclose
