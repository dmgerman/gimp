...
specifier|const
struct|struct
DECL|struct|__anon2ad6eafa0408
block|{
...
name|_
argument_list|(
literal|"Please wait while your "
literal|"personal GIMP folder is "
...
specifier|static
name|gboolean
DECL|function|user_install_run (GtkWidget * page,const gchar * oldgimp)
name|user_install_run
parameter_list|(
name|GtkWidget
modifier|*
