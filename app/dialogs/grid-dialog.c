...
specifier|static
name|void
DECL|function|grid_dialog_free (GridDialog * private)
name|grid_dialog_free
parameter_list|(
name|GridDialog
modifier|*
...
specifier|static
name|void
DECL|function|grid_dialog_response (GtkWidget * dialog,gint response_id,GridDialog * private)
name|grid_dialog_response
parameter_list|(
name|GtkWidget
modifier|*
