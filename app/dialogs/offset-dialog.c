...
typedef|typedef
struct|struct
DECL|struct|__anon2bfa5fe10108
block|{
DECL|member|context
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|offset_half_xy_callback (GtkWidget * widget,OffsetDialog * dialog)
name|offset_half_xy_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|offset_half_x_callback (GtkWidget * widget,OffsetDialog * dialog)
name|offset_half_x_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|offset_half_y_callback (GtkWidget * widget,OffsetDialog * dialog)
name|offset_half_y_callback
parameter_list|(
name|GtkWidget
modifier|*
