...
specifier|static
name|gint
name|qmask_query_delete_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gint
DECL|function|qmask_query_delete_callback (GtkWidget * widget,GdkEvent * event,gpointer client_data)
name|qmask_query_delete_callback
parameter_list|(
name|GtkWidget
modifier|*
