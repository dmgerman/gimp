...
condition|)
block|{
comment|/* FIXME: This is a hack. gettext doesn't pick the right language          by default on Windows, so we enforce the right one. */
comment|/* ISO 639-1        *    http:www.loc.gov/standards/iso639-2/        * List of existing mui packs:        *    http:www.microsoft.com/globaldev/reference/win2k/setup/Langid.mspx        * List of known id's        *    http:www.microsoft.com/globaldev/reference/lcid-all.mspx        */
switch|switch
condition|(
