...
begin_comment
comment|/*  a group of radio buttons with a frame around them   */
end_comment

begin_typedef
DECL|typedef|ToolOptionsRadioButtons
typedef|typedef
name|struct
name|_ToolOptionsRadioButtons
name|ToolOptionsRadioButtons
typedef|;
end_typedef

begin_struct
DECL|struct|_ToolOptionsRadioButtons
struct|struct
name|_ToolOptionsRadioButtons
block|{
DECL|member|widget
