...
begin_comment
comment|/*  static gint path_widget_preview_events   (GtkWidget *, GdkEvent *);  */
end_comment
...
begin_comment
comment|/* static gint path_widget_preview_events (GtkWidget *widget, 			     GdkEvent  *event) {   GdkEventButton *bevent;    switch (event->type)     {     case GDK_BUTTON_PRESS:       bevent = (GdkEventButton *) event;       break;      case GDK_EXPOSE:       if (preview_size) 	{  	  layer_widget_preview_redraw (layer_widget, preview_type); 	   	  gdk_draw_pixmap (widget->window, 			   widget->style->black_gc, 			   *pixmap, 			   0, 0, 2, 2, 			   layersD->image_width, 			   layersD->image_height); 	}        break;      default:       break;     }    return FALSE; } */
end_comment
