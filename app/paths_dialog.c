...
name|gchar
modifier|*
DECL|function|unique_name (gchar * cstr)
name|unique_name
parameter_list|(
name|gchar
modifier|*
...
specifier|static
name|PATHP
DECL|function|path_copy (PATHP p)
name|path_copy
parameter_list|(
name|PATHP
name|p
...
begin_function
name|PATHP
DECL|function|path_new (PathType ptype,GSList * path_details,gint closed,gint state,gint locked,gchar * name)
name|path_new
parameter_list|(
name|PathType
name|ptype
