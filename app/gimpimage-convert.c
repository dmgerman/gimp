...
specifier|static
name|void
DECL|function|realize_text (GtkWidget * text,gpointer data)
name|realize_text
parameter_list|(
name|GtkWidget
modifier|*
...
name|NULL
argument_list|,
literal|"You are attempting to convert an image with alpha/layers from RGB/GRAY to INDEXED.  You should not generate a palette of more than 255 colors if you intend to create a transparent or animated GIF file from this image."
argument_list|,
operator|-
literal|1
argument_list|)
...
argument_list|)
expr_stmt|;
comment|/* put the vbox in the frame */
...
specifier|static
name|void
DECL|function|palette_entries_callback (GtkWidget * w,gpointer client_data)
name|palette_entries_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|indexed_ok_callback (GtkWidget * widget,gpointer client_data)
name|indexed_ok_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gint
DECL|function|indexed_delete_callback (GtkWidget * w,GdkEvent * e,gpointer client_data)
name|indexed_delete_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|indexed_cancel_callback (GtkWidget * widget,gpointer client_data)
name|indexed_cancel_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|indexed_num_cols_update (GtkWidget * w,gpointer data)
name|indexed_num_cols_update
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|indexed_dither_update (GtkWidget * w,gpointer data)
name|indexed_dither_update
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* To begin, assume that there are fewer colours in 	   *  the image than the user actually asked for.  In that 	   *  case, we don't need to quantize or dither. 	   */
name|needs_quantize
operator|=
name|FALSE
expr_stmt|;
...
specifier|static
name|void
DECL|function|generate_histogram_gray (Histogram histogram,Layer * layer)
name|generate_histogram_gray
parameter_list|(
name|Histogram
name|histogram
...
specifier|static
name|void
DECL|function|generate_histogram_rgb (Histogram histogram,Layer * layer,int col_limit)
name|generate_histogram_rgb
parameter_list|(
name|Histogram
name|histogram
...
specifier|static
name|boxptr
DECL|function|find_biggest_color_pop (boxptr boxlist,int numboxes)
...
literal|0
expr_stmt|;
comment|/* Abortive initial attempt at alpha-dithering :) */
comment|/*	  if (has_alpha) 	    dest[ALPHA_I_PIX] = (src[alpha_pix]<= (random()&255)) ? 0 : 255;*/
name|color
operator|=
operator|&
name|quantobj
...
name|QuantizeObj
modifier|*
DECL|function|initialize_median_cut (int type,int num_colors,int dither_type,int palette_type)
name|initialize_median_cut
parameter_list|(
name|int
name|type
...
begin_comment
comment|/*  The convert-rgb procedure definition  */
end_comment

begin_decl_stmt
DECL|variable|convert_rgb_args
name|ProcArg
name|convert_rgb_args
index|[]
init|=
block|{
block|{
...
expr_stmt|;
block|}
comment|/*  make sure the drawable is not RGB color  */
if|if
condition|(
name|success
condition|)
...
begin_comment
comment|/*  The convert-grayscale procedure definition  */
end_comment

begin_decl_stmt
DECL|variable|convert_grayscale_args
name|ProcArg
name|convert_grayscale_args
index|[]
init|=
block|{
block|{
...
expr_stmt|;
block|}
comment|/*  make sure the drawable is not GRAYSCALE color  */
if|if
condition|(
name|success
condition|)
...
begin_comment
comment|/*  The convert-indexed procedure definition  */
end_comment

begin_decl_stmt
DECL|variable|convert_indexed_args
name|ProcArg
name|convert_indexed_args
index|[]
init|=
block|{
block|{
...
begin_comment
comment|/*  The convert-indexed-palette procedure definition  */
end_comment

begin_decl_stmt
DECL|variable|convert_indexed_palette_args
name|ProcArg
name|convert_indexed_palette_args
index|[]
init|=
block|{
block|{
...
condition|)
block|{
comment|/*					fprintf(stderr, "found it!\n"); */
name|the_palette
operator|=
name|entries
expr_stmt|;
...
condition|)
block|{
comment|/*			fprintf(stderr, "didn't find it\n"); */
name|success
operator|=
name|FALSE
expr_stmt|;
