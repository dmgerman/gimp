...
begin_function
name|void
DECL|function|convert_to_rgb (void * gimage_ptr)
name|convert_to_rgb
parameter_list|(
name|void
modifier|*
...
begin_function
name|void
DECL|function|convert_to_grayscale (void * gimage_ptr)
...
begin_function
name|void
DECL|function|convert_to_indexed (void * gimage_ptr)
...
name|data
expr_stmt|;
comment|/*      fprintf(stderr, "(palette %s)\n", entries->filename);*/
name|menu_item
operator|=
...
name|data
expr_stmt|;
comment|/* fprintf(stderr, "setting default to `%s'\n", theCustomPalette->name);*/
operator|*
name|default_palette
operator|=
literal|0
