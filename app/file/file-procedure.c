...
condition|)
block|{
comment|/* If there is not any (with or without magic) file proc that        * can load the URI by extension directly, try to find a proc        * that can load the prefix        */
name|file_proc
operator|=
name|file_proc_find_by_prefix
argument_list|(
...
name|GimpPlugInProcedure
modifier|*
DECL|function|file_proc_find_by_extension (GSList * procs,const gchar * uri,gboolean skip_magic,gboolean uri_procs_only)
name|file_proc_find_by_extension
parameter_list|(
name|GSList
modifier|*
