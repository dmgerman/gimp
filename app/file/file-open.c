...
name|GimpImage
modifier|*
DECL|function|file_open_image (Gimp * gimp,const gchar * uri,const gchar * raw_filename,const gchar * open_mode,PlugInProcDef * file_proc,GimpRunMode run_mode,GimpPDBStatusType * status)
...
begin_function
name|GimpPDBStatusType
DECL|function|file_open_with_display (Gimp * gimp,const gchar * uri)
...
begin_function
name|GimpPDBStatusType
DECL|function|file_open_with_proc_and_display (Gimp * gimp,const gchar * uri,const gchar * raw_filename,PlugInProcDef * file_proc)
name|file_open_with_proc_and_display
parameter_list|(
name|Gimp
modifier|*
