...
name|NULL
expr_stmt|;
comment|/*       options->type_toggle[2].label = N_("Sharpen");      options->type_toggle[2].value = CUSTOM_CONVOLVE;      options->type_toggle[3].label = NULL;   */
name|options
operator|->
name|type
operator|=
...
specifier|static
name|void
DECL|function|convolve_toggle_key_func (Tool * tool,GdkEventKey * kevent,gpointer gdisp_ptr)
name|convolve_toggle_key_func
parameter_list|(
name|Tool
modifier|*
name|tool
