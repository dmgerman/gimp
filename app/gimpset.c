...
begin_typedef
DECL|struct|__anon2c7e866b0108
typedef|typedef
struct|struct
block|{
DECL|member|object
...
name|REMOVE
block|,
DECL|enumerator|MEMBER_MODIFIED
name|MEMBER_MODIFIED
block|,
...
begin_function
name|void
DECL|function|gimp_set_member_modified (GimpSet * set,gpointer ob)
