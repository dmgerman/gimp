...
begin_function
name|void
DECL|function|gdisplay_real_install_tool_cursor (GDisplay * gdisp,GdkCursorType cursor_type,ToolType tool_type,CursorModifier modifier,gboolean toggle_cursor,gboolean always_install)
