...
begin_define
DECL|macro|FLUSH_NOW_TIMEOUT
define|#
directive|define
name|FLUSH_NOW_TIMEOUT
value|20
end_define

begin_enum
enum|enum
DECL|enum|__anon29ec23bd0103
block|{
...
specifier|static
name|void
DECL|function|gimp_display_dispose (GObject * object)
name|gimp_display_dispose
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_display_flush_now_timeout (GimpDisplay * display)
name|gimp_display_flush_now_timeout
parameter_list|(
name|GimpDisplay
modifier|*
name|display
