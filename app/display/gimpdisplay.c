...
begin_define
DECL|macro|FLUSH_NOW_INTERVAL
define|#
directive|define
name|FLUSH_NOW_INTERVAL
value|20000
end_define

begin_comment
DECL|macro|FLUSH_NOW_INTERVAL
comment|/* 20 ms in microseconds */
end_comment
...
begin_define
DECL|macro|GIMP_DISPLAY_GET_PRIVATE (display)
define|#
directive|define
...
name|GimpDisplay
modifier|*
DECL|function|gimp_display_new (Gimp * gimp,GimpImage * image,GimpUnit unit,gdouble scale,GimpUIManager * popup_manager,GimpDialogFactory * dialog_factory,GdkScreen * screen,gint monitor)
