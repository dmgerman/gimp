...
begin_define
DECL|macro|PAINT_AREA_CHUNK_WIDTH
define|#
directive|define
name|PAINT_AREA_CHUNK_WIDTH
value|32
end_define

begin_define
DECL|macro|PAINT_AREA_CHUNK_HEIGHT
define|#
directive|define
...
begin_struct
DECL|struct|_GimpDisplayImplPrivate
struct|struct
...
specifier|static
name|guint32
name|gimp_display_progress_get_window_id
parameter_list|(
name|GimpProgress
modifier|*
name|progress
...
specifier|static
name|void
name|gimp_display_flush_update_region
parameter_list|(
name|GimpDisplay
modifier|*
name|display
...
begin_macro
DECL|function|G_DEFINE_TYPE_WITH_CODE (GimpDisplayImpl,gimp_display_impl,GIMP_TYPE_DISPLAY,G_ADD_PRIVATE (GimpDisplayImpl)G_IMPLEMENT_INTERFACE (GIMP_TYPE_PROGRESS,gimp_display_progress_iface_init))
name|G_DEFINE_TYPE_WITH_CODE
argument_list|(
argument|GimpDisplayImpl
argument_list|,
argument|gimp_display_impl
argument_list|,
argument|GIMP_TYPE_DISPLAY
argument_list|,
argument|G_ADD_PRIVATE (GimpDisplayImpl)                          G_IMPLEMENT_INTERFACE (GIMP_TYPE_PROGRESS,                                                 gimp_display_progress_iface_init)
argument_list|)
end_macro
...
directive|define
name|parent_class
value|gimp_display_impl_parent_class
end_define

begin_function
specifier|static
name|void
name|gimp_display_impl_class_init
parameter_list|(
...
specifier|static
name|void
DECL|function|gimp_display_impl_init (GimpDisplayImpl * display)
name|gimp_display_impl_init
parameter_list|(
...
name|priv
operator|=
name|gimp_display_impl_get_instance_private
argument_list|(
name|display
argument_list|)
expr_stmt|;
...
name|GimpProgress
modifier|*
DECL|function|gimp_display_progress_start (GimpProgress * progress,gboolean cancellable,const gchar * message)
name|gimp_display_progress_start
parameter_list|(
name|GimpProgress
modifier|*
...
specifier|static
name|guint32
DECL|function|gimp_display_progress_get_window_id (GimpProgress * progress)
name|gimp_display_progress_get_window_id
parameter_list|(
name|GimpProgress
modifier|*
...
name|GimpDisplay
modifier|*
DECL|function|gimp_display_new (Gimp * gimp,GimpImage * image,GimpUnit unit,gdouble scale,GimpUIManager * popup_manager,GimpDialogFactory * dialog_factory,GdkMonitor * monitor)
...
argument_list|)
decl_stmt|;
comment|/*  set private->shell to NULL *before* destroying the shell.        *  all callbacks in gimpdisplayshell-callbacks.c will check        *  this pointer and do nothing if the shell is in destruction.        */
name|private
operator|->
name|shell
operator|=
...
name|GimpImage
modifier|*
DECL|function|gimp_display_get_image (GimpDisplay * display)
...
name|GimpDisplayShell
modifier|*
DECL|function|gimp_display_get_shell (GimpDisplay * display)
name|gimp_display_get_shell
parameter_list|(
name|GimpDisplay
modifier|*
...
begin_function
name|void
DECL|function|gimp_display_update_bounding_box (GimpDisplay * display)
name|gimp_display_update_bounding_box
parameter_list|(
name|GimpDisplay
modifier|*
...
specifier|static
name|void
DECL|function|gimp_display_flush_update_region (GimpDisplay * display)
name|gimp_display_flush_update_region
parameter_list|(
name|GimpDisplay
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  align transformed area to a coarse grid, to simplify the    *  invalidated area    */
name|x1
operator|=
name|floor
argument_list|(
