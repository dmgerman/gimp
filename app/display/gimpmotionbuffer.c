...
begin_function
name|gboolean
DECL|function|gimp_motion_buffer_flush_event_queue (GimpMotionBuffer * buffer)
name|gimp_motion_buffer_flush_event_queue
parameter_list|(
name|GimpMotionBuffer
modifier|*
