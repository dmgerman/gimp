...
begin_function
name|void
DECL|function|gimp_motion_buffer_start_stroke (GimpMotionBuffer * buffer,guint32 time,GimpCoords * last_motion)
...
begin_function
name|void
DECL|function|gimp_motion_buffer_finish_stroke (GimpMotionBuffer * buffer)
...
begin_function
name|void
DECL|function|gimp_motion_buffer_process_event_queue (GimpMotionBuffer * buffer,GdkModifierType state,guint32 time)
