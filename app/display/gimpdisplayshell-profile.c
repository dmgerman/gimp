...
name|action
operator|=
literal|"view-color-management-mode-off"
expr_stmt|;
name|managed
operator|=
name|FALSE
...
name|action
operator|=
literal|"view-color-management-mode-display"
expr_stmt|;
name|intent
operator|=
name|config
...
name|action
operator|=
literal|"view-color-management-mode-softproof"
expr_stmt|;
name|intent
operator|=
name|config
...
name|action
operator|=
literal|"view-color-management-intent-perceptual"
expr_stmt|;
break|break;
case|case
...
name|action
operator|=
literal|"view-color-management-intent-relative-colorimetric"
expr_stmt|;
break|break;
case|case
...
name|action
operator|=
literal|"view-color-management-intent-saturation"
expr_stmt|;
break|break;
case|case
...
name|action
operator|=
literal|"view-color-management-intent-absolute-colorimetric"
expr_stmt|;
break|break;
block|}
name|SET_SENSITIVE
...
name|SET_SENSITIVE
argument_list|(
literal|"view-color-management-black-point-compensation"
argument_list|,
name|managed
argument_list|)
expr_stmt|;
...
name|SET_SENSITIVE
argument_list|(
literal|"view-color-management-gamut-check"
argument_list|,
name|config
operator|->
name|mode
