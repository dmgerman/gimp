...
specifier|static
name|void
DECL|function|gimp_canvas_text_cursor_transform (GimpCanvasItem * item,gdouble * x,gdouble * y,gdouble * w,gdouble * h)
...
specifier|static
name|void
DECL|function|gimp_canvas_text_cursor_draw (GimpCanvasItem * item,cairo_t * cr)
name|gimp_canvas_text_cursor_draw
parameter_list|(
name|GimpCanvasItem
modifier|*
...
name|cairo_region_t
modifier|*
DECL|function|gimp_canvas_text_cursor_get_extents (GimpCanvasItem * item)
name|gimp_canvas_text_cursor_get_extents
parameter_list|(
name|GimpCanvasItem
modifier|*
...
name|GimpCanvasItem
modifier|*
DECL|function|gimp_canvas_text_cursor_new (GimpDisplayShell * shell,PangoRectangle * cursor,gboolean overwrite,GimpTextDirection direction)
