...
begin_define
DECL|macro|MIN_UPDATE_INTERVAL
define|#
directive|define
...
specifier|static
name|gboolean
DECL|function|gimp_canvas_progress_hit (GimpCanvasItem * item,gdouble x,gdouble y)
name|gimp_canvas_progress_hit
parameter_list|(
name|GimpCanvasItem
modifier|*
