...
begin_decl_stmt
DECL|variable|render_check_buf
name|guchar
modifier|*
...
begin_decl_stmt
DECL|variable|render_empty_buf
name|guchar
modifier|*
...
begin_decl_stmt
DECL|variable|render_white_buf
name|guchar
modifier|*
...
begin_decl_stmt
DECL|variable|render_blend_dark_check
name|guchar
modifier|*
...
begin_decl_stmt
DECL|variable|render_blend_light_check
name|guchar
modifier|*
...
begin_decl_stmt
DECL|variable|render_blend_white
name|guchar
modifier|*
...
begin_function
name|void
DECL|function|render_exit (Gimp * gimp)
name|render_exit
parameter_list|(
name|Gimp
modifier|*
...
directive|define
name|BUF_SIZE
value|(MAX (GIMP_DISPLAY_SHELL_RENDER_BUF_WIDTH, \                        GIMP_VIEWABLE_MAX_PREVIEW_SIZE) + 4)
name|render_check_buf
operator|=
name|g_new
argument_list|(
