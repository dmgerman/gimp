...
begin_comment
comment|/**  * gimp_display_shell_handle_size_changed_detailed:  * @shell:  * @previous_origin_x:  * @previous_origin_y:  *  * On e.g. an image crop we want to avoid repositioning the image  * content in the display shell if possible.  *  **/
end_comment

begin_function
name|void
DECL|function|gimp_display_shell_handle_size_changed_detailed (GimpDisplayShell * shell,gdouble previous_origin_x,gdouble previous_origin_y)
...
begin_function
name|void
DECL|function|gimp_display_shell_get_scaled_image_size (const GimpDisplayShell * shell,gint * w,gint * h)
