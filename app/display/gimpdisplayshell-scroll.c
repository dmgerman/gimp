...
specifier|static
name|void
DECL|function|gimp_display_shell_scroll_center_image_callback (GimpDisplayShell * shell,GtkAllocation * allocation,GtkWidget * canvas)
...
begin_function
name|void
DECL|function|gimp_display_shell_scroll_center_image_on_next_size_allocate (GimpDisplayShell * shell)
