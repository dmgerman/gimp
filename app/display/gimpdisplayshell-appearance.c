...
parameter_list|)
define|\
value|(shell->display->image ? \    (gimp_display_shell_get_fullscreen (shell) ? \     shell->fullscreen_options : shell->options) : \    shell->no_image_options)
end_define
...
begin_function
name|gboolean
DECL|function|gimp_display_shell_get_fullscreen (const GimpDisplayShell * shell)
name|gimp_display_shell_get_fullscreen
parameter_list|(
specifier|const
name|GimpDisplayShell
