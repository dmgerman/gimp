...
begin_function
name|void
DECL|function|gimp_display_shell_set_show_canvas (GimpDisplayShell * shell,gboolean show)
name|gimp_display_shell_set_show_canvas
parameter_list|(
name|GimpDisplayShell
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_display_shell_get_show_canvas (GimpDisplayShell * shell)
...
begin_function
name|void
DECL|function|gimp_display_shell_update_show_canvas (GimpDisplayShell * shell)
...
begin_function
name|void
DECL|function|gimp_display_shell_set_padding_in_show_all (GimpDisplayShell * shell,gboolean keep)
name|gimp_display_shell_set_padding_in_show_all
parameter_list|(
name|GimpDisplayShell
modifier|*
...
name|shell
argument_list|,
literal|"view-padding-color-in-show-all"
argument_list|,
name|keep
argument_list|)
expr_stmt|;
...
begin_function
name|gboolean
DECL|function|gimp_display_shell_get_padding_in_show_all (GimpDisplayShell * shell)
