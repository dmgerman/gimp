...
begin_define
DECL|macro|GET_APPEARANCE (shell)
define|#
directive|define
name|GET_APPEARANCE
parameter_list|(
...
parameter_list|)
define|\
value|(gimp_display_shell_get_fullscreen (shell) ? \&shell->fullscreen_appearance :&shell->appearance)
end_define
...
begin_function
name|void
DECL|function|gimp_display_shell_set_padding (GimpDisplayShell * shell,GimpDisplayPaddingMode padding_mode,const GimpRGB * padding_color)
...
begin_function
name|void
DECL|function|gimp_display_shell_get_padding (GimpDisplayShell * shell,GimpDisplayPaddingMode * padding_mode,GimpRGB * padding_color)
