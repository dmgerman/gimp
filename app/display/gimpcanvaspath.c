...
parameter_list|)
define|\
value|((GimpCanvasPathPrivate *) gimp_canvas_path_get_instance_private ((GimpCanvasPath *) (path)))
end_define
...
begin_macro
DECL|function|G_DEFINE_TYPE_WITH_PRIVATE (GimpCanvasPath,gimp_canvas_path,GIMP_TYPE_CANVAS_ITEM)
...
specifier|static
name|void
DECL|function|gimp_canvas_path_draw (GimpCanvasItem * item,cairo_t * cr)
name|gimp_canvas_path_draw
parameter_list|(
name|GimpCanvasItem
modifier|*
...
name|cairo_region_t
modifier|*
DECL|function|gimp_canvas_path_get_extents (GimpCanvasItem * item)
name|gimp_canvas_path_get_extents
parameter_list|(
name|GimpCanvasItem
modifier|*
...
specifier|static
name|void
DECL|function|gimp_canvas_path_stroke (GimpCanvasItem * item,cairo_t * cr)
name|gimp_canvas_path_stroke
parameter_list|(
name|GimpCanvasItem
modifier|*
