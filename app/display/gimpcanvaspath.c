...
name|GimpCanvasItem
modifier|*
DECL|function|gimp_canvas_path_new (GimpDisplayShell * shell,const GimpBezierDesc * bezier,gdouble x,gdouble y,gboolean filled,gboolean path_style)
