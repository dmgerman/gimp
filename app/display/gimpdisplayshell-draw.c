...
argument_list|)
expr_stmt|;
comment|/*   gtk_table_set_col_spacing (GTK_TABLE (table), 0, 1);   gtk_table_set_col_spacing (GTK_TABLE (table), 1, 2);   gtk_table_set_row_spacing (GTK_TABLE (table), 0, 1);   gtk_table_set_row_spacing (GTK_TABLE (table), 1, 2);   gtk_container_border_width (GTK_CONTAINER (table), 2);   */
name|gtk_box_pack_start
argument_list|(
name|GTK_BOX
argument_list|(
