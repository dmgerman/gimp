...
specifier|static
name|void
DECL|function|gimp_display_shell_draw_active_vectors (GimpDisplayShell * shell,cairo_t * cr,GimpVectors * vectors,gdouble width)
name|gimp_display_shell_draw_active_vectors
parameter_list|(
name|GimpDisplayShell
modifier|*
name|shell
...
specifier|static
name|void
DECL|function|gimp_display_shell_draw_inactive_vectors (GimpDisplayShell * shell,cairo_t * cr,GimpVectors * vectors,gdouble width)
name|gimp_display_shell_draw_inactive_vectors
parameter_list|(
name|GimpDisplayShell
modifier|*
name|shell
...
block|}
block|}
comment|/*  the active vector is always rendered on top  */
if|if
condition|(
name|active
condition|)
