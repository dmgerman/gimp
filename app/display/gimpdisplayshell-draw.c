...
condition|)
block|{
comment|/* render image to the render cache */
...
expr_stmt|;
block|}
comment|/* divide the cairo scale-factor by the window scale-factor, since            * the render cache uses device pixels.  see comment further up.            */
name|cairo_scale
argument_list|(
name|cr
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* render from the render cache to screen */
