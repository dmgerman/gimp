...
begin_function
name|void
DECL|function|gimp_display_shell_draw_selection_segments (GimpDisplayShell * shell,cairo_t * cr,GdkSegment * segs,gint n_segs)
...
begin_function
name|void
DECL|function|gimp_display_shell_draw_selection_in_mask (GimpDisplayShell * shell,cairo_t * cr,cairo_pattern_t * mask,gint index)
