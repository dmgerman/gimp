...
begin_function
name|void
DECL|function|gimp_canvas_arc_set (GimpCanvasItem * arc,gdouble center_x,gdouble center_y,gdouble radius_x,gdouble radius_y,gdouble start_angle,gdouble slice_angle)
name|gimp_canvas_arc_set
parameter_list|(
name|GimpCanvasItem
modifier|*
name|arc
