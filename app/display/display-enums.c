...
begin_function
name|GType
DECL|function|gimp_compass_orientation_get_type (void)
...
block|,
literal|"GIMP_COMPASS_ORIENTATION_AUTO"
block|,
literal|"auto"
block|}
block|,
...
block|,
literal|"GIMP_COMPASS_ORIENTATION_HORIZONTAL"
block|,
literal|"horizontal"
block|}
block|,
...
block|,
literal|"GIMP_COMPASS_ORIENTATION_VERTICAL"
block|,
literal|"vertical"
block|}
block|,
...
name|g_enum_register_static
argument_list|(
literal|"GimpCompassOrientation"
argument_list|,
name|values
argument_list|)
expr_stmt|;
