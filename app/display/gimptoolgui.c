...
directive|if
literal|0
block|if (! entry->sensitive)             gimp_overlay_dialog_set_response_sensitive (GIMP_OVERLAY_DIALOG (private->dialog),                                                         entry->response_id,                                                         FALSE);
endif|#
directive|endif
block|}
comment|/* FIXME */
...
directive|if
literal|0
block|if (private->default_response != -1)         gimp_overlay_dialog_set_default_response (GIMP_OVERLAY_DIALOG (private->dialog),                                                   private->default_response);
endif|#
directive|endif
