...
name|TRUE
return|;
comment|/*  do not process any key event while BUTTON1 is down. We do this          *  so tools keep the modifier state they were in when BUTTON1 was          *  pressed and to prevent accelerators from being invoked.          */
if|if
condition|(
name|state
operator|&
