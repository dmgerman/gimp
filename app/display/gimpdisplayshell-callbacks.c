...
condition|(
name|TRUE
comment|/* gimprc.use_style_padding_color */
condition|)
block|{
name|r
operator|=
...
begin_function
name|gboolean
DECL|function|gimp_display_shell_canvas_focus_in (GtkWidget * widget,GdkEventFocus * fevent,GimpDisplayShell * shell)
...
begin_function
name|gboolean
DECL|function|gimp_display_shell_canvas_focus_out (GtkWidget * widget,GdkEventFocus * fevent,GimpDisplayShell * shell)
...
begin_function
name|void
DECL|function|gimp_display_shell_color_button_default (gpointer callback_data,guint callback_action,GtkWidget * widget)
