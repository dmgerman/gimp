...
typedef|typedef
struct|struct
DECL|struct|__anon2b3c542a0108
block|{
DECL|member|shell
...
specifier|static
name|gboolean
DECL|function|autoscroll_timeout (gpointer data)
name|autoscroll_timeout
parameter_list|(
name|gpointer
name|data
...
specifier|static
name|void
DECL|function|begin_autoscrolling (ScrollInfo * info,GimpDisplayShell * shell,GdkModifierType state,GdkEventMotion * mevent)
name|begin_autoscrolling
parameter_list|(
name|ScrollInfo
modifier|*
...
specifier|static
name|void
DECL|function|end_autoscrolling (ScrollInfo * info)
name|end_autoscrolling
parameter_list|(
name|ScrollInfo
modifier|*
