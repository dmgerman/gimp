...
specifier|static
name|gboolean
DECL|function|gimp_display_shell_canvas_tick (GtkWidget * widget,GdkFrameClock * frame_clock,TickClosure * tick)
name|gimp_display_shell_canvas_tick
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
expr_stmt|;
block|}
name|gtk_widget_add_tick_callback
argument_list|(
name|widget
argument_list|,
operator|(
name|GtkTickCallback
operator|)
name|gimp_display_shell_canvas_tick
argument_list|,
name|tick
...
begin_function
name|gboolean
DECL|function|gimp_display_shell_canvas_draw (GtkWidget * widget,cairo_t * cr,GimpDisplayShell * shell)
...
name|TRUE
return|;
comment|/*  we will scroll around in the next tick anyway, so we just can as    *  well skip the drawing of this frame and wait for the next    */
if|if
condition|(
name|shell
operator|->
...
argument_list|)
expr_stmt|;
comment|/*  first, draw the background    */
