...
begin_function
name|void
DECL|function|gimp_display_shell_transform_segments (const GimpDisplayShell * shell,const BoundSeg * src_segs,BoundSeg * dest_segs,gint n_segs,gboolean use_offsets)
