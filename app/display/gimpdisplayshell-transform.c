...
begin_comment
comment|/**  * gimp_display_shell_transform_coords:  * @GimpDisplayShell: a display shell  * @image_coords:     a pointer to a set of image coordinates  * @display_coords:   a pointer to the place to return the corresponding  *                    display coordinates  *  * Transforms from image coordinates to display coordinates, so that objects  * can be rendered at the correct points on the display.  **/
end_comment
...
begin_comment
comment|/**  * gimp_display_shell_transform_coords:  * @GimpDisplayShell: a display shell  * @display_coords:   a pointer to a set of display coordinates  * @image_coords:     a pointer to the place to return the corresonding  *                    image coordinates  *  * Transforms from display coordinates to image coordinates, so that points  * on the display can be mapped to points in the image.  **/
end_comment
...
begin_comment
comment|/**  * gimp_display_shell_untransform_viewport:  * @x:      place to return image x coordinate of display upper left corner   * @y:      place to return image y coordinate of display upper left corner  * @width:  place to return width of display measured in image coordinates  * @height: place to return height of display measured in image coordinates  *  * This function calculates the part of the image, im image coordinates,  * the corresponds to the display viewport.  **/
end_comment
