...
begin_function
name|void
DECL|function|gimp_display_shell_scale_zoom_fraction (GimpZoomType zoom_type,gint * scalesrc,gint * scaledest)
...
begin_function
name|void
DECL|function|gimp_display_shell_scale_calc_fraction (gdouble zoom_factor,gint * scalesrc,gint * scaledest)
...
typedef|typedef
struct|struct
DECL|struct|__anon2772aaec0108
block|{
DECL|member|shell
name|GimpDisplayShell
modifier|*
