...
break|break;
block|}
comment|/* set scalesrc and scaledest to a fraction close to ratio */
...
argument_list|)
expr_stmt|;
comment|/* choosing 240 because it has a lot of nice divisors and the    * chance of a nice fraction is bigger */
name|scalesrc
operator|=
name|scaledest
operator|=
...
argument_list|)
expr_stmt|;
comment|/* determine gcd to shorten the fraction */
name|a
operator|=
name|MAX
argument_list|(
