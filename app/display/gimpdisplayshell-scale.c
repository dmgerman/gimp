...
typedef|typedef
struct|struct
DECL|struct|__anon2a2c23ee0108
block|{
DECL|member|shell
...
block|{
name|gboolean
name|starts_fitting_horizontally
decl_stmt|;
name|gboolean
name|starts_fitting_vertically
decl_stmt|;
name|gboolean
name|almost_centered_horizontally
decl_stmt|;
name|gboolean
name|almost_centered_vertically
decl_stmt|;
name|gimp_display_shell_scale_get_zoom_focus
argument_list|(
name|shell
