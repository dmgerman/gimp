...
begin_comment
comment|/**  * gimp_display_shell_scale:  * @shell:     the #GimpDisplayShell  * @zoom_type: whether to zoom in, our or to a specific scale  * @new_scale: ignored unless @zoom_type == %GIMP_ZOOM_TO  *  * This function changes the scale (zoom) of the display shell. It  * either zooms in / out one step (%GIMP_ZOOM_IN / %GIMP_ZOOM_OUT) or  * it sets to the zoom ratio passed as @new_scale (%GIMP_ZOOM_TO).  *  * This function also changes the offsets so that the center of the  * displayed area stays in the middle.  **/
end_comment
...
begin_comment
comment|/**  * gimp_display_shell_scale_to  * @shell:     the #GimpDisplayShell  * @zoom_type: whether to zoom in (%GIMP_ZOOM_IN) or out (%GIMP_ZOOM_OUT)  * @x:         x screen coordinate  * @y:         y screen coordinate  *  * This function changes the scale (zoom) of the display shell. It  * zooms in or out one step and changes the display offsets so that  * the point specified by @x and @y doesn't change it's position on  * screen (if possible). This is usually the location of the mouse.  **/
end_comment

begin_function
name|void
DECL|function|gimp_display_shell_scale_to (GimpDisplayShell * shell,GimpZoomType zoom_type,gdouble x,gdouble y)
