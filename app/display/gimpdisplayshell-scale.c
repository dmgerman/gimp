...
typedef|typedef
struct|struct
DECL|struct|__anon2c1a622e0108
block|{
DECL|member|shell
...
specifier|static
name|void
DECL|function|gimp_display_shell_size_allocate_center_image_callback (GimpDisplayShell * shell,GtkAllocation * allocation,GtkWidget * canvas)
name|gimp_display_shell_size_allocate_center_image_callback
parameter_list|(
name|GimpDisplayShell
modifier|*
name|shell
...
begin_comment
comment|/**  * gimp_display_shell_center_image_on_next_size_allocate:  * @shell:  *  * Centers the image in the display as soon as the canvas has got its  * new size  *  **/
end_comment

begin_function
name|void
DECL|function|gimp_display_shell_center_image_on_next_size_allocate (GimpDisplayShell * shell)
