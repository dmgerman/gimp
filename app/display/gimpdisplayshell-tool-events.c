...
condition|)
block|{
comment|/* enable motion compression for the canvas window for the                      * duration of the stroke                      */
name|gdk_window_set_event_compression
argument_list|(
name|gtk_widget_get_window
argument_list|(
name|canvas
...
name|GDK_MOD1_MASK
condition|)
comment|/* Make sure the picked layer is reset. */
name|shell
operator|->
name|picked_layer
operator|=
...
condition|)
block|{
comment|/* Do nothing. We only pick the layer on click. */
block|}
else|else
block|{
