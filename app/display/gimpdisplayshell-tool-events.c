...
name|GdkEvent
modifier|*
DECL|function|gimp_display_shell_compress_motion (GdkEvent * initial_event)
name|gimp_display_shell_compress_motion
parameter_list|(
name|GdkEvent
modifier|*
...
name|GSList
modifier|*
name|remaining_events
init|=
name|NULL
decl_stmt|;
comment|/* Put the event back at the front of the queue... the hard way :P */
name|remaining_events
operator|=
