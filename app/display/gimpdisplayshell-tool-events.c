...
begin_function
name|void
DECL|function|gimp_display_shell_buffer_motion (GimpMotionBuffer * buffer,const GimpCoords * coords,guint32 time,GdkModifierType state,GimpDisplayShell * shell)
