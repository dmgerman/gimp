...
begin_function
name|void
DECL|function|gimp_canvas_corner_set (GimpCanvasItem * corner,gdouble x,gdouble y,gdouble width,gdouble height,gint corner_width,gint corner_height,gboolean outside)
name|gimp_canvas_corner_set
parameter_list|(
name|GimpCanvasItem
modifier|*
name|corner
