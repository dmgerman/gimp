...
specifier|static
name|void
name|gimp_canvas_rectangle_invalidate
parameter_list|(
name|GimpCanvasItem
modifier|*
name|item
...
specifier|static
name|void
DECL|function|gimp_canvas_rectangle_invalidate (GimpCanvasItem * item,GimpDisplayShell * shell)
name|gimp_canvas_rectangle_invalidate
parameter_list|(
name|GimpCanvasItem
modifier|*
