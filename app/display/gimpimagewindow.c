...
include|#
directive|include
file|"widgets/gimpsessioninfo-dock.h"
end_include
...
begin_define
DECL|macro|GIMP_IMAGE_WINDOW_LEFT_DOCKS_WIDTH
define|#
directive|define
name|GIMP_IMAGE_WINDOW_LEFT_DOCKS_WIDTH
...
begin_define
DECL|macro|GIMP_IMAGE_WINDOW_RIGHT_DOCKS_POS
define|#
directive|define
name|GIMP_IMAGE_WINDOW_RIGHT_DOCKS_POS
value|"right-docks-position"
end_define

begin_comment
comment|/* Whether the window's maximized or not */
end_comment

begin_define
DECL|macro|GIMP_IMAGE_WINDOW_MAXIMIZED
define|#
directive|define
name|GIMP_IMAGE_WINDOW_MAXIMIZED
value|"maximized"
end_define
...
block|,
DECL|enumerator|PROP_INITIAL_MONITOR
name|PROP_INITIAL_MONITOR
block|}
enum|;
end_enum
...
decl_stmt|;
DECL|member|suspend_keep_pos
name|gint
name|suspend_keep_pos
decl_stmt|;
DECL|member|update_ui_manager_idle_id
name|gint
...
typedef|typedef
struct|struct
DECL|struct|__anon2a0a4b5b0208
block|{
DECL|member|canvas_x
name|gint
name|canvas_x
decl_stmt|;
DECL|member|canvas_y
name|gint
name|canvas_y
decl_stmt|;
DECL|member|window_x
name|gint
name|window_x
decl_stmt|;
DECL|member|window_y
name|gint
name|window_y
decl_stmt|;
...
specifier|static
name|void
name|gimp_image_window_dock_container_iface_init
parameter_list|(
...
specifier|static
name|void
name|gimp_image_window_session_managed_iface_init
parameter_list|(
...
specifier|static
name|void
name|gimp_image_window_style_updated
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_image_window_monitor_changed
parameter_list|(
name|GimpWindow
modifier|*
name|window
...
name|GList
modifier|*
name|gimp_image_window_get_docks
parameter_list|(
...
name|GimpDialogFactory
modifier|*
name|gimp_image_window_dock_container_get_dialog_factory
parameter_list|(
name|GimpDockContainer
modifier|*
name|dock_container
...
name|GimpUIManager
modifier|*
name|gimp_image_window_dock_container_get_ui_manager
parameter_list|(
name|GimpDockContainer
modifier|*
name|dock_container
...
specifier|static
name|void
name|gimp_image_window_add_dock
parameter_list|(
name|GimpDockContainer
modifier|*
name|dock_container
...
name|gimp_image_window_get_dock_side
parameter_list|(
name|GimpDockContainer
modifier|*
name|dock_container
...
name|GList
modifier|*
name|gimp_image_window_get_aux_info
parameter_list|(
...
specifier|static
name|void
name|gimp_image_window_set_aux_info
parameter_list|(
name|GimpSessionManaged
modifier|*
name|session_managed
...
specifier|static
name|void
name|gimp_image_window_page_reordered
parameter_list|(
name|GtkNotebook
modifier|*
name|notebook
...
specifier|static
name|void
name|gimp_image_window_shell_rotated
parameter_list|(
name|GimpDisplayShell
modifier|*
name|shell
...
name|GtkWidget
modifier|*
name|gimp_image_window_create_tab_label
parameter_list|(
name|GimpImageWindow
modifier|*
name|window
...
specifier|static
name|void
name|gimp_image_window_update_tab_labels
parameter_list|(
name|GimpImageWindow
modifier|*
name|window
...
specifier|static
name|void
DECL|function|gimp_image_window_dock_container_iface_init (GimpDockContainerInterface * iface)
name|gimp_image_window_dock_container_iface_init
parameter_list|(
name|GimpDockContainerInterface
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_window_session_managed_iface_init (GimpSessionManagedInterface * iface)
name|gimp_image_window_session_managed_iface_init
parameter_list|(
name|GimpSessionManagedInterface
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_window_map (GtkWidget * widget)
name|gimp_image_window_map
parameter_list|(
name|GtkWidget
modifier|*
...
name|ns_window
operator|=
name|gdk_quartz_window_get_nswindow
argument_list|(
name|gdk_window
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|gimp_image_window_style_updated (GtkWidget * widget)
name|gimp_image_window_style_updated
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_window_monitor_changed (GimpWindow * window,GdkMonitor * monitor)
name|gimp_image_window_monitor_changed
parameter_list|(
name|GimpWindow
modifier|*
...
name|GList
modifier|*
DECL|function|gimp_image_window_get_docks (GimpDockContainer * dock_container)
name|gimp_image_window_get_docks
parameter_list|(
name|GimpDockContainer
modifier|*
...
name|GimpDialogFactory
modifier|*
DECL|function|gimp_image_window_dock_container_get_dialog_factory (GimpDockContainer * dock_container)
name|gimp_image_window_dock_container_get_dialog_factory
parameter_list|(
name|GimpDockContainer
modifier|*
...
name|GimpUIManager
modifier|*
DECL|function|gimp_image_window_dock_container_get_ui_manager (GimpDockContainer * dock_container)
name|gimp_image_window_dock_container_get_ui_manager
parameter_list|(
name|GimpDockContainer
modifier|*
...
begin_function
name|void
DECL|function|gimp_image_window_add_dock (GimpDockContainer * dock_container,GimpDock * dock,GimpSessionInfoDock * dock_info)
name|gimp_image_window_add_dock
parameter_list|(
name|GimpDockContainer
modifier|*
...
specifier|static
name|GimpAlignmentType
DECL|function|gimp_image_window_get_dock_side (GimpDockContainer * dock_container,GimpDock * dock)
name|gimp_image_window_get_dock_side
parameter_list|(
name|GimpDockContainer
modifier|*
...
name|GList
modifier|*
DECL|function|gimp_image_window_get_aux_info (GimpSessionManaged * session_managed)
name|gimp_image_window_get_aux_info
parameter_list|(
name|GimpSessionManaged
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_window_set_aux_info (GimpSessionManaged * session_managed,GList * aux_info)
name|gimp_image_window_set_aux_info
parameter_list|(
name|GimpSessionManaged
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* We can't set the position of the right docks, because it will        * be undesirably adjusted when its get a new size        * allocation. We must wait until after the size allocation.        */
name|wait_with_right_docks
operator|=
name|TRUE
expr_stmt|;
...
directive|ifdef
name|G_OS_WIN32
comment|/* On Windows, user can provide startup hints to have a program    * maximized/minimized on startup. This can be done through command    * line: `start /max gimp-2.9.exe` or with the shortcut's "run"    * property.    * When such a hint is given, we should follow it and bypass the    * session's information.    */
if|if
condition|(
name|StartupInfo
operator|.
...
name|SW_MINIMIZE
condition|)
comment|/* XXX Iconification does not seem to work. I see the      * window being iconified and immediately re-raised.      * I leave this piece of code for later improvement. */
name|gtk_window_iconify
argument_list|(
name|GTK_WINDOW
argument_list|(
name|session_managed
...
expr_stmt|;
elseif|else
comment|/* Another show property not relevant to min/max.      * Defaults is: SW_SHOWNORMAL      */
endif|#
directive|endif
if|if
condition|(
...
name|GimpImageWindow
modifier|*
DECL|function|gimp_image_window_new (Gimp * gimp,GimpImage * image,GimpDialogFactory * dialog_factory,GdkMonitor * monitor)
...
argument_list|)
expr_stmt|;
name|gtk_notebook_set_tab_reorderable
argument_list|(
name|GTK_NOTEBOOK
argument_list|(
name|private
...
begin_function
name|gboolean
DECL|function|gimp_image_window_is_maximized (GimpImageWindow * window)
name|gimp_image_window_is_maximized
parameter_list|(
name|GimpImageWindow
modifier|*
...
name|window_state
operator|&
name|GDK_WINDOW_STATE_MAXIMIZED
operator|)
operator|!=
literal|0
return|;
...
begin_comment
comment|/**  * gimp_image_window_has_toolbox:  * @window:  *  * Returns: %TRUE if the image window contains a GimpToolbox.  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_image_window_has_toolbox (GimpImageWindow * window)
...
name|GtkWidget
modifier|*
DECL|function|gimp_image_window_get_first_dockbook (GimpDockColumns * columns)
name|gimp_image_window_get_first_dockbook
parameter_list|(
name|GimpDockColumns
modifier|*
name|columns
...
begin_comment
comment|/**  * gimp_image_window_get_default_dockbook:  * @window:  *  * Gets the default dockbook, which is the dockbook in which new  * dockables should be put in single-window mode.  *  * Returns: (nullable): The default dockbook for new dockables, or %NULL if no  *          dockbook were available.  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_image_window_get_default_dockbook (GimpImageWindow * window)
...
argument_list|)
expr_stmt|;
comment|/* First try the first dockbook in the right docks */
name|dock_columns
operator|=
name|GIMP_DOCK_COLUMNS
argument_list|(
...
begin_function
name|void
DECL|function|gimp_image_window_suspend_keep_pos (GimpImageWindow * window)
name|gimp_image_window_suspend_keep_pos
parameter_list|(
name|GimpImageWindow
modifier|*
...
begin_function
name|void
DECL|function|gimp_image_window_resume_keep_pos (GimpImageWindow * window)
name|gimp_image_window_resume_keep_pos
parameter_list|(
name|GimpImageWindow
modifier|*
...
begin_comment
comment|/**  * gimp_image_window_update_tabs:  * @window: the Image Window to update.  *  * Holds the logics of whether shell tabs are to be shown or not in the  * Image Window @window. This function should be called after every  * change to @window where one might expect tab visibility to change.  *  * No direct call to gtk_notebook_set_show_tabs() should ever be made.  * If we change the logics of tab hiding, we should only change this  * procedure instead.  **/
end_comment

begin_function
name|void
DECL|function|gimp_image_window_update_tabs (GimpImageWindow * window)
...
break|break;
default|default:
comment|/* If we have any strange value, just reset to default. */
name|position
operator|=
name|GTK_POS_TOP
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* If docks are being shown, and we are in multi-window-mode,            * and this is the window of the active display, try to set            * the keyboard focus to this window because it might have            * been stolen by a dock. See bug #567333.            */
if|if
condition|(
name|strcmp
argument_list|(
...
specifier|static
name|gboolean
DECL|function|gimp_image_window_update_ui_manager_idle (GimpImageWindow * window)
name|gimp_image_window_update_ui_manager_idle
parameter_list|(
name|GimpImageWindow
modifier|*
...
condition|)
block|{
comment|/*  we are fully initialized, use the window's current monitor        */
name|gimp_image_window_session_update
argument_list|(
name|window
argument_list|,
...
block|{
comment|/*  we are in construction, use the initial monitor; calling        *  gimp_widget_get_monitor() would get us the monitor where the        *  pointer is        */
name|gimp_image_window_session_update
argument_list|(
name|window
argument_list|,
...
specifier|static
name|void
DECL|function|gimp_image_window_page_reordered (GtkNotebook * notebook,GtkWidget * widget,gint page_num,GimpImageWindow * window)
name|gimp_image_window_page_reordered
parameter_list|(
name|GtkNotebook
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_window_session_apply (GimpImageWindow * window,const gchar * entry_id,GdkMonitor * monitor)
name|gimp_image_window_session_apply
parameter_list|(
name|GimpImageWindow
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_window_session_update (GimpImageWindow * window,GimpDisplay * new_display,const gchar * new_entry_id,GdkMonitor * monitor)
name|gimp_image_window_session_update
parameter_list|(
name|GimpImageWindow
modifier|*
...
argument_list|)
decl_stmt|;
comment|/* Handle changes to the entry id */
if|if
condition|(
name|new_entry_id
condition|)
...
condition|)
block|{
comment|/* We're initializing. If we're in single-window mode, this            * will be the only window, so start to session manage            * it. If we're in multi-window mode, we will find out if we            * should session manage ourselves when we get a display            */
if|if
condition|(
name|strcmp
argument_list|(
...
condition|)
block|{
comment|/* The entry id changed, immediately and always stop session            * managing the old entry            */
name|gimp_image_window_session_clear
argument_list|(
name|window
argument_list|)
...
condition|)
block|{
comment|/* If there is only one imageless display, we shall                * become the empty image window                */
if|if
condition|(
name|private
operator|->
...
condition|)
block|{
comment|/* As soon as we become the single image window, we                * shall session manage ourself until single-window mode                * is exited                */
name|gimp_image_window_session_apply
argument_list|(
name|window
argument_list|,
...
expr_stmt|;
block|}
comment|/* Handle changes to the displays. When in single-window mode, we    * just keep session managing the single image window. We only need    * to care about the multi-window mode case here    */
if|if
condition|(
name|new_display
operator|&&
...
specifier|static
name|void
DECL|function|gimp_image_window_shell_rotated (GimpDisplayShell * shell,GimpImageWindow * window)
name|gimp_image_window_shell_rotated
parameter_list|(
name|GimpDisplayShell
modifier|*
...
parameter_list|)
block|{
comment|/* update the<Image>/View/Rotate menu */
name|gimp_image_window_update_ui_manager
argument_list|(
name|window
argument_list|)
...
specifier|static
name|void
DECL|function|gimp_image_window_shell_close_button_callback (GimpDisplayShell * shell)
name|gimp_image_window_shell_close_button_callback
parameter_list|(
name|GimpDisplayShell
modifier|*
name|shell
...
name|GtkWidget
modifier|*
DECL|function|gimp_image_window_create_tab_label (GimpImageWindow * window,GimpDisplayShell * shell)
name|gimp_image_window_create_tab_label
parameter_list|(
name|GimpImageWindow
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_window_update_tab_labels (GimpImageWindow * window)
name|gimp_image_window_update_tab_labels
parameter_list|(
name|GimpImageWindow
modifier|*
