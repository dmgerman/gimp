...
name|GimpStatusbar
modifier|*
DECL|function|gimp_image_window_get_statusbar (GimpImageWindow * window)
...
begin_function
name|void
DECL|function|gimp_image_window_set_show_statusbar (GimpImageWindow * window,gboolean show)
...
begin_function
name|gboolean
DECL|function|gimp_image_window_get_show_statusbar (GimpImageWindow * window)
