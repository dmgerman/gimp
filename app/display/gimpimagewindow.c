...
typedef|typedef
struct|struct
DECL|struct|__anon2988dc180208
block|{
DECL|member|window
...
specifier|static
name|gboolean
name|gimp_image_window_key_pressed
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gboolean
DECL|function|gimp_image_window_key_pressed (GtkWidget * widget,GdkEventKey * event,gpointer user_data)
name|gimp_image_window_key_pressed
parameter_list|(
name|GtkWidget
modifier|*
