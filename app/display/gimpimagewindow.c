...
block|,
DECL|enumerator|PROP_INITIAL_SCREEN
name|PROP_INITIAL_SCREEN
block|,
...
typedef|typedef
struct|struct
DECL|struct|__anon2ad2b9c00208
block|{
...
specifier|static
name|void
DECL|function|gimp_image_window_monitor_changed (GimpWindow * window,GdkScreen * screen,gint monitor)
name|gimp_image_window_monitor_changed
parameter_list|(
name|GimpWindow
modifier|*
...
name|GimpImageWindow
modifier|*
DECL|function|gimp_image_window_new (Gimp * gimp,GimpImage * image,GimpDialogFactory * dialog_factory,GdkScreen * screen,gint monitor)
