...
block|,
DECL|enumerator|PROP_DOCK_FACTORY
name|PROP_DOCK_FACTORY
block|}
enum|;
end_enum
...
name|GimpImageWindow
modifier|*
DECL|function|gimp_image_window_new (Gimp * gimp,GimpImage * image,GimpMenuFactory * menu_factory,GimpDialogFactory * display_factory,GimpDialogFactory * dock_factory)
...
name|GimpDialogFactory
modifier|*
DECL|function|gimp_image_window_get_dock_factory (GimpImageWindow * window)
...
begin_function
name|void
DECL|function|gimp_image_window_set_show_docks (GimpImageWindow * window,gboolean show)
...
begin_function
name|gboolean
DECL|function|gimp_image_window_get_show_docks (GimpImageWindow * window)
