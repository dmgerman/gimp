...
typedef|typedef
struct|struct
DECL|struct|__anon27cf55fa0208
block|{
DECL|member|window
...
specifier|static
name|void
DECL|function|gimp_image_window_clear_docks (GimpDockColumns * columns)
name|gimp_image_window_clear_docks
parameter_list|(
