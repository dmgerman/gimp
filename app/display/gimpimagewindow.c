...
specifier|static
name|void
name|gimp_image_window_real_destroy
parameter_list|(
name|GtkObject
modifier|*
name|object
...
specifier|static
name|void
DECL|function|gimp_image_window_real_destroy (GtkObject * object)
name|gimp_image_window_real_destroy
parameter_list|(
name|GtkObject
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Note that the shell offset isn't the offset of the image into the    * shell, but the offset of the shell relative to the image,    * therefor we need to negate    */
