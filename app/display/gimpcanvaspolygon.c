...
name|GimpCanvasItem
modifier|*
DECL|function|gimp_canvas_polygon_new_from_coords (GimpDisplayShell * shell,const GimpCoords * coords,gint n_coords,gboolean filled)
