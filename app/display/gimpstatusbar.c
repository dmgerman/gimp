...
specifier|static
name|void
name|gimp_statusbar_size_request
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_statusbar_size_request (GtkWidget * widget,GtkRequisition * requisition)
name|gimp_statusbar_size_request
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_statusbar_set_text (GimpStatusbar * statusbar,const gchar * text)
