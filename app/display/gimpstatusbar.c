...
block|,
DECL|enumerator|SIGNAL_TEXT_POPPED
name|SIGNAL_TEXT_POPPED
block|,
DECL|enumerator|SIGNAL_LAST
name|SIGNAL_LAST
block|}
enum|;
end_enum
...
begin_decl_stmt
DECL|variable|statusbar_signals
specifier|static
name|guint
name|statusbar_signals
index|[
name|SIGNAL_LAST
index|]
init|=
...
name|NULL
argument_list|,
name|gimp_marshal_VOID__UINT_STRING
argument_list|,
name|G_TYPE_NONE
argument_list|,
literal|2
...
specifier|static
name|void
DECL|function|gimp_statusbar_update (GimpStatusbar * statusbar,const gchar * context_id,const gchar * text)
name|gimp_statusbar_update
parameter_list|(
name|GimpStatusbar
modifier|*
...
begin_function
name|void
DECL|function|gimp_statusbar_remove (GimpStatusbar * statusbar,const gchar * context,guint message_id)
...
name|list
decl_stmt|;
comment|/* care about signal emission if the topmost item is removed */
if|if
condition|(
name|msg
operator|->
...
begin_function
name|guint
DECL|function|gimp_statusbar_get_context_id (GimpStatusbar * statusbar,const gchar * context_description)
name|gimp_statusbar_get_context_id
parameter_list|(
name|GimpStatusbar
modifier|*
