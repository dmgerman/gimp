...
begin_function
name|void
DECL|function|gimp_statusbar_push_temp (GimpStatusbar * statusbar,const gchar * format,...)
...
begin_function
name|void
DECL|function|gimp_statusbar_push_temp_valist (GimpStatusbar * statusbar,const gchar * format,va_list args)
name|gimp_statusbar_push_temp_valist
parameter_list|(
name|GimpStatusbar
modifier|*
