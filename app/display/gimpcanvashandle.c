...
begin_function
name|gint
DECL|function|gimp_canvas_handle_calc_size (GimpCanvasItem * item,gdouble mouse_x,gdouble mouse_y,gint normal_size,gint hover_size)
...
begin_function
name|void
DECL|function|gimp_canvas_handle_get_size (GimpCanvasItem * handle,gint * width,gint * height)
...
begin_function
name|void
DECL|function|gimp_canvas_handle_set_size (GimpCanvasItem * handle,gint width,gint height)
