...
begin_function
name|void
DECL|function|gimp_display_scale (GimpDisplay * gdisp,GimpZoomType zoom_type)
...
begin_function
name|void
DECL|function|gimp_display_scale_setup (GimpDisplay * gdisp)
...
begin_function
name|void
DECL|function|gimp_display_scale_resize (GimpDisplay * gdisp,gboolean resize_window,gboolean redisplay)
name|gimp_display_scale_resize
parameter_list|(
name|GimpDisplay
modifier|*
...
begin_function
name|void
DECL|function|gimp_display_scale_shrink_wrap (GimpDisplay * gdisp)
