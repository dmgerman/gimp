...
specifier|static
name|void
name|gimp_display_shell_grid_changed_handler
parameter_list|(
name|GimpImage
modifier|*
name|gimage
...
name|config
argument_list|,
literal|"notify::fullscreen-canvas-padding-mode"
argument_list|,
name|G_CALLBACK
argument_list|(
name|gimp_display_shell_padding_notify_handler
...
name|config
argument_list|,
literal|"notify::fullscreen-canvas-padding-color"
argument_list|,
name|G_CALLBACK
argument_list|(
name|gimp_display_shell_padding_notify_handler
...
specifier|static
name|void
DECL|function|gimp_display_shell_grid_changed_handler (GimpImage * gimage,GimpDisplayShell * shell)
name|gimp_display_shell_grid_changed_handler
parameter_list|(
name|GimpImage
modifier|*
