...
specifier|static
name|void
name|gimp_display_shell_update_vectors_handler
parameter_list|(
name|GimpImage
modifier|*
name|image
...
specifier|static
name|void
DECL|function|gimp_display_shell_update_vectors_handler (GimpImage * image,GimpVectors * vectors,GimpDisplayShell * shell)
name|gimp_display_shell_update_vectors_handler
parameter_list|(
name|GimpImage
modifier|*
