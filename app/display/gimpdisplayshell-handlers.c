...
specifier|static
name|void
DECL|function|gimp_display_shell_size_changed_detailed_handler (GimpImage * image,gdouble previous_origin_x,gdouble previous_origin_y,GimpDisplayShell * shell)
name|gimp_display_shell_size_changed_detailed_handler
parameter_list|(
name|GimpImage
modifier|*
