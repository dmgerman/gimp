...
specifier|static
name|void
DECL|function|gimp_display_shell_image_size_starts_to_fit (GimpDisplayShell * shell,gint previous_width,gint previous_height,gint new_width,gint new_height,gboolean * horizontally,gboolean * vertically)
name|gimp_display_shell_image_size_starts_to_fit
parameter_list|(
name|GimpDisplayShell
modifier|*
name|shell
