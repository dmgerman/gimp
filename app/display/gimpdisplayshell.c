...
begin_comment
comment|/**  * gimp_display_shell_set_overlay:  * @shell: a #GimpDisplayShell  * @mask:  a #GimpDrawable (1 byte per pixel)  *  * Allows to preview a selection (used by the foreground selection tool).  **/
end_comment

begin_function
name|void
DECL|function|gimp_display_shell_set_overlay (GimpDisplayShell * shell,GimpDrawable * mask)
