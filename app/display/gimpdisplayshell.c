...
begin_function
name|void
DECL|function|gimp_display_shell_add_overlay (GimpDisplayShell * shell,GtkWidget * child,gdouble image_x,gdouble image_y)
...
begin_function
name|void
DECL|function|gimp_display_shell_move_overlay (GimpDisplayShell * shell,GtkWidget * child,gdouble image_x,gdouble image_y)
