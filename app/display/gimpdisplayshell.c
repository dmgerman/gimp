...
begin_comment
comment|/*  *  String, integer, float and size query boxes  */
end_comment
...
specifier|static
name|void
name|float_query_box_ok_callback
parameter_list|(
name|GtkWidget
modifier|*
parameter_list|,
...
specifier|static
name|void
DECL|function|float_query_box_ok_callback (GtkWidget * w,gpointer client_data)
name|float_query_box_ok_callback
parameter_list|(
name|GtkWidget
modifier|*
