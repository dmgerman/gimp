...
name|GtkWidget
modifier|*
DECL|function|gimp_display_shell_new (GimpDisplay * gdisp,guint scale)
...
begin_function
name|void
DECL|function|gimp_display_shell_set_menu_sensitivity (GimpDisplayShell * shell,Gimp * gimp)
...
name|border_y
expr_stmt|;
comment|/*  block the resulting expose event on any of the following        *  changes because our caller has to do a full display update anyway        */
name|g_signal_handlers_block_by_func
argument_list|(
name|G_OBJECT
argument_list|(
