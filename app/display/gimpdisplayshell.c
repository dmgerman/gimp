...
name|G_CALLBACK
argument_list|(
name|gimp_display_shell_color_changed
argument_list|)
argument_list|,
name|shell
argument_list|)
...
parameter_list|)
define|\
value|gimp_menu_item_set_label ("<Image>/" menu, (label))
...
block|}
break|break;
comment|/* Other cool things to be added: 	       * some kind of resolution / image size thing 	       * people seem to want to know the active layer name 	       */
default|default:
name|g_warning
argument_list|(
