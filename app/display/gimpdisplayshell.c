...
begin_comment
comment|/**  * gimp_display_shell_set_overlay:  * @shell: a #GimpDisplayShell  * @mask:  a #GimpDrawable (1 byte per pixel)  * @color: the color to use for the overlay (or %NULL to not change color)  *  * Allows to mark areas in a given color (used by the foreground  * selection tool).  Pixels that are selected (> 127) in the mask are  * drawn in the given color.  **/
end_comment

begin_function
name|void
DECL|function|gimp_display_shell_set_overlay (GimpDisplayShell * shell,GimpDrawable * mask,const GimpRGB * color)
