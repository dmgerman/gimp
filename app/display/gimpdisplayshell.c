...
specifier|static
name|void
name|toolbox_drag_data_received
parameter_list|(
name|GtkWidget
modifier|*
parameter_list|,
...
argument_list|)
expr_stmt|;
comment|/* The qmask buttons buttons */
name|gdisp
operator|->
name|qmaskoff
operator|=
...
argument_list|)
expr_stmt|;
comment|/* Create pixmaps - note: you must realize the parent prior to doing the      rest! */
if|if
condition|(
operator|!
name|qmasksel_pixmap
...
specifier|static
name|void
DECL|function|toolbox_drag_data_received (GtkWidget * widget,GdkDragContext * context,gint x,gint y,GtkSelectionData * data,guint info,guint time)
name|toolbox_drag_data_received
parameter_list|(
name|GtkWidget
modifier|*
