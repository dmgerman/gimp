...
specifier|static
name|void
DECL|function|gimp_display_shell_close_warning_response (GtkWidget * widget,gint response_id,GimpDisplayShell * shell)
name|gimp_display_shell_close_warning_response
parameter_list|(
name|GtkWidget
modifier|*
