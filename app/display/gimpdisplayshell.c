...
begin_comment
comment|/**  * gimp_display_shell_message:  * @shell:  the #GimpDisplayShell  * @format: printf-like format string  * @...:    arguments  *  * Display a message in the display shell. If the statusbar is  * visible, the message will appear there, otherwise a dialog window  * is opened.  */
end_comment

begin_function
name|void
DECL|function|gimp_display_shell_message (GimpDisplayShell * shell,const gchar * format,...)
...
begin_comment
comment|/**  * gimp_display_shell_message_valist:  * @shell:  the #GimpDisplayShell  * @format: printf-like format string  * @args:   arguments  *  * Display a message in the display shell. See gimp_display_shell_message()  * for details.  */
end_comment

begin_function
name|void
DECL|function|gimp_display_shell_message_valist (GimpDisplayShell * shell,const gchar * format,va_list args)
name|gimp_display_shell_message_valist
parameter_list|(
name|GimpDisplayShell
modifier|*
