...
specifier|static
name|void
DECL|function|gimp_canvas_line_draw (GimpCanvasItem * item,cairo_t * cr)
name|gimp_canvas_line_draw
parameter_list|(
name|GimpCanvasItem
modifier|*
...
name|cairo_region_t
modifier|*
DECL|function|gimp_canvas_line_get_extents (GimpCanvasItem * item)
name|gimp_canvas_line_get_extents
parameter_list|(
name|GimpCanvasItem
modifier|*
