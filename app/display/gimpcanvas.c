...
specifier|static
name|void
name|gimp_canvas_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_canvas_size_allocate (GtkWidget * widget,GtkAllocation * allocation)
name|gimp_canvas_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
...
begin_comment
comment|/**  * gimp_canvas_scroll:  * @canvas: the #GimpCanvas widget to scroll.  * @offset_x: the x scroll amount.  * @offset_y: the y scroll amount.  *  * Scrolls the canvas using gdk_window_scroll() and makes sure the result  * is displayed immediately by calling gdk_window_process_updates().  **/
end_comment

begin_function
name|void
DECL|function|gimp_canvas_scroll (GimpCanvas * canvas,gint offset_x,gint offset_y)
