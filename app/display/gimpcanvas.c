...
begin_comment
comment|/**  * gimp_canvas_set_padding:  * @canvas:   a #GimpCanvas widget  * @color:    a color in #GimpRGB format  *  * Sets the background color of the canvas's window.  This  * is the color the canvas is set to if it is cleared.  **/
end_comment

begin_function
name|void
DECL|function|gimp_canvas_set_padding (GimpCanvas * canvas,GimpCanvasPaddingMode padding_mode,const GimpRGB * padding_color)
