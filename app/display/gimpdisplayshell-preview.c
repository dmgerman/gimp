...
name|j
decl_stmt|;
comment|/*  calculate source coordinates for corners of (sub)rectangle                    */
for|for
control|(
name|j
operator|=
...
expr_stmt|;
block|}
comment|/*  transform source coordinates to display coordinates                    *  through tool and display_shell transforms                    */
for|for
control|(
name|i
operator|=
