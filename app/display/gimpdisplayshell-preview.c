...
specifier|static
name|void
name|gimp_display_shell_draw_quad_row
parameter_list|(
name|GimpDrawable
modifier|*
name|texture
...
specifier|static
name|void
name|gimp_display_shell_draw_quad_row_mask
parameter_list|(
name|GimpDrawable
modifier|*
name|texture
...
specifier|static
name|void
name|gimp_display_shell_trace_quad_edge
parameter_list|(
name|gint
modifier|*
name|dest
...
argument_list|)
expr_stmt|;
comment|/* is the preview in the window? */
block|{
name|gboolean
name|in_window_x
decl_stmt|,
...
DECL|macro|QUAD_TRACE_L_EDGE (a,b)
define|#
directive|define
name|QUAD_TRACE_L_EDGE
parameter_list|(
name|a
parameter_list|,
name|b
parameter_list|)
define|\
value|if (y [a] != y [b]) \         { \           gimp_display_shell_trace_quad_edge (l_edge, \                                               x [a], y [a], \                                               x [b], y [b]); \           left = l_edge; \           dul  = (u [b] - u [a]) / (y [b] - y [a]); \           dvl  = (v [b] - v [a]) / (y [b] - y [a]); \           u_l  = u [a]; \           v_l  = v [a]; \         }
DECL|macro|QUAD_TRACE_R_EDGE (a,b)
define|#
directive|define
name|QUAD_TRACE_R_EDGE
parameter_list|(
name|a
parameter_list|,
name|b
parameter_list|)
define|\
value|if (y [a] != y [b]) \         { \           gimp_display_shell_trace_quad_edge (r_edge, \                                               x [a], y [a], \                                               x [b], y [b]); \           right = r_edge; \           dur   = (u [b] - u [a]) / (y [b] - y [a]); \           dvr   = (v [b] - v [a]) / (y [b] - y [a]); \           u_r   = u [a]; \           v_r   = v [a]; \         }
DECL|macro|QUAD_DRAW_SECTION (a,b)
define|#
directive|define
name|QUAD_DRAW_SECTION
parameter_list|(
name|a
parameter_list|,
name|b
parameter_list|)
define|\
value|if (y [a] != y [b]) \         for (ry = y [a]; ry< y [b]; ry++) \           { \             if (ry>= 0&& ry< dheight) \               { \                 if (mask) \                   gimp_display_shell_draw_quad_row_mask \                                                     (texture, dest, row, \                                                     mask, mask_offx, mask_offy,\                                                     *left, u_l, v_l, \                                                     *right, u_r, v_r, \                                                     ry); \                 else \                   gimp_display_shell_draw_quad_row (texture, dest, row, \                                                     *left, u_l, v_l, \                                                     *right, u_r, v_r, \                                                     ry); \               } \             left ++;      right ++; \             u_l += dul;   v_l += dvl; \             u_r += dur;   v_r += dvr; \           } \     if (((x [0]> x [1])&& (x [3]> x [2])) ||
operator|(
operator|(
name|x
index|[
...
block|)
block|{
comment|/*        *     v0        *       |--__        * _____ |....--_ v1 ____        *       |       |        *       |       |        * _____ |.....__| ______        *       |__---   v2        *     v3        */
name|QUAD_TRACE_L_EDGE
argument_list|(
literal|0
argument_list|,
...
block|{
comment|/*        *           v0        *           /-___        * -------- /.....-- v1 ---        *         /       /        * ___ v2 /__...../________        *           ---_/        *               v3        */
name|QUAD_TRACE_L_EDGE
argument_list|(
literal|0
argument_list|,
...
unit|}  static
name|void
DECL|function|gimp_display_shell_draw_quad_row (GimpDrawable * texture,GdkDrawable * dest,GdkPixbuf * row,gint x1,gfloat u1,gfloat v1,gint x2,gfloat u2,gfloat v2,gint y)
name|gimp_display_shell_draw_quad_row
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_display_shell_draw_quad_row_mask (GimpDrawable * texture,GdkDrawable * dest,GdkPixbuf * row,GimpChannel * mask,gint mask_offx,gint mask_offy,gint x1,gfloat u1,gfloat v1,gint x2,gfloat u2,gfloat v2,gint y)
name|gimp_display_shell_draw_quad_row_mask
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_display_shell_trace_quad_edge (gint * dest,gint x1,gint y1,gint x2,gint y2)
name|gimp_display_shell_trace_quad_edge
parameter_list|(
name|gint
modifier|*
