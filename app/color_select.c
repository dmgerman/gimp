...
specifier|static
name|void
name|color_select_update_scales
parameter_list|(
name|ColorSelect
modifier|*
parameter_list|,
...
specifier|static
name|void
DECL|function|color_select_update_scales (ColorSelect * csp,gint skip)
name|color_select_update_scales
parameter_list|(
name|ColorSelect
modifier|*
...
specifier|static
name|void
DECL|function|color_select_scale_update (GtkObject * adjustment,gpointer data)
name|color_select_scale_update
parameter_list|(
name|GtkObject
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon29c1a8a30408
block|{
DECL|member|callback
name|GimpColorSelector_Callback
name|callback
