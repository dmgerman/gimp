...
block|,
literal|"Returns the tattoo associated with the specified layer."
block|,
literal|"This procedure returns the tattoo associated with the specified layer. A tattoo is a unique and permanent identifier attached to a layer that can be used to uniquely identify a layer within an image even between sessions"
block|,
literal|"Jay Cox"
block|,
literal|"Jay Cox"
