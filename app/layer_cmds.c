...
literal|"mode"
block|,
literal|"the layer combination mode: { NORMAL (0), DISSOLVE (1), MULTIPLY (3), SCREEN (4), OVERLAY (5) DIFFERENCE (6), ADDITION (7), SUBTRACT (8), DARKEN-ONLY (9), LIGHTEN-ONLY (10), HUE (11), SATURATION (12), COLOR (13), VALUE (14), DIVIDE/DODGE (15) }"
block|}
block|}
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|layer_get_tattoo_args
name|ProcArg
name|layer_get_tattoo_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|layer_get_tattoo_out_args
name|ProcArg
name|layer_get_tattoo_out_args
index|[]
init|=
block|{
block|{
...
literal|"tattoo"
block|,
literal|"the tattoo associated with the given layer"
block|}
block|}
decl_stmt|;
end_decl_stmt
...
block|,
literal|"This procedure returns the tattoo associated with the specified layer.  A tattoo is a unique and permenant identifier attached to a layer that can be used to uniquely identify a layer within an image even between sessions"
block|,
literal|"Jay Cox"
block|,
literal|"Jay Cox"
...
begin_decl_stmt
DECL|variable|layer_get_linked_args
name|ProcArg
name|layer_get_linked_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|layer_get_linked_out_args
name|ProcArg
name|layer_get_linked_out_args
index|[]
init|=
block|{
block|{
...
literal|"linked"
block|,
literal|"the layers linked state (for moves)"
block|}
block|}
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|layer_set_linked_args
name|ProcArg
name|layer_set_linked_args
index|[]
init|=
block|{
block|{
...
block|,
literal|"This procedure sets the specified layer's link state."
block|,
literal|"Wolfgang Hofer"
block|,
literal|"Wolfgang Hofer"
