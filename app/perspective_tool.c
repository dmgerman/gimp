...
name|TileManager
modifier|*
DECL|function|perspective_tool_transform (Tool * tool,GDisplay * gdisp,TransformState state)
name|perspective_tool_transform
parameter_list|(
name|Tool
modifier|*
...
specifier|static
name|void
DECL|function|perspective_tool_motion (Tool * tool,GDisplay * gdisp)
name|perspective_tool_motion
parameter_list|(
name|Tool
modifier|*
...
specifier|static
name|void
DECL|function|perspective_tool_recalc (Tool * tool,GDisplay * gdisp)
name|perspective_tool_recalc
parameter_list|(
name|Tool
modifier|*
