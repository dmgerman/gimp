...
begin_macro
DECL|function|G_DEFINE_TYPE_WITH_CODE (GimpLevelsConfig,gimp_levels_config,GIMP_TYPE_VIEWABLE,G_IMPLEMENT_INTERFACE (GIMP_TYPE_CONFIG,gimp_levels_config_iface_init))
