...
begin_function
name|void
DECL|function|gimp_gegl_apply_feather (GeglBuffer * src_buffer,GimpProgress * progress,const gchar * undo_desc,GeglBuffer * dest_buffer,gdouble radius_x,gdouble radius_y)
...
begin_function
name|void
DECL|function|gimp_gegl_apply_gaussian_blur (GeglBuffer * src_buffer,GimpProgress * progress,const gchar * undo_desc,GeglBuffer * dest_buffer,gdouble std_dev_x,gdouble std_dev_y)
name|gimp_gegl_apply_gaussian_blur
parameter_list|(
name|GeglBuffer
modifier|*
