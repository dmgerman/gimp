...
begin_comment
comment|/**  * gimp_cage_config_get_cage_point:  * @gcc: the cage config  * @mode: the actual mode of the cage, GIMP_CAGE_MODE_CAGE_CHANGE or GIMP_CAGE_MODE_DEFORM  *  * Returns: a copy of the cage's point, for the cage mode provided  */
end_comment

begin_function
name|GimpVector2
modifier|*
DECL|function|gimp_cage_config_get_cage_point (GimpCageConfig * gcc,GimpCageMode mode)
...
begin_comment
comment|/**  * gimp_cage_config_commit_cage_point:  * @gcc: the cage config  * @mode: the actual mode of the cage, GIMP_CAGE_MODE_CAGE_CHANGE or GIMP_CAGE_MODE_DEFORM  * @points: a GimpVector2 array of point of the same length as the number of point in the cage  *  * This function update the cage's point with the array provided.  */
end_comment

begin_function
name|void
DECL|function|gimp_cage_config_commit_cage_point (GimpCageConfig * gcc,GimpCageMode mode,GimpVector2 * points)
