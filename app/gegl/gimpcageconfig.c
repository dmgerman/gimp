...
begin_comment
comment|/**  * gimp_cage_config_get_cage_points:  * @gcc: the cage config  *  * Returns: a copy of the cage's point  */
end_comment

begin_function
name|GimpCagePoint
modifier|*
DECL|function|gimp_cage_config_get_cage_points (GimpCageConfig * gcc)
...
begin_comment
comment|/**  * gimp_cage_config_commit_cage_points:  * @gcc: the cage config  * @points: a GimpCagePoint array of point of the same length as the number of point in the cage  *  * This function update the cage's point with the array provided.  */
end_comment

begin_function
name|void
DECL|function|gimp_cage_config_commit_cage_points (GimpCageConfig * gcc,GimpCagePoint * points)
...
begin_comment
comment|/**  * gimp_cage_config_point_inside:  * @gcc: the cage config  * @x: x coordinate of the point to test  * @y: y coordinate of the point to test  *  * Check if the given point is inside the cage. This test is done in  * the regard of the topological inside of the source cage.  *  * Returns: TRUE if the point is inside, FALSE if not.  */
end_comment
