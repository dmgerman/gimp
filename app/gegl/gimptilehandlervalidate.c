...
begin_function
name|void
DECL|function|gimp_tile_handler_validate_invalidate (GimpTileHandlerValidate * validate,gint x,gint y,gint width,gint height)
...
begin_function
name|void
DECL|function|gimp_tile_handler_validate_undo_invalidate (GimpTileHandlerValidate * validate,gint x,gint y,gint width,gint height)
