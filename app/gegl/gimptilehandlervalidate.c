...
name|GeglTile
modifier|*
DECL|function|gimp_tile_handler_validate_validate_tile (GeglTileSource * source,gint x,gint y)
name|gimp_tile_handler_validate_validate_tile
parameter_list|(
name|GeglTileSource
modifier|*
name|source
...
name|tile
operator|=
name|gegl_tile_handler_get_source_tile
argument_list|(
...
begin_function
name|void
DECL|function|gimp_tile_handler_validate_validate (GimpTileHandlerValidate * validate,GeglBuffer * buffer,const GeglRectangle * rect,gboolean intersect)
...
begin_function
name|gboolean
DECL|function|gimp_tile_handler_validate_buffer_set_extent (GeglBuffer * buffer,const GeglRectangle * extent)
...
if|if
condition|(
name|gimp_gegl_buffer_set_extent
argument_list|(
name|buffer
argument_list|,
name|extent
...
argument_list|)
expr_stmt|;
comment|/* temporarily remove the source buffer's validate handler, so that    * gegl_buffer_copy() can use fast tile copying, using the TILE_COPY command.    * currently, gegl only uses TILE_COPY when the source buffer has no user-    * provided tile handlers.    */
if|if
condition|(
name|src_validate
condition|)
