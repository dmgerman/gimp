...
begin_macro
DECL|function|G_DEFINE_TYPE_WITH_CODE (GimpColorBalanceConfig,gimp_color_balance_config,GIMP_TYPE_VIEWABLE,G_IMPLEMENT_INTERFACE (GIMP_TYPE_CONFIG,gimp_color_balance_config_iface_init))
