...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpColorBalanceConfig,gimp_color_balance_config,G_TYPE_OBJECT)
name|G_DEFINE_TYPE
argument_list|(
...
begin_function
name|void
DECL|function|gimp_color_balance_config_reset (GimpColorBalanceConfig * config)
name|gimp_color_balance_config_reset
parameter_list|(
name|GimpColorBalanceConfig
modifier|*
...
begin_function
name|void
DECL|function|gimp_color_balance_config_reset_range (GimpColorBalanceConfig * config,GimpTransferMode range)
name|gimp_color_balance_config_reset_range
parameter_list|(
name|GimpColorBalanceConfig
modifier|*
