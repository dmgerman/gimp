...
condition|)
block|{
comment|/* XXX:      *      * hot-fix for bug #785521 and duplicates, this code to      * be removed after GIMP 2.9.6 is released and GIMP depends      * on 0.3.21 or newer again, we do it also for GEGL 0.3.21      * since setting it to FALSE when it already is FALSE      * is no harm.      */
name|GType
name|op_type
init|=
name|g_type_from_name
argument_list|(
literal|"GeglOpcopy-buffer_c"
argument_list|)
decl_stmt|;
if|if
condition|(
