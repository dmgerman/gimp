...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpOperationDissolveMode,gimp_operation_dissolve_mode,GIMP_TYPE_OPERATION_LAYER_MODE)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|gboolean
DECL|function|gimp_operation_dissolve_mode_process (GeglOperation * operation,void * in_buf,void * aux_buf,void * out_buf,glong samples,const GeglRectangle * roi)
name|gimp_operation_dissolve_mode_process
parameter_list|(
name|GeglOperation
modifier|*
