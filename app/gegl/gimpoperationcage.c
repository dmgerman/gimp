...
directive|if
literal|0
block|gimp_cage_add_cage_point(self->cage, 70, 20);     gimp_cage_add_cage_point(self->cage, 70, 300);     gimp_cage_add_cage_point(self->cage, 450, 300);     gimp_cage_add_cage_point(self->cage, 450, 20);          gimp_cage_move_cage_point_d (self->cage, 1, 100, 250);
else|#
directive|else
block|gimp_cage_add_cage_point(self->cage, 450, 20);
comment|/* need reverse */
block|gimp_cage_add_cage_point(self->cage, 450, 300);     gimp_cage_add_cage_point(self->cage, 70, 300);     gimp_cage_add_cage_point(self->cage, 70, 20);          gimp_cage_move_cage_point_d (self->cage, 2, 100, 250); 	gimp_cage_move_cage_point_d (self->cage, 1, 750, 550);
endif|#
directive|endif
else|#
directive|else
...
argument_list|)
expr_stmt|;
comment|//gimp_cage_move_cage_point_d (self->cage, 6, 500, 500);
else|#
directive|else
name|gimp_cage_add_cage_point
argument_list|(
...
comment|/*gegl_buffer_copy (in_buf, roi, out_buf, roi);*/
