...
name|node
operator|=
name|gimp_gegl_create_apply_node
argument_list|(
name|buffer_source
argument_list|,
name|buffer_offset_x
...
name|GeglNode
modifier|*
DECL|function|gimp_gegl_create_apply_node (GeglNode * apply,gint apply_offset_x,gint apply_offset_y,gint src_offset_x,gint src_offset_y,gint dest_offset_x,gint dest_offset_y,GeglBuffer * mask,gint mask_offset_x,gint mask_offset_y,gdouble opacity,GimpLayerModeEffects mode,GimpComponentMask affect)
name|gimp_gegl_create_apply_node
parameter_list|(
name|GeglNode
modifier|*
