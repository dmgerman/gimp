...
name|GeglNode
modifier|*
DECL|function|gimp_gegl_create_apply_buffer_node (GeglBuffer * buffer,gint buffer_offset_x,gint buffer_offset_y,gint src_offset_x,gint src_offset_y,gint dest_offset_x,gint dest_offset_y,GeglBuffer * mask,gint mask_offset_x,gint mask_offset_y,gdouble opacity,GimpLayerModeEffects mode,GimpComponentMask affect)
...
condition|)
block|{
comment|/*  nothing to do, pass through  */
name|gegl_node_connect_to
argument_list|(
name|input
argument_list|,
...
condition|)
block|{
comment|/*  modes that need access to the buffer's alpha channel are        *  implemented using GeglOperationPointComposer3 subclasses,        *  and have an "opacity" property, so they have access to all        *  sources of transparency independently        */
name|gegl_node_set
argument_list|(
name|mode_node
argument_list|,
...
condition|)
block|{
comment|/*  normal case: put the buffer through an opacity node that        *  applies mask and opacity before doing the actual mode        */
name|GeglNode
modifier|*
name|opacity_node
decl_stmt|;
...
block|{
comment|/*  shortcut for the case where the opacity node wouldn't do        *  anything        */
name|gegl_node_connect_to
argument_list|(
name|buffer_source
argument_list|,
