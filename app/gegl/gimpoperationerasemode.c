...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpOperationEraseMode,gimp_operation_erase_mode,GIMP_TYPE_OPERATION_POINT_COMPOSER)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|gboolean
DECL|function|gimp_operation_erase_mode_process (GeglOperation * operation,void * in_buf,void * aux_buf,void * out_buf,glong samples,const GeglRectangle * roi)
name|gimp_operation_erase_mode_process
parameter_list|(
name|GeglOperation
modifier|*
