...
name|description
operator|=
literal|"GIMP Posterize operation"
expr_stmt|;
name|point_class
operator|->
name|process
...
specifier|static
name|gboolean
DECL|function|gimp_operation_posterize_process (GeglOperation * operation,void * in_buf,void * out_buf,glong samples,const GeglRectangle * roi)
name|gimp_operation_posterize_process
parameter_list|(
name|GeglOperation
modifier|*
