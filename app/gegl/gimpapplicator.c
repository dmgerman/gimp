...
name|GimpApplicator
modifier|*
DECL|function|gimp_applicator_new (GeglNode * parent)
...
begin_function
name|void
DECL|function|gimp_applicator_set_output_format (GimpApplicator * applicator,const Babl * format)
...
begin_function
name|void
DECL|function|gimp_applicator_set_crop (GimpApplicator * applicator,const GeglRectangle * rect)
...
name|GeglRectangle
modifier|*
DECL|function|gimp_applicator_get_crop (GimpApplicator * applicator)
