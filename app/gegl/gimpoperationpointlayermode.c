...
case|:
comment|/* SVG 1.2 color-dodge with disabled [0..1] clamping */
comment|/* if (lay[R] * in[A] + in[R] * lay[A]>= lay[A] * in[A])             {               out[R] = lay[A] * in[A] + lay[R] * (1 - in[A]) + in[R] * (1 - lay[A]);               out[R] = lay[A] * in[A] + lay[R] * (1 - in[A]) + in[R] * (1 - lay[A]);               out[R] = lay[A] * in[A] + lay[R] * (1 - in[A]) + in[R] * (1 - lay[A]);             }           else */
block|{
name|out
index|[
name|R
...
name|GIMP_BURN_MODE
case|:
comment|/* SVG 1.2 color-burn with disabled [0..1] clamping */
comment|/* if (lay[R] * in[A] + in[R] * lay[A]<= lay[A] * in[A])             {               out[R] = lay[R] * (1 - in[A]) + in[R] * (1 - lay[A]);               out[G] = lay[G] * (1 - in[A]) + in[G] * (1 - lay[A]);               out[B] = lay[B] * (1 - in[A]) + in[B] * (1 - lay[A]);             }           else */
block|{
name|out
index|[
name|R
...
case|:
comment|/* Derieved from SVG 1.2 formulas */
name|out
index|[
name|R
index|]
