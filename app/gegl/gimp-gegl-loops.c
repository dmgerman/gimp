...
begin_comment
comment|/* helper function of gimp_gegl_smudge_with_paint_process()    src and dest can be the same address  */
end_comment
...
specifier|inline
name|void
DECL|function|gimp_gegl_smudge_with_paint_blend (const gfloat * src1,gfloat src1_rate,const gfloat * src2,gfloat src2_rate,gfloat * dest,gboolean no_erasing_src2)
name|gimp_gegl_smudge_with_paint_blend
parameter_list|(
specifier|const
name|gfloat
modifier|*
...
begin_comment
comment|/* helper function of gimp_gegl_smudge_with_paint() */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_gegl_smudge_with_paint_process (gfloat * accum,const gfloat * canvas,gfloat * paint,gint count,const gfloat * brush_color,gfloat brush_a,gboolean no_erasing,gfloat flow,gfloat rate)
name|gimp_gegl_smudge_with_paint_process
parameter_list|(
name|gfloat
modifier|*
name|accum
...
begin_comment
comment|/*  smudge painting calculation. Currently only smudge tool uses this function  *  Accum = rate*Accum + (1-rate)*Canvas  *  if brush_color!=NULL  *    Paint = flow*brushColor + (1-flow)*Accum  *  else  *    Paint = flow*Paint + (1-flow)*Accum  */
end_comment

begin_function
name|void
DECL|function|gimp_gegl_smudge_with_paint (GeglBuffer * accum_buffer,const GeglRectangle * accum_rect,GeglBuffer * canvas_buffer,const GeglRectangle * canvas_rect,const GimpRGB * brush_color,GeglBuffer * paint_buffer,gboolean no_erasing,gdouble flow,gdouble rate)
...
argument_list|)
expr_stmt|;
comment|/* convert brush color from double to float */
if|if
condition|(
name|brush_color
condition|)
...
begin_function
name|void
DECL|function|gimp_gegl_index_to_mask (GeglBuffer * indexed_buffer,const GeglRectangle * indexed_rect,const Babl * indexed_format,GeglBuffer * mask_buffer,const GeglRectangle * mask_rect,gint index)
...
begin_function
name|void
DECL|function|gimp_gegl_convert_color_profile (GeglBuffer * src_buffer,const GeglRectangle * src_rect,GimpColorProfile * src_profile,GeglBuffer * dest_buffer,const GeglRectangle * dest_rect,GimpColorProfile * dest_profile,GimpColorRenderingIntent intent,gboolean bpc,GimpProgress * progress)
