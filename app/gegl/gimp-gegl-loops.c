...
specifier|static
name|gboolean
DECL|function|gimp_color_profile_can_gegl_copy (GimpColorProfile * src_profile,GimpColorProfile * dest_profile)
name|gimp_color_profile_can_gegl_copy
parameter_list|(
...
block|{
comment|/* FIXME: no idea if this ever happens */
name|gegl_buffer_copy
argument_list|(
name|src_buffer
argument_list|,
...
begin_function
name|void
DECL|function|gimp_gegl_convert_color_transform (GeglBuffer * src_buffer,const GeglRectangle * src_rect,const Babl * src_format,GeglBuffer * dest_buffer,const GeglRectangle * dest_rect,const Babl * dest_format,GimpColorTransform transform,GimpProgress * progress)
name|gimp_gegl_convert_color_transform
parameter_list|(
name|GeglBuffer
modifier|*
...
name|dest_format
argument_list|,
comment|/* use READWRITE for alpha surfaces                              * because we must use the alpha channel                              * that is already copied, see above                              */
name|has_alpha
condition|?
name|GEGL_ACCESS_READWRITE
else|:
