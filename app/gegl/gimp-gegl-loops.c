...
name|transform
decl_stmt|;
comment|/*  FIXME: we need the unconditional full copy only in two cases:    *  - if we return without doing anything    *  - if there is an alpha channel, because lcms doesn't copy it    */
