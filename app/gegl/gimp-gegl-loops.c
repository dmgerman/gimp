...
begin_comment
comment|/* helper function of gimp_gegl_smudge_with_paint()    src and dest can be the same address  */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_gegl_smudge_with_paint_blend (const gfloat * src1,gfloat src1_rate,const gfloat * src2,gfloat src2_rate,gfloat * dest,gboolean no_erasing_src2,gboolean sse)
