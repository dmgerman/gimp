...
begin_macro
DECL|function|G_DEFINE_TYPE_WITH_CODE (GimpColorizeConfig,gimp_colorize_config,GIMP_TYPE_VIEWABLE,G_IMPLEMENT_INTERFACE (GIMP_TYPE_CONFIG,NULL))
