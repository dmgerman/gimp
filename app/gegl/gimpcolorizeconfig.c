...
begin_function
name|void
DECL|function|gimp_colorize_config_get_color (GimpColorizeConfig * config,GimpRGB * color)
...
begin_function
name|void
DECL|function|gimp_colorize_config_set_color (GimpColorizeConfig * config,const GimpRGB * color)
