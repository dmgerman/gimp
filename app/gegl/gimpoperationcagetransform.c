...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpOperationCageTransform,gimp_operation_cage_transform,GEGL_TYPE_OPERATION_FILTER)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|gboolean
DECL|function|gimp_operation_cage_transform_process (GeglOperation * operation,GeglBuffer * in_buf,GeglBuffer * out_buf,const GeglRectangle * roi)
name|gimp_operation_cage_transform_process
parameter_list|(
name|GeglOperation
modifier|*
...
condition|)
return|return;
comment|/* test if there is only one pixel left in the triangle */
if|if
condition|(
name|xmax
operator|-
