...
specifier|static
name|void
DECL|function|gimp_operation_cage_transform_interpolate_source_coords_recurs (GimpOperationCageTransform * oct,GeglBuffer * out_buf,const GeglRectangle * roi,GimpCoords p1_s,GimpCoords p1_d,GimpCoords p2_s,GimpCoords p2_d,GimpCoords p3_s,GimpCoords p3_d,gint recursion_depth,gfloat * coords)
name|gimp_operation_cage_transform_interpolate_source_coords_recurs
parameter_list|(
name|GimpOperationCageTransform
modifier|*
