...
parameter_list|)
define|\
value|g_test_add ("/gimp-session-management/" #function, \               GimpTestFixture, \               NULL, \               NULL, \               function, \               NULL);
end_define

begin_typedef
typedef|typedef
struct|struct
DECL|struct|__anon2b8bad180108
block|{
DECL|member|dummy
name|int
name|dummy
...
typedef|typedef
struct|struct
DECL|struct|__anon2b8bad180208
block|{
...
begin_comment
comment|/**  * Tests that a sessionrc from GIMP 2.6 is loaded and written (thus  * also interpreted) like we expect.  **/
end_comment

begin_function
specifier|static
name|void
DECL|function|session_2_6_compatibility (GimpTestFixture * fixture,gconstpointer data)
name|session_2_6_compatibility
parameter_list|(
name|GimpTestFixture
modifier|*
name|fixture
