...
parameter_list|)
define|\
value|g_test_add_func ("/gimp-session-2-6-compatibility/" #function, function);
end_define
...
parameter_list|)
define|\
value|g_test_add_func ("/gimp-session-2-6-compatibility/subprocess/" #function, function);
end_define
