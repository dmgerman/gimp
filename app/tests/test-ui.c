...
typedef|typedef
struct|struct
DECL|struct|__anon2b73ae3a0108
block|{
...
specifier|static
name|void
name|gimp_ui_synthesize_plus_key_event
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_ui_synthesize_plus_key_event (GtkWidget * widget)
name|gimp_ui_synthesize_plus_key_event
parameter_list|(
name|GtkWidget
modifier|*
...
literal|20
decl_stmt|;
comment|/* FIXME: How do we figure out hardware_keycode, especially in a    * platform independent way? 20 is the hardware keycode on my    * machine for GDK_plus when using a X11 backend... I hope it will    * be the same on others running at least the X11 build of GTK+    */
name|window
operator|=
name|gtk_widget_get_window
argument_list|(
