...
begin_comment
comment|/* early-stage sanity check, performed before the call to app_run(). */
end_comment
...
name|gchar
modifier|*
DECL|function|sanity_check_early (void)
...
begin_comment
comment|/* late-stage sanity check, performed during app_run(), after the user  * configuration has been loaded.  */
end_comment
...
name|gchar
modifier|*
DECL|function|sanity_check_late (void)
