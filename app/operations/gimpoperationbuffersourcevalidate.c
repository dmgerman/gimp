...
name|y
expr_stmt|;
comment|/* check if the rectangle interescts with the dirty region */
name|overlap
operator|=
...
name|iter
decl_stmt|;
comment|/* if the rectangle is not entirely within the dirty                    * region ...                    */
if|if
condition|(
name|overlap
operator|==
...
argument_list|)
expr_stmt|;
comment|/* realign the rectangle to the tile grid */
name|rect
operator|.
name|x
operator|=
...
name|shift_y
expr_stmt|;
comment|/* iterate over the rectangle -- this implicitly causes                    * validation                    */
name|iter
operator|=
