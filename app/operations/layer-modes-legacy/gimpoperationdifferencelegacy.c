...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpOperationDifferenceLegacy,gimp_operation_difference_legacy,GIMP_TYPE_OPERATION_POINT_LAYER_MODE)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|gboolean
DECL|function|gimp_operation_difference_legacy_process (GeglOperation * operation,void * in_buf,void * aux_buf,void * aux2_buf,void * out_buf,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_difference_legacy_process
parameter_list|(
name|GeglOperation
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_operation_difference_legacy_process_pixels (gfloat * in,gfloat * layer,gfloat * mask,gfloat * out,gfloat opacity,glong samples,const GeglRectangle * roi,gint level,GimpLayerColorSpace blend_trc,GimpLayerColorSpace composite_trc,GimpLayerCompositeMode composite_mode)
name|gimp_operation_difference_legacy_process_pixels
parameter_list|(
name|gfloat
modifier|*
