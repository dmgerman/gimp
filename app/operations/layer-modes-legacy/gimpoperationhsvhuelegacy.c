...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpOperationHsvHueLegacy,gimp_operation_hsv_hue_legacy,GIMP_TYPE_OPERATION_LAYER_MODE)
name|G_DEFINE_TYPE
argument_list|(
...
begin_function
name|gboolean
DECL|function|gimp_operation_hsv_hue_legacy_process (GeglOperation * op,void * in_p,void * layer_p,void * mask_p,void * out_p,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_hsv_hue_legacy_process
parameter_list|(
name|GeglOperation
modifier|*
