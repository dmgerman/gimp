...
typedef|typedef
struct|struct
DECL|struct|__anon28acb1630208
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon28acb1630308
block|{
DECL|member|buffer
name|GeglBuffer
modifier|*
...
name|g_warning
argument_list|(
literal|"gimp:blend can't handle gradients with foreground or "
literal|"background segments. Call gimp_gradient_flatten on "
literal|"the gradient first"
argument_list|)
expr_stmt|;
name|g_object_unref
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*rbd.dist_buffer = gradient_precalc_shapeburst (image, drawable,                                                      buffer_region,                                                      rbd.dist, progress);*/
comment|/* FIXME */
