...
specifier|static
name|void
name|gimp_operation_burn_mode_prepare
parameter_list|(
name|GeglOperation
modifier|*
name|operation
...
specifier|static
name|void
DECL|function|gimp_operation_burn_mode_prepare (GeglOperation * operation)
name|gimp_operation_burn_mode_prepare
parameter_list|(
name|GeglOperation
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_operation_burn_mode_process (GeglOperation * operation,void * in_buf,void * aux_buf,void * out_buf,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_burn_mode_process
parameter_list|(
name|GeglOperation
modifier|*
