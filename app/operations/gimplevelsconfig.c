...
block|,
DECL|enumerator|PROP_CLAMP_INPUT
name|PROP_CLAMP_INPUT
block|,
...
block|,
DECL|enumerator|PROP_CLAMP_OUTPUT
name|PROP_CLAMP_OUTPUT
block|}
enum|;
end_enum
...
name|_
argument_list|(
literal|"Clamp input values before applying output mapping."
argument_list|)
argument_list|,
name|FALSE
argument_list|,
...
name|channel
expr_stmt|;
comment|/*  serialize the channel properties manually (not using        *  gimp_config_serialize_properties()), so the parent class'        *  "time" property doesn't end up in the config file one per        *  channel. See bug #700653.        */
name|success
operator|=
operator|(
name|gimp_config_serialize_property_by_name
...
begin_function
name|gboolean
DECL|function|gimp_levels_config_load_cruft (GimpLevelsConfig * config,GInputStream * input,GError ** error)
...
begin_function
name|gboolean
DECL|function|gimp_levels_config_save_cruft (GimpLevelsConfig * config,GOutputStream * output,GError ** error)
...
name|_
argument_list|(
literal|"Writing levels file failed: "
argument_list|)
argument_list|)
expr_stmt|;
name|g_string_free
