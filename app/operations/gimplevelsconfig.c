...
begin_function
name|gboolean
DECL|function|gimp_levels_config_save_cruft (GimpLevelsConfig * config,GFile * file,GError ** error)
...
name|_
argument_list|(
literal|"Writing levels file '%s' failed: %s"
argument_list|)
argument_list|,
name|gimp_file_get_utf8_name
argument_list|(
