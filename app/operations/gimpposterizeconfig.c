...
begin_macro
DECL|function|G_DEFINE_TYPE_WITH_CODE (GimpPosterizeConfig,gimp_posterize_config,GIMP_TYPE_SETTINGS,G_IMPLEMENT_INTERFACE (GIMP_TYPE_CONFIG,NULL))
