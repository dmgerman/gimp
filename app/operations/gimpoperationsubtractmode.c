...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpOperationSubtractMode,gimp_operation_subtract_mode,GIMP_TYPE_OPERATION_POINT_LAYER_MODE)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|gboolean
DECL|function|gimp_operation_subtract_mode_process (GeglOperation * operation,void * in_buf,void * aux_buf,void * aux2_buf,void * out_buf,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_subtract_mode_process
parameter_list|(
name|GeglOperation
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_operation_subtract_mode_process_pixels (gfloat * in,gfloat * layer,gfloat * mask,gfloat * out,gdouble opacity,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_subtract_mode_process_pixels
parameter_list|(
name|gfloat
modifier|*
