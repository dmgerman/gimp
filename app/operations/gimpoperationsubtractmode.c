...
specifier|static
name|gboolean
DECL|function|gimp_operation_subtract_mode_process (GeglOperation * operation,void * in_buf,void * aux_buf,void * out_buf,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_subtract_mode_process
parameter_list|(
name|GeglOperation
modifier|*
