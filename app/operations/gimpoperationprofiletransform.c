...
block|,
DECL|enumerator|PROP_SRC_FORMAT
name|PROP_SRC_FORMAT
block|,
DECL|enumerator|PROP_DEST_PROFILE
name|PROP_DEST_PROFILE
block|,
DECL|enumerator|PROP_DEST_FORMAT
name|PROP_DEST_FORMAT
block|,
DECL|enumerator|PROP_RENDERING_INTENT
name|PROP_RENDERING_INTENT
block|,
DECL|enumerator|PROP_BLACK_POINT_COMPENSATION
name|PROP_BLACK_POINT_COMPENSATION
block|}
enum|;
end_enum
