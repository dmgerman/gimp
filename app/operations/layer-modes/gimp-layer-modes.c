...
begin_function
name|gboolean
DECL|function|gimp_layer_mode_is_alpha_only (GimpLayerMode mode)
...
begin_function
name|gboolean
DECL|function|gimp_layer_mode_is_trivial (GimpLayerMode mode)
...
begin_function
name|GimpLayerModeBlendFunc
DECL|function|gimp_layer_mode_get_blend_function (GimpLayerMode mode)
...
name|Babl
modifier|*
DECL|function|gimp_layer_mode_get_format (GimpLayerMode mode,GimpLayerColorSpace blend_space,GimpLayerColorSpace composite_space,GimpLayerCompositeMode composite_mode,const Babl * preferred_format)
...
condition|)
block|{
comment|/* alpha-only layer modes don't combine colors in non-union composite            * modes, hence we can disregard the composite space.            */
name|composite_space
operator|=
name|GIMP_LAYER_COLOR_SPACE_AUTO
expr_stmt|;
...
condition|)
block|{
comment|/* trivial layer modes don't combine colors when only the source            * region is included, hence we can disregard the composite space.            */
name|composite_space
operator|=
name|GIMP_LAYER_COLOR_SPACE_AUTO
expr_stmt|;
