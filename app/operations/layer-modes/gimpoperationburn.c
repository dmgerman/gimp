...
begin_function
name|gboolean
DECL|function|gimp_operation_burn_process_pixels (gfloat * in,gfloat * layer,gfloat * mask,gfloat * out,gfloat opacity,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_burn_process_pixels
parameter_list|(
name|gfloat
modifier|*
