...
ifndef|#
directive|ifndef
name|__GIMP_OPERATION_SCREEN_H__
end_ifndef

begin_define
DECL|macro|__GIMP_OPERATION_SCREEN_H__
define|#
directive|define
name|__GIMP_OPERATION_SCREEN_H__
end_define
...
begin_define
DECL|macro|GIMP_OPERATION_SCREEN_CLASS (klass)
define|#
directive|define
name|GIMP_OPERATION_SCREEN_CLASS
parameter_list|(
name|klass
parameter_list|)
...
begin_define
DECL|macro|GIMP_IS_OPERATION_SCREEN_CLASS (klass)
define|#
directive|define
name|GIMP_IS_OPERATION_SCREEN_CLASS
parameter_list|(
name|klass
parameter_list|)
...
begin_define
DECL|macro|GIMP_OPERATION_SCREEN_GET_CLASS (obj)
define|#
directive|define
name|GIMP_OPERATION_SCREEN_GET_CLASS
parameter_list|(
name|obj
parameter_list|)
...
begin_typedef
DECL|typedef|GimpOperationScreen
typedef|typedef
name|struct
name|_GimpOperationScreen
name|GimpOperationScreen
typedef|;
end_typedef

begin_typedef
DECL|typedef|GimpOperationScreenClass
typedef|typedef
name|struct
name|_GimpOperationScreenClass
name|GimpOperationScreenClass
typedef|;
end_typedef

begin_struct
DECL|struct|_GimpOperationScreen
struct|struct
name|_GimpOperationScreen
block|{
...
begin_struct
DECL|struct|_GimpOperationScreenClass
struct|struct
name|_GimpOperationScreenClass
block|{
...
begin_decl_stmt
name|GType
name|gimp_operation_screen_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
begin_comment
comment|/* __GIMP_OPERATION_SCREEN_H__ */
end_comment
