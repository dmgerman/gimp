...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpOperationHsvSaturation,gimp_operation_hsv_saturation,GIMP_TYPE_OPERATION_LAYER_MODE)
name|G_DEFINE_TYPE
argument_list|(
...
begin_function
name|gboolean
DECL|function|gimp_operation_hsv_saturation_process (GeglOperation * op,void * in,void * layer,void * mask,void * out,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_hsv_saturation_process
parameter_list|(
name|GeglOperation
modifier|*
