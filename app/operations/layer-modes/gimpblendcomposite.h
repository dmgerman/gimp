...
specifier|inline
name|void
DECL|function|compfun_src_over (gfloat * in,gfloat * layer,gfloat * mask,gfloat * out,gfloat opacity,gint samples)
...
case|:
comment|//compfun_src_over (blend_in, blend_out, mask, opacity, out, samples);
