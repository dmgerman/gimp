...
begin_function
name|gboolean
DECL|function|gimp_operation_normal_process_pixels_sse2 (gfloat * in,gfloat * aux,gfloat * mask,gfloat * out,gfloat opacity,glong samples,const GeglRectangle * roi,gint level)
