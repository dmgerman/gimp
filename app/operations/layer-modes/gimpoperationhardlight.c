...
begin_function
name|gboolean
DECL|function|gimp_operation_hardlight_process_pixels (gfloat * in,gfloat * layer,gfloat * mask,gfloat * out,gfloat opacity,glong samples,const GeglRectangle * roi,gint level,GimpLayerBlendTRC blend_trc,GimpLayerBlendTRC composite_trc,GimpLayerCompositeMode composite_mode)
name|gimp_operation_hardlight_process_pixels
parameter_list|(
name|gfloat
modifier|*
