...
specifier|static
name|gboolean
DECL|function|gimp_operation_hardlight_process (GeglOperation * operation,void * in_buf,void * aux_buf,void * aux2_buf,void * out_buf,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_hardlight_process
parameter_list|(
name|GeglOperation
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_operation_hardlight_process_pixels (gfloat * in,gfloat * layer,gfloat * mask,gfloat * out,gfloat opacity,glong samples,const GeglRectangle * roi,gint level,GimpLayerColorSpace blend_trc,GimpLayerColorSpace composite_trc,GimpLayerCompositeMode composite_mode)
name|gimp_operation_hardlight_process_pixels
parameter_list|(
name|gfloat
modifier|*
