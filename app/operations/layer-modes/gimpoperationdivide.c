...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpOperationDivide,gimp_operation_divide,GIMP_TYPE_OPERATION_LAYER_MODE)
name|G_DEFINE_TYPE
argument_list|(
...
begin_function
name|gboolean
DECL|function|gimp_operation_divide_process (GeglOperation * op,void * in,void * layer,void * mask,void * out,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_divide_process
parameter_list|(
name|GeglOperation
modifier|*
