...
begin_define
DECL|macro|SAFE_DIV_MAX
define|#
directive|define
name|SAFE_DIV_MAX
value|(1.0f / SAFE_DIV_MIN)
end_define
...
begin_comment
comment|/* returns a / b, clamped to [-SAFE_DIV_MAX, SAFE_DIV_MAX].  * if -SAFE_DIV_MIN<= a<= SAFE_DIV_MIN, returns 0.  */
end_comment
...
specifier|inline
name|gfloat
DECL|function|safe_div (gfloat a,gfloat b)
name|safe_div
parameter_list|(
name|gfloat
name|a
...
name|blue_luminance
decl_stmt|;
name|babl_space_get_rgb_luminance
argument_list|(
name|space
argument_list|,
operator|&
