...
begin_comment
comment|/* XXX: this should be removed along with _pre_process */
end_comment

begin_function
name|gboolean
DECL|function|gimp_operation_lch_hue_process_pixels (gfloat * in,gfloat * layer,gfloat * mask,gfloat * out,gfloat opacity,glong samples,const GeglRectangle * roi,gint level,GimpLayerBlendTRC blend_trc,GimpLayerBlendTRC composite_trc,GimpLayerCompositeMode composite_mode)
name|gimp_operation_lch_hue_process_pixels
parameter_list|(
name|gfloat
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_operation_lch_hue_process_pixels_linear (gfloat * in,gfloat * layer,gfloat * mask,gfloat * out,gfloat opacity,glong samples,const GeglRectangle * roi,gint level,GimpLayerBlendTRC blend_trc,GimpLayerBlendTRC composite_trc,GimpLayerCompositeMode composite_mode)
name|gimp_operation_lch_hue_process_pixels_linear
parameter_list|(
name|gfloat
modifier|*
