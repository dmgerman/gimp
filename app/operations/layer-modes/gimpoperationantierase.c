...
specifier|static
name|void
name|gimp_operation_anti_erase_prepare
parameter_list|(
name|GeglOperation
modifier|*
name|operation
...
specifier|static
name|void
name|gimp_operation_anti_erase_class_init
parameter_list|(
...
specifier|static
name|void
DECL|function|gimp_operation_anti_erase_init (GimpOperationAntiErase * self)
name|gimp_operation_anti_erase_init
parameter_list|(
...
specifier|static
name|void
DECL|function|gimp_operation_anti_erase_prepare (GeglOperation * operation)
name|gimp_operation_anti_erase_prepare
parameter_list|(
name|GeglOperation
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_operation_anti_erase_process (GeglOperation * operation,void * in_buf,void * aux_buf,void * aux2_buf,void * out_buf,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_anti_erase_process
parameter_list|(
name|GeglOperation
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_operation_anti_erase_process_pixels (gfloat * in,gfloat * layer,gfloat * mask,gfloat * out,gfloat opacity,glong samples,const GeglRectangle * roi,gint level,GimpLayerBlendTRC blend_trc,GimpLayerBlendTRC composite_trc,GimpLayerCompositeMode composite_mode)
name|gimp_operation_anti_erase_process_pixels
parameter_list|(
name|gfloat
modifier|*
