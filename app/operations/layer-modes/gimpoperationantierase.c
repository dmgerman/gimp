...
begin_function
name|gboolean
DECL|function|gimp_operation_anti_erase_process (GeglOperation * op,void * in_p,void * layer_p,void * mask_p,void * out_p,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_anti_erase_process
parameter_list|(
name|GeglOperation
modifier|*
