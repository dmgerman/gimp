...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpOperationOverlay,gimp_operation_overlay,GIMP_TYPE_OPERATION_LAYER_MODE)
name|G_DEFINE_TYPE
argument_list|(
...
literal|"description"
argument_list|,
literal|"GIMP overlay mode operation"
argument_list|,
name|NULL
argument_list|)
expr_stmt|;
...
begin_function
name|gboolean
DECL|function|gimp_operation_overlay_process (GeglOperation * operation,void * in,void * layer,void * mask,void * out,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_overlay_process
parameter_list|(
name|GeglOperation
modifier|*
