...
begin_function
name|gboolean
DECL|function|gimp_operation_softlight_process (GeglOperation * op,void * in,void * layer,void * mask,void * out,glong samples,const GeglRectangle * roi,gint level)
name|gimp_operation_softlight_process
parameter_list|(
name|GeglOperation
modifier|*
