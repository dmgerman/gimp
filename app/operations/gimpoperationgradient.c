...
begin_define
DECL|macro|GRADIENT_CACHE_N_SUPERSAMPLES
define|#
directive|define
name|GRADIENT_CACHE_N_SUPERSAMPLES
value|4
end_define

begin_define
DECL|macro|GRADIENT_CACHE_MAX_SIZE
define|#
directive|define
name|GRADIENT_CACHE_MAX_SIZE
value|((1<< 20) / sizeof (GimpRGB))
end_define

begin_enum
enum|enum
DECL|enum|__anon295a46010103
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon295a46010208
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon295a46010308
block|{
DECL|member|data
name|gfloat
modifier|*
...
specifier|static
name|void
name|gimp_operation_gradient_finalize
parameter_list|(
name|GObject
modifier|*
name|gobject
...
specifier|static
name|void
name|gimp_operation_gradient_validate_cache
parameter_list|(
name|GimpOperationGradient
modifier|*
name|self
...
specifier|static
name|void
DECL|function|gimp_operation_gradient_finalize (GObject * object)
name|gimp_operation_gradient_finalize
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|gdouble
DECL|function|gradient_calc_shapeburst_angular_factor (GeglSampler * dist_sampler,gdouble x,gdouble y)
name|gradient_calc_shapeburst_angular_factor
parameter_list|(
name|GeglSampler
modifier|*
...
specifier|static
name|gdouble
DECL|function|gradient_calc_shapeburst_spherical_factor (GeglSampler * dist_sampler,gdouble x,gdouble y)
name|gradient_calc_shapeburst_spherical_factor
parameter_list|(
name|GeglSampler
modifier|*
...
specifier|static
name|gdouble
DECL|function|gradient_calc_shapeburst_dimpled_factor (GeglSampler * dist_sampler,gdouble x,gdouble y)
name|gradient_calc_shapeburst_dimpled_factor
parameter_list|(
name|GeglSampler
modifier|*
...
specifier|static
name|void
DECL|function|gradient_dither_pixel (GimpRGB * color,GRand * dither_rand,gfloat * dest)
name|gradient_dither_pixel
parameter_list|(
name|GimpRGB
modifier|*
...
name|dist_sampler
operator|=
name|gegl_buffer_sampler_new_at_level
argument_list|(
name|input
argument_list|,
name|babl_format
...
specifier|static
name|void
DECL|function|gimp_operation_gradient_invalidate_cache (GimpOperationGradient * self)
name|gimp_operation_gradient_invalidate_cache
parameter_list|(
name|GimpOperationGradient
modifier|*
...
specifier|static
name|void
DECL|function|gimp_operation_gradient_validate_cache (GimpOperationGradient * self)
name|gimp_operation_gradient_validate_cache
parameter_list|(
name|GimpOperationGradient
modifier|*
...
name|GRADIENT_CACHE_N_SUPERSAMPLES
expr_stmt|;
comment|/*  have at least two values in the cache  */
name|cache_size
operator|=
name|MAX
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  don't use a cache if its necessary size is too big  */
if|if
condition|(
name|cache_size
operator|>
