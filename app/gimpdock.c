...
begin_comment
comment|/* static gboolean  gimp_dock_tab_button_press (GtkWidget      *widget, 					     GdkEventButton *bevent, 					     gpointer        data); static void      gimp_dock_tab_drag_begin   (GtkWidget      *widget, 					     GdkDragContext *context, 					     gpointer        data); static void      gimp_dock_tab_drag_end     (GtkWidget      *widget, 					     GdkDragContext *context, 					     gpointer        data); */
end_comment
