...
block|,
DECL|enumerator|PROP_SHOW_CANVAS_BOUNDARY
name|PROP_SHOW_CANVAS_BOUNDARY
block|,
...
block|,
DECL|enumerator|PROP_SNAP_TO_GUIDES
name|PROP_SNAP_TO_GUIDES
block|,
DECL|enumerator|PROP_SNAP_TO_GRID
name|PROP_SNAP_TO_GRID
block|,
DECL|enumerator|PROP_SNAP_TO_CANVAS
name|PROP_SNAP_TO_CANVAS
block|,
DECL|enumerator|PROP_SNAP_TO_PATH
