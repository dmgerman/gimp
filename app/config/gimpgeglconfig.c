...
begin_define
DECL|macro|GIMP_DEFAULT_SWAP_COMPRESSION
define|#
directive|define
name|GIMP_DEFAULT_SWAP_COMPRESSION
value|"fast"
end_define
...
name|PROP_SWAP_PATH
block|,
DECL|enumerator|PROP_SWAP_COMPRESSION
name|PROP_SWAP_COMPRESSION
block|,
