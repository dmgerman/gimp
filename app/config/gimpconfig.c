...
argument|filename
argument_list|,
argument|O_WRONLY | O_CREAT | O_TRUNC
argument_list|,
ifndef|#
directive|ifndef
name|G_OS_WIN32
...
typedef|typedef
struct|struct
DECL|struct|__anon2b3fcd150108
block|{
DECL|member|key
name|gchar
modifier|*
...
begin_comment
comment|/*   * Generic code useful when working with config objects.  */
end_comment

begin_comment
comment|/**  * gimp_config_duplicate:  * @object: a #GObject object to duplicate.  *   * Creates a copy of the passed object by copying all object properties.  * This only works for objects that are completely defined by their  * properties.  *   * Return value: the duplicated #GObject.  **/
end_comment
