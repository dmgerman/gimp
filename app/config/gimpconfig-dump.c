...
specifier|static
name|void
DECL|function|dump_gimprc_system (GimpConfig * rc,GimpConfigWriter * writer,GOutputStream * output)
name|dump_gimprc_system
parameter_list|(
name|GimpConfig
modifier|*
...
literal|"@gimpsysconfdir@/gimprc and a per-user @manpage_gimpdir@/gimprc\n"
...
literal|"variable GIMP2_DIRECTORY or to @manpage_gimpdir@.\n"
literal|".TP\n"
...
literal|".TP\n"
literal|".I @manpage_gimpdir@/gimprc\n"
...
specifier|static
name|void
DECL|function|dump_gimprc_manpage (GimpConfig * rc,GimpConfigWriter * writer,GOutputStream * output)
name|dump_gimprc_manpage
parameter_list|(
name|GimpConfig
modifier|*
...
literal|"%o  the name of the image's color profile\n\n"
decl_stmt|;
end_decl_stmt
...
specifier|static
name|void
DECL|function|dump_with_linebreaks (GOutputStream * output,const gchar * text)
name|dump_with_linebreaks
parameter_list|(
name|GOutputStream
modifier|*
