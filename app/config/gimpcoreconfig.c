...
begin_define
DECL|macro|BUILD_PLUG_IN_PATH (name)
define|#
directive|define
name|BUILD_PLUG_IN_PATH
parameter_list|(
name|name
parameter_list|)
define|\
value|("${gimp_dir}" G_DIR_SEPARATOR_S name G_SEARCHPATH_SEPARATOR_S \    "${gimp_plugin_dir}" G_DIR_SEPARATOR_S name)
end_define

begin_define
DECL|macro|BUILD_DATA_PATH (name)
define|#
directive|define
name|BUILD_DATA_PATH
parameter_list|(
name|name
parameter_list|)
define|\
value|("${gimp_dir}" G_DIR_SEPARATOR_S name G_SEARCHPATH_SEPARATOR_S \    "${gimp_datadir}" G_DIR_SEPARATOR_S name)
end_define
