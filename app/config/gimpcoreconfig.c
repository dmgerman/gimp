...
begin_comment
comment|/* Constant available since Shell32.dll 5.0 */
end_comment
...
begin_define
DECL|macro|CSIDL_LOCAL_APPDATA
define|#
directive|define
name|CSIDL_LOCAL_APPDATA
value|0x001c
...
begin_define
DECL|macro|GIMP_DEFAULT_BRUSH
define|#
directive|define
name|GIMP_DEFAULT_BRUSH
value|"2. Hardness 050"
end_define

begin_define
DECL|macro|GIMP_DEFAULT_DYNAMICS
define|#
directive|define
name|GIMP_DEFAULT_DYNAMICS
value|"Dynamics Off"
end_define

begin_define
DECL|macro|GIMP_DEFAULT_PATTERN
define|#
directive|define
name|GIMP_DEFAULT_PATTERN
value|"Pine"
end_define

begin_define
DECL|macro|GIMP_DEFAULT_PALETTE
define|#
directive|define
name|GIMP_DEFAULT_PALETTE
value|"Default"
end_define

begin_define
DECL|macro|GIMP_DEFAULT_GRADIENT
define|#
directive|define
name|GIMP_DEFAULT_GRADIENT
value|"FG to BG (RGB)"
end_define

begin_define
DECL|macro|GIMP_DEFAULT_TOOL_PRESET
define|#
directive|define
name|GIMP_DEFAULT_TOOL_PRESET
value|"Current Options"
end_define

begin_define
DECL|macro|GIMP_DEFAULT_FONT
define|#
directive|define
name|GIMP_DEFAULT_FONT
value|"Sans-serif"
end_define

begin_define
DECL|macro|GIMP_DEFAULT_MYPAINT_BRUSH
define|#
directive|define
name|GIMP_DEFAULT_MYPAINT_BRUSH
value|"Fixme"
end_define

begin_define
DECL|macro|GIMP_DEFAULT_COMMENT
define|#
directive|define
name|GIMP_DEFAULT_COMMENT
value|"Created with GIMP"
end_define

begin_enum
enum|enum
DECL|enum|__anon2b9ccc8b0103
block|{
...
block|,
DECL|enumerator|PROP_MYPAINT_BRUSH_PATH
name|PROP_MYPAINT_BRUSH_PATH
block|,
DECL|enumerator|PROP_MYPAINT_BRUSH_PATH_WRITABLE
...
block|,
DECL|enumerator|PROP_DEFAULT_MYPAINT_BRUSH
...
block|,
DECL|enumerator|PROP_EXPORT_FILE_TYPE
name|PROP_EXPORT_FILE_TYPE
block|,
DECL|enumerator|PROP_EXPORT_COLOR_PROFILE
name|PROP_EXPORT_COLOR_PROFILE
block|,
DECL|enumerator|PROP_EXPORT_COMMENT
name|PROP_EXPORT_COMMENT
block|,
DECL|enumerator|PROP_EXPORT_METADATA_EXIF
name|PROP_EXPORT_METADATA_EXIF
block|,
DECL|enumerator|PROP_EXPORT_METADATA_XMP
name|PROP_EXPORT_METADATA_XMP
block|,
DECL|enumerator|PROP_EXPORT_METADATA_IPTC
name|PROP_EXPORT_METADATA_IPTC
block|,
DECL|enumerator|PROP_DEBUG_POLICY
name|PROP_DEBUG_POLICY
block|,
DECL|enumerator|PROP_CHECK_UPDATES
name|PROP_CHECK_UPDATES
block|,
DECL|enumerator|PROP_CHECK_UPDATE_TIMESTAMP
name|PROP_CHECK_UPDATE_TIMESTAMP
block|,
DECL|enumerator|PROP_LAST_KNOWN_RELEASE
name|PROP_LAST_KNOWN_RELEASE
block|,
...
begin_comment
comment|/*  * Taken from glib 2.35 code / gimpenv.c.  * Only temporary until the user-font folder detection can go upstream  * in fontconfig!  * XXX  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* G_SEARCHPATH_SEPARATOR-separated list of folders. */
name|tmp
operator|=
name|g_strconcat
argument_list|(
...
argument_list|,
literal|"timestamp of the last update check"
argument_list|,
...
argument_list|,
literal|"last known release of GIMP"
argument_list|,
