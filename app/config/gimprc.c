...
begin_comment
comment|/**  * gimp_rc_new:  * @gimp:          a #Gimp  * @system_gimprc: the name of the system-wide gimprc file or %NULL to  *                 use the standard location  * @user_gimprc:   the name of the user gimprc file or %NULL to use the  *                 standard location  * @verbose:       enable console messages about loading and saving  *  * Creates a new GimpRc object and loads the system-wide and the user  * configuration files.  *  * Returns: the new #GimpRc.  */
end_comment

begin_function
name|GimpRc
modifier|*
DECL|function|gimp_rc_new (GObject * gimp,GFile * system_gimprc,GFile * user_gimprc,gboolean verbose)
name|gimp_rc_new
parameter_list|(
name|GObject
modifier|*
...
begin_function
name|void
DECL|function|gimp_rc_load_system (GimpRc * rc)
name|gimp_rc_load_system
parameter_list|(
name|GimpRc
modifier|*
...
begin_function
name|void
DECL|function|gimp_rc_load_user (GimpRc * rc)
name|gimp_rc_load_user
parameter_list|(
name|GimpRc
modifier|*
...
begin_comment
comment|/**  * gimp_rc_migrate:  * @rc: a #GimpRc object.  *  * Resets all GimpParamConfigPath properties of the passed rc object  * to their default values, in order to prevent paths in a migrated  * gimprc to refer to folders in the old GIMP's user directory.  **/
end_comment

begin_function
name|void
DECL|function|gimp_rc_migrate (GimpRc * rc)
