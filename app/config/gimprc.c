...
begin_comment
comment|/**  * gimp_rc_set_unkown_token:  * @gimprc: a #GimpRc object.  * @token:  * @value:  *  * Calls gimp_config_add_unknown_token() and triggers an idle-save if  * autosave is enabled on @gimprc.  **/
end_comment
