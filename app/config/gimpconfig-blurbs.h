...
ifndef|#
directive|ifndef
name|__GIMP_CONFIG_BLURBS_H__
end_ifndef

begin_define
DECL|macro|__GIMP_CONFIG_BLURBS_H__
define|#
directive|define
name|__GIMP_CONFIG_BLURBS_H__
end_define
...
define|\
value|"Set the gamma correction value for the display. 1.0 corresponds to no " \ "gamma correction.  For most displays, gamma correction should be set " \ "to between 2.0 and 2.6. One important thing to keep in mind: Many images "\ "that you might get from outside sources will in all likelihood already "\ "be gamma-corrected.  In these cases, the image will look washed-out if "\ "the gimp has gamma-correction turned on.  If you are going to work with "\ "images of this sort, turn gamma correction off by setting the value to 1.0."
end_define
...
begin_comment
comment|/* __GIMP_CONFIG_BLURBS_H__ */
end_comment
