...
name|ColorPanel
modifier|*
DECL|function|color_panel_new (guchar r,guchar g,guchar b,guchar a,gboolean show_alpha,gint width,gint height)
...
begin_function
name|void
DECL|function|color_panel_set_color (ColorPanel * color_panel,guchar r,guchar g,guchar b,guchar a)
...
specifier|static
name|void
DECL|function|color_panel_select_callback (gint r,gint g,gint b,gint a,ColorNotebookState state,gpointer data)
name|color_panel_select_callback
parameter_list|(
name|gint
name|r
...
specifier|static
name|void
DECL|function|color_panel_drag_color (GtkWidget * widget,guchar * r,guchar * g,guchar * b,guchar * a,gpointer data)
name|color_panel_drag_color
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|color_panel_drop_color (GtkWidget * widget,guchar r,guchar g,guchar b,guchar a,gpointer data)
name|color_panel_drop_color
parameter_list|(
name|GtkWidget
modifier|*
