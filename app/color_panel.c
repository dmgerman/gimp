...
name|ColorPanel
modifier|*
DECL|function|color_panel_new (unsigned char * initial,int width,int height)
...
name|private_part
expr_stmt|;
comment|/* make sure we hide and free color_select */
if|if
condition|(
name|private
operator|->
...
specifier|static
name|void
DECL|function|color_panel_select_callback (int r,int g,int b,ColorSelectState state,void * client_data)
name|color_panel_select_callback
parameter_list|(
name|int
name|r
