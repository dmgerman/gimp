...
specifier|static
name|void
DECL|function|color_panel_get_color (gpointer data,guchar * r,guchar * g,guchar * b)
name|color_panel_get_color
parameter_list|(
name|gpointer
name|data
...
specifier|static
name|void
DECL|function|color_panel_set_color (gpointer data,guchar r,guchar g,guchar b)
name|color_panel_set_color
parameter_list|(
name|gpointer
name|data
