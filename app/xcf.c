...
begin_function
DECL|function|read_one_path (XcfInfo * info)
specifier|static
name|BZPATHP
name|read_one_path
parameter_list|(
...
name|_
argument_list|(
literal|"Warning, unit out of range in XCF file, falling back to pixels"
argument_list|)
argument_list|)
expr_stmt|;
name|unit
