...
control|)
block|{
comment|/* save the start offset of where we are writing        *  out the next level.        */
name|offset
operator|=
name|info
operator|->
...
specifier|static
name|void
DECL|function|xcf_save_level (XcfInfo * info,TileLevel * level)
name|xcf_save_level
parameter_list|(
name|XcfInfo
modifier|*
...
control|)
block|{
comment|/* read in the offset of the next level */
name|info
operator|->
name|cp
operator|+=
...
specifier|static
name|gint
DECL|function|xcf_load_level (XcfInfo * info,TileManager * tiles,TileLevel * level,int level_num)
name|xcf_load_level
parameter_list|(
name|XcfInfo
modifier|*
...
name|TRUE
return|;
comment|/* get the first tile from this level. this will    *  cause 'level->tiles' to be created so that    *  we can load in the tiles.    */
