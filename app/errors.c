...
begin_decl_stmt
DECL|variable|log_domain_handler_ids
specifier|static
name|guint
name|log_domain_handler_ids
index|[
name|G_N_ELEMENTS
argument_list|(
name|log_domains
...
begin_decl_stmt
DECL|variable|gegl_handler_id
specifier|static
name|guint
name|gegl_handler_id
init|=
literal|0
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|global_handler_id
specifier|static
name|guint
name|global_handler_id
init|=
literal|0
decl_stmt|;
end_decl_stmt
...
name|GList
modifier|*
DECL|function|errors_recovered (void)
...
condition|)
block|{
comment|/* A quick basic security check. It is not foolproof,                    * but better than nothing to make sure we are not                    * trying to read, then delete a folder or a symlink                    * to a file outside the backup directory.                    */
name|recovered
operator|=
name|g_list_append
argument_list|(
...
name|log_domain
expr_stmt|;
comment|/* If debug policy requires it, WARNING and CRITICAL errors must be    * routed for appropriate debugging.    */
name|g_object_get
argument_list|(
name|G_OBJECT
argument_list|(
