...
typedef|typedef
struct|struct
DECL|struct|__anon2b83ca0c0108
block|{
DECL|member|bits
name|guchar
modifier|*
...
block|,
comment|/* to be reordered */
DECL|enumerator|GIMP_ZOOM_CURSOR
name|GIMP_ZOOM_CURSOR
block|,
comment|/* to be reordered / removed: */
