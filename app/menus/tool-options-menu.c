...
specifier|static
name|void
DECL|function|tool_options_menu_update_presets (GimpUIManager * manager,guint merge_id,const gchar * ui_path,const gchar * menu_path,const gchar * action_prefix,GimpContainer * presets)
name|tool_options_menu_update_presets
parameter_list|(
name|GimpUIManager
modifier|*
