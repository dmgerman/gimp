...
specifier|static
name|gint
DECL|function|menus_tearoff_delete_cb (GtkWidget * widget,GdkEvent * event,gpointer data)
name|menus_tearoff_delete_cb
parameter_list|(
name|GtkWidget
modifier|*
