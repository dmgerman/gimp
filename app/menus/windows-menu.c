...
specifier|static
name|gboolean
name|windows_menu_is_toolbox_dock_window
parameter_list|(
name|GimpDockWindow
modifier|*
name|dock_window
...
specifier|static
name|void
name|windows_menu_remove_toolbox_entries
parameter_list|(
name|GimpContainer
modifier|*
name|docks
...
argument_list|)
expr_stmt|;
comment|/* There can only be one toolbox around, so if a new is created,    * make sure to remove any toolbox entries from Recenly Closed Docks    */
if|if
condition|(
name|windows_menu_is_toolbox_dock_window
argument_list|(
...
specifier|static
name|gboolean
DECL|function|windows_menu_is_toolbox_dock_window (GimpDockWindow * dock_window)
name|windows_menu_is_toolbox_dock_window
parameter_list|(
name|GimpDockWindow
modifier|*
...
specifier|static
name|void
DECL|function|windows_menu_remove_toolbox_entries (GimpContainer * docks)
name|windows_menu_remove_toolbox_entries
parameter_list|(
name|GimpContainer
modifier|*
