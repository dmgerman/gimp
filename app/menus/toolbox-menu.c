...
name|N_
argument_list|(
literal|"/File/Dialogs/_Create New Dock"
argument_list|)
argument_list|)
block|,
block|{
...
name|N_
argument_list|(
literal|"/File/Dialogs/Create New Dock/Layers, Channels& Paths..."
argument_list|)
block|,
name|NULL
block|,
...
name|N_
argument_list|(
literal|"/File/Dialogs/Create New Dock/Brushes, Patterns& Gradients..."
argument_list|)
block|,
name|NULL
block|,
...
name|N_
argument_list|(
literal|"/File/Dialogs/Create New Dock/Misc. Stuff..."
argument_list|)
block|,
name|NULL
block|,
...
name|N_
argument_list|(
literal|"/File/Dialogs/Templates..."
argument_list|)
block|,
literal|""
block|,
