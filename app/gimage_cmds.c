...
name|Argument
modifier|*
name|gimp_image_parasite_list_invoker
parameter_list|(
name|Argument
modifier|*
parameter_list|)
...
name|Argument
modifier|*
DECL|function|gimage_get_unit_invoker (Argument * args)
name|gimage_get_unit_invoker
parameter_list|(
name|Argument
modifier|*
name|args
...
name|UNIT_PIXEL
expr_stmt|;
comment|/*  pixel is not a valid image unit  */
name|success
operator|=
name|TRUE
expr_stmt|;
...
begin_decl_stmt
DECL|variable|gimage_get_unit_args
name|ProcArg
name|gimage_get_unit_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|gimage_get_unit_out_args
name|ProcArg
name|gimage_get_unit_out_args
index|[]
init|=
block|{
block|{
...
literal|"unit"
block|,
literal|"the unit ID of the image's display unit"
block|,   }
block|}
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|gimage_get_unit_proc
name|ProcRecord
name|gimage_get_unit_proc
init|=
block|{
...
block|,
literal|"Returns the unit of the image"
block|,
literal|"This procedure returns the unit ID of the image's unit. This value is independent of any of the layers in this image. A return value of 0 means the image was invalid. See the gimp_unit_* procedure definitions for the valid range of unit IDs and a description of the unit system."
block|,
...
name|Argument
modifier|*
DECL|function|gimage_set_unit_invoker (Argument * args)
name|gimage_set_unit_invoker
parameter_list|(
name|Argument
modifier|*
name|args
...
begin_decl_stmt
DECL|variable|gimage_set_unit_args
name|ProcArg
name|gimage_set_unit_args
index|[]
init|=
block|{
block|{
...
literal|"unit"
block|,
literal|"unit ID of the image's new unit"
block|,   }
block|}
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|gimage_set_unit_proc
name|ProcRecord
name|gimage_set_unit_proc
init|=
block|{
...
block|,
literal|"Sets the unit of the image"
block|,
literal|"This procedure sets the image's unit by it's unit ID. This value is independent of any of the layers in this image. No scaling or resizing is performed. See the gimp_unit_* procedure definitions for the valid range of unit IDs and a description of the unit system."
block|,
literal|"Michael Natterer"
block|,
literal|"Michael Natterer"
...
condition|)
block|{
comment|/* A colourmap alteration affects the whole image. */
...
begin_comment
comment|/***** gimp_image_parasite_list ****/
end_comment

begin_decl_stmt
DECL|variable|gimp_image_parasite_list_in_args
name|ProcArg
name|gimp_image_parasite_list_in_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|gimp_image_parasite_list_out_args
name|ProcArg
name|gimp_image_parasite_list_out_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|gimp_image_parasite_list_proc
name|ProcRecord
...
name|Argument
modifier|*
DECL|function|gimp_image_parasite_list_invoker (Argument * args)
name|gimp_image_parasite_list_invoker
parameter_list|(
name|Argument
modifier|*
