...
specifier|static
name|void
DECL|function|window_size_req_cb (GtkWindow * win,GtkRequisition * req,GimpColormapDialog * ipal)
name|window_size_req_cb
parameter_list|(
name|GtkWindow
modifier|*
...
specifier|static
name|void
DECL|function|index_entry_change_cb (GtkEntry * entry,GimpColormapDialog * ipal)
name|index_entry_change_cb
parameter_list|(
name|GtkEntry
modifier|*
...
specifier|static
name|void
DECL|function|ipal_add_callback (GtkWidget * w,gpointer client_data)
name|ipal_add_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|ipal_edit_callback (GtkWidget * w,gpointer client_data)
name|ipal_edit_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|ipal_close_callback (GtkWidget * w,gpointer client_data)
name|ipal_close_callback
parameter_list|(
name|GtkWidget
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|create_image_menu (GimpColormapDialog * ipal,GimpImage ** def,int * default_index,MenuItemCallback callback)
name|create_image_menu
parameter_list|(
name|GimpColormapDialog
modifier|*
