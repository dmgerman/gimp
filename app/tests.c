...
argument_list|(
literal|"*\n"
literal|"*  The env var GIMP_TESTING_ABS_TOP_SRCDIR is not set,\n"
literal|"*  you are probably running in a debugger.\n"
literal|"*  Set it manually, e.g.:\n"
literal|"*\n"
literal|"*    set env GIMP_TESTING_ABS_TOP_SRCDIR=%s/source/gimp\n"
literal|"*\n"
argument_list|,
name|g_get_home_dir
argument_list|()
...
name|g_dir_make_tmp
argument_list|(
literal|"gimp-test-icon-theme-XXXXXX"
argument_list|,
name|NULL
argument_list|)
expr_stmt|;
