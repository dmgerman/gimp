...
specifier|inline
name|gdouble
DECL|function|weighted_sum (gdouble dx,gdouble dy,gint s00,gint s10,gint s01,gint s11)
name|weighted_sum
parameter_list|(
name|gdouble
name|dx
...
specifier|static
name|void
DECL|function|decimate_average_pr (PixelRegion * srcPR,gint x0,gint y0,gint x1,gint y1,guchar * p)
name|decimate_average_pr
parameter_list|(
name|PixelRegion
modifier|*
...
specifier|static
name|void
DECL|function|interpolate_bilinear_pr (PixelRegion * srcPR,gint x0,gint y0,gint x1,gint y1,gdouble xfrac,gdouble yfrac,guchar * p)
name|interpolate_bilinear_pr
parameter_list|(
name|PixelRegion
modifier|*
