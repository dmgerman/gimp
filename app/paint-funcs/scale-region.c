...
specifier|inline
name|void
DECL|function|gaussian_decimate (const guchar * pixels,const gint bytes,guchar * pixel)
name|gaussian_decimate
parameter_list|(
specifier|const
name|guchar
...
specifier|inline
name|void
DECL|function|gaussian_lanczos2 (const guchar * pixels,const gint bytes,guchar * pixel)
name|gaussian_lanczos2
parameter_list|(
specifier|const
name|guchar
