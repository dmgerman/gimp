...
ifndef|#
directive|ifndef
name|__PAINT_FUNCS_INDEXEDA_H__
end_ifndef

begin_define
DECL|macro|__PAINT_FUNCS_INDEXEDA_H__
define|#
directive|define
name|__PAINT_FUNCS_INDEXEDA_H__
end_define
...
begin_comment
comment|//void  gray_to_rgb_pixels    (const guchar *src, guchar *dest,
end_comment

begin_comment
comment|//			     int length, int bytes);
end_comment
...
begin_function_decl
name|void
name|combine_indexeda_and_indexed_pixels
parameter_list|(
specifier|const
name|guchar
modifier|*
...
begin_function_decl
name|void
name|apply_layer_mode_indexeda_indexed
parameter_list|(
...
begin_function_decl
name|void
name|apply_layer_mode_indexeda_indexeda
parameter_list|(
name|apply_combine_layer_info
modifier|*
name|info
...
begin_comment
comment|/*  __PAINT_FUNCS_INDEXEDA_H__  */
end_comment
