...
begin_function
name|void
DECL|function|border_region (PixelRegion * destPR,void * bs_ptr,int bs_segs,int radius)
name|border_region
parameter_list|(
name|PixelRegion
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  only draw the rest if they are different  */
if|if
condition|(
name|j
condition|)
...
begin_function
name|int
DECL|function|thin_region (PixelRegion * src,int type)
name|thin_region
parameter_list|(
name|PixelRegion
modifier|*
...
name|temp_row
decl_stmt|;
comment|/*  feed both the prev and cur row buffers from the paint func buffer  */
name|prev_row
operator|=
name|paint_funcs_get_buffer
argument_list|(
