...
begin_function
name|void
DECL|function|convolve_tempbuf (TempBuf * srcR,TempBuf * destR,const gfloat * matrix,gint size,gdouble divisor,GimpConvolutionType mode,gboolean alpha_weighting)
