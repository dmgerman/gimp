...
specifier|static
name|void
DECL|function|gimp_gradient_dump (GimpGradient * gradient,FILE * file)
name|gimp_gradient_dump
parameter_list|(
name|GimpGradient
modifier|*
...
begin_function
name|void
DECL|function|gimp_gradient_save (GimpGradient * gradient)
...
name|g_message
argument_list|(
literal|"%s(): can't save gradient with NULL filename"
argument_list|,
name|G_GNUC_FUNCTION
argument_list|)
expr_stmt|;
