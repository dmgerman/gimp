...
begin_comment
comment|/*  CHANNEL_GET_TATTOO_PROC  */
end_comment
...
begin_decl_stmt
DECL|variable|channel_get_tattoo_args
name|ProcArg
name|channel_get_tattoo_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|channel_get_tattoo_out_args
name|ProcArg
name|channel_get_tattoo_out_args
index|[]
init|=
block|{
block|{
...
literal|"tattoo"
block|,
literal|"the tattoo associated with the given channel"
block|}
block|}
decl_stmt|;
end_decl_stmt
...
block|,
literal|"This procedure returns the tattoo associated with the specified channel.  A tattoo is a unique and permenant identifier attached to a channel that can be used to uniquely identify a channel within an image even between sessions"
block|,
literal|"Jay Cox"
block|,
literal|"Jay Cox"
