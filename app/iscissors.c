...
name|resolution
decl_stmt|;
DECL|member|resolution_d
name|double
name|resolution_d
decl_stmt|;
DECL|member|resolution_w
name|GtkObject
modifier|*
name|resolution_w
decl_stmt|;
...
name|elasticity
decl_stmt|;
DECL|member|elasticity_d
name|double
name|elasticity_d
decl_stmt|;
DECL|member|elasticity_w
name|GtkObject
modifier|*
name|elasticity_w
decl_stmt|;
...
begin_comment
comment|/*  the intelligent scissors tool options  */
end_comment
...
comment|/*drawable_offsets(drawable,&tx,&ty); 	  tx += newx; 	  ty += newy;*/
name|gdk_points
index|[
name|index
index|]
...
operator|=
name|conv1
comment|/*+ MAX_CHANNELS * (CONV_WIDTH * offy + offx)*/
expr_stmt|;
name|destPR
operator|.
name|rowstride
