...
name|GPtrArray
modifier|*
DECL|function|plot_pixels (Iscissors * iscissors,TempBuf * dp_buf,gint x1,gint y1,gint xs,gint ys,gint xe,gint ye)
name|plot_pixels
parameter_list|(
name|Iscissors
modifier|*
...
specifier|static
name|void
DECL|function|find_max_gradient (Iscissors * iscissors,GImage * gimage,gint * x,gint * y)
name|find_max_gradient
parameter_list|(
name|Iscissors
modifier|*
