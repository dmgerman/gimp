...
block|}
block|}
comment|/*  dump=fopen("/ugrad/summersn/dump", "w"); */
comment|/*   fprintf(dump, "P5\n%d %d\n255\n", edge_map->width, edge_map->height); */
comment|/*   fwrite(edge_map->data, edge_map->width * edge_map->height, sizeof (guchar), dump); */
comment|/*   fclose (dump); */
return|return
name|edge_map
return|;
...
name|dboffset
expr_stmt|;
comment|/* look at this debuggin info.*/
name|printf
argument_list|(
literal|"Pixel region dump (Y %d %d) X %d %d\n"
argument_list|,
name|y
argument_list|,
name|endy
...
name|printf
argument_list|(
literal|"index(%d) X: %d Y: %d ox: %d oy: %d \n"
argument_list|,
name|index
argument_list|,
name|x
...
name|printf
argument_list|(
literal|"s.x:%d s.y:%d s.w:%d s.h:%d s.rs:%d s.b%d\n"
argument_list|,
name|srcPR
operator|.
name|x
...
name|printf
argument_list|(
literal|"d.x:%d d.y:%d d.w:%d d.h:%d d.rs:%d d.b%d\n"
argument_list|,
name|destPR
operator|.
name|x
...
name|printf
argument_list|(
literal|"e.x:%d e.y:%d e.w:%d e.h:%d\n"
argument_list|,
name|edge_buf
operator|->
name|x
