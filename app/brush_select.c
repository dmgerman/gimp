...
begin_typedef
DECL|struct|__anon292364b40108
typedef|typedef
struct|struct
block|{
DECL|member|bsp
...
argument_list|()
expr_stmt|;
comment|/*  if (active)     select_brush (bsp, active); */
comment|/*    brush_select_select (bsp, gimp_brush_list_get_brush_index (brush_list,  							       active)); */
name|select_brush
argument_list|(
name|gimp_brush_list_get_brush_by_index
argument_list|(
