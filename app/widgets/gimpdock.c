...
specifier|static
name|void
name|gimp_dock_display_changed
parameter_list|(
name|GimpContext
modifier|*
name|context
...
specifier|static
name|void
DECL|function|gimp_dock_display_changed (GimpContext * context,GimpObject * display,GimpDock * dock)
name|gimp_dock_display_changed
parameter_list|(
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dock_image_flush (GimpImage * image,GimpDock * dock)
name|gimp_dock_image_flush
parameter_list|(
name|GimpImage
modifier|*
