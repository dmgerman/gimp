...
specifier|static
name|void
DECL|function|gimp_dock_dispose (GObject * object)
name|gimp_dock_dispose
parameter_list|(
name|GObject
modifier|*
...
begin_comment
comment|/**  * gimp_dock_temp_add:  * @dock:  * @widget:  *  * Method to temporarily add a widget to the dock, for example to make  * font-scale style property to be applied temporarily to the  * child.  **/
end_comment

begin_function
name|void
DECL|function|gimp_dock_temp_add (GimpDock * dock,GtkWidget * child)
...
begin_function
name|void
DECL|function|gimp_dock_temp_remove (GimpDock * dock,GtkWidget * child)
