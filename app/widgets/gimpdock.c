...
begin_function
name|gboolean
DECL|function|gimp_dock_construct (GimpDock * dock,GimpDialogFactory * dialog_factory,GimpContext * context,gboolean destroy_if_empty)
...
name|g_print
argument_list|(
literal|"adding second dockbook\n"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|g_print
argument_list|(
literal|"adding another dockbook..."
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|g_print
argument_list|(
literal|"EEEEEEEEEEEEEEEEK: with index %d (lost it)\n"
argument_list|,
name|index
argument_list|)
expr_stmt|;
