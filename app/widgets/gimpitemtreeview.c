...
specifier|static
name|void
name|gimp_item_tree_view_real_rename_item
parameter_list|(
name|GimpItemTreeView
modifier|*
name|view
...
specifier|static
name|void
DECL|function|gimp_item_tree_view_real_rename_item (GimpItemTreeView * view,GimpItem * item,const gchar * new_name)
name|gimp_item_tree_view_real_rename_item
parameter_list|(
name|GimpItemTreeView
modifier|*
