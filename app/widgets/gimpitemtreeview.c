...
name|GtkWidget
modifier|*
DECL|function|gimp_item_tree_view_new (GType view_type,gint preview_size,gint preview_border_width,GimpImage * gimage,GimpMenuFactory * menu_factory,const gchar * menu_identifier,const gchar * ui_path)
