...
name|GtkWidget
modifier|*
DECL|function|gimp_item_tree_view_new (gint preview_size,gint preview_border_width,GimpImage * gimage,GType item_type,const gchar * signal_name,GimpMenuFactory * menu_factory,const gchar * menu_identifier,const gchar * ui_path)
