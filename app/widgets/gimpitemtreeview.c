...
include|#
directive|include
file|"core/gimpitem-exclusive.h"
end_include
...
decl_stmt|;
DECL|member|model_column_viewable
name|gint
name|model_column_viewable
decl_stmt|;
DECL|member|model_column_linked
name|gint
name|model_column_linked
decl_stmt|;
DECL|member|model_column_color_tag
name|gint
name|model_column_color_tag
decl_stmt|;
...
decl_stmt|;
DECL|member|color_tag_changed_handler
name|GimpTreeHandler
modifier|*
name|color_tag_changed_handler
decl_stmt|;
...
decl_stmt|;
DECL|member|lock_position_changed_handler
name|GimpTreeHandler
modifier|*
name|lock_position_changed_handler
decl_stmt|;
...
specifier|static
name|void
name|gimp_item_tree_view_constructed
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
name|gimp_item_tree_view_dispose
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
name|gimp_item_tree_view_color_tag_changed
parameter_list|(
name|GimpItem
modifier|*
name|item
...
specifier|static
name|void
name|gimp_item_tree_view_lock_position_changed
parameter_list|(
name|GimpItem
modifier|*
name|item
...
specifier|static
name|void
name|gimp_item_tree_view_lock_position_toggled
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gboolean
name|gimp_item_tree_view_item_pre_clicked
parameter_list|(
...
specifier|static
name|void
DECL|function|gimp_item_tree_view_constructed (GObject * object)
name|gimp_item_tree_view_constructed
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_item_tree_view_dispose (GObject * object)
name|gimp_item_tree_view_dispose
parameter_list|(
name|GObject
modifier|*
...
begin_comment
comment|/*  "Color Tag" callbacks  */
end_comment

begin_function
specifier|static
name|void
DECL|function|gimp_item_tree_view_color_tag_changed (GimpItem * item,GimpItemTreeView * view)
name|gimp_item_tree_view_color_tag_changed
parameter_list|(
name|GimpItem
modifier|*
...
specifier|static
name|void
DECL|function|gimp_item_tree_view_lock_position_changed (GimpItem * item,GimpItemTreeView * view)
name|gimp_item_tree_view_lock_position_changed
parameter_list|(
name|GimpItem
modifier|*
...
specifier|static
name|void
DECL|function|gimp_item_tree_view_lock_position_toggled (GtkWidget * widget,GimpItemTreeView * view)
name|gimp_item_tree_view_lock_position_toggled
parameter_list|(
name|GtkWidget
modifier|*
...
name|TRUE
decl_stmt|;
comment|/*  compress lock position undos  */
name|undo
operator|=
...
specifier|static
name|gboolean
DECL|function|gimp_item_tree_view_item_pre_clicked (GimpCellRendererViewable * cell,const gchar * path_str,GdkModifierType state,GimpItemTreeView * item_view)
name|gimp_item_tree_view_item_pre_clicked
parameter_list|(
name|GimpCellRendererViewable
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Don't select the clicked layer */
name|handled
operator|=
name|TRUE
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/*  select the active item only if it was made visible by expanding        *  its immediate parent. See bug #666561.        */
if|if
condition|(
name|active_item
operator|&&
