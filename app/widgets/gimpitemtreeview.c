...
specifier|static
name|void
DECL|function|gimp_item_tree_view_toggle_clicked (GtkCellRendererToggle * toggle,gchar * path_str,GdkModifierType state,GimpItemTreeView * view,GimpUndoType type)
name|gimp_item_tree_view_toggle_clicked
parameter_list|(
name|GtkCellRendererToggle
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  compress visibility/linked undos  */
if|if
condition|(
operator|!
name|gimp_undo_stack_peek
