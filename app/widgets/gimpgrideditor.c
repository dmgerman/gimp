...
specifier|static
name|void
name|gimp_grid_editor_grid_changed
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_decl_stmt
DECL|variable|grid_editor_signals
specifier|static
name|guint
name|grid_editor_signals
index|[
name|LAST_SIGNAL
index|]
init|=
...
specifier|static
name|void
DECL|function|gimp_grid_editor_grid_changed (GtkWidget * widget,gpointer data)
name|gimp_grid_editor_grid_changed
parameter_list|(
name|GtkWidget
modifier|*
