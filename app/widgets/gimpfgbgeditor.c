...
begin_define
DECL|macro|CHANNEL_EPSILON
define|#
directive|define
name|CHANNEL_EPSILON
value|1e-3
end_define

begin_enum
enum|enum
DECL|enum|__anon27e03ec90103
block|{
...
name|color_config
operator|&&
comment|/* Common out-of-gamut case */
operator|(
operator|(
name|color
operator|.
