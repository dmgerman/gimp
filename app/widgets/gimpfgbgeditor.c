...
specifier|static
name|void
name|gimp_fg_bg_editor_config_notify
parameter_list|(
...
specifier|static
name|void
DECL|function|gimp_fg_bg_editor_config_notify (GimpColorConfig * config,const GParamSpec * pspec,GimpFgBgEditor * editor)
name|gimp_fg_bg_editor_config_notify
parameter_list|(
name|GimpColorConfig
modifier|*
