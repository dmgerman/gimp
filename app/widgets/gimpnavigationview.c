...
include|#
directive|include
file|"display/gimpcanvas-style.h"
end_include
...
name|canvas_y
decl_stmt|;
DECL|member|canvas_width
name|gdouble
name|canvas_width
decl_stmt|;
DECL|member|canvas_height
name|gdouble
name|canvas_height
decl_stmt|;
...
name|p_height
decl_stmt|;
DECL|member|p_canvas_x
name|gint
name|p_canvas_x
decl_stmt|;
DECL|member|p_canvas_y
name|gint
name|p_canvas_y
decl_stmt|;
DECL|member|p_canvas_width
name|gint
name|p_canvas_width
decl_stmt|;
DECL|member|p_canvas_height
name|gint
name|p_canvas_height
decl_stmt|;
...
begin_function
name|void
DECL|function|gimp_navigation_view_set_canvas (GimpNavigationView * nav_view,gboolean visible,gdouble x,gdouble y,gdouble width,gdouble height)
