...
begin_function
name|void
DECL|function|gimp_navigation_view_set_marker (GimpNavigationView * nav_view,gdouble center_x,gdouble center_y,gdouble width,gdouble height)
