...
begin_function
name|void
DECL|function|gimp_selection_data_set_color (GtkSelectionData * selection,GdkAtom atom,const GimpRGB * color)
...
name|GdkPixbuf
modifier|*
DECL|function|gimp_selection_data_get_pixbuf (GtkSelectionData * selection)
...
name|g_warning
argument_list|(
literal|"Received invalid image data!"
argument_list|)
expr_stmt|;
return|return
name|NULL
...
begin_function
name|void
DECL|function|gimp_selection_data_set_image (GtkSelectionData * selection,GdkAtom atom,GimpImage * gimage)
...
begin_function
name|void
DECL|function|gimp_selection_data_set_component (GtkSelectionData * selection,GdkAtom atom,GimpImage * gimage,GimpChannelType channel)
...
begin_function
name|void
DECL|function|gimp_selection_data_set_item (GtkSelectionData * selection,GdkAtom atom,GimpItem * item)
...
begin_function
name|void
DECL|function|gimp_selection_data_set_viewable (GtkSelectionData * selection,GdkAtom atom,GimpViewable * viewable)
...
name|gchar
modifier|*
DECL|function|gimp_selection_data_get_name (GtkSelectionData * selection)
...
name|GimpToolInfo
modifier|*
DECL|function|gimp_selection_data_get_tool (GtkSelectionData * selection,Gimp * gimp)
