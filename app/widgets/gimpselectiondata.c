...
begin_function
name|void
DECL|function|gimp_selection_data_set_xcf (GtkSelectionData * selection,GimpImage * image)
...
name|output
operator|=
name|G_MEMORY_OUTPUT_STREAM
argument_list|(
name|g_memory_output_stream_new_resizable
argument_list|()
argument_list|)
expr_stmt|;
...
literal|8
argument_list|,
name|g_memory_output_stream_get_data
argument_list|(
name|output
argument_list|)
argument_list|,
name|g_memory_output_stream_get_data_size
argument_list|(
name|output
argument_list|)
argument_list|)
...
name|GimpImage
modifier|*
DECL|function|gimp_selection_data_get_xcf (GtkSelectionData * selection,Gimp * gimp)
