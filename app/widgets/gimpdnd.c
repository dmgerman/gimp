...
specifier|static
name|void
DECL|function|gimp_dnd_get_svg_data (GtkWidget * widget,GCallback get_svg_func,gpointer get_svg_data,GtkSelectionData * selection,GdkAtom atom)
name|gimp_dnd_get_svg_data
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_dnd_set_svg_data (GtkWidget * widget,GCallback set_svg_func,gpointer set_svg_data,GtkSelectionData * selection)
name|gimp_dnd_set_svg_data
parameter_list|(
name|GtkWidget
modifier|*
