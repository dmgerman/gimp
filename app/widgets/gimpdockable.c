...
specifier|static
name|GimpTabStyle
name|gimp_dockable_convert_tab_style
parameter_list|(
name|GimpDockable
modifier|*
name|dockable
...
name|g_warning
argument_list|(
literal|"Tab style error, unexpected code path taken, fix!"
argument_list|)
expr_stmt|;
break|break;
block|}
...
begin_comment
comment|/**  * gimp_dockable_get_actual_tab_style:  * @dockable:  *  * Get actual tab style, i.e. never "automatic". This state should  * actually be hold on a per-dockbook basis, but at this point that  * feels like over-engineering...  **/
end_comment

begin_function
name|GimpTabStyle
DECL|function|gimp_dockable_get_actual_tab_style (GimpDockable * dockable)
...
begin_comment
comment|/**  * gimp_dockable_set_actual_tab_style:  * @dockable:  * @tab_style:  *  * Sets actual tab style, meant for those that decides what  * "automatic" tab style means.  *  * Returns: %TRUE if changed, %FALSE otherwise.  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_dockable_set_actual_tab_style (GimpDockable * dockable,GimpTabStyle tab_style)
name|gimp_dockable_set_actual_tab_style
parameter_list|(
name|GimpDockable
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|gimp_dockable_create_drag_widget (GimpDockable * dockable)
...
specifier|static
name|GimpTabStyle
DECL|function|gimp_dockable_convert_tab_style (GimpDockable * dockable,GimpTabStyle tab_style)
name|gimp_dockable_convert_tab_style
parameter_list|(
name|GimpDockable
modifier|*
