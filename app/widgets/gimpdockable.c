...
name|GtkWidget
modifier|*
DECL|function|gimp_dockable_new (const gchar * name,const gchar * blurb,const gchar * stock_id,GimpDockableGetIconFunc get_icon_func,gpointer get_icon_data,GimpDockableSetContextFunc set_context_func)
