...
argument_list|)
expr_stmt|;
comment|/*  release gimp_dockable_show_menu()'s reference  */
name|g_object_unref
argument_list|(
name|dockable
argument_list|)
...
argument_list|)
expr_stmt|;
comment|/*  an item factory callback may destroy the dockable, so reference    *  if for gimp_dockable_menu_end()    */
name|g_object_ref
argument_list|(
name|dockable
argument_list|)
