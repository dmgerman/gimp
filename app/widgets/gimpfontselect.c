...
begin_function
name|GType
DECL|function|gimp_font_select_get_type (void)
...
specifier|static
name|void
DECL|function|gimp_font_select_class_init (GimpFontSelectClass * klass)
name|gimp_font_select_class_init
parameter_list|(
name|GimpFontSelectClass
modifier|*
...
name|Argument
modifier|*
DECL|function|gimp_font_select_run_callback (GimpPdbDialog * dialog,GimpObject * object,gboolean closing,gint * n_return_vals)
name|gimp_font_select_run_callback
parameter_list|(
name|GimpPdbDialog
modifier|*
