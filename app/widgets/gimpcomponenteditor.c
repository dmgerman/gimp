...
specifier|static
name|void
name|gimp_component_editor_docked_iface_init
parameter_list|(
...
specifier|static
name|void
name|gimp_component_editor_set_context
parameter_list|(
name|GimpDocked
modifier|*
name|docked
...
argument_list|,
argument|G_IMPLEMENT_INTERFACE (GIMP_TYPE_DOCKED,                                                 gimp_component_editor_docked_iface_init)
argument_list|)
end_macro
...
specifier|static
name|void
DECL|function|gimp_component_editor_docked_iface_init (GimpDockedInterface * iface)
name|gimp_component_editor_docked_iface_init
parameter_list|(
name|GimpDockedInterface
modifier|*
...
specifier|static
name|void
DECL|function|gimp_component_editor_set_context (GimpDocked * docked,GimpContext * context)
name|gimp_component_editor_set_context
parameter_list|(
name|GimpDocked
modifier|*
