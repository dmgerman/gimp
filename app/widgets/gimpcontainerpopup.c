...
name|GtkWidget
modifier|*
DECL|function|gimp_container_popup_new (GimpContainer * container,GimpContext * context,GimpViewType view_type,gint default_preview_size,gint preview_size,gint preview_border_width,GimpDialogFactory * dialog_factory,const gchar * dialog_identifier,const gchar * dialog_stock_id,const gchar * dialog_tooltip)
...
begin_function
name|gint
DECL|function|gimp_container_popup_get_preview_size (GimpContainerPopup * popup)
...
begin_function
name|void
DECL|function|gimp_container_popup_set_preview_size (GimpContainerPopup * popup,gint preview_size)
