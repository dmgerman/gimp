...
argument_list|)
expr_stmt|;
comment|/*  we override GimpContext's "gimp" property, so we need to          *  register the context just like GimpContext would do it.          */
name|context
operator|->
name|gimp
operator|=
