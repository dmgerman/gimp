...
specifier|static
name|void
DECL|function|device_status_drag_color (GtkWidget * widget,GimpRGB * color,gpointer data)
name|device_status_drag_color
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|device_status_drop_color (GtkWidget * widget,GimpRGB * color,gpointer data)
name|device_status_drop_color
parameter_list|(
name|GtkWidget
modifier|*
