...
specifier|static
name|void
name|gimp_tag_entry_item_set_tags
parameter_list|(
name|GimpTagged
modifier|*
name|entry
...
specifier|static
name|void
DECL|function|gimp_tag_entry_item_set_tags (GimpTagged * tagged,GList * tags)
name|gimp_tag_entry_item_set_tags
parameter_list|(
name|GimpTagged
modifier|*
