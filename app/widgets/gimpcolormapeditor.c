...
specifier|static
name|void
name|gimp_colormap_editor_color_update
parameter_list|(
...
specifier|static
name|void
DECL|function|gimp_colormap_editor_color_update (GimpColorDialog * dialog,const GimpRGB * color,GimpColorDialogState state,GimpColormapEditor * editor)
name|gimp_colormap_editor_color_update
parameter_list|(
name|GimpColorDialog
modifier|*
