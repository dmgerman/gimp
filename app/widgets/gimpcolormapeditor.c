...
specifier|static
name|void
DECL|function|gimp_colormap_color_dialog_callback (ColorDialog * color_dialog,const GimpRGB * color,ColorDialogState state,gpointer data)
name|gimp_colormap_color_dialog_callback
parameter_list|(
name|ColorDialog
modifier|*
name|color_dialog
