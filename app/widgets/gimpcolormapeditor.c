...
specifier|static
name|void
DECL|function|gimp_colormap_color_dialog_update (GimpColorDialog * color_dialog,const GimpRGB * color,GimpColorDialogState state,GimpColormapEditor * editor)
name|gimp_colormap_color_dialog_update
parameter_list|(
