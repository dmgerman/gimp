...
begin_decl_stmt
DECL|variable|gimp_gtk_scale_button_parent_class
specifier|static
name|gpointer
name|gimp_gtk_scale_button_parent_class
init|=
name|NULL
decl_stmt|;
end_decl_stmt
...
begin_function
name|GType
DECL|function|gimp_gtk_scale_button_get_type (void)
...
specifier|static
name|guint
DECL|function|gimp_gtk_binding_signal_new (const gchar * signal_name,GType itype,GSignalFlags signal_flags,GCallback handler,GSignalAccumulator accumulator,gpointer accu_data,GSignalCMarshaller c_marshaller,GType return_type,guint n_params,...)
