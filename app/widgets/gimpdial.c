...
name|NULL
argument_list|,
name|GIMP_TYPE_DIAL_BACKGROUND
argument_list|,
name|GIMP_DIAL_BACKGROUND_HSV
argument_list|,
name|GIMP_PARAM_READWRITE
...
specifier|static
name|void
DECL|function|gimp_dial_background_hsv (gdouble angle,gdouble distance,guchar * rgb)
name|gimp_dial_background_hsv
parameter_list|(
name|gdouble
name|angle
...
specifier|static
name|void
DECL|function|gimp_dial_draw_background (cairo_t * cr,gint size,GimpDialBackground background)
name|gimp_dial_draw_background
parameter_list|(
name|cairo_t
modifier|*
