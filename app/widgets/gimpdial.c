...
name|PROP_BETA
block|,
DECL|enumerator|PROP_CLOCKWISE_ANGLES
name|PROP_CLOCKWISE_ANGLES
block|,
DECL|enumerator|PROP_CLOCKWISE_DELTA
name|PROP_CLOCKWISE_DELTA
block|}
enum|;
end_enum
...
name|beta
decl_stmt|;
DECL|member|clockwise_angles
name|gboolean
name|clockwise_angles
decl_stmt|;
DECL|member|clockwise_delta
name|gboolean
name|clockwise_delta
decl_stmt|;
...
specifier|static
name|gdouble
name|gimp_dial_normalize_angle
parameter_list|(
name|gdouble
name|angle
parameter_list|)
...
specifier|static
name|gdouble
name|gimp_dial_get_angle_distance
parameter_list|(
name|gdouble
name|alpha
parameter_list|,
...
specifier|static
name|gboolean
DECL|function|gimp_dial_draw (GtkWidget * widget,cairo_t * cr)
name|gimp_dial_draw
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dial_reset_target (GimpCircle * circle)
name|gimp_dial_reset_target
parameter_list|(
name|GimpCircle
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dial_set_target (GimpDial * dial,DialTarget target)
name|gimp_dial_set_target
parameter_list|(
name|GimpDial
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dial_draw_segment (cairo_t * cr,gdouble radius,gdouble alpha,gdouble beta,gboolean clockwise_delta)
...
specifier|static
name|void
DECL|function|gimp_dial_draw_arrows (cairo_t * cr,gint size,gdouble alpha,gdouble beta,gboolean clockwise_delta,DialTarget highlight,gboolean draw_beta)
name|gimp_dial_draw_arrows
parameter_list|(
name|cairo_t
modifier|*
...
specifier|static
name|gdouble
DECL|function|gimp_dial_normalize_angle (gdouble angle)
name|gimp_dial_normalize_angle
parameter_list|(
name|gdouble
name|angle
...
specifier|static
name|gdouble
DECL|function|gimp_dial_get_angle_distance (gdouble alpha,gdouble beta)
name|gimp_dial_get_angle_distance
parameter_list|(
name|gdouble
name|alpha
