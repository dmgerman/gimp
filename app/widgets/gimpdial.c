...
specifier|static
name|void
name|gimp_dial_background_func_hsv
parameter_list|(
name|gdouble
name|angle
parameter_list|,
...
specifier|static
name|void
name|gimp_dial_draw_background
parameter_list|(
name|cairo_t
modifier|*
name|cr
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpDial,gimp_dial,GTK_TYPE_WIDGET)
name|G_DEFINE_TYPE
argument_list|(
argument|GimpDial
argument_list|,
...
specifier|static
name|void
DECL|function|gimp_dial_realize (GtkWidget * widget)
name|gimp_dial_realize
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dial_unrealize (GtkWidget * widget)
name|gimp_dial_unrealize
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dial_map (GtkWidget * widget)
name|gimp_dial_map
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dial_size_request (GtkWidget * widget,GtkRequisition * requisition)
name|gimp_dial_size_request
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dial_size_allocate (GtkWidget * widget,GtkAllocation * allocation)
name|gimp_dial_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gdouble
DECL|function|arctg (gdouble y,gdouble x)
name|arctg
parameter_list|(
name|gdouble
name|y
...
specifier|static
name|gdouble
DECL|function|min_prox (gdouble alpha,gdouble beta,gdouble angle)
name|min_prox
parameter_list|(
name|gdouble
name|alpha
...
specifier|static
name|DialTarget
DECL|function|closest (gdouble alpha,gdouble beta,gdouble angle)
name|closest
parameter_list|(
name|gdouble
name|alpha
...
literal|0
expr_stmt|;
comment|//g_signal_emit (widget, dial_signals[CONTEXT], 0);
block|}
elseif|else
if|if
condition|(
...
specifier|static
name|void
DECL|function|gimp_dial_background_func_hsv (gdouble angle,gdouble distance,guchar * rgb)
name|gimp_dial_background_func_hsv
parameter_list|(
name|gdouble
name|angle
...
specifier|static
name|void
DECL|function|gimp_dial_draw_background (cairo_t * cr,gint size,GimpDialBGFunc bg_func)
name|gimp_dial_draw_background
parameter_list|(
name|cairo_t
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dial_draw_arrows (cairo_t * cr,gint size,gdouble alpha,gdouble beta,gboolean clockwise)
name|gimp_dial_draw_arrows
parameter_list|(
name|cairo_t
modifier|*
