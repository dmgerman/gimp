...
specifier|static
name|void
DECL|function|gimp_dial_class_init (GimpDialClass * klass)
...
specifier|static
name|void
DECL|function|gimp_dial_draw_background (cairo_t * cr,gint size)
name|gimp_dial_draw_background
parameter_list|(
name|cairo_t
modifier|*
...
specifier|static
name|void
DECL|function|gimp_dial_draw_arrows (cairo_t * cr,gint size,gdouble alpha,gdouble beta,DialDirection direction)
name|gimp_dial_draw_arrows
parameter_list|(
name|cairo_t
modifier|*
