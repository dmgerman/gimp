...
begin_comment
comment|/*  stupid GimpHeader class just so we get a "header" CSS node  */
end_comment

begin_define
DECL|macro|GIMP_TYPE_HEADER
define|#
directive|define
name|GIMP_TYPE_HEADER
value|(gimp_header_get_type ())
end_define

begin_typedef
DECL|typedef|GimpHeader
typedef|typedef
name|struct
name|_GtkBox
name|GimpHeader
...
begin_typedef
DECL|typedef|GimpHeaderClass
typedef|typedef
name|struct
name|_GtkBoxClass
name|GimpHeaderClass
typedef|;
end_typedef
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpHeader,gimp_header,GTK_TYPE_BOX)
name|G_DEFINE_TYPE
argument_list|(
argument|GimpHeader
argument_list|,
argument|gimp_header
argument_list|,
...
specifier|static
name|void
DECL|function|gimp_header_init (GimpHeader * header)
name|gimp_header_init
parameter_list|(
name|GimpHeader
modifier|*
name|header
...
specifier|static
name|void
DECL|function|this_is_ugly (GtkWidget * widget,GtkAllocation * allocation,gpointer data)
name|this_is_ugly
parameter_list|(
name|GtkWidget
modifier|*
