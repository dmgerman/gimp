...
specifier|static
name|void
DECL|function|gimp_thumb_box_progress_iface_init (GimpProgressInterface * progress_iface)
name|gimp_thumb_box_progress_iface_init
parameter_list|(
name|GimpProgressInterface
modifier|*
...
decl_stmt|;
name|GtkRequisition
name|thumb_progress_requisition
decl_stmt|;
name|GtkRequisition
...
argument_list|)
expr_stmt|;
comment|/* don't gtk_widget_show (box->thumb_progress); */
comment|/* eek */
...
specifier|static
name|void
DECL|function|gimp_thumb_box_create_thumbnail (GimpThumbBox * box,const gchar * uri,GimpThumbnailSize size,gboolean force)
name|gimp_thumb_box_create_thumbnail
parameter_list|(
name|GimpThumbBox
modifier|*
...
condition|)
block|{
comment|/*  This is tricky because gimp_imagefile_create_thumbnail()            *  may call a plug-in and the progress callback runs the            *  mainloop. Thus the dialog may change below our feet. For            *  that reason we use a separate GimpImagefile to create the            *  thumbnail.            */
name|GimpImagefile
modifier|*
name|imagefile
init|=
