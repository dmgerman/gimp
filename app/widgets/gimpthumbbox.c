...
condition|)
block|{
comment|/*  This is tricky because gimp_imagefile_create_thumbnail()            *  may call a plug-in and the progress callback runs the            *  mainloop. Thus the dialog may change below our feet. For            *  that reason we use a seperate GimpImagefile to create the            *  thumbnail.            */
name|GimpImagefile
modifier|*
name|local
init|=
