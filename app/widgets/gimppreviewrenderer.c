...
name|GimpPreview
modifier|*
DECL|function|gimp_preview_new_by_type (GimpViewable * viewable)
...
begin_function
name|void
DECL|function|gimp_preview_calc_size (GimpPreview * preview,gint aspect_width,gint aspect_height,gint width,gint height,gdouble xresolution,gdouble yresolution,gint * return_width,gint * return_height,gboolean * scaling_up)
