...
specifier|static
name|void
DECL|function|gimp_container_tree_view_view_iface_init (GimpContainerViewInterface * view_iface)
name|gimp_container_tree_view_view_iface_init
parameter_list|(
name|GimpContainerViewInterface
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  Actually gtk_tree_view_get_path_at_pos() should take care of the    *  render direction, but unfortunately it doesn't seem to do that.    */
if|if
condition|(
name|gtk_widget_get_direction
argument_list|(
