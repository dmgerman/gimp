...
specifier|static
name|void
DECL|function|gimp_container_tree_view_set_viewable_func (GtkTreeViewColumn * tree_column,GtkCellRenderer * cell,GtkTreeModel * tree_model,GtkTreeIter * iter,gpointer data)
name|gimp_container_tree_view_set_viewable_func
parameter_list|(
