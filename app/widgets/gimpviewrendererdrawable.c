...
specifier|static
name|void
name|gimp_drawable_preview_calc_size
parameter_list|(
name|gint
name|drawable_width
parameter_list|,
...
specifier|static
name|void
DECL|function|gimp_drawable_preview_calc_size (gint drawable_width,gint drawable_height,gint width,gint height,gint * return_width,gint * return_height,gboolean * scaling_up)
name|gimp_drawable_preview_calc_size
parameter_list|(
name|gint
name|drawable_width
