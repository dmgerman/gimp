...
typedef|typedef
struct|struct
DECL|struct|__anon2c42673d0208
block|{
DECL|member|state
name|IsoCodesParserState
name|state
...
specifier|static
name|void
name|iso_codes_parser_characters
parameter_list|(
name|GMarkupParseContext
modifier|*
name|context
...
begin_function
name|gboolean
DECL|function|gimp_language_store_populate (GimpLanguageStore * store,GError ** error)
...
specifier|static
name|void
DECL|function|iso_codes_parser_characters (GMarkupParseContext * context,const gchar * text,gsize text_len,gpointer user_data,GError ** error)
name|iso_codes_parser_characters
parameter_list|(
name|GMarkupParseContext
modifier|*
