...
specifier|static
name|gboolean
name|gimp_dockbook_tab_drag_expose
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gboolean
DECL|function|gimp_dockbook_tab_drag_expose (GtkWidget * widget,GdkEventExpose * event)
name|gimp_dockbook_tab_drag_expose
parameter_list|(
name|GtkWidget
modifier|*
...
parameter_list|)
block|{
comment|/*  mimic the appearance of a notebook tab  */
