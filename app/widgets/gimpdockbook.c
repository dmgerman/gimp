...
specifier|static
name|void
name|gimp_dockbook_style_updated
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_dockbook_style_updated (GtkWidget * widget)
name|gimp_dockbook_style_updated
parameter_list|(
name|GtkWidget
modifier|*
...
directive|if
literal|0
block|g_object_get (widget,                 "tab-hborder",&tab_hborder,                 NULL);
endif|#
directive|endif
