...
specifier|static
name|gint
name|gimp_dockbook_get_tab_border
parameter_list|(
name|GimpDockbook
modifier|*
name|dockbook
...
specifier|static
name|void
DECL|function|gimp_dockbook_menu_position (GtkMenu * menu,gint * x,gint * y,gpointer data)
name|gimp_dockbook_menu_position
parameter_list|(
name|GtkMenu
modifier|*
name|menu
...
name|GtkWidget
modifier|*
DECL|function|gimp_dockbook_add_from_dialog_factory (GimpDockbook * dockbook,const gchar * identifiers,gint position)
...
specifier|static
name|gint
DECL|function|gimp_dockbook_get_tab_border (GimpDockbook * dockbook)
name|gimp_dockbook_get_tab_border
parameter_list|(
name|GimpDockbook
modifier|*
...
break|break;
default|default:
comment|/* GIMP_ICON_SIZE_MEDIUM and GIMP_ICON_SIZE_DEFAULT:        * let's use the size set by the theme. */
break|break;
block|}
return|return
name|tab_border
