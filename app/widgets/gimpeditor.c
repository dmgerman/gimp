...
begin_function
name|void
DECL|function|gimp_editor_create_menu (GimpEditor * editor,GimpMenuFactory * menu_factory,const gchar * menu_identifier,const gchar * ui_path,gpointer callback_data)
...
directive|if
literal|0
block|if (extended_callback)     g_signal_connect (button, "extended_clicked", 		      extended_callback, 		      callback_data);
endif|#
directive|endif
name|old_child
operator|=
