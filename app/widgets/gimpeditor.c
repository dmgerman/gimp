...
typedef|typedef
struct|struct
DECL|struct|__anon27590a610208
block|{
...
specifier|static
name|void
DECL|function|gimp_editor_get_styling (GimpEditor * editor,gint * content_spacing,GtkIconSize * button_icon_size,gint * button_spacing,GtkReliefStyle * button_relief)
name|gimp_editor_get_styling
parameter_list|(
name|GimpEditor
modifier|*
