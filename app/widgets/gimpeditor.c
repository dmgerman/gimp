...
specifier|static
name|void
DECL|function|gimp_editor_menu_position (GtkMenu * menu,gint * x,gint * y,gpointer data)
name|gimp_editor_menu_position
parameter_list|(
name|GtkMenu
modifier|*
name|menu
...
specifier|static
name|gboolean
DECL|function|gimp_editor_popup_menu (GtkWidget * widget)
name|gimp_editor_popup_menu
parameter_list|(
name|GtkWidget
modifier|*
