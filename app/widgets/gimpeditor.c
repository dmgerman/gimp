...
begin_struct
DECL|struct|_GimpEditorPrivate
struct|struct
...
specifier|static
name|void
DECL|function|gimp_editor_constructed (GObject * object)
name|gimp_editor_constructed
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_editor_dispose (GObject * object)
name|gimp_editor_dispose
parameter_list|(
name|GObject
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2acd5b390208
block|{
...
name|GimpUIManager
modifier|*
DECL|function|gimp_editor_get_ui_manager (GimpEditor * editor)
...
name|GtkBox
modifier|*
DECL|function|gimp_editor_get_button_box (GimpEditor * editor)
...
name|GimpMenuFactory
modifier|*
DECL|function|gimp_editor_get_menu_factory (GimpEditor * editor)
...
name|gpointer
modifier|*
DECL|function|gimp_editor_get_popup_data (GimpEditor * editor)
...
name|gchar
modifier|*
DECL|function|gimp_editor_get_ui_path (GimpEditor * editor)
...
specifier|static
name|void
DECL|function|gimp_editor_get_styling (GimpEditor * editor,GimpGuiConfig * config,gint * content_spacing,GtkIconSize * button_icon_size,gint * button_spacing,GtkReliefStyle * button_relief)
name|gimp_editor_get_styling
parameter_list|(
name|GimpEditor
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Check if we should override theme styling. */
if|if
condition|(
name|config
condition|)
...
break|break;
default|default:
comment|/* GIMP_ICON_SIZE_DEFAULT:            * let's use the sizes set by the theme. */
break|break;
block|}
block|}
block|}
