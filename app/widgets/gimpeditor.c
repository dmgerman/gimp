...
name|PROP_NAME
block|,
DECL|enumerator|PROP_SHOW_BUTTON_BAR
name|PROP_SHOW_BUTTON_BAR
block|}
enum|;
end_enum
...
specifier|static
name|void
DECL|function|gimp_editor_set_aux_info (GimpDocked * docked,GList * aux_info)
name|gimp_editor_set_aux_info
parameter_list|(
name|GimpDocked
modifier|*
...
name|GList
modifier|*
DECL|function|gimp_editor_get_aux_info (GimpDocked * docked)
name|gimp_editor_get_aux_info
parameter_list|(
name|GimpDocked
modifier|*
...
typedef|typedef
name|struct
name|_ExtendedAction
name|ExtendedAction
typedef|;
end_typedef

begin_struct
DECL|struct|_ExtendedAction
struct|struct
name|_ExtendedAction
block|{
...
specifier|static
name|void
DECL|function|gimp_editor_button_extended_actions_free (GList * list)
...
begin_function
name|gboolean
DECL|function|gimp_editor_has_button_bar (GimpEditor * editor)
...
begin_function
name|void
DECL|function|gimp_editor_set_show_button_bar (GimpEditor * editor,gboolean show)
name|gimp_editor_set_show_button_bar
parameter_list|(
name|GimpEditor
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_editor_get_show_button_bar (GimpEditor * editor)
