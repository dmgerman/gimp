...
name|GimpItemFactory
modifier|*
DECL|function|gimp_editor_get_menu (GimpDocked * docked,gpointer * popup_data,GimpUIManager ** ui_manager,const gchar ** ui_identifier)
name|gimp_editor_get_menu
parameter_list|(
name|GimpDocked
modifier|*
...
begin_function
name|void
DECL|function|gimp_editor_create_menu (GimpEditor * editor,GimpMenuFactory * menu_factory,const gchar * menu_identifier,const gchar * ui_identifier,gpointer callback_data)
