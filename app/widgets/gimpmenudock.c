...
begin_define
DECL|macro|GIMP_IMAGE_DOCK_MINIMAL_WIDTH
define|#
directive|define
name|GIMP_IMAGE_DOCK_MINIMAL_WIDTH
value|250
end_define
...
name|GtkWidget
modifier|*
DECL|function|gimp_image_dock_new (GimpDialogFactory * dialog_factory,GimpContainer * image_container)
