...
specifier|static
name|void
DECL|function|gimp_image_dock_display_changed (GimpContext * context,GimpObject * display,GimpDock * dock)
name|gimp_image_dock_display_changed
parameter_list|(
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|gimp_image_dock_image_flush (GimpImage * gimage,GimpDock * dock)
name|gimp_image_dock_image_flush
parameter_list|(
name|GimpImage
modifier|*
