...
specifier|static
name|void
name|update_segments_from_options_cb
parameter_list|(
...
begin_function
name|GType
DECL|function|gimp_dash_editor_get_type (void)
...
specifier|static
name|void
DECL|function|update_segments_from_options_cb (GimpStrokeOptions * options,gpointer stuff,GimpDashEditor * editor)
name|update_segments_from_options_cb
parameter_list|(
name|GimpStrokeOptions
modifier|*
