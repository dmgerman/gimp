...
begin_comment
comment|/**  * gimp_prop_opacity_spin_scale_new:  * @config:        #GimpConfig object to which property is attached.  * @property_name: Name of gdouble property  *  * Creates a #GimpSpinScale to set and display the value of a  * gdouble property in a very space-efficient way.  *  * Return value:  A new #GimpSpinScale widget.  *  * Since GIMP 2.8  */
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_prop_opacity_spin_scale_new (GObject * config,const gchar * property_name,const gchar * label)
...
typedef|typedef
struct|struct
DECL|struct|__anon27a87a790108
block|{
DECL|member|config
name|GObject
modifier|*
