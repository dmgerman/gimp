...
typedef|typedef
struct|struct
DECL|struct|__anon2c5bab660108
block|{
DECL|member|config
name|GObject
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|gimp_prop_icon_picker_new (GObject * config,const gchar * property_name,Gimp * gimp)
...
specifier|static
name|void
DECL|function|gimp_prop_icon_picker_callback (GtkWidget * picker,GParamSpec * unuded_param_spec,GObject * config)
name|gimp_prop_icon_picker_callback
parameter_list|(
name|GtkWidget
modifier|*
