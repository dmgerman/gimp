...
typedef|typedef
struct|struct
DECL|struct|__anon2747da800108
block|{
DECL|member|config
name|GObject
modifier|*
...
specifier|static
name|void
name|gimp_prop_aspect_notify_aspect
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_comment
comment|/**  * gimp_prop_aspect_ratio_new:  * @config:                Object to which property is attached.  * @numerator_property:    Name of double property for numerator.  * @denominator_property:  Name of double property for denominator.  * @fixed_aspect_property: Name of boolean property for fixed aspect.  * @width_property:        Name of double property for width.  * @height_property:       Name of double property for height.  *  * The @fixed_aspect_property, @width_property, and @height_property can  * be set to #NULL, in which case the controls will not do anything  * affecting or depending on these properties.  */
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_prop_aspect_ratio_new (GObject * config,const gchar * numerator_property,const gchar * denominator_property,const gchar * fixed_aspect_property,const gchar * width_property,const gchar * height_property)
...
specifier|static
name|void
DECL|function|gimp_prop_aspect_notify_aspect (GtkWidget * widget,GParamSpec * param_spec,AspectData * data)
name|gimp_prop_aspect_notify_aspect
parameter_list|(
name|GtkWidget
modifier|*
