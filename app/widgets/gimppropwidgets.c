...
specifier|static
name|void
name|gimp_prop_numeric_entry_notify
parameter_list|(
name|GObject
modifier|*
name|config
...
specifier|static
name|void
name|gimp_prop_numeric_entry_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gboolean
name|gimp_prop_numeric_entry_focus_out
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_prop_numeric_entry_notify (GObject * config,GParamSpec * param_spec,GtkEntry * entry)
name|gimp_prop_numeric_entry_notify
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_prop_numeric_entry_focus_out (GtkWidget * widget,GdkEventFocus * event,GObject * config)
name|gimp_prop_numeric_entry_focus_out
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_prop_numeric_entry_callback (GtkWidget * widget,GObject * config)
name|gimp_prop_numeric_entry_callback
parameter_list|(
name|GtkWidget
modifier|*
...
condition|)
return|return;
comment|/* we use strtod instead of g_ascii_strtod because it uses the locale,      which is what we want here */
name|value
operator|=
name|strtod
argument_list|(
...
name|g_message
argument_list|(
literal|"Invalid value entered for aspect ratio."
argument_list|)
expr_stmt|;
block|}
end_function
