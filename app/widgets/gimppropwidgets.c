...
typedef|typedef
struct|struct
DECL|struct|__anon2c5129780108
block|{
DECL|member|config
name|GObject
modifier|*
...
begin_comment
comment|/**  * gimp_prop_aspect_ratio_new:  * @config:               Object to which property is attached.  * @numerator_property:   Name of double property controlled by the first entry.  * @denominator_property: Name of double property controlled by the second entry.  * @digits:               Number of digits after decimal point to display.  *  * Creates a pair of entries separated by a ":" label.  Intended to provide  * a gui for setting an aspect ratio.  *  * Return value: A new #HBox, containing the entries and label.  *  * Since GIMP 2.4  */
end_comment
