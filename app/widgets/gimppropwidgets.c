...
typedef|typedef
struct|struct
DECL|struct|__anon2a3059f30108
block|{
DECL|member|config
name|GObject
modifier|*
...
begin_comment
comment|/**  * gimp_prop_number_pair_entry_new:  * @config:                  Object to which properties are attached.  * @left_number_property:    Name of double property for numerator.  * @right_number_property:   Name of double property for denominator.  * @connect_numbers_changed: %TRUE to connect to the widgets "numbers-changed"  *                           signal, %FALSE to not connect.  * @connect_numbers_changed: %TRUE to connect to the widgets "ratio-changed"  *                           signal, %FALSE to not connect.  * @separators:  * @allow_simplification:  * @min_valid_value:  * @max_valid_value:         What to pass to gimp_number_pair_entry_new ().  *  * Return value: A #GimpNumberPairEntry widget.  */
end_comment

begin_function
DECL|function|gimp_prop_number_pair_entry_new (GObject * config,const gchar * left_number_property,const gchar * right_number_property,gboolean connect_numbers_changed,gboolean connect_ratio_changed,const gchar * separators,gboolean allow_simplification,gdouble min_valid_value,gdouble max_valid_value)
name|GtkWidget
modifier|*
