...
typedef|typedef
struct|struct
DECL|struct|__anon2b8645850108
block|{
DECL|member|config
name|GObject
modifier|*
...
specifier|static
name|void
name|gimp_prop_aspect_ratio_changed
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_comment
comment|/**  * gimp_prop_aspect_ratio_new:  * @config:                Object to which property is attached.  * @numerator_property:    Name of double property for numerator.  * @denominator_property:  Name of double property for denominator.  *  * Return value: A #GimpNumberPairEntry widget.  */
end_comment
...
specifier|static
name|void
DECL|function|gimp_prop_aspect_ratio_changed (GtkWidget * widget,AspectData * data)
name|gimp_prop_aspect_ratio_changed
parameter_list|(
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2b8645850208
block|{
DECL|member|config
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|size_2d_data_free (Size2dData * data)
name|size_2d_data_free
parameter_list|(
name|Size2dData
modifier|*
name|data
...
specifier|static
name|void
name|gimp_prop_size_2d_entry_notify
parameter_list|(
name|GObject
modifier|*
name|config
...
specifier|static
name|void
name|gimp_prop_size_2d_size_changed
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_comment
comment|/**  * gimp_prop_size_2d_new:  * @config:          Object to which properties are attached.  * @width_property:  Name of double property for width.  * @height_property: Name of double property for height.  *  * Return value: A #GimpNumberPairEntry widget.  */
end_comment

begin_function
DECL|function|gimp_prop_size_2d_new (GObject * config,const gchar * width_property,const gchar * height_property)
name|GtkWidget
modifier|*
...
argument_list|)
argument_list|,
literal|"gimp-size-2d-entry-size-2d-data"
argument_list|,
name|size_2d_data
argument_list|,
operator|(
...
specifier|static
name|void
DECL|function|gimp_prop_size_2d_entry_notify (GObject * config,GParamSpec * param_spec,GtkEntry * entry)
name|gimp_prop_size_2d_entry_notify
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_prop_size_2d_size_changed (GtkWidget * widget,Size2dData * data)
name|gimp_prop_size_2d_size_changed
parameter_list|(
name|GtkWidget
modifier|*
