...
name|GtkWidget
modifier|*
DECL|function|gimp_prop_boolean_icon_box_new (GObject * config,const gchar * property_name,const gchar * true_icon,const gchar * false_icon,const gchar * true_tooltip,const gchar * false_tooltip)
...
typedef|typedef
struct|struct
DECL|struct|__anon28047cca0108
block|{
DECL|member|config
name|GObject
modifier|*
