...
begin_comment
comment|/**  * gimp_prop_spin_scale_new:  * @config:        #GimpConfig object to which property is attached.  * @property_name: Name of gdouble property  * @label:         Label of the created #GimpSpinScale.  * @step_increment:  * @page_increment:  * @digits:  *  * Creates a #GimpSpinScale to set and display the value of a  * gdouble property in a very space-efficient way.  * If @label is #NULL, the @property_name's nick will be used as label  * of the returned widget.  * The property's lower and upper values will be used as min/max of the  * #GimpSpinScale, unless the object carries locale data superseding  * the property's setting, with the respective keys "@property_name:min"  * and "@property_name:max".  *  * Return value:  A new #GimpSpinScale widget.  *  * Since GIMP 2.8  */
end_comment
...
name|NULL
return|;
comment|/* Check if locale min/max for this specific config object exist. */
name|config_key
operator|=
name|g_strconcat
argument_list|(
...
typedef|typedef
struct|struct
DECL|struct|__anon2ad38d8a0108
block|{
DECL|member|config
name|GObject
modifier|*
