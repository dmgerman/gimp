...
specifier|static
name|void
name|gimp_pickable_popup_confirm
parameter_list|(
name|GimpPopup
modifier|*
name|popup
...
specifier|static
name|void
DECL|function|gimp_pickable_popup_confirm (GimpPopup * popup)
name|gimp_pickable_popup_confirm
parameter_list|(
name|GimpPopup
modifier|*
...
parameter_list|)
block|{
comment|/* GimpPickablePopup *c_popup = GIMP_PICKABLE_POPUP (popup); */
name|GIMP_POPUP_CLASS
argument_list|(
name|parent_class
argument_list|)
