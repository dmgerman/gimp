...
begin_function
name|void
DECL|function|gimp_dock_window_set_dock (GimpDockWindow * dock_window,GimpDock * dock)
...
argument_list|)
expr_stmt|;
comment|/* FIXME: Handle more than one call to this function */
