...
begin_enum
enum|enum
DECL|enum|__anon2b6976740103
block|{
DECL|enumerator|ACTIVATE
name|ACTIVATE
block|,
DECL|enumerator|CHANGE_STATE
name|CHANGE_STATE
block|,
...
name|NULL
argument_list|,
name|gimp_marshal_VOID__VARIANT
argument_list|,
name|G_TYPE_NONE
argument_list|,
literal|1
...
begin_function
name|void
DECL|function|gimp_action_emit_activate (GimpAction * action,GVariant * value)
...
begin_function
name|void
DECL|function|gimp_action_emit_change_state (GimpAction * action,GVariant * value)
...
begin_function
name|void
DECL|function|gimp_action_set_icon_name (GimpAction * action,const gchar * icon_name)
...
begin_function
name|void
DECL|function|gimp_action_set_gicon (GimpAction * action,GIcon * icon)
name|gimp_action_set_gicon
parameter_list|(
name|GimpAction
modifier|*
name|action
...
name|GIcon
modifier|*
DECL|function|gimp_action_get_gicon (GimpAction * action)
name|gimp_action_get_gicon
parameter_list|(
name|GimpAction
modifier|*
name|action
...
name|GSList
modifier|*
DECL|function|gimp_action_get_proxies (GimpAction * action)
