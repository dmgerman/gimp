...
name|GtkWidget
modifier|*
DECL|function|gimp_image_view_new (GimpViewType view_type,GimpContainer * container,GimpContext * context,gint preview_size,gint min_items_x,gint min_items_y,GimpItemFactory * item_factory)
