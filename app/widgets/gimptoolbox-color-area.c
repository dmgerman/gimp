...
specifier|static
name|gboolean
DECL|function|color_area_expose_event (GtkWidget * widget,GdkEventExpose * eevent,GimpContext * context)
name|color_area_expose_event
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|color_area_draw_rect (GdkDrawable * drawable,GdkGC * gc,gint x,gint y,gint width,gint height,const GimpRGB * color)
name|color_area_draw_rect
parameter_list|(
name|GdkDrawable
modifier|*
