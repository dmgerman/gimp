...
name|g_warning
argument_list|(
literal|"%s: could not open \"%s\" for writing: %s"
argument_list|,
name|G_STRLOC
argument_list|,
name|filename
...
begin_function
name|void
DECL|function|gimp_devices_restore_test (Gimp * gimp)
...
name|g_message
argument_list|(
literal|"Could not read test-devicerc: %s"
argument_list|,
name|error
operator|->
name|message
...
begin_function
name|void
DECL|function|gimp_devices_save_test (Gimp * gimp)
...
name|g_message
argument_list|(
literal|"Could not write test-devicerc: %s"
argument_list|,
name|error
operator|->
name|message
...
name|g_warning
argument_list|(
literal|"%s: called multiple times for not present device"
argument_list|,
name|G_STRLOC
argument_list|)
expr_stmt|;
