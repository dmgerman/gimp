...
block|,
DECL|enumerator|PROP_LED_VISIBLE
name|PROP_LED_VISIBLE
block|,
...
argument_list|)
expr_stmt|;
comment|/* paint history graph for each value, with cubic interpolation */
for|for
control|(
name|i
operator|=
...
begin_function
name|void
DECL|function|gimp_meter_set_color (GimpMeter * meter,gint i,const GimpRGB * color)
...
name|GimpRGB
modifier|*
DECL|function|gimp_meter_get_color (GimpMeter * meter,gint i)
...
begin_function
name|void
DECL|function|gimp_meter_set_led_visible (GimpMeter * meter,gboolean visible)
name|gimp_meter_set_led_visible
parameter_list|(
name|GimpMeter
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_meter_get_led_visible (GimpMeter * meter)
name|gimp_meter_get_led_visible
parameter_list|(
name|GimpMeter
modifier|*
