...
typedef|typedef
struct|struct
DECL|struct|__anon277468400108
block|{
DECL|member|action
name|GtkAction
modifier|*
...
specifier|static
struct|struct
DECL|struct|__anon277468400208
block|{
DECL|member|config
name|GimpGuiConfig
modifier|*
...
specifier|static
name|void
name|gimp_action_history_insert
parameter_list|(
specifier|const
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|gimp_action_history_insert (const gchar * action_name,gint count)
name|gimp_action_history_insert
parameter_list|(
specifier|const
name|gchar
