...
name|gchar
modifier|*
name|gimp_file_proc_view_pattern_from_extension
parameter_list|(
specifier|const
name|gchar
modifier|*
...
name|GTK_TYPE_FILE_FILTER
argument_list|)
expr_stmt|;
comment|/*  COLUMN_FILTER     */
name|view
operator|=
name|g_object_new
argument_list|(
...
name|GimpPlugInProcedure
modifier|*
DECL|function|gimp_file_proc_view_get_proc (GimpFileProcView * view,gchar ** label,GtkFileFilter ** filter)
...
argument_list|)
expr_stmt|;
comment|/* if there's no selected item, we return the "automatic" procedure, which,    * if exists, is the first item.    */
if|if
condition|(
operator|!
name|has_selection
...
argument_list|)
expr_stmt|;
comment|/* there's no selected item, and no "automatic" procedure.  return NULL.        */
if|if
condition|(
operator|!
name|has_selection
...
name|gchar
modifier|*
DECL|function|gimp_file_proc_view_pattern_from_extension (const gchar * extension)
name|gimp_file_proc_view_pattern_from_extension
parameter_list|(
specifier|const
name|gchar
