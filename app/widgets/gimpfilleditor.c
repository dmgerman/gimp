...
name|GObject
modifier|*
name|gimp_fill_editor_constructor
parameter_list|(
name|GType
name|type
parameter_list|,
...
name|GObject
modifier|*
DECL|function|gimp_fill_editor_constructor (GType type,guint n_params,GObjectConstructParam * params)
name|gimp_fill_editor_constructor
parameter_list|(
name|GType
name|type
...
name|GtkWidget
modifier|*
DECL|function|gimp_fill_editor_new (GimpFillOptions * options)
