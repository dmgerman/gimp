...
block|,
DECL|enumerator|GIMP_FG_BG_TARGET_FOREGROUND
name|GIMP_FG_BG_TARGET_FOREGROUND
block|,
DECL|enumerator|GIMP_FG_BG_TARGET_BACKGROUND
name|GIMP_FG_BG_TARGET_BACKGROUND
block|,
DECL|enumerator|GIMP_FG_BG_TARGET_SWAP
name|GIMP_FG_BG_TARGET_SWAP
block|,
DECL|enumerator|GIMP_FG_BG_TARGET_DEFAULT
name|GIMP_FG_BG_TARGET_DEFAULT
DECL|typedef|GimpFgBgTarget
block|}
name|GimpFgBgTarget
typedef|;
end_typedef
