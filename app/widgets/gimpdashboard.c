...
comment|/* in bytes    */
struct|struct
DECL|struct|__anon2a21f6560508
block|{
...
struct|;
struct|struct
DECL|struct|__anon2a21f6560608
block|{
DECL|member|antecedent
name|gint
name|antecedent
