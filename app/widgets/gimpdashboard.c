...
comment|/* in bytes    */
struct|struct
DECL|struct|__anon2920aed00508
block|{
...
struct|;
struct|struct
DECL|struct|__anon2920aed00608
block|{
DECL|member|antecedent
name|gint
name|antecedent
