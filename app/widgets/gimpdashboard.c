...
block|,
DECL|enumerator|VARIABLE_SWAP_READING
name|VARIABLE_SWAP_READING
block|,
DECL|enumerator|VARIABLE_SWAP_READ
name|VARIABLE_SWAP_READ
block|,
DECL|enumerator|VARIABLE_SWAP_WRITING
name|VARIABLE_SWAP_WRITING
block|,
...
comment|/* in bytes    */
struct|struct
DECL|struct|__anon2bebcf770508
block|{
...
struct|;
struct|struct
DECL|struct|__anon2bebcf770608
block|{
DECL|member|antecedent
name|gint
name|antecedent
...
specifier|static
name|void
name|gimp_dashboard_sample_variable_or
parameter_list|(
name|GimpDashboard
modifier|*
name|dashboard
...
begin_comment
comment|/* avoid "defined but not used" warning.  un-#if 0 when needed */
end_comment

begin_endif
unit|static void       gimp_dashboard_sample_variable_and         (GimpDashboard       *dashboard,                                                               Variable             variable);
endif|#
directive|endif
end_endif
...
name|N_
argument_list|(
literal|"Whether data is being read from the swap"
argument_list|)
block|,
operator|.
name|type
...
name|N_
argument_list|(
literal|"Whether data is being written to the swap"
argument_list|)
block|,
operator|.
name|type
...
name|N_
argument_list|(
literal|"Whether data is trnasferred to or from the swap"
argument_list|)
block|,
operator|.
name|type
...
specifier|static
name|void
DECL|function|gimp_dashboard_sample_variable_or (GimpDashboard * dashboard,Variable variable)
name|gimp_dashboard_sample_variable_or
parameter_list|(
name|GimpDashboard
modifier|*
...
begin_endif
unit|static void gimp_dashboard_sample_variable_and (GimpDashboard *dashboard,                                     Variable       variable) {   GimpDashboardPrivate *priv          = dashboard->priv;   const VariableInfo   *variable_info =&variables[variable];   VariableData         *variable_data =&priv->variables[variable];   const Variable       *var;    variable_data->available     = TRUE;   variable_data->value.boolean = TRUE;    for (var = variable_info->data; *var; var++)     {       const VariableData *var_data =&priv->variables[*var];        if (! var_data->available)         {           variable_data->available = FALSE;            break;         }        variable_data->value.boolean&= var_data->value.boolean;     } }
endif|#
directive|endif
end_endif
...
typedef|typedef
struct|struct
DECL|struct|__anon2bebcf770708
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2bebcf770808
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2bebcf770908
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2bebcf770a08
block|{
DECL|member|active
name|gboolean
name|active
...
typedef|typedef
struct|struct
DECL|struct|__anon2bebcf770b08
block|{
DECL|member|prev_time
name|gint64
name|prev_time
