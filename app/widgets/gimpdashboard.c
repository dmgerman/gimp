...
comment|/* in bytes    */
struct|struct
DECL|struct|__anon2c3f88be0508
block|{
...
struct|;
struct|struct
DECL|struct|__anon2c3f88be0608
block|{
DECL|member|antecedent
name|gint
name|antecedent
