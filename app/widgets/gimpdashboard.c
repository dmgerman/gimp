...
block|,
DECL|enumerator|VARIABLE_ASSIGNED_THREADS
name|VARIABLE_ASSIGNED_THREADS
block|,
DECL|enumerator|VARIABLE_ACTIVE_THREADS
name|VARIABLE_ACTIVE_THREADS
block|,
DECL|enumerator|VARIABLE_ASYNC_RUNNING
name|VARIABLE_ASYNC_RUNNING
block|,
DECL|enumerator|VARIABLE_TILE_ALLOC_TOTAL
name|VARIABLE_TILE_ALLOC_TOTAL
block|,
...
comment|/* in bytes                   */
struct|struct
DECL|struct|__anon29ea25950508
block|{
...
struct|;
struct|struct
DECL|struct|__anon29ea25950608
block|{
DECL|member|antecedent
name|gint
name|antecedent
...
name|N_
argument_list|(
literal|"Number of assigned worker threads"
argument_list|)
block|,
operator|.
name|type
...
name|N_
argument_list|(
literal|"Number of active worker threads"
argument_list|)
block|,
operator|.
name|type
...
name|N_
argument_list|(
literal|"Total size of tile memory"
argument_list|)
block|,
operator|.
name|type
...
typedef|typedef
struct|struct
DECL|struct|__anon29ea25950708
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29ea25950808
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29ea25950908
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29ea25950a08
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29ea25950b08
block|{
DECL|member|active
name|gboolean
name|active
...
typedef|typedef
struct|struct
DECL|struct|__anon29ea25950c08
block|{
DECL|member|prev_time
name|gint64
name|prev_time
