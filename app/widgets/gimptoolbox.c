...
name|GIMP_DOCK_CLASS
argument_list|(
name|gimp_toolbox_parent_class
argument_list|)
operator|->
name|book_added
condition|)
...
specifier|static
name|void
DECL|function|toolbox_tool_reorder (GimpContainer * container,GimpToolInfo * tool_info,gint index,GimpToolbox * toolbox)
name|toolbox_tool_reorder
parameter_list|(
name|GimpContainer
modifier|*
...
specifier|static
name|void
DECL|function|toolbox_tool_visible_notify (GimpToolInfo * tool_info,GParamSpec * pspec,GtkToolItem * item)
name|toolbox_tool_visible_notify
parameter_list|(
name|GimpToolInfo
modifier|*
