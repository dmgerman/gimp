...
specifier|static
name|gboolean
name|gimp_highlightable_button_draw
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|gboolean
DECL|function|gimp_highlightable_button_draw (GtkWidget * widget,cairo_t * cr)
name|gimp_highlightable_button_draw
parameter_list|(
name|GtkWidget
modifier|*
...
expr_stmt|;
block|}
name|gtk_container_propagate_draw
argument_list|(
name|GTK_CONTAINER
argument_list|(
name|button
