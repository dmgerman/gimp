...
specifier|static
name|void
name|gimp_stroke_editor_combo_void
parameter_list|(
name|GtkComboBox
modifier|*
name|box
...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpStrokeEditor,gimp_stroke_editor,GTK_TYPE_VBOX)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_stroke_editor_combo_void (GtkComboBox * box)
name|gimp_stroke_editor_combo_void
parameter_list|(
name|GtkComboBox
modifier|*
