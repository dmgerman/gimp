...
name|GtkWidget
modifier|*
DECL|function|gimp_preview_new (GimpViewable * viewable,gboolean is_popup,gint width,gint height,gint border,gboolean clickable,gboolean show_popup)
