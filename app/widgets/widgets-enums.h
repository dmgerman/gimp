...
block|,
DECL|enumerator|GIMP_CONTAINER_TREE_VIEW_COLUMN_LAST
name|GIMP_CONTAINER_TREE_VIEW_COLUMN_LAST
DECL|typedef|GimpContainerTreeViewColumn
block|}
name|GimpContainerTreeViewColumn
typedef|;
end_typedef
