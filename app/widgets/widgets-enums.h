...
block|,
comment|/*< desc="RGBA">*/
DECL|enumerator|GIMP_CURSOR_FORMAT_PIXBUF_PREMULTIPLY
name|GIMP_CURSOR_FORMAT_PIXBUF_PREMULTIPLY
comment|/*< desc="RGBA Premultiplied">*/
