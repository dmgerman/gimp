...
begin_define
DECL|macro|GIMP_TYPE_DIAL_BACKGROUND
define|#
directive|define
name|GIMP_TYPE_DIAL_BACKGROUND
value|(gimp_dial_background_get_type ())
end_define

begin_decl_stmt
name|GType
name|gimp_dial_background_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
typedef|typedef
enum|enum
DECL|enum|__anon2978d03c0603
block|{
DECL|enumerator|GIMP_DIAL_BACKGROUND_PLAIN
name|GIMP_DIAL_BACKGROUND_PLAIN
block|,
comment|/*< desc="Plain">*/
DECL|enumerator|GIMP_DIAL_BACKGROUND_HSV
name|GIMP_DIAL_BACKGROUND_HSV
comment|/*< desc="HSV">*/
DECL|typedef|GimpDialBackground
block|}
