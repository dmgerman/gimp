...
begin_function
name|gboolean
DECL|function|gimp_data_factory_view_construct (GimpDataFactoryView * factory_view,gint view_size,gint view_border_width,GimpMenuFactory * menu_factory,const gchar * menu_identifier,const gchar * ui_identifier,const gchar * action_group)
name|gimp_data_factory_view_construct
parameter_list|(
name|GimpDataFactoryView
modifier|*
