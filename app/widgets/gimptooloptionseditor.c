...
directive|if
literal|0
block|gimp_ui_manager_update (gimp_editor->ui_manager,                           gimp_editor->popup_data);   gimp_ui_manager_ui_popup (gimp_editor->ui_manager,                             gimp_editor->ui_identifier,                             gimp_editor->popup_data,                             GTK_WIDGET (button),                             foo, foo, foo);
else|#
directive|else
