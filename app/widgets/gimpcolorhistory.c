...
include|#
directive|include
file|"app/core/gimpimage-colormap.h"
end_include
...
begin_comment
comment|/* GtkWidget methods */
end_comment

begin_function_decl
specifier|static
name|GtkSizeRequestMode
name|gimp_color_history_get_request_mode
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_color_history_get_preferred_width_for_height
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_color_history_get_preferred_height_for_width
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_color_history_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_color_history_image_changed
parameter_list|(
name|GimpContext
modifier|*
name|context
...
specifier|static
name|void
name|gimp_color_history_reorganize
parameter_list|(
name|GimpColorHistory
modifier|*
name|history
...
specifier|static
name|GtkSizeRequestMode
DECL|function|gimp_color_history_get_request_mode (GtkWidget * widget)
name|gimp_color_history_get_request_mode
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_history_get_preferred_width_for_height (GtkWidget * widget,gint height,gint * minimum_width,gint * natural_width)
name|gimp_color_history_get_preferred_width_for_height
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* This is a bit of a trick. Though the height actually depends on the    * width, I actually just request for about half the expected width if    * we were to align all color buttons on one line. This way, it is    * possible to resize the widget smaller than it currently is, hence    * allowing reorganization of icons.    */
operator|*
name|minimum_width
operator|=
name|button_width
...
specifier|static
name|void
DECL|function|gimp_color_history_get_preferred_height_for_width (GtkWidget * widget,gint width,gint * minimum_height,gint * natural_height)
name|gimp_color_history_get_preferred_height_for_width
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_history_size_allocate (GtkWidget * widget,GdkRectangle * allocation)
name|gimp_color_history_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_history_palette_dirty (GimpColorHistory * history)
name|gimp_color_history_palette_dirty
parameter_list|(
name|GimpColorHistory
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_history_image_changed (GimpContext * context,GimpImage * image,GimpColorHistory * history)
name|gimp_color_history_image_changed
parameter_list|(
name|GimpContext
modifier|*
...
specifier|static
name|void
DECL|function|gimp_color_history_reorganize (GimpColorHistory * history)
name|gimp_color_history_reorganize
parameter_list|(
name|GimpColorHistory
modifier|*
