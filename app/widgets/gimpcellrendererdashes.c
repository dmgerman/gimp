...
specifier|static
name|void
DECL|function|gimp_cell_renderer_dashes_get_size (GtkCellRenderer * cell,GtkWidget * widget,const GdkRectangle * cell_area,gint * x_offset,gint * y_offset,gint * width,gint * height)
name|gimp_cell_renderer_dashes_get_size
parameter_list|(
name|GtkCellRenderer
modifier|*
...
specifier|static
name|void
DECL|function|gimp_cell_renderer_dashes_render (GtkCellRenderer * cell,cairo_t * cr,GtkWidget * widget,const GdkRectangle * background_area,const GdkRectangle * cell_area,GtkCellRendererState flags)
name|gimp_cell_renderer_dashes_render
parameter_list|(
name|GtkCellRenderer
modifier|*
