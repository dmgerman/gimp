...
typedef|typedef
struct|struct
DECL|struct|__anon28d12d7c0108
block|{
DECL|member|manager
name|GimpUIManager
modifier|*
...
name|guint
modifier|*
name|action_accel_key
parameter_list|,
name|GdkModifierType
modifier|*
name|action_accel_mask
parameter_list|)
block|{
name|GtkTreeModel
modifier|*
...
name|_
argument_list|(
literal|"Alt+%d is used to switch to display %d and "
literal|"cannot be remapped."
argument_list|)
argument_list|,
name|accel_key
operator|-
