...
typedef|typedef
struct|struct
DECL|struct|__anon2767adff0208
block|{
DECL|member|states
name|GSList
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2767adff0308
block|{
DECL|member|text
name|gchar
modifier|*
...
begin_function
name|void
DECL|function|gimp_text_buffer_pre_serialize (GimpTextBuffer * buffer,GtkTextBuffer * content)
...
begin_function
name|void
DECL|function|gimp_text_buffer_post_deserialize (GimpTextBuffer * buffer,GtkTextBuffer * content)
