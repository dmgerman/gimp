...
argument_list|)
decl_stmt|;
comment|//   dynamics_editor->pressure_hardness_data = options->hardness_dynamics->pressure;
block|}
comment|//gtk_adjustment_set_value (dynamics_editor->pressure_hardness_data,       pressure_hardness );
block|}
end_function
...
argument_list|)
expr_stmt|;
comment|//pressure_hardness   = gtk_adjustment_get_value (editor->pressure_hardness_data);
