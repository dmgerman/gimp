...
name|frame
decl_stmt|;
comment|/*GtkWidget      *box;   gint            row = 0;   GtkWidget        *table;   GtkWidget        *menu;   GtkWidget        *label;   GtkWidget        *button;   GtkWidget        *incremental_toggle = NULL;   gint              table_row          = 0;   gint              n_dynamics         = 0;   GtkWidget        *dynamics_labels[7];   GType             tool_type; */
comment|//add a frame
name|frame
operator|=
name|gtk_frame_new
