...
name|GtkWidget
modifier|*
DECL|function|gimp_prop_angle_range_box_new (GObject * config,GParamSpec * alpha_pspec,GParamSpec * beta_pspec,GParamSpec * clockwise_pspec)
...
name|GtkWidget
modifier|*
DECL|function|gimp_prop_polar_box_new (GObject * config,GParamSpec * angle_pspec,GParamSpec * radius_pspec)
