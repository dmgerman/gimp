...
specifier|static
name|void
DECL|function|gimp_device_manager_device_added (GdkDeviceManager * gdk_manager,GdkDevice * device,GimpDeviceManager * manager)
name|gimp_device_manager_device_added
parameter_list|(
name|GdkDeviceManager
modifier|*
...
specifier|static
name|void
DECL|function|gimp_device_manager_device_removed (GdkDeviceManager * gdk_manager,GdkDevice * device,GimpDeviceManager * manager)
name|gimp_device_manager_device_removed
parameter_list|(
name|GdkDeviceManager
modifier|*
