...
specifier|static
name|void
DECL|function|create_cursor (GimpBitmapCursor * bmcursor)
name|create_cursor
parameter_list|(
name|GimpBitmapCursor
modifier|*
...
specifier|static
name|void
DECL|function|gimp_change_win_cursor_internal (GdkWindow * window,GimpCursorType cursor_type,GimpToolCursorType tool_cursor,GimpCursorModifier modifier)
name|gimp_change_win_cursor_internal
parameter_list|(
name|GdkWindow
modifier|*
name|window
...
begin_function
name|void
DECL|function|gimp_change_win_cursor (GdkWindow * win,GdkCursorType cursor_type,GimpToolCursorType tool_cursor,GimpCursorModifier modifier)
...
begin_function
name|void
DECL|function|gimp_unset_win_cursor (GdkWindow * win)
