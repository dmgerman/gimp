...
name|GdkCursor
modifier|*
DECL|function|gimp_cursor_new_from_bitmap (GdkDisplay * display,GimpCursorType cursor_type,GimpToolCursorType tool_cursor,GimpCursorModifier modifier)
name|gimp_cursor_new_from_bitmap
parameter_list|(
name|GdkDisplay
modifier|*
name|display
...
specifier|static
name|void
DECL|function|create_cursor_pixbuf (GimpBitmapCursor * bmcursor)
name|create_cursor_pixbuf
parameter_list|(
name|GimpBitmapCursor
modifier|*
name|bmcursor
...
name|GdkCursor
modifier|*
DECL|function|gimp_cursor_new_from_pixbuf (GdkDisplay * display,GimpCursorType cursor_type,GimpToolCursorType tool_cursor,GimpCursorModifier modifier)
name|gimp_cursor_new_from_pixbuf
parameter_list|(
name|GdkDisplay
modifier|*
name|display
...
name|GdkCursor
modifier|*
DECL|function|gimp_cursor_new (GdkDisplay * display,GimpCursorType cursor_type,GimpToolCursorType tool_cursor,GimpCursorModifier modifier)
...
begin_function
name|void
DECL|function|gimp_cursor_set (GtkWidget * widget,GimpCursorType cursor_type,GimpToolCursorType tool_cursor,GimpCursorModifier modifier)
