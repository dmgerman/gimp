...
name|GdkBitmap
modifier|*
DECL|function|get_cursor_bitmap (GimpBitmapCursor * bmcursor)
...
name|GdkBitmap
modifier|*
DECL|function|get_cursor_mask (GimpBitmapCursor * bmcursor)
...
name|GdkPixbuf
modifier|*
DECL|function|get_cursor_pixbuf (GimpBitmapCursor * bmcursor)
