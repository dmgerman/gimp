...
argument_list|)
argument_list|,
literal|"gimp-item-factory-update-func"
argument_list|,
name|update_func
argument_list|)
expr_stmt|;
...
begin_function
name|void
DECL|function|gimp_item_factory_popup_with_data (GtkItemFactory * item_factory,gpointer data,GtkDestroyNotify popdown_func)
