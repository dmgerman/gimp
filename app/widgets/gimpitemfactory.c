...
name|GimpItemFactory
modifier|*
DECL|function|gimp_item_factory_new (Gimp * gimp,GType container_type,const gchar * factory_path,GimpItemFactoryUpdateFunc update_func,gboolean update_on_popup,guint n_entries,GimpItemFactoryEntry * entries,gpointer callback_data,gboolean create_tearoff)
