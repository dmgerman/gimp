...
specifier|static
name|void
name|gimp_item_factory_menu_position
parameter_list|(
name|GtkMenu
modifier|*
name|menu
...
name|gchar
modifier|*
name|gimp_item_factory_translate
parameter_list|(
specifier|const
name|gchar
modifier|*
...
name|GimpItemFactory
modifier|*
DECL|function|gimp_item_factory_new (Gimp * gimp,GType container_type,const gchar * factory_path,const gchar * title,const gchar * help_id,GimpItemFactoryUpdateFunc update_func,gboolean update_on_popup,guint n_entries,GimpItemFactoryEntry * entries,gpointer callback_data,gboolean create_tearoff)
...
specifier|static
name|void
DECL|function|gimp_item_factory_menu_position (GtkMenu * menu,gint * x,gint * y,gpointer data)
name|gimp_item_factory_menu_position
parameter_list|(
name|GtkMenu
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_item_factory_translate (const gchar * path,gpointer data)
name|gimp_item_factory_translate
parameter_list|(
specifier|const
name|gchar
