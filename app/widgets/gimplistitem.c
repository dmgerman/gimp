...
begin_decl_stmt
DECL|variable|list_item_signals
specifier|static
name|guint
name|list_item_signals
index|[
name|LAST_SIGNAL
index|]
init|=
...
specifier|static
name|void
DECL|function|gimp_list_item_draw (GtkWidget * widget,GdkRectangle * area)
name|gimp_list_item_draw
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_list_item_name_changed (GimpViewable * viewable,GtkLabel * label)
name|gimp_list_item_name_changed
parameter_list|(
name|GimpViewable
modifier|*
