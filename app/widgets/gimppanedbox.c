...
begin_define
DECL|macro|INSTRUCTIONS_TEXT_PADDING
define|#
directive|define
...
name|widgets
decl_stmt|;
comment|/* Displays INSTRUCTIONS_TEXT when there are no dockables */
DECL|member|instructions
name|GtkWidget
modifier|*
name|instructions
decl_stmt|;
comment|/* Is the DND highlight shown */
DECL|member|dnd_highlight
name|gboolean
name|dnd_highlight
decl_stmt|;
DECL|member|dnd_rectangle
name|GdkRectangle
name|dnd_rectangle
decl_stmt|;
...
specifier|static
name|gint
name|gimp_paned_box_get_drop_area_size
parameter_list|(
name|GimpPanedBox
modifier|*
name|paned_box
...
specifier|static
name|gint
DECL|function|gimp_paned_box_get_drop_area_size (GimpPanedBox * paned_box)
name|gimp_paned_box_get_drop_area_size
parameter_list|(
name|GimpPanedBox
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_paned_box_drop_indicator_draw (GtkWidget * widget,cairo_t * cr,gpointer data)
name|gimp_paned_box_drop_indicator_draw
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
argument_list|)
expr_stmt|;
comment|/* See if we're at the edge of the dock If there are no dockables,    * the entire paned box is a drop area    */
name|orientation
operator|=
name|gtk_orientable_get_orientation
argument_list|(
...
name|height
expr_stmt|;
comment|/* If there are no widgets, the drop area is as big as the paned        * box        */
if|if
condition|(
operator|!
name|paned_box
...
specifier|static
name|void
DECL|function|gimp_paned_box_drag_data_received (GtkWidget * widget,GdkDragContext * context,gint x,gint y,GtkSelectionData * data,guint info,guint time)
name|gimp_paned_box_drag_data_received
parameter_list|(
name|GtkWidget
modifier|*
...
condition|)
block|{
comment|/* A widget is added, hide the instructions */
...
argument_list|)
expr_stmt|;
comment|/* The last widget is removed, show the instructions */
name|gtk_widget_show
argument_list|(
name|paned_box
operator|->
