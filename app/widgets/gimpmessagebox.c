...
begin_function
name|GType
DECL|function|gimp_message_box_get_type (void)
...
name|GtkWidget
modifier|*
DECL|function|gimp_message_box_new (const gchar * title,const gchar * message,const gchar * stock_id)
