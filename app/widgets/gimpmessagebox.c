...
name|GtkWidgetPath
modifier|*
name|gimp_message_box_get_path_for_child
parameter_list|(
name|GtkContainer
modifier|*
name|container
...
name|GtkWidgetPath
modifier|*
DECL|function|gimp_message_box_get_path_for_child (GtkContainer * container,GtkWidget * child)
name|gimp_message_box_get_path_for_child
parameter_list|(
name|GtkContainer
modifier|*
...
name|path
operator|=
name|gtk_widget_path_copy
argument_list|(
name|gtk_widget_get_path
argument_list|(
name|GTK_WIDGET
argument_list|(
name|container
...
argument_list|)
expr_stmt|;
name|gtk_widget_path_append_for_widget
argument_list|(
name|path
argument_list|,
name|child
