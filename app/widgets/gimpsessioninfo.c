...
begin_function
name|void
DECL|function|gimp_session_info_restore (GimpSessionInfo * info,GimpDialogFactory * factory,GdkScreen * screen,gint monitor)
...
begin_comment
comment|/**  * gimp_session_info_apply_geometry:  * @info:  * @screen:  * @current_monitor:  *  * Apply the geometry stored in the session info object to the  * associated widget.  **/
end_comment

begin_function
name|void
DECL|function|gimp_session_info_apply_geometry (GimpSessionInfo * info,GdkScreen * screen,gint current_monitor,gboolean apply_stored_monitor)
...
name|monitor
operator|=
name|gdk_screen_get_primary_monitor
argument_list|(
name|screen
argument_list|)
expr_stmt|;
