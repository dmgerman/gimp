...
include|#
directive|include
file|"gimpsessioninfodockable.h"
end_include

begin_enum
enum|enum
DECL|enum|__anon2b30b37b0103
block|{
...
specifier|static
name|GTokenType
DECL|function|session_info_dock_deserialize (GScanner * scanner,gint scope,GimpSessionInfo * info)
name|session_info_dock_deserialize
parameter_list|(
name|GScanner
modifier|*
