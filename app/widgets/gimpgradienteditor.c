...
begin_typedef
DECL|struct|__anon2b144a3a0408
typedef|typedef
struct|struct
block|{
DECL|member|shell
...
DECL|struct|__anon2b144a3a0508
struct|struct
block|{
DECL|member|r
DECL|member|g
...
name|g_message
argument_list|(
literal|"ed_do_rename_gradient_callback(): oops, can't find gradient to delete"
argument_list|)
expr_stmt|;
return|return;
block|}
