...
name|GtkWidget
modifier|*
DECL|function|cpopup_create_load_menu (GradientEditor * gradient_editor,GtkWidget ** color_boxes,GtkWidget ** labels,gchar * label1,gchar * label2,GCallback callback,gchar accel_key_0,guint8 accel_mods_0,gchar accel_key_1,guint8 accel_mods_1,gchar accel_key_2,guint8 accel_mods_2)
name|cpopup_create_load_menu
parameter_list|(
name|GradientEditor
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|cpopup_create_save_menu (GradientEditor * gradient_editor,GtkWidget ** color_boxes,GtkWidget ** labels,GCallback callback)
name|cpopup_create_save_menu
parameter_list|(
name|GradientEditor
modifier|*
