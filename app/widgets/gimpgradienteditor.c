...
literal|"  -GimpGradientEditor-handle-color: mix (@text_color, @base_color, 0.5);\n"
literal|"  -GimpGradientEditor-handle-color-selected: mix (@selected_fg_color, @selected_bg_color, 0.5);\n"
literal|"}\n"
expr_stmt|;
name|css
operator|=
...
specifier|static
name|void
DECL|function|control_draw_handle (cairo_t * cr,const GdkRGBA * border,const GdkRGBA * fill,gint xpos,gint height)
name|control_draw_handle
parameter_list|(
name|cairo_t
modifier|*
