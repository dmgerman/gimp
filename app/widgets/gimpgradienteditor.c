...
specifier|static
name|void
DECL|function|control_draw_normal_handle (GimpGradientEditor * editor,GdkPixmap * pixmap,gdouble pos,gint height,GtkStateType state)
name|control_draw_normal_handle
parameter_list|(
name|GimpGradientEditor
modifier|*
...
specifier|static
name|void
DECL|function|control_draw_middle_handle (GimpGradientEditor * editor,GdkPixmap * pixmap,gdouble pos,gint height,GtkStateType state)
name|control_draw_middle_handle
parameter_list|(
name|GimpGradientEditor
modifier|*
