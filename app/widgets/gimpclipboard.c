...
begin_comment
comment|/**  * gimp_clipboard_has_image:  * @gimp: pointer to #Gimp  *  * Tests if there's an image in the clipboard. If the global image cut  * buffer of @gimp is empty, this function returns %NULL.  *  * Returns: %TRUE if there's an image in the clipboard, %FALSE otherwise  **/
end_comment
...
begin_comment
comment|/**  * gimp_clipboard_has_svg:  * @gimp: pointer to #Gimp  *  * Tests if there's SVG data in %GDK_SELECTION_CLIPBOARD.  * This is done in a main-loop similar to  * gtk_clipboard_wait_is_text_available(). The same caveats apply here.  *  * Returns: %TRUE if there's SVG data in the clipboard, %FALSE otherwise  **/
end_comment
...
begin_comment
comment|/**  * gimp_clipboard_has_curve:  * @gimp: pointer to #Gimp  *  * Tests if there's curve data in %GDK_SELECTION_CLIPBOARD.  * This is done in a main-loop similar to  * gtk_clipboard_wait_is_text_available(). The same caveats apply here.  *  * Returns: %TRUE if there's curve data in the clipboard, %FALSE otherwise  **/
end_comment
