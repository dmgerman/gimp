...
specifier|static
name|void
DECL|function|gimp_overlay_child_clip_fully_opaque (GimpOverlayChild * child,GtkContainer * container,cairo_t * cr)
name|gimp_overlay_child_clip_fully_opaque
parameter_list|(
name|GimpOverlayChild
modifier|*
name|child
...
begin_function
name|gboolean
DECL|function|gimp_overlay_child_draw (GimpOverlayBox * box,GimpOverlayChild * child,cairo_t * cr)
