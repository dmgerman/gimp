...
specifier|static
name|void
name|gimp_layer_tree_view_layer_mode_box_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_layer_tree_view_update_highlight
parameter_list|(
name|GimpLayerTreeView
modifier|*
name|view
...
argument_list|)
decl_stmt|;
comment|/* currently, select_item() only ever fails when there is a floating        * selection, which can be committed/canceled through the editor buttons.        */
...
argument_list|)
expr_stmt|;
comment|/* call gimp_layer_tree_view_floating_selection_changed() now, to update        * the floating selection's row attributes.        */
name|gimp_layer_tree_view_floating_selection_changed
argument_list|(
name|gimp_item_tree_view_get_image
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_layer_tree_view_layer_mode_box_callback (GtkWidget * widget,const GParamSpec * pspec,GimpLayerTreeView * view)
name|gimp_layer_tree_view_layer_mode_box_callback
parameter_list|(
name|GtkWidget
modifier|*
...
condition|)
block|{
name|gimp_layer_mode_box_set_context
argument_list|(
name|GIMP_LAYER_MODE_BOX
argument_list|(
name|view
...
specifier|static
name|void
DECL|function|gimp_layer_tree_view_update_highlight (GimpLayerTreeView * layer_view)
name|gimp_layer_tree_view_update_highlight
parameter_list|(
name|GimpLayerTreeView
modifier|*
...
specifier|static
name|void
DECL|function|gimp_layer_tree_view_mask_callback (GimpLayer * layer,GimpLayerTreeView * layer_view)
name|gimp_layer_tree_view_mask_callback
parameter_list|(
name|GimpLayer
modifier|*
...
condition|)
block|{
comment|/* Shift-Control-click apply a layer mask */
if|if
condition|(
name|mask
condition|)
...
block|{
comment|/* Shift-click add a layer mask with last values */
if|if
condition|(
operator|!
name|mask
...
condition|)
block|{
comment|/* Control-click remove a layer mask */
if|if
condition|(
name|mask
condition|)
...
condition|)
block|{
comment|/* other clicks activate the layer */
if|if
condition|(
name|mask
condition|)
