...
specifier|static
name|void
name|gimp_layer_tree_view_drop_viewable
parameter_list|(
name|GimpContainerTreeView
modifier|*
name|view
...
name|return_drop_pos
operator|=
name|GTK_TREE_VIEW_DROP_INTO_OR_BEFORE
expr_stmt|;
else|else
operator|*
name|return_drop_pos
...
specifier|static
name|void
DECL|function|gimp_layer_tree_view_drop_viewable (GimpContainerTreeView * view,GimpViewable * src_viewable,GimpViewable * dest_viewable,GtkTreeViewDropPosition drop_pos)
name|gimp_layer_tree_view_drop_viewable
parameter_list|(
name|GimpContainerTreeView
modifier|*
