...
specifier|static
name|gboolean
name|gimp_layer_tree_view_layer_pre_clicked
parameter_list|(
...
specifier|static
name|gboolean
DECL|function|gimp_layer_tree_view_layer_pre_clicked (GimpCellRendererViewable * cell,const gchar * path_str,GdkModifierType state,GimpLayerTreeView * layer_view)
name|gimp_layer_tree_view_layer_pre_clicked
parameter_list|(
name|GimpCellRendererViewable
modifier|*
