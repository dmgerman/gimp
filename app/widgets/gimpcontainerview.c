...
name|GtkWidget
modifier|*
name|gimp_container_view_get_preview
parameter_list|(
name|GimpDocked
modifier|*
name|docked
...
specifier|static
name|void
name|gimp_container_view_set_docked_context
parameter_list|(
name|GimpDocked
modifier|*
name|docked
...
begin_function
name|void
DECL|function|gimp_container_view_set_size_request (GimpContainerView * view,gint width,gint height)
...
specifier|static
name|void
DECL|function|gimp_container_view_set_docked_context (GimpDocked * docked,GimpContext * context,GimpContext * prev_context)
name|gimp_container_view_set_docked_context
parameter_list|(
name|GimpDocked
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|gimp_container_view_get_preview (GimpDocked * docked,GimpContext * context,GtkIconSize size)
name|gimp_container_view_get_preview
parameter_list|(
name|GimpDocked
modifier|*
