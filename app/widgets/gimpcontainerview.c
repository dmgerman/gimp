...
decl_stmt|;
DECL|member|expanded_changed_handler
name|GimpTreeHandler
modifier|*
...
specifier|static
name|void
name|gimp_container_view_expanded_changed
parameter_list|(
name|GimpViewable
modifier|*
name|viewable
...
specifier|static
name|void
name|gimp_container_view_connect_context
parameter_list|(
name|GimpContainerView
modifier|*
name|view
...
specifier|static
name|gint
name|gimp_container_view_real_get_selected
parameter_list|(
name|GimpContainerView
modifier|*
name|view
...
begin_function
name|gboolean
DECL|function|gimp_container_view_multi_selected (GimpContainerView * view,GList * items)
...
begin_function
name|gint
DECL|function|gimp_container_view_get_selected (GimpContainerView * view,GList ** list)
...
specifier|static
name|gint
DECL|function|gimp_container_view_real_get_selected (GimpContainerView * view,GList ** list)
name|gimp_container_view_real_get_selected
parameter_list|(
name|GimpContainerView
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* optimization: when the toplevel container gets removed, call        * clear_items() which will get rid of all view widget stuff        * *and* empty private->item_hash, so below call to        * remove_foreach() will only disconnect all containers but not        * remove all items individually (because they are gone from        * item_hash).        */
name|gimp_container_view_clear_items
argument_list|(
name|view
argument_list|)
...
specifier|static
name|void
DECL|function|gimp_container_view_expanded_changed (GimpViewable * viewable,GimpContainerView * view)
name|gimp_container_view_expanded_changed
parameter_list|(
name|GimpViewable
modifier|*
...
specifier|static
name|void
DECL|function|gimp_container_view_connect_context (GimpContainerView * view)
name|gimp_container_view_connect_context
parameter_list|(
name|GimpContainerView
modifier|*
...
specifier|static
name|void
DECL|function|gimp_container_view_disconnect_context (GimpContainerView * view)
name|gimp_container_view_disconnect_context
parameter_list|(
name|GimpContainerView
modifier|*
