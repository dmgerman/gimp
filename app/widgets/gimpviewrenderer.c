...
name|y
decl_stmt|;
comment|/* this sucks, there should be a simpler way to do this */
name|surface
operator|=
...
condition|)
block|{
comment|/* this only works correctly for pixbufs w/o alpha channel */
name|d
index|[
literal|0
index|]
