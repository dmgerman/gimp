...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpSizeBox,gimp_size_box,GTK_TYPE_VBOX)
name|G_DEFINE_TYPE
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_size_box_destroy (GtkObject * object)
name|gimp_size_box_destroy
parameter_list|(
name|GtkObject
modifier|*
