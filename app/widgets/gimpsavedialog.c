...
specifier|static
name|void
name|gimp_save_dialog_add_compression_toggle
parameter_list|(
name|GimpSaveDialog
modifier|*
name|dialog
...
name|_
argument_list|(
literal|"The image uses features from %s, disabling "
literal|"compression won't make the XCF file "
literal|"readable by older GIMP versions."
argument_list|)
argument_list|,
name|version_string
argument_list|)
...
specifier|static
name|void
DECL|function|gimp_save_dialog_add_compression_toggle (GimpSaveDialog * dialog)
name|gimp_save_dialog_add_compression_toggle
parameter_list|(
name|GimpSaveDialog
modifier|*
