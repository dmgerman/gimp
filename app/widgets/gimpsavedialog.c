...
specifier|static
name|void
name|gimp_save_dialog_add_extra_widgets
parameter_list|(
name|GimpSaveDialog
modifier|*
name|dialog
...
specifier|static
name|void
name|gimp_save_dialog_compression_toggled
parameter_list|(
...
name|_
argument_list|(
literal|"Keep compression disabled to make the XCF "
...
argument_list|)
expr_stmt|;
comment|/* Force a "toggled" signal since gtk_toggle_button_set_active() won't    * send it if the button status doesn't change.    */
...
specifier|static
name|void
DECL|function|gimp_save_dialog_add_extra_widgets (GimpSaveDialog * dialog)
name|gimp_save_dialog_add_extra_widgets
parameter_list|(
name|GimpSaveDialog
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Additional information explaining file compatibility things */
name|dialog
operator|->
name|compat_info
operator|=
...
specifier|static
name|void
DECL|function|gimp_save_dialog_compression_toggled (GtkToggleButton * button,GimpSaveDialog * dialog)
name|gimp_save_dialog_compression_toggled
parameter_list|(
name|GtkToggleButton
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Only show compatibility information for GIMP over 2.6. The reason    * is mostly that we don't have details to make a compatibility list    * with this older version.    * It's anyway so prehistorical that we are not really caring about    * compatibility with older version.    */
if|if
condition|(
name|version
operator|<=
...
argument_list|)
expr_stmt|;
comment|/* Set the compatibility label. */
name|compat_hint
operator|=
name|g_strdup_printf
argument_list|(
...
literal|"won't be readable by older GIMP versions."
argument_list|)
argument_list|,
name|version_string
argument_list|)
...
name|widget
operator|=
name|gtk_expander_get_label_widget
argument_list|(
name|GTK_EXPANDER
argument_list|(
name|dialog
...
argument_list|)
expr_stmt|;
comment|/* Fill in the details (list of compatibility reasons). */
name|widget
operator|=
