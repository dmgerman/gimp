...
begin_function
name|GType
DECL|function|gimp_controller_info_get_type (void)
...
specifier|static
name|void
DECL|function|gimp_controller_info_config_iface_init (GimpConfigInterface * config_iface)
name|gimp_controller_info_config_iface_init
parameter_list|(
name|GimpConfigInterface
modifier|*
