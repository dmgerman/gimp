...
specifier|static
name|void
name|gimp_pdb_dialog_constructed
parameter_list|(
name|GObject
modifier|*
name|object
...
begin_macro
DECL|function|G_DEFINE_ABSTRACT_TYPE (GimpPdbDialog,gimp_pdb_dialog,GIMP_TYPE_DIALOG)
name|G_DEFINE_ABSTRACT_TYPE
argument_list|(
argument|GimpPdbDialog
argument_list|,
argument|gimp_pdb_dialog
argument_list|,
...
directive|define
name|parent_class
value|gimp_pdb_dialog_parent_class
end_define
...
specifier|static
name|void
DECL|function|gimp_pdb_dialog_init (GimpPdbDialog * dialog)
...
specifier|static
name|void
DECL|function|gimp_pdb_dialog_constructed (GObject * object)
name|gimp_pdb_dialog_constructed
parameter_list|(
name|GObject
modifier|*
