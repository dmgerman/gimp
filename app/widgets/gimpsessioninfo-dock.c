...
modifier|*
DECL|function|gimp_session_info_dock_new (void)
...
begin_function
name|GTokenType
DECL|function|gimp_session_info_dock_deserialize (GScanner * scanner,gint scope,GimpSessionInfoDock ** dock_info)
