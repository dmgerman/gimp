...
begin_function
name|void
DECL|function|gimp_session_info_dock_restore (GList * books,GimpDialogFactory * factory,GdkScreen * screen,GimpDockWindow * dock_window)
