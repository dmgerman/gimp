...
specifier|static
name|gboolean
DECL|function|gimp_handle_bar_draw (GtkWidget * widget,cairo_t * cr)
name|gimp_handle_bar_draw
parameter_list|(
name|GtkWidget
modifier|*
...
begin_function
name|void
DECL|function|gimp_handle_bar_connect_events (GimpHandleBar * bar,GtkWidget * event_source)
