...
name|GtkWidget
modifier|*
DECL|function|gimp_container_editor_add_button (GimpContainerEditor * editor,gchar ** xpm_data,const gchar * tooltip,const gchar * help_data,GtkSignalFunc callback)
