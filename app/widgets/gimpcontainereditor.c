...
begin_function
name|gboolean
DECL|function|gimp_container_editor_construct (GimpContainerEditor * editor,gint view_size,gint view_border_width,GimpMenuFactory * menu_factory,const gchar * menu_identifier,const gchar * ui_identifier)
...
directive|if
literal|0
block|editor->view =         GIMP_CONTAINER_VIEW (gimp_container_icon_view_new (editor->priv->container,                                                            editor->priv->context,                                                            view_size,                                                            view_border_width));
else|#
directive|else
name|editor
operator|->
