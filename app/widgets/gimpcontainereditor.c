...
name|ui_path
decl_stmt|;
DECL|member|busy_box
name|GtkWidget
modifier|*
name|busy_box
decl_stmt|;
DECL|member|async_set_binding
name|GBinding
modifier|*
...
begin_function
name|void
DECL|function|gimp_container_editor_bind_to_async_set (GimpContainerEditor * editor,GimpAsyncSet * async_set,const gchar * message)
name|gimp_container_editor_bind_to_async_set
parameter_list|(
name|GimpContainerEditor
modifier|*
