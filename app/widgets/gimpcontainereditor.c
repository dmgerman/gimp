...
begin_function
name|gboolean
DECL|function|gimp_container_editor_construct (GimpContainerEditor * editor,GimpMenuFactory * menu_factory,const gchar * menu_identifier,const gchar * ui_identifier)
