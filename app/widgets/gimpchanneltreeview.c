...
argument_list|()
expr_stmt|;
comment|/*  FIXME: disable keyboard navigation because as of gtk+-2.0.3,    *  GtkList kb navigation with is h-o-r-r-i-b-l-y broken with    *  GTK_SELECTION_MULTIPLE  --mitch 05/27/2002    */
