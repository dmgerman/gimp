...
specifier|static
name|void
DECL|function|gimp_container_combo_box_init (GimpContainerComboBox * combo)
...
specifier|static
name|void
DECL|function|gimp_container_combo_box_changed (GtkComboBox * combo,GimpContainerView * view)
name|gimp_container_combo_box_changed
parameter_list|(
name|GtkComboBox
modifier|*
