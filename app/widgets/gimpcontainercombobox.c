...
directive|if
literal|0
block|g_signal_connect (renderer, "update",                     G_CALLBACK (gimp_container_combo_box_renderer_update),                     combo_box);
endif|#
directive|endif
...
directive|if
literal|0
block|parent_view_iface->clear_items (view);
endif|#
directive|endif
block|}
end_function
...
specifier|static
name|void
DECL|function|gimp_container_combo_box_changed (GtkComboBox * combo_box)
name|gimp_container_combo_box_changed
parameter_list|(
name|GtkComboBox
modifier|*
