...
begin_macro
DECL|function|G_DEFINE_TYPE (GimpImagePropView,gimp_image_prop_view,GTK_TYPE_GRID)
name|G_DEFINE_TYPE
argument_list|(
...
name|GtkWidget
modifier|*
DECL|function|gimp_image_prop_view_add_label (GtkGrid * grid,gint row,const gchar * text)
name|gimp_image_prop_view_add_label
parameter_list|(
name|GtkGrid
modifier|*
