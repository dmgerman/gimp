...
name|GtkWidget
modifier|*
name|gimp_dialog_factory_put_in_dockable_constructor
parameter_list|(
name|GimpDialogFactory
modifier|*
name|factory
...
name|GimpDialogFactory
modifier|*
DECL|function|gimp_dialog_factory_new (const gchar * name,GimpContext * context,GimpMenuFactory * menu_factory,GimpDialogNewDockFunc new_dock_func,gboolean toggle_visibility)
...
begin_function
name|void
DECL|function|gimp_dialog_factory_set_put_in_dockables (GimpDialogFactory * factory,gboolean put_in_dockables)
...
begin_function
name|void
DECL|function|gimp_dialog_factory_set_dock_window_func (GimpDialogFactory * factory,GimpDialogNewFunc new_dock_window_func)
...
argument_list|)
expr_stmt|;
comment|/* Create a dock window to put the dock in. We need to create the    * dock window before the dock because the dock has a dependnecy to    * the ui manager in the dock window    */
name|dock_window
operator|=
...
begin_comment
comment|/**  * gimp_dialog_factory_dock_window_new:  * @factory:  * @screen:  *  * Creates a new dock window.  *  * Returns:  **/
end_comment

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_dialog_factory_dock_window_new (GimpDialogFactory * factory,GdkScreen * screen)
name|gimp_dialog_factory_dock_window_new
parameter_list|(
name|GimpDialogFactory
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Create the dock window */
name|dock_window
operator|=
name|factory
operator|->
...
argument_list|)
expr_stmt|;
comment|/* Add it to the dialog factory so it's position is saved when the    * app quits    */
name|gimp_dialog_factory_add_dialog
argument_list|(
name|factory
argument_list|,
...
name|GtkWidget
modifier|*
DECL|function|gimp_dialog_factory_dock_new (GimpDialogFactory * factory,GdkScreen * screen,GimpUIManager * ui_manager)
name|gimp_dialog_factory_dock_new
parameter_list|(
name|GimpDialogFactory
modifier|*
...
begin_comment
comment|/**  * gimp_dialog_factory_put_in_dockable_constructor:  * @factory:  * @entry:  * @context:  * @view_size:  *  * Put the created widget inside a #GimpDockable.  *  * Returns:  **/
end_comment
...
name|GtkWidget
modifier|*
DECL|function|gimp_dialog_factory_put_in_dockable_constructor (GimpDialogFactory * factory,GimpDialogFactoryEntry * entry,GimpContext * context,gint view_size)
name|gimp_dialog_factory_put_in_dockable_constructor
parameter_list|(
name|GimpDialogFactory
modifier|*
