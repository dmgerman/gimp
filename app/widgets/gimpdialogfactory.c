...
begin_function
name|void
DECL|function|gimp_dialog_factory_register (GimpDialogFactory * factory,const gchar * identifier,GimpDialogNewFunc new_func,gboolean singleton,gboolean session_managed)
...
specifier|static
name|void
DECL|function|gimp_dialog_factory_set_window_geometry (GtkWidget * window,GimpSessionInfo * info,gboolean set_size)
name|gimp_dialog_factory_set_window_geometry
parameter_list|(
name|GtkWidget
modifier|*
