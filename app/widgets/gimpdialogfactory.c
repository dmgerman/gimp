...
name|NULL
decl_stmt|;
comment|/*  If the dialog will be a dockable (factory->p->new_dock_func) and        *  we are called from gimp_dialog_factory_dialog_raise() (! context),        *  create a new dock _before_ creating the dialog.        *  We do this because the new dockable needs to be created in it's        *  dock's context.        */
if|if
condition|(
name|factory
operator|->
