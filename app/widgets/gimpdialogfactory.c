...
name|GimpDialogFactory
modifier|*
DECL|function|gimp_dialog_factory_new (GimpContext * context,GtkItemFactory * item_factory)
...
begin_function
name|void
DECL|function|gimp_dialog_factory_add_dock (GimpDialogFactory * factory,GimpDock * dock)
...
name|g_warning
argument_list|(
literal|"%s(): dock already registered"
argument_list|,
...
begin_function
name|void
DECL|function|gimp_dialog_factory_remove_dock (GimpDialogFactory * factory,GimpDock * dock)
