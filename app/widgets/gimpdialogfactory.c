...
name|GtkWidget
modifier|*
DECL|function|gimp_dialog_factory_dialog_new_internal (GimpDialogFactory * factory,GimpContext * context,const gchar * identifier)
...
name|g_print
argument_list|(
literal|"%s: registering toplevel \"%s\"\n"
argument_list|,
name|G_GNUC_FUNCTION
argument_list|,
name|entry
...
name|data
expr_stmt|;
comment|/*  we keep session info entries for all dialogs created by the        *  factory but don't save them if they don't want to be managed        */
if|if
condition|(
name|info
operator|->
