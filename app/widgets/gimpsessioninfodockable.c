...
begin_function
name|void
DECL|function|gimp_session_info_dockable_serialize (GimpConfigWriter * writer,GimpDockable * dockable)
...
begin_function
name|GTokenType
DECL|function|gimp_session_info_dockable_deserialize (GScanner * scanner,gint scope,GimpSessionInfoBook * book)
