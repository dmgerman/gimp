...
argument_list|)
expr_stmt|;
comment|/* Priority of default type/extension for Export:    *    *   1. Type of last Export    *   2. Type of the image Import    *   3. Type of latest Export of any document    *   4. Default file type set in Preferences    */
name|ext_file
operator|=
name|gimp_image_get_exported_file
argument_list|(
...
name|g_strconcat
argument_list|(
literal|"file:///we/only/care/about/extension."
argument_list|,
name|extension
argument_list|,
name|NULL
