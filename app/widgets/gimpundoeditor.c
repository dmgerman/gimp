...
specifier|static
name|void
DECL|function|gimp_undo_editor_destroy (GtkObject * object)
name|gimp_undo_editor_destroy
parameter_list|(
name|GtkObject
modifier|*
...
begin_function
name|void
DECL|function|gimp_undo_editor_set_image (GimpUndoEditor * editor,GimpImage * gimage)
name|gimp_undo_editor_set_image
parameter_list|(
name|GimpUndoEditor
modifier|*
...
specifier|static
name|void
DECL|function|gimp_undo_editor_undo_clicked (GtkWidget * widget,GimpUndoEditor * editor)
name|gimp_undo_editor_undo_clicked
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_undo_editor_redo_clicked (GtkWidget * widget,GimpUndoEditor * editor)
name|gimp_undo_editor_redo_clicked
parameter_list|(
name|GtkWidget
modifier|*
...
condition|)
block|{
comment|/*  the base_image was selected, pop all available undo items        */
while|while
condition|(
name|top_undo_item
operator|!=
...
condition|)
block|{
comment|/*  the selected item is on the undo stack, pop undos until it        *  is on the of the undo stack        */
while|while
condition|(
name|top_undo_item
operator|!=
