...
begin_function
name|GType
DECL|function|gimp_blob_editor_get_type (void)
...
specifier|static
name|void
DECL|function|gimp_blob_editor_class_init (GimpBlobEditorClass * klass)
name|gimp_blob_editor_class_init
parameter_list|(
name|GimpBlobEditorClass
modifier|*
...
specifier|static
name|void
DECL|function|gimp_blob_editor_draw_blob (GimpBlobEditor * editor,gdouble xc,gdouble yc,gdouble radius)
name|gimp_blob_editor_draw_blob
parameter_list|(
name|GimpBlobEditor
modifier|*
