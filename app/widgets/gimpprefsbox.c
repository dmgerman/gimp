...
block|,
DECL|enumerator|COLUMN_NOTEBOOK_PIXBUF
name|COLUMN_NOTEBOOK_PIXBUF
block|,
...
name|GtkWidget
modifier|*
DECL|function|gimp_prefs_box_add_page (GimpPrefsBox * box,const gchar * notebook_label,GdkPixbuf * notebook_icon,const gchar * tree_label,GdkPixbuf * tree_icon,const gchar * help_id,GtkTreeIter * parent,GtkTreeIter * iter)
