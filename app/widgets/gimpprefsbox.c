...
block|,
DECL|enumerator|COLUMN_PAGE_ICON_NAME
name|COLUMN_PAGE_ICON_NAME
block|,
DECL|enumerator|COLUMN_PAGE_ICON_SIZE
name|COLUMN_PAGE_ICON_SIZE
block|,
DECL|enumerator|COLUMN_PAGE_TITLE
name|COLUMN_PAGE_TITLE
block|,
DECL|enumerator|COLUMN_PAGE_HELP_ID
name|COLUMN_PAGE_HELP_ID
block|}
enum|;
end_enum
...
name|tree_icon_size
decl_stmt|;
DECL|member|page_icon_size
name|gint
name|page_icon_size
decl_stmt|;
DECL|member|page_icon_name
name|gchar
modifier|*
name|page_icon_name
decl_stmt|;
DECL|member|page_help_id
name|gchar
modifier|*
name|page_help_id
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* The main preferences stack */
name|private
operator|->
name|stack
operator|=
...
argument_list|)
argument_list|,
name|GTK_STACK_TRANSITION_TYPE_SLIDE_UP_DOWN
argument_list|)
expr_stmt|;
name|gtk_box_pack_start
argument_list|(
...
specifier|static
name|void
DECL|function|gimp_prefs_box_finalize (GObject * object)
name|gimp_prefs_box_finalize
parameter_list|(
name|GObject
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|gimp_prefs_box_add_page (GimpPrefsBox * box,const gchar * icon_name,const gchar * page_title,const gchar * tree_label,const gchar * help_id,GtkTreeIter * parent,GtkTreeIter * iter)
...
name|gchar
modifier|*
DECL|function|gimp_prefs_box_get_current_icon_name (GimpPrefsBox * box)
...
name|gchar
modifier|*
DECL|function|gimp_prefs_box_get_current_help_id (GimpPrefsBox * box)
...
name|GtkWidget
modifier|*
DECL|function|gimp_prefs_box_set_page_resettable (GimpPrefsBox * box,GtkWidget * page,const gchar * label)
