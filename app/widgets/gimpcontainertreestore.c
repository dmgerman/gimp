...
specifier|static
name|void
name|gimp_container_tree_store_constructed
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
DECL|function|gimp_container_tree_store_constructed (GObject * object)
name|gimp_container_tree_store_constructed
parameter_list|(
name|GObject
modifier|*
...
name|path
decl_stmt|;
comment|/* emit a "row-changed" signal for 'iter', so that editing of        * corresponding tree-view rows is canceled.  otherwise, if we remove the        * item while a corresponding row is being edited, bad things happen (see        * bug #792991).        */
name|path
operator|=
...
typedef|typedef
struct|struct
DECL|struct|__anon2c90ad2b0208
block|{
