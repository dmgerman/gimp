...
specifier|static
name|void
DECL|function|gimp_dynamics_output_editor_use_input (GimpDynamicsOutputEditor * editor,gint input,gboolean value)
name|gimp_dynamics_output_editor_use_input
parameter_list|(
name|GimpDynamicsOutputEditor
modifier|*
