...
specifier|static
name|void
DECL|function|gimp_dynamics_output_editor_notify_output (GimpDynamicsOutput * output,const GParamSpec * pspec,GtkListStore * list)
name|gimp_dynamics_output_editor_notify_output
parameter_list|(
name|GimpDynamicsOutput
modifier|*
