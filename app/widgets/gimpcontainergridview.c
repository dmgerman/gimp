...
specifier|static
name|gboolean
DECL|function|gimp_container_grid_view_move_by (GimpContainerGridView * view,gint x,gint y)
...
specifier|static
name|gboolean
DECL|function|gimp_container_grid_view_move_cursor (GimpContainerGridView * view,GtkMovementStep step,gint count)
name|gimp_container_grid_view_move_cursor
parameter_list|(
name|GimpContainerGridView
modifier|*
