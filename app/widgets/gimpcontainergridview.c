...
specifier|static
name|void
name|gimp_container_grid_view_docked_iface_init
parameter_list|(
...
argument_list|,
argument|G_IMPLEMENT_INTERFACE (GIMP_TYPE_CONTAINER_VIEW,                                                 gimp_container_grid_view_view_iface_init)                          G_IMPLEMENT_INTERFACE (GIMP_TYPE_DOCKED,                                                 gimp_container_grid_view_docked_iface_init)
argument_list|)
end_macro
...
specifier|static
name|void
DECL|function|gimp_container_grid_view_docked_iface_init (GimpDockedInterface * iface)
name|gimp_container_grid_view_docked_iface_init
parameter_list|(
name|GimpDockedInterface
modifier|*
...
specifier|static
name|void
DECL|function|gimp_container_grid_view_set_context (GimpDocked * docked,GimpContext * context)
name|gimp_container_grid_view_set_context
parameter_list|(
name|GimpDocked
modifier|*
