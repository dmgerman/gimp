...
argument_list|)
expr_stmt|;
comment|/*gimp_constrained_hwrap_box_new (FALSE);*/
comment|/*gtk_wrap_box_set_aspect_ratio (GTK_WRAP_BOX (grid_view->wrap_box), 256);*/
...
name|GtkWidget
modifier|*
DECL|function|gimp_container_grid_view_new (GimpContainer * container,GimpContext * context,gint preview_width,gint preview_height,gint min_items_x,gint min_items_y)
