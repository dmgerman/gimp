...
block|,
DECL|enumerator|PROP_SHOW_ALL_FILES
name|PROP_SHOW_ALL_FILES
block|, }
enum|;
end_enum
...
argument_list|)
expr_stmt|;
comment|/* The list of file formats. */
name|scrolled_window
operator|=
...
argument_list|)
expr_stmt|;
comment|/* Checkbox to show all files. */
name|checkbox
operator|=
...
name|_
argument_list|(
literal|"Select File _Type (%s) - Show All Files"
argument_list|)
argument_list|,
name|name
argument_list|)
