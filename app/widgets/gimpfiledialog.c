...
argument_list|)
expr_stmt|;
comment|/* gtk_widget_set_sensitive (dialog->cancel_button, cancelable); */
...
argument_list|)
expr_stmt|;
comment|/* gtk_widget_set_sensitive (dialog->cancel_button, FALSE); */
...
argument_list|)
expr_stmt|;
comment|/* don't gtk_widget_show (dialog->progress); */
name|gimp_file_dialog_add_proc_selection
argument_list|(
name|dialog
argument_list|,
...
specifier|static
name|void
DECL|function|gimp_file_dialog_add_proc_selection (GimpFileDialog * dialog,Gimp * gimp,GSList * file_procs,const gchar * automatic,const gchar * automatic_help_id,GtkWidget * vbox)
name|gimp_file_dialog_add_proc_selection
parameter_list|(
name|GimpFileDialog
modifier|*
