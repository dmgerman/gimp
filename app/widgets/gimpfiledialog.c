...
name|gchar
modifier|*
name|gimp_file_dialog_get_dirname_from_uri
parameter_list|(
specifier|const
name|gchar
modifier|*
...
begin_function
name|void
DECL|function|gimp_file_dialog_set_save_image (GimpFileDialog * dialog,Gimp * gimp,GimpImage * image,gboolean save_a_copy,gboolean export,gboolean close_after_saving,GimpObject * display)
...
name|gchar
modifier|*
DECL|function|gimp_file_dialog_get_dirname_from_uri (const gchar * uri)
name|gimp_file_dialog_get_dirname_from_uri
parameter_list|(
specifier|const
name|gchar
