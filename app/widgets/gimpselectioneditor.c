...
specifier|static
name|void
name|gimp_selection_editor_set_background
parameter_list|(
name|GObject
modifier|*
name|config
...
name|GtkWidget
modifier|*
DECL|function|gimp_selection_editor_new (GimpImage * gimage,GimpCoreConfig * config)
...
specifier|static
name|void
DECL|function|gimp_selection_editor_set_background (GObject * config,GParamSpec * pspec,GimpPreview * preview)
name|gimp_selection_editor_set_background
parameter_list|(
name|GObject
modifier|*
