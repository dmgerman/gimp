...
begin_define
DECL|macro|GIMP_TOOL_INFO_PREVIEW_GET_CLASS (obj)
define|#
directive|define
name|GIMP_TOOL_INFO_PREVIEW_GET_CLASS
parameter_list|(
name|obj
parameter_list|)
value|(G_TYPE_INSTANCE_GET_CLASS ((obj), GIMP_TYPE_TOOL_INFO_PREVIEW, GimpToolInfoPreviewClass))
end_define
