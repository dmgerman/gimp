...
typedef|typedef
enum|enum
DECL|enum|__anon29fc84960103
block|{
DECL|enumerator|DIAL_DIRECTION_CW
name|DIAL_DIRECTION_CW
init|=
literal|1
block|,
DECL|enumerator|DIAL_DIRECTION_CCW
name|DIAL_DIRECTION_CCW
init|=
operator|-
literal|1
DECL|typedef|DialDirection
block|}
name|DialDirection
typedef|;
end_typedef
