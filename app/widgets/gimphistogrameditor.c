...
specifier|static
name|void
name|gimp_histogram_editor_drawable_update
parameter_list|(
name|GimpDrawable
modifier|*
name|drawable
...
specifier|static
name|gboolean
DECL|function|gimp_histogram_editor_set_sensitive (gpointer item_data,GimpDrawable * drawable)
name|gimp_histogram_editor_set_sensitive
parameter_list|(
name|gpointer
name|item_data
parameter_list|,
...
argument_list|)
expr_stmt|;
comment|/* FIXME: also need to do this on    *        "GimpDrawable::alpha_changed" and "GimpImage::mode_changed"    */
...
specifier|static
name|void
DECL|function|gimp_histogram_editor_drawable_update (GimpDrawable * drawable,gint x,gint y,gint width,gint height,GimpHistogramEditor * editor)
name|gimp_histogram_editor_drawable_update
parameter_list|(
name|GimpDrawable
modifier|*
