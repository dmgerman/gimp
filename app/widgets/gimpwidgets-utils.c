...
specifier|const
struct|struct
DECL|struct|__anon27a497790108
block|{
DECL|member|r
name|guchar
name|r
...
begin_comment
comment|/**  * gimp_highlight_widget:  * @widget:  * @highlight:  *  * Turns highlighting for @widget on or off according to  * @highlight, in a similar fashion to gtk_drag_higlight()  * and gtk_drag_unhiglight().  **/
end_comment
...
typedef|typedef
struct|struct
DECL|struct|__anon27a497790208
block|{
