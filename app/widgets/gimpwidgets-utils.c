...
specifier|const
struct|struct
DECL|struct|__anon2b0238af0108
block|{
DECL|member|r
name|guchar
name|r
...
specifier|static
name|gboolean
DECL|function|gimp_highlight_widget_expose (GtkWidget * widget,GdkEventExpose * event,gpointer data)
name|gimp_highlight_widget_expose
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
parameter_list|)
block|{
comment|/* this code is a modified version of gtk+'s gtk_drag_highlight_expose(),    * changing the highlight color from black to the widget's text color, which    * improves its visibility when using a dark theme.    */
name|gint
name|x
decl_stmt|,
name|y
...
typedef|typedef
struct|struct
DECL|struct|__anon2b0238af0208
block|{
