...
specifier|static
struct|struct
DECL|struct|__anon273e9fe70108
block|{
...
begin_comment
comment|/**  * gimp_widgets_add_paned_widget:  * @box:                  A #GtkBox  * @box_widget_list:      List of current widgets in the @box  * @box_widget_keep_last: The widget to keep last in the @box  * @widget:               The #GtkWidget to add  * @index:                Where to add the @widget  *  * Add a #GtkWidget to a #GtkBox in a hierarchy of #GtkPaned:s so the  * space can be manually distributed between the widgets.  **/
end_comment

begin_function
name|void
DECL|function|gimp_widgets_add_paned_widget (GtkBox * box,GList ** box_widget_list,GtkWidget * box_widget_keep_last,GtkWidget * widget,gint index)
...
begin_comment
comment|/**  * gimp_widgets_remove_paned_widget:  * @box:             A #GtkBox  * @box_widget_list: Pointer to list of current widgets in the @box  * @widget:          The #GtkWidget to remove  *  * Remove a #GtkWidget from a #GtkBox added with  * gimp_widgets_add_paned_widget().  **/
end_comment

begin_function
name|void
DECL|function|gimp_widgets_remove_paned_widget (GtkBox * box,GList ** box_widget_list,GtkWidget * widget)
