...
begin_define
DECL|macro|GIMP_TOOL_OPTIONS_GUI_FUNC_KEY
define|#
directive|define
name|GIMP_TOOL_OPTIONS_GUI_FUNC_KEY
value|"gimp-tool-options-gui-func"
end_define

begin_function
name|GtkWidget
modifier|*
DECL|function|gimp_menu_item_get_image (GtkMenuItem * item)
...
begin_function
name|void
DECL|function|gimp_menu_item_set_image (GtkMenuItem * item,GtkWidget * image)
...
begin_function
name|void
DECL|function|gimp_grid_attach_icon (GtkGrid * grid,gint row,const gchar * icon_name,GtkWidget * widget,gint columns)
...
name|GdkPixbuf
modifier|*
DECL|function|gimp_widget_load_icon (GtkWidget * widget,const gchar * icon_name,gint size)
...
argument_list|)
expr_stmt|;
comment|/* This will find the symbolic icon and fallback to non-symbolic    * depending on icon theme.    */
name|icon_info
operator|=
...
condition|)
block|{
comment|/* As last resort, just draw an ugly magenta square. */
name|guchar
modifier|*
name|data
decl_stmt|;
...
begin_function
name|GimpChannelOps
DECL|function|gimp_modifiers_to_channel_op (GdkModifierType modifiers)
...
begin_function
name|GdkModifierType
DECL|function|gimp_replace_virtual_modifiers (GdkModifierType modifiers)
name|gimp_replace_virtual_modifiers
parameter_list|(
name|GdkModifierType
name|modifiers
...
begin_function
name|GdkModifierType
DECL|function|gimp_get_modify_selection_mask (void)
name|gimp_get_modify_selection_mask
parameter_list|(
name|void
parameter_list|)
...
begin_function
name|GdkModifierType
DECL|function|gimp_get_toggle_behavior_mask (void)
name|gimp_get_toggle_behavior_mask
parameter_list|(
name|void
parameter_list|)
...
begin_function
name|GdkModifierType
DECL|function|gimp_get_all_modifiers_mask (void)
...
name|size
operator|=
name|CGDisplayScreenSize
argument_list|(
name|kCGDirectMainDisplay
argument_list|)
expr_stmt|;
if|if
condition|(
...
begin_function
name|gboolean
DECL|function|gimp_get_style_color (GtkWidget * widget,const gchar * property_name,GdkRGBA * color)
...
return|;
block|}
comment|/* return ugly magenta to indicate that something is wrong */
name|color
operator|->
name|red
operator|=
...
specifier|static
name|void
name|gimp_accel_help_widget_weak_notify
parameter_list|(
name|gpointer
name|accel_group
parameter_list|,
...
specifier|static
name|void
DECL|function|gimp_accel_help_accel_group_weak_notify (gpointer widget,GObject * where_accel_group_was)
name|gimp_accel_help_accel_group_weak_notify
parameter_list|(
name|gpointer
name|widget
parameter_list|,
...
specifier|static
name|void
DECL|function|gimp_accel_help_widget_weak_notify (gpointer accel_group,GObject * where_widget_was)
name|gimp_accel_help_widget_weak_notify
parameter_list|(
name|gpointer
name|accel_group
...
specifier|const
struct|struct
DECL|struct|__anon27adfe590108
block|{
DECL|member|r
name|guchar
name|r
...
specifier|static
name|gboolean
DECL|function|gimp_highlight_widget_draw (GtkWidget * widget,cairo_t * cr,gpointer data)
name|gimp_highlight_widget_draw
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
parameter_list|)
block|{
comment|/* this code is a straight copy of draw_flash() from gtk-inspector's    * inspect-button.c    */
name|GtkAllocation
name|alloc
decl_stmt|;
if|if
...
argument_list|)
decl_stmt|;
comment|/* We don't want to draw the drag highlight around the        * CSD window decorations        */
if|if
condition|(
name|child
operator|==
...
begin_comment
comment|/**  * gimp_highlight_widget:  * @widget:  * @highlight:  *  * Turns highlighting for @widget on or off according to  * @highlight, in a similar fashion to gtk_drag_highlight()  * and gtk_drag_unhighlight().  **/
end_comment
...
typedef|typedef
struct|struct
DECL|struct|__anon27adfe590208
block|{
...
name|WidgetBlink
modifier|*
DECL|function|widget_blink_new (void)
name|widget_blink_new
parameter_list|(
name|void
parameter_list|)
block|{
...
specifier|static
name|void
DECL|function|widget_blink_free (WidgetBlink * blink)
name|widget_blink_free
parameter_list|(
name|WidgetBlink
modifier|*
name|blink
...
specifier|static
name|gboolean
DECL|function|gimp_widget_blink_timeout (GtkWidget * widget)
name|gimp_widget_blink_timeout
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_function
name|void
DECL|function|gimp_widget_blink (GtkWidget * widget)
...
begin_function
name|void
DECL|function|gimp_widget_blink_cancel (GtkWidget * widget)
name|gimp_widget_blink_cancel
parameter_list|(
name|GtkWidget
modifier|*
...
begin_function
name|void
DECL|function|gimp_tools_set_tool_options_gui_func (GimpToolOptions * tool_options,GimpToolOptionsGUIFunc func)
...
begin_function
name|gboolean
DECL|function|gimp_widget_get_fully_opaque (GtkWidget * widget)
...
argument_list|)
argument_list|,
literal|"gimp-widget-fully-opaque"
argument_list|)
operator|!=
name|NULL
return|;
...
begin_function
name|void
DECL|function|gimp_widget_set_fully_opaque (GtkWidget * widget,gboolean fully_opaque)
...
specifier|static
name|void
DECL|function|gimp_gtk_container_clear_callback (GtkWidget * widget,GtkContainer * container)
name|gimp_gtk_container_clear_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_function
name|void
DECL|function|gimp_gtk_container_clear (GtkContainer * container)
...
begin_function
name|void
DECL|function|gimp_button_set_suggested (GtkWidget * button,gboolean suggested,GtkReliefStyle default_relief)
...
begin_function
name|void
DECL|function|gimp_button_set_destructive (GtkWidget * button,gboolean destructive,GtkReliefStyle default_relief)
...
name|g_strdup_printf
argument_list|(
literal|"%s (device '%s', source device '%s')"
argument_list|,
name|str
argument_list|,
...
name|gdk_device_get_name
argument_list|(
name|gdk_event_get_source_device
argument_list|(
name|event
argument_list|)
argument_list|)
...
begin_function
name|gboolean
DECL|function|gimp_color_profile_store_add_defaults (GimpColorProfileStore * store,GimpColorConfig * config,GimpImageBaseType base_type,GimpPrecision precision,GError ** error)
...
specifier|static
name|void
DECL|function|connect_path_show (GimpColorProfileChooserDialog * dialog)
name|connect_path_show
parameter_list|(
...
condition|)
block|{
comment|/*  if something is already selected in this dialog,        *  leave it alone        */
name|g_object_unref
argument_list|(
name|file
argument_list|)
...
specifier|static
name|void
DECL|function|connect_path_response (GimpColorProfileChooserDialog * dialog,gint response)
name|connect_path_response
parameter_list|(
name|GimpColorProfileChooserDialog
modifier|*
name|dialog
...
begin_function
name|void
DECL|function|gimp_color_profile_chooser_dialog_connect_path (GtkWidget * dialog,GObject * config,const gchar * property_name)
...
begin_function
name|void
DECL|function|gimp_widget_flush_expose (void)
