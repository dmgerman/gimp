...
name|PROP_HELP_ID
block|,
DECL|enumerator|PROP_IMPORT_TITLE
name|PROP_IMPORT_TITLE
block|,
DECL|enumerator|PROP_EXPORT_TITLE
name|PROP_EXPORT_TITLE
block|,
DECL|enumerator|PROP_DEFAULT_FOLDER
name|PROP_DEFAULT_FOLDER
block|,
DECL|enumerator|PROP_LAST_FILE
name|PROP_LAST_FILE
block|}
enum|;
end_enum
...
name|help_id
decl_stmt|;
DECL|member|import_title
name|gchar
modifier|*
name|import_title
decl_stmt|;
DECL|member|export_title
name|gchar
modifier|*
name|export_title
decl_stmt|;
...
name|GtkWidget
modifier|*
DECL|function|gimp_settings_box_new (Gimp * gimp,GObject * config,GimpContainer * container,const gchar * import_title,const gchar * export_title,const gchar * help_id,GFile * default_folder,GFile * last_file)
