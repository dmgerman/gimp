...
specifier|static
name|void
name|gimp_histogram_view_dispose
parameter_list|(
name|GObject
modifier|*
name|object
...
specifier|static
name|void
name|gimp_histogram_view_get_preferred_width
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
name|gimp_histogram_view_get_preferred_height
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
operator|=
literal|"GimpHistogramView {\n"
literal|"  color: @text_color;\n"
literal|"  background-color: @base_color;\n"
literal|"  -GimpHistogramView-grid-color: darker (@bg_color);\n"
literal|"  -GimpHistogramView-fg-color: @fg_color;\n"
literal|"  -GimpHistogramView-fg-color-selected: @selected_fg_color;\n"
literal|"  -GimpHistogramView-bg-color: mix (lighter (@bg_color), darker (@bg_color), 0.5);\n"
literal|"  -GimpHistogramView-bg-color-selected: mix (lighter (@selected_bg_color), darker (@selected_bg_color), 0.5);\n"
literal|"}\n"
literal|"\n"
literal|"GimpHistogramView:selected {\n"
literal|"  background-color: @selected_bg_color;\n"
literal|"}\n"
expr_stmt|;
name|css
operator|=
...
specifier|static
name|void
DECL|function|gimp_histogram_view_dispose (GObject * object)
name|gimp_histogram_view_dispose
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|void
DECL|function|gimp_histogram_view_get_preferred_width (GtkWidget * widget,gint * minimum_width,gint * natural_width)
name|gimp_histogram_view_get_preferred_width
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_histogram_view_get_preferred_height (GtkWidget * widget,gint * minimum_height,gint * natural_height)
name|gimp_histogram_view_get_preferred_height
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gimp_histogram_view_draw_spike (GimpHistogramView * view,GimpHistogramChannel channel,cairo_t * cr,const GdkRGBA * fg_color,cairo_operator_t fg_operator,const GdkRGBA * bg_color,gint x,gint i,gint j,gdouble max,gdouble bg_max,gint height,gint border)
name|gimp_histogram_view_draw_spike
parameter_list|(
name|GimpHistogramView
modifier|*
...
specifier|static
name|void
DECL|function|gimp_histogram_view_notify (GimpHistogram * histogram,const GParamSpec * pspec,GimpHistogramView * view)
name|gimp_histogram_view_notify
parameter_list|(
name|GimpHistogram
modifier|*
...
specifier|static
name|void
DECL|function|gimp_histogram_view_update_bins (GimpHistogramView * view)
name|gimp_histogram_view_update_bins
parameter_list|(
name|GimpHistogramView
modifier|*
