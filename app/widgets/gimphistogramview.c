...
specifier|static
name|void
DECL|function|histogram_widget_draw (HistogramWidget * histogram,gint update)
...
name|HistogramWidget
modifier|*
DECL|function|histogram_widget_new (gint width,gint height)
...
begin_function
name|void
DECL|function|histogram_widget_range (HistogramWidget * histogram,gint start,gint end)
