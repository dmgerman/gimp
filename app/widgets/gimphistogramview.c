...
specifier|static
name|void
DECL|function|gimp_gdk_rgba_shade (const GdkRGBA * color,gdouble factor,GdkRGBA * shaded)
name|gimp_gdk_rgba_shade
parameter_list|(
specifier|const
name|GdkRGBA
modifier|*
...
name|in
operator|=
name|gtk_symbolic_color_new_literal
argument_list|(
name|color
argument_list|)
expr_stmt|;
name|out
operator|=
name|gtk_symbolic_color_new_shade
argument_list|(
name|in
argument_list|,
name|factor
...
specifier|static
name|void
DECL|function|gimp_gdk_rgba_mix (const GdkRGBA * color1,const GdkRGBA * color2,gdouble factor,GdkRGBA * mixed)
name|gimp_gdk_rgba_mix
parameter_list|(
specifier|const
name|GdkRGBA
modifier|*
...
name|out
operator|=
name|gtk_symbolic_color_new_mix
argument_list|(
name|in1
argument_list|,
name|in2
