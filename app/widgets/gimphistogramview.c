...
specifier|static
name|void
DECL|function|gimp_histogram_view_draw_spike (GimpHistogramView * view,GimpHistogramChannel channel,cairo_t * cr,const GdkColor * fg_color,cairo_operator_t fg_operator,const GdkColor * bg_color,gint x,gint i,gint j,gdouble max,gdouble bg_max,gint height,gint border)
name|gimp_histogram_view_draw_spike
parameter_list|(
name|GimpHistogramView
modifier|*
