...
name|GtkWidget
modifier|*
DECL|function|gimp_text_editor_new (GtkTextBuffer * buffer,const gchar * title,GimpTextEditorCallback callback,gpointer callback_data)
...
specifier|static
name|void
DECL|function|gimp_text_editor_response (TextEditorData * data,GtkResponseType response)
name|gimp_text_editor_response
parameter_list|(
name|TextEditorData
modifier|*
name|data
...
specifier|static
name|void
DECL|function|gimp_text_editor_ok (TextEditorData * data)
name|gimp_text_editor_ok
parameter_list|(
name|TextEditorData
modifier|*
...
specifier|static
name|void
DECL|function|gimp_text_editor_cancel (TextEditorData * data)
name|gimp_text_editor_cancel
parameter_list|(
name|TextEditorData
modifier|*
