...
directive|if
literal|0
block|GdkScreen   *screen = gtk_widget_get_screen (widget);   GdkColormap *rgba   = gdk_screen_get_rgba_colormap (screen);    g_assert (gdk_screen_get_rgba_visual (screen) != NULL);    gtk_widget_set_colormap (widget, rgba);
endif|#
directive|endif
