...
specifier|static
name|void
DECL|function|layout_col (GtkWrapBox * wbox,GtkAllocation * area,GSList * children,guint children_per_line,gboolean hexpand,gint * shortfall)
name|layout_col
parameter_list|(
name|GtkWrapBox
modifier|*
...
name|g_warning
argument_list|(
literal|"gtkvwrapbox: not enough space!\n"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|g_warning
argument_list|(
literal|"gtkvwrapbox: unhandled wbox justification"
argument_list|)
expr_stmt|;
name|height
operator|=
...
name|g_warning
argument_list|(
literal|"vwrapbox too small, shortfall is %d\n"
argument_list|,
name|shortfall
argument_list|)
expr_stmt|;
