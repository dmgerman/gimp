...
begin_enum
enum|enum
DECL|enum|__anon2c788e6e0203
block|{
DECL|enumerator|PROP_0
name|PROP_0
block|,
DECL|enumerator|PROP_CONTEXT_AWARE
name|PROP_CONTEXT_AWARE
block|}
enum|;
end_enum
...
specifier|static
name|void
name|gimp_color_dialog_context_notify
parameter_list|(
name|GimpColorDialog
modifier|*
name|dialog
...
argument_list|)
expr_stmt|;
comment|/* Note: I only use the "colormap-edit-color" action for icon, and        * tooltip, but don't actually run it because it would create yet        * another dialog. Instead we switch the stack view.        */
name|g_signal_connect_swapped
argument_list|(
name|button
argument_list|,
...
name|g_warning
argument_list|(
literal|"%s: 'colormap' action group not found"
argument_list|,
name|G_STRFUNC
argument_list|)
expr_stmt|;
...
name|GtkWidget
modifier|*
DECL|function|gimp_color_dialog_new (GimpViewable * viewable,GimpContext * context,gboolean context_aware,const gchar * title,const gchar * icon_name,const gchar * desc,GtkWidget * parent,GimpDialogFactory * dialog_factory,const gchar * dialog_identifier,const GimpRGB * color,gboolean wants_updates,gboolean show_alpha)
...
specifier|static
name|void
DECL|function|gimp_color_dialog_context_notify (GimpColorDialog * dialog,const GParamSpec * pspec)
name|gimp_color_dialog_context_notify
parameter_list|(
name|GimpColorDialog
modifier|*
