...
comment|/*   right_vbox = gtk_vbox_new (FALSE, 2);   gtk_box_pack_start (GTK_BOX (main_hbox), right_vbox, TRUE, TRUE, 0);   gtk_widget_show (right_vbox);   */
...
argument_list|)
expr_stmt|;
comment|/* gtk_box_pack_start (GTK_BOX (right_vbox), colors_frame, FALSE, FALSE, 0); */
name|gtk_box_pack_start
argument_list|(
name|GTK_BOX
argument_list|(
