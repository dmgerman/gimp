...
begin_define
DECL|macro|GIMP_HELP_WINDOWS_TABS_POSITION_TOP
define|#
directive|define
name|GIMP_HELP_WINDOWS_TABS_POSITION_TOP
value|"gimp-windows-tabs-position-top"
end_define

begin_define
DECL|macro|GIMP_HELP_WINDOWS_TABS_POSITION_BOTTOM
define|#
directive|define
name|GIMP_HELP_WINDOWS_TABS_POSITION_BOTTOM
value|"gimp-windows-tabs-position-bottom"
end_define

begin_define
DECL|macro|GIMP_HELP_WINDOWS_TABS_POSITION_LEFT
define|#
directive|define
name|GIMP_HELP_WINDOWS_TABS_POSITION_LEFT
value|"gimp-windows-tabs-position-left"
end_define

begin_define
DECL|macro|GIMP_HELP_WINDOWS_TABS_POSITION_RIGHT
define|#
directive|define
name|GIMP_HELP_WINDOWS_TABS_POSITION_RIGHT
value|"gimp-windows-tabs-position-right"
end_define
