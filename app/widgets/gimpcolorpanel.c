...
begin_function
name|void
DECL|function|gimp_color_panel_dialog_response (GimpColorPanel * panel,GimpColorDialogState state)
...
name|GIMP_COLOR_DIALOG_CANCEL
case|:
comment|/* GimpColorDialog returns the appropriate color (new one or        * original one if process cancelled.        */
name|gimp_color_button_set_color
argument_list|(
name|GIMP_COLOR_BUTTON
argument_list|(
