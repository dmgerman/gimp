...
name|GdkPixbuf
modifier|*
name|gimp_drawable_tree_view_drag_pixbuf
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|gimp_drawable_tree_view_view_iface_init (GimpContainerViewInterface * view_iface)
name|gimp_drawable_tree_view_view_iface_init
parameter_list|(
name|GimpContainerViewInterface
modifier|*
...
name|GdkPixbuf
modifier|*
DECL|function|gimp_drawable_tree_view_drag_pixbuf (GtkWidget * widget,gpointer data)
name|gimp_drawable_tree_view_drag_pixbuf
parameter_list|(
name|GtkWidget
modifier|*
