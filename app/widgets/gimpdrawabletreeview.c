...
name|_
argument_list|(
literal|"Cannot select item while a floating "
literal|"selection is active."
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
specifier|static
name|void
DECL|function|gimp_drawable_tree_view_new_dropped (GimpItemTreeView * view,GimpFillOptions * options,const gchar * undo_desc)
