...
begin_function
name|void
DECL|function|gimp_session_info_book_serialize (GimpConfigWriter * writer,GimpDockbook * dockbook)
...
begin_function
name|GTokenType
DECL|function|gimp_session_info_book_deserialize (GScanner * scanner,gint scope,GimpSessionInfo * info)
