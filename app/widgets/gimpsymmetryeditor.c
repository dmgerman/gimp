...
begin_comment
comment|/* GimpDockedInterface handlers. */
end_comment

begin_function_decl
specifier|static
name|void
name|gimp_symmetry_editor_set_context
parameter_list|(
name|GimpDocked
modifier|*
name|docked
...
begin_comment
comment|/* GimpImageEditor handlers. */
end_comment
...
specifier|static
name|void
DECL|function|gimp_symmetry_editor_class_init (GimpSymmetryEditorClass * klass)
...
specifier|static
name|void
DECL|function|gimp_symmetry_editor_set_context (GimpDocked * docked,GimpContext * context)
name|gimp_symmetry_editor_set_context
parameter_list|(
name|GimpDocked
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|gimp_symmetry_editor_new (GimpImage * image,GimpMenuFactory * menu_factory)
