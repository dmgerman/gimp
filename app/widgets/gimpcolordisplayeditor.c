...
name|GtkWidget
modifier|*
DECL|function|gimp_color_display_editor_new (GimpColorDisplayStack * stack,GimpColorConfig * config,GimpColorManaged * managed)
