...
argument_list|)
expr_stmt|;
comment|/*  connect to "remove" before the container view does so we can get    *  the stack child stored in its model    */
...
name|FALSE
decl_stmt|;
name|gtk_stack_set_visible_child
argument_list|(
name|GTK_STACK
argument_list|(
name|private
