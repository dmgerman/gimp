...
begin_comment
comment|/*  temp hack as replacement for GdkSegment  */
end_comment

begin_typedef
DECL|typedef|GimpSegment
typedef|typedef
name|struct
name|_GimpSegment
name|GimpSegment
