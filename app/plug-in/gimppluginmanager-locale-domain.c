...
begin_function
name|void
DECL|function|gimp_plug_in_manager_add_locale_domain (GimpPlugInManager * manager,GFile * file,const gchar * domain_name,const gchar * domain_path)
...
name|gchar
modifier|*
DECL|function|gimp_plug_in_manager_get_locale_domain (GimpPlugInManager * manager,GFile * file,const gchar ** domain_path)
