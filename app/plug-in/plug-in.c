...
begin_function
name|gboolean
DECL|function|plug_in_open (PlugIn * plug_in,GimpPlugInCallMode call_mode,gboolean synchronous)
name|plug_in_open
parameter_list|(
name|PlugIn
modifier|*
...
specifier|static
name|gboolean
DECL|function|plug_in_write (GIOChannel * channel,const guint8 * buf,gulong count,gpointer data)
name|plug_in_write
parameter_list|(
name|GIOChannel
modifier|*
...
specifier|static
name|gboolean
DECL|function|plug_in_flush (GIOChannel * channel,gpointer data)
name|plug_in_flush
parameter_list|(
name|GIOChannel
modifier|*
