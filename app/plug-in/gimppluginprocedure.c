...
name|gchar
modifier|*
name|gimp_plug_in_procedure_get_description
parameter_list|(
name|GimpViewable
modifier|*
name|viewable
...
name|gchar
modifier|*
name|gimp_plug_in_procedure_get_menu_label
parameter_list|(
name|GimpProcedure
modifier|*
name|procedure
...
name|gchar
modifier|*
DECL|function|gimp_plug_in_procedure_get_description (GimpViewable * viewable,gchar ** tooltip)
name|gimp_plug_in_procedure_get_description
parameter_list|(
name|GimpViewable
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_plug_in_procedure_get_label (GimpProcedure * procedure)
name|gimp_plug_in_procedure_get_label
parameter_list|(
name|GimpProcedure
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_plug_in_procedure_get_menu_label (GimpProcedure * procedure)
name|gimp_plug_in_procedure_get_menu_label
parameter_list|(
name|GimpProcedure
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_plug_in_procedure_get_blurb (GimpProcedure * procedure)
name|gimp_plug_in_procedure_get_blurb
parameter_list|(
name|GimpProcedure
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_plug_in_procedure_get_help_id (GimpProcedure * procedure)
name|gimp_plug_in_procedure_get_help_id
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_plug_in_procedure_get_sensitive (GimpProcedure * procedure,GimpObject * object,const gchar ** tooltip)
name|gimp_plug_in_procedure_get_sensitive
parameter_list|(
name|GimpProcedure
modifier|*
...
begin_function
name|void
DECL|function|gimp_plug_in_procedure_set_help_id (GimpPlugInProcedure * proc,const gchar * help_id)
...
begin_function
name|gboolean
DECL|function|gimp_plug_in_procedure_set_menu_label (GimpPlugInProcedure * proc,const gchar * menu_label,GError ** error)
...
name|required
operator|=
literal|"GimpRunMode, GimpImage, (GimpLayer | GimpDrawable)"
expr_stmt|;
goto|goto
name|failure
goto|;
...
name|required
operator|=
literal|"GimpRunMode, GimpImage, (GimpChannel | GimpDrawable)"
expr_stmt|;
goto|goto
name|failure
goto|;
...
name|required
operator|=
literal|"GimpRunMode, GimpImage, GimpVectors"
expr_stmt|;
goto|goto
name|failure
goto|;
...
name|required
operator|=
literal|"GimpRunMode, String, String"
expr_stmt|;
goto|goto
name|failure
goto|;
...
name|required
operator|=
literal|"GimpRunMode, GimpImage, GimpDrawable, String, String"
expr_stmt|;
goto|goto
name|failure
goto|;
...
begin_function
name|gboolean
DECL|function|gimp_plug_in_procedure_set_icon (GimpPlugInProcedure * proc,GimpIconType icon_type,const guint8 * icon_data,gint icon_data_length,GError ** error)
...
begin_function
name|gboolean
DECL|function|gimp_plug_in_procedure_take_icon (GimpPlugInProcedure * proc,GimpIconType icon_type,guint8 * icon_data,gint icon_data_length,GError ** error)
name|gimp_plug_in_procedure_take_icon
parameter_list|(
name|GimpPlugInProcedure
modifier|*
...
name|loader
operator|=
name|gdk_pixbuf_loader_new
argument_list|()
expr_stmt|;
if|if
condition|(
operator|!
name|gdk_pixbuf_loader_write
argument_list|(
name|loader
argument_list|,
name|proc
...
name|_
argument_list|(
literal|"Grayscale without alpha"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|_
argument_list|(
literal|"This plug-in only works on the "
literal|"following layer types:"
argument_list|)
argument_list|)
expr_stmt|;
name|g_string_append
...
begin_function
name|void
DECL|function|gimp_plug_in_procedure_set_mime_types (GimpPlugInProcedure * proc,const gchar * mime_types)
