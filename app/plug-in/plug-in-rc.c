...
specifier|static
name|GTokenType
name|plug_in_extra_deserialize
parameter_list|(
name|GScanner
modifier|*
name|scanner
...
begin_comment
comment|/*  Handle extra info such as mime-type and thumb-loader.  */
end_comment

begin_function
specifier|static
name|GTokenType
DECL|function|plug_in_extra_deserialize (GScanner * scanner,PlugInProcDef * proc_def)
name|plug_in_extra_deserialize
parameter_list|(
name|GScanner
modifier|*
