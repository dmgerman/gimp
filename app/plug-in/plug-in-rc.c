...
begin_define
DECL|macro|PLUG_IN_RC_FILE_VERSION
define|#
directive|define
...
name|SAVE_PROC
block|,
DECL|enumerator|EXTENSIONS
name|EXTENSIONS
block|,
DECL|enumerator|PREFIXES
name|PREFIXES
block|,
DECL|enumerator|MAGICS
name|MAGICS
block|,
DECL|enumerator|PRIORITY
name|PRIORITY
block|,
...
name|scanner
argument_list|,
literal|"plug-in filename is empty"
argument_list|)
expr_stmt|;
return|return
name|G_TOKEN_ERROR
...
name|scanner
argument_list|,
literal|"procedure name is empty"
argument_list|)
expr_stmt|;
return|return
name|G_TOKEN_ERROR
...
name|scanner
argument_list|,
literal|"procedure type %d is out of range"
argument_list|,
name|proc_type
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|plug_in_rc_write_proc_arg (GimpConfigWriter * writer,GParamSpec * pspec)
name|plug_in_rc_write_proc_arg
parameter_list|(
...
literal|"querying the installed plug-ins."
argument_list|,
name|error
argument_list|)
expr_stmt|;
