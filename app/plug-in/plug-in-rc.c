...
literal|"This file can safely be removed and will "
literal|"be automatically regenerated by querying "
literal|"the installed plugins."
argument_list|,
name|error
argument_list|)
expr_stmt|;
