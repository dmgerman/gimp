...
argument_list|)
expr_stmt|;
comment|/* if possible, replace the beginning of path with a literal            * "${gimp_plug_in_dir}", to help things like app bundles            * which are mounted at random temo locations.            */
if|if
condition|(
