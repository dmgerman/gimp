...
begin_comment
comment|/*    *  All functions return G_TOKEN_LEFT_PAREN on success,  *  or the GTokenType they would have expected but didn't get.  */
end_comment
...
specifier|inline
name|gboolean
DECL|function|parse_token (GScanner * scanner,GTokenType token)
name|parse_token
parameter_list|(
name|GScanner
modifier|*
...
specifier|inline
name|gboolean
DECL|function|parse_string_no_validate (GScanner * scanner,gchar ** dest)
name|parse_string_no_validate
parameter_list|(
name|GScanner
modifier|*
...
begin_function
name|gboolean
DECL|function|plug_in_rc_write (GSList * plug_in_defs,const gchar * filename)
