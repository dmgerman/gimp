...
block|{
comment|/*  the plug-in is run asynchronously, so display its error        *  messages here because nobody else will do it        */
...
name|type_name
argument_list|,
literal|"GimpParamIntFloatArray"
argument_list|)
operator|||
operator|!
name|strcmp
...
name|type_name
argument_list|,
literal|"GimpParamIntStringArray"
argument_list|)
operator|||
operator|!
name|strcmp
...
name|type_name
argument_list|,
literal|"GimpParamIntColorArray"
argument_list|)
operator|)
operator|&&
name|strcmp
...
argument_list|,
literal|"Plug-in \"%s\"\n(%s)\n\n"
literal|"attempted to uninstall procedure \"%s\" with a "
literal|"non-canonical name."
argument_list|,
name|gimp_object_get_name
argument_list|(
