...
specifier|static
name|void
name|plug_in_disconnect_cancel
parameter_list|(
name|PlugIn
modifier|*
name|plug_in
...
name|Argument
modifier|*
name|message_handler_get_invoker
parameter_list|(
name|Argument
modifier|*
name|args
...
begin_decl_stmt
DECL|variable|current_writefd
specifier|static
name|int
name|current_writefd
init|=
literal|0
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|progress_init_args
specifier|static
name|ProcArg
name|progress_init_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|progress_update_args
specifier|static
name|ProcArg
name|progress_update_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|message_handler_get_out_args
specifier|static
name|ProcArg
name|message_handler_get_out_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|message_handler_get_proc
specifier|static
name|ProcRecord
name|message_handler_get_proc
init|=
block|{
...
begin_decl_stmt
DECL|variable|message_handler_set_args
specifier|static
name|ProcArg
name|message_handler_set_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|message_handler_set_proc
specifier|static
name|ProcRecord
...
name|nth
decl_stmt|;
comment|/* initialize the progress init and update procedure db calls. */
...
specifier|static
name|void
DECL|function|plug_in_recv_message (gpointer data,gint id,GdkInputCondition cond)
name|plug_in_recv_message
parameter_list|(
name|gpointer
name|data
...
specifier|static
name|void
DECL|function|plug_in_handle_quit ()
name|plug_in_handle_quit
parameter_list|()
block|{
name|plug_in_close
...
specifier|static
name|int
DECL|function|plug_in_write (int fd,guint8 * buf,gulong count)
name|plug_in_write
parameter_list|(
name|int
name|fd
...
specifier|static
name|int
DECL|function|plug_in_flush (int fd)
name|plug_in_flush
parameter_list|(
name|int
name|fd
...
specifier|static
name|void
DECL|function|plug_in_add_to_db ()
name|plug_in_add_to_db
parameter_list|()
block|{
name|PlugInProcDef
...
specifier|static
name|void
DECL|function|plug_in_make_menu ()
name|plug_in_make_menu
parameter_list|()
block|{
name|GtkMenuEntry
...
specifier|static
name|void
DECL|function|plug_in_proc_def_insert (PlugInProcDef * proc_def)
name|plug_in_proc_def_insert
parameter_list|(
name|PlugInProcDef
modifier|*
...
condition|)
block|{
comment|/*	    parasite_free ((Parasite *)(args[i].value.pdb_pointer)); 	    args[i].value.pdb_pointer = NULL; */
block|}
break|break;
case|case
name|PDB_STATUS
...
specifier|static
name|void
DECL|function|plug_in_disconnect_cancel (PlugIn * plug_in)
name|plug_in_disconnect_cancel
parameter_list|(
name|PlugIn
modifier|*
...
name|Argument
modifier|*
DECL|function|message_handler_get_invoker (Argument * args)
name|message_handler_get_invoker
parameter_list|(
name|Argument
modifier|*
...
name|Argument
modifier|*
DECL|function|message_handler_set_invoker (Argument * args)
name|message_handler_set_invoker
parameter_list|(
name|Argument
modifier|*
