...
name|GimpArgument
modifier|*
DECL|function|plug_in_params_to_args (GimpArgumentSpec * arg_specs,gint n_arg_specs,GPParam * params,gint n_params,gboolean return_values,gboolean full_copy)
