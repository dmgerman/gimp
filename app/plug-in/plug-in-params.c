...
begin_comment
comment|/* The number keeps getting repeated here because in is required   * by the PDB interface for *ARRAY types.  */
end_comment

begin_decl_stmt
DECL|variable|plugins_query_out_args
specifier|static
name|ProcArg
name|plugins_query_out_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|plugins_query_in_args
specifier|static
name|ProcArg
name|plugins_query_in_args
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|plugin_query_proc
name|ProcRecord
name|plugin_query_proc
init|=
block|{
...
argument_list|)
expr_stmt|;
comment|/* initialize the temp name PDB interafce */
name|procedural_db_register
argument_list|(
operator|&
name|plugin_temp_PDB_name_proc
argument_list|)
expr_stmt|;
comment|/* initialize the plugin browser */
name|procedural_db_register
argument_list|(
operator|&
name|plugin_query_proc
...
name|NULL
expr_stmt|;
comment|/* count number of plugin entries */
comment|/* then allocate 4 arrays of correct size where we can store the    * strings.    */
name|tmp
operator|=
name|proc_defs
expr_stmt|;
