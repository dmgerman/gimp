...
specifier|static
name|guint
DECL|function|gimp_environ_table_case_insensitive_hash (gconstpointer v)
name|gimp_environ_table_case_insensitive_hash
parameter_list|(
name|gconstpointer
name|v
parameter_list|)
...
specifier|static
name|gboolean
DECL|function|gimp_environ_table_case_insensitive_equal (gconstpointer v1,gconstpointer v2)
name|gimp_environ_table_case_insensitive_equal
parameter_list|(
name|gconstpointer
name|v1
parameter_list|,
