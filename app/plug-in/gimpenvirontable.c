...
begin_function
name|void
DECL|function|gimp_environ_table_add (GimpEnvironTable * environ_table,const gchar * name,const gchar * value)
...
specifier|static
name|void
DECL|function|gimp_environ_table_populate_one (const gchar * name,const gchar * value,GPtrArray * env_array)
name|gimp_environ_table_populate_one
parameter_list|(
specifier|const
name|gchar
