...
name|GimpEnvironTable
modifier|*
DECL|function|gimp_environ_table_new (gboolean verbose)
...
specifier|static
name|guint
DECL|function|gimp_environ_table_str_hash (gconstpointer v)
name|gimp_environ_table_str_hash
parameter_list|(
name|gconstpointer
name|v
parameter_list|)
...
specifier|static
name|gboolean
DECL|function|gimp_environ_table_str_equal (gconstpointer v1,gconstpointer v2)
name|gimp_environ_table_str_equal
parameter_list|(
name|gconstpointer
name|v1
parameter_list|,
...
begin_function
name|void
DECL|function|gimp_environ_table_load (GimpEnvironTable * environ_table,GList * path)
...
specifier|static
name|void
DECL|function|gimp_environ_table_load_env_file (GimpEnvironTable * environ_table,GFile * file)
name|gimp_environ_table_load_env_file
parameter_list|(
name|GimpEnvironTable
modifier|*
...
condition|)
block|{
comment|/* g_listenv() only returns the names of environment variables        * that are correctly specified (name=value) in the environ        * array (Unix) or the process environment string table (Win32).        */
if|if
condition|(
name|gimp_environ_table_pass_through
argument_list|(
