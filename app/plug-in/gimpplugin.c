...
operator|&&
name|defined
name|WIN32_32BIT_DLL_FOLDER
end_if

begin_function_decl
specifier|static
name|void
name|gimp_plug_in_set_dll_directory
parameter_list|(
specifier|const
name|gchar
modifier|*
...
name|GimpPlugIn
modifier|*
DECL|function|gimp_plug_in_new (GimpPlugInManager * manager,GimpContext * context,GimpProgress * progress,GimpPlugInProcedure * procedure,GFile * file)
...
directive|endif
comment|/* Prevent the plug-in from inheriting our end of the pipes */
...
expr_stmt|;
block|}
comment|/* pop the frame here, because normally this only happens in        * gimp_plug_in_handle_temp_proc_return(), which can't        * be called after plug_in_close()        */
...
specifier|static
name|void
DECL|function|gimp_plug_in_set_dll_directory (const gchar * path)
name|gimp_plug_in_set_dll_directory
parameter_list|(
specifier|const
name|gchar
...
begin_function
name|void
DECL|function|gimp_plug_in_enable_precision (GimpPlugIn * plug_in)
...
begin_function
name|gboolean
DECL|function|gimp_plug_in_precision_enabled (GimpPlugIn * plug_in)
