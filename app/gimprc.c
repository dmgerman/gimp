...
specifier|static
name|gint
DECL|function|parse_thumbnail_size (gpointer val1p,gpointer val2p)
name|parse_thumbnail_size
parameter_list|(
name|gpointer
name|val1p
...
name|gchar
modifier|*
DECL|function|thumbnail_size_to_str (gpointer val1p,gpointer val2p)
name|thumbnail_size_to_str
parameter_list|(
name|gpointer
name|val1p
