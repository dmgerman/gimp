...
block|,
DECL|enumerator|TT_XNEWSESSIONINFO
name|TT_XNEWSESSIONINFO
block|,
...
specifier|static
name|gint
DECL|function|parse_new_session_info (gpointer val1p,gpointer val2p)
name|parse_new_session_info
parameter_list|(
name|gpointer
name|val1p
