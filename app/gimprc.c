...
name|TT_XDEVICE
block|,
DECL|enumerator|TT_XSESSIONGEOM
name|TT_XSESSIONGEOM
...
begin_decl_stmt
DECL|variable|session_geometries
specifier|static
name|SessionGeometry
modifier|*
name|session_geometries
index|[]
init|=
block|{
operator|&
...
begin_decl_stmt
DECL|variable|nsession_geometries
specifier|static
name|int
name|nsession_geometries
init|=
sizeof|sizeof
argument_list|(
name|session_geometries
...
specifier|static
name|int
DECL|function|parse_session_geometry (gpointer val1p,gpointer val2p)
name|parse_session_geometry
parameter_list|(
name|gpointer
name|val1p
...
name|ERROR
return|;
comment|/* Parse options for session geometry */
while|while
condition|(
name|peek_next_token
argument_list|()
