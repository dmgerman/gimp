...
begin_comment
comment|/*static void file_prefs_float_adjustment_callback (GtkAdjustment *, gpointer);*/
end_comment
...
begin_comment
comment|/*  commented out because it's not used  static void file_prefs_float_adjustment_callback (GtkAdjustment *adj, 				      gpointer       data) {   float *val;    val = data;   *val = (float) adj->value; } */
end_comment
...
name|GtkWidget
modifier|*
DECL|function|gimp_dialog_new (const gchar * title,const gchar * wmclass_name,GtkWindowPosition position,gint allow_shrink,gint allow_grow,gint auto_shrink,gchar * label,GtkSignalFunc callback,gpointer data,gboolean default_action,gboolean connect_delete,...)
...
name|GtkWidget
modifier|*
DECL|function|gimp_option_menu_new (GtkSignalFunc menu_item_callback,gpointer initial,gchar * label,gpointer data,gpointer set_data,...)
...
name|GtkWidget
modifier|*
DECL|function|gimp_radio_group_new (GtkSignalFunc radio_button_callback,gpointer initial,gchar * label,gpointer data,gpointer set_data,...)
