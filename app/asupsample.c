...
specifier|static
name|gulong
DECL|function|render_sub_pixel (gint max_depth,gint depth,sample_t ** block,gint x,gint y,gint x1,gint y1,gint x3,gint y3,double threshold,gint sub_pixel_size,render_func_t render_func,GimpRGB * color,gpointer render_data)
name|render_sub_pixel
parameter_list|(
name|gint
name|max_depth
