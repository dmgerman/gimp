...
typedef|typedef
struct|struct
DECL|struct|__anon2924d88e0108
block|{
DECL|member|bgdist
name|gfloat
name|bgdist
...
typedef|typedef
struct|struct
DECL|struct|__anon2924d88e0208
block|{
DECL|member|l
name|gfloat
name|l
...
specifier|static
name|void
DECL|function|stageone (lab * points,gint left,gint right,gint depth,gint * clusters,const gfloat * limits)
name|stageone
parameter_list|(
name|lab
modifier|*
...
specifier|static
name|void
DECL|function|stagetwo (lab * points,gint left,gint right,gint depth,GSList ** clusters,const gfloat * limits,gfloat threshold)
name|stagetwo
parameter_list|(
name|lab
modifier|*
...
name|lab
modifier|*
DECL|function|create_signature (lab * input,gint length,gint * returnlength,const gfloat * limits)
...
begin_comment
comment|/* Do not change these defines! They contain some magic!  * Must all be non-zero and FINAL must be 0xFF!  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* FIXME: Do not create HashTable in here, do it globally */
name|cr
operator|=
...
argument_list|)
expr_stmt|;
comment|/* FIXME: Do not free memory in here - do it globally */
...
begin_comment
comment|/**  * siox_drb:  * @pixels:       the rgb tiles to work on (read)  * @colormap:     colormap in case @pixels are indexed, %NULL otherwise  * @mask:         the alpha tiles to work on (write)  * @x:            horizontal offset into the mask  * @y:            vertical offset into the mask  * @pixtoclassresult: the hashtable as generated by siox_foreground_extract  * @brushmode:    at this time either SIOX_DRB_ADD or SIOX_DRB_SUBTRACT  * @brushradius:  the radius of the brush  * @threshold:    a threshold to be defined by the user.  *                Range for SIOX_DRB_ADD: ]0..1] default: 1.0,  *                range for for SIOX_DRB_SUBTRACT: [0..1[, default: 0.0  *  * drb - detail refinement brush, a brush mask for subpixel classification.  *  * FIXME: Now it is assumed that the brush is a square. Should be able  * to be whatever GIMP offers...  TODO: This is still an experimental  * method. There are more tests needed to evaluate performance of  * this!  */
end_comment

begin_function
name|void
DECL|function|siox_drb (TileManager * pixels,const guchar * colormap,TileManager * mask,gint x,gint y,GHashTable * pixtoclassresult,gint brushmode,gint brushradius,gfloat threshold)
name|siox_drb
parameter_list|(
name|TileManager
modifier|*
