...
specifier|static
name|void
DECL|function|stageone (lab * points,gint dims,gint depth,ArrayList * clusters,const gfloat limits[SIOX_DIMS],gint length)
name|stageone
parameter_list|(
name|lab
modifier|*
...
specifier|static
name|void
DECL|function|stagetwo (lab * points,gint dims,gint depth,ArrayList * clusters,const gfloat limits[SIOX_DIMS],gint length,gint total,gfloat threshold)
name|stagetwo
parameter_list|(
name|lab
modifier|*
...
name|lab
modifier|*
DECL|function|create_signature (lab * input,gint length,const gfloat limits[SIOX_DIMS],gint * returnlength)
