...
typedef|typedef
struct|struct
DECL|struct|__anon2773edbf0108
block|{
DECL|member|l
name|gfloat
name|l
...
specifier|static
name|void
DECL|function|process_neighbours (GQueue * q,gint pos_x,gint pos_y,TileManager * mask,guchar maskval,gint x,gint y,gint width,gint height)
...
specifier|static
name|gint
DECL|function|process_queue (GQueue * q,TileManager * mask,guchar maskval,gint x,gint y,gint width,gint height)
name|process_queue
parameter_list|(
name|GQueue
modifier|*
...
comment|/* mark startpixel as visited */
name|read_pixel_data_1
argument_list|(
name|mask
argument_list|,
