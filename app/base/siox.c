...
typedef|typedef
struct|struct
DECL|struct|__anon2bf5a21f0108
block|{
DECL|member|l
name|gfloat
name|l
...
typedef|typedef
struct|struct
DECL|struct|__anon2bf5a21f0208
block|{
DECL|member|bgdist
name|gfloat
name|bgdist
...
name|lab
modifier|*
DECL|function|create_signature (lab * input,gint length,gint * returnlength,const gfloat * limits,const gint dims)
...
specifier|static
name|void
DECL|function|find_max_blob (TileManager * mask,gint x,gint y,gint width,gint height,const gint sizeFactorToKeep)
name|find_max_blob
parameter_list|(
name|TileManager
modifier|*
