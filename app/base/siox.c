...
typedef|typedef
struct|struct
DECL|struct|__anon28fa7b230108
block|{
DECL|member|bgdist
name|gfloat
name|bgdist
...
typedef|typedef
struct|struct
DECL|struct|__anon28fa7b230208
block|{
DECL|member|l
name|gfloat
name|l
...
specifier|static
name|void
DECL|function|stageone (lab * points,gint left,gint right,gint depth,GSList ** clusters,const gfloat * limits)
name|stageone
parameter_list|(
name|lab
modifier|*
