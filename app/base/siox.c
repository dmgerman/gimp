...
name|val
decl_stmt|;
comment|/* this mask is used to flag a pixel as visited in the first pass */
specifier|const
name|guchar
name|visited
init|=
literal|0x40
decl_stmt|;
comment|/* this mask is used to mark a pixel in the second pass           */
specifier|const
name|guchar
name|contained
init|=
...
block|}
block|}
comment|/* now push maxblob coords to the queue and find maxblob again,    * so that it can be set as the resulting mask    */
