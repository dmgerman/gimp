...
begin_comment
comment|/* This function simply renders a checkerboard with the given    parameters into a newly allocated tempbuf */
end_comment
...
name|g_error
argument_list|(
literal|"invalid check_type argument to temp_buf_check: %d"
argument_list|,
name|check_type
argument_list|)
expr_stmt|;
...
name|g_error
argument_list|(
literal|"invalid check_size argument to temp_buf_check: %d"
argument_list|,
name|check_size
argument_list|)
expr_stmt|;
