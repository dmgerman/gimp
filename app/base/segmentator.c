...
name|lab
modifier|*
DECL|function|list_to_array (ArrayList * list,int * returnlength)
name|list_to_array
parameter_list|(
name|ArrayList
modifier|*
...
specifier|static
name|void
DECL|function|calcLAB (const guchar * src,lab * pixel)
name|calcLAB
parameter_list|(
specifier|const
name|guchar
...
specifier|static
name|void
DECL|function|normalize_mask (TileManager * mask,gint x,gint y,gint width,gint height)
name|normalize_mask
parameter_list|(
name|TileManager
modifier|*
...
name|g_printerr
argument_list|(
literal|"max = %d (need to actually implement normalize ?)\n"
argument_list|,
name|max
argument_list|)
expr_stmt|;
comment|/*  TODO (or not TODO)  */
block|}
end_function
...
specifier|static
name|gfloat
DECL|function|getclustersize (const float limits[DIMS])
name|getclustersize
parameter_list|(
specifier|const
name|float
...
begin_function
name|void
DECL|function|foreground_extract (TileManager * pixels,TileManager * mask,gfloat limits[DIMS],gint smoothness)
...
begin_comment
comment|/************ Unused functions, for reference ***************/
end_comment
