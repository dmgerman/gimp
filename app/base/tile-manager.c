...
begin_function
name|gint
DECL|function|tile_manager_tiles_per_col (const TileManager * tm)
...
begin_function
name|gint
DECL|function|tile_manager_tiles_per_row (const TileManager * tm)
...
name|TileManager
modifier|*
DECL|function|tile_manager_get_level_below (const TileManager * tm)
...
begin_function
name|void
DECL|function|tile_manager_set_level_below (TileManager * tm,TileManager * level_below)
