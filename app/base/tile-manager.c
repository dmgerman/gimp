...
begin_function
name|void
DECL|function|tile_manager_get_async (TileManager * tm,gint xpixel,gint ypixel)
...
begin_function
name|void
DECL|function|write_pixel_data (TileManager * tm,gint x1,gint y1,gint x2,gint y2,guchar * buffer,guint stride)
name|write_pixel_data
parameter_list|(
name|TileManager
modifier|*
...
begin_function
name|void
DECL|function|write_pixel_data_1 (TileManager * tm,gint x,gint y,guchar * buffer)
