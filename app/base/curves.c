...
begin_comment
comment|/*  the curves file dialog  */
end_comment
...
specifier|static
name|void
DECL|function|gimp_curves_tool_init (GimpCurvesTool * bc_tool)
name|gimp_curves_tool_init
parameter_list|(
name|GimpCurvesTool
modifier|*
...
specifier|static
name|void
DECL|function|gimp_curves_tool_control (GimpTool * tool,GimpToolAction action,GimpDisplay * gdisp)
name|gimp_curves_tool_control
parameter_list|(
name|GimpTool
modifier|*
...
specifier|static
name|void
DECL|function|curve_print_loc (CurvesDialog * cd,gint xpos,gint ypos)
...
specifier|static
name|void
DECL|function|curves_update (CurvesDialog * cd,gint update)
name|curves_update
parameter_list|(
name|CurvesDialog
modifier|*
...
specifier|static
name|gboolean
DECL|function|curves_set_sensitive_callback (gpointer item_data,CurvesDialog * cd)
name|curves_set_sensitive_callback
parameter_list|(
name|gpointer
name|item_data
...
specifier|static
name|void
DECL|function|curves_channel_reset (int i)
name|curves_channel_reset
parameter_list|(
name|int
name|i
...
specifier|static
name|void
DECL|function|curves_preview_update (GtkWidget * widget,gpointer data)
name|curves_preview_update
parameter_list|(
name|GtkWidget
modifier|*
...
block|}
block|}
comment|/* this is ugly, but works ... */
name|current_channel
operator|=
name|curves_dialog
operator|->
