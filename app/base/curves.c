...
begin_function
name|void
DECL|function|gimp_curves_tool_register (void)
...
specifier|static
name|void
DECL|function|gimp_curves_tool_destroy (GtkObject * object)
name|gimp_curves_tool_destroy
parameter_list|(
name|GtkObject
modifier|*
...
condition|)
block|{
comment|/* Calc max extents */
name|gdk_string_extents
argument_list|(
name|cd
operator|->
name|graph
