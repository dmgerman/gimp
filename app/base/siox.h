...
begin_define
DECL|macro|SIOX_REFINEMENT_TYPE_NO_CHANGE
define|#
directive|define
name|SIOX_REFINEMENT_TYPE_NO_CHANGE
value|0
end_define

begin_define
DECL|macro|SIOX_REFINEMENT_TYPE_ADD_FOREGROUND
define|#
directive|define
name|SIOX_REFINEMENT_TYPE_ADD_FOREGROUND
value|(1<< 0)
end_define

begin_define
DECL|macro|SIOX_REFINEMENT_TYPE_ADD_BACKGROUND
define|#
directive|define
name|SIOX_REFINEMENT_TYPE_ADD_BACKGROUND
value|(1<< 1)
end_define

begin_define
DECL|macro|SIOX_REFINEMENT_TYPE_CHANGE_SENSITIVITY
define|#
directive|define
name|SIOX_REFINEMENT_TYPE_CHANGE_SENSITIVITY
value|(1<< 2)
end_define

begin_define
DECL|macro|SIOX_REFINEMENT_TYPE_CHANGE_SMOOTHNESS
define|#
directive|define
name|SIOX_REFINEMENT_TYPE_CHANGE_SMOOTHNESS
value|(1<< 3)
end_define

begin_define
DECL|macro|SIOX_REFINEMENT_TYPE_CHANGE_MULTIBLOB
define|#
directive|define
name|SIOX_REFINEMENT_TYPE_CHANGE_MULTIBLOB
value|(1<< 4)
end_define

begin_define
DECL|macro|SIOX_REFINEMENT_TYPE_RECALCULATE
define|#
directive|define
name|SIOX_REFINEMENT_TYPE_RECALCULATE
value|0xFF
end_define
