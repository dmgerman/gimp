...
specifier|static
name|gfloat
DECL|function|brightness_contrast_lut_func (B_C_struct * data,gint nchannels,gint channel,gfloat value)
...
specifier|static
name|gfloat
DECL|function|levels_lut_func (levels_struct * data,gint n_channels,gint channel,gfloat value)
...
name|GimpLut
modifier|*
DECL|function|levels_lut_new (gdouble * gamma,gint * low_input,gint * high_input,gint * low_output,gint * high_output,gint n_channels)
name|levels_lut_new
parameter_list|(
name|gdouble
modifier|*
...
begin_function
name|void
DECL|function|levels_lut_setup (GimpLut * lut,gdouble * gamma,gint * low_input,gint * high_input,gint * low_output,gint * high_output,gint n_channels)
name|levels_lut_setup
parameter_list|(
name|GimpLut
modifier|*
...
name|GimpLut
modifier|*
DECL|function|eq_histogram_lut_new (GimpHistogram * histogram,gint n_channels)
...
begin_function
name|void
DECL|function|eq_histogram_lut_setup (GimpLut * lut,GimpHistogram * hist,gint n_channels)
name|eq_histogram_lut_setup
parameter_list|(
name|GimpLut
modifier|*
