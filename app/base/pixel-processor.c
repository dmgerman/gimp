...
name|PixelProcessor
modifier|*
DECL|function|pixel_regions_process_parallel_valist (PixelProcessorFunc f,gpointer data,gint num_regions,va_list ap)
...
begin_function
name|void
DECL|function|pixel_regions_process_parallel (PixelProcessorFunc f,gpointer data,gint num_regions,...)
...
specifier|static
name|void
DECL|function|pixel_processor_free (PixelProcessor * processor)
name|pixel_processor_free
parameter_list|(
name|PixelProcessor
modifier|*
