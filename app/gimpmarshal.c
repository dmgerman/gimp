...
begin_typedef
DECL|typedef|GimpSignal_POINTER__NONE
typedef|typedef
name|gpointer
function_decl|(
modifier|*
name|GimpSignal_POINTER__NONE
function_decl|)
parameter_list|(
name|GtkObject
modifier|*
...
begin_function
name|void
DECL|function|gimp_marshal_POINTER__NONE (GtkObject * object,GtkSignalFunc func,gpointer func_data,GtkArg * args)
