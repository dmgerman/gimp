...
typedef|typedef
struct|struct
DECL|struct|__anon2894d5cd0308
block|{
DECL|member|shell
name|GtkWidget
modifier|*
...
begin_function
name|void
DECL|function|gradient_get_color_at (gradient_t * gradient,gdouble pos,GimpRGB * color)
