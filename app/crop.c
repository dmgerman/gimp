...
expr_stmt|;
block|}
comment|/* Taken from the autocrop plug-in written by Tim Newsome */
if|if
condition|(
operator|!
name|crop_guess_bgcolor
...
specifier|static
name|int
DECL|function|crop_guess_bgcolor (GtkObject * get_color_obj,GetColorFunc get_color_func,int width,int height,int bytes,guchar * color)
name|crop_guess_bgcolor
parameter_list|(
name|GtkObject
modifier|*
