...
argument_list|)
expr_stmt|;
comment|/*  If the text size is specified in points, it's size will be scaled    *  correctly according to the image's resolution.    *  FIXME: this currently can't be activated for the PDB, as the text has    *         to be rendered in the size "text_get_extents" returns.    *  TODO: add an image parameter to "text_get_extents"    */
name|text_set_resolution
argument_list|(
operator|&
name|fontname
...
specifier|static
name|void
DECL|function|text_set_resolution (char ** fontname,int xres,int yres)
name|text_set_resolution
parameter_list|(
name|char
modifier|*
