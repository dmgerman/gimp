...
begin_decl_stmt
DECL|variable|gimp_image_table
specifier|static
name|GHashTable
modifier|*
...
name|GimpImage
modifier|*
DECL|function|gimp_image_get_by_ID (gint image_id)
...
begin_function
name|void
DECL|function|gimp_image_size_changed (GimpImage * gimage)
name|gimp_image_size_changed
parameter_list|(
name|GimpImage
modifier|*
