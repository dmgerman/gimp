...
name|GtkWidget
modifier|*
DECL|function|paint_mode_menu_new (MenuItemCallback callback,gpointer data,LayerModeEffects initial)
name|paint_mode_menu_new
parameter_list|(
...
begin_function
name|void
DECL|function|paint_mode_menu_set_paint_mode (GtkOptionMenu * paint_mode_menu,LayerModeEffects paint_mode)
name|paint_mode_menu_set_paint_mode
parameter_list|(
name|GtkOptionMenu
modifier|*
