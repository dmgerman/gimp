...
begin_function
name|void
DECL|function|gimp_color_display_foreach (GimpCDFunc func,gpointer user_data)
...
specifier|static
name|void
DECL|function|color_display_foreach (gpointer key,gpointer value,gpointer user_data)
name|color_display_foreach
parameter_list|(
name|gpointer
name|key
...
begin_function
name|void
DECL|function|gdisplay_color_detach (GDisplay * gdisp,const char * name)
