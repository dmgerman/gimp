...
argument_list|)
expr_stmt|;
comment|/* Create the global data lists */
name|global_brush_list
operator|=
name|GIMP_CONTAINER
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*   default_context->brush_name    = g_strdup (default_brush);   default_context->pattern_name  = g_strdup (default_pattern);   default_context->gradient_name = g_strdup (default_gradient);   default_context->palette_name  = g_strdup (default_palette);   */
