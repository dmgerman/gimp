...
specifier|static
name|void
DECL|function|make_seg (gint x1,gint y1,gint x2,gint y2,gboolean open)
name|make_seg
parameter_list|(
name|gint
name|x1
...
specifier|static
name|void
DECL|function|process_horiz_seg (gint x1,gint y1,gint x2,gint y2,gboolean open)
name|process_horiz_seg
parameter_list|(
name|gint
name|x1
...
specifier|static
name|void
DECL|function|make_horiz_segs (gint start,gint end,gint scanline,gint empty[],gint num_empty,gint top)
name|make_horiz_segs
parameter_list|(
name|gint
name|start
