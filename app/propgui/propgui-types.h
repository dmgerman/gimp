...
block|,
DECL|enumerator|GIMP_CONTROLLER_TYPE_TRANSFORM_GRID
...
typedef|typedef
struct|struct
DECL|struct|__anon2c34a89d0208
block|{
DECL|member|value
name|gdouble
name|value
...
begin_typedef
DECL|typedef|GimpPickerCallback
typedef|typedef
name|void
function_decl|(
modifier|*
...
begin_typedef
DECL|typedef|GimpControllerTransformGridCallback
typedef|typedef
name|void
function_decl|(
modifier|*
