...
block|,
DECL|enumerator|GIMP_CONTROLLER_TYPE_TRANSFORM_GRIDS
name|GIMP_CONTROLLER_TYPE_TRANSFORM_GRIDS
block|,
DECL|enumerator|GIMP_CONTROLLER_TYPE_GYROSCOPE
...
typedef|typedef
struct|struct
DECL|struct|__anon2c19d94d0208
block|{
DECL|member|value
name|gdouble
name|value
...
begin_typedef
DECL|typedef|GimpControllerTransformGridsCallback
typedef|typedef
name|void
function_decl|(
modifier|*
...
begin_typedef
DECL|typedef|GimpControllerGyroscopeCallback
typedef|typedef
name|void
function_decl|(
modifier|*
