...
include|#
directive|include
file|"gimppropgui-motion-blur-zoom.h"
end_include
...
name|GtkWidget
modifier|*
DECL|function|_gimp_prop_gui_new_motion_blur_zoom (GObject * config,GParamSpec ** param_specs,guint n_param_specs,GeglRectangle * area,GimpContext * context,GimpCreatePickerFunc create_picker_func,GimpCreateControllerFunc create_controller_func,gpointer creator)
