...
specifier|static
name|void
DECL|function|create_levels_scale (GObject * config,const gchar * property_name,const gchar * left,const gchar * right,GtkWidget * grid,gint col)
...
argument_list|)
expr_stmt|;
comment|/*  The grid containing sliders  */
name|grid
operator|=
name|gtk_grid_new
argument_list|()
