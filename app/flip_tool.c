...
name|type_d
decl_stmt|;
DECL|member|type_toggle
name|ToolOptionsRadioButtons
name|type_toggle
index|[
literal|3
index|]
...
specifier|static
name|void
DECL|function|flip_toggle_key_func (Tool * tool,GdkEventKey * kevent,gpointer gdisp_ptr)
name|flip_toggle_key_func
parameter_list|(
name|Tool
modifier|*
name|tool
