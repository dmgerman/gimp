...
specifier|static
name|void
DECL|function|gimp_text_layer_convert_type (GimpDrawable * drawable,GimpImage * dest_image,const Babl * new_format,GimpImageBaseType new_base_type,GimpPrecision new_precision,gint layer_dither_type,gint mask_dither_type,gboolean push_undo)
name|gimp_text_layer_convert_type
parameter_list|(
name|GimpDrawable
modifier|*
...
name|Babl
modifier|*
DECL|function|gimp_text_layer_get_format (GimpTextLayer * layer)
name|gimp_text_layer_get_format
parameter_list|(
name|GimpTextLayer
modifier|*
name|layer
...
name|_
argument_list|(
literal|"Your text cannot be rendered. It is likely too big. "
literal|"Please make it shorter or use a smaller font."
argument_list|)
argument_list|)
expr_stmt|;
