...
begin_comment
comment|/**  * gimp_text_layer_flush:  * @layer: a #GimpTextLayer  *  * Flushes pending changes to the text layer that would otherwise be  * performed in an idle handler.  */
end_comment

begin_function
name|void
DECL|function|gimp_text_layer_flush (GimpTextLayer * layer)
name|gimp_text_layer_flush
parameter_list|(
name|GimpTextLayer
modifier|*
