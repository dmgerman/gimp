...
begin_comment
comment|/* This function was picked up from Pango's pango-ot-info.c. Until there  * is a better way to get the tag, we use this.  */
end_comment

begin_function
specifier|static
name|hb_tag_t
DECL|function|get_hb_table_type (PangoOTTableType table_type)
name|get_hb_table_type
parameter_list|(
