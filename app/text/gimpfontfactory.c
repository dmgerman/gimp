...
specifier|static
name|void
name|gimp_font_factory_data_cancel
parameter_list|(
name|GimpDataFactory
modifier|*
name|factory
...
specifier|static
name|void
DECL|function|gimp_font_factory_data_cancel (GimpDataFactory * factory)
name|gimp_font_factory_data_cancel
parameter_list|(
name|GimpDataFactory
modifier|*
...
name|container
decl_stmt|;
comment|/* the operation was canceled and the factory might be dead (see    * gimp_font_factory_data_cancel()).  bail.    */
if|if
condition|(
