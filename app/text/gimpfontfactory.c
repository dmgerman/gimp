...
specifier|static
name|void
name|gimp_font_factory_finalize
parameter_list|(
name|GObject
modifier|*
name|object
...
name|GimpAsyncSet
modifier|*
name|gimp_font_factory_get_async_set
parameter_list|(
name|GimpDataFactory
modifier|*
name|factory
...
specifier|static
name|gboolean
name|gimp_font_factory_data_wait
parameter_list|(
name|GimpDataFactory
modifier|*
name|factory
...
specifier|static
name|void
DECL|function|gimp_font_factory_finalize (GObject * object)
name|gimp_font_factory_finalize
parameter_list|(
name|GObject
modifier|*
...
name|GimpAsyncSet
modifier|*
DECL|function|gimp_font_factory_get_async_set (GimpDataFactory * factory)
name|gimp_font_factory_get_async_set
parameter_list|(
name|GimpDataFactory
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_font_factory_data_wait (GimpDataFactory * factory)
name|gimp_font_factory_data_wait
parameter_list|(
name|GimpDataFactory
modifier|*
