...
specifier|static
name|void
DECL|function|sse2_op_overlay (void)
name|sse2_op_overlay
parameter_list|(
name|void
parameter_list|)
block|{ }
...
asm|("  movdqu      %0,%%xmm0\n" 																				"\tmovdqu      %1,%%xmm1\n" 																				"\tmovdqu      %2,%%xmm2\n" 																				"\tmovdqu      %3,%%xmm3\n" 																				"\tmovdqu      %4,%%xmm4\n" 																				"\tmovdqu      %5,%%xmm5\n" 																				"\tmovdqu      %6,%%xmm6\n" 																				"\tmovdqu      %7,%%xmm7\n"  																				"\tmovdqu      %%xmm0,%1\n" 																				"\tmovdqu      %%xmm1,%0\n" 																				"\tmovdqu      %%xmm2,%3\n" 																				"\tmovdqu      %%xmm3,%2\n" 																				"\tmovdqu      %%xmm4,%5\n" 																				"\tmovdqu      %%xmm5,%4\n" 																				"\tmovdqu      %%xmm6,%7\n" 																				"\tmovdqu      %%xmm7,%6\n" 																				:
comment|/* empty */
asm|: "m" (op.A[0]), "m" (op.B[0]), 																				"m" (op.A[1]), "m" (op.B[1]), 																				"m" (op.A[2]), "m" (op.B[2]), 																				"m" (op.A[3]), "m" (op.B[3]) 																				: "%xmm0", "%xmm1", "%xmm2", "%xmm3", "%xmm4", "%xmm5", "%xmm6", "%xmm7");
name|op
operator|.
name|A
operator|+=
