...
name|printf
argument_list|(
literal|"blend_rgba8_rgba8_rgba8 failed\n"
argument_list|)
expr_stmt|;
return|return
operator|(
...
name|gimp_composite_regression_timer_report
argument_list|(
literal|"blend_rgba8_rgba8_rgba8"
argument_list|,
name|ft0
argument_list|,
name|ft1
...
name|printf
argument_list|(
literal|"divide_rgba8_rgba8_rgba8 failed\n"
argument_list|)
expr_stmt|;
return|return
operator|(
...
name|gimp_composite_regression_timer_report
argument_list|(
literal|"divide_rgba8_rgba8_rgba8"
argument_list|,
name|ft0
argument_list|,
name|ft1
...
name|printf
argument_list|(
literal|"dodge_rgba8_rgba8_rgba8 failed\n"
argument_list|)
expr_stmt|;
return|return
operator|(
...
name|gimp_composite_regression_timer_report
argument_list|(
literal|"dodge_rgba8_rgba8_rgba8"
argument_list|,
name|ft0
argument_list|,
name|ft1
