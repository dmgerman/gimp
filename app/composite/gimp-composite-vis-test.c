...
begin_function
name|int
DECL|function|gimp_composite_vis_test (int iterations,int n_pixels)
name|gimp_composite_vis_test
parameter_list|(
name|int
name|iterations
parameter_list|,
...
name|printf
argument_list|(
literal|"gimp_composite_vis: Instruction set is not available.\n"
argument_list|)
expr_stmt|;
return|return
operator|(
