...
begin_comment
comment|/* private convieniece macros */
end_comment
...
name|g_printerr
argument_list|(
literal|"PROP_VECTORS: saved %d bytes\n"
argument_list|,
name|length
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|/* can't fail fast because there is no way to exit g_slist_foreach */
if|if
condition|(
operator|!
...
name|tattoo
decl_stmt|;
comment|/*        * name (string)        * locked (gint)        * tattoo (gint)        * number strokes (gint)        *        * then each stroke.        */
name|name
operator|=
operator|(
name|gchar
...
name|g_printerr
argument_list|(
literal|"name: %s, version: %d, locked: %d, tattoo: %d, num_strokes %d\n"
argument_list|,
name|name
argument_list|,
name|version
...
name|wheel
expr_stmt|;
comment|/*                * type (gint)                * x (gfloat)                * y (gfloat)                * ....                * wheel (gfloat)                * (but only the first num_axis elements)                */
name|xcf_write_int32_check_error
argument_list|(
name|info
operator|->
