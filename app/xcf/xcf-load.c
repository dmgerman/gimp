...
name|g_warning
argument_list|(
literal|"Mismatch in PROP_VECTORS size: skipping %d bytes."
argument_list|,
name|base
operator|+
name|prop_size
...
name|error
goto|;
comment|/* check for a gimp-text parasite */
name|parasite
operator|=
...
block|{
comment|/* check for a GDynText parasite */
name|parasite
operator|=
name|gimp_item_parasite_find
argument_list|(
...
expr_stmt|;
block|}
comment|/* if there's a text object, convert the layer to a text layer */
if|if
condition|(
name|text
condition|)
...
name|g_warning
argument_list|(
literal|"Unknown vectors type %d. Possibly corrupt XCF file"
argument_list|,
name|version
argument_list|)
expr_stmt|;
...
name|g_printerr
argument_list|(
literal|"name: %s, locked: %d, tattoo: %d, num_strokes %d\n"
argument_list|,
name|name
argument_list|,
name|locked
...
argument_list|)
expr_stmt|;
comment|/* here the stroke has to be created */
name|stroke
operator|=
name|GIMP_STROKE
argument_list|(
