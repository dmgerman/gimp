...
typedef|typedef
struct|struct
DECL|struct|__anon2bc21c6f0108
block|{
DECL|member|stack
name|GQueue
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2bc21c6f0208
block|{
DECL|member|id
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|svg_handler_svg (SvgHandler * handler,const gchar ** names,const gchar ** values,SvgParser * parser)
name|svg_handler_svg
parameter_list|(
name|SvgHandler
modifier|*
...
specifier|static
name|void
DECL|function|svg_handler_group (SvgHandler * handler,const gchar ** names,const gchar ** values,SvgParser * parser)
name|svg_handler_group
parameter_list|(
name|SvgHandler
modifier|*
...
specifier|static
name|void
DECL|function|svg_handler_path (SvgHandler * handler,const gchar ** names,const gchar ** values,SvgParser * parser)
name|svg_handler_path
parameter_list|(
name|SvgHandler
modifier|*
...
specifier|static
name|gboolean
DECL|function|parse_svg_length (const gchar * value,gdouble reference,gdouble resolution,gdouble * scale,gdouble * length)
name|parse_svg_length
parameter_list|(
specifier|const
name|gchar
...
typedef|typedef
struct|struct
DECL|struct|__anon2bc21c6f0308
block|{
DECL|member|strokes
name|GList
modifier|*
