...
typedef|typedef
struct|struct
DECL|struct|__anon2c828d2c0108
block|{
DECL|member|stack
name|GQueue
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2c828d2c0208
block|{
DECL|member|id
name|gchar
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_vectors_import_file (GimpImage * image,const gchar * filename,gboolean merge,gboolean scale,gint position,GError ** error)
...
typedef|typedef
struct|struct
DECL|struct|__anon2c828d2c0308
block|{
DECL|member|strokes
name|GList
modifier|*
