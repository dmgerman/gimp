...
typedef|typedef
struct|struct
DECL|struct|__anon29480f650108
block|{
DECL|member|id
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|svg_handler_svg (SvgHandler * handler,const gchar ** names,const gchar ** values)
name|svg_handler_svg
parameter_list|(
name|SvgHandler
modifier|*
...
specifier|static
name|void
DECL|function|svg_handler_group (SvgHandler * handler,const gchar ** names,const gchar ** values)
name|svg_handler_group
parameter_list|(
name|SvgHandler
modifier|*
...
specifier|static
name|void
DECL|function|svg_handler_path (SvgHandler * handler,const gchar ** names,const gchar ** values)
name|svg_handler_path
parameter_list|(
name|SvgHandler
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon29480f650208
block|{
DECL|member|strokes
name|GList
modifier|*
