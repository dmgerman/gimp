...
typedef|typedef
struct|struct
DECL|struct|__anon2c1be4620108
block|{
DECL|member|stack
name|GQueue
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2c1be4620208
block|{
DECL|member|id
name|gchar
modifier|*
...
begin_comment
comment|/**  * gimp_vectors_import:  * @image: the #GimpImage to add the paths to  * @filename: name of a SVG file  * @merge: should multiple paths be merged into a single #GimpVectors object  * @scale: should the SVG be scaled to fit the image dimensions  * @error: location to store possible errors  *  * Imports one or more paths from a SVG file.  *  * Return value: %TRUE on success, %FALSE if an error occured  **/
end_comment

begin_function
name|gboolean
DECL|function|gimp_vectors_import (GimpImage * image,const gchar * filename,gboolean merge,gboolean scale,GError ** error)
...
typedef|typedef
struct|struct
DECL|struct|__anon2c1be4620308
block|{
DECL|member|strokes
name|GList
modifier|*
