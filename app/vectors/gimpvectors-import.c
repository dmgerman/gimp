...
typedef|typedef
struct|struct
DECL|struct|__anon2a2c302d0208
block|{
DECL|member|x
DECL|member|y
name|gint
...
typedef|typedef
struct|struct
DECL|struct|__anon2a2c302d0308
block|{
DECL|member|state
name|ParserState
name|state
...
typedef|typedef
struct|struct
DECL|struct|__anon2a2c302d0408
block|{
DECL|member|vectors
name|GimpVectors
modifier|*
...
specifier|static
name|void
DECL|function|parse_svg_viewbox (VectorsParser * parser,const gchar * value)
name|parse_svg_viewbox
parameter_list|(
name|VectorsParser
modifier|*
