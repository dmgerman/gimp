...
specifier|static
name|gboolean
DECL|function|gimp_vectors_stroke (GimpItem * item,GimpDrawable * drawable,GimpPaintInfo * paint_info)
name|gimp_vectors_stroke
parameter_list|(
name|GimpItem
modifier|*
...
directive|ifdef
name|LIBART_STROKE_BAD_HACK
comment|/* Bad hack to be able to change the size of the stroke interactively:      * use the opacity value as the width...      */
