...
specifier|static
name|gboolean
DECL|function|gimp_vectors_bounds (GimpItem * item,gdouble * x,gdouble * y,gdouble * width,gdouble * height)
name|gimp_vectors_bounds
parameter_list|(
name|GimpItem
modifier|*
...
specifier|static
name|void
DECL|function|gimp_vectors_convert (GimpItem * item,GimpImage * dest_image,GType old_type)
name|gimp_vectors_convert
parameter_list|(
name|GimpItem
modifier|*
...
specifier|static
name|void
DECL|function|gimp_vectors_transform (GimpItem * item,GimpContext * context,const GimpMatrix3 * matrix,GimpTransformDirection direction,GimpInterpolationType interpolation_type,GimpTransformResize clip_result,GimpProgress * progress)
name|gimp_vectors_transform
parameter_list|(
name|GimpItem
modifier|*
...
specifier|static
name|gboolean
DECL|function|gimp_vectors_fill (GimpItem * item,GimpDrawable * drawable,GimpFillOptions * fill_options,gboolean push_undo,GimpProgress * progress,GError ** error)
name|gimp_vectors_fill
parameter_list|(
name|GimpItem
modifier|*
