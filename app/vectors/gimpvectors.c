...
specifier|static
name|gboolean
DECL|function|gimp_vectors_item_bounds (GimpItem * item,gdouble * x,gdouble * y,gdouble * width,gdouble * height)
name|gimp_vectors_item_bounds
parameter_list|(
name|GimpItem
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_vectors_bounds (GimpVectors * vectors,gdouble * x1,gdouble * y1,gdouble * x2,gdouble * y2)
name|gimp_vectors_bounds
parameter_list|(
name|GimpVectors
modifier|*
