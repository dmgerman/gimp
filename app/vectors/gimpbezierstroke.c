...
specifier|static
name|void
DECL|function|gimp_bezier_coords_subdivide (const GimpCoords * beziercoords,const gdouble precision,GArray ** ret_coords,GArray ** ret_params)
name|gimp_bezier_coords_subdivide
parameter_list|(
specifier|const
name|GimpCoords
...
specifier|static
name|void
DECL|function|gimp_bezier_coords_subdivide2 (const GimpCoords * beziercoords,const gdouble start_t,const gdouble end_t,const gdouble precision,GArray ** ret_coords,GArray ** ret_params,gint depth)
name|gimp_bezier_coords_subdivide2
parameter_list|(
specifier|const
name|GimpCoords
