...
name|GimpAnchor
modifier|*
DECL|function|gimp_bezier_stroke_extend (GimpBezierStroke * bezier_stroke,const GimpCoords * coords,GimpAnchor * neighbor)
name|gimp_bezier_stroke_extend
parameter_list|(
name|GimpBezierStroke
modifier|*
...
name|FALSE
expr_stmt|;
comment|/* We have to detect the type of the newly added point... */
name|ntype1
operator|=
operator|(
operator|(
