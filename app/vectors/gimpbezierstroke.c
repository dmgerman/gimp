...
name|GimpCoords
modifier|*
DECL|function|gimp_bezier_stroke_interpolate (const GimpStroke * stroke,gdouble precision,gint * ret_numcoords,gboolean * ret_closed)
name|gimp_bezier_stroke_interpolate
parameter_list|(
specifier|const
name|GimpStroke
...
specifier|static
name|void
DECL|function|gimp_bezier_coords_subdivide (GimpCoords * beziercoords,const gdouble precision,gint * ret_ncoords,GimpCoords * ret_coords)
name|gimp_bezier_coords_subdivide
parameter_list|(
name|GimpCoords
modifier|*
...
control|)
block|{
comment|/* if necessary, allocate new memory for return coords */
name|ret_coords
index|[
operator|*
name|ret_ncoords
