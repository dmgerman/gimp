...
name|GList
modifier|*
DECL|function|gimp_stroke_get_draw_controls (const GimpStroke * stroke,const GimpAnchor * active)
...
name|GArray
modifier|*
DECL|function|gimp_stroke_get_draw_lines (const GimpStroke * stroke,const GimpAnchor * active)
