...
name|gchar
modifier|*
DECL|function|gimp_vectors_image_size (const GimpImage * image)
name|gimp_vectors_image_size
parameter_list|(
specifier|const
name|GimpImage
...
specifier|static
name|void
DECL|function|gimp_vectors_export_path (const GimpVectors * vectors,FILE * file)
name|gimp_vectors_export_path
parameter_list|(
specifier|const
name|GimpVectors
