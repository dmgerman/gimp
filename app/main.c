...
begin_comment
comment|/*  These options are checked before gtk_init() is being called.  */
end_comment

begin_decl_stmt
DECL|variable|pre_entries
specifier|static
specifier|const
name|GOptionEntry
name|pre_entries
...
specifier|static
name|void
DECL|function|gimp_init_log_handlers (void)
name|gimp_init_log_handlers
parameter_list|(
name|void
parameter_list|)
