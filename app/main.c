...
name|filenames
decl_stmt|;
comment|/* Work around a bug in dbus-glib:            * It doesn't accept NULL as an empty string array.            */
if|if
condition|(
operator|!
name|filenames
...
name|code
operator|==
name|DBUS_GERROR_REMOTE_EXCEPTION
condition|)
block|{
name|g_printerr
argument_list|(
literal|"Caught remote method exception %s: %s"
argument_list|,
name|dbus_g_error_get_name
argument_list|(
name|error
argument_list|)
argument_list|,
