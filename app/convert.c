...
typedef|typedef
struct|struct
DECL|struct|__anon2a8ebecd0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2a8ebecd0208
block|{
DECL|member|ncolors
name|long
name|ncolors
...
typedef|typedef
struct|struct
DECL|struct|__anon2a8ebecd0308
block|{
DECL|member|shell
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*     hbox = gtk_hbox_new (FALSE, 1);     {       gtk_box_pack_start (GTK_BOX (vbox), hbox, FALSE, FALSE, 0);              toggle = gtk_check_button_new_with_label (_("Use a maximum of N colours from\nthe selected custom palette"));       gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (toggle), dialog->alphadither);       gtk_box_pack_start (GTK_BOX (hbox), toggle, TRUE, FALSE, 0);       gtk_signal_connect (GTK_OBJECT (toggle), "toggled", 			  (GtkSignalFunc) indexed_alphadither_update, 			  dialog);       gtk_widget_show (label);       gtk_widget_show (toggle);     }     gtk_widget_show (hbox);     */
...
specifier|static
name|void
DECL|function|indexed_alphadither_update (GtkWidget * w,gpointer data)
name|indexed_alphadither_update
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|indexed_remdups_update (GtkWidget * w,gpointer data)
name|indexed_remdups_update
parameter_list|(
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2a8ebecd0408
block|{
