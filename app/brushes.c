...
specifier|static
name|link_ptr
DECL|function|insert_brush_in_list (list,brush)
name|insert_brush_in_list
parameter_list|(
name|list
parameter_list|,
...
comment|/* There are no items in the brush list, so we'll just start      *  one right now.      */
name|list
operator|=
name|add_to_list
argument_list|(
...
begin_function
name|GBrushP
DECL|function|get_brush_by_index (index)
...
begin_function
name|void
DECL|function|select_brush (brush)
name|select_brush
parameter_list|(
name|brush
parameter_list|)
