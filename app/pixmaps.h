...
begin_comment
comment|/* FIXME dialog is basicaly a teporary pixmap so the device status  * window doesn't have problems showing the dialog devices, it doesn't  * really represent anything and really should be changed  */
end_comment
