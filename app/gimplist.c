...
name|GimpObject
modifier|*
DECL|function|gimp_list_get_child_by_name (const GimpList * list,const gchar * name)
...
name|GimpObject
modifier|*
DECL|function|gimp_list_get_child_by_index (const GimpList * list,gint index)
...
begin_function
name|gint
DECL|function|gimp_list_get_child_index (const GimpList * list,const GimpObject * object)
