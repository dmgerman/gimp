...
expr_stmt|;
block|{
comment|/*	    gtk_label_set_justify (GTK_LABEL (open_options_label), 		    GTK_JUSTIFY_LEFT); 		    gtk_label_set_line_wrap (GTK_LABEL (open_options_label), TRUE);*/
name|gtk_box_pack_end
argument_list|(
name|GTK_BOX
argument_list|(
...
name|GimpImage
modifier|*
DECL|function|file_open_image (char * filename,char * raw_filename)
name|file_open_image
parameter_list|(
name|char
modifier|*
...
specifier|static
name|gboolean
DECL|function|file_save_thumbnail (GimpImage * gimage,char * filename,char * raw_filename)
...
name|printf
argument_list|(
literal|"(gimage already has valid preview - %dx%d)\n"
argument_list|,
name|gimage
operator|->
name|comp_preview
...
argument_list|)
expr_stmt|;
comment|/*g_warning ("clique! %s", fname);*/
comment|/*gtk_clist_get_text(GTK_CLIST(w), client_data, 0,&txt);     g_warning ("clique! %p %d %s [%s]", w, client_data, txt, fname);*/
