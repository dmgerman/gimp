...
name|GimpImage
modifier|*
DECL|function|file_open_image (gchar * filename,gchar * raw_filename,RunModeType runmode,gint * status)
name|file_open_image
parameter_list|(
name|gchar
modifier|*
...
begin_function
name|gint
DECL|function|file_save (GimpImage * gimage,char * filename,char * raw_filename,RunModeType mode)
name|file_save
parameter_list|(
name|GimpImage
modifier|*
