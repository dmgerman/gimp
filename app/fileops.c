...
specifier|static
name|int
DECL|function|file_check_single_magic (char * offset,char * type,char * value,int headsize,guchar * file_head,FILE * ifp)
name|file_check_single_magic
parameter_list|(
name|char
modifier|*
...
specifier|static
name|int
DECL|function|file_check_magic_list (GSList * magics_list,int headsize,guchar * head,FILE * ifp)
name|file_check_magic_list
parameter_list|(
name|GSList
modifier|*
