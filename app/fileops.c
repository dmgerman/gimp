...
comment|/* If you have problems, blame Adam... not quite finished. 	 Will be moved somewhere more appropriate. */
endif|#
directive|endif
block|{
name|TempBuf
...
block|}
block|}
comment|/* END OF THUMBNAIL SAVING */
block|}
name|g_free
argument_list|(
name|return_vals
...
begin_function
DECL|function|readXVThumb (gchar * fnam,gint * w,gint * h)
specifier|static
name|guchar
modifier|*
name|readXVThumb
