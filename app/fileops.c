...
argument_list|)
expr_stmt|;
comment|/* pack the containing open_options hbox into the load-dialog */
name|gtk_box_pack_end
argument_list|(
name|GTK_BOX
argument_list|(
...
name|_
argument_list|(
literal|"Can't revert. No filename associated with this image"
argument_list|)
argument_list|)
expr_stmt|;
else|else
...
name|GimpImage
modifier|*
DECL|function|file_open_image (char * filename,char * raw_filename,RunModeType runmode)
name|file_open_image
parameter_list|(
name|char
modifier|*
...
specifier|static
name|gboolean
DECL|function|file_save_thumbnail (GimpImage * gimage,const char * full_source_filename)
...
specifier|static
name|void
DECL|function|set_preview (const gchar * fullfname)
name|set_preview
parameter_list|(
specifier|const
name|gchar
