...
typedef|typedef
struct|struct
DECL|struct|__anon278f99f40308
block|{
DECL|member|shell
name|GtkWidget
modifier|*
...
specifier|static
name|void
name|gradients_list_uniquefy_gradient_name
parameter_list|(
name|gradient_t
modifier|*
name|gradient
...
specifier|static
name|void
DECL|function|ed_do_new_gradient_callback (GtkWidget * widget,gchar * gradient_name,gpointer data)
name|ed_do_new_gradient_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|ed_do_copy_gradient_callback (GtkWidget * widget,gchar * gradient_name,gpointer data)
name|ed_do_copy_gradient_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|ed_do_rename_gradient_callback (GtkWidget * widget,gchar * gradient_name,gpointer data)
name|ed_do_rename_gradient_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|ed_do_delete_gradient_callback (GtkWidget * widget,gboolean delete,gpointer data)
name|ed_do_delete_gradient_callback
parameter_list|(
name|GtkWidget
modifier|*
...
name|NULL
expr_stmt|;
comment|/* Delete gradient from clists */
...
specifier|static
name|gint
DECL|function|preview_events (GtkWidget * widget,GdkEvent * event,gpointer data)
name|preview_events
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|preview_set_hint (gint x)
name|preview_set_hint
parameter_list|(
name|gint
name|x
...
specifier|static
name|void
DECL|function|preview_set_foreground (gint x)
name|preview_set_foreground
parameter_list|(
name|gint
name|x
...
specifier|static
name|void
DECL|function|preview_set_background (gint x)
name|preview_set_background
parameter_list|(
name|gint
name|x
...
specifier|static
name|void
DECL|function|preview_update (gboolean recalculate)
name|preview_update
parameter_list|(
name|gboolean
name|recalculate
...
specifier|static
name|void
DECL|function|preview_fill_image (gint width,gint height,gdouble left,gdouble right)
name|preview_fill_image
parameter_list|(
name|gint
name|width
...
specifier|static
name|void
DECL|function|control_compress_range (grad_segment_t * range_l,grad_segment_t * range_r,gdouble new_l,gdouble new_r)
name|control_compress_range
parameter_list|(
name|grad_segment_t
modifier|*
...
specifier|static
name|gdouble
DECL|function|control_move (grad_segment_t * range_l,grad_segment_t * range_r,gdouble delta)
name|control_move
parameter_list|(
name|grad_segment_t
modifier|*
...
specifier|static
name|void
DECL|function|control_draw (GdkPixmap * pixmap,gint width,gint height,gdouble left,gdouble right)
name|control_draw
parameter_list|(
name|GdkPixmap
modifier|*
...
specifier|static
name|void
DECL|function|control_draw_normal_handle (GdkPixmap * pixmap,gdouble pos,gint height)
name|control_draw_normal_handle
parameter_list|(
name|GdkPixmap
modifier|*
...
specifier|static
name|void
DECL|function|control_draw_middle_handle (GdkPixmap * pixmap,gdouble pos,gint height)
name|control_draw_middle_handle
parameter_list|(
name|GdkPixmap
modifier|*
...
specifier|static
name|gint
DECL|function|control_calc_p_pos (gdouble pos)
name|control_calc_p_pos
parameter_list|(
name|gdouble
name|pos
...
specifier|static
name|gdouble
DECL|function|control_calc_g_pos (gint pos)
name|control_calc_g_pos
parameter_list|(
name|gint
name|pos
...
specifier|static
name|void
DECL|function|cpopup_update_saved_color (gint n,GimpRGB * color)
name|cpopup_update_saved_color
parameter_list|(
name|gint
name|n
...
specifier|static
name|void
DECL|function|cpopup_set_color_selection_color (GtkColorSelection * cs,GimpRGB * color)
name|cpopup_set_color_selection_color
parameter_list|(
name|GtkColorSelection
modifier|*
...
specifier|static
name|void
DECL|function|cpopup_get_color_selection_color (GtkColorSelection * cs,GimpRGB * color)
name|cpopup_get_color_selection_color
parameter_list|(
name|GtkColorSelection
modifier|*
...
specifier|static
name|void
DECL|function|cpopup_create_color_dialog (gchar * title,GimpRGB * color,GtkSignalFunc color_changed_callback,GtkSignalFunc ok_callback,GtkSignalFunc cancel_callback,GtkSignalFunc delete_callback)
name|cpopup_create_color_dialog
parameter_list|(
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|cpopup_blend_endpoints (GimpRGB * rgb1,GimpRGB * rgb2,gboolean blend_colors,gboolean blend_opacity)
name|cpopup_blend_endpoints
parameter_list|(
name|GimpRGB
modifier|*
...
specifier|static
name|void
DECL|function|gradients_list_uniquefy_gradient_name (gradient_t * gradient)
name|gradients_list_uniquefy_gradient_name
parameter_list|(
name|gradient_t
modifier|*
...
name|newname
expr_stmt|;
comment|/*  should resort the list here  */
return|return;
block|}
block|}
block|}
