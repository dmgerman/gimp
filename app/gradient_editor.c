...
specifier|static
name|void
DECL|function|ed_set_list_of_gradients (void)
name|ed_set_list_of_gradients
parameter_list|(
name|void
parameter_list|)
...
specifier|static
name|void
DECL|function|ed_insert_in_gradients_listbox (gradient_t * grad,int pos,int select)
name|ed_insert_in_gradients_listbox
parameter_list|(
name|gradient_t
modifier|*
...
specifier|static
name|void
DECL|function|ed_list_item_update (GtkWidget * widget,gpointer data)
name|ed_list_item_update
parameter_list|(
name|GtkWidget
modifier|*
...
parameter_list|)
block|{
comment|/* If this is not the selected item, do nothing */
if|if
condition|(
name|widget
operator|->
...
name|GtkWidget
modifier|*
DECL|function|cpopup_create_load_menu (GtkWidget ** color_boxes,GtkWidget ** labels,char * label1,char * label2,GtkSignalFunc callback,gchar accel_key_0,guint8 accel_mods_0,gchar accel_key_1,guint8 accel_mods_1)
name|cpopup_create_load_menu
parameter_list|(
name|GtkWidget
modifier|*
...
comment|/* Just update the current gradient */
name|curr_gradient
operator|=
name|grad
expr_stmt|;
