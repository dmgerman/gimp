...
begin_comment
comment|/*  utility functions for the device_info_list  */
end_comment
...
name|DeviceInfo
modifier|*
DECL|function|device_info_get_by_device (GdkDevice * device)
...
specifier|static
name|void
DECL|function|input_dialog_able_callback (GtkWidget * widget,GdkDevice * device,gpointer data)
name|input_dialog_able_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|device_status_context_connect (GimpContext * context,GdkDevice * device)
name|device_status_context_connect
parameter_list|(
name|GimpContext
modifier|*
