...
operator|=
name|x
comment|/* BOUNDS (x, 0, gdisp->gimage->width) */
expr_stmt|;
name|ga
operator|->
name|y1
operator|=
name|y
comment|/* BOUNDS (y, 0, gdisp->gimage->height) */
expr_stmt|;
name|ga
operator|->
name|x2
...
operator|+
name|w
comment|/* BOUNDS (x + w, 0, gdisp->gimage->width) */
expr_stmt|;
name|ga
operator|->
name|y2
...
operator|+
name|h
comment|/* BOUNDS (y + h, 0, gdisp->gimage->height) */
expr_stmt|;
name|gdisp
operator|->
name|update_areas
...
operator|=
name|x
comment|/* BOUNDS (x, 0, gdisp->disp_width) */
expr_stmt|;
name|ga
operator|->
name|y1
operator|=
name|y
comment|/* BOUNDS (y, 0, gdisp->disp_height) */
expr_stmt|;
name|ga
operator|->
name|x2
...
operator|+
name|w
comment|/* BOUNDS (x + w, 0, gdisp->disp_width) */
expr_stmt|;
name|ga
operator|->
name|y2
...
operator|+
name|h
comment|/* BOUNDS (y + h, 0, gdisp->disp_height) */
expr_stmt|;
name|gdisp
operator|->
name|display_areas
...
argument_list|)
expr_stmt|;
comment|/* expose needs to be done on the unbounded area */
