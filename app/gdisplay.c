...
argument_list|)
expr_stmt|;
comment|/* Schedule the update for the window icon */
name|gdisp
operator|->
...
name|g_printerr
argument_list|(
literal|"gdisplay: falling back to default\n"
argument_list|)
expr_stmt|;
name|gdk_window_set_icon
argument_list|(
...
name|gdisp
decl_stmt|;
comment|/* need to test for valid gdisplay here */
name|gdisp
operator|=
operator|(
name|GDisplay
...
literal|0
expr_stmt|;
comment|/* Our work is done, don't request further execution */
return|return
literal|0
return|;
block|}
