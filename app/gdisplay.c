...
begin_comment
comment|/*  install and remove tool gimp cursor from gdisplay...  */
end_comment

begin_function
name|void
DECL|function|gdisplay_install_gimp_tool_cursor (GDisplay * gdisp,int cursor_type)
...
name|_
argument_list|(
literal|"<Image>/View/Dot for dot"
argument_list|)
argument_list|,
name|gdisp
operator|->
