...
specifier|static
name|void
DECL|function|selection_adjustment_update (GtkWidget * widget,gpointer data)
name|selection_adjustment_update
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|selection_unitmenu_update (GtkWidget * widget,gpointer data)
name|selection_unitmenu_update
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
argument_list|)
argument_list|,
literal|"fixed_width_spinbutton"
argument_list|)
argument_list|)
expr_stmt|;
...
argument_list|)
argument_list|,
literal|"fixed_height_spinbutton"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_spin_button_set_digits
