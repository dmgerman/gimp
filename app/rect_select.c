...
specifier|static
name|void
DECL|function|selection_tool_update_op_state (RectSelect * rect_sel,gint x,gint y,gint state,GDisplay * gdisp)
name|selection_tool_update_op_state
parameter_list|(
name|RectSelect
modifier|*
...
specifier|static
name|void
DECL|function|rect_select_options_reset (void)
...
name|Tool
modifier|*
DECL|function|tools_new_rect_select (void)
