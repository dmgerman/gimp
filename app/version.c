...
specifier|static
name|void
DECL|function|gimp_show_one_library_version (const gchar * package,int build_time_major,int build_time_minor,int build_time_micro,int run_time_major,int run_time_minor,int run_time_micro)
name|gimp_show_one_library_version
parameter_list|(
specifier|const
name|gchar
modifier|*
...
name|g_print
argument_list|(
literal|"%s: %s %d.%d.%d, %s %d.%d.%d\n"
argument_list|,
name|package
argument_list|,
name|_
argument_list|(
literal|"compiled against version"
argument_list|)
argument_list|,
name|build_time_major
argument_list|,
...
name|_
argument_list|(
literal|"running against version"
argument_list|)
argument_list|,
name|run_time_major
argument_list|,
