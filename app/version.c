...
name|gchar
modifier|*
DECL|function|gimp_library_version (const gchar * package,gint build_time_major,gint build_time_minor,gint build_time_micro,gint run_time_major,gint run_time_minor,gint run_time_micro,gboolean localized)
name|gimp_library_version
parameter_list|(
specifier|const
name|gchar
modifier|*
...
name|gchar
modifier|*
DECL|function|gimp_library_versions (gboolean localized)
name|gimp_library_versions
parameter_list|(
name|gboolean
name|localized
parameter_list|)
...
name|gchar
modifier|*
DECL|function|gimp_version (gboolean be_verbose,gboolean localized)
name|gimp_version
parameter_list|(
name|gboolean
name|be_verbose
