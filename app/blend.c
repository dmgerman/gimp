...
begin_typedef
DECL|struct|__anon298ed8330108
typedef|typedef
struct|struct
block|{
DECL|member|offset
...
begin_typedef
DECL|struct|__anon298ed8330208
typedef|typedef
struct|struct
block|{
DECL|member|PR
...
argument_list|)
expr_stmt|;
comment|/*  a separator after the paint mode options  */
name|separator
operator|=
...
argument_list|)
expr_stmt|;
comment|/*  automatically set the sensitive state of the frame  */
name|gtk_widget_set_sensitive
argument_list|(
name|frame
argument_list|,
