...
specifier|static
name|void
DECL|function|blend_options_reset (void)
...
specifier|static
name|void
DECL|function|blend_options_drop_tool (GtkWidget * widget,ToolType tool,gpointer data)
name|blend_options_drop_tool
parameter_list|(
name|GtkWidget
modifier|*
...
begin_function
name|void
DECL|function|blend (GImage * gimage,GimpDrawable * drawable,BlendMode blend_mode,int paint_mode,GradientType gradient_type,double opacity,double offset,RepeatMode repeat,int supersample,int max_depth,double threshold,double startx,double starty,double endx,double endy,GimpProgressFunc progress_callback,gpointer progress_data)
name|blend
parameter_list|(
name|GImage
modifier|*
