...
begin_struct
DECL|struct|__anon2bf986ae0108
specifier|static
struct|struct
block|{
DECL|member|width
...
specifier|static
name|long
DECL|function|pix_diff (guchar * pal,int bpp,int i,int j)
name|pix_diff
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|void
DECL|function|pix_swap (guchar * pal,int bpp,int i,int j)
name|pix_swap
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|gint32
DECL|function|doit (GDrawable * drawable,gint32 * layer_id)
name|doit
parameter_list|(
name|GDrawable
modifier|*
...
begin_function
DECL|function|callback (GtkWidget * widget,gpointer data)
specifier|static
name|void
name|callback
parameter_list|(
...
name|stderr
argument_list|,
literal|"bad data in callback: %x\n"
argument_list|,
operator|(
name|int
operator|)
