...
typedef|typedef
struct|struct
DECL|struct|__anon290a21fe0108
block|{
DECL|member|point
name|GdkPoint
name|point
...
begin_function
name|void
DECL|function|aff_element_draw (AffElement * elem,gboolean selected,gint width,gint height,GdkDrawable * win,GdkGC * normal_gc,GdkGC * selected_gc,PangoLayout * layout)
