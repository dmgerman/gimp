...
begin_function
name|void
DECL|function|aff_element_draw (AffElement * elem,gint selected,gint width,gint height,GdkDrawable * win,GdkGC * normal_gc,GdkGC * selected_gc,GdkFont * font)
...
name|AffElement
modifier|*
DECL|function|aff_element_new (gdouble x,gdouble y,IfsColor color,gint count)
