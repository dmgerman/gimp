...
typedef|typedef
struct|struct
DECL|struct|__anon291e82230108
block|{
DECL|member|run
name|gint
name|run
...
begin_comment
comment|/* static void item_callback (int, void *, void *); static void ok_callback (int, void *, void *); static void cancel_callback (int, void *, void *);  static int dialog_ID; static int group_ID; static int encoded_ID; */
end_comment
