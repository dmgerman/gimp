...
directive|else
comment|/* hof: dont know how to getpid on windows */
return|return
literal|0
return|;
endif|#
...
begin_function
name|gint
DECL|function|p_pid_is_alive (gint32 pid)
name|p_pid_is_alive
parameter_list|(
name|gint32
name|pid
...
directive|else
comment|/* hof: dont know how to check on Windows    *      assume that process is always alive    *      (therefore on Windows locks will not be cleared     *       automatically after crashes of the locking process)    */
return|return
operator|(
name|TRUE
operator|)
...
specifier|static
name|void
DECL|function|p_gap_lock_build_lockkey (t_gap_lockdata * lock,gint32 image_id)
name|p_gap_lock_build_lockkey
parameter_list|(
name|t_gap_lockdata
modifier|*
name|lock
...
begin_function
name|void
DECL|function|p_gap_lock_set (gint32 image_id)
name|p_gap_lock_set
parameter_list|(
name|gint32
name|image_id
...
argument_list|)
expr_stmt|;
comment|/* set LOCK on image (for all gap_plugins) */
name|l_lock
operator|.
name|lock
operator|=
...
begin_function
name|void
DECL|function|p_gap_lock_remove (gint32 image_id)
