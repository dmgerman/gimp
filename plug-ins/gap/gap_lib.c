...
begin_comment
DECL|variable|g_errtxt
comment|/* buffer for current message- or errortext */
end_comment
...
literal|1
expr_stmt|;
comment|/* sprintf(l_save_as_name, "plug_in_gap_plugins_SAVE_AS_MODE_%d", (int)image_id);*/
name|sprintf
argument_list|(
name|l_save_as_name
argument_list|,
...
name|g_errtxt
argument_list|,
literal|"BEFORE rename frame %ld to %ld\n"
argument_list|,
name|l_lo
argument_list|,
name|l_hi
