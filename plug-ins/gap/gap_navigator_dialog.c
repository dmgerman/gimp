...
name|ops_menu
decl_stmt|;
DECL|member|copy_menu_item
name|GtkWidget
modifier|*
name|copy_menu_item
decl_stmt|;
DECL|member|cut_menu_item
name|GtkWidget
modifier|*
name|cut_menu_item
decl_stmt|;
DECL|member|pastea_menu_item
name|GtkWidget
modifier|*
name|pastea_menu_item
decl_stmt|;
DECL|member|pasteb_menu_item
name|GtkWidget
modifier|*
name|pasteb_menu_item
decl_stmt|;
DECL|member|paster_menu_item
name|GtkWidget
modifier|*
name|paster_menu_item
decl_stmt|;
DECL|member|clrpaste_menu_item
name|GtkWidget
modifier|*
name|clrpaste_menu_item
decl_stmt|;
...
name|cursor_acitve
decl_stmt|;
DECL|member|paste_at_frame
name|gint32
name|paste_at_frame
decl_stmt|;
comment|/* -1: use current frame */
DECL|member|ratio
name|gdouble
name|ratio
decl_stmt|;
...
specifier|static
name|void
name|navi_ops_menu_set_sensitive
parameter_list|(
name|void
parameter_list|)
function_decl|;
...
specifier|static
name|void
DECL|function|edit_copy_callback (GtkWidget * w,gpointer client_data)
name|edit_copy_callback
parameter_list|(
name|GtkWidget
modifier|*
name|w
...
specifier|static
name|void
DECL|function|edit_cut_callback (GtkWidget * w,gpointer client_data)
name|edit_cut_callback
parameter_list|(
name|GtkWidget
modifier|*
name|w
...
specifier|static
name|void
DECL|function|p_edit_paste_call (gint32 paste_mode)
name|p_edit_paste_call
parameter_list|(
name|gint32
name|paste_mode
parameter_list|)
...
condition|)
block|{
comment|/* goto the first selected frame */
name|return_vals
operator|=
...
specifier|static
name|void
DECL|function|edit_pasteb_callback (GtkWidget * w,gpointer client_data)
name|edit_pasteb_callback
parameter_list|(
name|GtkWidget
modifier|*
name|w
...
specifier|static
name|void
DECL|function|edit_pastea_callback (GtkWidget * w,gpointer client_data)
name|edit_pastea_callback
parameter_list|(
name|GtkWidget
modifier|*
name|w
...
specifier|static
name|void
DECL|function|edit_paster_callback (GtkWidget * w,gpointer client_data)
name|edit_paster_callback
parameter_list|(
name|GtkWidget
modifier|*
name|w
...
specifier|static
name|void
DECL|function|edit_clrpaste_callback (GtkWidget * w,gpointer client_data)
name|edit_clrpaste_callback
parameter_list|(
name|GtkWidget
modifier|*
name|w
...
name|printf
argument_list|(
literal|"edit_clrpaste_callback\n"
argument_list|)
expr_stmt|;
name|return_vals
operator|=
...
begin_function
name|void
DECL|function|navi_vid_copy_and_cut (gint cut_flag)
name|navi_vid_copy_and_cut
parameter_list|(
name|gint
name|cut_flag
...
name|printf
argument_list|(
literal|"navi_dialog_vid_copy_callback\n"
argument_list|)
expr_stmt|;
name|range_list
operator|=
...
argument_list|()
expr_stmt|;
comment|/* generate prev linkpointers in the range list */
name|range_item
operator|=
name|NULL
expr_stmt|;
...
condition|)
block|{
comment|/* Note: process the ranges from low frame_nummers 	*       upto high frame_numbers. 	*       (the range_list was created in a way that 	*        the highest range is added as 1st list element         *        so we start at end of the list and to the 1. element using prev linkpinters 	*/
if|if
condition|(
name|gap_debug
condition|)
name|printf
argument_list|(
literal|"Copy Range from:%d  to:%d\n"
argument_list|,
operator|(
name|int
operator|)
...
begin_function
name|void
DECL|function|navi_ops_menu_set_sensitive (void)
name|navi_ops_menu_set_sensitive
parameter_list|(
name|void
parameter_list|)
...
literal|1
expr_stmt|;
comment|/* nothing selected, use current frame_nr */
block|}
end_function

begin_comment
comment|/* end navi_ops_menu_set_sensitive */
end_comment
...
name|printf
argument_list|(
literal|"frame_list_events: GDK_BUTTON_PRESS bevent->button == 3\n"
argument_list|)
expr_stmt|;
name|navi_ops_menu_set_sensitive
argument_list|()
...
name|printf
argument_list|(
literal|"frame_widget_preview_events GDK_BUTTON_PRESS button:%d\n"
argument_list|,
operator|(
name|int
operator|)
...
argument_list|)
expr_stmt|;
comment|/*  The popup menu (copy/cut/paste) */
name|naviD
operator|->
name|ops_menu
operator|=
...
name|menu_item
expr_stmt|;
comment|/* menu_item paste before */
name|menu_item
operator|=
name|gtk_menu_item_new_with_label
argument_list|(
