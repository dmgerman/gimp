...
argument_list|)
expr_stmt|;
comment|/* copy image specific parasites     *  (drawable specific parasites are handled implicite     *   by stealing layers and channels)     */
name|l_parasite_names
operator|=
...
name|printf
argument_list|(
literal|"copy image_parasite NAME:%s:\n"
argument_list|,
name|l_parasite_names
index|[
name|l_idx
...
argument_list|)
expr_stmt|;
comment|/* remove image specific parasites */
name|l_parasite_names
operator|=
name|p_gimp_image_parasite_list
argument_list|(
...
name|printf
argument_list|(
literal|"detach image_parasite NAME:%s:\n"
argument_list|,
name|l_parasite_names
index|[
name|l_idx
