...
begin_comment
comment|/* ============================================================================  * p_convert_indexed_dialog  *  * extra dialog with dither options (when converting to indexed image type)  *   return  0 .. OK   *          -1 .. in case of Error or cancel  * ============================================================================  */
end_comment

begin_function
specifier|static
name|long
DECL|function|p_convert_indexed_dialog (gint32 * dest_colors,gint32 * dest_dither,gint32 * palette_type,gint32 * alpha_dither,gint32 * remove_unused,char * palette,gint len_palette)
name|p_convert_indexed_dialog
parameter_list|(
name|gint32
modifier|*
name|dest_colors
...
name|_
argument_list|(
literal|"Remove unused or double colors\n(is ignored if Palette Type is not custom)"
argument_list|)
expr_stmt|;
name|argv
index|[
...
name|_
argument_list|(
literal|"Convert Frames to Indexed"
argument_list|)
argument_list|,
name|_
argument_list|(
...
name|stderr
argument_list|,
literal|"DEBUG: p_type_convert to INDEXED ncolors=%d, palette_type=%d palette_name=%s'\n"
argument_list|,
operator|(
name|int
operator|)
...
name|FALSE
expr_stmt|;
comment|/* an image without any layer is considered as not flattend */
name|l_layers_list
operator|=
name|gimp_image_get_layers
argument_list|(
...
condition|)
block|{
comment|/* on empty images we need 2 dummies to make flatten happy */
name|l_dummy_layer_id
operator|=
name|gimp_layer_new
argument_list|(
