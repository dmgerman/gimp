...
begin_comment
comment|/* revision history:  * gimp    1.1.11b; 1999/11/20  hof: some cosmetic gtk fixes:  *                                   - allow X-expansion (useful for the scale widgets)  *                                   - use a hbox on WGT_INT_PAIR and WGT_FLT_PAIR  *                                     (reduces the waste of horizontal space  *                                      when used together with other widget types in the table)  * gimp    1.1.5.1; 1999/05/08  hof: call fileselect in gtk+1.2 style   * version 0.96.03; 1998/08/15  hof: p_arr_gtk_init   * version 0.96.01; 1998/07/09  hof: Bugfix: gtk_init should be called only  *                                           once in a plugin process   * version 0.96.00; 1998/07/09  hof: 1.st release   *                                   (re-implementation of gap_sld_dialog.c)  */
end_comment
...
begin_typedef
DECL|struct|__anon2ab36c660108
typedef|typedef
struct|struct
block|{
DECL|member|scale
...
typedef|typedef
struct|struct
DECL|struct|__anon2ab36c660208
block|{
DECL|member|arr_ptr
name|t_arr_arg
modifier|*
...
begin_typedef
DECL|struct|__anon2ab36c660308
typedef|typedef
struct|struct
block|{
DECL|member|dlg
...
specifier|static
name|void
DECL|function|label_create_value (char * title,GtkTable * table,int row,t_arr_arg * arr_ptr)
name|label_create_value
parameter_list|(
name|char
modifier|*
...
specifier|static
name|void
DECL|function|pair_flt_entry_update_cb (GtkWidget * widget,t_arr_arg * arr_ptr)
name|pair_flt_entry_update_cb
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* printf("pair_flt_entry_update_cb: val: %f  lim: %f new_value %f\n", arr_ptr->flt_ret, arr_ptr->flt_ret_lim, new_value);     */
if|if
condition|(
name|arr_ptr
operator|->
...
name|upper
expr_stmt|;
comment|/* if constraint use limit both for entry and scale */
if|if
condition|(
name|arr_ptr
operator|->
...
specifier|static
name|void
DECL|function|pair_flt_scale_update_cb (GtkAdjustment * adjustment,t_arr_arg * arr_ptr)
name|pair_flt_scale_update_cb
parameter_list|(
name|GtkAdjustment
modifier|*
...
index|]
decl_stmt|;
comment|/* printf("pair_flt_scale_update_cb: val: %f  lim: %f  new_value %f\n", arr_ptr->flt_ret, arr_ptr->flt_ret_lim, (float)adjustment->value);     */
if|if
condition|(
name|arr_ptr
operator|->
...
specifier|static
name|void
DECL|function|pair_flt_create_value (t_pair * pair,char * title,GtkTable * table,int row,t_arr_arg * arr_ptr)
name|pair_flt_create_value
parameter_list|(
name|t_pair
modifier|*
...
literal|"%0.2f"
expr_stmt|;
comment|/* use default format */
block|}
else|else
block|{
comment|/* short check if formatstring starts with % and ends with f */
if|if
condition|(
operator|(
operator|*
...
block|}
block|}
comment|/* init the limitied value */
name|arr_ptr
operator|->
name|flt_ret_lim
operator|=
...
argument_list|)
expr_stmt|;
comment|/* gtk_table_attach(table, pair->scale, 2, 3, row, row + 1, GTK_EXPAND | GTK_FILL, GTK_FILL, 0, 0); */
...
argument_list|)
expr_stmt|;
comment|/* gtk_table_attach(GTK_TABLE(table), pair->entry, 1, 2, row, row + 1, GTK_FILL, GTK_FILL, 4, 0); */
if|if
condition|(
name|arr_ptr
operator|->
...
argument_list|)
expr_stmt|;
comment|/*  Horizontal box for entry and scale */
name|hbox
operator|=
name|gtk_hbox_new
argument_list|(
...
specifier|static
name|void
DECL|function|pair_int_entry_update_cb (GtkWidget * widget,t_arr_arg * arr_ptr)
name|pair_int_entry_update_cb
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
argument_list|)
expr_stmt|;
comment|/* printf("pair_int_entry_update_cb: val: %d  lim: %d new_value %d\n", arr_ptr->int_ret, arr_ptr->int_ret_lim, new_value);     */
if|if
condition|(
name|arr_ptr
operator|->
...
specifier|static
name|void
DECL|function|pair_int_scale_update_cb (GtkAdjustment * adjustment,t_arr_arg * arr_ptr)
name|pair_int_scale_update_cb
parameter_list|(
name|GtkAdjustment
modifier|*
name|adjustment
...
index|]
decl_stmt|;
comment|/* printf("pair_int_scale_update_cb: val: %d  lim: %d  new_value %f\n", arr_ptr->int_ret, arr_ptr->int_ret_lim, (float)adjustment->value);     */
if|if
condition|(
name|arr_ptr
operator|->
...
specifier|static
name|void
DECL|function|pair_int_create_value (t_pair * pair,char * title,GtkTable * table,int row,t_arr_arg * arr_ptr)
...
block|{
comment|/* short check if formatstring starts with % and ends with d */
if|if
condition|(
operator|(
operator|*
