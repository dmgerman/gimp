...
begin_function
DECL|function|gethue (struct rgbcolor * rgb)
name|int
name|gethue
parameter_list|(
name|struct
...
name|thissum
expr_stmt|;
comment|/* Color = center pixel - Looks bad... */
comment|/*      r = p->col[ty+brush->height/2][tx+brush->width/2].r;     g = p->col[ty+brush->height/2][tx+brush->width/2].g;     b = p->col[ty+brush->height/2][tx+brush->width/2].b;     */
name|applybrush
argument_list|(
name|brush
argument_list|,
