...
begin_function
DECL|function|reselect (GtkWidget * view,char * fname)
name|void
name|reselect
parameter_list|(
name|GtkWidget
...
begin_function
DECL|function|readdirintolist_real (char * subdir,GtkWidget * view,char * selected)
specifier|static
name|void
