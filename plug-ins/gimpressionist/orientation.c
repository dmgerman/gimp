...
specifier|static
name|void
DECL|function|create_orientmap_dialog_helper (GtkWidget * widget)
...
specifier|static
name|void
DECL|function|create_orientradio_button (GtkWidget * box,int orient_type,const gchar * label,const gchar * help_string,GSList ** radio_group)
