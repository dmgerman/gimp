...
argument_list|()
expr_stmt|;
comment|/*  gtk_widget_set_name (dlg, "gflare"); */
...
specifier|static
name|void
DECL|function|dlg_rescan_callback (GtkWidget * widget,gpointer data)
name|dlg_rescan_callback
parameter_list|(
name|GtkWidget
modifier|*
...
name|g_warning
argument_list|(
literal|"Not found `%s': used `Default' instead."
argument_list|,
name|pvals
operator|.
name|gflare_name
