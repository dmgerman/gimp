...
typedef|typedef
struct|struct
DECL|struct|__anon274a1b540108
block|{
DECL|member|radius
name|gdouble
name|radius
...
typedef|typedef
struct|struct
DECL|struct|__anon274a1b540208
block|{
DECL|member|run
name|gboolean
name|run
...
block|}
block|}
comment|/* Leading has gone off the image and trailing isn't yet in it        * (small image) */
elseif|else
if|if
condition|(
name|output
