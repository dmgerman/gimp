...
typedef|typedef
struct|struct
DECL|struct|__anon2b36b6ed0108
block|{
DECL|member|radius
name|gdouble
name|radius
...
typedef|typedef
struct|struct
DECL|struct|__anon2b36b6ed0208
block|{
DECL|member|run
name|gboolean
name|run
...
specifier|static
name|void
DECL|function|blur_line (const gdouble * cmatrix,const gint cmatrix_length,const guchar * src,guchar * dest,const gint len,const gint bytes)
name|blur_line
parameter_list|(
specifier|const
name|gdouble
