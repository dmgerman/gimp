...
begin_comment
comment|/*  * Exchange one color with the other (settable threshold to convert from  * one color-shade to another...might do wonders on certain images, or be  * totally useless on others).  *   * Author: robert@experimental.net  *   * TODO:  *		- locken van scales met elkaar  */
end_comment

begin_comment
comment|/*   * 1999/03/17   Fixed RUN_NONINTERACTIVE and RUN_WITH_LAST_VALS.   *              There were uninitialized variables.  *                                        --Sven<sven@gimp.org>  */
end_comment
...
typedef|typedef
struct|struct
DECL|struct|__anon2ac913b00108
block|{
DECL|member|fromred
...
specifier|static
name|void
DECL|function|lock_callback (GtkWidget * widget,gpointer data)
name|lock_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|real_exchange (gint x1,gint y1,gint x2,gint y2,gint dopreview)
name|real_exchange
parameter_list|(
name|gint
name|x1
