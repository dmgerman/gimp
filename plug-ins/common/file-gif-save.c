...
typedef|typedef
struct|struct
DECL|struct|__anon27b59e3c0308
block|{
...
specifier|static
name|GimpPDBStatusType
DECL|function|sanity_check (GFile * file,gint32 * image_ID,GimpRunMode run_mode,GError ** error)
name|sanity_check
parameter_list|(
name|GFile
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_image (GFile * file,gint32 image_ID,gint32 drawable_ID,gint32 orig_image_ID,GError ** error)
name|save_image
parameter_list|(
name|GFile
modifier|*
