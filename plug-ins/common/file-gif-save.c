...
typedef|typedef
struct|struct
DECL|struct|__anon2a3011c70208
block|{
...
name|_
argument_list|(
literal|"_Use delay entered above for all frames"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_box_pack_start
...
name|_
argument_list|(
literal|"U_se disposal entered above for all frames"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_box_pack_start
