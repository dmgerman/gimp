...
name|N_
argument_list|(
literal|"This field is a hint for numerical input fields. "
literal|"It specifies how many decimal digits the input field "
literal|"should provide to get approximately the same accuracy as an "
literal|"\"inch\" input field with two decimal digits."
argument_list|)
block|,
name|N_
argument_list|(
literal|"The unit's symbol if it has one (e.g. \"'\" for inches). "
literal|"Use the unit's abbreviation if it doesn't have a symbol."
argument_list|)
block|,
name|N_
argument_list|(
literal|"The unit's abbreviation (e.g. \"cm\" for centimeters)."
argument_list|)
block|,
name|N_
argument_list|(
...
specifier|static
name|GimpUnit
DECL|function|new_unit (GtkWidget * main_dialog,GimpUnit template)
name|new_unit
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|list_init (GtkTreeView * tv)
name|list_init
parameter_list|(
name|GtkTreeView
modifier|*
...
specifier|static
name|void
DECL|function|new_callback (GtkWidget * widget,GtkTreeView * tv)
name|new_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|duplicate_callback (GtkWidget * widget,GtkTreeView * tv)
