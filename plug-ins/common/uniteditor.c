...
literal|"\"inch\" input field with two decimal "
literal|"digits."
argument_list|)
expr_stmt|;
name|help_strings
...
literal|"for inches). Use the unit's abbreviation if "
literal|"it doesn't have a symbol."
argument_list|)
expr_stmt|;
name|help_strings
index|[
...
argument_list|)
expr_stmt|;
comment|/*  eek, passive column titles don't show a tooltip, so the next 3 lines    *  are useless...    */
for|for
control|(
name|i
operator|=
...
name|gimp_help_set_help_data
argument_list|(
name|gtk_clist_get_column_widget
argument_list|(
name|GTK_CLIST
argument_list|(
name|clist
