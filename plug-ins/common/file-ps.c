...
begin_typedef
DECL|typedef|PostScriptClass
typedef|typedef
name|struct
name|_PostScriptClass
name|PostScriptClass
typedef|;
end_typedef

begin_struct
DECL|struct|_PostScript
struct|struct
name|_PostScript
block|{
...
directive|define
name|PS
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), PS_TYPE, PostScript))
end_define
...
specifier|static
name|void
DECL|function|ps_class_init (PostScriptClass * klass)
name|ps_class_init
parameter_list|(
name|PostScriptClass
modifier|*
...
specifier|static
name|void
DECL|function|ps_init (PostScript * ps)
name|ps_init
parameter_list|(
name|PostScript
modifier|*
...
name|GList
modifier|*
DECL|function|ps_query_procedures (GimpPlugIn * plug_in)
name|ps_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|ps_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|ps_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|procedure
argument_list|,
literal|"Loads a small preview from a "
literal|"PostScript or PDF document"
argument_list|,
literal|""
argument_list|,
name|name
...
argument_list|,
literal|"PostScript exporting handles all "
literal|"image types except those with alpha "
literal|"channels."
argument_list|,
name|name
argument_list|)
...
name|procedure
argument_list|,
literal|"Export image as Encapsulated "
literal|"PostScript image"
argument_list|,
literal|"PostScript exporting handles all "
literal|"image types except those with alpha "
literal|"channels."
...
name|GimpValueArray
modifier|*
DECL|function|ps_load (GimpProcedure * procedure,GimpRunMode run_mode,GFile * file,const GimpValueArray * args,gpointer run_data)
name|ps_load
parameter_list|(
name|GimpProcedure
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|ps_save (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,GFile * file,const GimpValueArray * args,gpointer run_data)
name|ps_save
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|gboolean
DECL|function|ascii85_flush (GOutputStream * output,GError ** error)
name|ascii85_flush
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|inline
name|gboolean
DECL|function|ascii85_out (GOutputStream * output,guchar byte,GError ** error)
name|ascii85_out
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|ascii85_nout (GOutputStream * output,gint n,guchar * uptr,GError ** error)
name|ascii85_nout
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|ascii85_done (GOutputStream * output,GError ** error)
name|ascii85_done
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|ps_begin_data (GOutputStream * output,GError ** error)
name|ps_begin_data
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|ps_end_data (GOutputStream * output,GError ** error)
name|ps_end_data
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|void
DECL|function|ps_set_save_size (PSSaveVals * vals,GimpImage * image)
name|ps_set_save_size
parameter_list|(
name|PSSaveVals
modifier|*
...
specifier|static
name|gint
DECL|function|get_bbox (GFile * file,gint * x0,gint * y0,gint * x1,gint * y1)
name|get_bbox
parameter_list|(
name|GFile
modifier|*
...
name|FILE
modifier|*
DECL|function|ps_open (GFile * file,const PSLoadVals * loadopt,gint * llx,gint * lly,gint * urx,gint * ury,gboolean * is_epsf)
name|ps_open
parameter_list|(
name|GFile
modifier|*
...
name|GimpImage
modifier|*
DECL|function|create_new_image (GFile * file,guint pagenum,guint width,guint height,GimpImageBaseType type,GimpLayer ** layer)
name|create_new_image
parameter_list|(
name|GFile
modifier|*
...
name|GimpImage
modifier|*
DECL|function|load_ps (GFile * file,guint pagenum,FILE * ifp,gint llx,gint lly,gint urx,gint ury)
name|load_ps
parameter_list|(
name|GFile
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_ps_header (GOutputStream * output,GFile * file,GError ** error)
name|save_ps_header
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_ps_setup (GOutputStream * output,GimpDrawable * drawable,gint width,gint height,gint bpp,GError ** error)
name|save_ps_setup
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_ps_trailer (GOutputStream * output,GError ** error)
name|save_ps_trailer
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_ps_preview (GOutputStream * output,GimpDrawable * drawable,GError ** error)
name|save_ps_preview
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_gray (GOutputStream * output,GimpImage * image,GimpDrawable * drawable,GError ** error)
name|save_gray
parameter_list|(
name|GOutputStream
modifier|*
...
parameter_list|)
define|\
value|{ gint scan_lines;                                                    \     scan_lines = (i+tile_height-1< height) ? tile_height : (height-i); \     gegl_buffer_get (buffer, GEGL_RECTANGLE (0, i, width, scan_lines),  \                      1.0, format, begin,                                \                      GEGL_AUTO_ROWSTRIDE, GEGL_ABYSS_NONE);             \     src = begin; }
for|for
control|(
name|i
operator|=
...
specifier|static
name|gboolean
DECL|function|save_bw (GOutputStream * output,GimpImage * image,GimpDrawable * drawable,GError ** error)
name|save_bw
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_index (GOutputStream * output,GimpImage * image,GimpDrawable * drawable,GError ** error)
name|save_index
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gint32
DECL|function|count_ps_pages (GFile * file)
name|count_ps_pages
parameter_list|(
name|GFile
modifier|*
