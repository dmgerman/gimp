...
typedef|typedef
struct|struct
DECL|struct|__anon28d324150108
block|{
DECL|member|inner
name|gdouble
name|inner
...
name|invert
condition|)
comment|/* gimp_invert doesn't work properly with previews due to shadow handling      * so reimplement it here - see Bug 557380      */
block|{
name|normalize_invert
argument_list|(
name|drawable
...
specifier|static
name|void
DECL|function|normalize_invert (GimpDrawable * drawable,gboolean normalize,guint maxval,gboolean invert)
name|normalize_invert
parameter_list|(
name|GimpDrawable
modifier|*
