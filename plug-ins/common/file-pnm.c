...
typedef|typedef
struct|struct
DECL|struct|__anon2ae4f1a60108
block|{
DECL|member|raw
name|gint
name|raw
...
specifier|const
struct|struct
DECL|struct|__anon2ae4f1a60208
block|{
DECL|member|name
name|gchar
name|name
...
specifier|static
name|gboolean
DECL|function|save_image (GFile * file,GimpImage * image,GimpDrawable * drawable,gboolean pbm,gboolean float_format,GError ** error)
name|save_image
parameter_list|(
name|GFile
modifier|*
