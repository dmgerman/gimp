...
typedef|typedef
struct|struct
DECL|struct|__anon29208be10108
block|{
...
directive|ifdef
name|SENDMAIL
literal|"Sendmail is used to send emails and must be properly configured."
argument_list|,
else|#
directive|else
comment|/* xdg-email */
literal|"The preferred email composer is used to send emails and must be properly configured."
argument_list|,
endif|#
directive|endif
