...
typedef|typedef
struct|struct
DECL|struct|__anon2a0894950208
block|{
DECL|member|target
...
typedef|typedef
struct|struct
DECL|struct|__anon2a0894950308
block|{
DECL|member|n_pages
name|gint
name|n_pages
...
begin_macro
DECL|function|G_DEFINE_TYPE (Pdf,pdf,GIMP_TYPE_PLUG_IN)
name|G_DEFINE_TYPE
argument_list|(
argument|Pdf
argument_list|,
...
argument_list|,
literal|"Loads files in Adobe's Portable "
literal|"Document Format. PDF is designed to "
literal|"be easily processed by a variety "
literal|"of different platforms, and is a "
...
argument_list|,
literal|"Loads a small preview of the first "
literal|"page of the PDF format file. Uses "
literal|"the embedded thumbnail if present."
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
name|GimpValueArray
modifier|*
DECL|function|pdf_load (GimpProcedure * procedure,GimpRunMode run_mode,GFile * file,const GimpValueArray * args,gpointer run_data)
name|pdf_load
parameter_list|(
name|GimpProcedure
modifier|*
...
name|ngettext
argument_list|(
literal|"PDF document '%1$s' has %3$d page. Page %2$d is out of range."
argument_list|,
...
name|GimpValueArray
modifier|*
DECL|function|pdf_load_thumb (GimpProcedure * procedure,GFile * file,gint size,const GimpValueArray * args,gpointer run_data)
name|pdf_load_thumb
parameter_list|(
name|GimpProcedure
modifier|*
...
name|PopplerDocument
modifier|*
DECL|function|open_document (GFile * file,const gchar * PDF_password,GimpRunMode run_mode,GError ** load_error)
name|open_document
parameter_list|(
name|GFile
modifier|*
...
name|doc
operator|=
name|poppler_document_new_from_gfile
argument_list|(
name|file
argument_list|,
name|PDF_password
...
name|_
argument_list|(
literal|"PDF is password protected, please input the password:"
argument_list|)
argument_list|)
expr_stmt|;
while|while
...
name|_
argument_list|(
literal|"Wrong password! Please input the right one:"
argument_list|)
argument_list|)
expr_stmt|;
...
name|GimpImage
modifier|*
DECL|function|load_image (PopplerDocument * doc,GFile * file,GimpRunMode run_mode,GimpPageSelectorTarget target,guint32 resolution,gboolean antialias,PdfSelectedPages * pages)
name|load_image
parameter_list|(
name|PopplerDocument
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2a0894950408
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2a0894950508
block|{
DECL|member|selector
name|GimpPageSelector
modifier|*
...
begin_comment
comment|/**  * gimp_resolution_entry_attach_label:  * @gre:       The #GimpResolutionEntry you want to add a label to.  * @text:      The text of the label.  * @row:       The row where the label will be attached.  * @column:    The column where the label will be attached.  * @alignment: The horizontal alignment of the label.  *  * Attaches a #GtkLabel to the #GimpResolutionEntry (which is a #GtkGrid).  *  * Returns: A pointer to the new #GtkLabel widget.  **/
end_comment
