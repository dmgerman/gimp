...
typedef|typedef
struct|struct
DECL|struct|__anon2b457d020508
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b457d020608
block|{
DECL|member|hue
name|CML_PARAM
name|hue
...
begin_define
DECL|macro|EXPLORER_TYPE
define|#
directive|define
name|EXPLORER_TYPE
value|(explorer_get_type ())
end_define
...
directive|define
name|EXPLORER
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), EXPLORER_TYPE, Explorer))
end_define

begin_decl_stmt
name|GType
name|explorer_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
name|GList
modifier|*
name|explorer_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
name|plug_in
...
name|GimpProcedure
modifier|*
name|explorer_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
name|plug_in
...
typedef|typedef
struct|struct
DECL|struct|__anon2b457d020708
block|{
DECL|member|widget
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|explorer_class_init (ExplorerClass * klass)
name|explorer_class_init
parameter_list|(
name|ExplorerClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|explorer_init (Explorer * explorer)
name|explorer_init
parameter_list|(
name|Explorer
modifier|*
...
name|GList
modifier|*
DECL|function|explorer_query_procedures (GimpPlugIn * plug_in)
name|explorer_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|explorer_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|explorer_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|N_
argument_list|(
literal|"Create abstract Coupled-Map "
literal|"Lattice patterns"
argument_list|)
argument_list|,
literal|"Make an image of Coupled-Map Lattice "
literal|"(CML). CML is a kind of Cellula "
literal|"Automata on continuous (value) "
literal|"domain. In GIMP_RUN_NONINTERACTIVE, "
literal|"the name of a parameter file is "
literal|"passed as the 4th arg. You can "
literal|"control CML_explorer via parameter "
literal|"file."
argument_list|,
...
name|procedure
argument_list|,
literal|"parameter-uri"
argument_list|,
literal|"Parameter UTI"
argument_list|,
literal|"The local file:// URI of parameter file. "
literal|"CML_explorer makes an image with its settings."
argument_list|,
name|NULL
argument_list|,
...
name|GimpValueArray
modifier|*
DECL|function|explorer_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * _drawable,const GimpValueArray * args,gpointer run_data)
name|explorer_run
parameter_list|(
name|GimpProcedure
modifier|*
