...
begin_comment
comment|/* here's where we actually store our color-table */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* let's walk the tree, and see if it already contains this color */
for|for
control|(
name|node
operator|=
...
block|}
block|}
comment|/* this color was already stored -> update its count */
if|if
condition|(
name|node
condition|)
