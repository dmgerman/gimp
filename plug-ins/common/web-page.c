...
begin_comment
comment|/* Webpage plug-in.  * Copyright (C) 2011 Mukund Sivaraman<muks@banu.com>.  * Portions are copyright of the author of the  * file-open-location-dialog.c code.  *  * TODO:  * - Add a font scale combo: default, larger, smaller etc.  * - Save/restore URL and width  * - Set GIMP as user agent  */
end_comment
