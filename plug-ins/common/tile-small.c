...
typedef|typedef
struct|struct
DECL|struct|__anon2bdc043b0108
block|{
DECL|member|preview
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2bdc043b0308
block|{
DECL|member|type
name|AppliedTo
name|type
...
typedef|typedef
struct|struct
DECL|struct|__anon2bdc043b0408
block|{
DECL|member|htoggle
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Grid for the inner widgets..*/
name|grid
operator|=
name|gtk_grid_new
argument_list|()
...
specifier|static
name|gboolean
DECL|function|tileit_preview_draw (GtkWidget * widget,cairo_t * cr)
name|tileit_preview_draw
parameter_list|(
name|GtkWidget
modifier|*
