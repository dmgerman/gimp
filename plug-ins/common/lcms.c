...
name|GtkWidget
modifier|*
DECL|function|lcms_icc_profile_label_new (cmsHPROFILE src_profile)
...
specifier|static
name|gboolean
DECL|function|lcms_icc_apply_dialog (cmsHPROFILE src_profile,cmsHPROFILE dest_profile,gboolean * dont_ask)
name|lcms_icc_apply_dialog
parameter_list|(
name|cmsHPROFILE
name|src_profile
