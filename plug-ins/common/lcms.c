...
typedef|typedef
struct|struct
DECL|struct|__anon2bcae10d0308
block|{
DECL|member|name
specifier|const
name|gchar
...
specifier|static
name|gboolean
DECL|function|lcms_image_apply (gint32 image,cmsHPROFILE src_profile,cmsHPROFILE dest_profile,const gchar * filename)
name|lcms_image_apply
parameter_list|(
name|gint32
name|image
