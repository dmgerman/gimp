...
typedef|typedef
struct|struct
DECL|struct|__anon2a3dcab90308
block|{
DECL|member|name
specifier|const
name|gchar
...
typedef|typedef
struct|struct
DECL|struct|__anon2a3dcab90408
block|{
DECL|member|intent
...
specifier|static
name|GimpPDBStatusType
DECL|function|lcms_icc_file_info (const gchar * filename,gchar ** name,gchar ** desc,gchar ** info,GError ** error)
name|lcms_icc_file_info
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|cmsHPROFILE
DECL|function|lcms_image_get_profile (GimpColorConfig * config,gint32 image,guchar * checksum,GError ** error)
name|lcms_image_get_profile
parameter_list|(
name|GimpColorConfig
modifier|*
