...
typedef|typedef
struct|struct
DECL|struct|__anon287b28ee0308
block|{
DECL|member|name
specifier|const
name|gchar
...
specifier|static
name|GimpPDBStatusType
DECL|function|lcms_icc_apply (GimpColorConfig * config,GimpRunMode run_mode,gint32 image,const gchar * filename,gboolean * dont_ask)
name|lcms_icc_apply
parameter_list|(
name|GimpColorConfig
modifier|*
...
specifier|static
name|gboolean
DECL|function|lcms_image_apply_profile (gint32 image,cmsHPROFILE src_profile,cmsHPROFILE dest_profile,const gchar * filename)
name|lcms_image_apply_profile
parameter_list|(
name|gint32
name|image
...
specifier|static
name|gboolean
DECL|function|lcms_dialog (GimpColorConfig * config,gint32 image,gboolean apply)
name|lcms_dialog
parameter_list|(
name|GimpColorConfig
modifier|*
