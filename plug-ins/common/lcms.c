...
typedef|typedef
struct|struct
DECL|struct|__anon2ad3380b0308
block|{
DECL|member|name
specifier|const
name|gchar
...
name|GtkWidget
modifier|*
name|lcms_icc_profile_label_new
parameter_list|(
specifier|const
name|gchar
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|lcms_icc_profile_label_new (const gchar * format,...)
name|lcms_icc_profile_label_new
parameter_list|(
specifier|const
name|gchar
...
name|_
argument_list|(
literal|"The image '%s' has an embedded "
literal|"color profile:<b>%s</b>."
argument_list|)
argument_list|,
name|name
argument_list|,
...
name|_
argument_list|(
literal|"Convert it to the default RGB "
literal|"workspace:<b>%s</b> ?"
argument_list|)
argument_list|,
name|desc
argument_list|)
...
name|_
argument_list|(
literal|"Convert to RGB workspace profile?"
argument_list|)
argument_list|,
name|PLUG_IN_BINARY
argument_list|,
