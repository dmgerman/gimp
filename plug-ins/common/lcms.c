...
typedef|typedef
struct|struct
DECL|struct|__anon2af9242d0308
block|{
DECL|member|name
specifier|const
name|gchar
...
typedef|typedef
struct|struct
DECL|struct|__anon2af9242d0408
block|{
DECL|member|intent
...
specifier|static
name|GimpPDBStatusType
DECL|function|lcms_icc_file_info (GFile * file,gchar ** name,gchar ** desc,gchar ** info,GError ** error)
name|lcms_icc_file_info
parameter_list|(
name|GFile
modifier|*
...
specifier|static
name|gboolean
DECL|function|lcms_image_set_profile (gint32 image,cmsHPROFILE profile,GFile * file)
name|lcms_image_set_profile
parameter_list|(
name|gint32
name|image
...
specifier|static
name|gboolean
DECL|function|lcms_image_apply_profile (gint32 image,cmsHPROFILE src_profile,cmsHPROFILE dest_profile,GFile * file,GimpColorRenderingIntent intent,gboolean bpc)
name|lcms_image_apply_profile
parameter_list|(
name|gint32
name|image
