...
specifier|static
name|void
name|lcms_layers_transform_rgb
parameter_list|(
name|gint
modifier|*
name|layers
...
specifier|static
name|void
DECL|function|lcms_layers_transform_rgb (gint * layers,gint num_layers,cmsHPROFILE src_profile,cmsHPROFILE dest_profile,GimpColorRenderingIntent intent,gboolean bpc)
name|lcms_layers_transform_rgb
parameter_list|(
name|gint
modifier|*
