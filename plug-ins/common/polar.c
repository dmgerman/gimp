...
typedef|typedef
struct|struct
DECL|struct|__anon2992718f0108
block|{
DECL|member|circle
name|gdouble
name|circle
...
typedef|typedef
struct|struct
DECL|struct|__anon2992718f0208
block|{
DECL|member|preview
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2992718f0308
block|{
DECL|member|col
DECL|member|row
name|gint
...
specifier|static
name|guchar
DECL|function|bilinear (gdouble x,gdouble y,guchar * values)
name|bilinear
parameter_list|(
name|gdouble
name|x
...
name|pixel_fetcher_t
modifier|*
DECL|function|pixel_fetcher_new (GimpDrawable * drawable)
name|pixel_fetcher_new
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|pixel_fetcher_set_bg_color (pixel_fetcher_t * pf)
name|pixel_fetcher_set_bg_color
parameter_list|(
name|pixel_fetcher_t
modifier|*
...
specifier|static
name|void
DECL|function|pixel_fetcher_get_pixel (pixel_fetcher_t * pf,gint x,gint y,guchar * pixel)
name|pixel_fetcher_get_pixel
parameter_list|(
name|pixel_fetcher_t
modifier|*
