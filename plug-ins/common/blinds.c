...
typedef|typedef
struct|struct
DECL|struct|__anon2b9237d70108
block|{
DECL|member|preview
name|GtkWidget
modifier|*
...
specifier|static
name|gint
DECL|function|blinds_dialog (void)
name|blinds_dialog
parameter_list|(
name|void
parameter_list|)
...
specifier|static
name|void
DECL|function|blinds_radio_update (GtkWidget * widget,gpointer data)
name|blinds_radio_update
parameter_list|(
name|GtkWidget
modifier|*
