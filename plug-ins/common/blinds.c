...
specifier|static
name|gboolean
DECL|function|blinds_dialog (gint32 drawable_id)
name|blinds_dialog
parameter_list|(
name|gint32
name|drawable_id
...
specifier|static
name|void
DECL|function|dialog_update_preview (gpointer drawable_ptr,GimpPreview * preview)
name|dialog_update_preview
parameter_list|(
name|gpointer
name|drawable_ptr
...
specifier|static
name|void
DECL|function|apply_blinds (gint32 drawable_id)
name|apply_blinds
parameter_list|(
name|gint32
name|drawable_id
