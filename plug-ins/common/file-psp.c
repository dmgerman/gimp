...
typedef|typedef
struct|struct
DECL|struct|__anon2b9f44f92008
block|{
DECL|member|width
DECL|member|height
name|guint32
...
typedef|typedef
struct|struct
DECL|struct|__anon2b9f44f92108
block|{
DECL|member|compression
name|PSPCompression
name|compression
...
directive|define
name|PSP
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), PSP_TYPE, Psp))
end_define
...
specifier|static
name|void
DECL|function|psp_class_init (PspClass * klass)
name|psp_class_init
parameter_list|(
name|PspClass
modifier|*
...
specifier|static
name|void
DECL|function|psp_init (Psp * psp)
name|psp_init
parameter_list|(
name|Psp
modifier|*
...
name|GList
modifier|*
DECL|function|psp_query_procedures (GimpPlugIn * plug_in)
name|psp_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
block|list = g_list_append (list, g_strdup (SAVE_PROC));
endif|#
directive|endif
return|return
name|list
...
name|GimpProcedure
modifier|*
DECL|function|psp_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|psp_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|procedure
argument_list|,
literal|"Loads images from the Paint Shop "
literal|"Pro PSP file format"
argument_list|,
literal|"This plug-in loads and exports images "
literal|"in Paint Shop Pro's native PSP format. "
literal|"Vector layers aren't handled. "
literal|"Exporting isn't yet implemented."
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
name|procedure
argument_list|,
literal|"Exports images in the Paint Shop Pro "
literal|"PSP file format"
argument_list|,
literal|"This plug-in loads and exports images "
literal|"in Paint Shop Pro's native PSP format. "
literal|"Vector layers aren't handled. "
...
name|GimpValueArray
modifier|*
DECL|function|psp_load (GimpProcedure * procedure,GimpRunMode run_mode,GFile * file,const GimpValueArray * args,gpointer run_data)
name|psp_load
parameter_list|(
name|GimpProcedure
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|psp_save (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,GFile * file,const GimpValueArray * args,gpointer run_data)
name|psp_save
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|gint
DECL|function|read_creator_block (FILE * f,GimpImage * image,guint total_len,PSPimage * ia,GError ** error)
...
name|GimpLayer
modifier|*
DECL|function|read_layer_block (FILE * f,GimpImage * image,guint total_len,PSPimage * ia,GError ** error)
...
specifier|static
name|gint
DECL|function|read_tube_block (FILE * f,GimpImage * image,guint total_len,PSPimage * ia,GError ** error)
