...
typedef|typedef
struct|struct
DECL|struct|__anon2ad495922008
block|{
DECL|member|width
DECL|member|height
name|guint32
...
typedef|typedef
struct|struct
DECL|struct|__anon2ad495922108
block|{
DECL|member|compression
name|PSPCompression
name|compression
