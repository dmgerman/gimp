...
typedef|typedef
struct|struct
DECL|struct|__anon2aa1dbea2008
block|{
DECL|member|width
DECL|member|height
name|guint32
...
typedef|typedef
struct|struct
DECL|struct|__anon2aa1dbea2108
block|{
DECL|member|compression
name|PSPCompression
name|compression
