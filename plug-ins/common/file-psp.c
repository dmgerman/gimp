...
typedef|typedef
struct|struct
DECL|struct|__anon2af7fe102008
block|{
DECL|member|width
DECL|member|height
name|guint32
...
typedef|typedef
struct|struct
DECL|struct|__anon2af7fe102108
block|{
DECL|member|compression
name|PSPCompression
name|compression
