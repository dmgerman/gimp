...
specifier|static
name|GimpPDBStatusType
DECL|function|save_image (const CompressorEntry * compressor,GFile * file,GimpImage * image,GimpDrawable * drawable,gint32 run_mode,GError ** error)
name|save_image
parameter_list|(
specifier|const
name|CompressorEntry
...
name|GimpImage
modifier|*
DECL|function|load_image (const CompressorEntry * compressor,GFile * file,gint32 run_mode,GimpPDBStatusType * status,GError ** error)
name|load_image
parameter_list|(
specifier|const
name|CompressorEntry
