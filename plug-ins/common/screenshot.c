...
typedef|typedef
struct|struct
DECL|struct|__anon28b774a40208
block|{
...
name|GdkPixbuf
modifier|*
DECL|function|remove_shape (GdkPixbuf * pixbuf,GdkScreen * screen,GdkNativeWindow window,gint offset_x,gint offset_y)
name|remove_shape
parameter_list|(
name|GdkPixbuf
modifier|*
...
specifier|static
name|gint32
DECL|function|create_image (GdkPixbuf * pixbuf)
name|create_image
parameter_list|(
name|GdkPixbuf
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* this string is part of "Wait [spinbutton] seconds before grabbing" */
name|label
operator|=
