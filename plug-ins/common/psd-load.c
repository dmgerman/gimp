...
typedef|typedef
struct|struct
DECL|struct|__anon2c0fdb2a0208
block|{
DECL|member|hRes
name|Fixed
name|hRes
...
specifier|static
struct|struct
DECL|struct|__anon2c0fdb2a0308
block|{
...
name|i
decl_stmt|;
comment|/* Info used for extra data blocks */
name|guchar
name|numpadchars
decl_stmt|;
name|guint32
...
name|g_message
argument_list|(
literal|"Error: invalid number of channels in layer %d: %d"
argument_list|,
name|layernum
argument_list|,
name|layer
...
name|fd
argument_list|,
literal|"layer record extra data block throw"
argument_list|)
expr_stmt|;
operator|(
operator|*
...
argument_list|)
decl_stmt|;
comment|/* The order of these blocks sometimes varies so read all blocks. */
while|while
condition|(
name|totaloff
operator|-
...
name|fd
argument_list|,
literal|"layer extra data block signature"
argument_list|)
expr_stmt|;
name|xdkey
operator|=
...
name|fd
argument_list|,
literal|"layer extra data block key"
argument_list|)
expr_stmt|;
name|xdsize
operator|=
...
name|fd
argument_list|,
literal|"layer extra data block size"
argument_list|)
expr_stmt|;
name|IFDBG
block|{
...
condition|)
block|{
comment|/* luni: Long unicode name */
case|case
literal|0x6c756e69
case|:
if|if
...
name|fd
argument_list|,
literal|"layer extra data block lyid"
argument_list|)
decl_stmt|;
name|IFDBG
name|printf
...
block|}
break|break;
comment|/* iOpa: Layer Fill (opacity?)  */
case|case
literal|0x694f7061
case|:
block|{
...
name|fd
argument_list|,
literal|"layer extra data block fill"
argument_list|)
decl_stmt|;
name|throwchunk
argument_list|(
...
name|fd
argument_list|,
literal|"iOpa: Layer Fill padding throw"
argument_list|)
expr_stmt|;
name|IFDBG
name|printf
...
name|fd
argument_list|,
literal|"lclr: Layer Color padding throw"
argument_list|)
expr_stmt|;
name|IFDBG
block|{
...
name|fd
argument_list|,
literal|"layer extra data block lsct type"
argument_list|)
expr_stmt|;
name|IFDBG
name|printf
...
name|fd
argument_list|,
literal|"layer extra data block lsct"
argument_list|)
expr_stmt|;
name|blendkey
operator|=
...
name|fd
argument_list|,
literal|"lsct: Layer Set Controls throw"
argument_list|)
expr_stmt|;
break|break;
case|case
...
block|}
break|break;
comment|/* lnsr:  Some sort of layer type key. */
case|case
literal|0x6c6e7372
case|:
block|{
...
name|fd
argument_list|,
literal|"layer extra data block lnsr"
argument_list|)
decl_stmt|;
name|IFDBG
block|{
...
block|}
break|break;
comment|/* These 2 contain all of the settings for the different layer styles. */
case|case
literal|0x6c724658
case|:
comment|/* lrFX:  Layer effects settings. */
case|case
literal|0x6c667832
case|:
...
name|fd
argument_list|,
literal|"Skipping Unknown Resource"
argument_list|)
expr_stmt|;
name|offset
operator|+=
...
specifier|static
name|void
DECL|function|decode (long clen,long uclen,const guchar * src,guchar * dst,int step)
name|decode
parameter_list|(
name|long
name|clen
...
specifier|static
name|void
DECL|function|packbitsdecode (long * clenp,long uclen,const guchar * src,guchar * dst,int step)
name|packbitsdecode
parameter_list|(
name|long
modifier|*
...
specifier|static
name|void
DECL|function|cmyk2rgb (const guchar * src,guchar * dst,long width,long height,int alpha)
name|cmyk2rgb
parameter_list|(
specifier|const
name|guchar
...
specifier|static
name|void
DECL|function|cmykp2rgb (const guchar * src,guchar * dst,long width,long height,int alpha)
name|cmykp2rgb
parameter_list|(
specifier|const
name|guchar
...
specifier|static
name|void
DECL|function|bitmap2gray (const guchar * src,guchar * dest,long w,long h)
name|bitmap2gray
parameter_list|(
specifier|const
name|guchar
...
specifier|static
name|void
DECL|function|dumpchunk (size_t n,FILE * fd,const gchar * why)
name|dumpchunk
parameter_list|(
name|size_t
name|n
...
specifier|static
name|void
DECL|function|throwchunk (size_t n,FILE * fd,const gchar * why)
name|throwchunk
parameter_list|(
name|size_t
name|n
...
name|gchar
modifier|*
DECL|function|getstring (size_t n,FILE * fd,const gchar * why)
name|getstring
parameter_list|(
name|size_t
name|n
...
name|gchar
modifier|*
DECL|function|getpascalstring (FILE * fd,const gchar * why)
name|getpascalstring
parameter_list|(
name|FILE
modifier|*
...
name|gchar
modifier|*
DECL|function|getunicodepascalstring (FILE * fd,const gchar * why)
name|getunicodepascalstring
parameter_list|(
name|FILE
modifier|*
...
name|NULL
return|;
comment|/* Looks like these are always padded to an even number. */
name|len
operator|+=
name|len
operator|%
...
argument_list|)
expr_stmt|;
comment|/* Slower but necessary to get correct endianness */
for|for
control|(
name|count
operator|=
...
specifier|static
name|guchar
DECL|function|getguchar (FILE * fd,const gchar * why)
name|getguchar
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|gint16
DECL|function|getgint16 (FILE * fd,const gchar * why)
name|getgint16
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|gint32
DECL|function|getgint32 (FILE * fd,const gchar * why)
name|getgint32
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|void
DECL|function|xfread (FILE * fd,void * buf,long len,const gchar * why)
name|xfread
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|void
DECL|function|xfread_interlaced (FILE * fd,guchar * buf,long len,const gchar * why,gint step)
name|xfread_interlaced
parameter_list|(
name|FILE
modifier|*
