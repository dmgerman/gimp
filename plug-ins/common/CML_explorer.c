...
specifier|static
name|void
DECL|function|CML_save_to_file_response (GtkFileSelection * fs,gint response_id,gpointer data)
name|CML_save_to_file_response
parameter_list|(
name|GtkFileSelection
modifier|*
...
specifier|static
name|void
DECL|function|CML_load_from_file_response (GtkFileSelection * fs,gint response_id,gpointer data)
name|CML_load_from_file_response
parameter_list|(
name|GtkFileSelection
modifier|*
