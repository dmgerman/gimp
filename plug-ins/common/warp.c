...
typedef|typedef
struct|struct
DECL|struct|__anon29a14e270208
block|{
DECL|member|amount
name|gdouble
name|amount
decl_stmt|;
DECL|member|warp_map_id
name|gint
name|warp_map_id
decl_stmt|;
DECL|member|iter
...
directive|define
name|WARP
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), WARP_TYPE, Warp))
end_define
...
specifier|static
name|void
DECL|function|warp_class_init (WarpClass * klass)
name|warp_class_init
parameter_list|(
name|WarpClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|warp_init (Warp * warp)
name|warp_init
parameter_list|(
name|Warp
modifier|*
...
name|GList
modifier|*
DECL|function|warp_query_procedures (GimpPlugIn * plug_in)
name|warp_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|warp_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|warp_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|N_
argument_list|(
literal|"Twist or smear image in many "
literal|"different ways"
argument_list|)
argument_list|,
literal|"Smears an image along vector paths "
literal|"calculated as the gradient of a "
literal|"separate control matrix. The effect "
literal|"can look like brushstrokes of acrylic "
literal|"or watercolor paint, in some cases."
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
name|GimpValueArray
modifier|*
DECL|function|warp_run (GimpProcedure * procedure,GimpRunMode _run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|warp_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|void
DECL|function|diff_prepare_row (GeglBuffer * buffer,const Babl * format,guchar * data,gint x,gint y,gint w)
name|diff_prepare_row
parameter_list|(
name|GeglBuffer
modifier|*
...
name|b
decl_stmt|;
comment|/* y = CLAMP (y, 0, pixel_rgn->h - 1); FIXME? */
...
specifier|static
name|void
DECL|function|diff (GimpDrawable * drawable,GimpDrawable ** xl,GimpDrawable ** yl)
name|diff
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|warp_pixel (GeglBuffer * buffer,const Babl * format,gint width,gint height,gint x1,gint y1,gint x2,gint y2,gint x,gint y,guchar * pixel)
name|warp_pixel
parameter_list|(
name|GeglBuffer
modifier|*
...
specifier|static
name|gboolean
DECL|function|warp_map_constrain (GimpImage * image,GimpItem * item,gpointer data)
name|warp_map_constrain
parameter_list|(
name|GimpImage
modifier|*
