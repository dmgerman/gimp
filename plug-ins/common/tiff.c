...
typedef|typedef
struct|struct
DECL|struct|__anon2af394890108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2af394890208
block|{
DECL|member|run
name|gint
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon2af394890308
block|{
DECL|member|ID
name|gint32
name|ID
...
specifier|static
name|void
DECL|function|read_16bit (guchar * source,channel_data * channel,gushort photomet,gint startrow,gint startcol,gint rows,gint cols,gint alpha,gint extra)
name|read_16bit
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|void
DECL|function|read_8bit (guchar * source,channel_data * channel,gushort photomet,gint startrow,gint startcol,gint rows,gint cols,gint alpha,gint extra)
name|read_8bit
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|void
DECL|function|read_default (guchar * source,channel_data * channel,gushort bps,gushort photomet,gint startrow,gint startcol,gint rows,gint cols,gint alpha,gint extra)
name|read_default
parameter_list|(
name|guchar
modifier|*
