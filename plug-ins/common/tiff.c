...
typedef|typedef
struct|struct
DECL|struct|__anon2a08235e0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2a08235e0208
block|{
DECL|member|ID
name|gint32
name|ID
...
specifier|static
name|void
DECL|function|read_bw (guchar * source,channel_data * channel,gint startrow,gint startcol,gint rows,gint cols,gint align)
name|read_bw
parameter_list|(
name|guchar
modifier|*
