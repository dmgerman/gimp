...
typedef|typedef
struct|struct
DECL|struct|__anon29e122310108
block|{
DECL|member|xcenter
name|gint
name|xcenter
...
typedef|typedef
struct|struct
DECL|struct|__anon29e122310208
block|{
...
begin_comment
comment|/*  *  Update the cross cursor's  coordinates accoding to pvals.[xy]center  *  but do not redraw it.  */
end_comment
