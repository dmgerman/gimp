...
typedef|typedef
struct|struct
DECL|struct|__anon298dc1bb0108
block|{
DECL|member|xcenter
name|gint
name|xcenter
...
typedef|typedef
struct|struct
DECL|struct|__anon298dc1bb0208
block|{
DECL|member|run
name|gint
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon298dc1bb0308
block|{
...
argument_list|)
expr_stmt|;
comment|/*  blend two neighbored spokecolors  */
name|color
operator|=
name|spokecolor
index|[
...
name|gimp_message
argument_list|(
literal|"Sorry, the SuperNova effect\n"
literal|"is broken at the moment and\n"
literal|"has been temporarily disabled."
argument_list|)
expr_stmt|;
endif|#
directive|endif
