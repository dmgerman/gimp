...
typedef|typedef
struct|struct
DECL|struct|__anon2943b9ac0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2943b9ac0208
block|{
...
name|GimpValueArray
modifier|*
DECL|function|film_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|film_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|void
DECL|function|draw_number (GimpLayer * layer,gint num,gint x,gint y,gint height)
name|draw_number
parameter_list|(
name|GimpLayer
modifier|*
...
name|gchar
modifier|*
DECL|function|compose_image_name (GimpImage * image)
name|compose_image_name
parameter_list|(
name|GimpImage
modifier|*
...
name|GtkTreeModel
modifier|*
DECL|function|add_image_list (gboolean add_box_flag,GList * images,GtkWidget * hbox)
name|add_image_list
parameter_list|(
name|gboolean
name|add_box_flag
...
specifier|static
name|void
DECL|function|create_selection_tab (GtkWidget * notebook,GimpImage * image)
...
specifier|static
name|gboolean
DECL|function|film_dialog (GimpImage * image)
name|film_dialog
parameter_list|(
name|GimpImage
modifier|*
