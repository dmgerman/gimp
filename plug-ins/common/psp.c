...
typedef|typedef
struct|struct
DECL|struct|__anon297565c30d08
block|{
DECL|member|width
DECL|member|height
name|guint32
...
typedef|typedef
struct|struct
DECL|struct|__anon297565c30e08
block|{
DECL|member|compression
name|PSPCompression
name|compression
...
typedef|typedef
struct|struct
DECL|struct|__anon297565c30f08
block|{
DECL|member|run
name|gint
name|run
...
argument_list|(
operator|(
literal|"PSP: layer: %s %dx%d (%dx%d) opacity %d blend_mode %d"
operator|,
name|name
operator|,
name|image_rect
...
name|gimp_message
argument_list|(
literal|"PSP: Invalid bitmap type "
...
name|gimp_message
argument_list|(
literal|"PSP: Invalid channel type "
literal|"in channel information chunk"
argument_list|)
expr_stmt|;
name|fclose
