...
typedef|typedef
struct|struct
DECL|struct|__anon2c7facf00d08
block|{
DECL|member|width
DECL|member|height
name|guint32
...
typedef|typedef
struct|struct
DECL|struct|__anon2c7facf00e08
block|{
DECL|member|compression
name|PSPCompression
name|compression
