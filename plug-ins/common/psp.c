...
typedef|typedef
struct|struct
DECL|struct|__anon2945efab0d08
block|{
DECL|member|width
DECL|member|height
name|guint32
...
typedef|typedef
struct|struct
DECL|struct|__anon2945efab0e08
block|{
DECL|member|compression
name|PSPCompression
name|compression
