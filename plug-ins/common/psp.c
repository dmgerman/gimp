...
typedef|typedef
struct|struct
DECL|struct|__anon28fbecd60d08
block|{
DECL|member|width
DECL|member|height
name|guint32
...
typedef|typedef
struct|struct
DECL|struct|__anon28fbecd60e08
block|{
DECL|member|compression
name|PSPCompression
name|compression
...
typedef|typedef
struct|struct
DECL|struct|__anon28fbecd60f08
block|{
DECL|member|run
name|gint
name|run
...
specifier|static
name|void
DECL|function|read_channel_data (FILE * f,PSPCompression compression,guchar ** pixels,guint bytespp,guint offset,GDrawable * drawable,guint32 compressed_len)
