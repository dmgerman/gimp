...
typedef|typedef
struct|struct
DECL|struct|__anon2afc30bf0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2afc30bf0208
block|{
DECL|member|preview
name|GtkWidget
modifier|*
...
name|_
argument_list|(
literal|"_Modify Red/Hue Channel"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_box_pack_start
...
name|_
argument_list|(
literal|"Mo_dify Green/Saturation Channel"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_box_pack_start
...
name|_
argument_list|(
literal|"Mod_ify Blue/Luminance Channel"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_box_pack_start
