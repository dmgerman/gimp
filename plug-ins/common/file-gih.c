...
specifier|static
struct|struct
DECL|struct|__anon2a42b0190108
block|{
DECL|member|spacing
name|guint
name|spacing
...
typedef|typedef
struct|struct
DECL|struct|__anon2a42b0190208
block|{
...
literal|"additionally the layers can be divided into a "
...
specifier|static
name|gboolean
DECL|function|gih_load_one_brush (GInputStream * input,gint32 image_ID,GError ** error)
name|gih_load_one_brush
parameter_list|(
name|GInputStream
modifier|*
...
specifier|static
name|gint32
DECL|function|gih_load_image (GFile * file,GError ** error)
name|gih_load_image
parameter_list|(
name|GFile
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  Attaching name as a parasite */
name|name_parasite
operator|=
...
specifier|static
name|gboolean
DECL|function|gih_save_one_brush (GOutputStream * output,gint32 drawable_ID,GeglRectangle * rect,const gchar * name,GError ** error)
name|gih_save_one_brush
parameter_list|(
name|GOutputStream
modifier|*
...
case|:
comment|/* alpha channel is ignored */
name|format
operator|=
name|babl_format
argument_list|(
...
name|GIMP_RGB_IMAGE
case|:
comment|/* alpha channel is added */
case|case
name|GIMP_RGBA_IMAGE
case|:
name|format
...
specifier|static
name|gboolean
DECL|function|gih_save_image (GFile * file,gint32 image_ID,gint32 orig_image_ID,gint32 drawable_ID,GError ** error)
name|gih_save_image
parameter_list|(
name|GFile
modifier|*
