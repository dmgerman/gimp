...
specifier|static
struct|struct
DECL|struct|__anon2ae156cb0108
block|{
DECL|member|spacing
name|guint
name|spacing
...
typedef|typedef
struct|struct
DECL|struct|__anon2ae156cb0208
block|{
...
specifier|static
name|gboolean
DECL|function|gih_save_one_brush (gint fd,gint32 drawable_ID,GeglRectangle * rect,const gchar * name)
name|gih_save_one_brush
parameter_list|(
name|gint
name|fd
