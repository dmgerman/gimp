...
typedef|typedef
struct|struct
DECL|struct|__anon27a0042f0208
block|{
DECL|member|x
DECL|member|y
name|gint
...
specifier|static
name|void
DECL|function|speedcombo_changed (GtkWidget * scombo,gpointer data)
name|speedcombo_changed
parameter_list|(
name|GtkWidget
modifier|*
