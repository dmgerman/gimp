...
typedef|typedef
struct|struct
DECL|struct|__anon29e6a66b0208
block|{
DECL|member|x
DECL|member|y
name|gint
...
begin_decl_stmt
DECL|variable|message_context_id
specifier|static
name|guint
...
specifier|static
name|void
DECL|function|update_statusbar (void)
name|update_statusbar
parameter_list|(
name|void
parameter_list|)
