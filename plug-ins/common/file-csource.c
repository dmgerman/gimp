...
typedef|typedef
struct|struct
DECL|struct|__anon28d925080108
block|{
...
specifier|static
name|void
DECL|function|csource_class_init (CsourceClass * klass)
...
specifier|inline
name|gboolean
DECL|function|save_uchar (GOutputStream * output,guint * c,guint8 d,Config * config,GError ** error)
name|save_uchar
parameter_list|(
name|GOutputStream
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_image (GFile * file,Config * config,GimpImage * image,GimpDrawable * drawable,GError ** error)
name|save_image
parameter_list|(
name|GFile
modifier|*
...
specifier|static
name|void
DECL|function|rgb565_toggle_button_update (GtkWidget * toggle,gpointer data)
name|rgb565_toggle_button_update
parameter_list|(
name|GtkWidget
modifier|*
name|toggle
...
specifier|static
name|gboolean
DECL|function|save_dialog (Config * config)
name|save_dialog
parameter_list|(
name|Config
modifier|*
