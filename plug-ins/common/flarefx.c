...
typedef|typedef
struct|struct
DECL|struct|__anon28a7bac20108
block|{
DECL|member|posx
name|gint
name|posx
...
typedef|typedef
struct|struct
DECL|struct|__anon28a7bac20208
block|{
...
name|GtkWidget
modifier|*
DECL|function|flare_center_create (GimpDrawable * drawable)
name|flare_center_create
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|gboolean
DECL|function|flare_center_preview_expose (GtkWidget * widget,GdkEvent * event,GimpPreview * preview)
name|flare_center_preview_expose
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|flare_center_preview_events (GtkWidget * widget,GdkEvent * event,GimpPreview * preview)
name|flare_center_preview_events
parameter_list|(
name|GtkWidget
modifier|*
