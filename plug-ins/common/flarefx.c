...
typedef|typedef
struct|struct
DECL|struct|__anon298d09870108
block|{
DECL|member|posx
name|gint
name|posx
...
typedef|typedef
struct|struct
DECL|struct|__anon298d09870208
block|{
DECL|member|run
name|gint
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon298d09870308
block|{
...
specifier|static
name|void
name|flare_show_cursor_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|flare_show_cursor_callback (GtkWidget * widget,gpointer data)
name|flare_show_cursor_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|FlareFX (GDrawable * drawable,gboolean preview_mode)
name|FlareFX
parameter_list|(
name|GDrawable
modifier|*
...
name|preview_scale_y
expr_stmt|;
comment|/* now, we clobber the x1 x2 y1 y2 with the real sizes */
name|x1
operator|=
name|y1
operator|=
