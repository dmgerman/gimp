...
typedef|typedef
struct|struct
DECL|struct|__anon2bcd0dac0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2bcd0dac0208
block|{
DECL|member|ID
name|gint32
name|ID
...
typedef|typedef
struct|struct
DECL|struct|__anon2bcd0dac0308
block|{
DECL|member|o_pages
name|gint
name|o_pages
...
specifier|static
name|void
DECL|function|load_interleaved (TIFF * tif,channel_data * channel,gushort bps,gushort spp,gint extra)
name|load_interleaved
parameter_list|(
name|TIFF
modifier|*
...
name|buffer
decl_stmt|;
comment|/* this does not work - the image data is planar as well */
name|g_printerr
argument_list|(
literal|"GEGL_RECTANGLE (%d, %d, %d, %d)\n"
argument_list|,
name|x
argument_list|,
name|y
