...
typedef|typedef
struct|struct
DECL|struct|__anon2bd0ef240108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2bd0ef240208
block|{
DECL|member|ID
name|gint32
name|ID
...
typedef|typedef
struct|struct
DECL|struct|__anon2bd0ef240308
block|{
DECL|member|o_pages
name|gint
name|o_pages
...
specifier|static
name|void
DECL|function|load_contiguous (TIFF * tif,channel_data * channel,gushort bps,gushort spp,gint extra)
name|load_contiguous
parameter_list|(
name|TIFF
modifier|*
...
specifier|static
name|void
DECL|function|load_separate (TIFF * tif,channel_data * channel,gushort bps,gushort spp,gint extra)
name|load_separate
parameter_list|(
name|TIFF
modifier|*
