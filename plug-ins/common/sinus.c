...
typedef|typedef
struct|struct
DECL|struct|__anon2bfa0f8c0108
block|{
DECL|member|scalex
name|gdouble
name|scalex
...
typedef|typedef
struct|struct
DECL|struct|__anon2bfa0f8c0208
block|{
DECL|member|height
DECL|member|width
name|gint
...
typedef|typedef
struct|struct
DECL|struct|__anon2bfa0f8c0308
block|{
DECL|member|width
name|gint
name|width
...
name|GIMP_PDB_INT32
block|,
literal|"seed_is_time"
block|,
literal|"If set, random number generator is seeded with current time"
block|}
block|}
decl_stmt|;
name|INIT_I18N
