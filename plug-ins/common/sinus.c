...
typedef|typedef
struct|struct
DECL|struct|__anon29c168720108
block|{
DECL|member|scalex
name|gdouble
name|scalex
...
name|col2
decl_stmt|;
DECL|member|seed_is_default
name|gint
name|seed_is_default
decl_stmt|;
...
typedef|typedef
struct|struct
DECL|struct|__anon29c168720208
block|{
DECL|member|height
DECL|member|width
name|gint
...
typedef|typedef
struct|struct
DECL|struct|__anon29c168720308
block|{
DECL|member|width
name|gint
name|width
...
name|GIMP_PDB_INT32
block|,
literal|"seed_is_default"
block|,
literal|"If set, random number generator is seeded with random seed"
block|}
block|}
decl_stmt|;
name|INIT_I18N
...
specifier|static
name|void
DECL|function|sinus_random_update (GObject * unused,GtkWidget * random)
