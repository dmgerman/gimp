...
typedef|typedef
struct|struct
DECL|struct|__anon295313c60108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon295313c60208
block|{
DECL|member|run
name|gint
name|run
...
specifier|static
name|void
DECL|function|oilify_rgb (GimpDrawable * drawable)
name|oilify_rgb
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|oilify_intensity (GimpDrawable * drawable)
name|oilify_intensity
parameter_list|(
name|GimpDrawable
modifier|*
