...
name|p
parameter_list|)
value|((unsigned int) (p[0]*77+p[1]*150+p[2]*29)>> 8)
end_define

begin_typedef
DECL|struct|__anon27b487010108
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon27b487010208
typedef|typedef
struct|struct
block|{
DECL|member|run
...
begin_comment
comment|/*  Oilify interface functions  */
end_comment

begin_function
specifier|static
name|void
DECL|function|oilify_close_callback (GtkWidget * widget,gpointer data)
name|oilify_close_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|oilify_entry_update (GtkWidget * widget,gdouble * value)
name|oilify_entry_update
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|oilify_scale_update (GtkAdjustment * adjustment,gdouble * value)
name|oilify_scale_update
parameter_list|(
name|GtkAdjustment
modifier|*
...
specifier|static
name|void
DECL|function|oilify_toggle_update (GtkWidget * widget,gpointer data)
name|oilify_toggle_update
parameter_list|(
name|GtkWidget
modifier|*
