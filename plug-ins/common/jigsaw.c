...
begin_define
DECL|macro|JIGSAW_TYPE
define|#
directive|define
name|JIGSAW_TYPE
value|(jigsaw_get_type ())
end_define
...
directive|define
name|JIGSAW
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), JIGSAW_TYPE, Jigsaw))
end_define

begin_decl_stmt
name|GType
name|jigsaw_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
specifier|static
name|void
DECL|function|jigsaw_class_init (JigsawClass * klass)
name|jigsaw_class_init
parameter_list|(
name|JigsawClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|jigsaw_init (Jigsaw * jigsaw)
name|jigsaw_init
parameter_list|(
name|Jigsaw
modifier|*
...
name|GList
modifier|*
DECL|function|jigsaw_query_procedures (GimpPlugIn * plug_in)
name|jigsaw_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|jigsaw_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|jigsaw_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|N_
argument_list|(
literal|"Add a jigsaw-puzzle pattern "
literal|"to the image"
argument_list|)
argument_list|,
...
literal|"X"
argument_list|,
literal|"Number of tiles across"
argument_list|,
literal|1
argument_list|,
...
literal|"Blend lines"
argument_list|,
literal|"Number of lines for shading bevels"
argument_list|,
literal|1
argument_list|,
name|GIMP_MAX_IMAGE_SIZE
...
literal|"Blend amount"
argument_list|,
literal|"The power of the light highlights"
argument_list|,
literal|0
argument_list|,
literal|5
...
name|GimpValueArray
modifier|*
DECL|function|jigsaw_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|jigsaw_run
parameter_list|(
name|GimpProcedure
modifier|*
