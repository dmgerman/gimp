...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550608
block|{
DECL|member|xsize
DECL|member|ysize
name|gshort
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550708
block|{
DECL|member|numcol
name|gshort
name|numcol
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550808
block|{
DECL|member|majtype
name|gint
name|majtype
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550908
block|{
DECL|member|type
name|gshort
name|type
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550a08
block|{
DECL|member|type
name|gshort
name|type
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550b08
block|{
DECL|member|com
name|common
name|com
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550c08
block|{
DECL|member|com
name|common
name|com
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550d08
block|{
DECL|member|com
name|common
name|com
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550e08
block|{
DECL|member|com
name|common
name|com
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc550f08
block|{
DECL|member|com
name|common
name|com
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc551008
block|{
DECL|member|com
name|common
name|com
...
typedef|typedef
struct|struct
DECL|struct|__anon29c4fc551108
block|{
DECL|member|v1
DECL|member|v2
name|GimpVector4
...
begin_define
DECL|macro|DESIGNER_TYPE
define|#
directive|define
name|DESIGNER_TYPE
value|(designer_get_type ())
end_define
...
directive|define
name|DESIGNER
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), DESIGNER_TYPE, Designer))
end_define

begin_decl_stmt
name|GType
name|designer_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
name|GList
modifier|*
name|designer_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
name|plug_in
...
name|GimpProcedure
modifier|*
name|designer_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
name|plug_in
...
specifier|static
name|void
DECL|function|designer_class_init (DesignerClass * klass)
name|designer_class_init
parameter_list|(
name|DesignerClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|designer_init (Designer * designer)
name|designer_init
parameter_list|(
name|Designer
modifier|*
...
name|GList
modifier|*
DECL|function|designer_query_procedures (GimpPlugIn * plug_in)
name|designer_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|designer_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|designer_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|N_
argument_list|(
literal|"Create an image of a textured "
literal|"sphere"
argument_list|)
argument_list|,
literal|"This plug-in can be used to create "
literal|"textured and/or bumpmapped spheres, "
literal|"and uses a small lightweight "
literal|"raytracer to perform the task with "
...
argument_list|)
expr_stmt|;
comment|/* Use static seed, to get reproducible results */
for|for
control|(
name|i
operator|=
...
name|GimpValueArray
modifier|*
DECL|function|designer_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|designer_run
parameter_list|(
name|GimpProcedure
modifier|*
