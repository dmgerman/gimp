...
typedef|typedef
struct|struct
DECL|struct|__anon29c2e4b00108
block|{
DECL|member|hwidth
name|gint
name|hwidth
...
specifier|static
name|void
DECL|function|grid (gint32 image_ID,gint32 drawable_ID,GimpPreview * preview)
name|grid
parameter_list|(
name|gint32
name|image_ID
...
specifier|static
name|void
DECL|function|update_preview (GimpPreview * preview,gpointer drawable_ID)
name|update_preview
parameter_list|(
name|GimpPreview
modifier|*
...
specifier|static
name|gint
DECL|function|dialog (gint32 image_ID,gint32 drawable_ID)
name|dialog
parameter_list|(
name|gint32
name|image_ID
