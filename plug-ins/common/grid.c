...
typedef|typedef
struct|struct
DECL|struct|__anon2c4f0eb20108
block|{
DECL|member|hwidth
name|gint
name|hwidth
...
specifier|static
name|guchar
DECL|function|best_cmap_match (guchar * cmap,gint ncolors,GimpRGB * color)
name|best_cmap_match
parameter_list|(
name|guchar
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|preview_widget (gint32 image_ID,GimpDrawable * drawable)
name|preview_widget
parameter_list|(
name|gint32
name|image_ID
...
specifier|static
name|void
DECL|function|fill_preview (GtkWidget * widget,gint32 image_ID,GimpDrawable * drawable)
name|fill_preview
parameter_list|(
name|GtkWidget
modifier|*
