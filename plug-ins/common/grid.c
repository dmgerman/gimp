...
directive|define
name|GRID
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), GRID_TYPE, Grid))
end_define
...
specifier|static
name|void
DECL|function|grid_class_init (GridClass * klass)
name|grid_class_init
parameter_list|(
name|GridClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|grid_init (Grid * grid)
name|grid_init
parameter_list|(
name|Grid
modifier|*
...
name|GList
modifier|*
DECL|function|grid_query_procedures (GimpPlugIn * plug_in)
name|grid_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|grid_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|grid_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
argument_list|)
argument_list|,
literal|"Draws a grid using the specified "
literal|"colors. The grid origin is the "
...
name|GimpValueArray
modifier|*
DECL|function|grid_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|grid_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|void
DECL|function|grid (GimpImage * image,GimpDrawable * drawable,GimpPreview * preview)
name|grid
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|gint
DECL|function|dialog (GimpImage * image,GimpDrawable * drawable)
name|dialog
parameter_list|(
name|GimpImage
modifier|*
