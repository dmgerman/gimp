...
specifier|static
struct|struct
DECL|struct|__anon2afd188e0108
block|{
DECL|member|spacing
name|guint
name|spacing
...
typedef|typedef
struct|struct
DECL|struct|__anon2afd188e0208
block|{
...
specifier|static
name|gboolean
DECL|function|save_one_brush (gint fd,GimpPixelRgn * pixel_rgn)
name|save_one_brush
parameter_list|(
name|gint
name|fd
