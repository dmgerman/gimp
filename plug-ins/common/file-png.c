...
typedef|typedef
struct|struct
DECL|struct|__anon2766f0b00108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2766f0b00208
block|{
DECL|member|run
name|gboolean
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon2766f0b00308
block|{
...
condition|)
block|{
comment|/* This should happen only when using default linear profile            * (no profile explicitly set) or when not exporting to            * PNG_FORMAT_AUTO.            */
name|GimpColorProfile
modifier|*
name|saved_profile
decl_stmt|;
