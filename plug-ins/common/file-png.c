...
typedef|typedef
struct|struct
DECL|struct|__anon28d3e31d0108
block|{
...
specifier|static
name|gboolean
DECL|function|save_image (GFile * file,GimpImage * image,GimpDrawable * drawable,GimpImage * orig_image,GObject * config,gboolean * profile_saved,GError ** error)
name|save_image
parameter_list|(
name|GFile
modifier|*
