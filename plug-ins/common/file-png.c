...
typedef|typedef
struct|struct
DECL|struct|__anon2b5c07b90108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b5c07b90208
block|{
DECL|member|run
name|gboolean
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon2b5c07b90308
block|{
...
specifier|static
name|void
DECL|function|png_class_init (PngClass * klass)
name|png_class_init
parameter_list|(
name|PngClass
modifier|*
...
comment|/* FIXME this is currently broken for NONINTERACTICE until we have    * new default value handling, if simply gets overwritten below    */
name|load_parasite
argument_list|()
expr_stmt|;
switch|switch
...
begin_function
DECL|function|pixformat_changed (GtkWidget * widget,void * foo)
specifier|static
name|void
name|pixformat_changed
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
directive|if
literal|0
block|gtk_adjustment_set_value (pg.compression_level, pngvals.compression_level);   g_signal_connect (pg.compression_level, "value-changed",                     G_CALLBACK (gimp_int_adjustment_update),&pngvals.compression_level);
endif|#
directive|endif
