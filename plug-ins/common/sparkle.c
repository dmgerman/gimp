...
begin_define
DECL|macro|SPARKLE_TYPE
define|#
directive|define
name|SPARKLE_TYPE
value|(sparkle_get_type ())
end_define
...
directive|define
name|SPARKLE
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), SPARKLE_TYPE, Sparkle))
end_define

begin_decl_stmt
name|GType
name|sparkle_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
specifier|static
name|void
DECL|function|sparkle_class_init (SparkleClass * klass)
name|sparkle_class_init
parameter_list|(
name|SparkleClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|sparkle_init (Sparkle * sparkle)
name|sparkle_init
parameter_list|(
name|Sparkle
modifier|*
...
name|GList
modifier|*
DECL|function|sparkle_query_procedures (GimpPlugIn * plug_in)
name|sparkle_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|sparkle_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|sparkle_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|N_
argument_list|(
literal|"Turn bright spots into "
literal|"starry sparkles"
argument_list|)
argument_list|,
literal|"Uses a percentage based luminoisty "
literal|"threhsold to find candidate pixels "
literal|"for adding some sparkles (spikes)."
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
name|procedure
argument_list|,
literal|"John Beale,& (ported to GIMP v0.54) "
literal|"Michael J. Hammel& ted to GIMP v1.0) "
literal|"& Seth Burgess& Spencer Kimball"
argument_list|,
literal|"John Beale"
argument_list|,
...
literal|"Color type"
argument_list|,
literal|"Color of sparkles: { NATURAL (0), "
literal|"FOREGROUND (1), BACKGROUND (2) }"
argument_list|,
literal|0
argument_list|,
literal|2
...
name|GimpValueArray
modifier|*
DECL|function|sparkle_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|sparkle_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|void
DECL|function|sparkle_preview (GimpDrawable * drawable,GimpPreview * preview)
name|sparkle_preview
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|inline
name|void
DECL|function|rpnt (GeglBuffer * dest_buffer,const Babl * format,gint x1,gint y1,gint x2,gint y2,gdouble xr,gdouble yr,gint bytes,gdouble inten,guchar color[MAX_CHANNELS],guchar * dest_buf)
name|rpnt
parameter_list|(
name|GeglBuffer
modifier|*
...
specifier|static
name|void
DECL|function|fspike (GeglBuffer * src_buffer,GeglBuffer * dest_buffer,const Babl * format,gint bytes,gint x1,gint y1,gint x2,gint y2,gint xr,gint yr,gdouble inten,gdouble length,gdouble angle,GRand * gr,guchar * dest_buf)
name|fspike
parameter_list|(
name|GeglBuffer
modifier|*
