...
typedef|typedef
struct|struct
DECL|struct|__anon27df5d3c0108
block|{
...
specifier|static
name|gboolean
DECL|function|sparkle_dialog (gint32 drawable_ID)
name|sparkle_dialog
parameter_list|(
name|gint32
name|drawable_ID
...
specifier|static
name|gint
DECL|function|compute_lum_threshold (gint32 drawable_ID,gdouble percentile)
name|compute_lum_threshold
parameter_list|(
name|gint32
name|drawable_ID
...
specifier|static
name|void
DECL|function|sparkle (gint32 drawable_ID,GimpPreview * preview)
name|sparkle
parameter_list|(
name|gint32
name|drawable_ID
...
specifier|static
name|void
DECL|function|sparkle_preview (gpointer drawable_ID,GimpPreview * preview)
name|sparkle_preview
parameter_list|(
name|gpointer
name|drawable_ID
