...
begin_function
DECL|function|unsharp_mask_dialog ()
specifier|static
name|gint
name|unsharp_mask_dialog
parameter_list|()
...
begin_function
DECL|function|unsharp_cancel_callback (GtkWidget * widget,gpointer data)
specifier|static
name|void
name|unsharp_cancel_callback
parameter_list|(
...
begin_comment
comment|/* delete_event */
end_comment

begin_function
DECL|function|delete_event (GtkWidget * widget,GdkEvent * event,gpointer data)
name|gboolean
name|delete_event
parameter_list|(
name|GtkWidget
...
begin_function
DECL|function|destroy (GtkWidget * widget,gpointer data)
name|void
name|destroy
parameter_list|(
name|GtkWidget
