...
begin_comment
comment|/* SVG loading file filter for the GIMP  * (C) Copyright 2003  Dom Lachowicz<cinamod@hotmail.com>  *  * Largely rewritten by Sven Neumann<sven@gimp.org>  */
end_comment
...
typedef|typedef
struct|struct
DECL|struct|__anon28d0978a0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon28d0978a0208
block|{
DECL|member|run
name|gboolean
name|run
...
specifier|static
name|void
DECL|function|load_get_size_callback (gint * width,gint * height,gpointer data)
name|load_get_size_callback
parameter_list|(
name|gint
modifier|*
name|width
...
begin_decl_stmt
DECL|variable|resolution_dependant
specifier|static
name|gboolean
name|resolution_dependant
init|=
name|FALSE
decl_stmt|;
end_decl_stmt
...
specifier|static
name|void
DECL|function|load_resolution_callback (GimpSizeEntry * res,GimpSizeEntry * size)
name|load_resolution_callback
parameter_list|(
name|GimpSizeEntry
modifier|*
name|res
