...
begin_define
DECL|macro|SVG_BUFFER_SIZE
define|#
directive|define
name|SVG_BUFFER_SIZE
value|(8 * 1024)
end_define
...
typedef|typedef
struct|struct
DECL|struct|__anon2943baba0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2943baba0208
block|{
DECL|member|run
name|gboolean
name|run
...
specifier|static
name|void
DECL|function|load_size_callback (gint * width,gint * height,gpointer data)
name|load_size_callback
parameter_list|(
name|gint
modifier|*
name|width
