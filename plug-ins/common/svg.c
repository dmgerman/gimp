...
typedef|typedef
struct|struct
DECL|struct|__anon2ab1410d0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2ab1410d0208
block|{
DECL|member|run
name|gboolean
name|run
...
begin_comment
comment|/*  This is the callback used from load_rsvg_size().  */
end_comment
...
specifier|static
name|void
DECL|function|load_dialog_ok_callback (GtkWidget * widget,gpointer data)
name|load_dialog_ok_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
