...
begin_comment
comment|/**  * aa.c version 1.0  * A plugin that uses libaa (ftp://ftp.ta.jcu.cz/pub/aa) to * save images as  * ASCII.  * NOTE: This plugin *requires* aalib 1.1.5 or later. Earlier versions will  * not work.  * Code copied from all over the GIMP source.  * Tim Newsome<nuisance@cmu.edu>  */
end_comment
