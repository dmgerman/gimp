...
typedef|typedef
struct|struct
DECL|struct|__anon2781beed0108
block|{
...
argument_list|,
literal|"This plug-in saves Portable Network Graphics (PNG) files. "
literal|"This procedure adds an extra parameter to file_png_save that allows to control whether transparent pixels are saved or nullified"
argument_list|,
literal|"Michael Sweet<mike@easysw.com>, Daniel Skarda<0rfelyus@atrey.karlin.mff.cuni.cz>"
argument_list|,
literal|"Michael Sweet<mike@easysw.com>, Daniel Skarda<0rfelyus@atrey.karlin.mff.cuni.cz>, Nick Lamb<njl195@zepler.org.uk>"
...
name|_
argument_list|(
literal|"Save Color Values From Transparent Pixels"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_table_attach
