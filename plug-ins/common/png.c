...
typedef|typedef
struct|struct
DECL|struct|__anon29bcadc80108
block|{
...
begin_function
DECL|function|respin_cmap (png_structp pp,png_infop info,gint32 image_ID,GimpDrawable * drawable)
specifier|static
name|void
name|respin_cmap
parameter_list|(
...
literal|1
condition|)
comment|/* we have a winner for a transparent                             * index */
block|{
name|GimpRGB
name|color
decl_stmt|;
...
name|g_print
argument_list|(
literal|"PNG: Copying from index 0 to index %d of \"before\" "
argument_list|,
name|transparent
operator|-
literal|1
...
name|g_print
argument_list|(
literal|"to index 1 to index %d of \"after\".\n"
argument_list|,
name|transparent
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* We need a check that transparent != colors - 1 */
if|if
condition|(
name|transparent
operator|<
...
name|g_print
argument_list|(
literal|"PNG: Copying from index %d to index %d of \"before\" "
argument_list|,
name|transparent
operator|+
literal|1
...
name|g_print
argument_list|(
literal|"to index %d to index %d of \"after\".\n"
argument_list|,
name|transparent
operator|+
literal|1
...
name|g_print
argument_list|(
literal|"PNG: Copying from index %d of \"before\" "
argument_list|,
name|transparent
argument_list|)
expr_stmt|;
