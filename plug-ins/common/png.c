...
typedef|typedef
struct|struct
DECL|struct|__anon275c9f510108
block|{
...
condition|)
block|{
comment|/* It's not really a VERY evil hack, right? -- ruth */
name|png_set_tRNS
argument_list|(
name|pp
argument_list|,
...
begin_function
DECL|function|respin_cmap (gint32 image_ID,gint * colors)
specifier|static
name|guchar
modifier|*
name|respin_cmap
