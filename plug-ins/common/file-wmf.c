...
typedef|typedef
struct|struct
DECL|struct|__anon28e457a10108
block|{
...
directive|define
name|WMF
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), WMF_TYPE, Wmf))
end_define
...
specifier|static
name|void
DECL|function|wmf_class_init (WmfClass * klass)
name|wmf_class_init
parameter_list|(
name|WmfClass
modifier|*
...
specifier|static
name|void
DECL|function|wmf_init (Wmf * wmf)
name|wmf_init
parameter_list|(
name|Wmf
modifier|*
...
name|GList
modifier|*
DECL|function|wmf_query_procedures (GimpPlugIn * plug_in)
name|wmf_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|wmf_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|wmf_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
literal|"Resolution"
argument_list|,
literal|"Resolution to use for rendering the WMF"
argument_list|,
...
literal|"Width"
argument_list|,
literal|"Width (in pixels) to load the WMF in, "
...
literal|"Height"
argument_list|,
literal|"Height (in pixels) to load the WMF in, "
literal|"0 for original height"
argument_list|,
literal|0
argument_list|,
name|GIMP_MAX_IMAGE_SIZE
...
name|GimpValueArray
modifier|*
DECL|function|wmf_load (GimpProcedure * procedure,GimpRunMode run_mode,GFile * file,const GimpValueArray * args,gpointer run_data)
name|wmf_load
parameter_list|(
name|GimpProcedure
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|wmf_load_thumb (GimpProcedure * procedure,GFile * file,gint size,const GimpValueArray * args,gpointer run_data)
name|wmf_load_thumb
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|gboolean
DECL|function|load_wmf_size (GFile * file,WmfLoadVals * vals)
name|load_wmf_size
parameter_list|(
name|GFile
modifier|*
...
name|guchar
modifier|*
DECL|function|wmf_get_pixbuf (GFile * file,gint * width,gint * height)
name|wmf_get_pixbuf
parameter_list|(
name|GFile
modifier|*
...
name|guchar
modifier|*
DECL|function|wmf_load_file (GFile * file,guint * width,guint * height,GError ** error)
name|wmf_load_file
parameter_list|(
name|GFile
modifier|*
