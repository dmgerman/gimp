...
typedef|typedef
struct|struct
DECL|struct|__anon27bab3fc0208
block|{
DECL|member|run
name|gboolean
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon27bab3fc0308
block|{
...
specifier|static
name|void
DECL|function|iwarp_preview_build (GtkWidget * vbox)
name|iwarp_preview_build
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|iwarp_response (GtkWidget * widget,gint response_id,gpointer data)
name|iwarp_response
parameter_list|(
name|GtkWidget
modifier|*
