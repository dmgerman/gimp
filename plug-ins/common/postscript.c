...
index|[]
init|=
literal|"@(#) GIMP PostScript/PDF file-plugin v1.13  07-Apr-2002"
decl_stmt|;
end_decl_stmt
...
typedef|typedef
struct|struct
DECL|struct|__anon2b0a29e80108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b0a29e80208
block|{
DECL|member|run
name|gint
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon2b0a29e80308
block|{
DECL|member|width
DECL|member|height
name|gdouble
...
typedef|typedef
struct|struct
DECL|struct|__anon2b0a29e80408
block|{
DECL|member|run
name|gint
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon2b0a29e80508
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b0a29e80608
block|{
DECL|member|eol
name|long
name|eol
...
literal|""
argument_list|,
literal|"0,string,%!,0,string,%PDF,0,long,0xc5d0d3c6"
argument_list|)
expr_stmt|;
...
name|g_strdup_printf
argument_list|(
literal|"%s -sDEVICE=%s -r%d %s%s%s-q -dNOPAUSE %s \ -sOutputFile=%s %s-f %s %s-c quit"
argument_list|,
name|gs
argument_list|,
name|driver
