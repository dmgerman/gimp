...
specifier|static
name|gboolean
DECL|function|load_dialog (const gchar * filename,TiffSelectedPages * pages)
name|load_dialog
parameter_list|(
specifier|const
name|gchar
...
argument_list|)
expr_stmt|;
comment|/* Return early if we're not running interactively */
if|if
condition|(
name|run_mode
operator|!=
...
return|;
block|}
comment|/* Return early if there are zero or one `pages' in the TIFF image */
if|if
condition|(
name|pages
operator|->
...
specifier|static
name|gint32
DECL|function|load_image (const gchar * filename,TiffSelectedPages * pages)
name|load_image
parameter_list|(
specifier|const
name|gchar
