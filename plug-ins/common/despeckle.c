...
typedef|typedef
struct|struct
DECL|struct|__anon29fc8e460208
block|{
...
condition|)
block|{
comment|/* Make sure Svm is ininialized to a sufficient large value */
name|med
operator|=
operator|-
literal|1
...
specifier|static
name|gint
DECL|function|quick_median_select (guchar ** p,guchar * i,gint n)
name|quick_median_select
parameter_list|(
name|guchar
modifier|*
