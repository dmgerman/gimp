...
typedef|typedef
struct|struct
DECL|struct|__anon2c8500fc0108
block|{
DECL|member|elems
name|guchar
modifier|*
...
specifier|static
specifier|inline
DECL|function|list_add_elem (PixelsList * list,guchar * elem)
name|void
name|list_add_elem
parameter_list|(
name|PixelsList
...
typedef|typedef
struct|struct
DECL|struct|__anon2c8500fc0208
block|{
DECL|member|elems
name|gint
name|elems
...
specifier|inline
name|void
DECL|function|histogram_add (DespeckleHistogram * hist,guchar val,guchar * orig)
name|histogram_add
parameter_list|(
name|DespeckleHistogram
modifier|*
...
name|guchar
modifier|*
DECL|function|histogram_get_median (DespeckleHistogram * hist,guchar * _default)
...
specifier|inline
name|void
DECL|function|add_val (DespeckleHistogram * hist,guchar * src,gint width,gint bpp,gint x,gint y)
name|add_val
parameter_list|(
name|DespeckleHistogram
modifier|*
...
specifier|inline
name|void
DECL|function|del_val (DespeckleHistogram * hist,guchar * src,gint width,gint bpp,gint x,gint y)
name|del_val
parameter_list|(
name|DespeckleHistogram
modifier|*
...
specifier|inline
name|void
DECL|function|add_vals (DespeckleHistogram * hist,guchar * src,gint width,gint bpp,gint xmin,gint ymin,gint xmax,gint ymax)
name|add_vals
parameter_list|(
name|DespeckleHistogram
modifier|*
...
specifier|inline
name|void
DECL|function|del_vals (DespeckleHistogram * hist,guchar * src,gint width,gint bpp,gint xmin,gint ymin,gint xmax,gint ymax)
name|del_vals
parameter_list|(
name|DespeckleHistogram
modifier|*
...
specifier|inline
name|void
DECL|function|update_histogram (DespeckleHistogram * hist,guchar * src,gint width,gint bpp,gint xmin,gint ymin,gint xmax,gint ymax)
...
argument_list|)
expr_stmt|;
comment|//  del_vals (hist, src, width, bpp, xmax + 1, hist->ymin, hist->xmax, hist->ymax); // only when moving down (for x for y)
name|del_vals
argument_list|(
name|hist
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// only when moving right (for y for x)
comment|//  add_vals (hist, src, width, bpp, xmin, ymin, hist->xmin - 1, ymax); // only when moving down (for x for y)
name|add_vals
argument_list|(
name|hist
argument_list|,
