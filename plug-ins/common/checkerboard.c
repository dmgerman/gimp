...
typedef|typedef
struct|struct
DECL|struct|__anon28e2740b0108
block|{
DECL|member|fg
name|guchar
name|fg
...
specifier|static
name|void
DECL|function|do_checkerboard_pattern (gint32 drawable_ID,GimpPreview * preview)
name|do_checkerboard_pattern
parameter_list|(
name|gint32
name|drawable_ID
...
specifier|static
name|void
DECL|function|do_checkerboard_preview (gpointer drawable_ID,GimpPreview * preview)
name|do_checkerboard_preview
parameter_list|(
name|gpointer
name|drawable_ID
...
specifier|static
name|gboolean
DECL|function|checkerboard_dialog (gint32 image_ID,gint32 drawable_ID)
name|checkerboard_dialog
parameter_list|(
name|gint32
name|image_ID
