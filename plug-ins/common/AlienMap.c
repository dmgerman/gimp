...
typedef|typedef
struct|struct
DECL|struct|__anon29a8f2c80108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29a8f2c80208
block|{
DECL|member|preview
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|transform (guchar * r,guchar * g,guchar * b,double redstretch,double greenstretch,double bluestretch)
name|transform
parameter_list|(
name|guchar
modifier|*
