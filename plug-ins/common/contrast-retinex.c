...
typedef|typedef
struct|struct
DECL|struct|__anon29f617440108
block|{
DECL|member|scale
name|gint
name|scale
...
typedef|typedef
struct|struct
DECL|struct|__anon29f617440308
block|{
DECL|member|N
name|gint
name|N
...
begin_define
DECL|macro|RETINEX_TYPE
define|#
directive|define
name|RETINEX_TYPE
value|(retinex_get_type ())
end_define
...
directive|define
name|RETINEX
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), RETINEX_TYPE, Retinex))
end_define

begin_decl_stmt
name|GType
name|retinex_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
specifier|static
name|void
DECL|function|retinex_class_init (RetinexClass * klass)
name|retinex_class_init
parameter_list|(
name|RetinexClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|retinex_init (Retinex * retinex)
name|retinex_init
parameter_list|(
name|Retinex
modifier|*
...
name|GList
modifier|*
DECL|function|retinex_query_procedures (GimpPlugIn * plug_in)
name|retinex_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|retinex_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|retinex_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|N_
argument_list|(
literal|"Enhance contrast using the "
literal|"Retinex method"
argument_list|)
argument_list|,
literal|"The Retinex Image Enhancement "
literal|"Algorithm is an automatic image "
literal|"enhancement method that enhances "
literal|"a digital image in terms of dynamic "
literal|"range compression, color independence "
literal|"from the spectral distribution of the "
literal|"scene illuminant, and color/lightness "
literal|"rendition."
argument_list|,
name|name
argument_list|)
...
name|GimpValueArray
modifier|*
DECL|function|retinex_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|retinex_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|void
DECL|function|retinex_preview (GimpDrawable * drawable,GimpPreview * preview)
name|retinex_preview
parameter_list|(
name|GimpDrawable
modifier|*
