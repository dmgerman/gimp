...
specifier|static
name|gint
DECL|function|gpb_save_dialog (void)
...
specifier|static
name|gboolean
DECL|function|save_one_gpb (FILE * file,GimpPixelRgn * pixel_rgn,int index,int total)
name|save_one_gpb
parameter_list|(
name|FILE
modifier|*
