...
directive|define
name|HOT
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), HOT_TYPE, Hot))
end_define
...
specifier|static
name|void
DECL|function|hot_class_init (HotClass * klass)
name|hot_class_init
parameter_list|(
name|HotClass
modifier|*
...
specifier|static
name|void
DECL|function|hot_init (Hot * hot)
name|hot_init
parameter_list|(
name|Hot
modifier|*
...
name|GList
modifier|*
DECL|function|hot_query_procedures (GimpPlugIn * plug_in)
name|hot_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|hot_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|hot_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|N_
argument_list|(
literal|"Find and fix pixels that may "
literal|"be unsafely bright"
argument_list|)
argument_list|,
literal|"hot scans an image for pixels that "
literal|"will give unsave values of "
literal|"chrominance or composite signale "
literal|"amplitude when encoded into an NTSC "
literal|"or PAL signal. Three actions can be "
literal|"performed on these 'hot' pixels. "
literal|"(0) reduce luminance, "
literal|"(1) reduce saturation, or (2) Blacken."
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
literal|"Action"
argument_list|,
literal|"Action { (0) reduce luminance, "
literal|"(1) reduce saturation, or (2) Blacken }"
argument_list|,
literal|0
argument_list|,
...
name|GimpValueArray
modifier|*
DECL|function|hot_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|hot_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|gboolean
DECL|function|pluginCore (GimpImage * image,GimpDrawable * drawable,piArgs * argp)
name|pluginCore
parameter_list|(
name|GimpImage
modifier|*
