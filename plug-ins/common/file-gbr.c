...
typedef|typedef
struct|struct
DECL|struct|__anon2936acd00108
block|{
...
name|GimpValueArray
modifier|*
DECL|function|gbr_save (GimpProcedure * procedure,GimpRunMode run_mode,gint32 image_id,gint32 drawable_id,GFile * file,const GimpValueArray * args,gpointer run_data)
name|gbr_save
parameter_list|(
name|GimpProcedure
modifier|*
