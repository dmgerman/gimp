...
typedef|typedef
struct|struct
DECL|struct|__anon295d84450108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon295d84450208
block|{
DECL|member|run
name|gint
name|run
...
specifier|static
name|void
name|shift_amount_update_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|shift (GimpDrawable * drawable)
name|shift
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|gint
DECL|function|shift_dialog (gint32 image_ID)
name|shift_dialog
parameter_list|(
name|gint32
name|image_ID
...
specifier|static
name|void
DECL|function|shift_amount_update_callback (GtkWidget * widget,gpointer data)
name|shift_amount_update_callback
parameter_list|(
name|GtkWidget
modifier|*
...
name|GimpTile
modifier|*
DECL|function|shift_pixel (GimpDrawable * drawable,GimpTile * tile,gint x1,gint y1,gint x2,gint y2,gint x,gint y,gint * row,gint * col,guchar * pixel)
name|shift_pixel
parameter_list|(
name|GimpDrawable
modifier|*
