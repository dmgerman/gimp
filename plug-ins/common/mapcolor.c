...
typedef|typedef
struct|struct
DECL|struct|__anon279498c30108
block|{
DECL|member|colors
name|GimpRGB
name|colors
...
condition|)
block|{
comment|/*  For this channel, both source color values are the same.  */
comment|/*  Map everything below to the start of the destination range. */
for|for
control|(
name|i
operator|=
...
expr_stmt|;
block|}
comment|/*  Map source color to the middle of the destination range. */
name|colormap
index|[
name|rgb
index|]
...
literal|2
expr_stmt|;
comment|/*  Map everything above to the end of the destination range. */
for|for
control|(
name|i
operator|=
