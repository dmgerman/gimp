...
literal|"Compression"
argument_list|,
literal|"PNG deflate compression level"
argument_list|,
literal|0
argument_list|,
literal|9
...
specifier|static
name|gboolean
DECL|function|mng_save_image (const gchar * filename,GimpImage * image,GimpDrawable * drawable,GimpImage * original_image,GError ** error)
name|mng_save_image
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|gboolean
DECL|function|mng_save_dialog (GimpImage * image)
name|mng_save_dialog
parameter_list|(
name|GimpImage
modifier|*
