...
name|procedure
argument_list|,
literal|"Loads files of Compuserve GIF "
literal|"file format"
argument_list|,
...
name|procedure
argument_list|,
literal|"Loads only the first frame of a "
literal|"GIF image, to be "
...
name|GimpValueArray
modifier|*
DECL|function|gif_load (GimpProcedure * procedure,GimpRunMode run_mode,GFile * file,const GimpValueArray * args,gpointer run_data)
name|gif_load
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
struct|struct
DECL|struct|__anon2a1d556d0108
block|{
DECL|member|Width
name|guint
name|Width
...
specifier|static
struct|struct
DECL|struct|__anon2a1d556d0208
block|{
