...
typedef|typedef
struct|struct
DECL|struct|__anon2ac4bdf90108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2ac4bdf90208
block|{
...
specifier|static
name|void
DECL|function|tile_chain_button_update (GtkWidget * widget,gpointer data)
name|tile_chain_button_update
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|tile_adjustment_update (GtkAdjustment * adjustment,gpointer data)
name|tile_adjustment_update
parameter_list|(
name|GtkAdjustment
modifier|*
