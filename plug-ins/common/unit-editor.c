...
typedef|typedef
struct|struct
DECL|struct|__anon292e66c50208
block|{
DECL|member|title
specifier|const
name|gchar
...
begin_define
DECL|macro|EDITOR_TYPE
define|#
directive|define
name|EDITOR_TYPE
value|(editor_get_type ())
end_define
...
directive|define
name|EDITOR
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), EDITOR_TYPE, Editor))
end_define

begin_decl_stmt
name|GType
name|editor_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
specifier|static
name|void
DECL|function|editor_class_init (EditorClass * klass)
name|editor_class_init
parameter_list|(
name|EditorClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|editor_init (Editor * editor)
name|editor_init
parameter_list|(
name|Editor
modifier|*
...
name|GList
modifier|*
DECL|function|editor_query_procedures (GimpPlugIn * plug_in)
name|editor_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|editor_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|editor_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|editor_run (GimpProcedure * procedure,const GimpValueArray * args,gpointer run_data)
name|editor_run
parameter_list|(
name|GimpProcedure
modifier|*
