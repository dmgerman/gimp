...
typedef|typedef
struct|struct
DECL|struct|__anon2b15f54e0208
block|{
DECL|member|matrix
name|gfloat
name|matrix
...
begin_struct
struct|struct
DECL|struct|__anon2b15f54e0308
block|{
DECL|member|matrix
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  The plug-in is not able to handle images smaller than 3 pixels  */
if|if
condition|(
name|drawable
operator|->
...
specifier|static
name|void
DECL|function|convmatrix (GimpDrawable * drawable,GimpPreview * preview)
name|convmatrix
parameter_list|(
name|GimpDrawable
modifier|*
