...
typedef|typedef
struct|struct
DECL|struct|__anon29cceed70408
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29cceed70508
block|{
DECL|member|images
name|gint32
name|images
...
typedef|typedef
struct|struct
DECL|struct|__anon29cceed70608
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29cceed70808
block|{
DECL|member|thumb
name|GdkPixbuf
modifier|*
...
block|,
literal|"Layers as pages (bottom layers first). TRUE or FALSE"
block|}
block|,
block|{
name|GIMP_PDB_INT32
...
block|,
literal|"Reverse the pages order (top layers first). TRUE or FALSE"
block|}
block|}
decl_stmt|;
...
begin_function
DECL|function|draw_layer (gint32 * layers,gint n_layers,gint * j,gint * nreturn_vals,cairo_surface_t * pdf_file,cairo_t * cr,FILE * fp,GimpParam * values,gdouble x_res,gdouble y_res,const gchar * name,GError * error)
specifier|static
name|void
name|draw_layer
parameter_list|(
