...
DECL|typedef|GimpPluginPDFError
block|}
name|GimpPluginPDFError
typedef|;
end_typedef
...
block|,
DECL|enumerator|SA_REVERSE_ORDER
name|SA_REVERSE_ORDER
...
directive|define
name|PDF
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), PDF_TYPE, Pdf))
end_define
...
specifier|static
name|void
DECL|function|pdf_init (Pdf * pdf)
name|pdf_init
parameter_list|(
name|Pdf
modifier|*
...
name|GList
modifier|*
DECL|function|pdf_query_procedures (GimpPlugIn * plug_in)
name|pdf_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|pdf_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|pdf_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
argument_list|,
literal|"Saves files in Adobe's Portable "
literal|"Document Format. PDF is designed to "
literal|"be easily processed by a variety of "
literal|"different platforms, and is a "
literal|"distant cousin of PostScript."
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
literal|"Apply masks"
argument_list|,
literal|"Apply layer masks before saving (Keeping them "
literal|"will not change the output),"
argument_list|,
name|TRUE
argument_list|,
name|G_PARAM_READWRITE
...
literal|"Layers as pages"
argument_list|,
literal|"Layers as pages (bottom layers first)."
argument_list|,
name|FALSE
argument_list|,
name|G_PARAM_READWRITE
...
literal|"Reverse order"
argument_list|,
literal|"Reverse the pages order (top layers first)."
argument_list|,
name|FALSE
argument_list|,
name|G_PARAM_READWRITE
...
directive|if
literal|0
block|gimp_procedure_add_menu_path (procedure, "<Image>/File/Create/PDF");
endif|#
directive|endif
name|gimp_procedure_set_documentation
argument_list|(
...
literal|"Count"
argument_list|,
literal|"The number of images entered (This will be the "
...
literal|"Images"
argument_list|,
literal|"Input image for each page (An image can "
literal|"appear more than once)"
argument_list|,
name|G_PARAM_READWRITE
argument_list|)
expr_stmt|;
...
name|GimpValueArray
modifier|*
DECL|function|pdf_save (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,GFile * file,const GimpValueArray * args,gpointer run_data)
name|pdf_save
parameter_list|(
name|GimpProcedure
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|pdf_save_multi (GimpProcedure * procedure,const GimpValueArray * args,gpointer run_data)
name|pdf_save_multi
parameter_list|(
name|GimpProcedure
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|pdf_save_image (GimpProcedure * procedure,gboolean single_image,gboolean defaults_proc)
name|pdf_save_image
parameter_list|(
name|GimpProcedure
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Fill image with background color -        * otherwise the output PDF will always show white for background,        * and may display artifacts at transparency boundaries        */
if|if
condition|(
...
specifier|static
name|void
DECL|function|init_image_list_defaults (GimpImage * image)
name|init_image_list_defaults
parameter_list|(
name|GimpImage
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Frame for multi-page from layers. */
name|frame
operator|=
name|gtk_frame_new
argument_list|(
...
name|_
argument_list|(
literal|"top layers first"
argument_list|)
else|:
name|_
argument_list|(
literal|"bottom layers first"
argument_list|)
argument_list|)
expr_stmt|;
name|layers_as_pages_c
...
specifier|static
name|void
DECL|function|reverse_order_toggled (GtkToggleButton * reverse_order,GtkButton * layers_as_pages)
name|reverse_order_toggled
parameter_list|(
name|GtkToggleButton
modifier|*
...
name|cairo_surface_t
modifier|*
DECL|function|get_cairo_surface (GimpDrawable * drawable,gboolean as_mask,GError ** error)
name|get_cairo_surface
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|GimpRGB
DECL|function|get_layer_color (GimpLayer * layer,gboolean * single)
name|get_layer_color
parameter_list|(
name|GimpLayer
modifier|*
...
specifier|static
name|void
DECL|function|drawText (GimpLayer * layer,gdouble opacity,cairo_t * cr,gdouble x_res,gdouble y_res)
name|drawText
parameter_list|(
name|GimpLayer
modifier|*
...
name|context
argument_list|,
name|PANGO_GRAVITY_HINT_NATURAL
argument_list|)
expr_stmt|;
...
name|context
argument_list|,
name|PANGO_GRAVITY_HINT_STRONG
argument_list|)
expr_stmt|;
name|pango_context_set_base_gravity
argument_list|(
...
condition|(
operator|!
name|PANGO_GRAVITY_IS_VERTICAL
argument_list|(
...
specifier|static
name|gboolean
DECL|function|draw_layer (GimpLayer ** layers,gint n_layers,gint j,cairo_t * cr,gdouble x_res,gdouble y_res,const gchar * name,GError ** error)
name|draw_layer
parameter_list|(
name|GimpLayer
modifier|*
