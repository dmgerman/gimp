...
specifier|static
name|void
DECL|function|p_points_save_to_file_response (GtkFileSelection * fs,gint response_id,BenderDialog * cd)
...
specifier|static
name|void
DECL|function|p_points_load_from_file_response (GtkFileSelection * fs,gint response_id,BenderDialog * cd)
