...
begin_comment
comment|/* hsv_to_rgb has been taken from the compose-plug-in of GIMP V 0.54  * and hass been modified a little bit  */
end_comment

begin_function
specifier|static
name|void
DECL|function|hsv_to_rgb (unsigned char * h,unsigned char * s,unsigned char * v,unsigned char * rgb)
name|hsv_to_rgb
parameter_list|(
name|unsigned
name|char
