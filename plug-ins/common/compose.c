...
begin_comment
comment|/*  Lab colorspace support originally written by Alexey Dyachenko,  *  merged into the official plug-in by Sven Neumann.  */
end_comment
...
typedef|typedef
struct|struct
DECL|struct|__anon2796f7dc0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2796f7dc0208
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2796f7dc0308
block|{
DECL|member|width
DECL|member|height
name|gint
