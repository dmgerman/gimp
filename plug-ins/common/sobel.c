...
typedef|typedef
struct|struct
DECL|struct|__anon28be80ba0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon28be80ba0208
block|{
DECL|member|run
name|gint
name|run
...
specifier|static
name|void
DECL|function|sobel (GimpDrawable * drawable,gint do_horizontal,gint do_vertical,gint keep_sign)
name|sobel
parameter_list|(
name|GimpDrawable
modifier|*
