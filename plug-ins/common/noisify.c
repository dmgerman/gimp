...
specifier|static
name|void
DECL|function|preview_scroll_callback (GimpDrawable * drawable)
name|preview_scroll_callback
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|noisify_add_alpha_channel (GtkWidget * table,gint channel,gchar * name,GimpDrawable * drawable)
