...
directive|define
name|PLUG_IN_ROLE
value|"gimp-van-gogh-lic"
end_define

begin_typedef
typedef|typedef
enum|enum
DECL|enum|__anon2abbeeee0103
block|{
...
directive|define
name|LIC
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), LIC_TYPE, Lic))
end_define
...
begin_macro
DECL|function|G_DEFINE_TYPE (Lic,lic,GIMP_TYPE_PLUG_IN)
name|G_DEFINE_TYPE
argument_list|(
argument|Lic
argument_list|,
...
specifier|static
name|void
DECL|function|lic_init (Lic * lic)
name|lic_init
parameter_list|(
name|Lic
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2abbeeee0208
block|{
DECL|member|filtlen
name|gdouble
name|filtlen
...
specifier|static
name|void
DECL|function|peek (GeglBuffer * buffer,gint x,gint y,GimpRGB * color)
name|peek
parameter_list|(
name|GeglBuffer
modifier|*
...
specifier|static
name|void
DECL|function|poke (GeglBuffer * buffer,gint x,gint y,GimpRGB * color)
name|poke
parameter_list|(
name|GeglBuffer
modifier|*
...
specifier|static
name|void
DECL|function|getpixel (GeglBuffer * buffer,GimpRGB * p,gdouble u,gdouble v)
name|getpixel
parameter_list|(
name|GeglBuffer
modifier|*
...
specifier|static
name|void
DECL|function|lic_image (GeglBuffer * buffer,gint x,gint y,gdouble vx,gdouble vy,GimpRGB * color)
name|lic_image
parameter_list|(
name|GeglBuffer
modifier|*
...
specifier|static
name|gboolean
DECL|function|effect_image_constrain (GimpImage * image,GimpItem * item,gpointer data)
...
name|GList
modifier|*
DECL|function|lic_query_procedures (GimpPlugIn * plug_in)
name|lic_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|lic_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|lic_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|N_
argument_list|(
literal|"Special effects that nobody "
literal|"understands"
argument_list|)
argument_list|,
literal|"No help yet"
...
name|GimpValueArray
modifier|*
DECL|function|lic_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|lic_run
parameter_list|(
name|GimpProcedure
modifier|*
