...
name|guchar
modifier|*
DECL|function|rgb_to_hsl (gint32 drawable_ID,LICEffectChannel effect_channel)
name|rgb_to_hsl
parameter_list|(
name|gint32
name|drawable_ID
...
specifier|static
name|void
DECL|function|compute_lic (gint32 drawable_ID,const guchar * scalarfield,gboolean rotate)
name|compute_lic
parameter_list|(
name|gint32
name|drawable_ID
...
specifier|static
name|void
DECL|function|compute_image (gint32 drawable_ID)
name|compute_image
parameter_list|(
name|gint32
name|drawable_ID
