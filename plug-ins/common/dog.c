...
name|invert
decl_stmt|;
DECL|member|preview_x0
name|gint32
name|preview_x0
decl_stmt|;
DECL|member|preview_y0
name|gint32
name|preview_y0
decl_stmt|;
...
name|vbox
decl_stmt|;
DECL|member|sourceimage
name|GtkWidget
modifier|*
name|sourceimage
decl_stmt|;
DECL|member|previewimage
name|GtkWidget
modifier|*
name|previewimage
decl_stmt|;
DECL|member|update_button
name|GtkWidget
modifier|*
name|update_button
decl_stmt|;
...
specifier|static
name|void
DECL|function|dog (GimpDrawable * drawable,gdouble inner,gdouble outer,gboolean show_progress)
name|dog
parameter_list|(
name|GimpDrawable
modifier|*
...
name|Preview
modifier|*
DECL|function|preview_new (gint32 drawable_id)
name|preview_new
parameter_list|(
name|gint32
name|drawable_id
...
argument_list|)
expr_stmt|;
comment|/* "Source" label in top row, first column */
name|label
operator|=
name|gtk_label_new
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* GtkImage for peek at original in second row, first column */
name|preview
operator|->
name|src_buffer
operator|=
...
argument_list|)
expr_stmt|;
comment|/* vertical scrollbar in second row, second column */
name|y0
operator|=
name|CLAMP
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* horizontal scrollbar in third row, first column */
name|x0
operator|=
name|CLAMP
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* "Preview" label in first row, third column */
name|label
operator|=
name|gtk_label_new
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*gimp_image_undo_disable (preview->gimpimageid);*/
name|preview
operator|->
name|preview_id
operator|=
...
argument_list|)
expr_stmt|;
comment|/* GtkImage for preview in second row, third column */
name|preview
operator|->
name|preview_buffer
operator|=
...
specifier|static
name|void
DECL|function|preview_update_src_view (GtkWidget * widget,gpointer data)
name|preview_update_src_view
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* it sucks that GdkPixbuf does not handle grayscale images */
if|if
condition|(
name|bpp
operator|==
...
specifier|static
name|void
DECL|function|preview_update_preview (GtkWidget * widget,gpointer data)
name|preview_update_preview
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* it sucks that GdkPixbuf does not handle grayscale */
if|if
condition|(
name|bpp
operator|==
...
specifier|static
name|void
DECL|function|change_radius_callback (GtkWidget * widget,gpointer data)
name|change_radius_callback
parameter_list|(
name|GtkWidget
modifier|*
