...
name|GimpValueArray
modifier|*
DECL|function|remap_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|remap_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|gboolean
DECL|function|remap (GimpImage * image,gint num_colors,guchar * map)
name|remap
parameter_list|(
name|GimpImage
modifier|*
...
specifier|static
name|gboolean
DECL|function|remap_dialog (GimpImage * image,guchar * map)
name|remap_dialog
parameter_list|(
name|GimpImage
modifier|*
