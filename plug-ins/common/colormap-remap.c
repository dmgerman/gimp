...
condition|)
block|{
comment|/*  Make sure that the drawable is indexed  */
if|if
condition|(
...
specifier|static
name|gboolean
DECL|function|remap (gint32 image_ID,gboolean is_non_interactive,gint num_colors,guchar * map)
name|remap
parameter_list|(
name|gint32
name|image_ID
...
specifier|static
name|gboolean
DECL|function|remap_swap (gint32 image_ID,guchar * map,guchar index1,guchar index2)
name|remap_swap
parameter_list|(
name|gint32
name|image_ID
