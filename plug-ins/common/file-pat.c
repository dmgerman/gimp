...
specifier|static
name|gssize
DECL|function|gimp_input_stream_read (GInputStream * stream,void * buffer,gsize count,GError ** error)
name|gimp_input_stream_read
parameter_list|(
name|GInputStream
modifier|*
name|stream
...
name|g_message
argument_list|(
literal|"GIMP Pattern file is truncated "
literal|"(%d of %d lines recovered)."
argument_list|,
name|line
operator|-
literal|1
...
specifier|static
name|gssize
DECL|function|gimp_output_stream_write (GOutputStream * stream,void * buffer,gsize count,GError ** error)
name|gimp_output_stream_write
parameter_list|(
name|GOutputStream
modifier|*
name|stream
