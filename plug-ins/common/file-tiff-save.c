...
typedef|typedef
struct|struct
DECL|struct|__anon2b8cd2cb0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b8cd2cb0208
block|{
DECL|member|ID
name|gint32
name|ID
...
specifier|static
name|gboolean
DECL|function|save_image (const gchar * filename,gint32 image,gint32 layer,gint32 orig_image,gint * saved_bpp,GError ** error)
name|save_image
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|gboolean
DECL|function|save_dialog (gboolean has_alpha,gboolean is_monochrome,gboolean is_indexed)
name|save_dialog
parameter_list|(
name|gboolean
name|has_alpha
