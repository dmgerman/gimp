...
typedef|typedef
struct|struct
DECL|struct|__anon2c5011da0108
block|{
DECL|member|filtlen
name|gdouble
name|filtlen
...
specifier|static
name|void
DECL|function|getpixel (GimpRGB * p,gdouble u,gdouble v)
name|getpixel
parameter_list|(
name|GimpRGB
modifier|*
...
specifier|static
name|void
DECL|function|lic_image (gint x,gint y,gdouble vx,gdouble vy,GimpRGB * color)
name|lic_image
parameter_list|(
name|gint
name|x
...
specifier|static
name|gdouble
DECL|function|get_hue (GimpRGB * col)
name|get_hue
parameter_list|(
name|GimpRGB
modifier|*
...
specifier|static
name|gdouble
DECL|function|get_saturation (GimpRGB * col)
name|get_saturation
parameter_list|(
name|GimpRGB
modifier|*
...
specifier|static
name|gdouble
DECL|function|get_brightness (GimpRGB * col)
name|get_brightness
parameter_list|(
name|GimpRGB
modifier|*
...
name|guchar
modifier|*
DECL|function|rgb_to_hsl (GimpDrawable * image,gdouble (* hsl_func)(GimpRGB * col))
name|rgb_to_hsl
parameter_list|(
name|GimpDrawable
modifier|*
...
name|guchar
modifier|*
DECL|function|rgb_to_hue (GimpDrawable * image)
name|rgb_to_hue
parameter_list|(
name|GimpDrawable
modifier|*
...
name|guchar
modifier|*
DECL|function|rgb_to_saturation (GimpDrawable * image)
...
name|guchar
modifier|*
DECL|function|rgb_to_brightness (GimpDrawable * image)
