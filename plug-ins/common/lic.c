...
typedef|typedef
struct|struct
DECL|struct|__anon2b446a420108
block|{
DECL|member|filtlen
name|gdouble
name|filtlen
...
specifier|static
name|gdouble
DECL|function|get_hue (const GimpRGB * col)
name|get_hue
parameter_list|(
specifier|const
name|GimpRGB
...
specifier|static
name|gdouble
DECL|function|get_saturation (const GimpRGB * col)
name|get_saturation
parameter_list|(
specifier|const
name|GimpRGB
...
specifier|static
name|gdouble
DECL|function|get_brightness (const GimpRGB * col)
name|get_brightness
parameter_list|(
specifier|const
name|GimpRGB
...
name|guchar
modifier|*
DECL|function|rgb_to_hsl (GimpDrawable * image,gdouble (* hsl_func)(const GimpRGB * col))
name|rgb_to_hsl
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|compute_lic (gboolean rotate)
name|compute_lic
parameter_list|(
name|gboolean
name|rotate
