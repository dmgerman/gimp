...
typedef|typedef
struct|struct
DECL|struct|__anon27fb1bf80108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon27fb1bf80208
block|{
DECL|member|run
name|gint
name|run
...
specifier|static
name|gint
DECL|function|spread_dialog (gint32 image_ID)
name|spread_dialog
parameter_list|(
name|gint32
name|image_ID
...
specifier|static
name|void
DECL|function|spread_entry_callback (GtkWidget * widget,gpointer data)
name|spread_entry_callback
parameter_list|(
name|GtkWidget
modifier|*
