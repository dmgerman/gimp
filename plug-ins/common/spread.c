...
typedef|typedef
struct|struct
DECL|struct|__anon2b39f35f0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b39f35f0208
block|{
DECL|member|size
name|GtkWidget
modifier|*
...
name|GimpTile
modifier|*
DECL|function|spread_pixel (GimpDrawable * drawable,GimpTile * tile,gint x1,gint y1,gint x2,gint y2,gint x,gint y,gint * row,gint * col,guchar * pixel)
name|spread_pixel
parameter_list|(
name|GimpDrawable
modifier|*
