...
typedef|typedef
struct|struct
DECL|struct|__anon28a0c86b0108
block|{
DECL|member|radius
name|gdouble
name|radius
...
specifier|static
name|void
DECL|function|preview_toggle_callback (GtkWidget * toggle,GimpDrawable * drawable)
name|preview_toggle_callback
parameter_list|(
name|GtkWidget
modifier|*
...
begin_function
DECL|function|preview_update_real (GimpDrawable * drawable,gboolean apply_effect)
specifier|static
name|void
name|preview_update_real
parameter_list|(
...
specifier|static
name|void
DECL|function|preview_move (GimpDrawable * drawable)
name|preview_move
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|gboolean
DECL|function|preview_button_release (GimpDrawable * drawable)
name|preview_button_release
parameter_list|(
name|GimpDrawable
modifier|*
