...
specifier|static
name|void
DECL|function|dialog_close_callback (GtkWidget * widget,PDesc * pdesc)
...
specifier|static
name|gint
DECL|function|procedure_clist_select_callback (GtkWidget * widget,gint row,gint column,GdkEventButton * bevent,PDesc * pdesc)
name|procedure_clist_select_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gint
DECL|function|page_select_callback (GtkNotebook * notebook,GtkNotebookPage * page,guint page_num,PDesc * pdesc)
...
specifier|static
name|gint
DECL|function|procedure_ctree_select_callback (GtkWidget * widget,GtkWidget * row,gint column,PDesc * pdesc)
name|procedure_ctree_select_callback
parameter_list|(
name|GtkWidget
modifier|*
