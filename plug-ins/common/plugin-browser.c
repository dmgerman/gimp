...
typedef|typedef
struct|struct
DECL|struct|__anon2c2872be0308
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2c2872be0408
block|{
DECL|member|menu
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|browser_search (PluginBrowser * browser,const gchar * search_text)
name|browser_search
parameter_list|(
name|PluginBrowser
modifier|*
...
specifier|static
name|gboolean
DECL|function|browser_search_timeout (gpointer data)
name|browser_search_timeout
parameter_list|(
name|gpointer
name|data
parameter_list|)
...
argument_list|)
expr_stmt|;
comment|/* paned : left=notebook ; right=description */
name|paned
operator|=
name|gtk_hpaned_new
argument_list|()
...
specifier|static
name|void
DECL|function|browser_entry_changed (GtkEditable * editable,PluginBrowser * browser)
name|browser_entry_changed
parameter_list|(
name|GtkEditable
modifier|*
