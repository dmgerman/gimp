...
typedef|typedef
struct|struct
DECL|struct|__anon2accee060308
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2accee060408
block|{
DECL|member|menu
name|gchar
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|browser_create_procedure (GimpPlugIn * plug_in,const gchar * procedure_name)
name|browser_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
argument_list|)
argument_list|,
literal|"Allows one to browse the plug-in "
literal|"menus system. You can search for "
literal|"plug-in names, sort by name or menu "
literal|"location and you can view a tree "
literal|"representation of the plug-in menus. "
literal|"Can also be of help to find where "
literal|"new plug-ins have installed "
literal|"themselves in the menus."
argument_list|,
name|PLUG_IN_PROC
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|insert_into_tree_view (PluginBrowser * browser,const gchar * name,gint64 xtime,const gchar * xtimestr,const gchar * menu_path,const gchar * types_str,PInfo * pinfo)
