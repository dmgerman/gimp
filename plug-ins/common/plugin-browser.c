...
typedef|typedef
struct|struct
DECL|struct|__anon2a8d6e4f0308
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2a8d6e4f0408
block|{
DECL|member|menu
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|get_plugin_info (PluginBrowser * browser,const gchar * search_text)
