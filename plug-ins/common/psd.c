...
begin_struct
DECL|struct|__anon2b0904de0208
specifier|static
struct|struct
block|{
...
name|fd
argument_list|,
literal|"layer record crap throw"
argument_list|)
expr_stmt|;
operator|(
operator|*
...
comment|/* raw data */
block|{
comment|/* FIXME: only lightly tested */
name|gint
name|linei
decl_stmt|;
for|for
...
condition|)
block|{
comment|/*	  printf("*** This is bogus.  Quitting.\n"); 		  gimp_quit(); */
name|printf
argument_list|(
literal|"*** This mask info block looks pretty bogus.\n"
argument_list|)
expr_stmt|;
block|}
...
directive|if
literal|0
block|switch (PSDheader.channels) { 	case 1: 	  step = 1; 	  imagetype = PSD_GRAY_IMAGE; 	  break; 	case 2: 	  step = 2; 	  imagetype = PSD_GRAYA_IMAGE; 	  break; 	default: 	  printf("Warning: base GRAY image has %d channels...\n", 		 step = PSDheader.channels); 	  imagetype = PSD_GRAYA_IMAGE; 	  break; 	}
else|#
directive|else
name|imagetype
operator|=
...
directive|if
literal|0
block|switch (PSDheader.channels) { 	case 1: 	  step = 1; 	  imagetype = PSD_INDEXED_IMAGE; 	  break; 	case 2: 	  step = 2; 	  printf("Warning: base INDEXED image has 2 channels - " 		 "ignoring alpha.\n"); 	  imagetype = PSD_INDEXEDA_IMAGE; 	  break; 	default: 	  printf("Warning: base INDEXED image has %d channels...\n", 		 step = PSDheader.channels); 	  imagetype = PSD_INDEXEDA_IMAGE; 	  break; 	}
else|#
directive|else
name|imagetype
operator|=
...
directive|if
literal|0
block|switch (PSDheader.channels) { 	case 3: 	  step = 3; 	  imagetype = PSD_RGB_IMAGE; 	  break; 	case 4: 	  step = 4; 	  imagetype = PSD_RGBA_IMAGE; 	  break; 	default: 	  printf("Warning: base RGB image has %d channels...\n", 		 step = PSDheader.channels); 	  break; 	}
else|#
directive|else
name|imagetype
operator|=
...
DECL|union|__anon2b0904de030a
union|union
block|{
DECL|struct|__anon2b0904de0408
struct|struct
block|{
DECL|member|b1
DECL|member|b2
...
directive|ifndef
name|WORDS_BIGENDIAN
DECL|union|__anon2b0904de050a
union|union
block|{
DECL|struct|__anon2b0904de0608
struct|struct
block|{
DECL|member|b1
DECL|member|b2
