...
begin_comment
comment|/*  * TODO:  *  *      Crush 16bpp channels *  *	CMYK -> RGB *  *      * I don't think these should be done lossily -- wait for  *        GIMP to be able to support them natively.  *  *      File saving (accepting sponsors!)  */
end_comment
