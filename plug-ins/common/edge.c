...
argument_list|)
expr_stmt|;
comment|/* This prevents annoying change of adjustment */
name|init_val
operator|=
name|evals
operator|.
...
directive|if
literal|0
block|gtk_scale_set_value_pos (GTK_SCALE (scale), GTK_POS_TOP);   gtk_scale_set_digits (GTK_SCALE (scale), 1);   gtk_range_set_update_policy (GTK_RANGE (scale), GTK_UPDATE_DELAYED);
endif|#
directive|endif
name|entry
operator|=
...
begin_comment
comment|/*  Edge detection interface functions  */
end_comment

begin_function
specifier|static
name|void
DECL|function|edge_close_callback (GtkWidget * widget,gpointer data)
name|edge_close_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|edge_toggle_update (GtkWidget * widget,gpointer data)
name|edge_toggle_update
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|edge_scale_update (GtkAdjustment * adjustment,gpointer data)
name|edge_scale_update
parameter_list|(
name|GtkAdjustment
modifier|*
...
specifier|static
name|void
DECL|function|edge_entry_update (GtkWidget * entry,gpointer data)
name|edge_entry_update
parameter_list|(
name|GtkWidget
modifier|*
