...
typedef|typedef
struct|struct
DECL|struct|__anon2bfe99390208
block|{
DECL|member|amount
name|gdouble
name|amount
...
specifier|static
name|gint
DECL|function|edge_detect (guchar * data)
name|edge_detect
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|gint
DECL|function|sobel (guchar * data)
name|sobel
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|gint
DECL|function|prewitt (guchar * data)
name|prewitt
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|gint
DECL|function|gradient (guchar * data)
name|gradient
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|gint
DECL|function|roberts (guchar * data)
name|roberts
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|gint
DECL|function|differential (guchar * data)
name|differential
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|gint
DECL|function|laplace (guchar * data)
name|laplace
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|void
DECL|function|edge_radio_button_update (GtkWidget * widget,gpointer data)
name|edge_radio_button_update
parameter_list|(
name|GtkWidget
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|edge_preview_new (GimpDrawable * drawable)
name|edge_preview_new
parameter_list|(
name|GimpDrawable
modifier|*
...
specifier|static
name|void
DECL|function|edge_preview_update (GimpDrawable * drawable)
name|edge_preview_update
parameter_list|(
name|GimpDrawable
modifier|*
...
name|Y
parameter_list|)
value|src[bytes * ( CLAMP((X),0,preview_width) + preview_width * CLAMP((Y),0,preview_height) )+chan]
name|kernel
index|[
literal|0
index|]
