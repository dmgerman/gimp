...
typedef|typedef
struct|struct
DECL|struct|__anon2b7b4f160208
block|{
DECL|member|amount
name|gdouble
name|amount
...
typedef|typedef
struct|struct
DECL|struct|__anon2b7b4f160308
block|{
DECL|member|run
name|gint
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon2b7b4f160408
block|{
DECL|member|tile
name|GimpTile
modifier|*
...
specifier|static
name|void
DECL|function|init_tile_buf (TileBuf * buf,GimpDrawable * drawable)
name|init_tile_buf
parameter_list|(
name|TileBuf
modifier|*
