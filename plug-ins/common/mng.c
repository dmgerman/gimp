...
begin_comment
comment|/* These can probably be better represented by enumerated types  * but the following will do. */
end_comment

begin_define
DECL|macro|CHUNKS_PNG_D
define|#
directive|define
name|CHUNKS_PNG_D
value|0
...
begin_comment
comment|/* Spins the color map (palette) so that the background color  * is in the right place (index 0 -- expected by some applications)  * in the palette. */
end_comment

begin_function
specifier|static
name|void
DECL|function|respin_cmap (png_structp png_ptr,png_infop png_info_ptr,gint32 image_id)
name|respin_cmap
parameter_list|(
name|png_structp
name|png_ptr
