...
typedef|typedef
struct|struct
DECL|struct|__anon29f57d2d0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29f57d2d0208
block|{
DECL|member|val
name|gint
name|val
...
typedef|typedef
struct|struct
DECL|struct|__anon29f57d2d0308
block|{
DECL|member|rle
name|gboolean
name|rle
...
specifier|static
name|gint32
DECL|function|create_new_image (const gchar * filename,guint width,guint height,GimpImageBaseType type,gint32 * layer_ID,GeglBuffer ** buffer)
name|create_new_image
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|gint
DECL|function|save_index (FILE * ofp,gint32 image_ID,gint32 drawable_ID,gboolean grey,gboolean rle)
name|save_index
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|gint
DECL|function|save_rgb (FILE * ofp,gint32 image_ID,gint32 drawable_ID,gboolean rle)
name|save_rgb
parameter_list|(
name|FILE
modifier|*
