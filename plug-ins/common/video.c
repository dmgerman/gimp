...
begin_typedef
DECL|struct|__anon29fb280e0108
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon29fb280e0208
typedef|typedef
struct|struct
block|{
DECL|member|run
...
index|]
decl_stmt|;
comment|/* determine pattern number from radio buttons */
name|vvals
operator|.
name|pattern_number
operator|=
...
argument_list|)
expr_stmt|;
comment|/*  table = gtk_table_new (4, 8, FALSE);*/
name|box
operator|=
name|gtk_hbox_new
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* put the vbox in the hbox */
name|gtk_box_pack_start
argument_list|(
name|GTK_BOX
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* put the vbox in the radioframe */
name|gtk_container_add
argument_list|(
name|GTK_CONTAINER
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  video_render_preview(FALSE);*/
name|in_main_loop
operator|=
name|TRUE
expr_stmt|;
...
begin_comment
comment|/*  Video interface functions  */
end_comment

begin_function
specifier|static
name|void
DECL|function|video_close_callback (GtkWidget * widget,gpointer data)
name|video_close_callback
parameter_list|(
name|GtkWidget
modifier|*
