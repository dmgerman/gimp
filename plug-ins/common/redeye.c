...
specifier|static
name|void
DECL|function|remove_redeye (GimpDrawable * drawable,GimpPreview * preview)
name|remove_redeye
parameter_list|(
name|GimpDrawable
modifier|*
...
operator|)
expr_stmt|;
comment|/* substitute pixel vales */
