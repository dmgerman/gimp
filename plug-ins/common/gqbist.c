...
typedef|typedef
struct|struct
DECL|struct|__anon294f33dd0208
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon294f33dd0308
block|{
DECL|member|info
name|ExpInfo
name|info
...
specifier|static
name|void
DECL|function|file_chooser_save_response (GtkWidget * dialog,gint response_id,gpointer data)
name|file_chooser_save_response
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
...
specifier|static
name|void
DECL|function|file_chooser_load_response (GtkWidget * dialog,gint response_id,gpointer data)
name|file_chooser_load_response
parameter_list|(
name|GtkWidget
modifier|*
name|dialog
