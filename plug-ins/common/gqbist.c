...
specifier|static
name|void
DECL|function|file_selection_save_response (GtkFileSelection * fs,gint response_id,gpointer data)
name|file_selection_save_response
parameter_list|(
...
specifier|static
name|void
DECL|function|file_selection_load_response (GtkFileSelection * fs,gint response_id,gpointer data)
name|file_selection_load_response
parameter_list|(
name|GtkFileSelection
modifier|*
name|fs
