...
typedef|typedef
struct|struct
DECL|struct|__anon274f939c0208
block|{
...
name|N_
argument_list|(
literal|"<Image>/Filters/Blur/Gaussian Blur..."
argument_list|)
argument_list|,
literal|"RGB*, GRAY*"
argument_list|,
...
literal|0
condition|)
comment|/* can only be noninteractive */
block|{
if|if
condition|(
name|nparams
...
specifier|static
name|void
DECL|function|gauss (GimpDrawable * drawable,gdouble horz,gdouble vert,BlurMethod method)
name|gauss
parameter_list|(
name|GimpDrawable
modifier|*
