...
specifier|static
name|void
DECL|function|vinvert_render_row (guchar * src,guchar * dest,gint col,const gint bytes)
name|vinvert_render_row
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|void
DECL|function|vinvert_render_region (const GimpPixelRgn * srcPR,const GimpPixelRgn * destPR)
