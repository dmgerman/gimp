...
name|procedure
argument_list|,
literal|"Daniel Cotting (cotting@multimania.com, "
...
specifier|static
name|void
DECL|function|fractalexplorer_list_load_all (const gchar * explorer_path)
name|fractalexplorer_list_load_all
parameter_list|(
specifier|const
name|gchar
