...
typedef|typedef
struct|struct
DECL|struct|__anon2c5133ed0308
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2c5133ed0408
block|{
DECL|member|menu
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|browser_show_plugin (PDesc * browser,PInfo * pinfo)
name|browser_show_plugin
parameter_list|(
name|PDesc
modifier|*
...
specifier|static
name|void
DECL|function|list_store_select_callback (GtkTreeSelection * selection,PDesc * browser)
name|list_store_select_callback
parameter_list|(
name|GtkTreeSelection
modifier|*
...
specifier|static
name|void
DECL|function|tree_store_select_callback (GtkTreeSelection * selection,PDesc * browser)
name|tree_store_select_callback
parameter_list|(
name|GtkTreeSelection
modifier|*
...
specifier|static
name|void
DECL|function|get_parent (PDesc * browser,gchar * mpath,GtkTreeIter * parent)
name|get_parent
parameter_list|(
name|PDesc
modifier|*
...
specifier|static
name|void
DECL|function|insert_into_tree_view (PDesc * browser,gchar * name,gchar * xtimestr,gchar * menu_str,gchar * types_str,PInfo * pinfo)
...
specifier|static
name|void
DECL|function|get_plugin_info (PDesc * browser,const gchar * search_text)
...
specifier|static
name|void
DECL|function|dialog_response (GtkWidget * widget,gint response_id,PDesc * browser)
