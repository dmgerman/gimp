...
typedef|typedef
struct|struct
DECL|struct|__anon274a72fe0308
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|browser_search (GimpBrowser * gimp_browser,gint search_type,GimpDBBrowser * browser)
name|browser_search
parameter_list|(
name|GimpBrowser
modifier|*
