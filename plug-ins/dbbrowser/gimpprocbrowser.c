...
specifier|static
name|void
name|procedure_activated_callback
parameter_list|(
name|GtkTreeView
modifier|*
name|treeview
...
specifier|static
name|void
DECL|function|procedure_activated_callback (GtkTreeView * treeview,GtkTreePath * path,GtkTreeViewColumn * column,dbbrowser_t * dbbrowser)
name|procedure_activated_callback
parameter_list|(
name|GtkTreeView
modifier|*
...
specifier|static
name|void
DECL|function|dialog_response (GtkWidget * widget,gint response_id,dbbrowser_t * dbbrowser)
name|dialog_response
parameter_list|(
name|GtkWidget
modifier|*
