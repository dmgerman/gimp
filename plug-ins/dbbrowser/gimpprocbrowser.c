...
typedef|typedef
struct|struct
DECL|struct|__anon2bc9d6ce0308
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|browser_entry_changed (GtkEditable * editable,GimpDBBrowser * browser)
name|browser_entry_changed
parameter_list|(
name|GtkEditable
modifier|*
...
specifier|static
name|void
DECL|function|browser_search (GimpDBBrowser * browser,SearchType search_type)
name|browser_search
parameter_list|(
name|GimpDBBrowser
modifier|*
