...
specifier|static
name|gint
DECL|function|dialog_list_button (GtkWidget * widget,GdkEventButton * event,gpointer data)
name|dialog_list_button
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* gtk_widget_grab_focus (fs->selection_entry); */
name|dialog_select
argument_list|(
name|dbbrowser
argument_list|,
...
condition|)
block|{}
comment|/* gtk_button_clicked (GTK_BUTTON (fs->ok_button)); */
break|break;
default|default:
break|break;
block|}
...
operator|++
expr_stmt|;
comment|/* TODO   label = gtk_label_new("Help :");   gtk_misc_set_alignment (GTK_MISC (label), 1.0, 0.5);    gtk_table_attach (GTK_TABLE (dbbrowser->descr_table), label, 		    0, 1, row, row+1,  		    GTK_FILL, GTK_FILL, 3, 0);   gtk_widget_show(label);       insert help here      but gtk_text seems bugggggggyyy */
if|if
condition|(
name|old_table
condition|)
...
specifier|static
name|void
DECL|function|dialog_selection_free_filename (GtkWidget * widget,gpointer client_data)
