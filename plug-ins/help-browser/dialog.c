...
typedef|typedef
struct|struct
DECL|struct|__anon2bc293870108
block|{
DECL|member|width
name|gint
name|width
...
specifier|static
name|void
DECL|function|title_changed (GtkWidget * view,WebKitWebFrame * frame,const gchar * title,GtkWidget * combo)
name|title_changed
parameter_list|(
name|GtkWidget
modifier|*
