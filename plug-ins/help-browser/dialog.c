...
typedef|typedef
struct|struct
DECL|struct|__anon277117ec0108
block|{
DECL|member|width
name|gint
name|width
...
if|#
directive|if
name|DEBUG_SORT_HELP_ITEMS
name|g_printerr
argument_list|(
literal|"%s: processing %s (parent %s)\n"
argument_list|,
name|G_STRFUNC
argument_list|,
name|item
...
condition|)
block|{
comment|/* make sure that all item->index's are comparable */
name|item
operator|->
name|index
operator|<<=
...
parameter_list|)
block|{
name|WebKitEditorState
modifier|*
name|editor_state
init|=
name|webkit_web_view_get_editor_state
argument_list|(
name|WEBKIT_WEB_VIEW
argument_list|(
name|view
...
if|if
condition|(
name|webkit_editor_state_is_copy_available
argument_list|(
name|editor_state
argument_list|)
condition|)
block|{
name|webkit_web_view_execute_editing_command
argument_list|(
name|WEBKIT_WEB_VIEW
argument_list|(
name|view
argument_list|)
argument_list|,
name|WEBKIT_EDITING_COMMAND_COPY
argument_list|)
expr_stmt|;
block|}
block|}
...
argument_list|)
decl_stmt|;
name|WebKitBackForwardListItem
modifier|*
name|back_fw_list_item
init|=
name|webkit_back_forward_list_get_nth_item
argument_list|(
name|back_fw_list
argument_list|,
name|steps
...
name|back_fw_list_item
condition|)
name|webkit_web_view_go_to_back_forward_list_item
argument_list|(
name|WEBKIT_WEB_VIEW
argument_list|(
name|view
...
name|title
operator|=
name|webkit_back_forward_list_item_get_title
argument_list|(
name|item
argument_list|)
expr_stmt|;
...
name|list
operator|=
name|webkit_back_forward_list_get_back_list_with_limit
argument_list|(
name|back_forward_list
argument_list|,
literal|12
...
name|list
operator|=
name|webkit_back_forward_list_get_forward_list_with_limit
argument_list|(
name|back_forward_list
argument_list|,
literal|12
...
specifier|static
name|void
DECL|function|title_changed (WebKitWebView * view,GParamSpec * pspec,GtkWidget * window)
name|title_changed
parameter_list|(
name|WebKitWebView
modifier|*
...
name|title
init|=
name|webkit_web_view_get_title
argument_list|(
name|view
argument_list|)
decl_stmt|;
...
specifier|static
name|void
DECL|function|load_changed (WebKitWebView * view,WebKitLoadEvent event)
name|load_changed
parameter_list|(
name|WebKitWebView
modifier|*
...
parameter_list|)
block|{
name|WebKitFindController
modifier|*
name|find_controller
init|=
name|webkit_web_view_get_find_controller
argument_list|(
name|WEBKIT_WEB_VIEW
argument_list|(
name|view
...
argument_list|)
expr_stmt|;
name|webkit_find_controller_search_finish
argument_list|(
name|find_controller
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
name|webkit_find_controller_search_previous
argument_list|(
name|find_controller
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
name|webkit_find_controller_search_next
argument_list|(
name|find_controller
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|search (const gchar * text)
name|search
parameter_list|(
specifier|const
name|gchar
...
name|prev_text
init|=
name|webkit_find_controller_get_search_text
argument_list|(
name|find_controller
argument_list|)
decl_stmt|;
...
argument_list|)
expr_stmt|;
name|webkit_find_controller_search
argument_list|(
name|find_controller
argument_list|,
name|text
argument_list|,
name|WEBKIT_FIND_OPTIONS_CASE_INSENSITIVE
operator||
name|WEBKIT_FIND_OPTIONS_WRAP_AROUND
argument_list|,
name|G_MAXUINT
argument_list|)
expr_stmt|;
