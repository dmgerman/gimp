...
DECL|function|save_image (GFile * file,GimpImage * image,GimpDrawable * drawable,GimpRunMode run_mode,GimpProcedure * procedure,GObject * config,GError ** error)
name|save_image
parameter_list|(
name|GFile
modifier|*
...
specifier|static
name|void
DECL|function|write_image (FILE * f,guchar * src,gint width,gint height,gboolean use_run_length_encoding,gint channels,gint bpp,gint spzeile,gint MapSize,RGBMode rgb_format,gint mask_info_size,gint color_space_size)
name|write_image
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|gboolean
DECL|function|format_sensitive_callback (gint value,gpointer data)
name|format_sensitive_callback
parameter_list|(
name|gint
name|value
parameter_list|,
...
specifier|static
name|void
DECL|function|config_notify (GObject * config,const GParamSpec * pspec,gpointer data)
name|config_notify
parameter_list|(
name|GObject
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_dialog (GimpProcedure * procedure,GObject * config,gint channels)
name|save_dialog
parameter_list|(
name|GimpProcedure
modifier|*
...
name|_
argument_list|(
literal|"_Write color space information"
argument_list|)
argument_list|)
expr_stmt|;
...
literal|"color space information by default. Disabling "
