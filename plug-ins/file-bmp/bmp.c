...
literal|"Use RLE"
argument_list|,
literal|"Use run-lengh-encoding"
argument_list|,
name|FALSE
argument_list|,
...
name|procedure
argument_list|,
literal|"write-color-space-info"
argument_list|,
literal|"Write color space information"
argument_list|,
literal|"Whether or not to write BITMAPV5HEADER "
literal|"color space data"
argument_list|,
name|TRUE
argument_list|,
name|G_PARAM_READWRITE
...
literal|"RGB format"
argument_list|,
literal|"Export format for RGB images"
argument_list|,
literal|0
argument_list|,
literal|5
