...
begin_function
name|int
DECL|function|count_tags (GExiv2Metadata * metadata,gchar * header,gchar ** tags,int items)
name|count_tags
parameter_list|(
name|GExiv2Metadata
modifier|*
...
begin_function
name|void
DECL|function|get_tags (GExiv2Metadata * metadata,gchar * header,gchar ** tags,const int items,const int count)
name|get_tags
parameter_list|(
name|GExiv2Metadata
modifier|*
...
name|g_printerr
argument_list|(
literal|"failed to set tag [Xmp.iptcExt.OrganisationInImageName]\n"
argument_list|)
expr_stmt|;
block|}
...
name|g_printerr
argument_list|(
literal|"failed to set tag [Xmp.iptcExt.OrganisationInImageCode]\n"
argument_list|)
expr_stmt|;
block|}
...
name|g_printerr
argument_list|(
literal|"failed to set tag [Xmp.plus.ModelReleaseID]\n"
argument_list|)
expr_stmt|;
block|}
...
name|g_printerr
argument_list|(
literal|"failed to set tag [Xmp.plus.PropertyReleaseID]\n"
argument_list|)
expr_stmt|;
block|}
