...
specifier|static
name|void
DECL|function|metadata_class_init (MetadataClass * klass)
...
name|N_
argument_list|(
literal|"Edit metadata (IPTC, EXIF, XMP)"
argument_list|)
argument_list|,
literal|"Edit metadata information attached "
literal|"to the current image. Some or all "
literal|"of this metadata will be saved in "
literal|"the file, depending on the output "
literal|"file format."
argument_list|,
name|name
argument_list|)
...
specifier|static
name|gboolean
DECL|function|metadata_editor_dialog (GimpImage * image,GimpMetadata * g_metadata)
name|metadata_editor_dialog
parameter_list|(
name|GimpImage
modifier|*
...
begin_function
name|void
DECL|function|metadata_editor_write_callback (GtkWidget * dialog,GtkBuilder * builder,GimpImage * image)
name|metadata_editor_write_callback
parameter_list|(
name|GtkWidget
modifier|*
