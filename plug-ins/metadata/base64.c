...
begin_function
name|gint
DECL|function|base64_decode (const gchar * src_b64,guint src_size,gchar * dest,guint dest_size)
name|base64_decode
parameter_list|(
specifier|const
name|gchar
...
begin_function
name|gint
DECL|function|base64_encode (const gchar * src,guint src_size,gchar * dest_b64,guint dest_size)
name|base64_encode
parameter_list|(
specifier|const
name|gchar
...
parameter_list|)
block|{
comment|/* FIXME: just index the base64_code string, 6 bits at a time */
name|g_warning
argument_list|(
literal|"not written yet\n"
argument_list|)
expr_stmt|;
return|return
literal|1
