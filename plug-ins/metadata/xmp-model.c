...
begin_comment
comment|/* Used for converting row-changed events into property-changed and  * schema-changed events.*/
end_comment

begin_define
DECL|macro|XMP_MODEL_SCHEMA
define|#
directive|define
name|XMP_MODEL_SCHEMA
value|0
end_define

begin_define
DECL|macro|XMP_MODEL_PROPERTY
define|#
directive|define
name|XMP_MODEL_PROPERTY
value|1
end_define
...
block|,
DECL|enumerator|SCHEMA_CHANGED
name|SCHEMA_CHANGED
block|,
...
name|xmp_model
argument_list|,
name|GTK_TYPE_TREE_STORE
argument_list|)
expr_stmt|;
end_expr_stmt

begin_decl_stmt
DECL|variable|xmp_model_signals
specifier|static
name|guint
name|xmp_model_signals
index|[
name|LAST_SIGNAL
index|]
init|=
...
specifier|static
name|void
DECL|function|xmp_model_init (XMPModel * xmp_model)
name|xmp_model_init
parameter_list|(
name|XMPModel
modifier|*
...
specifier|static
name|void
DECL|function|xmp_model_finalize (GObject * object)
name|xmp_model_finalize
parameter_list|(
name|GObject
modifier|*
...
begin_comment
comment|/* translate a row-changed event into a property-changed or  * schema-changed event with the detail.  */
end_comment

begin_function
specifier|static
name|void
DECL|function|tree_model_row_changed (GtkTreeModel * model,GtkTreePath * path,GtkTreeIter * iter,gpointer user_data)
name|tree_model_row_changed
parameter_list|(
name|GtkTreeModel
modifier|*
...
name|schema
decl_stmt|;
comment|/* 1. check which iter depth the change was: 0 for schema 1 for    * property? */
name|depth
operator|=
name|gtk_tree_store_iter_depth
argument_list|(
name|GTK_TREE_STORE
argument_list|(
name|model
...
condition|)
block|{
comment|/* 2. If a schema has changed, emit a schema changed signal */
block|}
if|if
condition|(
name|depth
...
name|XMPSchema
modifier|*
DECL|function|find_xmp_schema_by_iter (XMPModel * xmp_model,GtkTreeIter * child)
name|find_xmp_schema_by_iter
parameter_list|(
name|XMPModel
modifier|*
...
name|XMPSchema
modifier|*
DECL|function|find_xmp_schema_by_uri (XMPModel * xmp_model,const gchar * schema_uri)
name|find_xmp_schema_by_uri
parameter_list|(
name|XMPModel
modifier|*
name|xmp_model
...
begin_comment
comment|/**  * xmp_model_property_changed:  * @xmp_model: An #XMPModel  * @schema: An #XMPSchema the property belongs to  * @iter: A valid #GtkTreeIter pointing to the changed row  *  * Emits the "property-changed" event based on the @tree_model with  * detail. The detail is a joined string of xmp-schema-prefix and  * xmp-property-name (e.g.  property-changed::dc:DocumentID).  **/
end_comment

begin_function
name|void
DECL|function|xmp_model_property_changed (XMPModel * xmp_model,XMPSchema * schema,GtkTreeIter * iter)
name|xmp_model_property_changed
parameter_list|(
name|XMPModel
modifier|*
