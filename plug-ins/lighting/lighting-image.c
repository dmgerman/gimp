...
begin_function
name|guchar
DECL|function|peek_map (GeglBuffer * buffer,const Babl * format,gint x,gint y)
name|peek_map
parameter_list|(
name|GeglBuffer
modifier|*
...
begin_function
name|gdouble
DECL|function|get_map_value (GeglBuffer * buffer,const Babl * format,gdouble u,gdouble v,gint * inside)
name|get_map_value
parameter_list|(
name|GeglBuffer
modifier|*
