...
begin_comment
comment|/* Interpol linearly height[2] and triangle_normals[1]  * using the next row  */
end_comment

begin_function
name|void
DECL|function|interpol_row (gint x1,gint x2,gint y)
name|interpol_row
parameter_list|(
name|gint
name|x1
...
control|)
block|{
comment|/* heights rows 1 and 2 are inverted */
name|p1
operator|.
name|x
operator|=
