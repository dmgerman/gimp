...
begin_typedef
DECL|struct|__anon2a1b8c100108
typedef|typedef
struct|struct
block|{
DECL|member|preview
...
begin_typedef
DECL|struct|__anon2a1b8c100308
typedef|typedef
struct|struct
block|{
DECL|member|type
...
begin_typedef
DECL|struct|__anon2a1b8c100408
typedef|typedef
struct|struct
block|{
DECL|member|htoggle
...
comment|/* This was built up incrementally... shows does'nt it */
name|frame
operator|=
name|gtk_frame_new
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Table for the stuff next to the explict button */
name|table3
operator|=
name|gtk_table_new
argument_list|(
...
specifier|static
name|void
DECL|function|tileit_close_callback (GtkWidget * widget,gpointer data)
name|tileit_close_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|tileit_toggle_update (GtkWidget * widget,gpointer data)
name|tileit_toggle_update
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|tileit_scale_update (GtkAdjustment * adjustment,gint * value)
name|tileit_scale_update
parameter_list|(
name|GtkAdjustment
modifier|*
...
specifier|static
name|void
DECL|function|tileit_entry_update (GtkWidget * widget,gint * value)
name|tileit_entry_update
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|tileit_get_pixel (int x,int y,guchar * pixel)
