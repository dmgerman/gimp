...
directive|define
name|PLUG_IN_AUTHOR
value|"Craig Setera (setera@infonet.isl.net)"
end_define
...
begin_typedef
DECL|struct|__anon2922217d0108
typedef|typedef
struct|struct
block|{
...
directive|define
name|IN_ARGS
value|{ PARAM_INT32, "run_mode", "Interactive, non-interactive" }
end_define
...
name|OUT_ARGS
define|\
value|{ PARAM_INT32, "image_count", "Number of acquired images" }, \ 	{ PARAM_INT32ARRAY, "image_ids", "Array of acquired image identifiers" }
end_define
...
begin_typedef
DECL|struct|__anon2922217d0208
typedef|typedef
struct|struct
block|{
