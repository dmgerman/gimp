...
begin_comment
comment|/* A Bison parser, made from imap_csim.y    by GNU bison 1.35.  */
end_comment
...
name|x
parameter_list|)
value|((unsigned)(x)<= 282 ? yytranslate[x] : 63)
end_define
