...
name|gchar
modifier|*
DECL|function|unescape_text (gchar * input)
name|unescape_text
parameter_list|(
name|gchar
modifier|*
...
parameter_list|)
block|{
comment|/*   * We "unescape" simple things "in place", knowing that unescaped   * strings always are shorter than the original input.   *   * It is a shame there is no g_markup_unescape_text() function, but   * instead you have to create a full GMarkupParser/Context.   */
DECL|struct|token
struct|struct
name|token
block|{
...
name|p
decl_stmt|;
comment|/* FIXME: The following code does not perform a UTF-8 substring          search. */
for|for
control|(
name|p
operator|=
