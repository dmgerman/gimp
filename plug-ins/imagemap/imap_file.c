...
specifier|static
name|void
DECL|function|open_cb (GtkFileSelection * fs,gint response_id,gpointer data)
name|open_cb
parameter_list|(
...
name|_
argument_list|(
literal|"<span weight=\"bold\" size=\"larger\">File already exists.</span>\n\n"
...
specifier|static
name|void
DECL|function|save_cb (GtkFileSelection * fs,gint response_id,gpointer data)
name|save_cb
parameter_list|(
name|GtkFileSelection
modifier|*
