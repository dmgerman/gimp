...
specifier|static
name|void
name|send_to_back_command_undo
parameter_list|(
name|Command_t
modifier|*
name|parent
...
specifier|static
name|void
name|send_to_back_command_redo
parameter_list|(
name|Command_t
modifier|*
name|parent
...
begin_typedef
DECL|struct|__anon2a50544a0108
typedef|typedef
struct|struct
block|{
DECL|member|parent
...
specifier|static
name|void
DECL|function|send_to_back_command_undo (Command_t * command)
name|send_to_back_command_undo
parameter_list|(
name|Command_t
modifier|*
...
specifier|static
name|void
DECL|function|send_to_back_command_redo (Command_t * command)
name|send_to_back_command_redo
parameter_list|(
name|Command_t
modifier|*
