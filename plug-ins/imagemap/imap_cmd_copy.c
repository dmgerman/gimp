...
begin_decl_stmt
DECL|variable|copy_command_class
specifier|static
name|CommandClass_t
...
name|NULL
block|,
comment|/* copy_command_destruct */
name|copy_command_execute
block|,
name|copy_command_undo
block|,
name|NULL
comment|/* copy_command_redo */
block|}
decl_stmt|;
end_decl_stmt

begin_typedef
DECL|struct|__anon29d2ee960108
typedef|typedef
struct|struct
block|{
DECL|member|parent
...
name|Command_t
modifier|*
DECL|function|copy_command_new (ObjectList_t * list)
...
specifier|static
name|void
DECL|function|copy_command_undo (Command_t * parent)
name|copy_command_undo
parameter_list|(
name|Command_t
modifier|*
