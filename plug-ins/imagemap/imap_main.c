...
specifier|static
name|gboolean
DECL|function|fuzzy_select_on_button_press (GtkWidget * widget,GdkEventButton * event,gpointer data)
name|fuzzy_select_on_button_press
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
name|channel_ID
decl_stmt|;
comment|/* Save the old selection first */
name|channel_ID
operator|=
...
begin_function
name|void
DECL|function|set_fuzzy_select_func (void)
