...
directive|define
name|IMAP
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), IMAP_TYPE, Imap))
end_define
...
specifier|static
name|void
DECL|function|imap_class_init (ImapClass * klass)
name|imap_class_init
parameter_list|(
name|ImapClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|imap_init (Imap * imap)
name|imap_init
parameter_list|(
name|Imap
modifier|*
...
name|GList
modifier|*
DECL|function|imap_query_procedures (GimpPlugIn * plug_in)
name|imap_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|imap_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|imap_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|imap_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|imap_run
parameter_list|(
name|GimpProcedure
modifier|*
