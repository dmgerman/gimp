...
begin_decl_stmt
DECL|variable|cut_command_class
specifier|static
name|CommandClass_t
name|cut_command_class
init|=
block|{
name|cut_command_destruct
block|,
...
begin_typedef
DECL|struct|__anon2b35aee70108
typedef|typedef
struct|struct
block|{
DECL|member|parent
...
name|Command_t
modifier|*
DECL|function|cut_command_new (ObjectList_t * list)
...
specifier|static
name|void
DECL|function|cut_command_destruct (Command_t * parent)
name|cut_command_destruct
parameter_list|(
name|Command_t
modifier|*
...
specifier|static
name|gboolean
DECL|function|cut_command_execute (Command_t * parent)
name|cut_command_execute
parameter_list|(
name|Command_t
modifier|*
...
specifier|static
name|void
DECL|function|cut_command_undo (Command_t * parent)
name|cut_command_undo
parameter_list|(
name|Command_t
modifier|*
...
specifier|static
name|void
DECL|function|cut_command_redo (Command_t * command)
name|cut_command_redo
parameter_list|(
name|Command_t
modifier|*
