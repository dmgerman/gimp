...
argument_list|)
expr_stmt|;
comment|/* Fix me: no action yet      GTK_WIDGET_SET_FLAGS(data->help, GTK_CAN_DEFAULT);      gtk_box_pack_start(GTK_BOX(hbbox), data->help, FALSE, FALSE, 0);      gtk_widget_show(data->help);    */
return|return
name|data
return|;
block|}
