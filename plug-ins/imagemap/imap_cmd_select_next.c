...
name|select_next_command_execute
parameter_list|(
name|Command_t
modifier|*
name|parent
...
begin_decl_stmt
DECL|variable|select_next_command_class
specifier|static
name|CommandClass_t
name|select_next_command_class
init|=
block|{
name|NULL
block|,
comment|/* select_next_command_destruct */
name|select_next_command_execute
block|,
name|select_next_command_undo
block|,
...
begin_typedef
DECL|struct|__anon28c7619a0108
typedef|typedef
struct|struct
block|{
DECL|member|parent
...
name|list
decl_stmt|;
DECL|typedef|SelectNextCommand_t
block|}
name|SelectNextCommand_t
typedef|;
end_typedef
...
name|Command_t
modifier|*
DECL|function|select_next_command_new (ObjectList_t * list)
...
specifier|static
name|CmdExecuteValue_t
DECL|function|select_next_command_execute (Command_t * parent)
name|select_next_command_execute
parameter_list|(
name|Command_t
modifier|*
...
specifier|static
name|void
DECL|function|select_next_command_undo (Command_t * command)
name|select_next_command_undo
parameter_list|(
name|Command_t
modifier|*
...
specifier|static
name|void
DECL|function|select_next_command_redo (Command_t * command)
name|select_next_command_redo
parameter_list|(
name|Command_t
modifier|*
