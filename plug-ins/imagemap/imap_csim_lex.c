...
directive|define
name|ECHO
value|(void) fwrite( csim_text, csim_leng, 1, csim_out )
end_define
...
begin_comment
comment|/** Setup the input buffer state to scan a string. The next call to csim_lex() will  * scan from a @e copy of @a str.  * @param str a NUL-terminated string to scan  *  * @return the newly allocated buffer state object.  * @note If you want to scan bytes that may contain NUL values, then use  *       csim__scan_bytes() instead.  */
end_comment
