...
begin_typedef
DECL|struct|__anon2aeaec870208
typedef|typedef
struct|struct
block|{
DECL|member|dialog
...
specifier|static
name|void
DECL|function|draw_lines (cairo_t * cr,gint width,gint height)
name|draw_lines
parameter_list|(
name|cairo_t
modifier|*
...
specifier|static
name|void
DECL|function|draw_crosses (cairo_t * cr,gint width,gint height)
name|draw_crosses
parameter_list|(
name|cairo_t
modifier|*
...
begin_function
name|void
DECL|function|draw_grid (cairo_t * cr,gint width,gint height)
name|draw_grid
parameter_list|(
name|cairo_t
modifier|*
