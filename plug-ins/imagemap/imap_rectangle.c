...
specifier|static
name|gpointer
name|rectangle_create_info_tab
parameter_list|(
name|GtkWidget
modifier|*
name|notebook
...
begin_typedef
DECL|struct|__anon2c11dfc40108
typedef|typedef
struct|struct
block|{
DECL|member|obj
...
specifier|static
name|gpointer
DECL|function|rectangle_create_info_tab (GtkWidget * notebook)
name|rectangle_create_info_tab
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*   gtk_signal_connect(GTK_OBJECT(props->x), "changed",  		      (GtkSignalFunc) x_changed_cb, (gpointer) props); */
name|create_label_in_table
argument_list|(
name|table
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/*    create_check_button_in_table(table, 4, 0, "Preview");*/
name|label
operator|=
name|gtk_label_new
argument_list|(
...
modifier|*
modifier|*
DECL|function|rectangle_get_icon_data (void)
name|rectangle_get_icon_data
parameter_list|(
name|void
parameter_list|)
