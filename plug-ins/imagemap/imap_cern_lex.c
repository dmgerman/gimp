...
directive|define
name|ECHO
value|(void) fwrite( cern_text, cern_leng, 1, cern_out )
end_define
...
begin_comment
comment|/** Setup the input buffer state to scan a string. The next call to cern_lex() will  * scan from a @e copy of @a str.  * @param str a NUL-terminated string to scan  *  * @return the newly allocated buffer state object.  * @note If you want to scan bytes that may contain NUL values, then use  *       cern__scan_bytes() instead.  */
end_comment
