...
specifier|static
name|void
DECL|function|sel2path_close_callback (GtkWidget * widget,gpointer data)
name|sel2path_close_callback
parameter_list|(
name|GtkWidget
modifier|*
...
begin_function
name|void
DECL|function|gen_anchor (gdouble * p,double x,double y,int is_newcurve)
name|gen_anchor
parameter_list|(
name|gdouble
modifier|*
...
begin_function
name|void
DECL|function|gen_control (gdouble * p,double x,double y)
name|gen_control
parameter_list|(
name|gdouble
modifier|*
...
directive|if
literal|0
block|int count;    for(count = 0; count< num_path_points; count++)     {       printf("[%d] %g\n",count,point_pairs[count]);     }
endif|#
directive|endif
comment|/* 0 */
name|return_vals
