...
name|GimpValueArray
modifier|*
DECL|function|ico_load_thumb (GimpProcedure * procedure,GFile * file,gint size,const GimpValueArray * args,gpointer run_data)
name|ico_load_thumb
parameter_list|(
name|GimpProcedure
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|ico_save (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,GFile * file,const GimpValueArray * args,gpointer run_data)
name|ico_save
parameter_list|(
name|GimpProcedure
modifier|*
