...
name|GtkWidget
modifier|*
DECL|function|ico_preview_new (GimpDrawable * layer)
...
name|GtkWidget
modifier|*
DECL|function|ico_create_icon_hbox (GtkWidget * icon_preview,GimpDrawable * layer,gint layer_num,IcoSaveInfo * info)
...
name|GtkWidget
modifier|*
DECL|function|ico_dialog_get_layer_preview (GtkWidget * dialog,GimpDrawable * layer)
...
specifier|static
name|void
DECL|function|ico_dialog_update_icon_preview (GtkWidget * dialog,GimpDrawable * layer,gint bpp)
...
begin_function
name|void
DECL|function|ico_dialog_add_icon (GtkWidget * dialog,GimpDrawable * layer,gint layer_num)
