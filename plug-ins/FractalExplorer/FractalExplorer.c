...
specifier|static
name|void
DECL|function|fractalexplorer_list_response (GtkWidget * widget,gint response_id,fractalexplorerListOptions * options)
name|fractalexplorer_list_response
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
name|GtkWidget
modifier|*
DECL|function|fractalexplorer_new_pixmap (GtkWidget * list,gchar ** pixdata)
name|fractalexplorer_new_pixmap
parameter_list|(
name|GtkWidget
modifier|*
