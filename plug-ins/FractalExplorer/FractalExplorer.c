...
argument_list|)
expr_stmt|;
comment|/* pixmap = gdk_pixmap_create_from_xpm_d(list->window,&mask,&transparent,pixdata); */
name|pixmap_widget
operator|=
name|gtk_pixmap_new
argument_list|(
