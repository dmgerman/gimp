...
begin_comment
comment|/* Changes:  *  * 2000-01-05  Fixed a problem with strtok and got rid of the selfmade i18n  *             Sven Neumann<sven@gimp.org>  */
end_comment
...
specifier|static
name|void
DECL|function|fractalexplorer_rescan_response (GtkWidget * widget,gint response_id,gpointer data)
name|fractalexplorer_rescan_response
parameter_list|(
name|GtkWidget
modifier|*
name|widget
