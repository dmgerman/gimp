...
argument_list|)
argument_list|,
literal|"Fractal Explorer<Daniel Cotting/cotting@mygale.org>"
argument_list|)
expr_stmt|;
...
literal|"Version 2.00 Beta (Multilingual)\n"
argument_list|)
expr_stmt|;
name|gtk_container_add
argument_list|(
...
name|fputs
argument_list|(
literal|"# Get the plug-in at                 http://www.mygale.org/~cotting   *\n"
argument_list|,
name|fp
argument_list|)
expr_stmt|;
