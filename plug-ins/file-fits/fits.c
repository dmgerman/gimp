...
specifier|static
name|gint32
DECL|function|create_new_image (const gchar * filename,guint pagenum,guint width,guint height,GimpImageBaseType itype,GimpImageType dtype,gint32 * layer_ID,GeglBuffer ** buffer)
name|create_new_image
parameter_list|(
specifier|const
name|gchar
