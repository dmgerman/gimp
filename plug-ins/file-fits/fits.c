...
typedef|typedef
struct|struct
DECL|struct|__anon299fd8120108
block|{
DECL|member|replace
name|gint
name|replace
...
specifier|static
name|gint32
DECL|function|create_new_image (const gchar * filename,guint pagenum,guint width,guint height,GimpImageBaseType itype,GimpImageType dtype,GimpPrecision iprecision,gint32 * layer_ID,GeglBuffer ** buffer)
name|create_new_image
parameter_list|(
specifier|const
name|gchar
