...
typedef|typedef
struct|struct
DECL|struct|__anon2956c3cc0108
block|{
DECL|member|replace
name|gint
name|replace
...
name|GimpImage
modifier|*
DECL|function|create_new_image (const gchar * filename,guint pagenum,guint width,guint height,GimpImageBaseType itype,GimpImageType dtype,GimpPrecision iprecision,GimpLayer ** layer,GeglBuffer ** buffer)
name|create_new_image
parameter_list|(
specifier|const
name|gchar
