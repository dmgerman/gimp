...
begin_macro
DECL|function|G_DEFINE_TYPE (Fits,fits,GIMP_TYPE_PLUG_IN)
name|G_DEFINE_TYPE
argument_list|(
argument|Fits
argument_list|,
...
name|procedure
argument_list|,
literal|"use-data-min-max"
argument_list|,
literal|"Use data min max"
argument_list|,
literal|"Use DATAMIN/DATAMAX-scaling if possible"
argument_list|,
name|FALSE
argument_list|,
name|G_PARAM_READWRITE
...
name|GimpImage
modifier|*
DECL|function|load_image (GFile * file,GObject * config,GimpRunMode run_mode,GError ** error)
name|load_image
parameter_list|(
name|GFile
modifier|*
...
name|GimpImage
modifier|*
DECL|function|load_fits (GFile * file,FitsFile * ifp,GObject * config,guint picnum,guint ncompose)
name|load_fits
parameter_list|(
name|GFile
modifier|*
