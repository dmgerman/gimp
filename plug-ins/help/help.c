...
typedef|typedef
struct|struct
DECL|struct|__anon28eb414b0108
block|{
...
specifier|static
name|void
DECL|function|load_help (const gchar * procedure,const gchar * help_domain,const gchar * help_locale,const gchar * help_id)
name|load_help
parameter_list|(
specifier|const
name|gchar
...
name|g_printerr
argument_list|(
literal|"help: got a request for %s %s %s\n"
argument_list|,
name|idle_help
operator|->
name|help_domain
