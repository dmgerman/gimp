...
name|c
decl_stmt|;
comment|/* After a dot is displayed the optional encoding.        * We don't care in context of our help system.        */
name|c
operator|=
name|strchr
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  if the list doesn't contain the default locale yet, append it  */
for|for
control|(
name|list
operator|=
