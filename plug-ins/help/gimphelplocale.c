...
typedef|typedef
struct|struct
DECL|struct|__anon27edde4f0208
block|{
DECL|member|file
name|GFile
modifier|*
...
begin_function
name|gboolean
DECL|function|gimp_help_locale_parse (GimpHelpLocale * locale,const gchar * uri,const gchar * help_domain,GError ** error)
...
specifier|static
name|gboolean
DECL|function|locale_parser_parse (GMarkupParseContext * context,GInputStream * stream,GError ** error)
name|locale_parser_parse
parameter_list|(
name|GMarkupParseContext
modifier|*
