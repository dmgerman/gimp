...
name|g_printerr
argument_list|(
literal|"uri_backend_load_image: %s\n"
argument_list|,
operator|(
operator|*
name|error
...
name|g_printerr
argument_list|(
literal|"uri_backend_save_image: %s\n"
argument_list|,
operator|(
operator|*
name|error
...
specifier|static
name|gboolean
DECL|function|copy_uri (const gchar * src_uri,const gchar * dest_uri,const gchar * format,GError ** error)
name|copy_uri
parameter_list|(
specifier|const
name|gchar
