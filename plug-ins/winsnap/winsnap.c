...
begin_comment
comment|/*  * snap_close_callback  *  * The close button has been pressed... Close  * down the widgetry.  */
end_comment

begin_function
specifier|static
name|void
DECL|function|snap_close_callback (GtkWidget * widget,gpointer data)
name|snap_close_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_comment
comment|/*  * snap_grab_callback  *  * The "grab" button has been selected.  */
end_comment

begin_function
specifier|static
name|void
DECL|function|snap_grab_callback (GtkWidget * widget,gpointer data)
name|snap_grab_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
