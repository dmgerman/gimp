...
argument_list|)
expr_stmt|;
comment|/* clear nonshaped preview widget */
name|total_alpha_preview
argument_list|()
expr_stmt|;
for|for
...
argument_list|)
expr_stmt|;
comment|/*	gtk_fixed_put (GTK_FIXED (shape_fixed), GTK_WIDGET(shape_preview), 		       0,0);*/
block|}
comment|/*      gtk_widget_show (GTK_WIDGET(shape_preview));*/
block|}
name|gtk_widget_show
argument_list|(
name|shape_fixed
