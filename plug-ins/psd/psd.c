...
begin_struct
DECL|struct|__anon2b8cd7050208
specifier|static
struct|struct
block|{
...
begin_comment
comment|/* static void do_masks(guint32 *offset) {    } */
end_comment
...
begin_comment
comment|/* static guchar * getchunk(size_t n, FILE * fd, char *why) {   guchar *tmpchunk;    tmpchunk = xmalloc(n);   xfread(fd, tmpchunk, n, why);   return(tmpchunk); */
end_comment
...
name|LITTLE_ENDIAN
operator|)
DECL|union|__anon2b8cd705030a
union|union
block|{
DECL|struct|__anon2b8cd7050408
struct|struct
block|{
DECL|member|b1
DECL|member|b2
...
name|LITTLE_ENDIAN
operator|)
DECL|union|__anon2b8cd705050a
union|union
block|{
DECL|struct|__anon2b8cd7050608
struct|struct
block|{
DECL|member|b1
DECL|member|b2
