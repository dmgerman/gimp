...
begin_comment
comment|/* vpropagate.c -- This is a plug-in for the GIMP (1.0's API)  * Author: Shuji Narazaki<narazaki@InetQ.or.jp>  * Time-stamp:<1997/06/08 22:29:17 narazaki@InetQ.or.jp>  * Version: 0.88  *  * Copyright (C) 1996-1997 Shuji Narazaki<narazaki@InetQ.or.jp>  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License as published by  * the Free Software Foundation; either version 2 of the License, or  * (at your option) any later version.  *  * This program is distributed in the hope that it will be useful,  * but WITHOUT ANY WARRANTY; without even the implied warranty of  * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the  * GNU General Public License for more details.  *  * You should have received a copy of the GNU General Public License  * along with this program; if not, write to the Free Software  * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
directive|define
name|PROGRESS_NAME
value|"vpropagate(0.87): propagating..."
end_define
...
begin_comment
comment|/* void bcopy(void *, void *, int); */
end_comment
...
typedef|typedef
struct|struct
DECL|struct|__anon2bcf94660108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2bcf94660208
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2bcf94660308
block|{
DECL|member|run
name|gint
name|run
...
specifier|static
name|void
DECL|function|set_value (dtype,bytes,best,here,dest,tmp)
name|set_value
parameter_list|(
name|dtype
parameter_list|,
...
specifier|static
name|int
DECL|function|value_difference_check (pos1,pos2,ch)
name|value_difference_check
parameter_list|(
name|pos1
parameter_list|,
...
specifier|static
name|void
DECL|function|initialize_white (dtype,bytes,best,here,tmp)
name|initialize_white
parameter_list|(
name|dtype
parameter_list|,
...
specifier|static
name|void
DECL|function|propagate_white (dtype,bytes,orig,here,best,tmp)
name|propagate_white
parameter_list|(
name|dtype
parameter_list|,
...
specifier|static
name|void
DECL|function|initialize_black (image_type,channels,best,here,tmp)
name|initialize_black
parameter_list|(
name|image_type
parameter_list|,
...
specifier|static
name|void
DECL|function|propagate_black (image_type,channels,orig,here,best,tmp)
name|propagate_black
parameter_list|(
name|image_type
parameter_list|,
...
typedef|typedef
struct|struct
DECL|struct|__anon2bcf94660408
block|{
...
specifier|static
name|void
DECL|function|initialize_middle (image_type,channels,best,here,tmp)
name|initialize_middle
parameter_list|(
name|image_type
parameter_list|,
...
specifier|static
name|void
DECL|function|propagate_middle (image_type,channels,orig,here,best,tmp)
name|propagate_middle
parameter_list|(
name|image_type
parameter_list|,
...
specifier|static
name|void
DECL|function|set_middle_to_peak (image_type,channels,best,here,dest,tmp)
name|set_middle_to_peak
parameter_list|(
name|image_type
parameter_list|,
...
specifier|static
name|void
DECL|function|set_foreground_to_peak (image_type,channels,best,here,dest,tmp)
name|set_foreground_to_peak
parameter_list|(
name|image_type
parameter_list|,
...
specifier|static
name|void
DECL|function|initialize_foreground (image_type,channels,best,here,tmp)
name|initialize_foreground
parameter_list|(
name|image_type
parameter_list|,
...
specifier|static
name|void
DECL|function|initialize_background (image_type,channels,best,here,tmp)
name|initialize_background
parameter_list|(
name|image_type
parameter_list|,
...
specifier|static
name|void
DECL|function|propagate_a_color (image_type,channels,orig,here,best,tmp)
name|propagate_a_color
parameter_list|(
name|image_type
parameter_list|,
...
specifier|static
name|void
DECL|function|propagate_opaque (image_type,channels,orig,here,best,tmp)
name|propagate_opaque
parameter_list|(
name|image_type
parameter_list|,
...
specifier|static
name|void
DECL|function|propagate_transparent (image_type,channels,orig,here,best,tmp)
name|propagate_transparent
parameter_list|(
name|image_type
parameter_list|,
...
name|GtkWidget
modifier|*
DECL|function|gtkW_frame_new (gchar * name,GtkWidget * parent)
name|gtkW_frame_new
parameter_list|(
name|gchar
modifier|*
