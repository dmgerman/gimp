...
argument_list|,
literal|"Michael Sweet"
argument_list|,
literal|"Michael Sweet"
argument_list|,
name|PLUG_IN_VERSION
argument_list|,
literal|"<Image>/Filters/Image/Sharpen..."
argument_list|,
literal|"RGB*, GRAY*"
argument_list|,
name|PROC_PLUG_IN
...
name|fact
decl_stmt|;
comment|/* Scaling for convolution matrix */
...
block|}
empty_stmt|;
comment|/*   * Draw the preview image...   */
switch|switch
condition|(
name|img_bpp
condition|)
