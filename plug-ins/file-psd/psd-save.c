...
specifier|static
name|void
DECL|function|write_pixel_data (FILE * fd,gint32 drawableID,glong * ChanLenPosition,gint32 ltable_offset,gboolean write_mask)
name|write_pixel_data
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|void
DECL|function|get_image_data (gint32 image_id)
name|get_image_data
parameter_list|(
name|gint32
name|image_id
...
name|Babl
modifier|*
DECL|function|get_pixel_format (gint32 drawableID)
name|get_pixel_format
parameter_list|(
name|gint32
name|drawableID
...
specifier|static
name|void
DECL|function|append_layers (const gint * layers,gint n_layers,GArray * array)
name|append_layers
parameter_list|(
specifier|const
name|gint
...
name|PSD_Layer
modifier|*
DECL|function|image_get_all_layers (gint32 image_id,gint * n_layers)
name|image_get_all_layers
parameter_list|(
name|gint32
name|image_id
