...
begin_comment
comment|/* Set to FALSE to suppress pop-up warnings about lossy file conversions */
end_comment
...
begin_define
DECL|macro|LOAD_MERGED_PROC
define|#
directive|define
name|LOAD_MERGED_PROC
value|"file-psd-load-merged"
end_define
...
begin_comment
DECL|macro|PSD_LOTH_SECTION
comment|/* Section divider setting - Layer groups (PS6) */
end_comment

begin_define
DECL|macro|PSD_LOTH_SECTION2
define|#
directive|define
name|PSD_LOTH_SECTION2
value|"lsdk"
end_define

begin_comment
DECL|macro|PSD_LOTH_SECTION2
comment|/* Nested section divider setting - Layer groups (CS5) */
end_comment
...
begin_comment
DECL|macro|PSD_LOTH_RESTRICT
comment|/* Channel blending restriction setting (PS6) */
end_comment
...
begin_comment
DECL|macro|PSD_LMT_MERGE_TRANS
comment|/* Merged transparency save flag (?) */
end_comment
...
begin_comment
DECL|macro|PSD_LMT_MERGE_TRANS_16
comment|/* Merged transparency save flag 2 */
end_comment
...
begin_comment
DECL|macro|PSD_LMT_MERGE_TRANS_32
comment|/* Merged transparency save flag 3 */
end_comment
...
begin_typedef
DECL|enum|__anon29e9fa230803
typedef|typedef
enum|enum
block|{
DECL|enumerator|PSD_CHANNEL_EXTRA_MASK
name|PSD_CHANNEL_EXTRA_MASK
init|=
operator|-
literal|3
block|,
comment|/* User supplied extra layer mask */
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa230c08
block|{
DECL|member|red
name|guint16
name|red
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa230d08
block|{
DECL|member|hue
name|guint16
name|hue
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa230e08
block|{
DECL|member|cyan
name|guint16
name|cyan
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa230f08
block|{
DECL|member|L
name|guint16
name|L
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa231008
block|{
DECL|member|gray
name|guint16
name|gray
...
begin_comment
comment|/* GIMP layer mode info */
end_comment

begin_typedef
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa231208
block|{
DECL|member|mode
name|GimpLayerMode
name|mode
...
begin_typedef
DECL|struct|__anon29e9fa231308
typedef|typedef
struct|struct
block|{
DECL|member|hRes
...
begin_typedef
DECL|struct|__anon29e9fa231408
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon29e9fa231508
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon29e9fa231608
typedef|typedef
struct|struct
block|{
DECL|member|format
...
begin_typedef
DECL|struct|__anon29e9fa231708
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon29e9fa231808
typedef|typedef
struct|struct
block|{
DECL|member|colorSpace
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa231908
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa231a08
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa231b08
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa231c08
block|{
DECL|member|id
name|gint32
name|id
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa231d08
block|{
DECL|member|top
name|gint32
name|top
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa231e08
block|{
DECL|member|top
name|gint32
name|top
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa231f08
block|{
DECL|member|xx
name|gdouble
name|xx
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa232008
block|{
DECL|member|drop
name|gboolean
name|drop
...
DECL|member|group_type
name|guchar
name|group_type
decl_stmt|;
comment|/* 0 -> not a group; 1 -> open folder; 2 -> closed folder; 3 -> end of group */
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa232108
block|{
DECL|member|id
name|gint16
name|id
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa232208
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa232308
block|{
DECL|member|type
name|gchar
name|type
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa232408
block|{
DECL|member|sig
name|gchar
name|sig
...
typedef|typedef
struct|struct
DECL|struct|__anon29e9fa232508
block|{
DECL|member|merged_image_only
name|gboolean
name|merged_image_only
decl_stmt|;
comment|/* Whether to load only the merged image data */
