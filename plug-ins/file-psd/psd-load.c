...
begin_function
name|gint32
DECL|function|load_image (const gchar * filename,gboolean merged_image_only,gboolean * resolution_loaded,GError ** load_error)
name|load_image
parameter_list|(
specifier|const
name|gchar
...
block|}
block|}
comment|/* Skip channel length data for unloaded channels */
if|if
condition|(
name|fseek
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Merged image data is blended against white.  Unblend it. */
if|if
condition|(
name|img_a
operator|->
