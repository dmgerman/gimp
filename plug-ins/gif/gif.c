...
begin_comment
comment|/* GIF loading and saving file filter for The GIMP version 1.0  *  *    - Adam D. Moss  *    - Peter Mattis  *    - Spencer Kimball  *  *      Based around original GIF code by David Koblas.  *  *  * Version 2.0.5 - 98/09/28  *                        Adam D. Moss -<adam@gimp.org><adam@foxbox.org>  */
end_comment
...
typedef|typedef
struct|struct
DECL|struct|__anon274df3190108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon274df3190208
block|{
DECL|member|run
name|gint
name|run
...
specifier|static
struct|struct
DECL|struct|__anon274df3190308
block|{
DECL|member|Width
name|unsigned
name|int
...
specifier|static
struct|struct
DECL|struct|__anon274df3190408
block|{
...
block|}
block|}
comment|/* commented out - this is now done in find_unused.. where neces. */
comment|/*  if ((*colors)< 256) 	  (*colors) += 1; */
block|}
...
name|g_warning
argument_list|(
literal|"GIF: colorstobpp - Eep! too many colors: %d\n"
argument_list|,
name|colors
argument_list|)
expr_stmt|;
...
name|bpp
expr_stmt|;
comment|/*  printf(">> %dbpp is %d colours<<\n", bpp, colors); */
return|return
operator|(
name|colors
operator|)
