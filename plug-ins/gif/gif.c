...
begin_comment
comment|/* GIF loading and saving file filter for the Gimp version 0.99+  *    - Peter Mattis, Spencer Kimball, Adam Moss.  *      Based around original GIF code by David Koblas.  *  *  * Version 1.99.18 - 97/12/11  *  *   Adam D. Moss -<adam@gimp.org><adam@foxbox.org>  *  *     This is beta code.  See TODO section for current shortcomings.  */
end_comment
...
typedef|typedef
struct|struct
DECL|struct|__anon2c050ddd0108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2c050ddd0208
block|{
DECL|member|run
name|gint
name|run
...
specifier|static
struct|struct
DECL|struct|__anon2c050ddd0308
block|{
DECL|member|Width
name|unsigned
name|int
...
specifier|static
struct|struct
DECL|struct|__anon2c050ddd0408
block|{
...
name|disposal
expr_stmt|;
comment|/*      switch (Gif89.disposal) 	{ 	case 0x00: break;  	case 0x01: strcat(framename," (combine)"); break; 	case 0x02: strcat(framename," (replace)"); break; 	case 0x03: strcat(framename," (combine)"); break; 	case 0x04: 	case 0x05: 	case 0x06: 	case 0x07: printf("GIF: Hmm... please forward this GIF to the " 			  "GIF plugin author!\n  (adam@foxbox.org)\n"); break; 	default: printf("GIF: Something got corrupted.\n"); break; 	}*/
if|if
condition|(
name|Gif89
operator|.
...
begin_function
DECL|function|find_unused_ia_colour (guchar * pixels,int numpixels)
specifier|static
name|int
name|find_unused_ia_colour
parameter_list|(
...
condition|)
block|{
comment|/* 	fprintf(stderr,"GIF: Found unused colour index %d.\n",(int)i); 	*/
return|return
name|i
return|;
block|}
...
name|gtk_label_new
argument_list|(
literal|"Default delay between frames where unspecified: "
argument_list|)
expr_stmt|;
name|gtk_box_pack_start
argument_list|(
...
name|gtk_frame_new
argument_list|(
literal|"Default disposal where unspecified"
argument_list|)
expr_stmt|;
name|gtk_frame_set_shadow_type
argument_list|(
...
name|group
argument_list|,
literal|"Make frame from cumulative layers (combine)"
argument_list|)
expr_stmt|;
name|group
operator|=
...
specifier|static
name|void
DECL|function|GIFEncodeHeader (FILE * fp,gboolean gif89,int GWidth,int GHeight,int GInterlace,int Background,int Transparent,int BitsPerPixel,int Red[],int Green[],int Blue[],ifunptr GetPixel)
name|GIFEncodeHeader
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|void
DECL|function|GIFEncodeGraphicControlExt (FILE * fp,int Disposal,int Delay89,int NumFramesInImage,int GWidth,int GHeight,int GInterlace,int Background,int Transparent,int BitsPerPixel,int Red[],int Green[],int Blue[],ifunptr GetPixel)
name|GIFEncodeGraphicControlExt
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|void
DECL|function|GIFEncodeLoopExt (FILE * fp,int GWidth,int GHeight,int GInterlace,int Background,int Transparent,int BitsPerPixel,int Red[],int Green[],int Blue[],ifunptr GetPixel,guint num_loops)
name|GIFEncodeLoopExt
parameter_list|(
name|FILE
modifier|*
