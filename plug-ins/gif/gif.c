...
begin_comment
comment|/* GIF loading and saving file filter for The GIMP version 1.0  *  *    - Adam D. Moss  *    - Peter Mattis  *    - Spencer Kimball  *  *      Based around original GIF code by David Koblas.  *  *  * Version 2.0.3 - 98/05/18  *                        Adam D. Moss -<adam@gimp.org><adam@foxbox.org>  */
end_comment
