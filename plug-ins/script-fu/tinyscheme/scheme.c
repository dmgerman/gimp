...
block|{
comment|/* Each load of any file gets its own top-level loop that               ends when the file has been read.  We detect that by               monitoring sc->file_i. */
name|pointer
name|depth
init|=
name|sc
...
begin_struct
DECL|struct|__anon2a1d5a140208
specifier|static
struct|struct
block|{
DECL|member|fct
...
begin_typedef
DECL|struct|__anon2a1d5a140308
typedef|typedef
struct|struct
block|{
DECL|member|func
