...
begin_function
DECL|function|is_array (pointer p)
name|INTERFACE
name|INLINE
name|int
name|is_array
...
begin_function
DECL|function|mk_character (scheme * sc,int c)
name|INTERFACE
name|pointer
name|mk_character
parameter_list|(
...
begin_comment
comment|/* allocate name to string area */
end_comment

begin_function
DECL|function|store_string (scheme * sc,int len_str,const char * str,char fill)
specifier|static
name|char
modifier|*
name|store_string
...
begin_function
DECL|function|mk_empty_string (scheme * sc,int len,char fill)
specifier|static
name|pointer
name|mk_empty_string
parameter_list|(
...
begin_function
DECL|function|mk_array (scheme * sc,int len,int type)
name|INTERFACE
specifier|static
name|pointer
name|mk_array
...
begin_function
DECL|function|array_elem (scheme * sc,pointer a,int ielem)
name|INTERFACE
specifier|static
name|pointer
name|array_elem
...
begin_function
DECL|function|set_array_elem (scheme * sc,pointer a,int ielem,pointer v)
name|INTERFACE
specifier|static
name|pointer
name|set_array_elem
...
begin_function
DECL|function|backchar (scheme * sc,int c)
specifier|static
name|void
name|backchar
parameter_list|(
...
begin_function
DECL|function|putchars (scheme * sc,const char * chars,int len)
specifier|static
name|void
name|putchars
parameter_list|(
...
name|_port
decl_stmt|;
comment|/* Output characters to console mode (if enabled) */
call|(
modifier|*
name|ts_output_routine
call|)
...
begin_function
DECL|function|putcharacter (scheme * sc,int c)
name|INTERFACE
name|void
name|putcharacter
parameter_list|(
...
begin_function
DECL|function|is_one_of (char * s,int c)
specifier|static
name|INLINE
name|int
name|is_one_of
...
name|sc
argument_list|,
literal|"make-array: size must be>= 0:"
argument_list|,
name|car
argument_list|(
name|sc
...
name|sc
argument_list|,
literal|"make-array: unknown array type:"
argument_list|,
name|cadr
argument_list|(
name|sc
...
name|sc
argument_list|,
literal|"array-ref: out of bounds:"
argument_list|,
name|cadr
argument_list|(
name|sc
...
name|sc
argument_list|,
literal|"array-set!: unable to alter immutable array:"
argument_list|,
name|car
argument_list|(
name|sc
...
name|sc
argument_list|,
literal|"array-set!: out of bounds:"
argument_list|,
name|cadr
argument_list|(
name|sc
