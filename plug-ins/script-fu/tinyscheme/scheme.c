...
name|NULL
condition|)
comment|/* Should this be left in?? ~~~~~ */
call|(
modifier|*
name|ts_output_routine
call|)
...
begin_comment
comment|//#warning FIXME: Update hash_fn() to handle UTF-8 coded keys
end_comment
...
begin_struct
DECL|struct|__anon28fd21120208
specifier|static
struct|struct
block|{
DECL|member|fct
...
begin_typedef
DECL|struct|__anon28fd21120308
typedef|typedef
struct|struct
block|{
DECL|member|func
