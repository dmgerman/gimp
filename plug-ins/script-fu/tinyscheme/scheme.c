...
name|stderr
argument_list|,
literal|"set_foreign_error_flag called outside a foreign function\n"
argument_list|)
expr_stmt|;
block|}
else|else
...
begin_struct
DECL|struct|__anon296401c10208
specifier|static
struct|struct
block|{
DECL|member|fct
...
begin_typedef
DECL|struct|__anon296401c10308
typedef|typedef
struct|struct
block|{
DECL|member|func
