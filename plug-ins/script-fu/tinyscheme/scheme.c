...
begin_comment
comment|/* For now, we don't want foreign functions to access a strings key */
end_comment

begin_function
DECL|function|symkey (pointer p)
name|INLINE
name|char
modifier|*
name|symkey
...
argument_list|)
expr_stmt|;
comment|/* mem was allocated via glib */
block|}
elseif|else
if|if
condition|(
...
argument_list|)
expr_stmt|;
comment|/* FIXME: Check for bad character and search for next good char. */
return|return
...
begin_struct
DECL|struct|__anon274d1eb20208
specifier|static
struct|struct
block|{
DECL|member|fct
...
begin_typedef
DECL|struct|__anon274d1eb20308
typedef|typedef
struct|struct
block|{
DECL|member|func
