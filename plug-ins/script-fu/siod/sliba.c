...
begin_function
name|void
DECL|function|array_prin1_string (char * ptr,struct gen_printio * f)
name|array_prin1_string
parameter_list|(
name|char
modifier|*
name|ptr
...
control|)
block|{
comment|/* Add one to account for the NUL at the end of the string */
name|len
operator|=
name|strlen
argument_list|(
