...
name|string
parameter_list|)
value|my_strescape (string, NULL)
end_define
...
typedef|typedef
struct|struct
DECL|struct|__anon2c64f8cf0108
block|{
DECL|member|adj
name|GtkAdjustment
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2c64f8cf0208
block|{
DECL|member|preview
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2c64f8cf0308
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2c64f8cf0408
block|{
DECL|member|name
name|gchar
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2c64f8cf0608
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2c64f8cf0708
block|{
DECL|member|status
name|GtkWidget
modifier|*
...
begin_comment
comment|/*  *  We need the g_strescape () implementation from glib-1.3,  *  so provide it here until this becomes the standard.   */
end_comment
...
name|gchar
modifier|*
DECL|function|my_strescape (const gchar * source,const gchar * exceptions)
name|my_strescape
parameter_list|(
specifier|const
name|gchar
