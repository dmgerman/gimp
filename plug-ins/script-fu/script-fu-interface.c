...
typedef|typedef
struct|struct
DECL|struct|__anon27fcf2ca0108
block|{
DECL|member|adj
name|GtkAdjustment
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon27fcf2ca0208
block|{
DECL|member|preview
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon27fcf2ca0308
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon27fcf2ca0408
block|{
DECL|member|name
name|gchar
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon27fcf2ca0508
block|{
DECL|member|list
name|GSList
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon27fcf2ca0708
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon27fcf2ca0808
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
parameter_list|)
block|{
comment|/* FIXME: here should be a check if the fontname is valid and the font is present */
name|gtk_label_set_text
argument_list|(
name|GTK_LABEL
argument_list|(
...
block|for (i = 0; i< script->num_args; i++)     if (script->arg_types[i] == SF_FONT)       { 	font = gdk_font_load (script->arg_values[i].sfa_font.fontname); 	if (font == NULL) 	  { 	    g_message (_("At least one font you've choosen is invalid.\n" 			 "Please check your settings.\n")); 	    return; 	  } 	else 	  gdk_font_unref (font);       }
endif|#
directive|endif
name|length
operator|=
