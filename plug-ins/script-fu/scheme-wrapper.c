...
specifier|static
name|pointer
name|script_fu_marshal_procedure_call_strict
parameter_list|(
name|scheme
modifier|*
name|sc
...
specifier|static
name|pointer
name|script_fu_marshal_procedure_call_permissive
parameter_list|(
name|scheme
modifier|*
name|sc
...
typedef|typedef
struct|struct
DECL|struct|__anon2c0b8cc40108
block|{
DECL|member|name
specifier|const
name|gchar
...
argument_list|)
expr_stmt|;
comment|/* Define string constant for use in building search paths */
name|symbol
operator|=
name|sc
operator|->
...
specifier|static
name|void
DECL|function|ts_init_enum (scheme * sc,GType enum_type)
name|ts_init_enum
parameter_list|(
name|scheme
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  register the internal database execution procedure; see comment below  */
name|symbol
operator|=
name|sc
operator|->
...
name|buff
decl_stmt|;
comment|/* Build a define that will call the foreign function.        * The Scheme statement was suggested by Simon Budig.        *        * We call the procedure through -gimp-proc-db-call, which is a more        * permissive version of gimp-proc-db-call, that accepts (and ignores)        * any number of arguments for nullary procedures, for backward        * compatibility.        */
name|buff
operator|=
name|g_strdup_printf
argument_list|(
literal|" (define (%s . args)"
literal|" (apply -gimp-proc-db-call \"%s\" args))"
argument_list|,
name|proc_list
index|[
name|i
...
specifier|static
name|pointer
DECL|function|script_fu_marshal_procedure_call (scheme * sc,pointer a,gboolean permissive)
name|script_fu_marshal_procedure_call
parameter_list|(
name|scheme
modifier|*
...
name|g_printerr
argument_list|(
literal|"      COLOR list contains non-numbers\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
argument_list|)
argument_list|,
literal|"Argument %d for %s is an unknown type %s"
argument_list|,
name|i
operator|+
literal|1
...
specifier|static
name|pointer
DECL|function|script_fu_marshal_procedure_call_strict (scheme * sc,pointer a)
name|script_fu_marshal_procedure_call_strict
parameter_list|(
name|scheme
modifier|*
...
specifier|static
name|pointer
DECL|function|script_fu_marshal_procedure_call_permissive (scheme * sc,pointer a)
name|script_fu_marshal_procedure_call_permissive
parameter_list|(
name|scheme
modifier|*
