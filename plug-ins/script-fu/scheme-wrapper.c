...
begin_comment
comment|/* Create an SF-RUN-MODE constant for use in scripts.  */
end_comment

begin_comment
comment|/* It is set to the run mode state determined by GIMP. */
end_comment

begin_function
name|void
DECL|function|set_run_mode_constant (GimpRunMode run_mode)
