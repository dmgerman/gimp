...
begin_function
name|void
DECL|function|tinyscheme_init (gboolean local_register_scripts)
...
argument_list|()
expr_stmt|;
comment|/* FIXME: need to search in the scripts search path */
name|filename
operator|=
...
name|g_printerr
argument_list|(
literal|"Unable to read initialization file\n"
argument_list|)
expr_stmt|;
block|}
else|else
