...
typedef|typedef
struct|struct
DECL|struct|__anon2b6f8a9c0108
block|{
DECL|member|adj
name|GtkAdjustment
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2b6f8a9c0208
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b6f8a9c0308
block|{
DECL|member|name
name|gchar
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2b6f8a9c0408
block|{
DECL|member|list
name|GSList
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2b6f8a9c0608
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b6f8a9c0708
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|script_fu_progress_start (const gchar * message,gboolean cancelable,gpointer user_data)
name|script_fu_progress_start
parameter_list|(
specifier|const
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|script_fu_progress_end (gpointer user_data)
name|script_fu_progress_end
parameter_list|(
name|gpointer
name|user_data
parameter_list|)
...
specifier|static
name|void
DECL|function|script_fu_progress_text (const gchar * message,gpointer user_data)
name|script_fu_progress_text
parameter_list|(
specifier|const
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|script_fu_progress_value (gdouble percentage,gpointer user_data)
name|script_fu_progress_value
parameter_list|(
name|gdouble
name|percentage
parameter_list|,
...
specifier|static
name|void
DECL|function|script_fu_about (SFScript * script)
name|script_fu_about
parameter_list|(
name|SFScript
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*  move focus from the text view to the Close button  */
