...
begin_function
name|void
DECL|function|script_fu_find_scripts (GimpPlugIn * plug_in,GList * path)
...
specifier|static
name|void
DECL|function|script_fu_load_directory (GFile * directory)
name|script_fu_load_directory
parameter_list|(
name|GFile
modifier|*
...
specifier|static
name|void
DECL|function|script_fu_load_script (GFile * file)
name|script_fu_load_script
parameter_list|(
name|GFile
modifier|*
...
specifier|static
name|gboolean
DECL|function|script_fu_install_script (gpointer foo G_GNUC_UNUSED,GList * scripts,gpointer data)
name|script_fu_install_script
parameter_list|(
name|gpointer
name|foo
...
specifier|static
name|gboolean
DECL|function|script_fu_remove_script (gpointer foo G_GNUC_UNUSED,GList * scripts,gpointer data)
name|script_fu_remove_script
parameter_list|(
name|gpointer
name|foo
...
name|GimpValueArray
modifier|*
DECL|function|script_fu_script_proc (GimpProcedure * procedure,const GimpValueArray * args,gpointer data)
name|script_fu_script_proc
parameter_list|(
name|GimpProcedure
modifier|*
