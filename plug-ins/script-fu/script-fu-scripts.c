...
operator|++
expr_stmt|;
comment|/*  and may be followed by a DRAWABLE id  */
if|if
condition|(
name|script_fu_param_init
argument_list|(
...
expr_stmt|;
block|}
comment|/*  the first parameter may be a LAYER id  */
if|if
condition|(
name|min_args
operator|==
...
expr_stmt|;
block|}
comment|/*  the first parameter may be a CHANNEL id  */
if|if
condition|(
name|min_args
operator|==
...
expr_stmt|;
block|}
comment|/*  the first parameter may be a VECTORS id  */
if|if
condition|(
name|min_args
operator|==
