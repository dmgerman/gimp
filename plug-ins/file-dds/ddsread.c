...
DECL|function|read_dds (GFile * file,GimpImage ** ret_image,gboolean interactive,GimpProcedure * procedure,GObject * config)
name|read_dds
parameter_list|(
name|GFile
modifier|*
...
specifier|static
name|gboolean
DECL|function|load_layer (FILE * fp,dds_header_t * hdr,dds_load_info_t * d,GimpImage * image,guint level,char * prefix,guint * l,guchar * pixels,guchar * buf,gboolean decode_images)
name|load_layer
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|gboolean
DECL|function|load_mipmaps (FILE * fp,dds_header_t * hdr,dds_load_info_t * d,GimpImage * image,char * prefix,unsigned int * l,guchar * pixels,guchar * buf,gboolean read_mipmaps,gboolean decode_images)
name|load_mipmaps
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|gboolean
DECL|function|load_face (FILE * fp,dds_header_t * hdr,dds_load_info_t * d,GimpImage * image,gchar * prefix,guint * l,guchar * pixels,guchar * buf,gboolean read_mipmaps,gboolean decode_images)
name|load_face
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|guchar
DECL|function|color_bits (guint mask)
name|color_bits
parameter_list|(
name|guint
name|mask
...
specifier|static
name|guchar
DECL|function|color_shift (guint mask)
name|color_shift
parameter_list|(
name|guint
name|mask
...
specifier|static
name|gboolean
DECL|function|load_dialog (GimpProcedure * procedure,GObject * config)
name|load_dialog
parameter_list|(
name|GimpProcedure
modifier|*
...
name|_
argument_list|(
literal|"_Automatically decode YCoCg/AExp "
literal|"images when detected"
argument_list|)
argument_list|)
expr_stmt|;
name|gtk_box_pack_start
