...
specifier|static
name|void
DECL|function|write_layer (FILE * fp,GimpImage * image,GimpDrawable * drawable,int w,int h,int bpp,int fmtbpp,int mipmaps)
name|write_layer
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|void
DECL|function|write_volume_mipmaps (FILE * fp,GimpImage * image,GList * layers,int w,int h,int d,int bpp,int fmtbpp,int mipmaps)
...
specifier|static
name|gboolean
DECL|function|write_image (FILE * fp,GimpImage * image,GimpDrawable * drawable)
name|write_image
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|void
DECL|function|string_value_combo_set_item_sensitive (GtkWidget * widget,gint value,gboolean sensitive)
...
specifier|static
name|void
DECL|function|string_value_combo_set_active (GtkWidget * widget,gint value)
...
specifier|static
name|gint
DECL|function|save_dialog (GimpImage * image,GimpDrawable * drawable)
name|save_dialog
parameter_list|(
name|GimpImage
modifier|*
