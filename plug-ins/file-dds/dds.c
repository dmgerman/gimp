...
name|procedure
argument_list|,
literal|"Converts YCoCg (scaled) encoded "
literal|"pixels to RGB"
argument_list|,
literal|"Converts YCoCg (scaled) encoded "
literal|"pixels to RGB"
argument_list|,
...
name|procedure
argument_list|,
literal|"Converts alpha exponent encoded "
literal|"pixels to RGB"
argument_list|,
literal|"Converts alpha exponent encoded "
literal|"pixels to RGB"
...
name|GimpValueArray
modifier|*
DECL|function|dds_decode (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|dds_decode
parameter_list|(
name|GimpProcedure
modifier|*
