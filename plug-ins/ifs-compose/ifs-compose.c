...
typedef|typedef
struct|struct
DECL|struct|__anon29c911c00308
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29c911c00508
block|{
DECL|member|ifsvals
name|IfsComposeVals
name|ifsvals
...
typedef|typedef
struct|struct
DECL|struct|__anon29c911c00608
block|{
DECL|member|color
name|GimpRGB
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon29c911c00708
block|{
DECL|member|dialog
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon29c911c00808
block|{
DECL|member|area
name|GtkWidget
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon29c911c00908
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon29c911c00a08
block|{
DECL|member|run
name|gboolean
name|run
...
directive|define
name|IFS
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), IFS_TYPE, Ifs))
end_define
...
specifier|static
name|void
name|design_area_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|ifs_class_init (IfsClass * klass)
name|ifs_class_init
parameter_list|(
name|IfsClass
modifier|*
...
specifier|static
name|void
DECL|function|ifs_init (Ifs * ifs)
name|ifs_init
parameter_list|(
name|Ifs
modifier|*
...
name|GList
modifier|*
DECL|function|ifs_query_procedures (GimpPlugIn * plug_in)
name|ifs_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|ifs_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|ifs_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpValueArray
modifier|*
DECL|function|ifs_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * image,GimpDrawable * drawable,const GimpValueArray * args,gpointer run_data)
name|ifs_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|gboolean
DECL|function|design_area_draw (GtkWidget * widget,cairo_t * cr)
name|design_area_draw
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|design_area_size_allocate (GtkWidget * widget,GtkAllocation * allocation)
name|design_area_size_allocate
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|gboolean
DECL|function|value_pair_scale_callback_real (gpointer data)
name|value_pair_scale_callback_real
parameter_list|(
name|gpointer
name|data
parameter_list|)
...
literal|500
argument_list|,
comment|/* update every half second */
name|value_pair_scale_callback_real
argument_list|,
name|value_pair
argument_list|)
