...
specifier|static
name|void
DECL|function|rcm_create_pixmap_button (GtkWidget ** label,GtkWidget ** button,GtkWidget ** label_box,GCallback callback,gpointer data,const gchar * text,GtkWidget * parent,gint pos)
