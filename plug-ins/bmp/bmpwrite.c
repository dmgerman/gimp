...
name|_
argument_list|(
literal|"Cannot operate on grayscale images with alpha channel."
argument_list|)
argument_list|)
expr_stmt|;
return|return
...
name|_
argument_list|(
literal|"Cannot operate on indexed images with alpha channel."
argument_list|)
argument_list|)
expr_stmt|;
return|return
...
name|channels
expr_stmt|;
comment|/* We'll begin with the 32 and 24 bit Bitmaps, they are easy :-) */
if|if
condition|(
name|bpp
operator|==
