...
name|_
argument_list|(
literal|"Cannot save indexed image with transparency "
literal|"in BMP file format."
argument_list|)
argument_list|,
name|_
argument_list|(
...
specifier|static
name|void
DECL|function|WriteImage (FILE * f,guchar * src,gint width,gint height,gint encoded,gint channels,gint bpp,gint spzeile,gint MapSize,RGBMode rgb_format)
name|WriteImage
parameter_list|(
name|FILE
modifier|*
...
specifier|static
name|gboolean
DECL|function|save_dialog_rgb (gint channels)
name|save_dialog_rgb
parameter_list|(
name|gint
name|channels
