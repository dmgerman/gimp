...
begin_function
name|gint
DECL|function|WriteBMP (char * filename,gint32 image,gint32 drawable_ID)
name|WriteBMP
parameter_list|(
name|char
modifier|*
...
begin_function
name|void
DECL|function|WriteImage (FILE * f,guchar * src,int width,int height,int encoded,int channels,int bpp,int spzeile,int MapSize)
name|WriteImage
parameter_list|(
name|FILE
modifier|*
