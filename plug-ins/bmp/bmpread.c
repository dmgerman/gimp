...
specifier|static
name|gboolean
DECL|function|ReadChannelMasks (FILE * fd,Bitmap_Channel * masks,guint channels)
...
name|g_print
argument_list|(
literal|"Channel %d mask %08x in %d out %d\n"
argument_list|,
name|i
argument_list|,
name|masks
...
condition|)
block|{
comment|/* Default is 5.5.5 if no masks are given */
name|masks
operator|=
name|g_new
argument_list|(
