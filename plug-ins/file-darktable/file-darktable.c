...
literal|"cr2"
block|,
literal|"0,string,\\x49\\x49\\x2a\\x00\\x10\\x00\\x00\\x00\\x43\\x52"
block|,
...
name|i
decl_stmt|;
comment|// TODO: check if darktable is installed
name|gboolean
name|have_darktable
init|=
name|TRUE
...
argument_list|)
expr_stmt|;
comment|/* keep the filename in sync with the .lua file! */
name|filename_out
operator|=
