...
directive|if
literal|0
block|g_print ("window: (%d,%d)--(%d,%d), viewport: (%d,%d)--(%d,%d)\n", 	   window->org_x, window->org_y, window->org_x + window->ext_x, window->org_y + window->ext_y,  	   viewport->org_x, viewport->org_y, viewport->org_x + viewport->ext_x, viewport->org_y + viewport->ext_y);
endif|#
directive|endif
name|canvas
operator|->
...
directive|if
literal|0
block|g_print ("font name: %s\n", name);
endif|#
directive|endif
comment|/* Very rough mapping from typical Windows fonts to XLFD */
name|g_strdown
argument_list|(
name|name
argument_list|)
...
directive|if
literal|0
block|g_print ("Another XLFD font: %s\n", fontname);
endif|#
directive|endif
name|objp
operator|->
