...
name|bpp
expr_stmt|;
comment|/* Special cases: Scanline is compatible with GIMP storage */
if|if
condition|(
name|extra
operator|==
...
expr_stmt|;
block|}
comment|/* Or read in and process each sample -- slower */
block|}
else|else
block|{
if|if
...
expr_stmt|;
block|}
comment|/* Set s/bitleft ready to use NEXTSAMPLE macro */
name|s
operator|=
name|source
expr_stmt|;
