...
begin_comment
comment|/* revision history:  * version 1.1.15;  2000/01/20  hof: parasites, Translate Guide Orientation to XJT orientation  * version 1.02.00; 1999/02/01  hof: PDB-calls to load/save resolution tattoos and parasites  *                                   busy_cursors (needs GIMP 1.1.1)  * version 1.01.00; 1998/11/22  hof: PDB-calls to load/save guides under GIMP 1.1  * version 1.00.00; 1998/10/31  hof: 1.st (pre) release  */
end_comment
...
modifier|*
modifier|*
DECL|function|p_gimp_parasite_list (gint32 * num_parasites)
...
begin_comment
comment|/* end p_gimp_parasite_list */
end_comment
