...
argument_list|)
expr_stmt|;
comment|/*   mw_iscale_entry_new (table, _("First color "), 0, 255, 1, 5, 0, */
comment|/* 		       0, 1, 1, 2,&(svals.col1[3])); */
comment|/*   mw_iscale_entry_new (table, _("Second color "), 0, 255, 1, 5, 0, */
comment|/* 		       0, 1, 2, 3,&(svals.col2[3])); */
name|gtk_widget_show
argument_list|(
name|table
argument_list|)
