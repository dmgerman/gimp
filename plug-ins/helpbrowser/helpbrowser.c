...
typedef|typedef
struct|struct
DECL|struct|__anon2b70dcdd0308
block|{
DECL|member|index
name|gint
name|index
...
typedef|typedef
struct|struct
DECL|struct|__anon2b70dcdd0408
block|{
DECL|member|title
name|gchar
modifier|*
...
begin_function
name|gboolean
DECL|function|open_browser_dialog (gchar * locale,gchar * path)
...
specifier|static
name|gboolean
DECL|function|open_url (gchar * locale,gchar * path)
name|open_url
parameter_list|(
name|gchar
modifier|*
