...
typedef|typedef
struct|struct
DECL|struct|__anon27c3e0780208
block|{
DECL|member|title
specifier|const
name|gchar
...
typedef|typedef
struct|struct
DECL|struct|__anon27c3e0780308
block|{
...
specifier|static
name|void
DECL|function|load_help (const gchar * help_path,const gchar * locale,const gchar * help_id)
name|load_help
parameter_list|(
specifier|const
name|gchar
...
specifier|static
name|gboolean
DECL|function|idle_load_help (gpointer data)
name|idle_load_help
parameter_list|(
name|gpointer
name|data
...
specifier|static
name|void
DECL|function|open_browser_dialog (void)
