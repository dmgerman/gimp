...
typedef|typedef
struct|struct
DECL|struct|__anon2c54b6f20108
block|{
DECL|member|uri
name|gchar
modifier|*
...
name|gchar
modifier|*
DECL|function|queue_prev (Queue * h,gint skip,gdouble * pos)
name|queue_prev
parameter_list|(
name|Queue
modifier|*
...
name|gchar
modifier|*
DECL|function|queue_next (Queue * h,gint skip,gdouble * pos)
name|queue_next
parameter_list|(
name|Queue
modifier|*
...
begin_function
name|void
DECL|function|queue_set_scroll_offset (Queue * h,gdouble pos)
