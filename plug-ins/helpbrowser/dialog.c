...
literal|"<toolitem action=\"back\" />"
literal|"<toolitem action=\"forward\" />"
literal|"<separator />"
...
name|ui_manager
argument_list|,
literal|"/ui/help-browser-toolbar/back"
argument_list|)
expr_stmt|;
...
name|ui_manager
argument_list|,
literal|"/ui/help-browser-toolbar/forward"
argument_list|)
expr_stmt|;
name|gtk_action_set_sensitive
argument_list|(
