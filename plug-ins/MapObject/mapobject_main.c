...
begin_comment
comment|/* MapObject 0.32 -- image filter plug-in for The Gimp program                   */
end_comment

begin_comment
comment|/* Copyright (C) 1996/97 Tom Bech                                                */
end_comment

begin_comment
comment|/* Copyright (C) 1996/97 Federico Mena Quintero                                  */
end_comment
