...
begin_typedef
DECL|struct|__anon29fe73430108
typedef|typedef
struct|struct
block|{
DECL|member|xmin
...
begin_typedef
DECL|struct|__anon29fe73430208
typedef|typedef
struct|struct
block|{
DECL|member|preview
...
literal|"Julia Fractal Chaos Explorer Plug-In for the GIMP\n"
