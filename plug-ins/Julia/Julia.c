...
name|run
decl_stmt|;
DECL|typedef|Julia_interface_t
block|}
name|Julia_interface_t
typedef|;
end_typedef
...
argument_list|,
literal|"Julia Chaos Fractal Explorer Plug-In"
argument_list|,
literal|"Fills the active painting area with a Julia fractal."
argument_list|,
...
argument_list|,
literal|"<Image>/Filters/Render/Julia Fractal"
argument_list|,
literal|"RGB*"
argument_list|,
name|PROC_PLUG_IN
...
argument_list|(
literal|"Rendering Julia Fractal..."
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|Julia_get_pixel (int x,int y,guchar * pixel)
name|Julia_get_pixel
parameter_list|(
name|int
name|x
...
begin_comment
comment|/* Julia_get_pixel */
end_comment

begin_function
specifier|static
name|void
DECL|function|Julia_render_row (const guchar * src_row,guchar * dest_row,gint row,gint row_width,gint bytes)
name|Julia_render_row
parameter_list|(
specifier|const
name|guchar
...
specifier|static
name|void
DECL|function|Julia_logo_ok_callback (GtkWidget * widget,gpointer data)
name|Julia_logo_ok_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|Julia_about_callback (GtkWidget * widget,gpointer data)
name|Julia_about_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|Julia (GDrawable * drawable)
name|Julia
parameter_list|(
name|GDrawable
modifier|*
...
specifier|static
name|gint
DECL|function|Julia_dialog (void)
name|Julia_dialog
parameter_list|(
name|void
parameter_list|)
...
argument_list|)
argument_list|,
literal|"Julia Fractal Explorer (cotting@mygale.org)"
argument_list|)
expr_stmt|;
...
literal|5
argument_list|,
literal|"Change the CX value (changes aspect of fractal)"
argument_list|)
expr_stmt|;
name|dialog_create_value
argument_list|(
...
literal|5
argument_list|,
literal|"Change the CY value (changes aspect of fractal)"
argument_list|)
expr_stmt|;
name|gtk_widget_show
argument_list|(
...
begin_comment
comment|/* static void dialog_reset_callback(GtkWidget *widget, gpointer data) { static Julia_vals_t wvals = {         -2,1,-1.5,1.5,100,0,128,128,128,0,0,0, };          gtk_widget_destroy(GTK_WIDGET(data));         Julia_dialog(); } */
end_comment
...
specifier|static
name|void
DECL|function|Julia_toggle_update (GtkWidget * widget,gpointer data)
name|Julia_toggle_update
parameter_list|(
name|GtkWidget
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|Julia_logo_dialog ()
name|Julia_logo_dialog
parameter_list|()
block|{
name|GtkWidget
...
literal|"Julia Fractal Chaos Explorer\nPlug-In for the GIMP\n"
