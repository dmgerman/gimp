...
specifier|static
name|void
DECL|function|ico_bpp_changed (GtkWidget * combo,GObject * hbox)
name|ico_bpp_changed
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|ico_toggle_compress (GtkWidget * checkbox,GObject * hbox)
name|ico_toggle_compress
parameter_list|(
name|GtkWidget
modifier|*
