...
DECL|member|error_mix
name|int
name|error_mix
decl_stmt|;
comment|/* How much error gets mixed in to decide */
comment|/* what color to print */
...
directive|if
literal|0
block|dither_matrix_t mat0;   dither_matrix_t mat1;   dither_matrix_t mat2;   dither_matrix_t mat3;   dither_matrix_t mat4;   dither_matrix_t mat5;
endif|#
directive|endif
DECL|member|mat6
name|dither_matrix_t
...
begin_comment
unit|static int sq2[] = {   0, 2,   3, 1 };  static int sq3[] = {   3, 2, 7,   8, 4, 0,   1, 6, 5 };
...
begin_include
unit|static int msq0[] = {   00, 14, 21, 17,  8,   22, 18,  5,  4, 11,   9,   1, 12, 23, 15,   13, 20, 19,  6,  2,   16,  7,  3, 10, 24 };  static int msq1[] = {   03, 11, 20, 17,  9,   22, 19,  8,  1, 10,   06,  0, 12, 24, 18,   14, 23, 16,  5,  2,   15,  7,  4, 13, 21 };  static unsigned short quic0[] = {
include|#
directive|include
...
specifier|static
name|void
DECL|function|init_matrix_short (dither_matrix_t * mat,int x_size,int y_size,unsigned short * array,int transpose)
name|init_matrix_short
parameter_list|(
name|dither_matrix_t
modifier|*
name|mat
...
specifier|inline
name|unsigned
DECL|function|ditherpoint (const dither_t * d,dither_matrix_t * mat,int x,int y)
name|ditherpoint
parameter_list|(
specifier|const
name|dither_t
...
specifier|static
name|int
DECL|function|imax (int a,int b)
name|imax
parameter_list|(
name|int
name|a
...
begin_function
name|void
DECL|function|dither_set_error_mix (void * vd,double mix_ratio)
...
specifier|inline
name|int
DECL|function|update_color (int color,int dither)
name|update_color
parameter_list|(
name|int
name|color
...
specifier|inline
name|int
DECL|function|print_color (dither_t * d,dither_color_t * rv,int base,int density,int adjusted,int x,int y,unsigned char * c,unsigned char * lc,unsigned char bit,int length,unsigned randomizer,int dontprint,unsigned * ink_budget,dither_matrix_t * pick_matrix,dither_matrix_t * dither_matrix,int dither_type)
name|print_color
parameter_list|(
name|dither_t
modifier|*
...
directive|if
literal|0
if|else if (base< d->adaptive_limit) 	    { 	      unsigned dtmp = (base - d->adaptive_lower_limit) * 65536 / 		(d->adaptive_limit - d->adaptive_lower_limit); 	      if (((xrand()& 0xffff000)>> 12)> dtmp) 		{ 		  dither_type = D_ORDERED; 		  dither_value = base; 		} 	      else if (adjusted<= 0) 		return adjusted; 	    }
endif|#
directive|endif
elseif|else
if|if
...
begin_comment
comment|/*  * 'dither_fastblack()' - Dither grayscale pixels to black using a hard  * threshold.  This is for use with predithered output, or for text  * or other pure black and white only.  */
end_comment

begin_function
name|void
DECL|function|dither_fastblack (unsigned short * gray,int row,void * vd,unsigned char * black)
...
begin_comment
comment|/*  * 'dither_black_n()' - Dither grayscale pixels to n levels of black.  * This is for grayscale output.  */
end_comment

begin_function
name|void
DECL|function|dither_black (unsigned short * gray,int row,void * vd,unsigned char * black)
name|dither_black
parameter_list|(
name|unsigned
name|short
...
begin_comment
comment|/*  * 'dither_cmyk_n()' - Dither RGB pixels to n levels of cyan, magenta, yellow,  *                     and black.  */
end_comment
...
name|unsigned
name|short
DECL|function|usmin (unsigned short a,unsigned short b)
name|usmin
parameter_list|(
name|unsigned
name|short
...
specifier|static
name|void
DECL|function|generate_cmy (dither_t * d,unsigned short * rgb,int * nonzero,int row)
name|generate_cmy
parameter_list|(
name|dither_t
modifier|*
...
begin_function
name|void
DECL|function|dither_cmyk (unsigned short * rgb,int row,void * vd,unsigned char * cyan,unsigned char * lcyan,unsigned char * magenta,unsigned char * lmagenta,unsigned char * yellow,unsigned char * lyellow,unsigned char * black)
name|dither_cmyk
parameter_list|(
name|unsigned
name|short
...
directive|if
literal|0
block|ocd = oc * d->c_darkness;       omd = om * d->m_darkness;       oyd = oy * d->y_darkness;
endif|#
directive|endif
if|if
condition|(
