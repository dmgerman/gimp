...
specifier|static
name|void
name|gimp_print_preview_get_page_size
parameter_list|(
name|GimpPrintPreview
modifier|*
name|preview
...
specifier|static
name|gboolean
DECL|function|gimp_print_preview_is_inside (GimpPrintPreview * preview,gdouble x,gdouble y)
name|gimp_print_preview_is_inside
parameter_list|(
name|GimpPrintPreview
modifier|*
name|preview
...
specifier|static
name|void
DECL|function|print_preview_set_inside (GimpPrintPreview * preview,gboolean inside)
...
specifier|static
name|void
DECL|function|gimp_print_preview_get_page_size (GimpPrintPreview * preview,gdouble * paper_width,gdouble * paper_height)
name|gimp_print_preview_get_page_size
parameter_list|(
name|GimpPrintPreview
modifier|*
