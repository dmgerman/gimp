...
typedef|typedef
struct|struct
DECL|struct|__anon2c5c53220108
block|{
DECL|member|data
name|PrintData
modifier|*
...
specifier|static
name|void
name|print_resolution_load_defaults
parameter_list|(
name|PrintSizeInfo
modifier|*
name|info
...
specifier|static
name|void
DECL|function|update_custom_widget (GtkPrintOperation * operation,GtkWidget * custom_widget,GtkPageSetup * page_setup,GtkPrintSettings * print_settings)
name|update_custom_widget
parameter_list|(
name|GtkPrintOperation
modifier|*
...
specifier|static
name|void
DECL|function|print_resolution_load_defaults (PrintSizeInfo * info)
name|print_resolution_load_defaults
parameter_list|(
name|PrintSizeInfo
modifier|*
