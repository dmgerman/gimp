...
specifier|static
name|void
DECL|function|initialize_raw_weave (raw_t * w,int S,int J,int H)
...
DECL|function|initialize_weave_params (int S,int J,int H,int firstrow,int lastrow,int pagelength)
...
name|printf
argument_list|(
literal|"S=%d  J=%d  H=%d  firstrow=%d  lastrow=%d  pagelength=%d\n"
argument_list|,
name|S
argument_list|,
name|J
