...
argument_list|)
expr_stmt|;
name|gtk_print_operation_set_allow_async
argument_list|(
name|operation
argument_list|,
name|TRUE
...
specifier|static
name|void
DECL|function|print_done (GtkPrintOperation * operation,GtkPrintOperationResult result,GtkPrintOperationResult * result_ptr)
name|print_done
parameter_list|(
name|GtkPrintOperation
modifier|*
