...
argument_list|)
expr_stmt|;
comment|/* The export image should have been deleted already from the    * "status-changed" handler, but better make sure that it isn't    * left behind.    */
if|if
condition|(
...
specifier|static
name|void
DECL|function|status_changed (GtkPrintOperation * operation,gint32 * image_ID)
name|status_changed
parameter_list|(
name|GtkPrintOperation
modifier|*
...
if|if
condition|(
name|gtk_print_operation_get_status
argument_list|(
name|operation
argument_list|)
operator|>
name|GTK_PRINT_STATUS_GENERATING_DATA
condition|)
block|{
