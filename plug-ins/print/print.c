...
argument_list|)
expr_stmt|;
comment|/* FIXME: There should be a better way to query for a procedure.    *        Also this code has a race condition. The best solution    *        would be to catch the error somehow (see bug #344818).    */
