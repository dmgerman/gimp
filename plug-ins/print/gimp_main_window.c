...
begin_define
DECL|macro|EXPANDED_PREVIEW_WINDOW
define|#
directive|define
name|EXPANDED_PREVIEW_WINDOW
end_define
...
name|plug_in_name
decl_stmt|;
comment|/*    * Fetch a thumbnail of the image we're to print from the Gimp...    */
name|thumbnail_w
operator|=
name|THUMBNAIL_MAXW
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/*    * thumbnail_w and thumbnail_h have now been adjusted to the actual    * thumbnail dimensions.  Now initialize a colour-adjusted version of    * the thumbnail...    */
name|adjusted_thumbnail_data
operator|=
name|g_malloc
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*    * Use a dummy label as a spacer    */
name|label
operator|=
name|gtk_label_new
argument_list|(
...
directive|if
literal|0
block|gtk_signal_handlers_destroy (GTK_OBJECT (entry));
endif|#
directive|endif
...
begin_define
DECL|macro|Combo_get_text (combo)
define|#
directive|define
name|Combo_get_text
parameter_list|(
