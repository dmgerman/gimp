...
begin_typedef
DECL|struct|__anon29b3b2f50108
typedef|typedef
struct|struct
block|{
DECL|member|model
...
name|stderr
argument_list|,
literal|"canon: Couldn't look up paper size %dx%d - "
...
specifier|static
name|void
DECL|function|canon_init_printer (FILE * prn,canon_cap_t caps,int output_type,const char * media_str,const vars_t * v,int print_head,const char * source_str,int xdpi,int ydpi,int page_width,int page_height,int top,int left,int use_dmt)
...
begin_function
DECL|function|canon_deinit_printer (FILE * prn,canon_cap_t caps)
name|void
name|canon_deinit_printer
parameter_list|(
name|FILE
modifier|*
name|prn
