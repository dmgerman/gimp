...
begin_decl_stmt
DECL|variable|photo_pigment_dither_ranges
specifier|static
name|simple_dither_range_t
name|photo_pigment_dither_ranges
index|[]
init|=
block|{
comment|/* MRS: Not calibrated! */
block|{
literal|0.15
block|,
literal|0x1
...
begin_decl_stmt
DECL|variable|photo_pigment_ink
specifier|static
name|escp2_variable_ink_t
name|photo_pigment_ink
init|=
block|{
name|photo_pigment_dither_ranges
block|,
...
begin_decl_stmt
DECL|variable|standard_pigment_dither_ranges
specifier|static
name|simple_dither_range_t
name|standard_pigment_dither_ranges
index|[]
init|=
block|{
comment|/* MRS: Not calibrated! */
...
begin_decl_stmt
DECL|variable|standard_pigment_ink
specifier|static
name|escp2_variable_ink_t
name|standard_pigment_ink
init|=
block|{
name|standard_pigment_dither_ranges
block|,
...
begin_decl_stmt
DECL|variable|escp2_pigment_standard_inks
specifier|static
name|escp2_variable_inkset_t
name|escp2_pigment_standard_inks
init|=
block|{
operator|&
name|standard_pigment_ink
...
begin_decl_stmt
DECL|variable|escp2_pigment_photo_inks
specifier|static
name|escp2_variable_inkset_t
name|escp2_pigment_photo_inks
init|=
block|{
operator|&
name|photo_pigment_ink
...
begin_decl_stmt
DECL|variable|variable_pigment_inks
specifier|static
name|escp2_variable_inklist_t
name|variable_pigment_inks
init|=
block|{
operator|&
name|standard_inks
...
DECL|member|black_nozzle_separation
name|int
name|black_nozzle_separation
decl_stmt|;
comment|/* Separation between rows */
DECL|member|xres
name|int
name|xres
decl_stmt|;
...
DECL|member|enhanced_xres
name|int
name|enhanced_xres
decl_stmt|;
comment|/* Distance between dots in highest */
comment|/* quality modes */
...
begin_comment
DECL|macro|MODEL_INIT_MASK
comment|/* Is a special init sequence */
end_comment
...
begin_comment
DECL|macro|MODEL_INIT_STANDARD
comment|/* required for this printer, and if */
end_comment
...
begin_comment
DECL|macro|MODEL_HASBLACK_MASK
comment|/* Can this printer print black ink */
end_comment
...
begin_comment
DECL|macro|MODEL_HASBLACK_YES
comment|/* when it is also printing color? */
end_comment
...
begin_comment
DECL|macro|MODEL_6COLOR_MASK
comment|/* Is this a 6-color printer? */
end_comment
...
begin_comment
DECL|macro|MODEL_1440DPI_MASK
comment|/* Can this printer do 1440x720 dpi? */
end_comment
...
begin_comment
DECL|macro|MODEL_GRAYMODE_MASK
comment|/* Does this printer support special */
end_comment
...
begin_comment
DECL|macro|MODEL_720DPI_MODE_MASK
comment|/* Does this printer require old */
end_comment
...
begin_comment
DECL|macro|MODEL_720DPI_DEFAULT
comment|/* or new setting for printing */
end_comment
...
begin_comment
DECL|macro|MODEL_720DPI_600
comment|/* 720 dpi?  Only matters for */
end_comment

begin_comment
comment|/* single dot size printers */
end_comment
...
begin_comment
DECL|macro|MODEL_VARIABLE_DOT_MASK
comment|/* Does this printer support var */
end_comment
...
begin_comment
DECL|macro|MODEL_VARIABLE_NORMAL
comment|/* dot size printing? The newest */
end_comment
...
begin_comment
DECL|macro|MODEL_VARIABLE_4
comment|/* printers support multiple modes */
end_comment
...
begin_comment
DECL|macro|MODEL_COMMAND_MASK
comment|/* What general command set does */
end_comment
...
begin_comment
DECL|macro|MODEL_INK_MASK
comment|/* Does this printer support */
end_comment
...
begin_comment
DECL|macro|MODEL_INK_NORMAL
comment|/* different types of inks? */
end_comment
...
begin_comment
DECL|macro|MODEL_INK_SELECTABLE
comment|/* Only the Stylus Pro's do */
end_comment
...
begin_comment
DECL|macro|MODEL_ZEROMARGIN_YES
comment|/* (print to the edge of the paper) */
end_comment
...
begin_typedef
DECL|struct|__anon2b9377e70208
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_typedef
DECL|struct|__anon2b9377e70308
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_typedef
DECL|struct|__anon2b9377e70408
typedef|typedef
struct|struct
block|{
DECL|member|name
...
name|platen_gap
decl_stmt|;
DECL|member|base_density
name|double
name|base_density
decl_stmt|;
DECL|member|k_lower_scale
name|double
name|k_lower_scale
decl_stmt|;
DECL|member|k_upper
...
block|,
block|{
literal|"Premium Glossy Photo Paper"
block|,
literal|8
block|,
literal|0
...
block|,
block|{
literal|"Photo Quality Glossy Paper"
block|,
literal|6
block|,
literal|0
...
specifier|static
name|unsigned
DECL|function|escp2_black_nozzle_separation (int model)
name|escp2_black_nozzle_separation
parameter_list|(
name|int
name|model
parameter_list|)
...
specifier|static
name|unsigned
DECL|function|escp2_enhanced_xres (int model)
name|escp2_enhanced_xres
parameter_list|(
name|int
name|model
parameter_list|)
...
directive|if
literal|0
comment|/*    * I believe that this code is no longer needed.  I think I put it in    * a while back because our softweave pattern couldn't handle the top    * and bottom of the page.  Lying to the printer about the length of    * the page would allow us to print the entire image.  With our current    * weave code able to use the entire width of the permitted region,    * this hack shouldn't be needed any more.    */
block|page_length += (39 + (escp2_nozzles(model) * 2) * 		  escp2_nozzle_separation(model)) / 10;
comment|/* Top and bottom */
block|page_top += (39 + (escp2_nozzles(model) * 2) * 	       escp2_nozzle_separation(model)) / 10;
endif|#
directive|endif
name|init
operator|.
...
literal|.5
expr_stmt|;
comment|/* Can't find paper type? Assume plain */
name|nv
operator|.
name|density
operator|*=
...
specifier|static
name|void
DECL|function|escp2_unpack_2_1 (int length,const unsigned char * in,unsigned char * out0,unsigned char * out1)
...
specifier|static
name|void
DECL|function|escp2_unpack_2_2 (int length,const unsigned char * in,unsigned char * out0,unsigned char * out1)
...
control|)
block|{
comment|/*       * Note - we can't use (tempin& N)>> (shift - M) since negative       * right-shifts are not always implemented.       */
name|tempin
operator|=
operator|*
name|in
...
specifier|static
name|void
DECL|function|escp2_unpack_8_1 (int length,const unsigned char * in,unsigned char * out0,unsigned char * out1,unsigned char * out2,unsigned char * out3,unsigned char * out4,unsigned char * out5,unsigned char * out6,unsigned char * out7)
name|escp2_unpack_8_1
parameter_list|(
name|int
name|length
parameter_list|,
...
specifier|static
name|void
DECL|function|escp2_unpack_8_2 (int length,const unsigned char * in,unsigned char * out0,unsigned char * out1,unsigned char * out2,unsigned char * out3,unsigned char * out4,unsigned char * out5,unsigned char * out6,unsigned char * out7)
name|escp2_unpack_8_2
parameter_list|(
name|int
name|length
parameter_list|,
...
specifier|static
name|void
DECL|function|escp2_unpack_8 (int length,int bits,const unsigned char * in,unsigned char * out0,unsigned char * out1,unsigned char * out2,unsigned char * out3,unsigned char * out4,unsigned char * out5,unsigned char * out6,unsigned char * out7)
name|escp2_unpack_8
parameter_list|(
name|int
name|length
...
DECL|struct|__anon2b9377e70508
block|{
DECL|member|row
name|int
name|row
...
DECL|struct|__anon2b9377e70608
block|{
DECL|member|pass
name|int
name|pass
...
decl_stmt|;
comment|/* (really pass) */
DECL|struct|__anon2b9377e70808
struct|struct
block|{
DECL|member|k
name|off_t
...
decl_stmt|;
comment|/* (really pass) */
DECL|struct|__anon2b9377e70a08
struct|struct
block|{
DECL|member|k
name|char
...
index|]
decl_stmt|;
DECL|struct|__anon2b9377e70c08
struct|struct
block|{
DECL|member|k
name|unsigned
...
begin_typedef
DECL|struct|__anon2b9377e70d08
typedef|typedef
struct|struct
block|{
...
name|void
modifier|*
DECL|function|initialize_weave (int jets,int sep,int osample,int v_subpasses,int v_subsample,colormode_t colormode,int width,int linewidth,int lineheight,int separation_rows,int first_line,int phys_lines,int weave_strategy)
name|initialize_weave
parameter_list|(
name|int
name|jets
...
name|weave_strategy
parameter_list|)
comment|/* Which weaving pattern to use */
block|{
name|int
name|i
decl_stmt|;
...
specifier|static
name|void
DECL|function|flush_pass (escp2_softweave_t * sw,int passno,int model,int width,int hoffset,int ydpi,int xdpi,int physical_xdpi,FILE * prn,int vertical_subpass)
name|flush_pass
parameter_list|(
name|escp2_softweave_t
modifier|*
...
specifier|static
name|void
DECL|function|escp2_flush (void * vsw,int model,int width,int hoffset,int ydpi,int xdpi,int physical_xdpi,FILE * prn)
name|escp2_flush
parameter_list|(
name|void
modifier|*
...
specifier|static
name|void
DECL|function|escp2_flush_all (void * vsw,int model,int width,int hoffset,int ydpi,int xdpi,int physical_xdpi,FILE * prn)
name|escp2_flush_all
parameter_list|(
name|void
modifier|*
...
specifier|static
name|void
DECL|function|finalize_row (escp2_softweave_t * sw,int row,int model,int width,int hoffset,int ydpi,int xdpi,int physical_xdpi,FILE * prn)
name|finalize_row
parameter_list|(
name|escp2_softweave_t
modifier|*
...
specifier|static
name|void
DECL|function|escp2_write_weave (void * vsw,FILE * prn,int length,int ydpi,int model,int width,int offset,int xdpi,int physical_xdpi,const unsigned char * c,const unsigned char * m,const unsigned char * y,const unsigned char * k,const unsigned char * C,const unsigned char * M)
name|escp2_write_weave
parameter_list|(
name|void
modifier|*
