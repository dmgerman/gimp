...
begin_comment
comment|/*  * Constants for 4-level dithering functions...  */
end_comment
...
specifier|static
name|void
DECL|function|dither_black4 (guchar * gray,int row,int src_width,int dst_width,unsigned char * black)
name|dither_black4
parameter_list|(
name|guchar
modifier|*
...
specifier|static
name|void
DECL|function|dither_cmyk4 (guchar * rgb,int row,int src_width,int dst_width,unsigned char * cyan,unsigned char * magenta,unsigned char * yellow,unsigned char * black)
name|dither_cmyk4
parameter_list|(
name|guchar
modifier|*
