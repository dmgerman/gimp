...
begin_define
DECL|macro|FAXG3_TYPE
define|#
directive|define
name|FAXG3_TYPE
value|(faxg3_get_type ())
end_define
...
directive|define
name|FAXG3
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), FAXG3_TYPE, Faxg3))
end_define
...
begin_macro
DECL|function|G_DEFINE_TYPE (Faxg3,faxg3,GIMP_TYPE_PLUG_IN)
name|G_DEFINE_TYPE
argument_list|(
argument|Faxg3
argument_list|,
...
specifier|static
name|void
DECL|function|faxg3_init (Faxg3 * faxg3)
name|faxg3_init
parameter_list|(
name|Faxg3
modifier|*
...
name|GList
modifier|*
DECL|function|faxg3_query_procedures (GimpPlugIn * plug_in)
name|faxg3_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|faxg3_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|faxg3_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
argument_list|,
literal|"Jochen Friedrich, Gert Doering, "
...
name|GimpValueArray
modifier|*
DECL|function|faxg3_load (GimpProcedure * procedure,GimpRunMode run_mode,GFile * file,const GimpValueArray * args,gpointer run_data)
name|faxg3_load
parameter_list|(
name|GimpProcedure
modifier|*
