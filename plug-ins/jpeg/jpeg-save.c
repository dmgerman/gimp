...
specifier|static
name|gint32
DECL|function|load_image (gchar * filename,GRunModeType runmode,gint preview)
name|load_image
parameter_list|(
name|gchar
modifier|*
...
specifier|static
name|void
DECL|function|add_menu_item (GtkWidget * menu,gchar * label,guint op_no,GtkSignalFunc callback)
name|add_menu_item
parameter_list|(
name|GtkWidget
modifier|*
