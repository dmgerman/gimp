...
typedef|typedef
struct|struct
DECL|struct|__anon28d96c010108
block|{
DECL|member|quality
name|gdouble
name|quality
...
typedef|typedef
struct|struct
DECL|struct|__anon28d96c010208
block|{
DECL|member|run
name|gint
name|run
...
typedef|typedef
struct|struct
DECL|struct|__anon28d96c010308
block|{
DECL|member|cinfo
name|struct
...
name|TRUE
expr_stmt|;
comment|/* pw - get the comment text_buffer object and grab it's data */
name|text_buffer
operator|=
