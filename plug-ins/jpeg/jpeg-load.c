...
directive|endif
comment|/* don't attach the CMYK profile we are using to convert the data */
if|if
condition|(
operator|!
name|cmyk_transform
...
specifier|static
name|void
DECL|function|jpeg_sanitize_comment (gchar * comment)
name|jpeg_sanitize_comment
parameter_list|(
name|gchar
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon27e022940108
block|{
DECL|member|pub
name|struct
