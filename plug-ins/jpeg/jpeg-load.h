...
begin_comment
comment|/*  * 4-SEP-01 - remove the use of GtkText  * - DindinX<David@dindinx.org>  *  * The new version of GTK+ does not support GtkText anymore.  * I've just replaced the one used for the image comment by  * a GtkTextView/GtkTextBuffer couple;  */
end_comment
...
begin_comment
comment|/*  * 15-NOV-04 - add support for EXIF JPEG thumbnail reading and writing  * - S. Mukund<muks@mukund.org>  *  * Digital cameras store a TIFF APP1 marker that contains various  * parameters of the shot along with a thumbnail image.  */
end_comment
...
typedef|typedef
struct|struct
DECL|struct|__anon27d609590108
block|{
DECL|member|quality
name|gdouble
name|quality
...
typedef|typedef
struct|struct
DECL|struct|__anon27d609590208
block|{
DECL|member|cinfo
name|struct
...
condition|)
block|{
comment|/*  disable loading of EXIF data  */
name|cinfo
operator|->
name|client_data
operator|=
...
name|_
argument_list|(
literal|"EXIF data will be ignored."
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
typedef|typedef
struct|struct
DECL|struct|__anon27d609590308
block|{
DECL|member|pub
name|struct
name|jpeg_source_mgr
...
typedef|typedef
struct|struct
DECL|struct|__anon27d609590408
block|{
DECL|member|pub
name|struct
