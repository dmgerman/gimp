...
begin_typedef
DECL|struct|__anon290924e80108
typedef|typedef
struct|struct
block|{
DECL|member|matrix
...
begin_typedef
DECL|struct|__anon290924e80208
typedef|typedef
struct|struct
block|{
DECL|member|run
...
begin_typedef
DECL|struct|__anon290924e80308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon290924e80408
typedef|typedef
struct|struct
block|{
DECL|member|name
...
index|]
decl_stmt|;
DECL|struct|__anon290924e80508
specifier|static
struct|struct
block|{
DECL|member|label
...
specifier|static
name|void
DECL|function|uni_load_matrix (char * filename)
name|uni_load_matrix
parameter_list|(
name|char
modifier|*
...
name|g_warning
argument_list|(
literal|"uni_load_matrix(): invalid number of rows/colums in \"%s\""
argument_list|,
name|filename
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|uni_save_matrix (UniMatrix * matrix,char * filename)
name|uni_save_matrix
parameter_list|(
name|UniMatrix
modifier|*
...
name|g_warning
argument_list|(
literal|"uni_save_matrix(): can not save matrix with NULL filename"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|g_warning
argument_list|(
literal|"uni_save_matrix(): can't open \"%s\""
argument_list|,
name|filename
argument_list|)
expr_stmt|;
