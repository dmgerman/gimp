...
argument_list|,
literal|"Twist or smear an image"
argument_list|,
...
specifier|static
name|void
DECL|function|warp (GDrawable * orig_draw,GDrawable ** map_x_p,GDrawable ** map_y_p,gint32 * xyimage_id_p)
name|warp
parameter_list|(
name|GDrawable
modifier|*
...
specifier|static
name|void
DECL|function|warp_one (GDrawable * draw,GDrawable * map_x,GDrawable * map_y,GDrawable * mag_draw,gint first_time)
name|warp_one
parameter_list|(
name|GDrawable
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* only update shadow tiles (& push undo-stack) the first time through. Thanks Spencer! */
if|if
condition|(
name|first_time
operator|==
...
name|angled
expr_stmt|;
comment|/* here is the displacement vector */
name|amnt_x
operator|=
name|dvals
operator|.
...
specifier|static
name|gdouble
DECL|function|warp_map_give_value (guchar * pt,gint alpha,gint bytes)
name|warp_map_give_value
parameter_list|(
name|guchar
modifier|*
