...
begin_comment
comment|/* pixel,  red,  green,  blue */
end_comment

begin_comment
comment|/* static  GdkColor yellow_color =      { 0, 0xd6d6, 0xd6d6, 0x0000 };    static  GdkColor grey_color   =      { 0, 0xd6d6, 0xd6d6, 0xd6d6 };    */
end_comment
...
comment|/*   gimp_drawable_detach (map_x);   gimp_drawable_detach (map_y);   */
if|if
condition|(
name|run_mode
operator|!=
...
specifier|static
name|void
DECL|function|warp (GDrawable * orig_draw,GDrawable ** map_x_p,GDrawable ** map_y_p)
name|warp
parameter_list|(
name|GDrawable
modifier|*
