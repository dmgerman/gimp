...
begin_function
name|gboolean
DECL|function|save_layer (GFile * file,GimpImage * image,GimpDrawable * drawable,WebPSaveParams * params,GError ** error)
name|save_layer
parameter_list|(
name|GFile
modifier|*
...
begin_function
name|gboolean
DECL|function|save_animation (GFile * file,GimpImage * image,GimpDrawable * drawable,WebPSaveParams * params,GError ** error)
name|save_animation
parameter_list|(
name|GFile
modifier|*
