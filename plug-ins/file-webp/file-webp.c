...
literal|"Keyframe distance"
argument_list|,
literal|"Maximum distance between keyframes"
argument_list|,
literal|0
argument_list|,
name|G_MAXINT
...
argument_list|,
literal|"Save color profle"
argument_list|,
literal|"Toggle saving the color profile"
argument_list|,
...
directive|if
literal|0
block|params.save_exif    = (metadata_flags& GIMP_METADATA_SAVE_EXIF) != 0;   params.save_xmp     = (metadata_flags& GIMP_METADATA_SAVE_XMP) != 0;   params.save_iptc    = (metadata_flags& GIMP_METADATA_SAVE_IPTC) != 0;   params.save_profile = (metadata_flags& GIMP_METADATA_SAVE_COLOR_PROFILE) != 0;
endif|#
directive|endif
if|if
condition|(
