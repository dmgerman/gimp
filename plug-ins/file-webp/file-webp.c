...
argument_list|)
expr_stmt|;
comment|/*    * "preset" values in the PDB save proc are internal IDs, not    * necessarily corresponding to the constants from libwebp (though at    * time of writing, they are the same).    * Generate the "preset" parameter description from webp_presets, so    * that we don't have to edit multiple places if new presets are added    * in the future.    */
name|preset_param_desc
operator|=
name|g_strdup_printf
argument_list|(
literal|"WebP encoder preset (%s=0"
argument_list|,
name|webp_presets
index|[
literal|0
