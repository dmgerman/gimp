...
begin_function
DECL|function|gck_bilinear_rgb (double x,double y,GimpRGB * values)
name|GimpRGB
...
begin_function
DECL|function|gck_bilinear_rgba (double x,double y,GimpRGB * values)
name|GimpRGB
...
begin_function
DECL|function|gck_render_sub_pixel (int max_depth,int depth,_GckSampleType ** block,int x,int y,int x1,int y1,int x3,int y3,double threshold,int sub_pixel_size,GckRenderFunction render_func,GimpRGB * color)
name|gulong
