...
typedef|typedef
struct|struct
DECL|struct|__anon2bf5777c0108
block|{
DECL|member|radius
name|gdouble
name|radius
...
typedef|typedef
struct|struct
DECL|struct|__anon2bf5777c0208
block|{
DECL|member|run
name|gint
name|run
...
block|{
comment|/* gimp_message ("gauss_iir: cannot operate on indexed color images"); */
name|status
operator|=
...
specifier|static
name|gint
DECL|function|gauss_iir_dialog ()
name|gauss_iir_dialog
parameter_list|()
block|{
name|GtkWidget
