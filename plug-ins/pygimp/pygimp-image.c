...
name|pygimp_error
argument_list|,
literal|"could not resize image (ID %d): "
literal|"new dimensions: %d x %d, offsets x: %d, y: %d"
argument_list|,
name|self
operator|->
name|ID
...
name|PyObject
modifier|*
DECL|function|img_scale (PyGimpImage * self,PyObject * args)
name|img_scale
parameter_list|(
name|PyGimpImage
modifier|*
...
name|pygimp_error
argument_list|,
literal|"could not scale image (ID %d): new dimensions: %d x %d"
argument_list|,
name|self
operator|->
name|ID
...
name|PyObject
modifier|*
DECL|function|img_crop (PyGimpImage * self,PyObject * args)
name|img_crop
parameter_list|(
name|PyGimpImage
modifier|*
...
name|pygimp_error
argument_list|,
literal|"could not crop image (ID %d): new dimensions: %d x %d, "
literal|"offsets x: %d, y: %d"
argument_list|,
name|self
operator|->
name|ID
