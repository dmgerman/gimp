...
name|PyObject
modifier|*
DECL|function|vs_remove (PyGimpVectorsStroke * self)
name|vs_remove
parameter_list|(
name|PyGimpVectorsStroke
modifier|*
...
name|PyObject
modifier|*
DECL|function|vectors_stroke_new (PyGimpVectors * vectors,gint stroke)
name|vectors_stroke_new
parameter_list|(
name|PyGimpVectors
modifier|*
name|vectors
...
name|PyObject
modifier|*
DECL|function|vectors_bezier_stroke_new (PyGimpVectors * vectors,gint stroke)
...
name|PyObject
modifier|*
DECL|function|vectors_bezier_stroke_new_moveto (PyGimpVectors * self,PyObject * args,PyObject * kwargs)
name|vectors_bezier_stroke_new_moveto
parameter_list|(
name|PyGimpVectors
modifier|*
name|self
...
name|kwargs
argument_list|,
literal|"dd:bezier_stroke_new_moveto"
argument_list|,
name|kwlist
argument_list|,
operator|&
...
name|PyObject
modifier|*
DECL|function|vectors_bezier_stroke_new_ellipse (PyGimpVectors * self,PyObject * args,PyObject * kwargs)
name|vectors_bezier_stroke_new_ellipse
parameter_list|(
name|PyGimpVectors
modifier|*
name|self
...
name|kwargs
argument_list|,
literal|"ddddd:bezier_stroke_new_ellipse"
argument_list|,
name|kwlist
argument_list|,
operator|&
...
block|{
block|{
literal|"bezier_stroke_new_moveto"
block|,
operator|(
name|PyCFunction
operator|)
...
block|,
block|{
literal|"bezier_stroke_new_ellipse"
block|,
operator|(
name|PyCFunction
operator|)
