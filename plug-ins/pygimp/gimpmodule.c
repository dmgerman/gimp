...
name|PyObject
modifier|*
DECL|function|pygimp_export_image (PyObject * self,PyObject * args,PyObject * kwargs)
name|pygimp_export_image
parameter_list|(
name|PyObject
modifier|*
name|self
...
return|;
block|}
comment|/* If no drawable is given, assume the active drawable */
if|if
condition|(
name|drw
operator|==
...
name|PyExc_ValueError
argument_list|,
literal|"No active drawable in the image and no drawable "
literal|" specified for export."
argument_list|)
expr_stmt|;
return|return
name|NULL
...
name|PyObject
modifier|*
DECL|function|pygimp_export_dialog_new (PyObject * self,PyObject * args,PyObject * kwargs)
name|pygimp_export_dialog_new
parameter_list|(
name|PyObject
modifier|*
name|self
...
argument_list|)
expr_stmt|;
comment|/* pyobject_new handles NULL values */
return|return
name|pygobject_new
argument_list|(
operator|(
