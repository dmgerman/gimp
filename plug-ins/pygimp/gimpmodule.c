...
begin_define
DECL|macro|ARG_UINT_FORMAT
define|#
directive|define
name|ARG_UINT_FORMAT
value|"I"
end_define
...
name|n
parameter_list|)
value|G_STMT_START {					\     if (!PyCallable_Check(pdata->n)) {					\ 	PyErr_SetString(pygimp_error, #n "must be a callable");		\ 	goto cleanup;							\     }									\     Py_INCREF(pdata->n);						\ } G_STMT_END
name|PROCESS_FUNC
argument_list|(
name|start
argument_list|)
...
argument_list|)
expr_stmt|;
comment|/* these are private, for use in gimpprocbrowser */
name|PyDict_SetItemString
argument_list|(
name|d
argument_list|,
