...
name|PyObject
modifier|*
DECL|function|pygimp_bilinear (PyObject * self,PyObject * args,PyObject * kwargs)
name|pygimp_bilinear
parameter_list|(
name|PyObject
modifier|*
name|self
...
argument_list|,
literal|"values is not a sequence of 4 items"
argument_list|)
expr_stmt|;
return|return
name|NULL
...
name|PyObject
modifier|*
DECL|function|pygimp_bilinear_color (PyObject * self,PyObject * args,PyObject * kwargs,gboolean with_alpha)
name|pygimp_bilinear_color
parameter_list|(
name|PyObject
modifier|*
name|self
...
name|with_alpha
condition|?
literal|"ddO:bilinear_rgba"
else|:
literal|"ddO:bilinear_rgb"
argument_list|,
name|kwlist
argument_list|,
operator|&
...
name|PyExc_TypeError
argument_list|,
literal|"values[%d] is not a GimpRGB"
argument_list|,
name|i
argument_list|)
expr_stmt|;
...
name|PyObject
modifier|*
DECL|function|pygimp_bilinear_rgb (PyObject * self,PyObject * args,PyObject * kwargs)
name|pygimp_bilinear_rgb
parameter_list|(
name|PyObject
modifier|*
name|self
...
name|PyObject
modifier|*
DECL|function|pygimp_bilinear_rgba (PyObject * self,PyObject * args,PyObject * kwargs)
name|pygimp_bilinear_rgba
parameter_list|(
name|PyObject
modifier|*
name|self
...
directive|if
literal|0
block|{"bilinear_pixels_8", (PyCFunction)pygimp_bilinear_pixels_8, METH_VARARGS | METH_KEYWORDS},     {"adaptive_supersample_area", (PyCFunction)pygimp_adaptive_supersample_area, METH_VARARGS | METH_KEYWORDS},
endif|#
directive|endif
block|{
name|NULL
