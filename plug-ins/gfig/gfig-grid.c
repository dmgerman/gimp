...
typedef|typedef
struct|struct
DECL|struct|__anon2c6fb0640108
block|{
DECL|member|product
name|gint
name|product
...
specifier|static
name|void
DECL|function|draw_grid_polar (cairo_t * cr)
name|draw_grid_polar
parameter_list|(
name|cairo_t
modifier|*
...
specifier|static
name|void
DECL|function|draw_grid_sq (cairo_t * cr)
name|draw_grid_sq
parameter_list|(
name|cairo_t
modifier|*
...
specifier|static
name|void
DECL|function|draw_grid_iso (cairo_t * cr)
name|draw_grid_iso
parameter_list|(
name|cairo_t
modifier|*
...
name|cairo_t
modifier|*
DECL|function|gfig_get_grid_gc (cairo_t * cr,GtkWidget * w,gint gctype)
name|gfig_get_grid_gc
parameter_list|(
name|cairo_t
modifier|*
...
begin_function
name|void
DECL|function|draw_grid (cairo_t * cr)
name|draw_grid
parameter_list|(
name|cairo_t
modifier|*
