...
typedef|typedef
struct|struct
DECL|struct|__anon2893a64b0108
block|{
...
begin_function
name|void
DECL|function|draw_item (cairo_t * cr,gboolean fill)
name|draw_item
parameter_list|(
name|cairo_t
modifier|*
...
begin_function
name|void
DECL|function|draw_circle (GdkPoint * p,gboolean selected,cairo_t * cr)
name|draw_circle
parameter_list|(
name|GdkPoint
modifier|*
...
begin_function
name|void
DECL|function|draw_sqr (GdkPoint * p,gboolean selected,cairo_t * cr)
name|draw_sqr
parameter_list|(
name|GdkPoint
modifier|*
...
begin_function
name|void
DECL|function|gfig_draw_arc (gint x,gint y,gint width,gint height,gint angle1,gint angle2,cairo_t * cr)
name|gfig_draw_arc
parameter_list|(
name|gint
name|x
...
begin_function
name|void
DECL|function|gfig_draw_line (gint x0,gint y0,gint x1,gint y1,cairo_t * cr)
name|gfig_draw_line
parameter_list|(
name|gint
name|x0
