...
typedef|typedef
struct|struct
DECL|struct|__anon28de99350108
block|{
...
specifier|static
name|void
DECL|function|gfig_load_menu_callback (GtkWidget * widget,gpointer data)
name|gfig_load_menu_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gfig_close_menu_callback (GtkWidget * widget,gpointer data)
name|gfig_close_menu_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
name|G_CALLBACK
argument_list|(
argument|gfig_load_menu_callback
argument_list|)
block|}
block|,
block|{
...
name|G_CALLBACK
argument_list|(
argument|gfig_save_menu_callback
argument_list|)
block|}
block|,
block|{
...
name|G_CALLBACK
argument_list|(
argument|gfig_close_menu_callback
argument_list|)
block|}
block|,
block|{
...
name|G_CALLBACK
argument_list|(
argument|options_dialog_callback
argument_list|)
block|}
block|,
block|{
