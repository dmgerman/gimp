...
typedef|typedef
struct|struct
DECL|struct|__anon2acf0b160108
block|{
...
name|toggle
expr_stmt|;
comment|/* Add buttons above the preview frame */
name|gtk_box_pack_start
argument_list|(
name|GTK_BOX
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  gtk_action_group_add_radio_actions (group,                                       radio_actions,                                       G_N_ELEMENTS (radio_actions),                                       ifsDesign->op,                                       G_CALLBACK (design_op_update_callback),                                       window);*/
...
begin_function
name|void
DECL|function|tool_option_page_update (GtkWidget * button,GtkWidget * notebook)
...
specifier|static
name|void
DECL|function|tool_option_no_option (GtkWidget * notebook,GtkWidget * button)
...
begin_define
DECL|macro|BOX_APPEND (button,text)
define|#
directive|define
name|BOX_APPEND
parameter_list|(
...
name|GtkWidget
modifier|*
DECL|function|draw_buttons (GtkWidget * notebook)
name|draw_buttons
parameter_list|(
name|GtkWidget
modifier|*
