...
typedef|typedef
struct|struct
DECL|struct|__anon2c1d95750108
block|{
...
specifier|static
name|void
DECL|function|file_selection_response (GtkFileSelection * fs,gint response_id,GFigObj * obj)
...
specifier|static
name|void
DECL|function|gfig_load_file_selection_response (GtkFileSelection * fs,gint response_id,gpointer data)
name|gfig_load_file_selection_response
parameter_list|(
name|GtkFileSelection
modifier|*
name|fs
