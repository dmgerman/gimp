...
typedef|typedef
struct|struct
DECL|struct|__anon2b0f2c540108
block|{
...
begin_function
name|void
DECL|function|my_gtk_label_set (GtkLabel * label,const char * str)
name|my_gtk_label_set
parameter_list|(
name|GtkLabel
modifier|*
name|label
...
begin_comment
unit|static void gfig_obj_size_update(gint sz) {   static gchar buf[256];      sprintf(buf,"%6d",sz);   my_gtk_label_set(GTK_LABEL(obj_size_label),buf); }    static GtkWidget * gfig_obj_size_label(void) {   GtkWidget *label;   GtkWidget *hbox;   gchar buf[256];    hbox = gtk_hbox_new (FALSE,0);
