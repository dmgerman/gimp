...
directive|define
name|PREVIEW_MASK
value|GDK_EXPOSURE_MASK | \                        GDK_MOTION_NOTIFY | \ 		       GDK_POINTER_MOTION_MASK | \                        GDK_BUTTON_PRESS_MASK | \ 		       GDK_BUTTON_RELEASE_MASK | \ 		       GDK_BUTTON_MOTION_MASK
end_define
...
typedef|typedef
struct|struct
DECL|struct|__anon2990551c0108
block|{
...
name|GdkPixmap
modifier|*
DECL|function|gdk_pixmap_create_from_xpm_d (GdkWindow * window,GdkBitmap ** mask,GdkColor * transparent_color,gchar ** data)
...
begin_comment
comment|/* Special case for now - options on poly button */
end_comment

begin_function
specifier|static
name|void
DECL|function|poly_num_sides_dialog (void)
name|poly_num_sides_dialog
parameter_list|(
name|void
parameter_list|)
block|{
...
specifier|static
name|gint
DECL|function|set_brush_press (GtkWidget * widget,GdkEventButton * event,gpointer data)
name|set_brush_press
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
name|buf
argument_list|,
literal|"Unable to set brush to '%.100s'"
argument_list|,
name|str
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* Now bit for the button */
name|gtk_signal_connect
argument_list|(
name|GTK_OBJECT
argument_list|(
...
directive|if
literal|0
block|label = gtk_label_new("Painting:");   gtk_misc_set_alignment(GTK_MISC(label),0.5,0.5);   gtk_widget_show(label);   gtk_table_attach(GTK_TABLE(table), label, 0, 2, 2, 3, 0 , GTK_FILL|GTK_EXPAND, 0, 0);    progress_widget = gtk_progress_bar_new();   gtk_widget_show(progress_widget);   gtk_table_attach(GTK_TABLE(table), progress_widget, 2, 5, 2, 3, 0 , 0, 0, 0);
endif|#
directive|endif
comment|/* 0 */
name|gtk_container_add
...
block|page = select_page();   label = gtk_label_new("Select");   gtk_widget_show(label);   gtk_misc_set_alignment(GTK_MISC(label),0.5,0.5);   gtk_notebook_append_page(GTK_NOTEBOOK(notebook), page, label);   gtk_widget_show(page);
endif|#
directive|endif
comment|/* 0 */
name|page
...
specifier|static
name|void
DECL|function|mygimp_edit_clear (gint32 image_ID,gint32 layer_ID)
name|mygimp_edit_clear
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
specifier|static
name|void
DECL|function|gfig_entry_update_fp (GtkWidget * widget,gdouble * value)
name|gfig_entry_update_fp
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|find_grid_pos (GdkPoint * p,GdkPoint * gp)
name|find_grid_pos
parameter_list|(
name|GdkPoint
modifier|*
...
name|GdkGC
modifier|*
DECL|function|gfig_get_grid_gc (GtkWidget * w)
...
name|printf
argument_list|(
literal|"Painting ellispe as polygon\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
name|g_warning
argument_list|(
literal|"Internal error in ploygon - no vertice point \n"
argument_list|)
expr_stmt|;
return|return;
block|}
...
begin_function
name|void
DECL|function|draw_objects (DALLOBJS * objs)
name|draw_objects
parameter_list|(
name|DALLOBJS
modifier|*
