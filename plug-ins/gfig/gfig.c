...
typedef|typedef
struct|struct
DECL|struct|__anon2b37de7e0708
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b37de7e0808
block|{
DECL|member|gridspacing
name|void
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon2b37de7e0908
block|{
DECL|member|opts
name|GfigOpts
name|opts
...
specifier|static
name|void
DECL|function|plug_in_parse_gfig_path (void)
...
specifier|static
name|void
DECL|function|refill_cache (void)
name|refill_cache
parameter_list|(
name|void
parameter_list|)
...
name|GtkWidget
modifier|*
DECL|function|but_with_pix (gchar ** pixdata,GSList ** group,gint baction)
name|but_with_pix
parameter_list|(
name|gchar
modifier|*
...
specifier|static
name|gint
DECL|function|poly_button_press (GtkWidget * widget,GdkEventButton * event,gpointer data)
...
specifier|static
name|gint
DECL|function|spiral_button_press (GtkWidget * widget,GdkEventButton * event,gpointer data)
...
name|_
argument_list|(
literal|"Use the brush/pencil or the airbrush when drawing "
literal|"on the image. Pattern paints with currently "
literal|"selected brush with a pattern. Only applies to "
literal|"circles/ellipses if Approx. Circles/Ellipses "
literal|"toggle is set."
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
name|_
argument_list|(
literal|"Layer background type. Copy causes previous "
...
argument_list|)
expr_stmt|;
comment|/*gtk_widget_show (xframe);*/
...
specifier|static
name|void
DECL|function|gfig_list_ok_callback (GtkWidget * widget,gpointer data)
...
specifier|static
name|void
DECL|function|gfig_list_cancel_callback (GtkWidget * widget,gpointer data)
...
specifier|static
name|void
DECL|function|gfig_rescan_ok_callback (GtkWidget * widget,gpointer data)
...
specifier|static
name|void
DECL|function|gfig_load_file_selection_ok (GtkWidget * widget,GtkFileSelection * fs,gpointer data)
...
specifier|static
name|void
DECL|function|save_button_callback (GtkWidget * widget,gpointer data)
name|save_button_callback
parameter_list|(
name|GtkWidget
modifier|*
...
specifier|static
name|void
DECL|function|gfig_update_stat_labels (void)
name|gfig_update_stat_labels
parameter_list|(
name|void
parameter_list|)
