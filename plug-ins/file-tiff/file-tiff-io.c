...
name|input
operator|=
name|g_io_stream_get_input_stream
argument_list|(
name|iostream
argument_list|)
expr_stmt|;
...
name|output
operator|=
name|g_io_stream_get_output_stream
argument_list|(
name|iostream
argument_list|)
expr_stmt|;
...
argument_list|)
operator|||
comment|/* Since libtiff 4.0.0alpha. */
operator|!
name|strcmp
argument_list|(
name|fmt
argument_list|,
literal|"Unknown field with tag %d (0x%x) encountered"
argument_list|)
condition|)
block|{
name|va_list
