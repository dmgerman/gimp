...
specifier|static
name|gboolean
DECL|function|save_layer (TIFF * tif,TiffSaveVals * tsvals,gint32 image,gint32 layer,gint32 page,gint32 num_pages,gint32 orig_image,gint * saved_bpp,GError ** error)
name|save_layer
parameter_list|(
name|TIFF
modifier|*
