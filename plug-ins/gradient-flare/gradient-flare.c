...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0308
block|{
DECL|member|name
name|gchar
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0408
block|{
DECL|member|fp
name|FILE
modifier|*
...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0608
block|{
DECL|member|init
name|gint
name|init
...
decl_stmt|;
struct|struct
DECL|struct|__anon27ded80a0708
block|{
DECL|member|x0
DECL|member|y0
DECL|member|x1
...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0808
block|{
DECL|member|init
name|gint
name|init
...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0908
block|{
DECL|member|x0
name|gdouble
name|x0
...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0a08
block|{
DECL|member|init
name|gint
name|init
...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0b08
block|{
DECL|member|xcenter
name|gdouble
name|xcenter
...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0c08
block|{
DECL|member|format
specifier|const
name|Babl
...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0d08
block|{
DECL|member|tag
name|gint
name|tag
...
typedef|typedef
struct|struct
DECL|struct|__anon27ded80a0e08
block|{
DECL|member|xcenter
name|gint
name|xcenter
...
begin_define
DECL|macro|GFLARE_TYPE
define|#
directive|define
name|GFLARE_TYPE
value|(gflare_get_type ())
end_define
...
directive|define
name|GFLARE
value|(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), GFLARE_TYPE, Gflare))
end_define

begin_decl_stmt
name|GType
name|gflare_get_type
argument_list|(
name|void
argument_list|)
name|G_GNUC_CONST
...
specifier|static
name|void
DECL|function|gflare_class_init (GflareClass * klass)
name|gflare_class_init
parameter_list|(
name|GflareClass
modifier|*
name|klass
...
specifier|static
name|void
DECL|function|gflare_init (Gflare * gflare)
name|gflare_init
parameter_list|(
name|Gflare
modifier|*
...
name|GList
modifier|*
DECL|function|gflare_query_procedures (GimpPlugIn * plug_in)
name|gflare_query_procedures
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|GimpProcedure
modifier|*
DECL|function|gflare_create_procedure (GimpPlugIn * plug_in,const gchar * name)
name|gflare_create_procedure
parameter_list|(
name|GimpPlugIn
modifier|*
...
name|N_
argument_list|(
literal|"Produce a lense flare effect "
literal|"using gradients"
argument_list|)
argument_list|,
literal|"This plug-in produces a lense flare "
literal|"effect using custom gradients. In "
literal|"interactive call, the user can edit "
literal|"his/her own favorite lense flare "
literal|"(GFlare) and render it. Edited "
literal|"gflare is saved automatically to "
literal|"the folder in gflare-path, if it is "
literal|"defined in gimprc. In "
literal|"non-interactive call, the user can "
literal|"only render one of GFlare "
literal|"which has been stored in "
literal|"gflare-path already."
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
literal|"GFlare name"
argument_list|,
literal|"Name of the GFlare to render"
argument_list|,
literal|"Default"
argument_list|,
...
literal|"Vector length"
argument_list|,
literal|"Vector length for second flares "
literal|"(percentage of Radius)"
argument_list|,
literal|0
argument_list|,
literal|10000
...
literal|"Use asupsample"
argument_list|,
literal|"Use adaptive supersampling while rendering"
argument_list|,
name|FALSE
argument_list|,
name|G_PARAM_READWRITE
...
name|GimpValueArray
modifier|*
DECL|function|gflare_run (GimpProcedure * procedure,GimpRunMode run_mode,GimpImage * _image,GimpDrawable * _drawable,const GimpValueArray * args,gpointer run_data)
name|gflare_run
parameter_list|(
name|GimpProcedure
modifier|*
...
specifier|static
name|void
DECL|function|plugin_do_non_asupsample (GeglBuffer * src_buffer,GeglBuffer * dest_buffer)
name|plugin_do_non_asupsample
parameter_list|(
name|GeglBuffer
modifier|*
...
specifier|static
name|void
DECL|function|plugin_do_asupsample (GeglBuffer * src_buffer,GeglBuffer * dest_buffer)
name|plugin_do_asupsample
parameter_list|(
name|GeglBuffer
modifier|*
...
specifier|static
struct|struct
DECL|struct|__anon27ded80a0f08
block|{
DECL|member|values
name|guchar
modifier|*
...
specifier|static
struct|struct
DECL|struct|__anon27ded80a1008
block|{
DECL|member|label
specifier|const
name|gchar
...
begin_comment
comment|/*         This is gflare editor dialog, one which opens by clicking         "Edit" button on the selector page in the main dialog.  */
end_comment
...
begin_comment
comment|/*   puts gradient menu with caption into grid   occupies 1 row and 3 cols in grid  */
end_comment

begin_function
specifier|static
name|void
DECL|function|ed_put_gradient_menu (GtkWidget * grid,gint x,gint y,const gchar * caption,GradientMenu * gm)
name|ed_put_gradient_menu
parameter_list|(
name|GtkWidget
modifier|*
