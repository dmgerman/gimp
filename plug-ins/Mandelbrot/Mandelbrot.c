...
begin_typedef
DECL|struct|__anon2b3c3f780108
typedef|typedef
struct|struct
block|{
DECL|member|xmin
...
name|bluemode
decl_stmt|;
DECL|typedef|mandelbrot_vals_t
block|}
name|mandelbrot_vals_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon2b3c3f780208
typedef|typedef
struct|struct
block|{
DECL|member|preview
...
name|run
decl_stmt|;
DECL|typedef|mandelbrot_interface_t
block|}
name|mandelbrot_interface_t
typedef|;
end_typedef
...
begin_comment
comment|/* static void      dialog_reset_callback(GtkWidget *widget, gpointer data); */
end_comment
...
argument_list|,
literal|"Mandelbrot Chaos Fractal Explorer Plug-In"
argument_list|,
literal|"Fills the active painting area with a Mandelbrot fractal."
argument_list|,
...
argument_list|,
literal|"<Image>/Filters/Render/Mandelbrot Fractal"
argument_list|,
literal|"RGB*"
argument_list|,
name|PROC_PLUG_IN
...
argument_list|(
literal|"Rendering mandelbrot fractal..."
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|mandelbrot_get_pixel (int x,int y,guchar * pixel)
name|mandelbrot_get_pixel
parameter_list|(
name|int
name|x
...
begin_comment
comment|/* mandelbrot_get_pixel */
end_comment

begin_function
specifier|static
name|void
DECL|function|mandelbrot_render_row (const guchar * src_row,guchar * dest_row,gint row,gint row_width,gint bytes)
name|mandelbrot_render_row
parameter_list|(
specifier|const
name|guchar
...
name|bluestretch
expr_stmt|;
comment|/*       v1 = (short int)src_row[col*bytes]; */
comment|/*       v2 = (short int)src_row[col*bytes +1]; */
comment|/*       v3 = (short int)src_row[col*bytes +2]; */
comment|/*       transform(&v1,&v2,&v3, redstretch, greenstretch, bluestretch); */
name|a
operator|=
name|xmin
operator|+
...
specifier|static
name|void
DECL|function|mandelbrot_logo_ok_callback (GtkWidget * widget,gpointer data)
name|mandelbrot_logo_ok_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|mandelbrot_about_callback (GtkWidget * widget,gpointer data)
name|mandelbrot_about_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|mandelbrot (GDrawable * drawable)
name|mandelbrot
parameter_list|(
name|GDrawable
modifier|*
...
argument_list|)
expr_stmt|;
comment|/*   redstretch = wvals.redstretch;   greenstretch = wvals.greenstretch;   bluestretch = wvals.bluestretch; */
name|xbild
operator|=
name|width
expr_stmt|;
...
specifier|static
name|gint
DECL|function|mandelbrot_dialog (void)
name|mandelbrot_dialog
parameter_list|(
name|void
parameter_list|)
...
argument_list|)
argument_list|,
literal|"Mandelbrot Fractal Explorer (cotting@mygale.org)"
argument_list|)
expr_stmt|;
...
name|toggle
argument_list|,
literal|"Create a color-map using a gradient from the gradient editor. The result is only visible in the final image. The preview will be calculated with the color-map derived from the color options above (color density/function)."
argument_list|)
expr_stmt|;
name|gtk_widget_show
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* 	button = gtk_button_new_with_label("Reset");         GTK_WIDGET_SET_FLAGS(button, GTK_CAN_DEFAULT);         gtk_signal_connect(GTK_OBJECT(button), "clicked",         		   (GtkSignalFunc) dialog_reset_callback,         		   dialog);         gtk_box_pack_start(GTK_BOX(GTK_DIALOG(dialog)->action_area), button, TRUE, TRUE, 0);         gtk_widget_show(button); */
comment|/* Done */
name|gtk_widget_show
argument_list|(
name|dialog
...
specifier|static
name|void
DECL|function|dialog_create_int_value (char * title,GtkTable * table,int row,gdouble * value,int left,int right,const char * desc)
name|dialog_create_int_value
parameter_list|(
name|char
modifier|*
...
begin_comment
comment|/* static void dialog_reset_callback(GtkWidget *widget, gpointer data) { static mandelbrot_vals_t wvals = {         -2,1,-1.5,1.5,100,0,128,128,128,0,0,0, };         gtk_widget_destroy(GTK_WIDGET(data));         mandelbrot_dialog(); }  */
end_comment
...
specifier|static
name|void
DECL|function|mandelbrot_toggle_update (GtkWidget * widget,gpointer data)
name|mandelbrot_toggle_update
parameter_list|(
name|GtkWidget
modifier|*
...
name|GtkWidget
modifier|*
DECL|function|mandelbrot_logo_dialog ()
name|mandelbrot_logo_dialog
parameter_list|()
block|{
name|GtkWidget
...
literal|"Mandelbrot Fractal Chaos Explorer\nPlug-In for the GIMP\n"
