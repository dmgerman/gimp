...
begin_typedef
DECL|struct|__anon27c4d3530108
typedef|typedef
struct|struct
block|{
DECL|member|xmin
...
begin_typedef
DECL|struct|__anon27c4d3530208
typedef|typedef
struct|struct
block|{
DECL|member|preview
...
specifier|static
name|void
DECL|function|dialog_create_value (char * title,GtkTable * table,int row,gdouble * value,int left,int right)
name|dialog_create_value
parameter_list|(
name|char
modifier|*
...
literal|"Mandelbrot Fractal Chaos Explorer Plug-In for the GIMP\n"
