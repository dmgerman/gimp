...
specifier|static
name|gboolean
name|jpeg_load_exif_resolution
parameter_list|(
name|gint32
name|image_ID
parameter_list|,
...
specifier|static
name|gboolean
DECL|function|jpeg_load_exif_resolution (gint32 image_ID,ExifData * exif_data)
name|jpeg_load_exif_resolution
parameter_list|(
name|gint32
name|image_ID
...
name|g_warning
argument_list|(
literal|"Unknown EXIF resolution unit %d; skipping EXIF resolution."
argument_list|,
name|unit
argument_list|)
expr_stmt|;
