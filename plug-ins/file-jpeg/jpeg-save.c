...
typedef|typedef
struct|struct
DECL|struct|__anon29fc791c0108
block|{
DECL|member|cinfo
name|struct
...
typedef|typedef
struct|struct
DECL|struct|__anon29fc791c0208
block|{
DECL|member|run
name|gboolean
name|run
...
break|break;
block|}
comment|/* Though it would be technically possible to export with a            * linear profile, it is not such a great idea to export 8-bit            * formats as linear. This is why our current JPEG exporter            * only exports 8-bit non linear JPEG images.            */
if|if
condition|(
name|linear
condition|)
