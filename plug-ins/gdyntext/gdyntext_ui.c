...
begin_typedef
DECL|struct|__anon28d178110108
typedef|typedef
struct|struct
block|{
DECL|member|window
...
argument_list|)
expr_stmt|;
comment|/*       for (list = data->messages; list; list = list->next)       message_window_append(MESSAGE_WINDOW(message_window), (char *)list->data);   */
name|main_window
operator|=
name|create_main_window
argument_list|(
