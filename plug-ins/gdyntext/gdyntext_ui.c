...
include|#
directive|include
file|"graphics/layer_align_0.xpm"
end_include

begin_include
include|#
directive|include
file|"graphics/layer_align_1.xpm"
end_include

begin_include
include|#
directive|include
file|"graphics/layer_align_2.xpm"
end_include

begin_include
include|#
directive|include
file|"graphics/layer_align_3.xpm"
end_include

begin_include
include|#
directive|include
file|"graphics/layer_align_4.xpm"
end_include

begin_include
include|#
directive|include
file|"graphics/layer_align_5.xpm"
end_include

begin_include
include|#
directive|include
file|"graphics/layer_align_6.xpm"
end_include

begin_include
include|#
directive|include
file|"graphics/layer_align_7.xpm"
end_include

begin_include
include|#
directive|include
file|"graphics/layer_align_8.xpm"
end_include

begin_include
include|#
directive|include
file|"graphics/layer_align_9.xpm"
end_include
...
argument_list|)
expr_stmt|;
comment|/* 	gtk_widget_realize(window); 	gdk_window_set_decorations(window->window, !GDK_DECOR_ALL); 	*/
name|hbox1
operator|=
name|gtk_hbox_new
argument_list|(
...
literal|"\n"
literal|"Copyright (C) 1998,1999,2000 Marco Lamberto\n"
...
argument_list|)
expr_stmt|;
comment|/* 	if (data->messages) { 		GList *l;  		for (l = g_list_first(data->messages); l; l = l->next) 			message_window_append(MESSAGE_WINDOW(message_window), (char *)l->data); 	} 	*/
name|main_window
operator|=
name|create_main_window
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* update the font preview */
name|gtk_widget_set_sensitive
argument_list|(
name|main_window
operator|->
...
argument_list|)
expr_stmt|;
comment|/* update also the text area font */
name|gtk_text_set_font
argument_list|(
name|GTK_TEXT
argument_list|(
...
begin_function
DECL|function|on_layer_align_change (GtkWidget * widget,gpointer data)
name|void
name|on_layer_align_change
parameter_list|(
name|GtkWidget
...
name|xlfd
argument_list|,
literal|"-star division-helmet-medium-r-normal-*-*-200-*-*-p-*-adobe-fontspecific"
argument_list|)
expr_stmt|;
name|data
operator|->
...
argument_list|(
literal|"  XLFD:\n   '%s'\n"
literal|"  COLOR:           '0x%06X'\n"
literal|"  ANTIALIAS:       '%d'\n"
literal|"  ALIGNMENT:       '%d'\n"
literal|"  ROTATION:        '%d'\n"
literal|"  LINE_SPACING:    '%d'\n"
literal|"  LAYER_ALIGNMENT: '%d'\n"
literal|"  CHANGE_LNAME:    '%d'\n"
argument_list|,
name|data
operator|->
name|xlfd
