...
argument_list|)
expr_stmt|;
comment|/*sprintf(xfontnames[num_fonts], "-*-%05d-*-*-*-*-*-*-*-*-*-*-*-*", num_fonts);*/
block|}
name|fclose
argument_list|(
name|f
...
control|)
block|{
comment|/* 		// FIXME: non '-*' fonts, disabled because GIMP can't use them!!! 		if (xfontnames[i][0] == '-') { */
name|font_info
operator|=
name|g_strsplit
argument_list|(
