...
begin_comment
comment|/**********************************************************************  *  AlienMap (Co-)sine color transformation plug-in (Version 1.03)  *  Daniel Cotting (cotting@mygale.org)  **********************************************************************  *  Official homepages: http://www.mygale.org/~cotting  *                      http://cotting.citeweb.net  *                      http://village.cyberbrain.com/cotting  **********************************************************************      */
end_comment
...
begin_typedef
DECL|struct|__anon2bf59fd20108
typedef|typedef
struct|struct
block|{
...
name|blueinvert
decl_stmt|;
DECL|member|redphase
name|gdouble
name|redphase
decl_stmt|;
DECL|member|greenphase
name|gdouble
name|greenphase
decl_stmt|;
DECL|member|bluephase
name|gdouble
name|bluephase
decl_stmt|;
...
name|bluefrequency
decl_stmt|;
DECL|member|redinvert2
name|gint
name|redinvert2
decl_stmt|;
DECL|member|greeninvert2
name|gint
name|greeninvert2
decl_stmt|;
DECL|member|blueinvert2
name|gint
name|blueinvert2
decl_stmt|;
...
begin_typedef
DECL|struct|__anon2bf59fd20208
typedef|typedef
struct|struct
block|{
DECL|member|preview
...
specifier|static
name|void
name|dialog_animation_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
begin_decl_stmt
DECL|variable|do_greeninvert2
name|gint
name|do_greeninvert2
decl_stmt|;
end_decl_stmt

begin_decl_stmt
DECL|variable|do_blueinvert2
name|gint
name|do_blueinvert2
decl_stmt|;
end_decl_stmt
...
literal|"redinvert"
block|,
literal|"Red inversion before transformation (true or false)"
block|}
block|,
block|{
name|PARAM_INT8
...
literal|"greeninvert"
block|,
literal|"Green inversion before transformation (true or false)"
block|}
block|,
block|{
name|PARAM_INT8
...
literal|"blueinvert"
block|,
literal|"Blue inversion before transformation (true or false)"
block|}
block|,
block|{
name|PARAM_FLOAT
...
literal|"redphase"
block|,
literal|"Red component phase displacement [-PI;PI]"
block|}
block|,
block|{
name|PARAM_FLOAT
...
literal|"greenphase"
block|,
literal|"Green component phase displacement [-PI;PI]"
block|}
block|,
block|{
name|PARAM_FLOAT
...
literal|"bluephase"
block|,
literal|"Blue component phase displacement [-PI;PI]"
block|}
block|,
block|{
name|PARAM_FLOAT
...
block|,
literal|"Red component frequency"
block|}
block|,
block|{
name|PARAM_FLOAT
...
block|,
literal|"Green component frequency"
block|}
block|,
block|{
name|PARAM_FLOAT
...
block|,
literal|"Blue component frequency"
block|}
block|,
block|{
name|PARAM_INT8
...
literal|"redinvert2"
block|,
literal|"Red inversion after transformation (true or false)"
block|}
block|,
block|{
name|PARAM_INT8
block|,
literal|"greeninvert2"
block|,
literal|"Green inversion after transformation (true or false)"
block|}
block|,
block|{
name|PARAM_INT8
...
literal|"blueinvert2"
block|,
literal|"Blue inversion after transformation (true or false)"
block|}
block|,   }
decl_stmt|;
specifier|static
...
begin_function
name|void
DECL|function|transform (short int * r,short int * g,short int * b,double redstretch,double greenstretch,double bluestretch,double redphase,double greenphase,double bluephase,double redfrequency,double greenfrequency,double bluefrequency)
name|transform
parameter_list|(
name|short
name|int
...
begin_comment
comment|/* alienmap_get_pixel */
end_comment

begin_function
specifier|static
name|void
DECL|function|alienmap_render_row (const guchar * src_row,guchar * dest_row,gint row,gint row_width,gint bytes,double redstretch,double greenstretch,double bluestretch,double redphase,double greenphase,double bluephase,double redfrequency,double greenfrequency,double bluefrequency)
name|alienmap_render_row
parameter_list|(
specifier|const
name|guchar
...
specifier|static
name|void
DECL|function|alienmap_logo_ok_callback (GtkWidget * widget,gpointer data)
name|alienmap_logo_ok_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|alienmap_close_callback (GtkWidget * widget,gpointer data)
name|alienmap_close_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
specifier|static
name|void
DECL|function|dialog_animation_callback (GtkWidget * widget,gpointer data)
name|dialog_animation_callback
parameter_list|(
name|GtkWidget
modifier|*
...
argument_list|(
literal|"script-fu-colorcycling-anim"
argument_list|,
operator|&
name|ExternalInt
argument_list|,
...
specifier|static
name|void
DECL|function|alienmap_about_callback (GtkWidget * widget,gpointer data)
name|alienmap_about_callback
parameter_list|(
name|GtkWidget
modifier|*
name|widget
...
name|pi
argument_list|,
literal|"Change phase displacement of function for red channel"
argument_list|)
expr_stmt|;
name|table2
operator|=
...
name|pi
argument_list|,
literal|"Change phase displacement of function for green channel"
argument_list|)
expr_stmt|;
name|table3
operator|=
...
name|pi
argument_list|,
literal|"Change phase displacement of function for blue channel"
argument_list|)
expr_stmt|;
name|frame
operator|=
...
literal|10
argument_list|,
literal|"Change frequency of function for red channel"
argument_list|)
expr_stmt|;
name|table2
operator|=
...
literal|10
argument_list|,
literal|"Change frequency of function for green channel"
argument_list|)
expr_stmt|;
name|table3
operator|=
...
literal|10
argument_list|,
literal|"Change frequency of function for blue channel"
argument_list|)
expr_stmt|;
...
name|toggle
argument_list|,
literal|"If you enable this option, higher color values will be swapped with lower ones (and vice versa) before color transformation is applied."
argument_list|)
expr_stmt|;
name|toggle
operator|=
...
name|toggle
argument_list|,
literal|"If you enable this option, higher color values will be swapped with lower ones (and vice versa) after color transformation is applied."
argument_list|)
expr_stmt|;
name|gtk_widget_show
argument_list|(
...
name|button
argument_list|,
literal|"Create an animation with the color-cycling script and then exit this dialog box."
argument_list|)
expr_stmt|;
name|button
operator|=
...
name|GtkWidget
modifier|*
DECL|function|alienmap_logo_dialog ()
name|alienmap_logo_dialog
parameter_list|()
block|{
name|GtkWidget
