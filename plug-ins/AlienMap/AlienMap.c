...
typedef|typedef
struct|struct
DECL|struct|__anon2b9fc5e30108
block|{
...
typedef|typedef
struct|struct
DECL|struct|__anon2b9fc5e30208
block|{
DECL|member|preview
name|GtkWidget
modifier|*
...
name|_
argument_list|(
literal|"Green channel: use linear mapping instead of "
literal|"any trigonometrical function"
argument_list|)
argument_list|,
name|NULL
argument_list|)
...
name|_
argument_list|(
literal|"Blue channel: use linear mapping instead of "
literal|"any trigonometrical function"
argument_list|)
argument_list|,
name|NULL
...
specifier|static
name|void
DECL|function|dialog_create_value (gchar * title,GtkTable * table,gint row,gdouble * value,gint left,gint right,const gchar * desc)
name|dialog_create_value
parameter_list|(
name|gchar
modifier|*
