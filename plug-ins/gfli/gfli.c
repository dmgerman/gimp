...
literal|"to_frame"
block|,
literal|"End saveing with this frame"
block|}
block|, }
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
DECL|variable|ninfo_return_vals
name|gint
name|ninfo_return_vals
init|=
sizeof|sizeof
argument_list|(
name|info_return_vals
...
block|}
block|}
comment|/* If we reach this point, something went wrong. */
operator|*
name|nreturn_vals
operator|=
literal|1
...
begin_function
DECL|function|cb_cancel (GtkWidget * widget,gpointer data)
specifier|static
name|void
name|cb_cancel
parameter_list|(
...
begin_function
DECL|function|cb_ok (GtkWidget * widget,gpointer data)
specifier|static
name|void
name|cb_ok
parameter_list|(
...
begin_function
DECL|function|cb_change (GtkWidget * widget,gpointer data)
specifier|static
name|void
name|cb_change
parameter_list|(
...
begin_function
DECL|function|interactive_load_image (gchar * name)
name|gint32
name|interactive_load_image
parameter_list|(
name|gchar
...
begin_function
DECL|function|interactive_save_image (gchar * name,gint32 image_id)
name|int
name|interactive_save_image
parameter_list|(
name|gchar
...
argument_list|)
expr_stmt|;
comment|/*  	 * Maybe I'll add some functions to influence compression  	 * or FLI version. But for now you can set a start- and a end-frame:  	 */
name|label
operator|=
name|gtk_label_new
argument_list|(
